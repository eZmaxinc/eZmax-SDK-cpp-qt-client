...
/*
 * Supply_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/supply/{pkiSupplyID}
 */

#ifndef Supply_deleteObject_v1_Response_H
#define Supply_deleteObject_v1_Response_H
...
class Supply_deleteObject_v1_Response : public Object {
public:
    Supply_deleteObject_v1_Response();
    Supply_deleteObject_v1_Response(const QString &json);
    ~Supply_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Supply_deleteObject_v1_Response)

#endif // Supply_deleteObject_v1_Response_H
