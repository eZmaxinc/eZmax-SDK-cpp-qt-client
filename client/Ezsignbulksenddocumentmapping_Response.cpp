...
Ezsignbulksenddocumentmapping_Response::Ezsignbulksenddocumentmapping_Response(const QString &json) {
...
void Ezsignbulksenddocumentmapping_Response::fromJson(const QString &jsonString) {
