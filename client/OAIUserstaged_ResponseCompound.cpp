...
QString OAIUserstaged_ResponseCompound::getSEmailAddress() const {
    return s_email_address;
}
void OAIUserstaged_ResponseCompound::setSEmailAddress(const QString &s_email_address) {
    this->s_email_address = s_email_address;
    this->m_s_email_address_isSet = true;
}

bool OAIUserstaged_ResponseCompound::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool OAIUserstaged_ResponseCompound::is_s_email_address_Valid() const{
