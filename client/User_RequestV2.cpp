...
User_RequestV2::User_RequestV2() {
    this->initializeModel();
}

User_RequestV2::~User_RequestV2() {}

void User_RequestV2::initializeModel() {
...
void User_RequestV2::fromJsonObject(QJsonObject json) {
...
QJsonObject User_RequestV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 User_RequestV2::getPkiUserId() const {
    return m_pki_user_id;
}
void User_RequestV2::setPkiUserId(const qint32 &pki_user_id) {
    m_pki_user_id = pki_user_id;
    m_pki_user_id_isSet = true;
}

bool User_RequestV2::is_pki_user_id_Set() const{
    return m_pki_user_id_isSet;
}

bool User_RequestV2::is_pki_user_id_Valid() const{
    return m_pki_user_id_isValid;
}

qint32 User_RequestV2::getFkiAgentId() const {
    return m_fki_agent_id;
}
void User_RequestV2::setFkiAgentId(const qint32 &fki_agent_id) {
    m_fki_agent_id = fki_agent_id;
    m_fki_agent_id_isSet = true;
}

bool User_RequestV2::is_fki_agent_id_Set() const{
    return m_fki_agent_id_isSet;
}

bool User_RequestV2::is_fki_agent_id_Valid() const{
    return m_fki_agent_id_isValid;
}

qint32 User_RequestV2::getFkiBrokerId() const {
    return m_fki_broker_id;
}
void User_RequestV2::setFkiBrokerId(const qint32 &fki_broker_id) {
    m_fki_broker_id = fki_broker_id;
    m_fki_broker_id_isSet = true;
}

bool User_RequestV2::is_fki_broker_id_Set() const{
    return m_fki_broker_id_isSet;
}

bool User_RequestV2::is_fki_broker_id_Valid() const{
    return m_fki_broker_id_isValid;
}

qint32 User_RequestV2::getFkiAssistantId() const {
    return m_fki_assistant_id;
}
void User_RequestV2::setFkiAssistantId(const qint32 &fki_assistant_id) {
    m_fki_assistant_id = fki_assistant_id;
    m_fki_assistant_id_isSet = true;
}

bool User_RequestV2::is_fki_assistant_id_Set() const{
    return m_fki_assistant_id_isSet;
}

bool User_RequestV2::is_fki_assistant_id_Valid() const{
    return m_fki_assistant_id_isValid;
}

qint32 User_RequestV2::getFkiEmployeeId() const {
    return m_fki_employee_id;
}
void User_RequestV2::setFkiEmployeeId(const qint32 &fki_employee_id) {
    m_fki_employee_id = fki_employee_id;
    m_fki_employee_id_isSet = true;
}

bool User_RequestV2::is_fki_employee_id_Set() const{
    return m_fki_employee_id_isSet;
}

bool User_RequestV2::is_fki_employee_id_Valid() const{
    return m_fki_employee_id_isValid;
}

qint32 User_RequestV2::getFkiCompanyIdDefault() const {
    return m_fki_company_id_default;
}
void User_RequestV2::setFkiCompanyIdDefault(const qint32 &fki_company_id_default) {
    m_fki_company_id_default = fki_company_id_default;
    m_fki_company_id_default_isSet = true;
}

bool User_RequestV2::is_fki_company_id_default_Set() const{
    return m_fki_company_id_default_isSet;
}

bool User_RequestV2::is_fki_company_id_default_Valid() const{
    return m_fki_company_id_default_isValid;
}

qint32 User_RequestV2::getFkiDepartmentIdDefault() const {
    return m_fki_department_id_default;
}
void User_RequestV2::setFkiDepartmentIdDefault(const qint32 &fki_department_id_default) {
    m_fki_department_id_default = fki_department_id_default;
    m_fki_department_id_default_isSet = true;
}

bool User_RequestV2::is_fki_department_id_default_Set() const{
    return m_fki_department_id_default_isSet;
}

bool User_RequestV2::is_fki_department_id_default_Valid() const{
    return m_fki_department_id_default_isValid;
}

qint32 User_RequestV2::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void User_RequestV2::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool User_RequestV2::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool User_RequestV2::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

qint32 User_RequestV2::getFkiLanguageId() const {
    return m_fki_language_id;
}
void User_RequestV2::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool User_RequestV2::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool User_RequestV2::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

Email_RequestCompound User_RequestV2::getObjEmail() const {
    return m_obj_email;
}
void User_RequestV2::setObjEmail(const Email_RequestCompound &obj_email) {
    m_obj_email = obj_email;
    m_obj_email_isSet = true;
}

bool User_RequestV2::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool User_RequestV2::is_obj_email_Valid() const{
    return m_obj_email_isValid;
}

qint32 User_RequestV2::getFkiBillingentityinternalId() const {
    return m_fki_billingentityinternal_id;
}
void User_RequestV2::setFkiBillingentityinternalId(const qint32 &fki_billingentityinternal_id) {
    m_fki_billingentityinternal_id = fki_billingentityinternal_id;
    m_fki_billingentityinternal_id_isSet = true;
}

bool User_RequestV2::is_fki_billingentityinternal_id_Set() const{
    return m_fki_billingentityinternal_id_isSet;
}

bool User_RequestV2::is_fki_billingentityinternal_id_Valid() const{
    return m_fki_billingentityinternal_id_isValid;
}

Phone_RequestCompoundV2 User_RequestV2::getObjPhoneHome() const {
    return m_obj_phone_home;
}
void User_RequestV2::setObjPhoneHome(const Phone_RequestCompoundV2 &obj_phone_home) {
    m_obj_phone_home = obj_phone_home;
    m_obj_phone_home_isSet = true;
}

bool User_RequestV2::is_obj_phone_home_Set() const{
    return m_obj_phone_home_isSet;
}

bool User_RequestV2::is_obj_phone_home_Valid() const{
    return m_obj_phone_home_isValid;
}

Phone_RequestCompoundV2 User_RequestV2::getObjPhoneSms() const {
    return m_obj_phone_sms;
}
void User_RequestV2::setObjPhoneSms(const Phone_RequestCompoundV2 &obj_phone_sms) {
    m_obj_phone_sms = obj_phone_sms;
    m_obj_phone_sms_isSet = true;
}

bool User_RequestV2::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool User_RequestV2::is_obj_phone_sms_Valid() const{
    return m_obj_phone_sms_isValid;
}

qint32 User_RequestV2::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void User_RequestV2::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool User_RequestV2::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool User_RequestV2::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

QString User_RequestV2::getSUserSecretresponse() const {
    return m_s_user_secretresponse;
}
void User_RequestV2::setSUserSecretresponse(const QString &s_user_secretresponse) {
    m_s_user_secretresponse = s_user_secretresponse;
    m_s_user_secretresponse_isSet = true;
}

bool User_RequestV2::is_s_user_secretresponse_Set() const{
    return m_s_user_secretresponse_isSet;
}

bool User_RequestV2::is_s_user_secretresponse_Valid() const{
    return m_s_user_secretresponse_isValid;
}

qint32 User_RequestV2::getFkiModuleIdForm() const {
    return m_fki_module_id_form;
}
void User_RequestV2::setFkiModuleIdForm(const qint32 &fki_module_id_form) {
    m_fki_module_id_form = fki_module_id_form;
    m_fki_module_id_form_isSet = true;
}

bool User_RequestV2::is_fki_module_id_form_Set() const{
    return m_fki_module_id_form_isSet;
}

bool User_RequestV2::is_fki_module_id_form_Valid() const{
    return m_fki_module_id_form_isValid;
}

Field_eUserType User_RequestV2::getEUserType() const {
    return m_e_user_type;
}
void User_RequestV2::setEUserType(const Field_eUserType &e_user_type) {
    m_e_user_type = e_user_type;
    m_e_user_type_isSet = true;
}

bool User_RequestV2::is_e_user_type_Set() const{
    return m_e_user_type_isSet;
}

bool User_RequestV2::is_e_user_type_Valid() const{
    return m_e_user_type_isValid;
}

Field_eUserLogintype User_RequestV2::getEUserLogintype() const {
    return m_e_user_logintype;
}
void User_RequestV2::setEUserLogintype(const Field_eUserLogintype &e_user_logintype) {
    m_e_user_logintype = e_user_logintype;
    m_e_user_logintype_isSet = true;
}

bool User_RequestV2::is_e_user_logintype_Set() const{
    return m_e_user_logintype_isSet;
}

bool User_RequestV2::is_e_user_logintype_Valid() const{
    return m_e_user_logintype_isValid;
}

QString User_RequestV2::getSUserFirstname() const {
    return m_s_user_firstname;
}
void User_RequestV2::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool User_RequestV2::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool User_RequestV2::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString User_RequestV2::getSUserLastname() const {
    return m_s_user_lastname;
}
void User_RequestV2::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool User_RequestV2::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool User_RequestV2::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString User_RequestV2::getSUserLoginname() const {
    return m_s_user_loginname;
}
void User_RequestV2::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool User_RequestV2::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool User_RequestV2::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString User_RequestV2::getSUserJobtitle() const {
    return m_s_user_jobtitle;
}
void User_RequestV2::setSUserJobtitle(const QString &s_user_jobtitle) {
    m_s_user_jobtitle = s_user_jobtitle;
    m_s_user_jobtitle_isSet = true;
}

bool User_RequestV2::is_s_user_jobtitle_Set() const{
    return m_s_user_jobtitle_isSet;
}

bool User_RequestV2::is_s_user_jobtitle_Valid() const{
    return m_s_user_jobtitle_isValid;
}

Field_eUserEzsignaccess User_RequestV2::getEUserEzsignaccess() const {
    return m_e_user_ezsignaccess;
}
void User_RequestV2::setEUserEzsignaccess(const Field_eUserEzsignaccess &e_user_ezsignaccess) {
    m_e_user_ezsignaccess = e_user_ezsignaccess;
    m_e_user_ezsignaccess_isSet = true;
}

bool User_RequestV2::is_e_user_ezsignaccess_Set() const{
    return m_e_user_ezsignaccess_isSet;
}

bool User_RequestV2::is_e_user_ezsignaccess_Valid() const{
    return m_e_user_ezsignaccess_isValid;
}

bool User_RequestV2::isBUserIsactive() const {
    return m_b_user_isactive;
}
void User_RequestV2::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool User_RequestV2::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool User_RequestV2::is_b_user_isactive_Valid() const{
    return m_b_user_isactive_isValid;
}

bool User_RequestV2::isBUserValidatebyadministration() const {
    return m_b_user_validatebyadministration;
}
void User_RequestV2::setBUserValidatebyadministration(const bool &b_user_validatebyadministration) {
    m_b_user_validatebyadministration = b_user_validatebyadministration;
    m_b_user_validatebyadministration_isSet = true;
}

bool User_RequestV2::is_b_user_validatebyadministration_Set() const{
    return m_b_user_validatebyadministration_isSet;
}

bool User_RequestV2::is_b_user_validatebyadministration_Valid() const{
    return m_b_user_validatebyadministration_isValid;
}

bool User_RequestV2::isBUserValidatebydirector() const {
    return m_b_user_validatebydirector;
}
void User_RequestV2::setBUserValidatebydirector(const bool &b_user_validatebydirector) {
    m_b_user_validatebydirector = b_user_validatebydirector;
    m_b_user_validatebydirector_isSet = true;
}

bool User_RequestV2::is_b_user_validatebydirector_Set() const{
    return m_b_user_validatebydirector_isSet;
}

bool User_RequestV2::is_b_user_validatebydirector_Valid() const{
    return m_b_user_validatebydirector_isValid;
}

bool User_RequestV2::isBUserAttachmentautoverified() const {
    return m_b_user_attachmentautoverified;
}
void User_RequestV2::setBUserAttachmentautoverified(const bool &b_user_attachmentautoverified) {
    m_b_user_attachmentautoverified = b_user_attachmentautoverified;
    m_b_user_attachmentautoverified_isSet = true;
}

bool User_RequestV2::is_b_user_attachmentautoverified_Set() const{
    return m_b_user_attachmentautoverified_isSet;
}

bool User_RequestV2::is_b_user_attachmentautoverified_Valid() const{
    return m_b_user_attachmentautoverified_isValid;
}

bool User_RequestV2::isBUserChangepassword() const {
    return m_b_user_changepassword;
}
void User_RequestV2::setBUserChangepassword(const bool &b_user_changepassword) {
    m_b_user_changepassword = b_user_changepassword;
    m_b_user_changepassword_isSet = true;
}

bool User_RequestV2::is_b_user_changepassword_Set() const{
    return m_b_user_changepassword_isSet;
}

bool User_RequestV2::is_b_user_changepassword_Valid() const{
...
bool User_RequestV2::isValid() const {
