...
Ezsigndocument_getWordsPositions_v1_Request::Ezsigndocument_getWordsPositions_v1_Request(const QString &json) {
...
void Ezsigndocument_getWordsPositions_v1_Request::fromJson(const QString &jsonString) {
