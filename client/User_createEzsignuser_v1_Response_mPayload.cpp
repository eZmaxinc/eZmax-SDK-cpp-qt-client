...
void User_createEzsignuser_v1_Response_mPayload::initializeModel() {
...
void User_createEzsignuser_v1_Response_mPayload::fromJsonObject(QJsonObject json) {
...
QString User_createEzsignuser_v1_Response_mPayload::asJson() const {
...
QJsonObject User_createEzsignuser_v1_Response_mPayload::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> User_createEzsignuser_v1_Response_mPayload::getASEmailAddressSuccess() const {
    return m_a_s_email_address_success;
}
void User_createEzsignuser_v1_Response_mPayload::setASEmailAddressSuccess(const QList<QString> &a_s_email_address_success) {
    m_a_s_email_address_success = a_s_email_address_success;
    m_a_s_email_address_success_isSet = true;
}

bool User_createEzsignuser_v1_Response_mPayload::is_a_s_email_address_success_Set() const{
    return m_a_s_email_address_success_isSet;
}

bool User_createEzsignuser_v1_Response_mPayload::is_a_s_email_address_success_Valid() const{
    return m_a_s_email_address_success_isValid;
}

QList<QString> User_createEzsignuser_v1_Response_mPayload::getASEmailAddressFailure() const {
    return m_a_s_email_address_failure;
}
void User_createEzsignuser_v1_Response_mPayload::setASEmailAddressFailure(const QList<QString> &a_s_email_address_failure) {
    m_a_s_email_address_failure = a_s_email_address_failure;
    m_a_s_email_address_failure_isSet = true;
}

bool User_createEzsignuser_v1_Response_mPayload::is_a_s_email_address_failure_Set() const{
    return m_a_s_email_address_failure_isSet;
}

bool User_createEzsignuser_v1_Response_mPayload::is_a_s_email_address_failure_Valid() const{
    return m_a_s_email_address_failure_isValid;
}

bool User_createEzsignuser_v1_Response_mPayload::isSet() const {
...
bool User_createEzsignuser_v1_Response_mPayload::isValid() const {
