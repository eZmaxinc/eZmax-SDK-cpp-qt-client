...
ObjectCompanyApi::ObjectCompanyApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectCompanyApi::~ObjectCompanyApi() {
}

void ObjectCompanyApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectCompanyApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectCompanyApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectCompanyApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectCompanyApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectCompanyApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectCompanyApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectCompanyApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectCompanyApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectCompanyApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectCompanyApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectCompanyApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectCompanyApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectCompanyApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectCompanyApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectCompanyApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectCompanyApi::enableResponseCompression() {
...
QString ObjectCompanyApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectCompanyApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectCompanyApi::companyGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectCompanyApi::companyGetAutocompleteV2Callback);
...
void ObjectCompanyApi::companyGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    ...
    Company_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectCompanyApi::tokenAvailable() {
