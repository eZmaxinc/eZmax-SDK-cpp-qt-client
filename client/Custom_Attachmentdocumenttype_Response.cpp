...
Custom_Attachmentdocumenttype_Response::Custom_Attachmentdocumenttype_Response(const QString &json) {
...
void Custom_Attachmentdocumenttype_Response::fromJson(const QString &jsonString) {
