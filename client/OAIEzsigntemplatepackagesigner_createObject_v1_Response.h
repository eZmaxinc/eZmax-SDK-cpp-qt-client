...
private:
    ...
    OAIEzsigntemplatepackagesigner_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackagesigner_createObject_v1_Response)
