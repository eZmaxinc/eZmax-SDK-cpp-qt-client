...
Field_eWebhookEzmaxpartnerevent Webhook_ResponseCompound::getEWebhookEzmaxpartnerevent() const {
    return m_e_webhook_ezmaxpartnerevent;
}
void Webhook_ResponseCompound::setEWebhookEzmaxpartnerevent(const Field_eWebhookEzmaxpartnerevent &e_webhook_ezmaxpartnerevent) {
    m_e_webhook_ezmaxpartnerevent = e_webhook_ezmaxpartnerevent;
    m_e_webhook_ezmaxpartnerevent_isSet = true;
}

bool Webhook_ResponseCompound::is_e_webhook_ezmaxpartnerevent_Set() const{
    return m_e_webhook_ezmaxpartnerevent_isSet;
}

bool Webhook_ResponseCompound::is_e_webhook_ezmaxpartnerevent_Valid() const{
...
Field_eWebhookRealestateevent Webhook_ResponseCompound::getEWebhookRealestateevent() const {
    return m_e_webhook_realestateevent;
}
void Webhook_ResponseCompound::setEWebhookRealestateevent(const Field_eWebhookRealestateevent &e_webhook_realestateevent) {
    m_e_webhook_realestateevent = e_webhook_realestateevent;
    m_e_webhook_realestateevent_isSet = true;
}

bool Webhook_ResponseCompound::is_e_webhook_realestateevent_Set() const{
    return m_e_webhook_realestateevent_isSet;
}

bool Webhook_ResponseCompound::is_e_webhook_realestateevent_Valid() const{
...
QString Webhook_ResponseCompound::getSWebhookAuthentificationexternalerror() const {
    return m_s_webhook_authentificationexternalerror;
}
void Webhook_ResponseCompound::setSWebhookAuthentificationexternalerror(const QString &s_webhook_authentificationexternalerror) {
...
bool Webhook_ResponseCompound::is_s_webhook_authentificationexternalerror_Set() const{
    return m_s_webhook_authentificationexternalerror_isSet;
}

bool Webhook_ResponseCompound::is_s_webhook_authentificationexternalerror_Valid() const{
