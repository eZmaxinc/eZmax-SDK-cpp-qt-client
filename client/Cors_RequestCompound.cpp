...
Cors_RequestCompound::Cors_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Cors_RequestCompound::Cors_RequestCompound() {
    this->initializeModel();
}

Cors_RequestCompound::~Cors_RequestCompound() {}

void Cors_RequestCompound::initializeModel() {
...
void Cors_RequestCompound::fromJson(const QString &jsonString) {
...
void Cors_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Cors_RequestCompound::asJson() const {
...
QJsonObject Cors_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Cors_RequestCompound::getPkiCorsId() const {
    return m_pki_cors_id;
}
void Cors_RequestCompound::setPkiCorsId(const qint32 &pki_cors_id) {
    m_pki_cors_id = pki_cors_id;
    m_pki_cors_id_isSet = true;
}

bool Cors_RequestCompound::is_pki_cors_id_Set() const{
    return m_pki_cors_id_isSet;
}

bool Cors_RequestCompound::is_pki_cors_id_Valid() const{
    return m_pki_cors_id_isValid;
}

qint32 Cors_RequestCompound::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void Cors_RequestCompound::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool Cors_RequestCompound::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool Cors_RequestCompound::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

QString Cors_RequestCompound::getSCorsEntryurl() const {
    return m_s_cors_entryurl;
}
void Cors_RequestCompound::setSCorsEntryurl(const QString &s_cors_entryurl) {
    m_s_cors_entryurl = s_cors_entryurl;
    m_s_cors_entryurl_isSet = true;
}

bool Cors_RequestCompound::is_s_cors_entryurl_Set() const{
    return m_s_cors_entryurl_isSet;
}

bool Cors_RequestCompound::is_s_cors_entryurl_Valid() const{
    return m_s_cors_entryurl_isValid;
}

bool Cors_RequestCompound::isSet() const {
...
bool Cors_RequestCompound::isValid() const {
