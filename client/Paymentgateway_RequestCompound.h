...
/*
 * Paymentgateway_RequestCompound.h
 *
 * A Paymentgateway Object and children
 */

#ifndef Paymentgateway_RequestCompound_H
#define Paymentgateway_RequestCompound_H
...
class Paymentgateway_RequestCompound : public Object {
public:
    Paymentgateway_RequestCompound();
    Paymentgateway_RequestCompound(const QString &json);
    ~Paymentgateway_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentgateway_RequestCompound)

#endif // Paymentgateway_RequestCompound_H
