...
#ifndef Ezsignannotation_Request_H
#define Ezsignannotation_Request_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignannotation_Request)

#endif // Ezsignannotation_Request_H
