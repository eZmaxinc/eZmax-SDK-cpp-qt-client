...
private:
    ...
    OAIEzsignbulksendtransmission_ResponseCompound m_obj_ezsignbulksendtransmission;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksendtransmission_getObject_v2_Response_mPayload)
