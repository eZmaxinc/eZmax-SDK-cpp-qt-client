...
public:
    OAIObjectEzsignsignatureApi(const QString &scheme = "https", const QString &host = "prod.api.appcluster01.ca-central-1.ezmax.com", int port = 0, const QString &basePath = "/rest", const int timeOut = 0);
    ...
    void ezsignsignatureGetObjectGetChildrenV1(const qint32 &pki_ezsignsignature_id);
...
private:
    ...
    void ezsignsignatureGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsignsignatureGetObjectGetChildrenV1Signal();
    ...
    void ezsignsignatureGetObjectGetChildrenV1SignalFull(OAIHttpRequestWorker *worker);
    ...
    void ezsignsignatureGetObjectGetChildrenV1SignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsignsignatureGetObjectGetChildrenV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
