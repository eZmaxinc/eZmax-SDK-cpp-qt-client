...
/*
 * OAIEzsignbulksenddocumentmapping_RequestCompound.h
 *
 * A Ezsignbulksenddocumentmapping Object and children
 */

#ifndef OAIEzsignbulksenddocumentmapping_RequestCompound_H
#define OAIEzsignbulksenddocumentmapping_RequestCompound_H
...
class OAIEzsignbulksenddocumentmapping_RequestCompound : public OAIObject {
public:
    OAIEzsignbulksenddocumentmapping_RequestCompound();
    OAIEzsignbulksenddocumentmapping_RequestCompound(QString json);
    ~OAIEzsignbulksenddocumentmapping_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksenddocumentmapping_RequestCompound)

#endif // OAIEzsignbulksenddocumentmapping_RequestCompound_H
