...
#include "Ezsignformfield_ResponseCompound.h"
...
Ezsignformfield_ResponseCompound::Ezsignformfield_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignformfield_ResponseCompound::Ezsignformfield_ResponseCompound() {
    this->initializeModel();
}

Ezsignformfield_ResponseCompound::~Ezsignformfield_ResponseCompound() {}

void Ezsignformfield_ResponseCompound::initializeModel() {
...
void Ezsignformfield_ResponseCompound::fromJson(const QString &jsonString) {
...
void Ezsignformfield_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignformfield_ResponseCompound::asJson() const {
...
QJsonObject Ezsignformfield_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignformfield_ResponseCompound::getPkiEzsignformfieldId() const {
    return m_pki_ezsignformfield_id;
}
void Ezsignformfield_ResponseCompound::setPkiEzsignformfieldId(const qint32 &pki_ezsignformfield_id) {
    m_pki_ezsignformfield_id = pki_ezsignformfield_id;
    m_pki_ezsignformfield_id_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_pki_ezsignformfield_id_Set() const{
    return m_pki_ezsignformfield_id_isSet;
}

bool Ezsignformfield_ResponseCompound::is_pki_ezsignformfield_id_Valid() const{
    return m_pki_ezsignformfield_id_isValid;
}

qint32 Ezsignformfield_ResponseCompound::getIEzsignpagePagenumber() const {
    return m_i_ezsignpage_pagenumber;
}
void Ezsignformfield_ResponseCompound::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

QString Ezsignformfield_ResponseCompound::getSEzsignformfieldLabel() const {
    return m_s_ezsignformfield_label;
}
void Ezsignformfield_ResponseCompound::setSEzsignformfieldLabel(const QString &s_ezsignformfield_label) {
    m_s_ezsignformfield_label = s_ezsignformfield_label;
    m_s_ezsignformfield_label_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_label_Set() const{
    return m_s_ezsignformfield_label_isSet;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_label_Valid() const{
    return m_s_ezsignformfield_label_isValid;
}

QString Ezsignformfield_ResponseCompound::getSEzsignformfieldValue() const {
    return m_s_ezsignformfield_value;
}
void Ezsignformfield_ResponseCompound::setSEzsignformfieldValue(const QString &s_ezsignformfield_value) {
    m_s_ezsignformfield_value = s_ezsignformfield_value;
    m_s_ezsignformfield_value_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_value_Set() const{
    return m_s_ezsignformfield_value_isSet;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_value_Valid() const{
    return m_s_ezsignformfield_value_isValid;
}

qint32 Ezsignformfield_ResponseCompound::getIEzsignformfieldX() const {
    return m_i_ezsignformfield_x;
}
void Ezsignformfield_ResponseCompound::setIEzsignformfieldX(const qint32 &i_ezsignformfield_x) {
    m_i_ezsignformfield_x = i_ezsignformfield_x;
    m_i_ezsignformfield_x_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_x_Set() const{
    return m_i_ezsignformfield_x_isSet;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_x_Valid() const{
    return m_i_ezsignformfield_x_isValid;
}

qint32 Ezsignformfield_ResponseCompound::getIEzsignformfieldY() const {
    return m_i_ezsignformfield_y;
}
void Ezsignformfield_ResponseCompound::setIEzsignformfieldY(const qint32 &i_ezsignformfield_y) {
    m_i_ezsignformfield_y = i_ezsignformfield_y;
    m_i_ezsignformfield_y_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_y_Set() const{
    return m_i_ezsignformfield_y_isSet;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_y_Valid() const{
    return m_i_ezsignformfield_y_isValid;
}

qint32 Ezsignformfield_ResponseCompound::getIEzsignformfieldWidth() const {
    return m_i_ezsignformfield_width;
}
void Ezsignformfield_ResponseCompound::setIEzsignformfieldWidth(const qint32 &i_ezsignformfield_width) {
    m_i_ezsignformfield_width = i_ezsignformfield_width;
    m_i_ezsignformfield_width_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_width_Set() const{
    return m_i_ezsignformfield_width_isSet;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_width_Valid() const{
    return m_i_ezsignformfield_width_isValid;
}

qint32 Ezsignformfield_ResponseCompound::getIEzsignformfieldHeight() const {
    return m_i_ezsignformfield_height;
}
void Ezsignformfield_ResponseCompound::setIEzsignformfieldHeight(const qint32 &i_ezsignformfield_height) {
    m_i_ezsignformfield_height = i_ezsignformfield_height;
    m_i_ezsignformfield_height_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_height_Set() const{
    return m_i_ezsignformfield_height_isSet;
}

bool Ezsignformfield_ResponseCompound::is_i_ezsignformfield_height_Valid() const{
...
void Ezsignformfield_ResponseCompound::setBEzsignformfieldSelected(const bool &b_ezsignformfield_selected) {
    m_b_ezsignformfield_selected = b_ezsignformfield_selected;
    m_b_ezsignformfield_selected_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_b_ezsignformfield_selected_Set() const{
    return m_b_ezsignformfield_selected_isSet;
}

bool Ezsignformfield_ResponseCompound::is_b_ezsignformfield_selected_Valid() const{
    return m_b_ezsignformfield_selected_isValid;
}

QString Ezsignformfield_ResponseCompound::getSEzsignformfieldEnteredvalue() const {
    return m_s_ezsignformfield_enteredvalue;
}
void Ezsignformfield_ResponseCompound::setSEzsignformfieldEnteredvalue(const QString &s_ezsignformfield_enteredvalue) {
    m_s_ezsignformfield_enteredvalue = s_ezsignformfield_enteredvalue;
    m_s_ezsignformfield_enteredvalue_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_enteredvalue_Set() const{
    return m_s_ezsignformfield_enteredvalue_isSet;
}

bool Ezsignformfield_ResponseCompound::is_s_ezsignformfield_enteredvalue_Valid() const{
    return m_s_ezsignformfield_enteredvalue_isValid;
}

Field_eEzsignformfieldDependencyrequirement Ezsignformfield_ResponseCompound::getEEzsignformfieldDependencyrequirement() const {
    return m_e_ezsignformfield_dependencyrequirement;
}
void Ezsignformfield_ResponseCompound::setEEzsignformfieldDependencyrequirement(const Field_eEzsignformfieldDependencyrequirement &e_ezsignformfield_dependencyrequirement) {
...
bool Ezsignformfield_ResponseCompound::is_e_ezsignformfield_dependencyrequirement_Set() const{
    return m_e_ezsignformfield_dependencyrequirement_isSet;
}

bool Ezsignformfield_ResponseCompound::is_e_ezsignformfield_dependencyrequirement_Valid() const{
    return m_e_ezsignformfield_dependencyrequirement_isValid;
}

Enum_Horizontalalignment Ezsignformfield_ResponseCompound::getEEzsignformfieldHorizontalalignment() const {
    return m_e_ezsignformfield_horizontalalignment;
}
void Ezsignformfield_ResponseCompound::setEEzsignformfieldHorizontalalignment(const Enum_Horizontalalignment &e_ezsignformfield_horizontalalignment) {
...
bool Ezsignformfield_ResponseCompound::is_e_ezsignformfield_horizontalalignment_Set() const{
    return m_e_ezsignformfield_horizontalalignment_isSet;
}

bool Ezsignformfield_ResponseCompound::is_e_ezsignformfield_horizontalalignment_Valid() const{
    return m_e_ezsignformfield_horizontalalignment_isValid;
}

Textstylestatic_ResponseCompound Ezsignformfield_ResponseCompound::getObjTextstylestatic() const {
    return m_obj_textstylestatic;
}
void Ezsignformfield_ResponseCompound::setObjTextstylestatic(const Textstylestatic_ResponseCompound &obj_textstylestatic) {
    m_obj_textstylestatic = obj_textstylestatic;
    m_obj_textstylestatic_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_obj_textstylestatic_Set() const{
    return m_obj_textstylestatic_isSet;
}

bool Ezsignformfield_ResponseCompound::is_obj_textstylestatic_Valid() const{
    return m_obj_textstylestatic_isValid;
}

QList<Ezsignelementdependency_ResponseCompound> Ezsignformfield_ResponseCompound::getAObjEzsignelementdependency() const {
    return m_a_obj_ezsignelementdependency;
}
void Ezsignformfield_ResponseCompound::setAObjEzsignelementdependency(const QList<Ezsignelementdependency_ResponseCompound> &a_obj_ezsignelementdependency) {
    m_a_obj_ezsignelementdependency = a_obj_ezsignelementdependency;
    m_a_obj_ezsignelementdependency_isSet = true;
}

bool Ezsignformfield_ResponseCompound::is_a_obj_ezsignelementdependency_Set() const{
    return m_a_obj_ezsignelementdependency_isSet;
}

bool Ezsignformfield_ResponseCompound::is_a_obj_ezsignelementdependency_Valid() const{
    return m_a_obj_ezsignelementdependency_isValid;
}

bool Ezsignformfield_ResponseCompound::isSet() const {
...
bool Ezsignformfield_ResponseCompound::isValid() const {
