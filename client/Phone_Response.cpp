...
Phone_Response::Phone_Response(const QString &json) {
...
void Phone_Response::initializeModel() {
...
void Phone_Response::fromJson(const QString &jsonString) {
...
void Phone_Response::fromJsonObject(QJsonObject json) {
...
QString Phone_Response::asJson() const {
...
QJsonObject Phone_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Phone_Response::getPkiPhoneId() const {
    return m_pki_phone_id;
}
void Phone_Response::setPkiPhoneId(const qint32 &pki_phone_id) {
    m_pki_phone_id = pki_phone_id;
    m_pki_phone_id_isSet = true;
}

bool Phone_Response::is_pki_phone_id_Set() const{
    return m_pki_phone_id_isSet;
}

bool Phone_Response::is_pki_phone_id_Valid() const{
    return m_pki_phone_id_isValid;
}

qint32 Phone_Response::getFkiPhonetypeId() const {
    return m_fki_phonetype_id;
}
void Phone_Response::setFkiPhonetypeId(const qint32 &fki_phonetype_id) {
    m_fki_phonetype_id = fki_phonetype_id;
    m_fki_phonetype_id_isSet = true;
}

bool Phone_Response::is_fki_phonetype_id_Set() const{
    return m_fki_phonetype_id_isSet;
}

bool Phone_Response::is_fki_phonetype_id_Valid() const{
    return m_fki_phonetype_id_isValid;
}

Field_ePhoneType Phone_Response::getEPhoneType() const {
    return m_e_phone_type;
}
void Phone_Response::setEPhoneType(const Field_ePhoneType &e_phone_type) {
    m_e_phone_type = e_phone_type;
    m_e_phone_type_isSet = true;
}

bool Phone_Response::is_e_phone_type_Set() const{
    return m_e_phone_type_isSet;
}

bool Phone_Response::is_e_phone_type_Valid() const{
    return m_e_phone_type_isValid;
}

QString Phone_Response::getSPhoneE164() const {
    return m_s_phone_e164;
}
void Phone_Response::setSPhoneE164(const QString &s_phone_e164) {
    m_s_phone_e164 = s_phone_e164;
    m_s_phone_e164_isSet = true;
}

bool Phone_Response::is_s_phone_e164_Set() const{
    return m_s_phone_e164_isSet;
}

bool Phone_Response::is_s_phone_e164_Valid() const{
    return m_s_phone_e164_isValid;
}

QString Phone_Response::getSPhoneExtension() const {
    return m_s_phone_extension;
}
void Phone_Response::setSPhoneExtension(const QString &s_phone_extension) {
    m_s_phone_extension = s_phone_extension;
    m_s_phone_extension_isSet = true;
}

bool Phone_Response::is_s_phone_extension_Set() const{
    return m_s_phone_extension_isSet;
}

bool Phone_Response::is_s_phone_extension_Valid() const{
    return m_s_phone_extension_isValid;
}

bool Phone_Response::isSet() const {
...
bool Phone_Response::isValid() const {
