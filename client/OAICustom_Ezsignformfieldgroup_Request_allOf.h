...
/*
 * OAICustom_Ezsignformfieldgroup_Request_allOf.h
 *
 * 
 */

#ifndef OAICustom_Ezsignformfieldgroup_Request_allOf_H
#define OAICustom_Ezsignformfieldgroup_Request_allOf_H
...
class OAICustom_Ezsignformfieldgroup_Request_allOf : public OAIObject {
public:
    OAICustom_Ezsignformfieldgroup_Request_allOf();
    OAICustom_Ezsignformfieldgroup_Request_allOf(QString json);
    ~OAICustom_Ezsignformfieldgroup_Request_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_Ezsignformfieldgroup_Request_allOf)

#endif // OAICustom_Ezsignformfieldgroup_Request_allOf_H
