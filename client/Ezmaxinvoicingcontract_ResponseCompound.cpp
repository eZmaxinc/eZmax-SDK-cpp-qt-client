...
Ezmaxinvoicingcontract_ResponseCompound::Ezmaxinvoicingcontract_ResponseCompound(const QString &json) {
...
void Ezmaxinvoicingcontract_ResponseCompound::fromJson(const QString &jsonString) {
