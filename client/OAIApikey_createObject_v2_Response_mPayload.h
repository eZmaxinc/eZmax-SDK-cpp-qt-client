...
/*
 * OAIApikey_createObject_v2_Response_mPayload.h
 *
 * Payload for POST /2/object/apikey
 */

#ifndef OAIApikey_createObject_v2_Response_mPayload_H
#define OAIApikey_createObject_v2_Response_mPayload_H
...
public:
    OAIApikey_createObject_v2_Response_mPayload();
    OAIApikey_createObject_v2_Response_mPayload(QString json);
    ~OAIApikey_createObject_v2_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIApikey_createObject_v2_Response_mPayload)

#endif // OAIApikey_createObject_v2_Response_mPayload_H
