...
void OAIEzsigntemplatepackage_ListElement::fromJsonObject(QJsonObject json) {
    ...
    m_i_ezsigntemplatepackagemembership_isValid = ::OpenAPI::fromJsonValue(m_i_ezsigntemplatepackagemembership, json[QString("iEzsigntemplatepackagemembership")]);
...
QJsonObject OAIEzsigntemplatepackage_ListElement::asJsonObject() const {
    ...
    if (m_i_ezsigntemplatepackagemembership_isSet) {
        obj.insert(QString("iEzsigntemplatepackagemembership"), ::OpenAPI::toJsonValue(m_i_ezsigntemplatepackagemembership));
    }
