...
/*
 * Ezsigndocument_applyEzsigntemplateglobal_v2_Response.h
 *
 * Response for POST /2/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplateglobal
 */

#ifndef Ezsigndocument_applyEzsigntemplateglobal_v2_Response_H
#define Ezsigndocument_applyEzsigntemplateglobal_v2_Response_H
...
class Ezsigndocument_applyEzsigntemplateglobal_v2_Response : public Object {
public:
    Ezsigndocument_applyEzsigntemplateglobal_v2_Response();
    Ezsigndocument_applyEzsigntemplateglobal_v2_Response(const QString &json);
    ~Ezsigndocument_applyEzsigntemplateglobal_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_applyEzsigntemplateglobal_v2_Response)

#endif // Ezsigndocument_applyEzsigntemplateglobal_v2_Response_H
