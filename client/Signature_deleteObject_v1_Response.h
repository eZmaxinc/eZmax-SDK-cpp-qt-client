...
/*
 * Signature_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/signature/{pkiSignatureID}
 */

#ifndef Signature_deleteObject_v1_Response_H
#define Signature_deleteObject_v1_Response_H
...
class Signature_deleteObject_v1_Response : public Object {
public:
    Signature_deleteObject_v1_Response();
    Signature_deleteObject_v1_Response(const QString &json);
    ~Signature_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Signature_deleteObject_v1_Response)

#endif // Signature_deleteObject_v1_Response_H
