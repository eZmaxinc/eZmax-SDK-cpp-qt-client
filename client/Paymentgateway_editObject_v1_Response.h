...
/*
 * Paymentgateway_editObject_v1_Response.h
 *
 * Response for PUT /1/object/paymentgateway/{pkiPaymentgatewayID}
 */

#ifndef Paymentgateway_editObject_v1_Response_H
#define Paymentgateway_editObject_v1_Response_H
...
class Paymentgateway_editObject_v1_Response : public Object {
public:
    Paymentgateway_editObject_v1_Response();
    Paymentgateway_editObject_v1_Response(const QString &json);
    ~Paymentgateway_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentgateway_editObject_v1_Response)

#endif // Paymentgateway_editObject_v1_Response_H
