...
Ezsigndocument_getEzsignannotations_v1_Response_mPayload::Ezsigndocument_getEzsignannotations_v1_Response_mPayload(const QString &json) {
...
void Ezsigndocument_getEzsignannotations_v1_Response_mPayload::fromJson(const QString &jsonString) {
