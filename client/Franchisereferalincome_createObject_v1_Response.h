...
#ifndef Franchisereferalincome_createObject_v1_Response_H
#define Franchisereferalincome_createObject_v1_Response_H
...
class Franchisereferalincome_createObject_v1_Response : public Object {
public:
    Franchisereferalincome_createObject_v1_Response();
    Franchisereferalincome_createObject_v1_Response(QString json);
    ~Franchisereferalincome_createObject_v1_Response() override;
    ...
    Franchisereferalincome_createObject_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Franchisereferalincome_createObject_v1_Response_mPayload &m_payload);
...
private:
    ...
    Franchisereferalincome_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Franchisereferalincome_createObject_v1_Response)

#endif // Franchisereferalincome_createObject_v1_Response_H
