...
/*
 * Ezsignbulksend_ListElement.h
 *
 * An Ezsignbulksend List Element
 */

#ifndef Ezsignbulksend_ListElement_H
#define Ezsignbulksend_ListElement_H
...
class Ezsignbulksend_ListElement : public Object {
public:
    Ezsignbulksend_ListElement();
    Ezsignbulksend_ListElement(const QString &json);
    ~Ezsignbulksend_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_ListElement)

#endif // Ezsignbulksend_ListElement_H
