...
/*
 * Cors_editObject_v1_Response.h
 *
 * Response for PUT /1/object/cors/{pkiCorsID}
 */

#ifndef Cors_editObject_v1_Response_H
#define Cors_editObject_v1_Response_H
...
class Cors_editObject_v1_Response : public Object {
public:
    Cors_editObject_v1_Response();
    Cors_editObject_v1_Response(const QString &json);
    ~Cors_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Cors_editObject_v1_Response)

#endif // Cors_editObject_v1_Response_H
