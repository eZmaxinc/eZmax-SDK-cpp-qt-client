...
#ifndef Ezsigntemplatepackagesigner_Response_H
#define Ezsigntemplatepackagesigner_Response_H
...
class Ezsigntemplatepackagesigner_Response : public Object {
public:
    Ezsigntemplatepackagesigner_Response();
    Ezsigntemplatepackagesigner_Response(const QString &json);
    ~Ezsigntemplatepackagesigner_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagesigner_Response)

#endif // Ezsigntemplatepackagesigner_Response_H
