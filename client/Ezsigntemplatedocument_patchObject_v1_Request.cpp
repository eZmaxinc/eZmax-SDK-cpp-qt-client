...
Ezsigntemplatedocument_patchObject_v1_Request::Ezsigntemplatedocument_patchObject_v1_Request(const QString &json) {
...
void Ezsigntemplatedocument_patchObject_v1_Request::fromJson(const QString &jsonString) {
