...
/*
 * Creditcardmerchant_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/creditcardmerchant/getAutocomplete
 */

#ifndef Creditcardmerchant_getAutocomplete_v2_Response_H
#define Creditcardmerchant_getAutocomplete_v2_Response_H
...
class Creditcardmerchant_getAutocomplete_v2_Response_mPayload;
...
public:
    ...
    Creditcardmerchant_getAutocomplete_v2_Response_mPayload getMPayload() const;
    void setMPayload(const Creditcardmerchant_getAutocomplete_v2_Response_mPayload &m_payload);
...
private:
    ...
    Creditcardmerchant_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardmerchant_getAutocomplete_v2_Response)

#endif // Creditcardmerchant_getAutocomplete_v2_Response_H
