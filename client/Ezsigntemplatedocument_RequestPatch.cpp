...
Ezsigntemplatedocument_RequestPatch::Ezsigntemplatedocument_RequestPatch(const QString &json) {
...
void Ezsigntemplatedocument_RequestPatch::fromJson(const QString &jsonString) {
