...
Ezsigntemplateelementdependency_Request::Ezsigntemplateelementdependency_Request(const QString &json) {
...
void Ezsigntemplateelementdependency_Request::fromJson(const QString &jsonString) {
