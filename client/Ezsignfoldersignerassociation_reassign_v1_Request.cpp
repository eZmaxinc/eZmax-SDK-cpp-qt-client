...
Ezsignfoldersignerassociation_reassign_v1_Request::Ezsignfoldersignerassociation_reassign_v1_Request(const QString &json) {
...
void Ezsignfoldersignerassociation_reassign_v1_Request::fromJson(const QString &jsonString) {
