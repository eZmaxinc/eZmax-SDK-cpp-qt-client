...
Multilingual_EzsignsignergroupDescription::Multilingual_EzsignsignergroupDescription(const QString &json) {
...
void Multilingual_EzsignsignergroupDescription::fromJson(const QString &jsonString) {
