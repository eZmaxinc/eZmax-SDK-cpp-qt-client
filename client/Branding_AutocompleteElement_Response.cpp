...
Branding_AutocompleteElement_Response::Branding_AutocompleteElement_Response(const QString &json) {
...
void Branding_AutocompleteElement_Response::fromJson(const QString &jsonString) {
