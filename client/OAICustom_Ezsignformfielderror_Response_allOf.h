...
/*
 * OAICustom_Ezsignformfielderror_Response_allOf.h
 *
 * 
 */

#ifndef OAICustom_Ezsignformfielderror_Response_allOf_H
#define OAICustom_Ezsignformfielderror_Response_allOf_H
...
class OAICustom_Ezsignformfielderror_Response_allOf : public OAIObject {
public:
    OAICustom_Ezsignformfielderror_Response_allOf();
    OAICustom_Ezsignformfielderror_Response_allOf(QString json);
    ~OAICustom_Ezsignformfielderror_Response_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_Ezsignformfielderror_Response_allOf)

#endif // OAICustom_Ezsignformfielderror_Response_allOf_H
