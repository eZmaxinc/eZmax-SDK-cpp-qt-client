...
Billingentityinternal_ListElement::Billingentityinternal_ListElement(const QString &json) {
...
void Billingentityinternal_ListElement::fromJson(const QString &jsonString) {
