...
/*
 * Userstaged_ListElement.h
 *
 * A Userstaged List Element
 */

#ifndef Userstaged_ListElement_H
#define Userstaged_ListElement_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Userstaged_ListElement)

#endif // Userstaged_ListElement_H
