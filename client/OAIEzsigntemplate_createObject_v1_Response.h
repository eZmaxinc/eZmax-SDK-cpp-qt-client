...
/*
 * OAIEzsigntemplate_createObject_v1_Response.h
 *
 * Response for POST /1/object/ezsigntemplate
 */

#ifndef OAIEzsigntemplate_createObject_v1_Response_H
#define OAIEzsigntemplate_createObject_v1_Response_H
...
class OAIEzsigntemplate_createObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplate_createObject_v1_Response();
    OAIEzsigntemplate_createObject_v1_Response(QString json);
    ~OAIEzsigntemplate_createObject_v1_Response() override;
...
private:
    ...
    OAIEzsigntemplate_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplate_createObject_v1_Response)

#endif // OAIEzsigntemplate_createObject_v1_Response_H
