...
Ezsigntemplatepackagesignermembership_Response::Ezsigntemplatepackagesignermembership_Response(const QString &json) {
...
void Ezsigntemplatepackagesignermembership_Response::fromJson(const QString &jsonString) {
