...
bool Creditcardclient_Response::isBCreditcardclientIsactive() const {
    return m_b_creditcardclient_isactive;
}
void Creditcardclient_Response::setBCreditcardclientIsactive(const bool &b_creditcardclient_isactive) {
    m_b_creditcardclient_isactive = b_creditcardclient_isactive;
    m_b_creditcardclient_isactive_isSet = true;
}

bool Creditcardclient_Response::is_b_creditcardclient_isactive_Set() const{
    return m_b_creditcardclient_isactive_isSet;
}

bool Creditcardclient_Response::is_b_creditcardclient_isactive_Valid() const{
    return m_b_creditcardclient_isactive_isValid;
}

bool Creditcardclient_Response::isBCreditcardclientAllowedagencypayment() const {
    return m_b_creditcardclient_allowedagencypayment;
}
void Creditcardclient_Response::setBCreditcardclientAllowedagencypayment(const bool &b_creditcardclient_allowedagencypayment) {
...
bool Creditcardclient_Response::is_b_creditcardclient_allowedagencypayment_Set() const{
    return m_b_creditcardclient_allowedagencypayment_isSet;
}

bool Creditcardclient_Response::is_b_creditcardclient_allowedagencypayment_Valid() const{
    return m_b_creditcardclient_allowedagencypayment_isValid;
}

bool Creditcardclient_Response::isBCreditcardclientAllowedroyallepageprotection() const {
    return m_b_creditcardclient_allowedroyallepageprotection;
}
void Creditcardclient_Response::setBCreditcardclientAllowedroyallepageprotection(const bool &b_creditcardclient_allowedroyallepageprotection) {
...
bool Creditcardclient_Response::is_b_creditcardclient_allowedroyallepageprotection_Set() const{
    return m_b_creditcardclient_allowedroyallepageprotection_isSet;
}

bool Creditcardclient_Response::is_b_creditcardclient_allowedroyallepageprotection_Valid() const{
