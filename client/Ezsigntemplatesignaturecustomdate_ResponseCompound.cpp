...
Ezsigntemplatesignaturecustomdate_ResponseCompound::Ezsigntemplatesignaturecustomdate_ResponseCompound(const QString &json) {
...
void Ezsigntemplatesignaturecustomdate_ResponseCompound::fromJson(const QString &jsonString) {
...
qint32 Ezsigntemplatesignaturecustomdate_ResponseCompound::getIEzsigntemplatesignaturecustomdateOffsetx() const {
    return m_i_ezsigntemplatesignaturecustomdate_offsetx;
}
void Ezsigntemplatesignaturecustomdate_ResponseCompound::setIEzsigntemplatesignaturecustomdateOffsetx(const qint32 &i_ezsigntemplatesignaturecustomdate_offsetx) {
...
bool Ezsigntemplatesignaturecustomdate_ResponseCompound::is_i_ezsigntemplatesignaturecustomdate_offsetx_Set() const{
    return m_i_ezsigntemplatesignaturecustomdate_offsetx_isSet;
}

bool Ezsigntemplatesignaturecustomdate_ResponseCompound::is_i_ezsigntemplatesignaturecustomdate_offsetx_Valid() const{
    return m_i_ezsigntemplatesignaturecustomdate_offsetx_isValid;
}

qint32 Ezsigntemplatesignaturecustomdate_ResponseCompound::getIEzsigntemplatesignaturecustomdateOffsety() const {
    return m_i_ezsigntemplatesignaturecustomdate_offsety;
}
void Ezsigntemplatesignaturecustomdate_ResponseCompound::setIEzsigntemplatesignaturecustomdateOffsety(const qint32 &i_ezsigntemplatesignaturecustomdate_offsety) {
...
bool Ezsigntemplatesignaturecustomdate_ResponseCompound::is_i_ezsigntemplatesignaturecustomdate_offsety_Set() const{
    return m_i_ezsigntemplatesignaturecustomdate_offsety_isSet;
}

bool Ezsigntemplatesignaturecustomdate_ResponseCompound::is_i_ezsigntemplatesignaturecustomdate_offsety_Valid() const{
