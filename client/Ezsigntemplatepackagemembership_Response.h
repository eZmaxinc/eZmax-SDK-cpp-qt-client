...
#ifndef Ezsigntemplatepackagemembership_Response_H
#define Ezsigntemplatepackagemembership_Response_H
...
class Ezsigntemplatepackagemembership_Response : public Object {
public:
    Ezsigntemplatepackagemembership_Response();
    Ezsigntemplatepackagemembership_Response(const QString &json);
    ~Ezsigntemplatepackagemembership_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagemembership_Response)

#endif // Ezsigntemplatepackagemembership_Response_H
