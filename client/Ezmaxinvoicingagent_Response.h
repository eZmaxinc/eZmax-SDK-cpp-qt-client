...
#ifndef Ezmaxinvoicingagent_Response_H
#define Ezmaxinvoicingagent_Response_H
...
class Ezmaxinvoicingagent_Response : public Object {
public:
    Ezmaxinvoicingagent_Response();
    Ezmaxinvoicingagent_Response(const QString &json);
    ~Ezmaxinvoicingagent_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxinvoicingagent_Response)

#endif // Ezmaxinvoicingagent_Response_H
