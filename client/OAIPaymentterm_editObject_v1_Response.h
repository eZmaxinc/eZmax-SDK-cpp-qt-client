...
/*
 * OAIPaymentterm_editObject_v1_Response.h
 *
 * Response for PUT /1/object/paymentterm/{pkiPaymenttermID}
 */

#ifndef OAIPaymentterm_editObject_v1_Response_H
#define OAIPaymentterm_editObject_v1_Response_H
...
class OAIPaymentterm_editObject_v1_Response : public OAIObject {
public:
    OAIPaymentterm_editObject_v1_Response();
    OAIPaymentterm_editObject_v1_Response(QString json);
    ~OAIPaymentterm_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPaymentterm_editObject_v1_Response)

#endif // OAIPaymentterm_editObject_v1_Response_H
