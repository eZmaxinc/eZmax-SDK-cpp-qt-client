...
Custom_Ezsignformfieldgroup_Request::Custom_Ezsignformfieldgroup_Request(const QString &json) {
...
void Custom_Ezsignformfieldgroup_Request::fromJson(const QString &jsonString) {
