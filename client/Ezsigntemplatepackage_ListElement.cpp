...
Ezsigntemplatepackage_ListElement::Ezsigntemplatepackage_ListElement(const QString &json) {
...
void Ezsigntemplatepackage_ListElement::fromJson(const QString &jsonString) {
