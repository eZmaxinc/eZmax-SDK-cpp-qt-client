...
/*
 * Creditcardclient_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/creditcardclient/{pkiCreditcardclientID}
 */

#ifndef Creditcardclient_patchObject_v1_Response_H
#define Creditcardclient_patchObject_v1_Response_H
...
class Creditcardclient_patchObject_v1_Response : public Object {
public:
    Creditcardclient_patchObject_v1_Response();
    Creditcardclient_patchObject_v1_Response(const QString &json);
    ~Creditcardclient_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardclient_patchObject_v1_Response)

#endif // Creditcardclient_patchObject_v1_Response_H
