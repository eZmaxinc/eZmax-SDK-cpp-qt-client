...
/*
 * OAIEzsignfolder_getCommunicationList_v1_Response.h
 *
 * Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationList
 */

#ifndef OAIEzsignfolder_getCommunicationList_v1_Response_H
#define OAIEzsignfolder_getCommunicationList_v1_Response_H
...
class OAIEzsignfolder_getCommunicationList_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_getCommunicationList_v1_Response();
    OAIEzsignfolder_getCommunicationList_v1_Response(QString json);
    ~OAIEzsignfolder_getCommunicationList_v1_Response() override;
...
private:
    ...
    OAIEzsignfolder_getCommunicationList_v1_Response_mPayload m_m_payload;
