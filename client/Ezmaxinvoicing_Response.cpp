...
Ezmaxinvoicing_Response::Ezmaxinvoicing_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezmaxinvoicing_Response::Ezmaxinvoicing_Response() {
    this->initializeModel();
}

Ezmaxinvoicing_Response::~Ezmaxinvoicing_Response() {}

void Ezmaxinvoicing_Response::initializeModel() {
...
void Ezmaxinvoicing_Response::fromJson(const QString &jsonString) {
...
void Ezmaxinvoicing_Response::fromJsonObject(QJsonObject json) {
...
QString Ezmaxinvoicing_Response::asJson() const {
...
QJsonObject Ezmaxinvoicing_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezmaxinvoicing_Response::getPkiEzmaxinvoicingId() const {
    return m_pki_ezmaxinvoicing_id;
}
void Ezmaxinvoicing_Response::setPkiEzmaxinvoicingId(const qint32 &pki_ezmaxinvoicing_id) {
    m_pki_ezmaxinvoicing_id = pki_ezmaxinvoicing_id;
    m_pki_ezmaxinvoicing_id_isSet = true;
}

bool Ezmaxinvoicing_Response::is_pki_ezmaxinvoicing_id_Set() const{
    return m_pki_ezmaxinvoicing_id_isSet;
}

bool Ezmaxinvoicing_Response::is_pki_ezmaxinvoicing_id_Valid() const{
    return m_pki_ezmaxinvoicing_id_isValid;
}

qint32 Ezmaxinvoicing_Response::getFkiEzmaxinvoicingcontractId() const {
    return m_fki_ezmaxinvoicingcontract_id;
}
void Ezmaxinvoicing_Response::setFkiEzmaxinvoicingcontractId(const qint32 &fki_ezmaxinvoicingcontract_id) {
    m_fki_ezmaxinvoicingcontract_id = fki_ezmaxinvoicingcontract_id;
    m_fki_ezmaxinvoicingcontract_id_isSet = true;
}

bool Ezmaxinvoicing_Response::is_fki_ezmaxinvoicingcontract_id_Set() const{
    return m_fki_ezmaxinvoicingcontract_id_isSet;
}

bool Ezmaxinvoicing_Response::is_fki_ezmaxinvoicingcontract_id_Valid() const{
    return m_fki_ezmaxinvoicingcontract_id_isValid;
}

qint32 Ezmaxinvoicing_Response::getFkiEzmaxpricingId() const {
    return m_fki_ezmaxpricing_id;
}
void Ezmaxinvoicing_Response::setFkiEzmaxpricingId(const qint32 &fki_ezmaxpricing_id) {
    m_fki_ezmaxpricing_id = fki_ezmaxpricing_id;
    m_fki_ezmaxpricing_id_isSet = true;
}

bool Ezmaxinvoicing_Response::is_fki_ezmaxpricing_id_Set() const{
    return m_fki_ezmaxpricing_id_isSet;
}

bool Ezmaxinvoicing_Response::is_fki_ezmaxpricing_id_Valid() const{
    return m_fki_ezmaxpricing_id_isValid;
}

qint32 Ezmaxinvoicing_Response::getFkiSystemconfigurationtypeId() const {
    return m_fki_systemconfigurationtype_id;
}
void Ezmaxinvoicing_Response::setFkiSystemconfigurationtypeId(const qint32 &fki_systemconfigurationtype_id) {
    m_fki_systemconfigurationtype_id = fki_systemconfigurationtype_id;
    m_fki_systemconfigurationtype_id_isSet = true;
}

bool Ezmaxinvoicing_Response::is_fki_systemconfigurationtype_id_Set() const{
    return m_fki_systemconfigurationtype_id_isSet;
}

bool Ezmaxinvoicing_Response::is_fki_systemconfigurationtype_id_Valid() const{
    return m_fki_systemconfigurationtype_id_isValid;
}

QString Ezmaxinvoicing_Response::getSSystemconfigurationtypeDescriptionX() const {
    return m_s_systemconfigurationtype_description_x;
}
void Ezmaxinvoicing_Response::setSSystemconfigurationtypeDescriptionX(const QString &s_systemconfigurationtype_description_x) {
...
bool Ezmaxinvoicing_Response::is_s_systemconfigurationtype_description_x_Set() const{
    return m_s_systemconfigurationtype_description_x_isSet;
}

bool Ezmaxinvoicing_Response::is_s_systemconfigurationtype_description_x_Valid() const{
    return m_s_systemconfigurationtype_description_x_isValid;
}

QString Ezmaxinvoicing_Response::getYyyymmEzmaxinvoicing() const {
    return m_yyyymm_ezmaxinvoicing;
}
void Ezmaxinvoicing_Response::setYyyymmEzmaxinvoicing(const QString &yyyymm_ezmaxinvoicing) {
    m_yyyymm_ezmaxinvoicing = yyyymm_ezmaxinvoicing;
    m_yyyymm_ezmaxinvoicing_isSet = true;
}

bool Ezmaxinvoicing_Response::is_yyyymm_ezmaxinvoicing_Set() const{
    return m_yyyymm_ezmaxinvoicing_isSet;
}

bool Ezmaxinvoicing_Response::is_yyyymm_ezmaxinvoicing_Valid() const{
    return m_yyyymm_ezmaxinvoicing_isValid;
}

qint32 Ezmaxinvoicing_Response::getIEzmaxinvoicingDays() const {
    return m_i_ezmaxinvoicing_days;
}
void Ezmaxinvoicing_Response::setIEzmaxinvoicingDays(const qint32 &i_ezmaxinvoicing_days) {
    m_i_ezmaxinvoicing_days = i_ezmaxinvoicing_days;
    m_i_ezmaxinvoicing_days_isSet = true;
}

bool Ezmaxinvoicing_Response::is_i_ezmaxinvoicing_days_Set() const{
    return m_i_ezmaxinvoicing_days_isSet;
}

bool Ezmaxinvoicing_Response::is_i_ezmaxinvoicing_days_Valid() const{
    return m_i_ezmaxinvoicing_days_isValid;
}

Field_eEzmaxinvoicingPaymenttype Ezmaxinvoicing_Response::getEEzmaxinvoicingPaymenttype() const {
    return m_e_ezmaxinvoicing_paymenttype;
}
void Ezmaxinvoicing_Response::setEEzmaxinvoicingPaymenttype(const Field_eEzmaxinvoicingPaymenttype &e_ezmaxinvoicing_paymenttype) {
    m_e_ezmaxinvoicing_paymenttype = e_ezmaxinvoicing_paymenttype;
    m_e_ezmaxinvoicing_paymenttype_isSet = true;
}

bool Ezmaxinvoicing_Response::is_e_ezmaxinvoicing_paymenttype_Set() const{
    return m_e_ezmaxinvoicing_paymenttype_isSet;
}

bool Ezmaxinvoicing_Response::is_e_ezmaxinvoicing_paymenttype_Valid() const{
    return m_e_ezmaxinvoicing_paymenttype_isValid;
}

QString Ezmaxinvoicing_Response::getDEzmaxinvoicingRebatepaymenttype() const {
    return m_d_ezmaxinvoicing_rebatepaymenttype;
}
void Ezmaxinvoicing_Response::setDEzmaxinvoicingRebatepaymenttype(const QString &d_ezmaxinvoicing_rebatepaymenttype) {
    m_d_ezmaxinvoicing_rebatepaymenttype = d_ezmaxinvoicing_rebatepaymenttype;
    m_d_ezmaxinvoicing_rebatepaymenttype_isSet = true;
}

bool Ezmaxinvoicing_Response::is_d_ezmaxinvoicing_rebatepaymenttype_Set() const{
    return m_d_ezmaxinvoicing_rebatepaymenttype_isSet;
}

bool Ezmaxinvoicing_Response::is_d_ezmaxinvoicing_rebatepaymenttype_Valid() const{
    return m_d_ezmaxinvoicing_rebatepaymenttype_isValid;
}

qint32 Ezmaxinvoicing_Response::getIEzmaxinvoicingContractlength() const {
    return m_i_ezmaxinvoicing_contractlength;
}
void Ezmaxinvoicing_Response::setIEzmaxinvoicingContractlength(const qint32 &i_ezmaxinvoicing_contractlength) {
    m_i_ezmaxinvoicing_contractlength = i_ezmaxinvoicing_contractlength;
    m_i_ezmaxinvoicing_contractlength_isSet = true;
}

bool Ezmaxinvoicing_Response::is_i_ezmaxinvoicing_contractlength_Set() const{
    return m_i_ezmaxinvoicing_contractlength_isSet;
}

bool Ezmaxinvoicing_Response::is_i_ezmaxinvoicing_contractlength_Valid() const{
    return m_i_ezmaxinvoicing_contractlength_isValid;
}

QString Ezmaxinvoicing_Response::getDEzmaxinvoicingRebatecontractlength() const {
    return m_d_ezmaxinvoicing_rebatecontractlength;
}
void Ezmaxinvoicing_Response::setDEzmaxinvoicingRebatecontractlength(const QString &d_ezmaxinvoicing_rebatecontractlength) {
...
bool Ezmaxinvoicing_Response::is_d_ezmaxinvoicing_rebatecontractlength_Set() const{
    return m_d_ezmaxinvoicing_rebatecontractlength_isSet;
}

bool Ezmaxinvoicing_Response::is_d_ezmaxinvoicing_rebatecontractlength_Valid() const{
    return m_d_ezmaxinvoicing_rebatecontractlength_isValid;
}

bool Ezmaxinvoicing_Response::isBEzmaxinvoicingRebateEzsignallagents() const {
    return m_b_ezmaxinvoicing_rebate_ezsignallagents;
}
void Ezmaxinvoicing_Response::setBEzmaxinvoicingRebateEzsignallagents(const bool &b_ezmaxinvoicing_rebate_ezsignallagents) {
...
bool Ezmaxinvoicing_Response::is_b_ezmaxinvoicing_rebate_ezsignallagents_Set() const{
    return m_b_ezmaxinvoicing_rebate_ezsignallagents_isSet;
}

bool Ezmaxinvoicing_Response::is_b_ezmaxinvoicing_rebate_ezsignallagents_Valid() const{
    return m_b_ezmaxinvoicing_rebate_ezsignallagents_isValid;
}

Common_Audit Ezmaxinvoicing_Response::getObjAudit() const {
    return m_obj_audit;
}
void Ezmaxinvoicing_Response::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Ezmaxinvoicing_Response::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Ezmaxinvoicing_Response::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Ezmaxinvoicing_Response::isSet() const {
...
bool Ezmaxinvoicing_Response::isValid() const {
