...
Ezsignannotation_ResponseCompound::Ezsignannotation_ResponseCompound(const QString &json) {
...
void Ezsignannotation_ResponseCompound::fromJson(const QString &jsonString) {
