...
QString OAIEzsignsignature_RequestCompound::getEEzsignsignatureType() const {
    return e_ezsignsignature_type;
}
void OAIEzsignsignature_RequestCompound::setEEzsignsignatureType(const QString &e_ezsignsignature_type) {
