...
_serverConfigs.insert("ezsigndocumentGetObjectGetChildrenV1",defaultConf);
_serverIndices.insert("ezsigndocumentGetObjectGetChildrenV1",0);
...
void OAIObjectEzsigndocumentApi::ezsigndocumentApplyEzsigntemplateV1(const qint32 &pki_ezsigndocument_id, const OAIEzsigndocument_applyEzsigntemplate_v1_Request &oai_ezsigndocument_apply_ezsigntemplate_v1_request) {
    ...
    fullPath.replace(pki_ezsigndocument_idPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(pki_ezsigndocument_id)));
...
void OAIObjectEzsigndocumentApi::ezsigndocumentGetDownloadUrlV1(const qint32 &pki_ezsigndocument_id, const QString &e_document_type) {
    ...
    fullPath.replace(e_document_typePathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(e_document_type)));
...
void OAIObjectEzsigndocumentApi::ezsigndocumentGetObjectGetChildrenV1(const qint32 &pki_ezsigndocument_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetObjectGetChildrenV1"][_serverIndices.value("ezsigndocumentGetObjectGetChildrenV1")].URL()+"/1/object/ezsigndocument/{pkiEzsigndocumentID}/getChildren");
    QString pki_ezsigndocument_idPathParam("{");
    pki_ezsigndocument_idPathParam.append("pkiEzsigndocumentID").append("}");
    fullPath.replace(pki_ezsigndocument_idPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(pki_ezsigndocument_id)));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigndocumentApi::ezsigndocumentGetObjectGetChildrenV1Callback);
    connect(this, &OAIObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater); 
    worker->execute(&input);
}

void OAIObjectEzsigndocumentApi::ezsigndocumentGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit ezsigndocumentGetObjectGetChildrenV1Signal();
        emit ezsigndocumentGetObjectGetChildrenV1SignalFull(worker);
    } else {
        emit ezsigndocumentGetObjectGetChildrenV1SignalE(error_type, error_str);
        emit ezsigndocumentGetObjectGetChildrenV1SignalEFull(worker, error_type, error_str);
    }
}
