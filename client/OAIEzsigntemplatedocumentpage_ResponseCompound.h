...
/*
 * OAIEzsigntemplatedocumentpage_ResponseCompound.h
 *
 * An Ezsigntemplatedocumentpage Object and children to create a complete structure
 */

#ifndef OAIEzsigntemplatedocumentpage_ResponseCompound_H
#define OAIEzsigntemplatedocumentpage_ResponseCompound_H
...
public:
    OAIEzsigntemplatedocumentpage_ResponseCompound();
    OAIEzsigntemplatedocumentpage_ResponseCompound(QString json);
    ~OAIEzsigntemplatedocumentpage_ResponseCompound() override;
