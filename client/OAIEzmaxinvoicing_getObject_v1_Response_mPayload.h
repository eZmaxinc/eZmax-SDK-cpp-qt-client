...
/*
 * OAIEzmaxinvoicing_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}
 */

#ifndef OAIEzmaxinvoicing_getObject_v1_Response_mPayload_H
#define OAIEzmaxinvoicing_getObject_v1_Response_mPayload_H
...
class OAIEzmaxinvoicing_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIEzmaxinvoicing_getObject_v1_Response_mPayload();
    OAIEzmaxinvoicing_getObject_v1_Response_mPayload(QString json);
    ~OAIEzmaxinvoicing_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzmaxinvoicing_getObject_v1_Response_mPayload)

#endif // OAIEzmaxinvoicing_getObject_v1_Response_mPayload_H
