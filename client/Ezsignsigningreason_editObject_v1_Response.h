...
/*
 * Ezsignsigningreason_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignsigningreason/{pkiEzsignsigningreasonID}
 */

#ifndef Ezsignsigningreason_editObject_v1_Response_H
#define Ezsignsigningreason_editObject_v1_Response_H
...
class Ezsignsigningreason_editObject_v1_Response : public Object {
public:
    Ezsignsigningreason_editObject_v1_Response();
    Ezsignsigningreason_editObject_v1_Response(const QString &json);
    ~Ezsignsigningreason_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsigningreason_editObject_v1_Response)

#endif // Ezsignsigningreason_editObject_v1_Response_H
