...
/*
 * Ezsignfolder_send_v2_Response.h
 *
 * Response for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/send
 */

#ifndef Ezsignfolder_send_v2_Response_H
#define Ezsignfolder_send_v2_Response_H
...
class Ezsignfolder_send_v2_Response : public Object {
public:
    Ezsignfolder_send_v2_Response();
    Ezsignfolder_send_v2_Response(QString json);
    ~Ezsignfolder_send_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_send_v2_Response)

#endif // Ezsignfolder_send_v2_Response_H
