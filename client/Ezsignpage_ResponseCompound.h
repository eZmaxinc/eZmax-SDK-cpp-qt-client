...
/*
 * Ezsignpage_ResponseCompound.h
 *
 * An Ezsignpage Object and children to create a complete structure
 */

#ifndef Ezsignpage_ResponseCompound_H
#define Ezsignpage_ResponseCompound_H
...
class Ezsignpage_ResponseCompound : public Object {
public:
    Ezsignpage_ResponseCompound();
    Ezsignpage_ResponseCompound(const QString &json);
    ~Ezsignpage_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignpage_ResponseCompound)

#endif // Ezsignpage_ResponseCompound_H
