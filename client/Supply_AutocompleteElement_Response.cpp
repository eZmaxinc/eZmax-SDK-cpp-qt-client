...
Supply_AutocompleteElement_Response::Supply_AutocompleteElement_Response(const QString &json) {
...
void Supply_AutocompleteElement_Response::fromJson(const QString &jsonString) {
