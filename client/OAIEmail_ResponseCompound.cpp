...
OAIEmail_ResponseCompound::OAIEmail_ResponseCompound(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmail_ResponseCompound::OAIEmail_ResponseCompound() {
    this->initializeModel();
}

OAIEmail_ResponseCompound::~OAIEmail_ResponseCompound() {}

void OAIEmail_ResponseCompound::initializeModel() {
...
void OAIEmail_ResponseCompound::fromJson(QString jsonString) {
...
QString OAIEmail_ResponseCompound::asJson() const {
...
bool OAIEmail_ResponseCompound::is_pki_email_id_Valid() const{
...
bool OAIEmail_ResponseCompound::is_fki_emailtype_id_Valid() const{
...
bool OAIEmail_ResponseCompound::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

bool OAIEmail_ResponseCompound::isSet() const {
...
bool OAIEmail_ResponseCompound::isValid() const {
