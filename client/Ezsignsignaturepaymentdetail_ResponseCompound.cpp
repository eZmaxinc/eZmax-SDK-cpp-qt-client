...
#include "Ezsignsignaturepaymentdetail_ResponseCompound.h"
...
Ezsignsignaturepaymentdetail_ResponseCompound::Ezsignsignaturepaymentdetail_ResponseCompound() {
    this->initializeModel();
}

Ezsignsignaturepaymentdetail_ResponseCompound::~Ezsignsignaturepaymentdetail_ResponseCompound() {}

void Ezsignsignaturepaymentdetail_ResponseCompound::initializeModel() {
...
void Ezsignsignaturepaymentdetail_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignaturepaymentdetail_ResponseCompound::asJson() const {
...
QJsonObject Ezsignsignaturepaymentdetail_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignaturepaymentdetail_ResponseCompound::getPkiEzsignsignaturepaymentdetailId() const {
    return m_pki_ezsignsignaturepaymentdetail_id;
}
void Ezsignsignaturepaymentdetail_ResponseCompound::setPkiEzsignsignaturepaymentdetailId(const qint32 &pki_ezsignsignaturepaymentdetail_id) {
...
bool Ezsignsignaturepaymentdetail_ResponseCompound::is_pki_ezsignsignaturepaymentdetail_id_Set() const{
    return m_pki_ezsignsignaturepaymentdetail_id_isSet;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_pki_ezsignsignaturepaymentdetail_id_Valid() const{
    return m_pki_ezsignsignaturepaymentdetail_id_isValid;
}

qint32 Ezsignsignaturepaymentdetail_ResponseCompound::getFkiGlaccountcontainerId() const {
    return m_fki_glaccountcontainer_id;
}
void Ezsignsignaturepaymentdetail_ResponseCompound::setFkiGlaccountcontainerId(const qint32 &fki_glaccountcontainer_id) {
    m_fki_glaccountcontainer_id = fki_glaccountcontainer_id;
    m_fki_glaccountcontainer_id_isSet = true;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_fki_glaccountcontainer_id_Set() const{
    return m_fki_glaccountcontainer_id_isSet;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_fki_glaccountcontainer_id_Valid() const{
    return m_fki_glaccountcontainer_id_isValid;
}

QString Ezsignsignaturepaymentdetail_ResponseCompound::getTEzsignsignaturepaymentdetailDescription() const {
    return m_t_ezsignsignaturepaymentdetail_description;
}
void Ezsignsignaturepaymentdetail_ResponseCompound::setTEzsignsignaturepaymentdetailDescription(const QString &t_ezsignsignaturepaymentdetail_description) {
...
bool Ezsignsignaturepaymentdetail_ResponseCompound::is_t_ezsignsignaturepaymentdetail_description_Set() const{
    return m_t_ezsignsignaturepaymentdetail_description_isSet;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_t_ezsignsignaturepaymentdetail_description_Valid() const{
    return m_t_ezsignsignaturepaymentdetail_description_isValid;
}

QString Ezsignsignaturepaymentdetail_ResponseCompound::getDEzsignsignaturepaymentdetailAmount() const {
    return m_d_ezsignsignaturepaymentdetail_amount;
}
void Ezsignsignaturepaymentdetail_ResponseCompound::setDEzsignsignaturepaymentdetailAmount(const QString &d_ezsignsignaturepaymentdetail_amount) {
...
bool Ezsignsignaturepaymentdetail_ResponseCompound::is_d_ezsignsignaturepaymentdetail_amount_Set() const{
    return m_d_ezsignsignaturepaymentdetail_amount_isSet;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_d_ezsignsignaturepaymentdetail_amount_Valid() const{
    return m_d_ezsignsignaturepaymentdetail_amount_isValid;
}

Field_eEzsignsignaturepaymentdetailTaxable Ezsignsignaturepaymentdetail_ResponseCompound::getEEzsignsignaturepaymentdetailTaxable() const {
    return m_e_ezsignsignaturepaymentdetail_taxable;
}
void Ezsignsignaturepaymentdetail_ResponseCompound::setEEzsignsignaturepaymentdetailTaxable(const Field_eEzsignsignaturepaymentdetailTaxable &e_ezsignsignaturepaymentdetail_taxable) {
...
bool Ezsignsignaturepaymentdetail_ResponseCompound::is_e_ezsignsignaturepaymentdetail_taxable_Set() const{
    return m_e_ezsignsignaturepaymentdetail_taxable_isSet;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::is_e_ezsignsignaturepaymentdetail_taxable_Valid() const{
    return m_e_ezsignsignaturepaymentdetail_taxable_isValid;
}

bool Ezsignsignaturepaymentdetail_ResponseCompound::isSet() const {
...
bool Ezsignsignaturepaymentdetail_ResponseCompound::isValid() const {
