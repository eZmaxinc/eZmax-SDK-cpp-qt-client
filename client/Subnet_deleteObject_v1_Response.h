...
/*
 * Subnet_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/subnet/{pkiSubnetID}
 */

#ifndef Subnet_deleteObject_v1_Response_H
#define Subnet_deleteObject_v1_Response_H
...
class Subnet_deleteObject_v1_Response : public Object {
public:
    Subnet_deleteObject_v1_Response();
    Subnet_deleteObject_v1_Response(const QString &json);
    ~Subnet_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Subnet_deleteObject_v1_Response)

#endif // Subnet_deleteObject_v1_Response_H
