...
Address_Request::Address_Request(const QString &json) {
...
void Address_Request::fromJson(const QString &jsonString) {
...
QString Address_Request::asJson() const {
...
void Address_Request::setFkiAddresstypeId(const qint32 &fki_addresstype_id) {
    m_fki_addresstype_id = fki_addresstype_id;
    m_fki_addresstype_id_isSet = true;
}

bool Address_Request::is_fki_addresstype_id_Set() const{
    return m_fki_addresstype_id_isSet;
}

bool Address_Request::is_fki_addresstype_id_Valid() const{
    return m_fki_addresstype_id_isValid;
}

QString Address_Request::getSAddressCivic() const {
    return m_s_address_civic;
}
void Address_Request::setSAddressCivic(const QString &s_address_civic) {
    m_s_address_civic = s_address_civic;
    m_s_address_civic_isSet = true;
}

bool Address_Request::is_s_address_civic_Set() const{
    return m_s_address_civic_isSet;
}

bool Address_Request::is_s_address_civic_Valid() const{
    return m_s_address_civic_isValid;
}

QString Address_Request::getSAddressStreet() const {
    return m_s_address_street;
}
void Address_Request::setSAddressStreet(const QString &s_address_street) {
    m_s_address_street = s_address_street;
    m_s_address_street_isSet = true;
}

bool Address_Request::is_s_address_street_Set() const{
    return m_s_address_street_isSet;
}

bool Address_Request::is_s_address_street_Valid() const{
    return m_s_address_street_isValid;
}

QString Address_Request::getSAddressSuite() const {
    return m_s_address_suite;
}
void Address_Request::setSAddressSuite(const QString &s_address_suite) {
    m_s_address_suite = s_address_suite;
    m_s_address_suite_isSet = true;
}

bool Address_Request::is_s_address_suite_Set() const{
    return m_s_address_suite_isSet;
}

bool Address_Request::is_s_address_suite_Valid() const{
    return m_s_address_suite_isValid;
}

QString Address_Request::getSAddressCity() const {
    return m_s_address_city;
}
void Address_Request::setSAddressCity(const QString &s_address_city) {
    m_s_address_city = s_address_city;
    m_s_address_city_isSet = true;
}

bool Address_Request::is_s_address_city_Set() const{
    return m_s_address_city_isSet;
}

bool Address_Request::is_s_address_city_Valid() const{
    return m_s_address_city_isValid;
}

qint32 Address_Request::getFkiProvinceId() const {
    return m_fki_province_id;
}
void Address_Request::setFkiProvinceId(const qint32 &fki_province_id) {
    m_fki_province_id = fki_province_id;
    m_fki_province_id_isSet = true;
}

bool Address_Request::is_fki_province_id_Set() const{
    return m_fki_province_id_isSet;
}

bool Address_Request::is_fki_province_id_Valid() const{
    return m_fki_province_id_isValid;
}

qint32 Address_Request::getFkiCountryId() const {
    return m_fki_country_id;
}
void Address_Request::setFkiCountryId(const qint32 &fki_country_id) {
    m_fki_country_id = fki_country_id;
    m_fki_country_id_isSet = true;
}

bool Address_Request::is_fki_country_id_Set() const{
    return m_fki_country_id_isSet;
}

bool Address_Request::is_fki_country_id_Valid() const{
    return m_fki_country_id_isValid;
}

QString Address_Request::getSAddressZip() const {
    return m_s_address_zip;
}
void Address_Request::setSAddressZip(const QString &s_address_zip) {
    m_s_address_zip = s_address_zip;
    m_s_address_zip_isSet = true;
}

bool Address_Request::is_s_address_zip_Set() const{
    return m_s_address_zip_isSet;
}

bool Address_Request::is_s_address_zip_Valid() const{
    return m_s_address_zip_isValid;
}

QString Address_Request::getFAddressLongitude() const {
    return m_f_address_longitude;
}
void Address_Request::setFAddressLongitude(const QString &f_address_longitude) {
    m_f_address_longitude = f_address_longitude;
    m_f_address_longitude_isSet = true;
}

bool Address_Request::is_f_address_longitude_Set() const{
    return m_f_address_longitude_isSet;
}

bool Address_Request::is_f_address_longitude_Valid() const{
    return m_f_address_longitude_isValid;
}

QString Address_Request::getFAddressLatitude() const {
    return m_f_address_latitude;
}
void Address_Request::setFAddressLatitude(const QString &f_address_latitude) {
    m_f_address_latitude = f_address_latitude;
    m_f_address_latitude_isSet = true;
}

bool Address_Request::is_f_address_latitude_Set() const{
    return m_f_address_latitude_isSet;
}

bool Address_Request::is_f_address_latitude_Valid() const{
