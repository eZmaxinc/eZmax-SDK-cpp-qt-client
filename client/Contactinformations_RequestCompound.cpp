...
Contactinformations_RequestCompound::Contactinformations_RequestCompound(const QString &json) {
...
void Contactinformations_RequestCompound::fromJson(const QString &jsonString) {
