...
/*
 * Commissionadvance_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/commissionadvance/{pkiCommissionadvanceID}/getAttachments
 */

#ifndef Commissionadvance_getAttachments_v1_Response_mPayload_H
#define Commissionadvance_getAttachments_v1_Response_mPayload_H
...
class Commissionadvance_getAttachments_v1_Response_mPayload : public Object {
public:
    Commissionadvance_getAttachments_v1_Response_mPayload();
    Commissionadvance_getAttachments_v1_Response_mPayload(const QString &json);
    ~Commissionadvance_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Commissionadvance_getAttachments_v1_Response_mPayload)

#endif // Commissionadvance_getAttachments_v1_Response_mPayload_H
