...
#ifndef Usergroupdelegation_Request_H
#define Usergroupdelegation_Request_H
...
class Usergroupdelegation_Request : public Object {
public:
    Usergroupdelegation_Request();
    Usergroupdelegation_Request(const QString &json);
    ~Usergroupdelegation_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupdelegation_Request)

#endif // Usergroupdelegation_Request_H
