...
/*
 * Ezsigndocument_declineToSign_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/declineToSign
 */

#ifndef Ezsigndocument_declineToSign_v1_Response_H
#define Ezsigndocument_declineToSign_v1_Response_H
...
class Ezsigndocument_declineToSign_v1_Response : public Object {
public:
    Ezsigndocument_declineToSign_v1_Response();
    Ezsigndocument_declineToSign_v1_Response(const QString &json);
    ~Ezsigndocument_declineToSign_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_declineToSign_v1_Response)

#endif // Ezsigndocument_declineToSign_v1_Response_H
