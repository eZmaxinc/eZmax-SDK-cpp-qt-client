...
#ifndef Ezsignsignergroupmembership_Request_H
#define Ezsignsignergroupmembership_Request_H
...
class Ezsignsignergroupmembership_Request : public Object {
public:
    Ezsignsignergroupmembership_Request();
    Ezsignsignergroupmembership_Request(const QString &json);
    ~Ezsignsignergroupmembership_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignergroupmembership_Request)

#endif // Ezsignsignergroupmembership_Request_H
