...
/*
 * OAIPermission_createObject_v1_Request.h
 *
 * Request for POST /1/object/permission
 */

#ifndef OAIPermission_createObject_v1_Request_H
#define OAIPermission_createObject_v1_Request_H
...
class OAIPermission_createObject_v1_Request : public OAIObject {
public:
    OAIPermission_createObject_v1_Request();
    OAIPermission_createObject_v1_Request(QString json);
    ~OAIPermission_createObject_v1_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPermission_createObject_v1_Request)

#endif // OAIPermission_createObject_v1_Request_H
