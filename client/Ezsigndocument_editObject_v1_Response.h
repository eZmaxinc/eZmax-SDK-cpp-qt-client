...
/*
 * Ezsigndocument_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef Ezsigndocument_editObject_v1_Response_H
#define Ezsigndocument_editObject_v1_Response_H
...
class Ezsigndocument_editObject_v1_Response : public Object {
public:
    Ezsigndocument_editObject_v1_Response();
    Ezsigndocument_editObject_v1_Response(const QString &json);
    ~Ezsigndocument_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_editObject_v1_Response)

#endif // Ezsigndocument_editObject_v1_Response_H
