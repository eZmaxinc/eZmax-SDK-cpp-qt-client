...
/*
 * Textstylestatic_RequestCompound.h
 *
 * A Textstylestatic Object and children
 */

#ifndef Textstylestatic_RequestCompound_H
#define Textstylestatic_RequestCompound_H
...
class Textstylestatic_RequestCompound : public Object {
public:
    Textstylestatic_RequestCompound();
    Textstylestatic_RequestCompound(const QString &json);
    ~Textstylestatic_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Textstylestatic_RequestCompound)

#endif // Textstylestatic_RequestCompound_H
