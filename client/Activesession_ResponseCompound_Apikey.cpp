...
Activesession_ResponseCompound_Apikey::Activesession_ResponseCompound_Apikey(const QString &json) {
...
void Activesession_ResponseCompound_Apikey::fromJson(const QString &jsonString) {
