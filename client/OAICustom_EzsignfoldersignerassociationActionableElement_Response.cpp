...
bool OAICustom_EzsignfoldersignerassociationActionableElement_Response::isValid() const {
    ...
    return m_pki_ezsignfoldersignerassociation_id_isValid && m_fki_ezsignfolder_id_isValid && m_b_ezsignfoldersignerassociation_receivecopy_isValid && m_t_ezsignfoldersignerassociation_message_isValid && m_b_ezsignfoldersignerassociation_hasactionableelements_current_isValid && true;
}
