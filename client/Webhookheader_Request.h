...
#ifndef Webhookheader_Request_H
#define Webhookheader_Request_H
...
class Webhookheader_Request : public Object {
public:
    Webhookheader_Request();
    Webhookheader_Request(const QString &json);
    ~Webhookheader_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhookheader_Request)

#endif // Webhookheader_Request_H
