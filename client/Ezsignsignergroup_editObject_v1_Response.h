...
/*
 * Ezsignsignergroup_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}
 */

#ifndef Ezsignsignergroup_editObject_v1_Response_H
#define Ezsignsignergroup_editObject_v1_Response_H
...
class Ezsignsignergroup_editObject_v1_Response : public Object {
public:
    Ezsignsignergroup_editObject_v1_Response();
    Ezsignsignergroup_editObject_v1_Response(const QString &json);
    ~Ezsignsignergroup_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignergroup_editObject_v1_Response)

#endif // Ezsignsignergroup_editObject_v1_Response_H
