...
#include "ObjectClonehistoryApi.h"
...
ObjectClonehistoryApi::ObjectClonehistoryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectClonehistoryApi::~ObjectClonehistoryApi() {
}

void ObjectClonehistoryApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectClonehistoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectClonehistoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectClonehistoryApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectClonehistoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectClonehistoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectClonehistoryApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectClonehistoryApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectClonehistoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectClonehistoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectClonehistoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectClonehistoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectClonehistoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectClonehistoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectClonehistoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectClonehistoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectClonehistoryApi::enableResponseCompression() {
...
QString ObjectClonehistoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectClonehistoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectClonehistoryApi::clonehistoryGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectClonehistoryApi::clonehistoryGetListV1Callback);
...
void ObjectClonehistoryApi::clonehistoryGetListV1Callback(HttpRequestWorker *worker) {
    ...
    Clonehistory_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectClonehistoryApi::tokenAvailable() {
