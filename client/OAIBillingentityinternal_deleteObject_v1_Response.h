...
/*
 * OAIBillingentityinternal_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/billingentityinternal/{pkiBillingentityinternalID}
 */

#ifndef OAIBillingentityinternal_deleteObject_v1_Response_H
#define OAIBillingentityinternal_deleteObject_v1_Response_H
...
class OAIBillingentityinternal_deleteObject_v1_Response : public OAIObject {
public:
    OAIBillingentityinternal_deleteObject_v1_Response();
    OAIBillingentityinternal_deleteObject_v1_Response(QString json);
    ~OAIBillingentityinternal_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBillingentityinternal_deleteObject_v1_Response)

#endif // OAIBillingentityinternal_deleteObject_v1_Response_H
