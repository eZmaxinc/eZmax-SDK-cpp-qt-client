...
Domain_getList_v1_Response::Domain_getList_v1_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Domain_getList_v1_Response::Domain_getList_v1_Response() {
    this->initializeModel();
}

Domain_getList_v1_Response::~Domain_getList_v1_Response() {}

void Domain_getList_v1_Response::initializeModel() {
...
void Domain_getList_v1_Response::fromJson(const QString &jsonString) {
...
void Domain_getList_v1_Response::fromJsonObject(QJsonObject json) {
...
QString Domain_getList_v1_Response::asJson() const {
...
QJsonObject Domain_getList_v1_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload_getList Domain_getList_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Domain_getList_v1_Response::setObjDebugPayload(const Common_Response_objDebugPayload_getList &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Domain_getList_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Domain_getList_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Domain_getList_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void Domain_getList_v1_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Domain_getList_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Domain_getList_v1_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

Domain_getList_v1_Response_mPayload Domain_getList_v1_Response::getMPayload() const {
    return m_m_payload;
}
void Domain_getList_v1_Response::setMPayload(const Domain_getList_v1_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Domain_getList_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Domain_getList_v1_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Domain_getList_v1_Response::isSet() const {
...
bool Domain_getList_v1_Response::isValid() const {
