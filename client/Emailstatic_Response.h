...
#ifndef Emailstatic_Response_H
#define Emailstatic_Response_H
...
class Emailstatic_Response : public Object {
public:
    Emailstatic_Response();
    Emailstatic_Response(QString json);
    ~Emailstatic_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Emailstatic_Response)

#endif // Emailstatic_Response_H
