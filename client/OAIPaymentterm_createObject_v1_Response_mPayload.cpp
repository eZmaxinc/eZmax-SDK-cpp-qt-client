...
OAIPaymentterm_createObject_v1_Response_mPayload::OAIPaymentterm_createObject_v1_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentterm_createObject_v1_Response_mPayload::OAIPaymentterm_createObject_v1_Response_mPayload() {
    this->initializeModel();
}

OAIPaymentterm_createObject_v1_Response_mPayload::~OAIPaymentterm_createObject_v1_Response_mPayload() {}

void OAIPaymentterm_createObject_v1_Response_mPayload::initializeModel() {

    m_a_pki_paymentterm_id_isSet = false;
    m_a_pki_paymentterm_id_isValid = false;
}

void OAIPaymentterm_createObject_v1_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIPaymentterm_createObject_v1_Response_mPayload::asJson() const {
...
bool OAIPaymentterm_createObject_v1_Response_mPayload::is_a_pki_paymentterm_id_Valid() const{
...
bool OAIPaymentterm_createObject_v1_Response_mPayload::isValid() const {
