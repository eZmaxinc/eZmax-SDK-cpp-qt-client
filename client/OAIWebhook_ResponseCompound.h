...
/*
 * OAIWebhook_ResponseCompound.h
 *
 * A Webhook Object
 */

#ifndef OAIWebhook_ResponseCompound_H
#define OAIWebhook_ResponseCompound_H
...
public:
    OAIWebhook_ResponseCompound();
    OAIWebhook_ResponseCompound(QString json);
    ~OAIWebhook_ResponseCompound() override;
