...
Usergroupexternalmembership_Response::Usergroupexternalmembership_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Usergroupexternalmembership_Response::Usergroupexternalmembership_Response() {
    this->initializeModel();
}

Usergroupexternalmembership_Response::~Usergroupexternalmembership_Response() {}

void Usergroupexternalmembership_Response::initializeModel() {
...
void Usergroupexternalmembership_Response::fromJson(const QString &jsonString) {
...
void Usergroupexternalmembership_Response::fromJsonObject(QJsonObject json) {
...
QString Usergroupexternalmembership_Response::asJson() const {
...
QJsonObject Usergroupexternalmembership_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Usergroupexternalmembership_Response::getPkiUsergroupexternalmembershipId() const {
    return m_pki_usergroupexternalmembership_id;
}
void Usergroupexternalmembership_Response::setPkiUsergroupexternalmembershipId(const qint32 &pki_usergroupexternalmembership_id) {
    m_pki_usergroupexternalmembership_id = pki_usergroupexternalmembership_id;
    m_pki_usergroupexternalmembership_id_isSet = true;
}

bool Usergroupexternalmembership_Response::is_pki_usergroupexternalmembership_id_Set() const{
    return m_pki_usergroupexternalmembership_id_isSet;
}

bool Usergroupexternalmembership_Response::is_pki_usergroupexternalmembership_id_Valid() const{
    return m_pki_usergroupexternalmembership_id_isValid;
}

qint32 Usergroupexternalmembership_Response::getFkiUsergroupexternalId() const {
    return m_fki_usergroupexternal_id;
}
void Usergroupexternalmembership_Response::setFkiUsergroupexternalId(const qint32 &fki_usergroupexternal_id) {
    m_fki_usergroupexternal_id = fki_usergroupexternal_id;
    m_fki_usergroupexternal_id_isSet = true;
}

bool Usergroupexternalmembership_Response::is_fki_usergroupexternal_id_Set() const{
    return m_fki_usergroupexternal_id_isSet;
}

bool Usergroupexternalmembership_Response::is_fki_usergroupexternal_id_Valid() const{
    return m_fki_usergroupexternal_id_isValid;
}

qint32 Usergroupexternalmembership_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Usergroupexternalmembership_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Usergroupexternalmembership_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Usergroupexternalmembership_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

QString Usergroupexternalmembership_Response::getSUserFirstname() const {
    return m_s_user_firstname;
}
void Usergroupexternalmembership_Response::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool Usergroupexternalmembership_Response::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool Usergroupexternalmembership_Response::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString Usergroupexternalmembership_Response::getSUserLastname() const {
    return m_s_user_lastname;
}
void Usergroupexternalmembership_Response::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool Usergroupexternalmembership_Response::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool Usergroupexternalmembership_Response::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString Usergroupexternalmembership_Response::getSUserLoginname() const {
    return m_s_user_loginname;
}
void Usergroupexternalmembership_Response::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool Usergroupexternalmembership_Response::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool Usergroupexternalmembership_Response::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString Usergroupexternalmembership_Response::getSEmailAddress() const {
    return m_s_email_address;
}
void Usergroupexternalmembership_Response::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Usergroupexternalmembership_Response::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Usergroupexternalmembership_Response::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

QString Usergroupexternalmembership_Response::getSUsergroupexternalName() const {
    return m_s_usergroupexternal_name;
}
void Usergroupexternalmembership_Response::setSUsergroupexternalName(const QString &s_usergroupexternal_name) {
    m_s_usergroupexternal_name = s_usergroupexternal_name;
    m_s_usergroupexternal_name_isSet = true;
}

bool Usergroupexternalmembership_Response::is_s_usergroupexternal_name_Set() const{
    return m_s_usergroupexternal_name_isSet;
}

bool Usergroupexternalmembership_Response::is_s_usergroupexternal_name_Valid() const{
    return m_s_usergroupexternal_name_isValid;
}

bool Usergroupexternalmembership_Response::isSet() const {
...
bool Usergroupexternalmembership_Response::isValid() const {
