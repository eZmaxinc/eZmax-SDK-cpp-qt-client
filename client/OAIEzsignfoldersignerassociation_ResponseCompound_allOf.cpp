...
OAIEzsignsignergroup_ResponseCompound OAIEzsignfoldersignerassociation_ResponseCompound_allOf::getObjEzsignsignergroup() const {
    return obj_ezsignsignergroup;
}
void OAIEzsignfoldersignerassociation_ResponseCompound_allOf::setObjEzsignsignergroup(const OAIEzsignsignergroup_ResponseCompound &obj_ezsignsignergroup) {
    this->obj_ezsignsignergroup = obj_ezsignsignergroup;
    this->m_obj_ezsignsignergroup_isSet = true;
}

bool OAIEzsignfoldersignerassociation_ResponseCompound_allOf::is_obj_ezsignsignergroup_Set() const{
    return m_obj_ezsignsignergroup_isSet;
}

bool OAIEzsignfoldersignerassociation_ResponseCompound_allOf::is_obj_ezsignsignergroup_Valid() const{
...
OAIUsergroup_ResponseCompound OAIEzsignfoldersignerassociation_ResponseCompound_allOf::getObjUsergroup() const {
    return obj_usergroup;
}
void OAIEzsignfoldersignerassociation_ResponseCompound_allOf::setObjUsergroup(const OAIUsergroup_ResponseCompound &obj_usergroup) {
    this->obj_usergroup = obj_usergroup;
    this->m_obj_usergroup_isSet = true;
}

bool OAIEzsignfoldersignerassociation_ResponseCompound_allOf::is_obj_usergroup_Set() const{
    return m_obj_usergroup_isSet;
}

bool OAIEzsignfoldersignerassociation_ResponseCompound_allOf::is_obj_usergroup_Valid() const{
