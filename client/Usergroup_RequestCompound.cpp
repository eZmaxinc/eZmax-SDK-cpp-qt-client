...
Usergroup_RequestCompound::Usergroup_RequestCompound(const QString &json) {
...
void Usergroup_RequestCompound::fromJson(const QString &jsonString) {
...
Email_Request Usergroup_RequestCompound::getObjEmail() const {
    return m_obj_email;
}
void Usergroup_RequestCompound::setObjEmail(const Email_Request &obj_email) {
    m_obj_email = obj_email;
    m_obj_email_isSet = true;
}

bool Usergroup_RequestCompound::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool Usergroup_RequestCompound::is_obj_email_Valid() const{
