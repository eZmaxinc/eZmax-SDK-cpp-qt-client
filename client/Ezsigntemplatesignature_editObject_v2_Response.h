...
/*
 * Ezsigntemplatesignature_editObject_v2_Response.h
 *
 * Response for PUT /2/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef Ezsigntemplatesignature_editObject_v2_Response_H
#define Ezsigntemplatesignature_editObject_v2_Response_H
...
class Ezsigntemplatesignature_editObject_v2_Response : public Object {
public:
    Ezsigntemplatesignature_editObject_v2_Response();
    Ezsigntemplatesignature_editObject_v2_Response(QString json);
    ~Ezsigntemplatesignature_editObject_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_editObject_v2_Response)

#endif // Ezsigntemplatesignature_editObject_v2_Response_H
