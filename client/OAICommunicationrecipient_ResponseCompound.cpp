...
QString OAICommunicationrecipient_ResponseCompound::getSEmailAddress() const {
    return s_email_address;
}
void OAICommunicationrecipient_ResponseCompound::setSEmailAddress(const QString &s_email_address) {
    this->s_email_address = s_email_address;
    this->m_s_email_address_isSet = true;
}

bool OAICommunicationrecipient_ResponseCompound::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool OAICommunicationrecipient_ResponseCompound::is_s_email_address_Valid() const{
...
OAIPhone_ResponseCompound OAICommunicationrecipient_ResponseCompound::getObjPhoneSms() const {
    return obj_phone_sms;
}
void OAICommunicationrecipient_ResponseCompound::setObjPhoneSms(const OAIPhone_ResponseCompound &obj_phone_sms) {
    this->obj_phone_sms = obj_phone_sms;
    this->m_obj_phone_sms_isSet = true;
}

bool OAICommunicationrecipient_ResponseCompound::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool OAICommunicationrecipient_ResponseCompound::is_obj_phone_sms_Valid() const{
