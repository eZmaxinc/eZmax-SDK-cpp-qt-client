...
Period_AutocompleteElement_Response::Period_AutocompleteElement_Response(const QString &json) {
...
void Period_AutocompleteElement_Response::fromJson(const QString &jsonString) {
