...
/*
 * Ezsigntemplatesigner_createObject_v2_Response_mPayload.h
 *
 * Payload for POST /2/object/ezsigntemplatesigner
 */

#ifndef Ezsigntemplatesigner_createObject_v2_Response_mPayload_H
#define Ezsigntemplatesigner_createObject_v2_Response_mPayload_H
...
class Ezsigntemplatesigner_createObject_v2_Response_mPayload : public Object {
public:
    Ezsigntemplatesigner_createObject_v2_Response_mPayload();
    Ezsigntemplatesigner_createObject_v2_Response_mPayload(const QString &json);
    ~Ezsigntemplatesigner_createObject_v2_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesigner_createObject_v2_Response_mPayload)

#endif // Ezsigntemplatesigner_createObject_v2_Response_mPayload_H
