...
/*
 * OAIEzsignfolder_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignfolder/{pkiEzsignfolderID}
 */

#ifndef OAIEzsignfolder_deleteObject_v1_Response_H
#define OAIEzsignfolder_deleteObject_v1_Response_H
...
class OAIEzsignfolder_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_deleteObject_v1_Response();
    OAIEzsignfolder_deleteObject_v1_Response(QString json);
    ~OAIEzsignfolder_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_deleteObject_v1_Response)

#endif // OAIEzsignfolder_deleteObject_v1_Response_H
