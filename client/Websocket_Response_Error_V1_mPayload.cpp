...
Websocket_Response_Error_V1_mPayload::Websocket_Response_Error_V1_mPayload() {
    this->initializeModel();
}

Websocket_Response_Error_V1_mPayload::~Websocket_Response_Error_V1_mPayload() {}

void Websocket_Response_Error_V1_mPayload::initializeModel() {
...
void Websocket_Response_Error_V1_mPayload::fromJsonObject(QJsonObject json) {
...
QString Websocket_Response_Error_V1_mPayload::asJson() const {
...
QJsonObject Websocket_Response_Error_V1_mPayload::asJsonObject() const {
    QJsonObject obj;
...
QString Websocket_Response_Error_V1_mPayload::getSErrorMessage() const {
    return m_s_error_message;
}
void Websocket_Response_Error_V1_mPayload::setSErrorMessage(const QString &s_error_message) {
    m_s_error_message = s_error_message;
    m_s_error_message_isSet = true;
}

bool Websocket_Response_Error_V1_mPayload::is_s_error_message_Set() const{
    return m_s_error_message_isSet;
}

bool Websocket_Response_Error_V1_mPayload::is_s_error_message_Valid() const{
    return m_s_error_message_isValid;
}

Field_eErrorCode Websocket_Response_Error_V1_mPayload::getEErrorCode() const {
    return m_e_error_code;
}
void Websocket_Response_Error_V1_mPayload::setEErrorCode(const Field_eErrorCode &e_error_code) {
    m_e_error_code = e_error_code;
    m_e_error_code_isSet = true;
}

bool Websocket_Response_Error_V1_mPayload::is_e_error_code_Set() const{
    return m_e_error_code_isSet;
}

bool Websocket_Response_Error_V1_mPayload::is_e_error_code_Valid() const{
    return m_e_error_code_isValid;
}

bool Websocket_Response_Error_V1_mPayload::isSet() const {
...
bool Websocket_Response_Error_V1_mPayload::isValid() const {
