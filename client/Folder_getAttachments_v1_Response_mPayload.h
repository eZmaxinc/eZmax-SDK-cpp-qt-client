...
/*
 * Folder_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/folder/{pkiFolderID}/getAttachments
 */

#ifndef Folder_getAttachments_v1_Response_mPayload_H
#define Folder_getAttachments_v1_Response_mPayload_H
...
class Folder_getAttachments_v1_Response_mPayload : public Object {
public:
    Folder_getAttachments_v1_Response_mPayload();
    Folder_getAttachments_v1_Response_mPayload(const QString &json);
    ~Folder_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Folder_getAttachments_v1_Response_mPayload)

#endif // Folder_getAttachments_v1_Response_mPayload_H
