...
Ezsignfolder_createObject_v1_Response_mPayload::Ezsignfolder_createObject_v1_Response_mPayload(const QString &json) {
...
void Ezsignfolder_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
