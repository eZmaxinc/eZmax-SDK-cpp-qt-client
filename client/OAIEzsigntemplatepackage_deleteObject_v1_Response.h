...
/*
 * OAIEzsigntemplatepackage_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}
 */

#ifndef OAIEzsigntemplatepackage_deleteObject_v1_Response_H
#define OAIEzsigntemplatepackage_deleteObject_v1_Response_H
...
class OAIEzsigntemplatepackage_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatepackage_deleteObject_v1_Response();
    OAIEzsigntemplatepackage_deleteObject_v1_Response(QString json);
    ~OAIEzsigntemplatepackage_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackage_deleteObject_v1_Response)

#endif // OAIEzsigntemplatepackage_deleteObject_v1_Response_H
