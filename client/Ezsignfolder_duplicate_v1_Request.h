...
public:
    ...
    bool isBKeepenteredvalues() const;
    void setBKeepenteredvalues(const bool &b_keepenteredvalues);
    bool is_b_keepenteredvalues_Set() const;
    bool is_b_keepenteredvalues_Valid() const;
...
private:
    ...
    bool m_b_keepenteredvalues;
    bool m_b_keepenteredvalues_isSet;
    bool m_b_keepenteredvalues_isValid;
};
