...
/*
 * OAIApikey_createObject_v2_Response.h
 *
 * Response for POST /2/object/apikey
 */

#ifndef OAIApikey_createObject_v2_Response_H
#define OAIApikey_createObject_v2_Response_H
...
class OAIApikey_createObject_v2_Response : public OAIObject {
public:
    OAIApikey_createObject_v2_Response();
    OAIApikey_createObject_v2_Response(QString json);
    ~OAIApikey_createObject_v2_Response() override;
...
private:
    ...
    OAIApikey_createObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIApikey_createObject_v2_Response)

#endif // OAIApikey_createObject_v2_Response_H
