...
Ezsignuser_ResponseCompound::Ezsignuser_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignuser_ResponseCompound::Ezsignuser_ResponseCompound() {
    this->initializeModel();
}

Ezsignuser_ResponseCompound::~Ezsignuser_ResponseCompound() {}

void Ezsignuser_ResponseCompound::initializeModel() {
...
void Ezsignuser_ResponseCompound::fromJson(const QString &jsonString) {
...
void Ezsignuser_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignuser_ResponseCompound::asJson() const {
...
QJsonObject Ezsignuser_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignuser_ResponseCompound::getPkiEzsignuserId() const {
    return m_pki_ezsignuser_id;
}
void Ezsignuser_ResponseCompound::setPkiEzsignuserId(const qint32 &pki_ezsignuser_id) {
    m_pki_ezsignuser_id = pki_ezsignuser_id;
    m_pki_ezsignuser_id_isSet = true;
}

bool Ezsignuser_ResponseCompound::is_pki_ezsignuser_id_Set() const{
    return m_pki_ezsignuser_id_isSet;
}

bool Ezsignuser_ResponseCompound::is_pki_ezsignuser_id_Valid() const{
    return m_pki_ezsignuser_id_isValid;
}

qint32 Ezsignuser_ResponseCompound::getFkiContactId() const {
    return m_fki_contact_id;
}
void Ezsignuser_ResponseCompound::setFkiContactId(const qint32 &fki_contact_id) {
    m_fki_contact_id = fki_contact_id;
    m_fki_contact_id_isSet = true;
}

bool Ezsignuser_ResponseCompound::is_fki_contact_id_Set() const{
    return m_fki_contact_id_isSet;
}

bool Ezsignuser_ResponseCompound::is_fki_contact_id_Valid() const{
    return m_fki_contact_id_isValid;
}

Contact_ResponseCompound Ezsignuser_ResponseCompound::getObjContact() const {
    return m_obj_contact;
}
void Ezsignuser_ResponseCompound::setObjContact(const Contact_ResponseCompound &obj_contact) {
    m_obj_contact = obj_contact;
    m_obj_contact_isSet = true;
}

bool Ezsignuser_ResponseCompound::is_obj_contact_Set() const{
    return m_obj_contact_isSet;
}

bool Ezsignuser_ResponseCompound::is_obj_contact_Valid() const{
    return m_obj_contact_isValid;
}

Common_Audit Ezsignuser_ResponseCompound::getObjAudit() const {
    return m_obj_audit;
}
void Ezsignuser_ResponseCompound::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Ezsignuser_ResponseCompound::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Ezsignuser_ResponseCompound::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Ezsignuser_ResponseCompound::isSet() const {
...
bool Ezsignuser_ResponseCompound::isValid() const {
