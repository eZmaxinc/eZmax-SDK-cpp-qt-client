...
Ezsigndocument_matchingtemplate_v3_Response::Ezsigndocument_matchingtemplate_v3_Response(const QString &json) {
...
void Ezsigndocument_matchingtemplate_v3_Response::fromJson(const QString &jsonString) {
