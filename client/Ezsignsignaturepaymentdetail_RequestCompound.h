...
/*
 * Ezsignsignaturepaymentdetail_RequestCompound.h
 *
 * An Ezsignsignaturepaymentdetail Object and children to create a complete structure
 */

#ifndef Ezsignsignaturepaymentdetail_RequestCompound_H
#define Ezsignsignaturepaymentdetail_RequestCompound_H
...
class Ezsignsignaturepaymentdetail_RequestCompound : public Object {
public:
    Ezsignsignaturepaymentdetail_RequestCompound();
    Ezsignsignaturepaymentdetail_RequestCompound(const QString &json);
    ~Ezsignsignaturepaymentdetail_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturepaymentdetail_RequestCompound)

#endif // Ezsignsignaturepaymentdetail_RequestCompound_H
