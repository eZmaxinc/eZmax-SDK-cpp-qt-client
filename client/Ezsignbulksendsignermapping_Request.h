...
#ifndef Ezsignbulksendsignermapping_Request_H
#define Ezsignbulksendsignermapping_Request_H
...
class Ezsignbulksendsignermapping_Request : public Object {
public:
    Ezsignbulksendsignermapping_Request();
    Ezsignbulksendsignermapping_Request(const QString &json);
    ~Ezsignbulksendsignermapping_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksendsignermapping_Request)

#endif // Ezsignbulksendsignermapping_Request_H
