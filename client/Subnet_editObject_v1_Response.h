...
/*
 * Subnet_editObject_v1_Response.h
 *
 * Response for PUT /1/object/subnet/{pkiSubnetID}
 */

#ifndef Subnet_editObject_v1_Response_H
#define Subnet_editObject_v1_Response_H
...
class Subnet_editObject_v1_Response : public Object {
public:
    Subnet_editObject_v1_Response();
    Subnet_editObject_v1_Response(const QString &json);
    ~Subnet_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Subnet_editObject_v1_Response)

#endif // Subnet_editObject_v1_Response_H
