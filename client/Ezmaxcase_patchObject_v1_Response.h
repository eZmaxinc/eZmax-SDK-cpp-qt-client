...
/*
 * Ezmaxcase_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/creditcardclient/{pkiCreditcardclientID}
 */

#ifndef Ezmaxcase_patchObject_v1_Response_H
#define Ezmaxcase_patchObject_v1_Response_H
...
class Ezmaxcase_patchObject_v1_Response : public Object {
public:
    Ezmaxcase_patchObject_v1_Response();
    Ezmaxcase_patchObject_v1_Response(QString json);
    ~Ezmaxcase_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxcase_patchObject_v1_Response)

#endif // Ezmaxcase_patchObject_v1_Response_H
