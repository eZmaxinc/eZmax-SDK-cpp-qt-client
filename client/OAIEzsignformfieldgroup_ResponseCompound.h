...
private:
    ...
    QList<OAIEzsignformfield_ResponseCompound> m_a_obj_ezsignformfield;
    ...
    QList<OAIEzsignformfieldgroupsigner_ResponseCompound> m_a_obj_ezsignformfieldgroupsigner;
