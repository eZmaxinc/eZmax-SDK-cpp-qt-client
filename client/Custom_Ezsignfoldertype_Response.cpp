...
Field_eEzsignfoldertypeDocumentmerge Custom_Ezsignfoldertype_Response::getEEzsignfoldertypeDocumentmerge() const {
    return m_e_ezsignfoldertype_documentmerge;
}
void Custom_Ezsignfoldertype_Response::setEEzsignfoldertypeDocumentmerge(const Field_eEzsignfoldertypeDocumentmerge &e_ezsignfoldertype_documentmerge) {
    m_e_ezsignfoldertype_documentmerge = e_ezsignfoldertype_documentmerge;
    m_e_ezsignfoldertype_documentmerge_isSet = true;
}

bool Custom_Ezsignfoldertype_Response::is_e_ezsignfoldertype_documentmerge_Set() const{
    return m_e_ezsignfoldertype_documentmerge_isSet;
}

bool Custom_Ezsignfoldertype_Response::is_e_ezsignfoldertype_documentmerge_Valid() const{
