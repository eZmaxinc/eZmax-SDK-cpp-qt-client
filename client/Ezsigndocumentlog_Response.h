...
#ifndef Ezsigndocumentlog_Response_H
#define Ezsigndocumentlog_Response_H
...
class Ezsigndocumentlog_Response : public Object {
public:
    Ezsigndocumentlog_Response();
    Ezsigndocumentlog_Response(const QString &json);
    ~Ezsigndocumentlog_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocumentlog_Response)

#endif // Ezsigndocumentlog_Response_H
