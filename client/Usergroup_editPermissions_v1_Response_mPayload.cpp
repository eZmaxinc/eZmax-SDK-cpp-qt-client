...
Usergroup_editPermissions_v1_Response_mPayload::Usergroup_editPermissions_v1_Response_mPayload(const QString &json) {
...
void Usergroup_editPermissions_v1_Response_mPayload::fromJson(const QString &jsonString) {
