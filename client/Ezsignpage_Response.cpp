...
Ezsignpage_Response::Ezsignpage_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignpage_Response::Ezsignpage_Response() {
    this->initializeModel();
}

Ezsignpage_Response::~Ezsignpage_Response() {}

void Ezsignpage_Response::initializeModel() {
...
void Ezsignpage_Response::fromJson(const QString &jsonString) {
...
void Ezsignpage_Response::fromJsonObject(QJsonObject json) {
...
QString Ezsignpage_Response::asJson() const {
...
QJsonObject Ezsignpage_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignpage_Response::getPkiEzsignpageId() const {
    return m_pki_ezsignpage_id;
}
void Ezsignpage_Response::setPkiEzsignpageId(const qint32 &pki_ezsignpage_id) {
    m_pki_ezsignpage_id = pki_ezsignpage_id;
    m_pki_ezsignpage_id_isSet = true;
}

bool Ezsignpage_Response::is_pki_ezsignpage_id_Set() const{
    return m_pki_ezsignpage_id_isSet;
}

bool Ezsignpage_Response::is_pki_ezsignpage_id_Valid() const{
    return m_pki_ezsignpage_id_isValid;
}

qint32 Ezsignpage_Response::getIEzsignpageWidthimage() const {
    return m_i_ezsignpage_widthimage;
}
void Ezsignpage_Response::setIEzsignpageWidthimage(const qint32 &i_ezsignpage_widthimage) {
    m_i_ezsignpage_widthimage = i_ezsignpage_widthimage;
    m_i_ezsignpage_widthimage_isSet = true;
}

bool Ezsignpage_Response::is_i_ezsignpage_widthimage_Set() const{
    return m_i_ezsignpage_widthimage_isSet;
}

bool Ezsignpage_Response::is_i_ezsignpage_widthimage_Valid() const{
    return m_i_ezsignpage_widthimage_isValid;
}

qint32 Ezsignpage_Response::getIEzsignpageHeightimage() const {
    return m_i_ezsignpage_heightimage;
}
void Ezsignpage_Response::setIEzsignpageHeightimage(const qint32 &i_ezsignpage_heightimage) {
    m_i_ezsignpage_heightimage = i_ezsignpage_heightimage;
    m_i_ezsignpage_heightimage_isSet = true;
}

bool Ezsignpage_Response::is_i_ezsignpage_heightimage_Set() const{
    return m_i_ezsignpage_heightimage_isSet;
}

bool Ezsignpage_Response::is_i_ezsignpage_heightimage_Valid() const{
    return m_i_ezsignpage_heightimage_isValid;
}

qint32 Ezsignpage_Response::getIEzsignpageWidthpdf() const {
    return m_i_ezsignpage_widthpdf;
}
void Ezsignpage_Response::setIEzsignpageWidthpdf(const qint32 &i_ezsignpage_widthpdf) {
    m_i_ezsignpage_widthpdf = i_ezsignpage_widthpdf;
    m_i_ezsignpage_widthpdf_isSet = true;
}

bool Ezsignpage_Response::is_i_ezsignpage_widthpdf_Set() const{
    return m_i_ezsignpage_widthpdf_isSet;
}

bool Ezsignpage_Response::is_i_ezsignpage_widthpdf_Valid() const{
    return m_i_ezsignpage_widthpdf_isValid;
}

qint32 Ezsignpage_Response::getIEzsignpageHeightpdf() const {
    return m_i_ezsignpage_heightpdf;
}
void Ezsignpage_Response::setIEzsignpageHeightpdf(const qint32 &i_ezsignpage_heightpdf) {
    m_i_ezsignpage_heightpdf = i_ezsignpage_heightpdf;
    m_i_ezsignpage_heightpdf_isSet = true;
}

bool Ezsignpage_Response::is_i_ezsignpage_heightpdf_Set() const{
    return m_i_ezsignpage_heightpdf_isSet;
}

bool Ezsignpage_Response::is_i_ezsignpage_heightpdf_Valid() const{
    return m_i_ezsignpage_heightpdf_isValid;
}

qint32 Ezsignpage_Response::getIEzsignpagePagenumber() const {
    return m_i_ezsignpage_pagenumber;
}
void Ezsignpage_Response::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Ezsignpage_Response::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Ezsignpage_Response::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

QString Ezsignpage_Response::getSComputedImageurl() const {
    return m_s_computed_imageurl;
}
void Ezsignpage_Response::setSComputedImageurl(const QString &s_computed_imageurl) {
    m_s_computed_imageurl = s_computed_imageurl;
    m_s_computed_imageurl_isSet = true;
}

bool Ezsignpage_Response::is_s_computed_imageurl_Set() const{
    return m_s_computed_imageurl_isSet;
}

bool Ezsignpage_Response::is_s_computed_imageurl_Valid() const{
    return m_s_computed_imageurl_isValid;
}

bool Ezsignpage_Response::isSet() const {
...
bool Ezsignpage_Response::isValid() const {
