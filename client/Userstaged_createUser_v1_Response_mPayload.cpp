...
Userstaged_createUser_v1_Response_mPayload::Userstaged_createUser_v1_Response_mPayload(const QString &json) {
...
void Userstaged_createUser_v1_Response_mPayload::fromJson(const QString &jsonString) {
