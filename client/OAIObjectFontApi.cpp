...
OAIObjectFontApi::~OAIObjectFontApi() {
}

void OAIObjectFontApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectFontApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectFontApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectFontApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectFontApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectFontApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectFontApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectFontApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectFontApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectFontApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectFontApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectFontApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectFontApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectFontApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectFontApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectFontApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectFontApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectFontApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectFontApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectFontApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectFontApi::fontGetAutocompleteV2(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &e_filter_active, const ::OpenAPI::OptionalParam<QString> &s_query, const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectFontApi::fontGetAutocompleteV2Callback);
    connect(this, &OAIObjectFontApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIObjectFontApi::fontGetAutocompleteV2Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIFont_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectFontApi::tokenAvailable(){
