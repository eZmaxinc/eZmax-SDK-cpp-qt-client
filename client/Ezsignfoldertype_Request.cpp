...
bool Ezsignfoldertype_Request::isBEzsignfoldertypeDiscussion() const {
    return m_b_ezsignfoldertype_discussion;
}
void Ezsignfoldertype_Request::setBEzsignfoldertypeDiscussion(const bool &b_ezsignfoldertype_discussion) {
    m_b_ezsignfoldertype_discussion = b_ezsignfoldertype_discussion;
    m_b_ezsignfoldertype_discussion_isSet = true;
}

bool Ezsignfoldertype_Request::is_b_ezsignfoldertype_discussion_Set() const{
    return m_b_ezsignfoldertype_discussion_isSet;
}

bool Ezsignfoldertype_Request::is_b_ezsignfoldertype_discussion_Valid() const{
