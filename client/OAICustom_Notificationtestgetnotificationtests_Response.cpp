...
bool OAICustom_Notificationtestgetnotificationtests_Response::isValid() const {
    ...
    return m_pki_notificationtest_id_isValid && m_fki_notificationsubsection_id_isValid && m_s_notificationtest_function_isValid && m_s_notificationtest_name_x_isValid && m_e_notificationpreference_status_isValid && m_i_notificationtest_isValid && true;
}
