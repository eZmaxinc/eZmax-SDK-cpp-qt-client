...
/*
 * Supplier_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/supplier/{pkiSupplierID}/getAttachments
 */

#ifndef Supplier_getAttachments_v1_Response_mPayload_H
#define Supplier_getAttachments_v1_Response_mPayload_H
...
class Supplier_getAttachments_v1_Response_mPayload : public Object {
public:
    Supplier_getAttachments_v1_Response_mPayload();
    Supplier_getAttachments_v1_Response_mPayload(const QString &json);
    ~Supplier_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Supplier_getAttachments_v1_Response_mPayload)

#endif // Supplier_getAttachments_v1_Response_mPayload_H
