...
/*
 * OAIDepartment_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/department/getAutocomplete
 */

#ifndef OAIDepartment_getAutocomplete_v2_Response_H
#define OAIDepartment_getAutocomplete_v2_Response_H
...
class OAIDepartment_getAutocomplete_v2_Response : public OAIObject {
public:
    OAIDepartment_getAutocomplete_v2_Response();
    OAIDepartment_getAutocomplete_v2_Response(QString json);
    ~OAIDepartment_getAutocomplete_v2_Response() override;
...
private:
    ...
    OAIDepartment_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIDepartment_getAutocomplete_v2_Response)

#endif // OAIDepartment_getAutocomplete_v2_Response_H
