...
/*
 * OAICustom_Webhooklog_Response_allOf.h
 *
 * 
 */

#ifndef OAICustom_Webhooklog_Response_allOf_H
#define OAICustom_Webhooklog_Response_allOf_H
...
class OAICustom_Webhooklog_Response_allOf : public OAIObject {
public:
    OAICustom_Webhooklog_Response_allOf();
    OAICustom_Webhooklog_Response_allOf(QString json);
    ~OAICustom_Webhooklog_Response_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_Webhooklog_Response_allOf)

#endif // OAICustom_Webhooklog_Response_allOf_H
