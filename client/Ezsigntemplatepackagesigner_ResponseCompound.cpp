...
Ezsigntemplatepackagesigner_ResponseCompound::Ezsigntemplatepackagesigner_ResponseCompound(const QString &json) {
...
void Ezsigntemplatepackagesigner_ResponseCompound::fromJson(const QString &jsonString) {
