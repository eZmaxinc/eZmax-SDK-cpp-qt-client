...
Ezsigntemplateformfieldgroup_RequestCompound::Ezsigntemplateformfieldgroup_RequestCompound(const QString &json) {
...
void Ezsigntemplateformfieldgroup_RequestCompound::fromJson(const QString &jsonString) {
