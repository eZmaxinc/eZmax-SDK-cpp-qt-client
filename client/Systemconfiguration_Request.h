...
#ifndef Systemconfiguration_Request_H
#define Systemconfiguration_Request_H
...
class Systemconfiguration_Request : public Object {
public:
    Systemconfiguration_Request();
    Systemconfiguration_Request(QString json);
    ~Systemconfiguration_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Systemconfiguration_Request)

#endif // Systemconfiguration_Request_H
