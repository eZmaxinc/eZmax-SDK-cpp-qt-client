...
/*
 * Ezsignfolder_disposeEzsignfolders_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/disposeEzsignfolders
 */

#ifndef Ezsignfolder_disposeEzsignfolders_v1_Response_H
#define Ezsignfolder_disposeEzsignfolders_v1_Response_H
...
class Ezsignfolder_disposeEzsignfolders_v1_Response : public Object {
public:
    Ezsignfolder_disposeEzsignfolders_v1_Response();
    Ezsignfolder_disposeEzsignfolders_v1_Response(const QString &json);
    ~Ezsignfolder_disposeEzsignfolders_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_disposeEzsignfolders_v1_Response)

#endif // Ezsignfolder_disposeEzsignfolders_v1_Response_H
