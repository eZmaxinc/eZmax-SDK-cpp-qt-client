...
Creditcardclient_RequestCompound::Creditcardclient_RequestCompound(const QString &json) {
...
void Creditcardclient_RequestCompound::fromJson(const QString &jsonString) {
