...
Ezsigntemplatedocument_ResponseCompound::Ezsigntemplatedocument_ResponseCompound(const QString &json) {
...
void Ezsigntemplatedocument_ResponseCompound::fromJson(const QString &jsonString) {
