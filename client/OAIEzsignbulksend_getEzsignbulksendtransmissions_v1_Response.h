...
/*
 * OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response.h
 *
 * Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksend}/getEzsignbulksendtransmissions
 */

#ifndef OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response_H
#define OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response_H
...
class OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response : public OAIObject {
public:
    OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response();
    OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response(QString json);
    ~OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response() override;
...
private:
    ...
    OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response)

#endif // OAIEzsignbulksend_getEzsignbulksendtransmissions_v1_Response_H
