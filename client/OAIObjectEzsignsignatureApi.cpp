...
void OAIObjectEzsignsignatureApi::ezsignsignatureCreateObjectV1(const QList<OAIEzsignsignature_createObject_v1_Request> &oai_ezsignsignature_create_object_v1_request) {
    ...
    {
        QJsonDocument doc(::Ezmaxapi::toJsonValue(oai_ezsignsignature_create_object_v1_request).toArray());
...
void OAIObjectEzsignsignatureApi::ezsignsignatureGetEzsignsignatureattachmentV1(const qint32 &pki_ezsignsignature_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignsignatureApi::ezsignsignatureGetEzsignsignatureattachmentV1Callback);
    connect(this, &OAIObjectEzsignsignatureApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignsignatureApi::ezsignsignatureGetEzsignsignatureattachmentV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignsignature_getEzsignsignatureattachment_v1_Response output(QString(worker->response));
    worker->deleteLater();
