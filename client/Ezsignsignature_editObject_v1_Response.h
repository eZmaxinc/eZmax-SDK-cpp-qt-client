...
/*
 * Ezsignsignature_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignsignature/{pkiEzsignsignatureID}
 */

#ifndef Ezsignsignature_editObject_v1_Response_H
#define Ezsignsignature_editObject_v1_Response_H
...
class Ezsignsignature_editObject_v1_Response : public Object {
public:
    Ezsignsignature_editObject_v1_Response();
    Ezsignsignature_editObject_v1_Response(QString json);
    ~Ezsignsignature_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignature_editObject_v1_Response)

#endif // Ezsignsignature_editObject_v1_Response_H
