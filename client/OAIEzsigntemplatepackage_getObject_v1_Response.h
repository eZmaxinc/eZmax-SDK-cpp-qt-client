...
/*
 * OAIEzsigntemplatepackage_getObject_v1_Response.h
 *
 * Response for GET /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}
 */

#ifndef OAIEzsigntemplatepackage_getObject_v1_Response_H
#define OAIEzsigntemplatepackage_getObject_v1_Response_H
...
class OAIEzsigntemplatepackage_getObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatepackage_getObject_v1_Response();
    OAIEzsigntemplatepackage_getObject_v1_Response(QString json);
    ~OAIEzsigntemplatepackage_getObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplatepackage_getObject_v1_Response)

#endif // OAIEzsigntemplatepackage_getObject_v1_Response_H
