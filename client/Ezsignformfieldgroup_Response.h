...
#ifndef Ezsignformfieldgroup_Response_H
#define Ezsignformfieldgroup_Response_H
...
class Ezsignformfieldgroup_Response : public Object {
public:
    Ezsignformfieldgroup_Response();
    Ezsignformfieldgroup_Response(const QString &json);
    ~Ezsignformfieldgroup_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfieldgroup_Response)

#endif // Ezsignformfieldgroup_Response_H
