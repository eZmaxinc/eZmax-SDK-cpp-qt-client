...
Usergroup_editObject_v1_Request::Usergroup_editObject_v1_Request(const QString &json) {
...
void Usergroup_editObject_v1_Request::fromJson(const QString &jsonString) {
