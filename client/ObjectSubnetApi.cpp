...
ObjectSubnetApi::ObjectSubnetApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectSubnetApi::~ObjectSubnetApi() {
}

void ObjectSubnetApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectSubnetApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectSubnetApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectSubnetApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectSubnetApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectSubnetApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectSubnetApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectSubnetApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectSubnetApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectSubnetApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectSubnetApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectSubnetApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectSubnetApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectSubnetApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectSubnetApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectSubnetApi::enableResponseCompression() {
...
QString ObjectSubnetApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectSubnetApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectSubnetApi::subnetCreateObjectV1(const Subnet_createObject_v1_Request &subnet_create_object_v1_request) {
...
void ObjectSubnetApi::subnetCreateObjectV1Callback(HttpRequestWorker *worker) {
    ...
    Subnet_createObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectSubnetApi::subnetDeleteObjectV1(const qint32 &pki_subnet_id) {
...
void ObjectSubnetApi::subnetDeleteObjectV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void ObjectSubnetApi::subnetEditObjectV1(const qint32 &pki_subnet_id, const Subnet_editObject_v1_Request &subnet_edit_object_v1_request) {
...
void ObjectSubnetApi::subnetEditObjectV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void ObjectSubnetApi::subnetGetObjectV2(const qint32 &pki_subnet_id) {
...
void ObjectSubnetApi::subnetGetObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Subnet_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectSubnetApi::tokenAvailable() {
