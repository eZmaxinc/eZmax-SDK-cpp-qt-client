...
Usergroupexternal_ResponseCompound::Usergroupexternal_ResponseCompound(const QString &json) {
...
void Usergroupexternal_ResponseCompound::fromJson(const QString &jsonString) {
