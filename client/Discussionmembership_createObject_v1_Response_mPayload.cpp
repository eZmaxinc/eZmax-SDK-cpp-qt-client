...
Discussionmembership_createObject_v1_Response_mPayload::Discussionmembership_createObject_v1_Response_mPayload(const QString &json) {
...
void Discussionmembership_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
