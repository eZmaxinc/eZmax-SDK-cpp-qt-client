...
/*
 * OAIEzsigntemplatesignaturecustomdate_ResponseCompound.h
 *
 * An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure
 */

#ifndef OAIEzsigntemplatesignaturecustomdate_ResponseCompound_H
#define OAIEzsigntemplatesignaturecustomdate_ResponseCompound_H
...
class OAIEzsigntemplatesignaturecustomdate_ResponseCompound : public OAIObject {
public:
    OAIEzsigntemplatesignaturecustomdate_ResponseCompound();
    OAIEzsigntemplatesignaturecustomdate_ResponseCompound(QString json);
    ~OAIEzsigntemplatesignaturecustomdate_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesignaturecustomdate_ResponseCompound)

#endif // OAIEzsigntemplatesignaturecustomdate_ResponseCompound_H
