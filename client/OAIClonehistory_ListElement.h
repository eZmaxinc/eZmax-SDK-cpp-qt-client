...
/*
 * OAIClonehistory_ListElement.h
 *
 * A Clonehistory List Element
 */

#ifndef OAIClonehistory_ListElement_H
#define OAIClonehistory_ListElement_H
...
class OAIClonehistory_ListElement : public OAIObject {
public:
    OAIClonehistory_ListElement();
    OAIClonehistory_ListElement(QString json);
    ~OAIClonehistory_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIClonehistory_ListElement)

#endif // OAIClonehistory_ListElement_H
