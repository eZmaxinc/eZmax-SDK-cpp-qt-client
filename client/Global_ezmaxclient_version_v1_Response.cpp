...
Global_ezmaxclient_version_v1_Response::Global_ezmaxclient_version_v1_Response(const QString &json) {
...
void Global_ezmaxclient_version_v1_Response::fromJson(const QString &jsonString) {
