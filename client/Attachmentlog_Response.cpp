...
Attachmentlog_Response::Attachmentlog_Response() {
    this->initializeModel();
}

Attachmentlog_Response::~Attachmentlog_Response() {}

void Attachmentlog_Response::initializeModel() {
...
void Attachmentlog_Response::fromJsonObject(QJsonObject json) {
...
QString Attachmentlog_Response::asJson() const {
...
QJsonObject Attachmentlog_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Attachmentlog_Response::getFkiAttachmentId() const {
    return m_fki_attachment_id;
}
void Attachmentlog_Response::setFkiAttachmentId(const qint32 &fki_attachment_id) {
    m_fki_attachment_id = fki_attachment_id;
    m_fki_attachment_id_isSet = true;
}

bool Attachmentlog_Response::is_fki_attachment_id_Set() const{
    return m_fki_attachment_id_isSet;
}

bool Attachmentlog_Response::is_fki_attachment_id_Valid() const{
    return m_fki_attachment_id_isValid;
}

qint32 Attachmentlog_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Attachmentlog_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Attachmentlog_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Attachmentlog_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

QString Attachmentlog_Response::getDtAttachmentlogDatetime() const {
    return m_dt_attachmentlog_datetime;
}
void Attachmentlog_Response::setDtAttachmentlogDatetime(const QString &dt_attachmentlog_datetime) {
    m_dt_attachmentlog_datetime = dt_attachmentlog_datetime;
    m_dt_attachmentlog_datetime_isSet = true;
}

bool Attachmentlog_Response::is_dt_attachmentlog_datetime_Set() const{
    return m_dt_attachmentlog_datetime_isSet;
}

bool Attachmentlog_Response::is_dt_attachmentlog_datetime_Valid() const{
    return m_dt_attachmentlog_datetime_isValid;
}

Field_eAttachmentlogType Attachmentlog_Response::getEAttachmentlogType() const {
    return m_e_attachmentlog_type;
}
void Attachmentlog_Response::setEAttachmentlogType(const Field_eAttachmentlogType &e_attachmentlog_type) {
    m_e_attachmentlog_type = e_attachmentlog_type;
    m_e_attachmentlog_type_isSet = true;
}

bool Attachmentlog_Response::is_e_attachmentlog_type_Set() const{
    return m_e_attachmentlog_type_isSet;
}

bool Attachmentlog_Response::is_e_attachmentlog_type_Valid() const{
    return m_e_attachmentlog_type_isValid;
}

QString Attachmentlog_Response::getSAttachmentlogDetail() const {
    return m_s_attachmentlog_detail;
}
void Attachmentlog_Response::setSAttachmentlogDetail(const QString &s_attachmentlog_detail) {
    m_s_attachmentlog_detail = s_attachmentlog_detail;
    m_s_attachmentlog_detail_isSet = true;
}

bool Attachmentlog_Response::is_s_attachmentlog_detail_Set() const{
    return m_s_attachmentlog_detail_isSet;
}

bool Attachmentlog_Response::is_s_attachmentlog_detail_Valid() const{
    return m_s_attachmentlog_detail_isValid;
}

bool Attachmentlog_Response::isSet() const {
...
bool Attachmentlog_Response::isValid() const {
