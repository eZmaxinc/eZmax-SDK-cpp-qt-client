...
/*
 * Paymentpreparation_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/paymentpreparation/{pkiPaymentpreparationID}/getAttachments
 */

#ifndef Paymentpreparation_getAttachments_v1_Response_mPayload_H
#define Paymentpreparation_getAttachments_v1_Response_mPayload_H
...
class Paymentpreparation_getAttachments_v1_Response_mPayload : public Object {
public:
    Paymentpreparation_getAttachments_v1_Response_mPayload();
    Paymentpreparation_getAttachments_v1_Response_mPayload(const QString &json);
    ~Paymentpreparation_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentpreparation_getAttachments_v1_Response_mPayload)

#endif // Paymentpreparation_getAttachments_v1_Response_mPayload_H
