...
/*
 * OAISubnet_ResponseCompound.h
 *
 * A Subnet Object
 */

#ifndef OAISubnet_ResponseCompound_H
#define OAISubnet_ResponseCompound_H
...
class OAISubnet_ResponseCompound : public OAIObject {
public:
    OAISubnet_ResponseCompound();
    OAISubnet_ResponseCompound(QString json);
    ~OAISubnet_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISubnet_ResponseCompound)

#endif // OAISubnet_ResponseCompound_H
