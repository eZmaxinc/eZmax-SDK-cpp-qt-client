...
/*
 * OAIUserstaged_map_v1_Response.h
 *
 * Response for POST /1/object/userstaged/{pkiUserstagedID}/map
 */

#ifndef OAIUserstaged_map_v1_Response_H
#define OAIUserstaged_map_v1_Response_H
...
class OAIUserstaged_map_v1_Response : public OAIObject {
public:
    OAIUserstaged_map_v1_Response();
    OAIUserstaged_map_v1_Response(QString json);
    ~OAIUserstaged_map_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUserstaged_map_v1_Response)

#endif // OAIUserstaged_map_v1_Response_H
