...
/*
 * Inscription_getCommunicationrecipients_v1_Response_mPayload.h
 *
 * Response for GET /1/object/inscription/{pkiInscriptionID}/getCommunicationrecipients
 */

#ifndef Inscription_getCommunicationrecipients_v1_Response_mPayload_H
#define Inscription_getCommunicationrecipients_v1_Response_mPayload_H
...
class Inscription_getCommunicationrecipients_v1_Response_mPayload : public Object {
public:
    Inscription_getCommunicationrecipients_v1_Response_mPayload();
    Inscription_getCommunicationrecipients_v1_Response_mPayload(const QString &json);
    ~Inscription_getCommunicationrecipients_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Inscription_getCommunicationrecipients_v1_Response_mPayload)

#endif // Inscription_getCommunicationrecipients_v1_Response_mPayload_H
