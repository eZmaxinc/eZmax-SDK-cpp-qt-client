...
void OAIPhone_Request::fromJsonObject(QJsonObject json) {
    ...
    m_s_phone_international_isValid = ::OpenAPI::fromJsonValue(m_s_phone_international, json[QString("sPhoneInternational")]);
...
QJsonObject OAIPhone_Request::asJsonObject() const {
    ...
    if (m_s_phone_international_isSet) {
        obj.insert(QString("sPhoneInternational"), ::OpenAPI::toJsonValue(m_s_phone_international));
    }
...
qint32 OAIPhone_Request::getPkiPhoneId() const {
    return m_pki_phone_id;
}
void OAIPhone_Request::setPkiPhoneId(const qint32 &pki_phone_id) {
    m_pki_phone_id = pki_phone_id;
    m_pki_phone_id_isSet = true;
}

bool OAIPhone_Request::is_pki_phone_id_Set() const{
    return m_pki_phone_id_isSet;
}

bool OAIPhone_Request::is_pki_phone_id_Valid() const{
...
QString OAIPhone_Request::getSPhoneE164() const {
    return m_s_phone_e164;
}
void OAIPhone_Request::setSPhoneE164(const QString &s_phone_e164) {
    m_s_phone_e164 = s_phone_e164;
    m_s_phone_e164_isSet = true;
}

bool OAIPhone_Request::is_s_phone_e164_Set() const{
    return m_s_phone_e164_isSet;
}

bool OAIPhone_Request::is_s_phone_e164_Valid() const{
