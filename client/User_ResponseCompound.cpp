...
User_ResponseCompound::User_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

User_ResponseCompound::User_ResponseCompound() {
    this->initializeModel();
}

User_ResponseCompound::~User_ResponseCompound() {}

void User_ResponseCompound::initializeModel() {
...
void User_ResponseCompound::fromJson(const QString &jsonString) {
...
void User_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString User_ResponseCompound::asJson() const {
...
QJsonObject User_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 User_ResponseCompound::getPkiUserId() const {
    return m_pki_user_id;
}
void User_ResponseCompound::setPkiUserId(const qint32 &pki_user_id) {
    m_pki_user_id = pki_user_id;
    m_pki_user_id_isSet = true;
}

bool User_ResponseCompound::is_pki_user_id_Set() const{
    return m_pki_user_id_isSet;
}

bool User_ResponseCompound::is_pki_user_id_Valid() const{
    return m_pki_user_id_isValid;
}

qint32 User_ResponseCompound::getFkiAgentId() const {
    return m_fki_agent_id;
}
void User_ResponseCompound::setFkiAgentId(const qint32 &fki_agent_id) {
    m_fki_agent_id = fki_agent_id;
    m_fki_agent_id_isSet = true;
}

bool User_ResponseCompound::is_fki_agent_id_Set() const{
    return m_fki_agent_id_isSet;
}

bool User_ResponseCompound::is_fki_agent_id_Valid() const{
    return m_fki_agent_id_isValid;
}

qint32 User_ResponseCompound::getFkiBrokerId() const {
    return m_fki_broker_id;
}
void User_ResponseCompound::setFkiBrokerId(const qint32 &fki_broker_id) {
    m_fki_broker_id = fki_broker_id;
    m_fki_broker_id_isSet = true;
}

bool User_ResponseCompound::is_fki_broker_id_Set() const{
    return m_fki_broker_id_isSet;
}

bool User_ResponseCompound::is_fki_broker_id_Valid() const{
    return m_fki_broker_id_isValid;
}

qint32 User_ResponseCompound::getFkiAssistantId() const {
    return m_fki_assistant_id;
}
void User_ResponseCompound::setFkiAssistantId(const qint32 &fki_assistant_id) {
    m_fki_assistant_id = fki_assistant_id;
    m_fki_assistant_id_isSet = true;
}

bool User_ResponseCompound::is_fki_assistant_id_Set() const{
    return m_fki_assistant_id_isSet;
}

bool User_ResponseCompound::is_fki_assistant_id_Valid() const{
    return m_fki_assistant_id_isValid;
}

qint32 User_ResponseCompound::getFkiEmployeeId() const {
    return m_fki_employee_id;
}
void User_ResponseCompound::setFkiEmployeeId(const qint32 &fki_employee_id) {
    m_fki_employee_id = fki_employee_id;
    m_fki_employee_id_isSet = true;
}

bool User_ResponseCompound::is_fki_employee_id_Set() const{
    return m_fki_employee_id_isSet;
}

bool User_ResponseCompound::is_fki_employee_id_Valid() const{
    return m_fki_employee_id_isValid;
}

qint32 User_ResponseCompound::getFkiEzmaxpartnerId() const {
    return m_fki_ezmaxpartner_id;
}
void User_ResponseCompound::setFkiEzmaxpartnerId(const qint32 &fki_ezmaxpartner_id) {
    m_fki_ezmaxpartner_id = fki_ezmaxpartner_id;
    m_fki_ezmaxpartner_id_isSet = true;
}

bool User_ResponseCompound::is_fki_ezmaxpartner_id_Set() const{
    return m_fki_ezmaxpartner_id_isSet;
}

bool User_ResponseCompound::is_fki_ezmaxpartner_id_Valid() const{
    return m_fki_ezmaxpartner_id_isValid;
}

qint32 User_ResponseCompound::getFkiCompanyIdDefault() const {
    return m_fki_company_id_default;
}
void User_ResponseCompound::setFkiCompanyIdDefault(const qint32 &fki_company_id_default) {
    m_fki_company_id_default = fki_company_id_default;
    m_fki_company_id_default_isSet = true;
}

bool User_ResponseCompound::is_fki_company_id_default_Set() const{
    return m_fki_company_id_default_isSet;
}

bool User_ResponseCompound::is_fki_company_id_default_Valid() const{
    return m_fki_company_id_default_isValid;
}

QString User_ResponseCompound::getSCompanyNameX() const {
    return m_s_company_name_x;
}
void User_ResponseCompound::setSCompanyNameX(const QString &s_company_name_x) {
    m_s_company_name_x = s_company_name_x;
    m_s_company_name_x_isSet = true;
}

bool User_ResponseCompound::is_s_company_name_x_Set() const{
    return m_s_company_name_x_isSet;
}

bool User_ResponseCompound::is_s_company_name_x_Valid() const{
    return m_s_company_name_x_isValid;
}

qint32 User_ResponseCompound::getFkiDepartmentIdDefault() const {
    return m_fki_department_id_default;
}
void User_ResponseCompound::setFkiDepartmentIdDefault(const qint32 &fki_department_id_default) {
    m_fki_department_id_default = fki_department_id_default;
    m_fki_department_id_default_isSet = true;
}

bool User_ResponseCompound::is_fki_department_id_default_Set() const{
    return m_fki_department_id_default_isSet;
}

bool User_ResponseCompound::is_fki_department_id_default_Valid() const{
    return m_fki_department_id_default_isValid;
}

QString User_ResponseCompound::getSDepartmentNameX() const {
    return m_s_department_name_x;
}
void User_ResponseCompound::setSDepartmentNameX(const QString &s_department_name_x) {
    m_s_department_name_x = s_department_name_x;
    m_s_department_name_x_isSet = true;
}

bool User_ResponseCompound::is_s_department_name_x_Set() const{
    return m_s_department_name_x_isSet;
}

bool User_ResponseCompound::is_s_department_name_x_Valid() const{
    return m_s_department_name_x_isValid;
}

qint32 User_ResponseCompound::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void User_ResponseCompound::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool User_ResponseCompound::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool User_ResponseCompound::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

QString User_ResponseCompound::getSTimezoneName() const {
    return m_s_timezone_name;
}
void User_ResponseCompound::setSTimezoneName(const QString &s_timezone_name) {
    m_s_timezone_name = s_timezone_name;
    m_s_timezone_name_isSet = true;
}

bool User_ResponseCompound::is_s_timezone_name_Set() const{
    return m_s_timezone_name_isSet;
}

bool User_ResponseCompound::is_s_timezone_name_Valid() const{
    return m_s_timezone_name_isValid;
}

qint32 User_ResponseCompound::getFkiLanguageId() const {
    return m_fki_language_id;
}
void User_ResponseCompound::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool User_ResponseCompound::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool User_ResponseCompound::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

QString User_ResponseCompound::getSLanguageNameX() const {
    return m_s_language_name_x;
}
void User_ResponseCompound::setSLanguageNameX(const QString &s_language_name_x) {
    m_s_language_name_x = s_language_name_x;
    m_s_language_name_x_isSet = true;
}

bool User_ResponseCompound::is_s_language_name_x_Set() const{
    return m_s_language_name_x_isSet;
}

bool User_ResponseCompound::is_s_language_name_x_Valid() const{
...
bool User_ResponseCompound::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool User_ResponseCompound::is_obj_email_Valid() const{
    return m_obj_email_isValid;
}

qint32 User_ResponseCompound::getFkiBillingentityinternalId() const {
    return m_fki_billingentityinternal_id;
}
void User_ResponseCompound::setFkiBillingentityinternalId(const qint32 &fki_billingentityinternal_id) {
    m_fki_billingentityinternal_id = fki_billingentityinternal_id;
    m_fki_billingentityinternal_id_isSet = true;
}

bool User_ResponseCompound::is_fki_billingentityinternal_id_Set() const{
    return m_fki_billingentityinternal_id_isSet;
}

bool User_ResponseCompound::is_fki_billingentityinternal_id_Valid() const{
    return m_fki_billingentityinternal_id_isValid;
}

QString User_ResponseCompound::getSBillingentityinternalDescriptionX() const {
    return m_s_billingentityinternal_description_x;
}
void User_ResponseCompound::setSBillingentityinternalDescriptionX(const QString &s_billingentityinternal_description_x) {
...
bool User_ResponseCompound::is_s_billingentityinternal_description_x_Set() const{
    return m_s_billingentityinternal_description_x_isSet;
}

bool User_ResponseCompound::is_s_billingentityinternal_description_x_Valid() const{
    return m_s_billingentityinternal_description_x_isValid;
}

Phone_ResponseCompound User_ResponseCompound::getObjPhoneHome() const {
    return m_obj_phone_home;
}
void User_ResponseCompound::setObjPhoneHome(const Phone_ResponseCompound &obj_phone_home) {
    m_obj_phone_home = obj_phone_home;
    m_obj_phone_home_isSet = true;
}

bool User_ResponseCompound::is_obj_phone_home_Set() const{
    return m_obj_phone_home_isSet;
}

bool User_ResponseCompound::is_obj_phone_home_Valid() const{
    return m_obj_phone_home_isValid;
}

Phone_ResponseCompound User_ResponseCompound::getObjPhoneSms() const {
    return m_obj_phone_sms;
}
void User_ResponseCompound::setObjPhoneSms(const Phone_ResponseCompound &obj_phone_sms) {
    m_obj_phone_sms = obj_phone_sms;
    m_obj_phone_sms_isSet = true;
}

bool User_ResponseCompound::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool User_ResponseCompound::is_obj_phone_sms_Valid() const{
    return m_obj_phone_sms_isValid;
}

qint32 User_ResponseCompound::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void User_ResponseCompound::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool User_ResponseCompound::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool User_ResponseCompound::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

qint32 User_ResponseCompound::getFkiModuleIdForm() const {
    return m_fki_module_id_form;
}
void User_ResponseCompound::setFkiModuleIdForm(const qint32 &fki_module_id_form) {
    m_fki_module_id_form = fki_module_id_form;
    m_fki_module_id_form_isSet = true;
}

bool User_ResponseCompound::is_fki_module_id_form_Set() const{
    return m_fki_module_id_form_isSet;
}

bool User_ResponseCompound::is_fki_module_id_form_Valid() const{
    return m_fki_module_id_form_isValid;
}

QString User_ResponseCompound::getSModuleNameX() const {
    return m_s_module_name_x;
}
void User_ResponseCompound::setSModuleNameX(const QString &s_module_name_x) {
    m_s_module_name_x = s_module_name_x;
    m_s_module_name_x_isSet = true;
}

bool User_ResponseCompound::is_s_module_name_x_Set() const{
    return m_s_module_name_x_isSet;
}

bool User_ResponseCompound::is_s_module_name_x_Valid() const{
    return m_s_module_name_x_isValid;
}

Field_eUserOrigin User_ResponseCompound::getEUserOrigin() const {
    return m_e_user_origin;
}
void User_ResponseCompound::setEUserOrigin(const Field_eUserOrigin &e_user_origin) {
    m_e_user_origin = e_user_origin;
    m_e_user_origin_isSet = true;
}

bool User_ResponseCompound::is_e_user_origin_Set() const{
    return m_e_user_origin_isSet;
}

bool User_ResponseCompound::is_e_user_origin_Valid() const{
    return m_e_user_origin_isValid;
}

Field_eUserType User_ResponseCompound::getEUserType() const {
    return m_e_user_type;
}
void User_ResponseCompound::setEUserType(const Field_eUserType &e_user_type) {
    m_e_user_type = e_user_type;
    m_e_user_type_isSet = true;
}

bool User_ResponseCompound::is_e_user_type_Set() const{
    return m_e_user_type_isSet;
}

bool User_ResponseCompound::is_e_user_type_Valid() const{
    return m_e_user_type_isValid;
}

Field_eUserLogintype User_ResponseCompound::getEUserLogintype() const {
    return m_e_user_logintype;
}
void User_ResponseCompound::setEUserLogintype(const Field_eUserLogintype &e_user_logintype) {
    m_e_user_logintype = e_user_logintype;
    m_e_user_logintype_isSet = true;
}

bool User_ResponseCompound::is_e_user_logintype_Set() const{
    return m_e_user_logintype_isSet;
}

bool User_ResponseCompound::is_e_user_logintype_Valid() const{
    return m_e_user_logintype_isValid;
}

QString User_ResponseCompound::getSUserFirstname() const {
    return m_s_user_firstname;
}
void User_ResponseCompound::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool User_ResponseCompound::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool User_ResponseCompound::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString User_ResponseCompound::getSUserLastname() const {
    return m_s_user_lastname;
}
void User_ResponseCompound::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool User_ResponseCompound::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool User_ResponseCompound::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString User_ResponseCompound::getSUserLoginname() const {
    return m_s_user_loginname;
}
void User_ResponseCompound::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool User_ResponseCompound::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool User_ResponseCompound::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString User_ResponseCompound::getSUserJobtitle() const {
    return m_s_user_jobtitle;
}
void User_ResponseCompound::setSUserJobtitle(const QString &s_user_jobtitle) {
    m_s_user_jobtitle = s_user_jobtitle;
    m_s_user_jobtitle_isSet = true;
}

bool User_ResponseCompound::is_s_user_jobtitle_Set() const{
    return m_s_user_jobtitle_isSet;
}

bool User_ResponseCompound::is_s_user_jobtitle_Valid() const{
    return m_s_user_jobtitle_isValid;
}

Field_eUserEzsignaccess User_ResponseCompound::getEUserEzsignaccess() const {
    return m_e_user_ezsignaccess;
}
void User_ResponseCompound::setEUserEzsignaccess(const Field_eUserEzsignaccess &e_user_ezsignaccess) {
    m_e_user_ezsignaccess = e_user_ezsignaccess;
    m_e_user_ezsignaccess_isSet = true;
}

bool User_ResponseCompound::is_e_user_ezsignaccess_Set() const{
    return m_e_user_ezsignaccess_isSet;
}

bool User_ResponseCompound::is_e_user_ezsignaccess_Valid() const{
    return m_e_user_ezsignaccess_isValid;
}

QString User_ResponseCompound::getDtUserLastlogondate() const {
    return m_dt_user_lastlogondate;
}
void User_ResponseCompound::setDtUserLastlogondate(const QString &dt_user_lastlogondate) {
    m_dt_user_lastlogondate = dt_user_lastlogondate;
    m_dt_user_lastlogondate_isSet = true;
}

bool User_ResponseCompound::is_dt_user_lastlogondate_Set() const{
    return m_dt_user_lastlogondate_isSet;
}

bool User_ResponseCompound::is_dt_user_lastlogondate_Valid() const{
    return m_dt_user_lastlogondate_isValid;
}

QString User_ResponseCompound::getDtUserPasswordchanged() const {
    return m_dt_user_passwordchanged;
}
void User_ResponseCompound::setDtUserPasswordchanged(const QString &dt_user_passwordchanged) {
    m_dt_user_passwordchanged = dt_user_passwordchanged;
    m_dt_user_passwordchanged_isSet = true;
}

bool User_ResponseCompound::is_dt_user_passwordchanged_Set() const{
    return m_dt_user_passwordchanged_isSet;
}

bool User_ResponseCompound::is_dt_user_passwordchanged_Valid() const{
    return m_dt_user_passwordchanged_isValid;
}

QString User_ResponseCompound::getDtUserEzsignprepaidexpiration() const {
    return m_dt_user_ezsignprepaidexpiration;
}
void User_ResponseCompound::setDtUserEzsignprepaidexpiration(const QString &dt_user_ezsignprepaidexpiration) {
    m_dt_user_ezsignprepaidexpiration = dt_user_ezsignprepaidexpiration;
    m_dt_user_ezsignprepaidexpiration_isSet = true;
}

bool User_ResponseCompound::is_dt_user_ezsignprepaidexpiration_Set() const{
    return m_dt_user_ezsignprepaidexpiration_isSet;
}

bool User_ResponseCompound::is_dt_user_ezsignprepaidexpiration_Valid() const{
    return m_dt_user_ezsignprepaidexpiration_isValid;
}

bool User_ResponseCompound::isBUserIsactive() const {
    return m_b_user_isactive;
}
void User_ResponseCompound::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool User_ResponseCompound::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool User_ResponseCompound::is_b_user_isactive_Valid() const{
    return m_b_user_isactive_isValid;
}

bool User_ResponseCompound::isBUserSuspended() const {
    return m_b_user_suspended;
}
void User_ResponseCompound::setBUserSuspended(const bool &b_user_suspended) {
    m_b_user_suspended = b_user_suspended;
    m_b_user_suspended_isSet = true;
}

bool User_ResponseCompound::is_b_user_suspended_Set() const{
    return m_b_user_suspended_isSet;
}

bool User_ResponseCompound::is_b_user_suspended_Valid() const{
    return m_b_user_suspended_isValid;
}

bool User_ResponseCompound::isBUserValidatebyadministration() const {
    return m_b_user_validatebyadministration;
}
void User_ResponseCompound::setBUserValidatebyadministration(const bool &b_user_validatebyadministration) {
    m_b_user_validatebyadministration = b_user_validatebyadministration;
    m_b_user_validatebyadministration_isSet = true;
}

bool User_ResponseCompound::is_b_user_validatebyadministration_Set() const{
    return m_b_user_validatebyadministration_isSet;
}

bool User_ResponseCompound::is_b_user_validatebyadministration_Valid() const{
    return m_b_user_validatebyadministration_isValid;
}

bool User_ResponseCompound::isBUserValidatebydirector() const {
    return m_b_user_validatebydirector;
}
void User_ResponseCompound::setBUserValidatebydirector(const bool &b_user_validatebydirector) {
    m_b_user_validatebydirector = b_user_validatebydirector;
    m_b_user_validatebydirector_isSet = true;
}

bool User_ResponseCompound::is_b_user_validatebydirector_Set() const{
    return m_b_user_validatebydirector_isSet;
}

bool User_ResponseCompound::is_b_user_validatebydirector_Valid() const{
    return m_b_user_validatebydirector_isValid;
}

bool User_ResponseCompound::isBUserAttachmentautoverified() const {
    return m_b_user_attachmentautoverified;
}
void User_ResponseCompound::setBUserAttachmentautoverified(const bool &b_user_attachmentautoverified) {
    m_b_user_attachmentautoverified = b_user_attachmentautoverified;
    m_b_user_attachmentautoverified_isSet = true;
}

bool User_ResponseCompound::is_b_user_attachmentautoverified_Set() const{
    return m_b_user_attachmentautoverified_isSet;
}

bool User_ResponseCompound::is_b_user_attachmentautoverified_Valid() const{
    return m_b_user_attachmentautoverified_isValid;
}

bool User_ResponseCompound::isBUserChangepassword() const {
    return m_b_user_changepassword;
}
void User_ResponseCompound::setBUserChangepassword(const bool &b_user_changepassword) {
    m_b_user_changepassword = b_user_changepassword;
    m_b_user_changepassword_isSet = true;
}

bool User_ResponseCompound::is_b_user_changepassword_Set() const{
    return m_b_user_changepassword_isSet;
}

bool User_ResponseCompound::is_b_user_changepassword_Valid() const{
    return m_b_user_changepassword_isValid;
}

bool User_ResponseCompound::isBUserEzsigntemplaterolegrouping() const {
    return m_b_user_ezsigntemplaterolegrouping;
}
void User_ResponseCompound::setBUserEzsigntemplaterolegrouping(const bool &b_user_ezsigntemplaterolegrouping) {
    m_b_user_ezsigntemplaterolegrouping = b_user_ezsigntemplaterolegrouping;
    m_b_user_ezsigntemplaterolegrouping_isSet = true;
}

bool User_ResponseCompound::is_b_user_ezsigntemplaterolegrouping_Set() const{
    return m_b_user_ezsigntemplaterolegrouping_isSet;
}

bool User_ResponseCompound::is_b_user_ezsigntemplaterolegrouping_Valid() const{
    return m_b_user_ezsigntemplaterolegrouping_isValid;
}

Common_Audit User_ResponseCompound::getObjAudit() const {
    return m_obj_audit;
}
void User_ResponseCompound::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool User_ResponseCompound::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool User_ResponseCompound::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool User_ResponseCompound::isSet() const {
...
bool User_ResponseCompound::isValid() const {
