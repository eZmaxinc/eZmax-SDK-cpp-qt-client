...
/*
 * OAIWebhook_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/webhook/{pkiWebhookID}
 */

#ifndef OAIWebhook_deleteObject_v1_Response_H
#define OAIWebhook_deleteObject_v1_Response_H
...
class OAIWebhook_deleteObject_v1_Response : public OAIObject {
public:
    OAIWebhook_deleteObject_v1_Response();
    OAIWebhook_deleteObject_v1_Response(QString json);
    ~OAIWebhook_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIWebhook_deleteObject_v1_Response)

#endif // OAIWebhook_deleteObject_v1_Response_H
