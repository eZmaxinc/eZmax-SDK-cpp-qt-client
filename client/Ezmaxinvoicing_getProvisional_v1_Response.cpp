...
Ezmaxinvoicing_getProvisional_v1_Response::Ezmaxinvoicing_getProvisional_v1_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezmaxinvoicing_getProvisional_v1_Response::Ezmaxinvoicing_getProvisional_v1_Response() {
    this->initializeModel();
}

Ezmaxinvoicing_getProvisional_v1_Response::~Ezmaxinvoicing_getProvisional_v1_Response() {}

void Ezmaxinvoicing_getProvisional_v1_Response::initializeModel() {
...
void Ezmaxinvoicing_getProvisional_v1_Response::fromJson(const QString &jsonString) {
...
void Ezmaxinvoicing_getProvisional_v1_Response::fromJsonObject(QJsonObject json) {
...
QString Ezmaxinvoicing_getProvisional_v1_Response::asJson() const {
...
QJsonObject Ezmaxinvoicing_getProvisional_v1_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload Ezmaxinvoicing_getProvisional_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Ezmaxinvoicing_getProvisional_v1_Response::setObjDebugPayload(const Common_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Ezmaxinvoicing_getProvisional_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void Ezmaxinvoicing_getProvisional_v1_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::is_obj_debug_Valid() const{
...
bool Ezmaxinvoicing_getProvisional_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Ezmaxinvoicing_getProvisional_v1_Response::isSet() const {
...
bool Ezmaxinvoicing_getProvisional_v1_Response::isValid() const {
