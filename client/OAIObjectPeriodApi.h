...
public:
    ...
    */
    Q_DECL_DEPRECATED void periodGetAutocompleteV1(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<QString> &s_query = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language = ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language>());
...
private:
    ...
    void periodGetAutocompleteV2Callback(OAIHttpRequestWorker *worker);

signals:

    void periodGetAutocompleteV1Signal(OAICommon_getAutocomplete_v1_Response summary);
    void periodGetAutocompleteV2Signal(OAIPeriod_getAutocomplete_v2_Response summary);

    void periodGetAutocompleteV1SignalFull(OAIHttpRequestWorker *worker, OAICommon_getAutocomplete_v1_Response summary);
    void periodGetAutocompleteV2SignalFull(OAIHttpRequestWorker *worker, OAIPeriod_getAutocomplete_v2_Response summary);
    ...
    void periodGetAutocompleteV2SignalE(OAIPeriod_getAutocomplete_v2_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void periodGetAutocompleteV2SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
