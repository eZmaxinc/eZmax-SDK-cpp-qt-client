...
Ezsignsignature_ResponseCompound::Ezsignsignature_ResponseCompound(const QString &json) {
...
void Ezsignsignature_ResponseCompound::fromJson(const QString &jsonString) {
...
qint32 Ezsignsignature_ResponseCompound::getFkiPaymentgatewayId() const {
    return m_fki_paymentgateway_id;
}
void Ezsignsignature_ResponseCompound::setFkiPaymentgatewayId(const qint32 &fki_paymentgateway_id) {
    m_fki_paymentgateway_id = fki_paymentgateway_id;
    m_fki_paymentgateway_id_isSet = true;
}

bool Ezsignsignature_ResponseCompound::is_fki_paymentgateway_id_Set() const{
    return m_fki_paymentgateway_id_isSet;
}

bool Ezsignsignature_ResponseCompound::is_fki_paymentgateway_id_Valid() const{
...
QString Ezsignsignature_ResponseCompound::getDEzsignsignatureCreditcardamount() const {
    return m_d_ezsignsignature_creditcardamount;
}
void Ezsignsignature_ResponseCompound::setDEzsignsignatureCreditcardamount(const QString &d_ezsignsignature_creditcardamount) {
    m_d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount;
    m_d_ezsignsignature_creditcardamount_isSet = true;
}

bool Ezsignsignature_ResponseCompound::is_d_ezsignsignature_creditcardamount_Set() const{
    return m_d_ezsignsignature_creditcardamount_isSet;
}

bool Ezsignsignature_ResponseCompound::is_d_ezsignsignature_creditcardamount_Valid() const{
    return m_d_ezsignsignature_creditcardamount_isValid;
}

QString Ezsignsignature_ResponseCompound::getSEzsignsignatureCreditcardamountdescription() const {
    return m_s_ezsignsignature_creditcardamountdescription;
}
void Ezsignsignature_ResponseCompound::setSEzsignsignatureCreditcardamountdescription(const QString &s_ezsignsignature_creditcardamountdescription) {
    m_s_ezsignsignature_creditcardamountdescription = s_ezsignsignature_creditcardamountdescription;
    m_s_ezsignsignature_creditcardamountdescription_isSet = true;
}

bool Ezsignsignature_ResponseCompound::is_s_ezsignsignature_creditcardamountdescription_Set() const{
    return m_s_ezsignsignature_creditcardamountdescription_isSet;
}

bool Ezsignsignature_ResponseCompound::is_s_ezsignsignature_creditcardamountdescription_Valid() const{
    return m_s_ezsignsignature_creditcardamountdescription_isValid;
}

bool Ezsignsignature_ResponseCompound::isBEzsignsignatureCreditcardcustomamount() const {
    return m_b_ezsignsignature_creditcardcustomamount;
}
void Ezsignsignature_ResponseCompound::setBEzsignsignatureCreditcardcustomamount(const bool &b_ezsignsignature_creditcardcustomamount) {
...
bool Ezsignsignature_ResponseCompound::is_b_ezsignsignature_creditcardcustomamount_Set() const{
    return m_b_ezsignsignature_creditcardcustomamount_isSet;
}

bool Ezsignsignature_ResponseCompound::is_b_ezsignsignature_creditcardcustomamount_Valid() const{
...
Field_eEzsignsignatureSignaturepad Ezsignsignature_ResponseCompound::getEEzsignsignatureSignaturepad() const {
    return m_e_ezsignsignature_signaturepad;
}
void Ezsignsignature_ResponseCompound::setEEzsignsignatureSignaturepad(const Field_eEzsignsignatureSignaturepad &e_ezsignsignature_signaturepad) {
    m_e_ezsignsignature_signaturepad = e_ezsignsignature_signaturepad;
    m_e_ezsignsignature_signaturepad_isSet = true;
}

bool Ezsignsignature_ResponseCompound::is_e_ezsignsignature_signaturepad_Set() const{
    return m_e_ezsignsignature_signaturepad_isSet;
}

bool Ezsignsignature_ResponseCompound::is_e_ezsignsignature_signaturepad_Valid() const{
    return m_e_ezsignsignature_signaturepad_isValid;
}

Field_eEzsignsignatureSignaturepadrequired Ezsignsignature_ResponseCompound::getEEzsignsignatureSignaturepadrequired() const {
    return m_e_ezsignsignature_signaturepadrequired;
}
void Ezsignsignature_ResponseCompound::setEEzsignsignatureSignaturepadrequired(const Field_eEzsignsignatureSignaturepadrequired &e_ezsignsignature_signaturepadrequired) {
...
bool Ezsignsignature_ResponseCompound::is_e_ezsignsignature_signaturepadrequired_Set() const{
    return m_e_ezsignsignature_signaturepadrequired_isSet;
}

bool Ezsignsignature_ResponseCompound::is_e_ezsignsignature_signaturepadrequired_Valid() const{
...
QList<Ezsignsignaturepaymentdetail_ResponseCompound> Ezsignsignature_ResponseCompound::getAObjEzsignsignaturepaymentdetail() const {
    return m_a_obj_ezsignsignaturepaymentdetail;
}
void Ezsignsignature_ResponseCompound::setAObjEzsignsignaturepaymentdetail(const QList<Ezsignsignaturepaymentdetail_ResponseCompound> &a_obj_ezsignsignaturepaymentdetail) {
