...
User_RequestCompoundV2::User_RequestCompoundV2(const QString &json) {
...
void User_RequestCompoundV2::fromJson(const QString &jsonString) {
...
bool User_RequestCompoundV2::isBUserEzsigntemplaterolegrouping() const {
    return m_b_user_ezsigntemplaterolegrouping;
}
void User_RequestCompoundV2::setBUserEzsigntemplaterolegrouping(const bool &b_user_ezsigntemplaterolegrouping) {
    m_b_user_ezsigntemplaterolegrouping = b_user_ezsigntemplaterolegrouping;
    m_b_user_ezsigntemplaterolegrouping_isSet = true;
}

bool User_RequestCompoundV2::is_b_user_ezsigntemplaterolegrouping_Set() const{
    return m_b_user_ezsigntemplaterolegrouping_isSet;
}

bool User_RequestCompoundV2::is_b_user_ezsigntemplaterolegrouping_Valid() const{
