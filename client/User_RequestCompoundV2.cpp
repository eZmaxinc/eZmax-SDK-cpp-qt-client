...
Email_Request User_RequestCompoundV2::getObjEmail() const {
    return m_obj_email;
}
void User_RequestCompoundV2::setObjEmail(const Email_Request &obj_email) {
...
Phone_RequestV2 User_RequestCompoundV2::getObjPhoneHome() const {
    return m_obj_phone_home;
}
void User_RequestCompoundV2::setObjPhoneHome(const Phone_RequestV2 &obj_phone_home) {
...
Phone_RequestV2 User_RequestCompoundV2::getObjPhoneSms() const {
    return m_obj_phone_sms;
}
void User_RequestCompoundV2::setObjPhoneSms(const Phone_RequestV2 &obj_phone_sms) {
