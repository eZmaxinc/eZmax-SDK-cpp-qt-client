...
/*
 * Ezsignsignaturepaymentdetail_ResponseCompound.h
 *
 * An Ezsignsignaturepaymentdetail Object and children to create a complete structure
 */

#ifndef Ezsignsignaturepaymentdetail_ResponseCompound_H
#define Ezsignsignaturepaymentdetail_ResponseCompound_H
...
class Ezsignsignaturepaymentdetail_ResponseCompound : public Object {
public:
    Ezsignsignaturepaymentdetail_ResponseCompound();
    Ezsignsignaturepaymentdetail_ResponseCompound(const QString &json);
    ~Ezsignsignaturepaymentdetail_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturepaymentdetail_ResponseCompound)

#endif // Ezsignsignaturepaymentdetail_ResponseCompound_H
