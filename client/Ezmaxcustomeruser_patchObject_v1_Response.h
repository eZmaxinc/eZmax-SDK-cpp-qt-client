...
/*
 * Ezmaxcustomeruser_patchObject_v1_Response.h
 *
 * Request for PATCH /1/object/ezmaxcustomeruser/{pkiEzmaxcustomeruserID}
 */

#ifndef Ezmaxcustomeruser_patchObject_v1_Response_H
#define Ezmaxcustomeruser_patchObject_v1_Response_H
...
class Ezmaxcustomeruser_patchObject_v1_Response : public Object {
public:
    Ezmaxcustomeruser_patchObject_v1_Response();
    Ezmaxcustomeruser_patchObject_v1_Response(const QString &json);
    ~Ezmaxcustomeruser_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxcustomeruser_patchObject_v1_Response)

#endif // Ezmaxcustomeruser_patchObject_v1_Response_H
