...
#ifndef _ObjectBrokerApi_H
#define _ObjectBrokerApi_H
...
class ObjectBrokerApi : public QObject {
    Q_OBJECT

public:
    ObjectBrokerApi(const int timeOut = 0);
    ~ObjectBrokerApi();
    ...
    */
    virtual void brokerGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<qint32> &i_row_max = ::Ezmaxapi::OptionalParam<qint32>(), const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset = ::Ezmaxapi::OptionalParam<qint32>(), const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language = ::Ezmaxapi::OptionalParam<Header_Accept_Language>(), const ::Ezmaxapi::OptionalParam<QString> &s_filter = ::Ezmaxapi::OptionalParam<QString>());

    /**
    * @param[in]  pki_broker_id qint32 [required]
    * @param[in]  broker_import_into_edm_v1_request Broker_importIntoEDM_v1_Request [required]
    */
    virtual void brokerImportIntoEDMV1(const qint32 &pki_broker_id, const Broker_importIntoEDM_v1_Request &broker_import_into_edm_v1_request);
