...
private:
    ...
    QList<qint32> a_pki_ezsigntemplatepackagesignermembership_id;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplatepackagesignermembership_createObject_v1_Response_mPayload)
