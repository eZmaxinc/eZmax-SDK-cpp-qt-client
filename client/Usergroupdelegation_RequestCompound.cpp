...
Usergroupdelegation_RequestCompound::Usergroupdelegation_RequestCompound(const QString &json) {
...
void Usergroupdelegation_RequestCompound::fromJson(const QString &jsonString) {
