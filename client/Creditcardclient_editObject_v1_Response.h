...
/*
 * Creditcardclient_editObject_v1_Response.h
 *
 * Response for PUT /1/object/creditcardclient/{pkiCreditcardclientID}
 */

#ifndef Creditcardclient_editObject_v1_Response_H
#define Creditcardclient_editObject_v1_Response_H
...
class Creditcardclient_editObject_v1_Response : public Object {
public:
    Creditcardclient_editObject_v1_Response();
    Creditcardclient_editObject_v1_Response(const QString &json);
    ~Creditcardclient_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardclient_editObject_v1_Response)

#endif // Creditcardclient_editObject_v1_Response_H
