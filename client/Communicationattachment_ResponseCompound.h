...
/*
 * Communicationattachment_ResponseCompound.h
 *
 * A Communicationattachment Object
 */

#ifndef Communicationattachment_ResponseCompound_H
#define Communicationattachment_ResponseCompound_H
...
class Communicationattachment_ResponseCompound : public Object {
public:
    Communicationattachment_ResponseCompound();
    Communicationattachment_ResponseCompound(QString json);
    ~Communicationattachment_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Communicationattachment_ResponseCompound)

#endif // Communicationattachment_ResponseCompound_H
