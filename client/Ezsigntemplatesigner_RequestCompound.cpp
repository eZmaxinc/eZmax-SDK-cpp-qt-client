...
Ezsigntemplatesigner_RequestCompound::Ezsigntemplatesigner_RequestCompound(const QString &json) {
...
void Ezsigntemplatesigner_RequestCompound::fromJson(const QString &jsonString) {
