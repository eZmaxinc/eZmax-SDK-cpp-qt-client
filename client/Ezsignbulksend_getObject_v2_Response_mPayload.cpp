...
Ezsignbulksend_getObject_v2_Response_mPayload::Ezsignbulksend_getObject_v2_Response_mPayload(const QString &json) {
...
void Ezsignbulksend_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
