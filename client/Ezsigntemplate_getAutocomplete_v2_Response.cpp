...
Ezsigntemplate_getAutocomplete_v2_Response::Ezsigntemplate_getAutocomplete_v2_Response(const QString &json) {
...
void Ezsigntemplate_getAutocomplete_v2_Response::fromJson(const QString &jsonString) {
