...
qint32 OAIUser_ResponseCompound::getFkiAgentId() const {
    return m_fki_agent_id;
}
void OAIUser_ResponseCompound::setFkiAgentId(const qint32 &fki_agent_id) {
    m_fki_agent_id = fki_agent_id;
    m_fki_agent_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_agent_id_Set() const{
    return m_fki_agent_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_agent_id_Valid() const{
    return m_fki_agent_id_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiBrokerId() const {
    return m_fki_broker_id;
}
void OAIUser_ResponseCompound::setFkiBrokerId(const qint32 &fki_broker_id) {
    m_fki_broker_id = fki_broker_id;
    m_fki_broker_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_broker_id_Set() const{
    return m_fki_broker_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_broker_id_Valid() const{
    return m_fki_broker_id_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiAssistantId() const {
    return m_fki_assistant_id;
}
void OAIUser_ResponseCompound::setFkiAssistantId(const qint32 &fki_assistant_id) {
    m_fki_assistant_id = fki_assistant_id;
    m_fki_assistant_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_assistant_id_Set() const{
    return m_fki_assistant_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_assistant_id_Valid() const{
    return m_fki_assistant_id_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiEmployeeId() const {
    return m_fki_employee_id;
}
void OAIUser_ResponseCompound::setFkiEmployeeId(const qint32 &fki_employee_id) {
    m_fki_employee_id = fki_employee_id;
    m_fki_employee_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_employee_id_Set() const{
    return m_fki_employee_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_employee_id_Valid() const{
    return m_fki_employee_id_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiCompanyIdDefault() const {
    return m_fki_company_id_default;
}
void OAIUser_ResponseCompound::setFkiCompanyIdDefault(const qint32 &fki_company_id_default) {
    m_fki_company_id_default = fki_company_id_default;
    m_fki_company_id_default_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_company_id_default_Set() const{
    return m_fki_company_id_default_isSet;
}

bool OAIUser_ResponseCompound::is_fki_company_id_default_Valid() const{
    return m_fki_company_id_default_isValid;
}

QString OAIUser_ResponseCompound::getSCompanyNameX() const {
    return m_s_company_name_x;
}
void OAIUser_ResponseCompound::setSCompanyNameX(const QString &s_company_name_x) {
    m_s_company_name_x = s_company_name_x;
    m_s_company_name_x_isSet = true;
}

bool OAIUser_ResponseCompound::is_s_company_name_x_Set() const{
    return m_s_company_name_x_isSet;
}

bool OAIUser_ResponseCompound::is_s_company_name_x_Valid() const{
    return m_s_company_name_x_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiDepartmentIdDefault() const {
    return m_fki_department_id_default;
}
void OAIUser_ResponseCompound::setFkiDepartmentIdDefault(const qint32 &fki_department_id_default) {
    m_fki_department_id_default = fki_department_id_default;
    m_fki_department_id_default_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_department_id_default_Set() const{
    return m_fki_department_id_default_isSet;
}

bool OAIUser_ResponseCompound::is_fki_department_id_default_Valid() const{
    return m_fki_department_id_default_isValid;
}

QString OAIUser_ResponseCompound::getSDepartmentNameX() const {
    return m_s_department_name_x;
}
void OAIUser_ResponseCompound::setSDepartmentNameX(const QString &s_department_name_x) {
    m_s_department_name_x = s_department_name_x;
    m_s_department_name_x_isSet = true;
}

bool OAIUser_ResponseCompound::is_s_department_name_x_Set() const{
    return m_s_department_name_x_isSet;
}

bool OAIUser_ResponseCompound::is_s_department_name_x_Valid() const{
    return m_s_department_name_x_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void OAIUser_ResponseCompound::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

QString OAIUser_ResponseCompound::getSTimezoneName() const {
    return m_s_timezone_name;
}
void OAIUser_ResponseCompound::setSTimezoneName(const QString &s_timezone_name) {
    m_s_timezone_name = s_timezone_name;
    m_s_timezone_name_isSet = true;
}

bool OAIUser_ResponseCompound::is_s_timezone_name_Set() const{
    return m_s_timezone_name_isSet;
}

bool OAIUser_ResponseCompound::is_s_timezone_name_Valid() const{
...
QString OAIUser_ResponseCompound::getSLanguageNameX() const {
    return m_s_language_name_x;
}
void OAIUser_ResponseCompound::setSLanguageNameX(const QString &s_language_name_x) {
    m_s_language_name_x = s_language_name_x;
    m_s_language_name_x_isSet = true;
}

bool OAIUser_ResponseCompound::is_s_language_name_x_Set() const{
    return m_s_language_name_x_isSet;
}

bool OAIUser_ResponseCompound::is_s_language_name_x_Valid() const{
    return m_s_language_name_x_isValid;
}

OAIEmail_ResponseCompound OAIUser_ResponseCompound::getObjEmail() const {
    return m_obj_email;
}
void OAIUser_ResponseCompound::setObjEmail(const OAIEmail_ResponseCompound &obj_email) {
    m_obj_email = obj_email;
    m_obj_email_isSet = true;
}

bool OAIUser_ResponseCompound::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool OAIUser_ResponseCompound::is_obj_email_Valid() const{
    return m_obj_email_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiBillingentityinternalId() const {
    return m_fki_billingentityinternal_id;
}
void OAIUser_ResponseCompound::setFkiBillingentityinternalId(const qint32 &fki_billingentityinternal_id) {
    m_fki_billingentityinternal_id = fki_billingentityinternal_id;
    m_fki_billingentityinternal_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_billingentityinternal_id_Set() const{
    return m_fki_billingentityinternal_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_billingentityinternal_id_Valid() const{
    return m_fki_billingentityinternal_id_isValid;
}

QString OAIUser_ResponseCompound::getSBillingentityinternalDescriptionX() const {
    return m_s_billingentityinternal_description_x;
}
void OAIUser_ResponseCompound::setSBillingentityinternalDescriptionX(const QString &s_billingentityinternal_description_x) {
...
bool OAIUser_ResponseCompound::is_s_billingentityinternal_description_x_Set() const{
    return m_s_billingentityinternal_description_x_isSet;
}

bool OAIUser_ResponseCompound::is_s_billingentityinternal_description_x_Valid() const{
    return m_s_billingentityinternal_description_x_isValid;
}

OAIPhone_ResponseCompound OAIUser_ResponseCompound::getObjPhoneHome() const {
    return m_obj_phone_home;
}
void OAIUser_ResponseCompound::setObjPhoneHome(const OAIPhone_ResponseCompound &obj_phone_home) {
    m_obj_phone_home = obj_phone_home;
    m_obj_phone_home_isSet = true;
}

bool OAIUser_ResponseCompound::is_obj_phone_home_Set() const{
    return m_obj_phone_home_isSet;
}

bool OAIUser_ResponseCompound::is_obj_phone_home_Valid() const{
    return m_obj_phone_home_isValid;
}

OAIPhone_ResponseCompound OAIUser_ResponseCompound::getObjPhoneSms() const {
    return m_obj_phone_sms;
}
void OAIUser_ResponseCompound::setObjPhoneSms(const OAIPhone_ResponseCompound &obj_phone_sms) {
    m_obj_phone_sms = obj_phone_sms;
    m_obj_phone_sms_isSet = true;
}

bool OAIUser_ResponseCompound::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool OAIUser_ResponseCompound::is_obj_phone_sms_Valid() const{
    return m_obj_phone_sms_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void OAIUser_ResponseCompound::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool OAIUser_ResponseCompound::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

qint32 OAIUser_ResponseCompound::getFkiModuleIdForm() const {
    return m_fki_module_id_form;
}
void OAIUser_ResponseCompound::setFkiModuleIdForm(const qint32 &fki_module_id_form) {
    m_fki_module_id_form = fki_module_id_form;
    m_fki_module_id_form_isSet = true;
}

bool OAIUser_ResponseCompound::is_fki_module_id_form_Set() const{
    return m_fki_module_id_form_isSet;
}

bool OAIUser_ResponseCompound::is_fki_module_id_form_Valid() const{
    return m_fki_module_id_form_isValid;
}

QString OAIUser_ResponseCompound::getSModuleNameX() const {
    return m_s_module_name_x;
}
void OAIUser_ResponseCompound::setSModuleNameX(const QString &s_module_name_x) {
    m_s_module_name_x = s_module_name_x;
    m_s_module_name_x_isSet = true;
}

bool OAIUser_ResponseCompound::is_s_module_name_x_Set() const{
    return m_s_module_name_x_isSet;
}

bool OAIUser_ResponseCompound::is_s_module_name_x_Valid() const{
    return m_s_module_name_x_isValid;
}

OAIField_eUserOrigin OAIUser_ResponseCompound::getEUserOrigin() const {
    return m_e_user_origin;
}
void OAIUser_ResponseCompound::setEUserOrigin(const OAIField_eUserOrigin &e_user_origin) {
    m_e_user_origin = e_user_origin;
    m_e_user_origin_isSet = true;
}

bool OAIUser_ResponseCompound::is_e_user_origin_Set() const{
    return m_e_user_origin_isSet;
}

bool OAIUser_ResponseCompound::is_e_user_origin_Valid() const{
...
OAIField_eUserLogintype OAIUser_ResponseCompound::getEUserLogintype() const {
    return m_e_user_logintype;
}
void OAIUser_ResponseCompound::setEUserLogintype(const OAIField_eUserLogintype &e_user_logintype) {
    m_e_user_logintype = e_user_logintype;
    m_e_user_logintype_isSet = true;
}

bool OAIUser_ResponseCompound::is_e_user_logintype_Set() const{
    return m_e_user_logintype_isSet;
}

bool OAIUser_ResponseCompound::is_e_user_logintype_Valid() const{
...
OAIField_eUserEzsignaccess OAIUser_ResponseCompound::getEUserEzsignaccess() const {
    return m_e_user_ezsignaccess;
}
void OAIUser_ResponseCompound::setEUserEzsignaccess(const OAIField_eUserEzsignaccess &e_user_ezsignaccess) {
    m_e_user_ezsignaccess = e_user_ezsignaccess;
    m_e_user_ezsignaccess_isSet = true;
}

bool OAIUser_ResponseCompound::is_e_user_ezsignaccess_Set() const{
    return m_e_user_ezsignaccess_isSet;
}

bool OAIUser_ResponseCompound::is_e_user_ezsignaccess_Valid() const{
    return m_e_user_ezsignaccess_isValid;
}

QString OAIUser_ResponseCompound::getDtUserLastlogondate() const {
    return m_dt_user_lastlogondate;
}
void OAIUser_ResponseCompound::setDtUserLastlogondate(const QString &dt_user_lastlogondate) {
    m_dt_user_lastlogondate = dt_user_lastlogondate;
    m_dt_user_lastlogondate_isSet = true;
}

bool OAIUser_ResponseCompound::is_dt_user_lastlogondate_Set() const{
    return m_dt_user_lastlogondate_isSet;
}

bool OAIUser_ResponseCompound::is_dt_user_lastlogondate_Valid() const{
    return m_dt_user_lastlogondate_isValid;
}

QString OAIUser_ResponseCompound::getDtUserPasswordchanged() const {
    return m_dt_user_passwordchanged;
}
void OAIUser_ResponseCompound::setDtUserPasswordchanged(const QString &dt_user_passwordchanged) {
    m_dt_user_passwordchanged = dt_user_passwordchanged;
    m_dt_user_passwordchanged_isSet = true;
}

bool OAIUser_ResponseCompound::is_dt_user_passwordchanged_Set() const{
    return m_dt_user_passwordchanged_isSet;
}

bool OAIUser_ResponseCompound::is_dt_user_passwordchanged_Valid() const{
    return m_dt_user_passwordchanged_isValid;
}

QString OAIUser_ResponseCompound::getDtUserEzsignprepaidexpiration() const {
    return m_dt_user_ezsignprepaidexpiration;
}
void OAIUser_ResponseCompound::setDtUserEzsignprepaidexpiration(const QString &dt_user_ezsignprepaidexpiration) {
    m_dt_user_ezsignprepaidexpiration = dt_user_ezsignprepaidexpiration;
    m_dt_user_ezsignprepaidexpiration_isSet = true;
}

bool OAIUser_ResponseCompound::is_dt_user_ezsignprepaidexpiration_Set() const{
    return m_dt_user_ezsignprepaidexpiration_isSet;
}

bool OAIUser_ResponseCompound::is_dt_user_ezsignprepaidexpiration_Valid() const{
    return m_dt_user_ezsignprepaidexpiration_isValid;
}

bool OAIUser_ResponseCompound::isBUserIsactive() const {
    return m_b_user_isactive;
}
void OAIUser_ResponseCompound::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool OAIUser_ResponseCompound::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool OAIUser_ResponseCompound::is_b_user_isactive_Valid() const{
    return m_b_user_isactive_isValid;
}

bool OAIUser_ResponseCompound::isBUserValidatebyadministration() const {
    return m_b_user_validatebyadministration;
}
void OAIUser_ResponseCompound::setBUserValidatebyadministration(const bool &b_user_validatebyadministration) {
    m_b_user_validatebyadministration = b_user_validatebyadministration;
    m_b_user_validatebyadministration_isSet = true;
}

bool OAIUser_ResponseCompound::is_b_user_validatebyadministration_Set() const{
    return m_b_user_validatebyadministration_isSet;
}

bool OAIUser_ResponseCompound::is_b_user_validatebyadministration_Valid() const{
    return m_b_user_validatebyadministration_isValid;
}

bool OAIUser_ResponseCompound::isBUserValidatebydirector() const {
    return m_b_user_validatebydirector;
}
void OAIUser_ResponseCompound::setBUserValidatebydirector(const bool &b_user_validatebydirector) {
    m_b_user_validatebydirector = b_user_validatebydirector;
    m_b_user_validatebydirector_isSet = true;
}

bool OAIUser_ResponseCompound::is_b_user_validatebydirector_Set() const{
    return m_b_user_validatebydirector_isSet;
}

bool OAIUser_ResponseCompound::is_b_user_validatebydirector_Valid() const{
    return m_b_user_validatebydirector_isValid;
}

bool OAIUser_ResponseCompound::isBUserAttachmentautoverified() const {
    return m_b_user_attachmentautoverified;
}
void OAIUser_ResponseCompound::setBUserAttachmentautoverified(const bool &b_user_attachmentautoverified) {
    m_b_user_attachmentautoverified = b_user_attachmentautoverified;
    m_b_user_attachmentautoverified_isSet = true;
}

bool OAIUser_ResponseCompound::is_b_user_attachmentautoverified_Set() const{
    return m_b_user_attachmentautoverified_isSet;
}

bool OAIUser_ResponseCompound::is_b_user_attachmentautoverified_Valid() const{
    return m_b_user_attachmentautoverified_isValid;
}

bool OAIUser_ResponseCompound::isBUserChangepassword() const {
    return m_b_user_changepassword;
}
void OAIUser_ResponseCompound::setBUserChangepassword(const bool &b_user_changepassword) {
    m_b_user_changepassword = b_user_changepassword;
    m_b_user_changepassword_isSet = true;
}

bool OAIUser_ResponseCompound::is_b_user_changepassword_Set() const{
    return m_b_user_changepassword_isSet;
}

bool OAIUser_ResponseCompound::is_b_user_changepassword_Valid() const{
