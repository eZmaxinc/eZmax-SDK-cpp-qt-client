...
/*
 * OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsigsignature/getEzsignsignaturesAutomatic
 */

#ifndef OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
#define OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
...
class OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload();
    OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload(QString json);
    ~OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload)

#endif // OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
