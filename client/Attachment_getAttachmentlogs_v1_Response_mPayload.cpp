...
Attachment_getAttachmentlogs_v1_Response_mPayload::Attachment_getAttachmentlogs_v1_Response_mPayload(const QString &json) {
...
void Attachment_getAttachmentlogs_v1_Response_mPayload::fromJson(const QString &jsonString) {
