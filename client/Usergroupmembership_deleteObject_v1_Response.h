...
/*
 * Usergroupmembership_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroupmembership/{pkiUsergroupmembershipID}
 */

#ifndef Usergroupmembership_deleteObject_v1_Response_H
#define Usergroupmembership_deleteObject_v1_Response_H
...
class Usergroupmembership_deleteObject_v1_Response : public Object {
public:
    Usergroupmembership_deleteObject_v1_Response();
    Usergroupmembership_deleteObject_v1_Response(const QString &json);
    ~Usergroupmembership_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupmembership_deleteObject_v1_Response)

#endif // Usergroupmembership_deleteObject_v1_Response_H
