...
/*
 * Ezsignsignaturecustomdate_ResponseCompoundV2.h
 *
 * An Ezsignsignaturecustomdate Object and children to create a complete structure
 */

#ifndef Ezsignsignaturecustomdate_ResponseCompoundV2_H
#define Ezsignsignaturecustomdate_ResponseCompoundV2_H
...
class Ezsignsignaturecustomdate_ResponseCompoundV2 : public Object {
public:
    Ezsignsignaturecustomdate_ResponseCompoundV2();
    Ezsignsignaturecustomdate_ResponseCompoundV2(const QString &json);
    ~Ezsignsignaturecustomdate_ResponseCompoundV2() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturecustomdate_ResponseCompoundV2)

#endif // Ezsignsignaturecustomdate_ResponseCompoundV2_H
