...
void OAIEzsigntemplatepackagemembership_createObject_v1_Response_mPayload::fromJsonObject(QJsonObject json) {
    ...
    m_a_pki_ezsigntemplatepackagemembership_id_isValid = ::OpenAPI::fromJsonValue(a_pki_ezsigntemplatepackagemembership_id, json[QString("a_pkiEzsigntemplatepackagemembershipID")]);
...
QJsonObject OAIEzsigntemplatepackagemembership_createObject_v1_Response_mPayload::asJsonObject() const {
    QJsonObject obj;
    if (a_pki_ezsigntemplatepackagemembership_id.size() > 0) {
        obj.insert(QString("a_pkiEzsigntemplatepackagemembershipID"), ::OpenAPI::toJsonValue(a_pki_ezsigntemplatepackagemembership_id));
    }
...
QList<qint32> OAIEzsigntemplatepackagemembership_createObject_v1_Response_mPayload::getAPkiEzsigntemplatepackagemembershipId() const {
    return a_pki_ezsigntemplatepackagemembership_id;
}
void OAIEzsigntemplatepackagemembership_createObject_v1_Response_mPayload::setAPkiEzsigntemplatepackagemembershipId(const QList<qint32> &a_pki_ezsigntemplatepackagemembership_id) {
    this->a_pki_ezsigntemplatepackagemembership_id = a_pki_ezsigntemplatepackagemembership_id;
    this->m_a_pki_ezsigntemplatepackagemembership_id_isSet = true;
}
