...
bool Systemconfiguration_ResponseCompound::isBSystemconfigurationAllowcomplexcreditcardsignature() const {
    return m_b_systemconfiguration_allowcomplexcreditcardsignature;
}
void Systemconfiguration_ResponseCompound::setBSystemconfigurationAllowcomplexcreditcardsignature(const bool &b_systemconfiguration_allowcomplexcreditcardsignature) {
...
bool Systemconfiguration_ResponseCompound::is_b_systemconfiguration_allowcomplexcreditcardsignature_Set() const{
    return m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet;
}

bool Systemconfiguration_ResponseCompound::is_b_systemconfiguration_allowcomplexcreditcardsignature_Valid() const{
