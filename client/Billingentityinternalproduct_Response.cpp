...
Billingentityinternalproduct_Response::Billingentityinternalproduct_Response(const QString &json) {
...
void Billingentityinternalproduct_Response::fromJson(const QString &jsonString) {
