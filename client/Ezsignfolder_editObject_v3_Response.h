...
/*
 * Ezsignfolder_editObject_v3_Response.h
 *
 * Response for PUT /3/object/ezsignfolder/{pkiEzsignfolderID}
 */

#ifndef Ezsignfolder_editObject_v3_Response_H
#define Ezsignfolder_editObject_v3_Response_H
...
class Ezsignfolder_editObject_v3_Response : public Object {
public:
    Ezsignfolder_editObject_v3_Response();
    Ezsignfolder_editObject_v3_Response(const QString &json);
    ~Ezsignfolder_editObject_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_editObject_v3_Response)

#endif // Ezsignfolder_editObject_v3_Response_H
