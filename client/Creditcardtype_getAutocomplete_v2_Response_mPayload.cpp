...
Creditcardtype_getAutocomplete_v2_Response_mPayload::Creditcardtype_getAutocomplete_v2_Response_mPayload(const QString &json) {
...
void Creditcardtype_getAutocomplete_v2_Response_mPayload::fromJson(const QString &jsonString) {
