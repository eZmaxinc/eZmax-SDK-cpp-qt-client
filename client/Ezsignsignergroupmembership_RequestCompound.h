...
/*
 * Ezsignsignergroupmembership_RequestCompound.h
 *
 * A Ezsignsignergroupmembership Object and children
 */

#ifndef Ezsignsignergroupmembership_RequestCompound_H
#define Ezsignsignergroupmembership_RequestCompound_H
...
class Ezsignsignergroupmembership_RequestCompound : public Object {
public:
    Ezsignsignergroupmembership_RequestCompound();
    Ezsignsignergroupmembership_RequestCompound(const QString &json);
    ~Ezsignsignergroupmembership_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignergroupmembership_RequestCompound)

#endif // Ezsignsignergroupmembership_RequestCompound_H
