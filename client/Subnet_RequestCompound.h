...
/*
 * Subnet_RequestCompound.h
 *
 * A Subnet Object and children
 */

#ifndef Subnet_RequestCompound_H
#define Subnet_RequestCompound_H
...
class Subnet_RequestCompound : public Object {
public:
    Subnet_RequestCompound();
    Subnet_RequestCompound(const QString &json);
    ~Subnet_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Subnet_RequestCompound)

#endif // Subnet_RequestCompound_H
