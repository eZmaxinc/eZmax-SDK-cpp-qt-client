...
/*
 * Descriptionstatic_ResponseCompound.h
 *
 * A Descriptionstatic Object and children to create a complete structure
 */

#ifndef Descriptionstatic_ResponseCompound_H
#define Descriptionstatic_ResponseCompound_H
...
class Descriptionstatic_ResponseCompound : public Object {
public:
    Descriptionstatic_ResponseCompound();
    Descriptionstatic_ResponseCompound(QString json);
    ~Descriptionstatic_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Descriptionstatic_ResponseCompound)

#endif // Descriptionstatic_ResponseCompound_H
