...
/*
 * Attachment_ResponseCompound.h
 *
 * A Attachment Object
 */

#ifndef Attachment_ResponseCompound_H
#define Attachment_ResponseCompound_H
...
class Attachment_ResponseCompound : public Object {
public:
    Attachment_ResponseCompound();
    Attachment_ResponseCompound(const QString &json);
    ~Attachment_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Attachment_ResponseCompound)

#endif // Attachment_ResponseCompound_H
