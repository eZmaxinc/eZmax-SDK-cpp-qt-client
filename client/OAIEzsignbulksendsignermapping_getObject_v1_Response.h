...
/*
 * OAIEzsignbulksendsignermapping_getObject_v1_Response.h
 *
 * Response for GET /1/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}
 */

#ifndef OAIEzsignbulksendsignermapping_getObject_v1_Response_H
#define OAIEzsignbulksendsignermapping_getObject_v1_Response_H
...
class OAIEzsignbulksendsignermapping_getObject_v1_Response : public OAIObject {
public:
    OAIEzsignbulksendsignermapping_getObject_v1_Response();
    OAIEzsignbulksendsignermapping_getObject_v1_Response(QString json);
    ~OAIEzsignbulksendsignermapping_getObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsignbulksendsignermapping_getObject_v1_Response)

#endif // OAIEzsignbulksendsignermapping_getObject_v1_Response_H
