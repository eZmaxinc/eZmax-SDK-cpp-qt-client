...
OAIPaymentterm_createObject_v1_Request::OAIPaymentterm_createObject_v1_Request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentterm_createObject_v1_Request::OAIPaymentterm_createObject_v1_Request() {
    this->initializeModel();
}

OAIPaymentterm_createObject_v1_Request::~OAIPaymentterm_createObject_v1_Request() {}

void OAIPaymentterm_createObject_v1_Request::initializeModel() {

    m_a_obj_paymentterm_isSet = false;
    m_a_obj_paymentterm_isValid = false;
}

void OAIPaymentterm_createObject_v1_Request::fromJson(QString jsonString) {
...
QString OAIPaymentterm_createObject_v1_Request::asJson() const {
...
bool OAIPaymentterm_createObject_v1_Request::is_a_obj_paymentterm_Valid() const{
...
bool OAIPaymentterm_createObject_v1_Request::isValid() const {
