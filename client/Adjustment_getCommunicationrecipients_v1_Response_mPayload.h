...
/*
 * Adjustment_getCommunicationrecipients_v1_Response_mPayload.h
 *
 * Response for GET /1/object/adjustment/{pkiAdjustmentID}/getCommunicationrecipients
 */

#ifndef Adjustment_getCommunicationrecipients_v1_Response_mPayload_H
#define Adjustment_getCommunicationrecipients_v1_Response_mPayload_H
...
class Adjustment_getCommunicationrecipients_v1_Response_mPayload : public Object {
public:
    Adjustment_getCommunicationrecipients_v1_Response_mPayload();
    Adjustment_getCommunicationrecipients_v1_Response_mPayload(const QString &json);
    ~Adjustment_getCommunicationrecipients_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Adjustment_getCommunicationrecipients_v1_Response_mPayload)

#endif // Adjustment_getCommunicationrecipients_v1_Response_mPayload_H
