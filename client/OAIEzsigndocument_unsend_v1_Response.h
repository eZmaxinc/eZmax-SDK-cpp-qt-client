...
/*
 * OAIEzsigndocument_unsend_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/unsend
 */

#ifndef OAIEzsigndocument_unsend_v1_Response_H
#define OAIEzsigndocument_unsend_v1_Response_H
...
class OAIEzsigndocument_unsend_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_unsend_v1_Response();
    OAIEzsigndocument_unsend_v1_Response(QString json);
    ~OAIEzsigndocument_unsend_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_unsend_v1_Response)

#endif // OAIEzsigndocument_unsend_v1_Response_H
