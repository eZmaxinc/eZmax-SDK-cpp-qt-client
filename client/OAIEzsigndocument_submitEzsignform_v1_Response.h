...
/*
 * OAIEzsigndocument_submitEzsignform_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/submitEzsignform
 */

#ifndef OAIEzsigndocument_submitEzsignform_v1_Response_H
#define OAIEzsigndocument_submitEzsignform_v1_Response_H
...
class OAIEzsigndocument_submitEzsignform_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_submitEzsignform_v1_Response();
    OAIEzsigndocument_submitEzsignform_v1_Response(QString json);
    ~OAIEzsigndocument_submitEzsignform_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_submitEzsignform_v1_Response)

#endif // OAIEzsigndocument_submitEzsignform_v1_Response_H
