...
/*
 * Attempt_ResponseCompound.h
 *
 * An Attempt object and children to create a complete structure
 */

#ifndef Attempt_ResponseCompound_H
#define Attempt_ResponseCompound_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Attempt_ResponseCompound)

#endif // Attempt_ResponseCompound_H
