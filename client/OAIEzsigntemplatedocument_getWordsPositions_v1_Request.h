...
/*
 * OAIEzsigntemplatedocument_getWordsPositions_v1_Request.h
 *
 * Request for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions
 */

#ifndef OAIEzsigntemplatedocument_getWordsPositions_v1_Request_H
#define OAIEzsigntemplatedocument_getWordsPositions_v1_Request_H
...
class OAIEzsigntemplatedocument_getWordsPositions_v1_Request : public OAIObject {
public:
    OAIEzsigntemplatedocument_getWordsPositions_v1_Request();
    OAIEzsigntemplatedocument_getWordsPositions_v1_Request(QString json);
    ~OAIEzsigntemplatedocument_getWordsPositions_v1_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatedocument_getWordsPositions_v1_Request)

#endif // OAIEzsigntemplatedocument_getWordsPositions_v1_Request_H
