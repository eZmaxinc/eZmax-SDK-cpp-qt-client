...
/*
 * Apikey_getCors_v1_Response.h
 *
 * Response for GET /1/object/apikey/{pkiApikeyID}/getCors
 */

#ifndef Apikey_getCors_v1_Response_H
#define Apikey_getCors_v1_Response_H
...
class Apikey_getCors_v1_Response_mPayload;

class Apikey_getCors_v1_Response : public Object {
public:
    Apikey_getCors_v1_Response();
    Apikey_getCors_v1_Response(const QString &json);
    ~Apikey_getCors_v1_Response() override;
    ...
    Apikey_getCors_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Apikey_getCors_v1_Response_mPayload &m_payload);
...
private:
    ...
    Apikey_getCors_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Apikey_getCors_v1_Response)

#endif // Apikey_getCors_v1_Response_H
