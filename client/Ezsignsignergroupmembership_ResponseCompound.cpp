...
Ezsignsignergroupmembership_ResponseCompound::Ezsignsignergroupmembership_ResponseCompound(const QString &json) {
...
void Ezsignsignergroupmembership_ResponseCompound::fromJson(const QString &jsonString) {
