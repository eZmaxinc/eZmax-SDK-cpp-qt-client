...
Ezsigntemplatepackage_RequestCompound::Ezsigntemplatepackage_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsigntemplatepackage_RequestCompound::Ezsigntemplatepackage_RequestCompound() {
    this->initializeModel();
}

Ezsigntemplatepackage_RequestCompound::~Ezsigntemplatepackage_RequestCompound() {}

void Ezsigntemplatepackage_RequestCompound::initializeModel() {
...
void Ezsigntemplatepackage_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsigntemplatepackage_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsigntemplatepackage_RequestCompound::asJson() const {
...
QJsonObject Ezsigntemplatepackage_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsigntemplatepackage_RequestCompound::getPkiEzsigntemplatepackageId() const {
    return m_pki_ezsigntemplatepackage_id;
}
void Ezsigntemplatepackage_RequestCompound::setPkiEzsigntemplatepackageId(const qint32 &pki_ezsigntemplatepackage_id) {
    m_pki_ezsigntemplatepackage_id = pki_ezsigntemplatepackage_id;
    m_pki_ezsigntemplatepackage_id_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_pki_ezsigntemplatepackage_id_Set() const{
    return m_pki_ezsigntemplatepackage_id_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_pki_ezsigntemplatepackage_id_Valid() const{
    return m_pki_ezsigntemplatepackage_id_isValid;
}

qint32 Ezsigntemplatepackage_RequestCompound::getFkiEzsignfoldertypeId() const {
    return m_fki_ezsignfoldertype_id;
}
void Ezsigntemplatepackage_RequestCompound::setFkiEzsignfoldertypeId(const qint32 &fki_ezsignfoldertype_id) {
    m_fki_ezsignfoldertype_id = fki_ezsignfoldertype_id;
    m_fki_ezsignfoldertype_id_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_ezsignfoldertype_id_Set() const{
    return m_fki_ezsignfoldertype_id_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_ezsignfoldertype_id_Valid() const{
    return m_fki_ezsignfoldertype_id_isValid;
}

qint32 Ezsigntemplatepackage_RequestCompound::getFkiEzdoctemplatedocumentId() const {
    return m_fki_ezdoctemplatedocument_id;
}
void Ezsigntemplatepackage_RequestCompound::setFkiEzdoctemplatedocumentId(const qint32 &fki_ezdoctemplatedocument_id) {
    m_fki_ezdoctemplatedocument_id = fki_ezdoctemplatedocument_id;
    m_fki_ezdoctemplatedocument_id_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_ezdoctemplatedocument_id_Set() const{
    return m_fki_ezdoctemplatedocument_id_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_ezdoctemplatedocument_id_Valid() const{
    return m_fki_ezdoctemplatedocument_id_isValid;
}

qint32 Ezsigntemplatepackage_RequestCompound::getFkiLanguageId() const {
    return m_fki_language_id;
}
void Ezsigntemplatepackage_RequestCompound::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

QString Ezsigntemplatepackage_RequestCompound::getSEzsigntemplatepackageDescription() const {
    return m_s_ezsigntemplatepackage_description;
}
void Ezsigntemplatepackage_RequestCompound::setSEzsigntemplatepackageDescription(const QString &s_ezsigntemplatepackage_description) {
...
bool Ezsigntemplatepackage_RequestCompound::is_s_ezsigntemplatepackage_description_Set() const{
    return m_s_ezsigntemplatepackage_description_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_s_ezsigntemplatepackage_description_Valid() const{
    return m_s_ezsigntemplatepackage_description_isValid;
}

bool Ezsigntemplatepackage_RequestCompound::isBEzsigntemplatepackageAdminonly() const {
    return m_b_ezsigntemplatepackage_adminonly;
}
void Ezsigntemplatepackage_RequestCompound::setBEzsigntemplatepackageAdminonly(const bool &b_ezsigntemplatepackage_adminonly) {
    m_b_ezsigntemplatepackage_adminonly = b_ezsigntemplatepackage_adminonly;
    m_b_ezsigntemplatepackage_adminonly_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_b_ezsigntemplatepackage_adminonly_Set() const{
    return m_b_ezsigntemplatepackage_adminonly_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_b_ezsigntemplatepackage_adminonly_Valid() const{
    return m_b_ezsigntemplatepackage_adminonly_isValid;
}

bool Ezsigntemplatepackage_RequestCompound::isBEzsigntemplatepackageIsactive() const {
    return m_b_ezsigntemplatepackage_isactive;
}
void Ezsigntemplatepackage_RequestCompound::setBEzsigntemplatepackageIsactive(const bool &b_ezsigntemplatepackage_isactive) {
    m_b_ezsigntemplatepackage_isactive = b_ezsigntemplatepackage_isactive;
    m_b_ezsigntemplatepackage_isactive_isSet = true;
}

bool Ezsigntemplatepackage_RequestCompound::is_b_ezsigntemplatepackage_isactive_Set() const{
    return m_b_ezsigntemplatepackage_isactive_isSet;
}

bool Ezsigntemplatepackage_RequestCompound::is_b_ezsigntemplatepackage_isactive_Valid() const{
    return m_b_ezsigntemplatepackage_isactive_isValid;
}

bool Ezsigntemplatepackage_RequestCompound::isSet() const {
...
bool Ezsigntemplatepackage_RequestCompound::isValid() const {
