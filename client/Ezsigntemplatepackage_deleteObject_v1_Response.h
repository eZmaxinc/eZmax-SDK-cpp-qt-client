...
/*
 * Ezsigntemplatepackage_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}
 */

#ifndef Ezsigntemplatepackage_deleteObject_v1_Response_H
#define Ezsigntemplatepackage_deleteObject_v1_Response_H
...
class Ezsigntemplatepackage_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplatepackage_deleteObject_v1_Response();
    Ezsigntemplatepackage_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplatepackage_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackage_deleteObject_v1_Response)

#endif // Ezsigntemplatepackage_deleteObject_v1_Response_H
