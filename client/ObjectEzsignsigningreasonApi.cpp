...
ObjectEzsignsigningreasonApi::ObjectEzsignsigningreasonApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectEzsignsigningreasonApi::~ObjectEzsignsigningreasonApi() {
}

void ObjectEzsignsigningreasonApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("ezsignsigningreasonCreateObjectV1", defaultConf);
    _serverIndices.insert("ezsignsigningreasonCreateObjectV1", 0);
    _serverConfigs.insert("ezsignsigningreasonEditObjectV1", defaultConf);
    _serverIndices.insert("ezsignsigningreasonEditObjectV1", 0);
    _serverConfigs.insert("ezsignsigningreasonGetAutocompleteV2", defaultConf);
    _serverIndices.insert("ezsignsigningreasonGetAutocompleteV2", 0);
    _serverConfigs.insert("ezsignsigningreasonGetListV1", defaultConf);
    _serverIndices.insert("ezsignsigningreasonGetListV1", 0);
    _serverConfigs.insert("ezsignsigningreasonGetObjectV2", defaultConf);
    _serverIndices.insert("ezsignsigningreasonGetObjectV2", 0);
}
 ...
 */
int ObjectEzsignsigningreasonApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectEzsignsigningreasonApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectEzsignsigningreasonApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectEzsignsigningreasonApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectEzsignsigningreasonApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectEzsignsigningreasonApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectEzsignsigningreasonApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectEzsignsigningreasonApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectEzsignsigningreasonApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectEzsignsigningreasonApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectEzsignsigningreasonApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectEzsignsigningreasonApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectEzsignsigningreasonApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectEzsignsigningreasonApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectEzsignsigningreasonApi::enableResponseCompression() {
...
QString ObjectEzsignsigningreasonApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectEzsignsigningreasonApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonCreateObjectV1(const Ezsignsigningreason_createObject_v1_Request &ezsignsigningreason_create_object_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsignsigningreasonCreateObjectV1"][_serverIndices.value("ezsignsigningreasonCreateObjectV1")].URL()+"/1/object/ezsignsigningreason");
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonCreateObjectV1Callback(HttpRequestWorker *worker) {
    ...
    Ezsignsigningreason_createObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonEditObjectV1(const qint32 &pki_ezsignsigningreason_id, const Ezsignsigningreason_editObject_v1_Request &ezsignsigningreason_edit_object_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsignsigningreasonEditObjectV1"][_serverIndices.value("ezsignsigningreasonEditObjectV1")].URL()+"/1/object/ezsignsigningreason/{pkiEzsignsigningreasonID}");
    ...
    {
        QString pki_ezsignsigningreason_idPathParam("{");
        pki_ezsignsigningreason_idPathParam.append("pkiEzsignsigningreasonID").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "pkiEzsignsigningreasonID", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"pkiEzsignsigningreasonID"+pathSuffix : pathPrefix;
        fullPath.replace(pki_ezsignsigningreason_idPathParam, paramString+QUrl::toPercentEncoding(::Ezmaxapi::toStringValue(pki_ezsignsigningreason_id)));
    }
    HttpRequestWorker *worker = new HttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonEditObjectV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsigningreason_editObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
    QString fullPath = QString(_serverConfigs["ezsignsigningreasonGetAutocompleteV2"][_serverIndices.value("ezsignsigningreasonGetAutocompleteV2")].URL()+"/2/object/ezsignsigningreason/getAutocomplete/{sSelector}");
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsigningreason_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    QString fullPath = QString(_serverConfigs["ezsignsigningreasonGetListV1"][_serverIndices.value("ezsignsigningreasonGetListV1")].URL()+"/1/object/ezsignsigningreason/getList");
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetListV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsigningreason_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetObjectV2(const qint32 &pki_ezsignsigningreason_id) {
    QString fullPath = QString(_serverConfigs["ezsignsigningreasonGetObjectV2"][_serverIndices.value("ezsignsigningreasonGetObjectV2")].URL()+"/2/object/ezsignsigningreason/{pkiEzsignsigningreasonID}");
...
void ObjectEzsignsigningreasonApi::ezsignsigningreasonGetObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsigningreason_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignsigningreasonApi::tokenAvailable() {
