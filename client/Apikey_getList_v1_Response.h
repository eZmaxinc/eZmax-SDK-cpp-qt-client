...
/*
 * Apikey_getList_v1_Response.h
 *
 * Response for GET /1/object/apikey/getList
 */

#ifndef Apikey_getList_v1_Response_H
#define Apikey_getList_v1_Response_H
...
class Apikey_getList_v1_Response_mPayload;

class Apikey_getList_v1_Response : public Object {
public:
    Apikey_getList_v1_Response();
    Apikey_getList_v1_Response(const QString &json);
    ~Apikey_getList_v1_Response() override;
    ...
    Apikey_getList_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Apikey_getList_v1_Response_mPayload &m_payload);
...
private:
    ...
    Apikey_getList_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Apikey_getList_v1_Response)

#endif // Apikey_getList_v1_Response_H
