...
Ezsignformfield_RequestCompound::Ezsignformfield_RequestCompound(const QString &json) {
...
void Ezsignformfield_RequestCompound::fromJson(const QString &jsonString) {
