...
Billingentityinternalproduct_ResponseCompound::Billingentityinternalproduct_ResponseCompound(QString json) {
...
void Billingentityinternalproduct_ResponseCompound::fromJson(QString jsonString) {
