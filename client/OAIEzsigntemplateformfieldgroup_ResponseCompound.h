...
private:
    ...
    QList<OAIEzsigntemplateformfieldgroupsigner_ResponseCompound> m_a_obj_ezsigntemplateformfieldgroupsigner;
    bool m_a_obj_ezsigntemplateformfieldgroupsigner_isSet;
    bool m_a_obj_ezsigntemplateformfieldgroupsigner_isValid;

    QList<OAICustom_DropdownElement_ResponseCompound> m_a_obj_dropdown_element;
    bool m_a_obj_dropdown_element_isSet;
    bool m_a_obj_dropdown_element_isValid;

    QList<OAIEzsigntemplateformfield_ResponseCompound> m_a_obj_ezsigntemplateformfield;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplateformfieldgroup_ResponseCompound)
