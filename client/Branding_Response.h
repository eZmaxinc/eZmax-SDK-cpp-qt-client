...
#ifndef Branding_Response_H
#define Branding_Response_H
...
class Branding_Response : public Object {
public:
    Branding_Response();
    Branding_Response(QString json);
    ~Branding_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_Response)

#endif // Branding_Response_H
