...
#ifndef Ezsignfoldertype_Request_H
#define Ezsignfoldertype_Request_H
...
class Ezsignfoldertype_Request : public Object {
public:
    Ezsignfoldertype_Request();
    Ezsignfoldertype_Request(QString json);
    ~Ezsignfoldertype_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_Request)

#endif // Ezsignfoldertype_Request_H
