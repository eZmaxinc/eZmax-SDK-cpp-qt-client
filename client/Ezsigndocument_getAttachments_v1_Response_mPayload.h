...
/*
 * Ezsigndocument_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getAttachments
 */

#ifndef Ezsigndocument_getAttachments_v1_Response_mPayload_H
#define Ezsigndocument_getAttachments_v1_Response_mPayload_H
...
class Ezsigndocument_getAttachments_v1_Response_mPayload : public Object {
public:
    Ezsigndocument_getAttachments_v1_Response_mPayload();
    Ezsigndocument_getAttachments_v1_Response_mPayload(const QString &json);
    ~Ezsigndocument_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_getAttachments_v1_Response_mPayload)

#endif // Ezsigndocument_getAttachments_v1_Response_mPayload_H
