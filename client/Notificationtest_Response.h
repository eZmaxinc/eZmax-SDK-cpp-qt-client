...
#ifndef Notificationtest_Response_H
#define Notificationtest_Response_H
...
class Notificationtest_Response : public Object {
public:
    Notificationtest_Response();
    Notificationtest_Response(const QString &json);
    ~Notificationtest_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Notificationtest_Response)

#endif // Notificationtest_Response_H
