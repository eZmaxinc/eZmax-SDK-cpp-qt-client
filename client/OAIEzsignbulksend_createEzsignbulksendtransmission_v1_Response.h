...
/*
 * OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response.h
 *
 * Response for POST /1/object/ezsignbulksend/{pkiEzsignbulksendID}/createEzsignbulksendtransmission
 */

#ifndef OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response_H
#define OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response_H
...
class OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response : public OAIObject {
public:
    OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response();
    OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response(QString json);
    ~OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response() override;
...
private:
    ...
    OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response)

#endif // OAIEzsignbulksend_createEzsignbulksendtransmission_v1_Response_H
