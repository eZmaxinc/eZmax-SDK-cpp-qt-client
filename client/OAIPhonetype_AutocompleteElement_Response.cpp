...
OAIPhonetype_AutocompleteElement_Response::OAIPhonetype_AutocompleteElement_Response() {
    this->initializeModel();
}

OAIPhonetype_AutocompleteElement_Response::~OAIPhonetype_AutocompleteElement_Response() {}

void OAIPhonetype_AutocompleteElement_Response::initializeModel() {
...
void OAIPhonetype_AutocompleteElement_Response::fromJson(QString jsonString) {
...
QString OAIPhonetype_AutocompleteElement_Response::asJson() const {
...
bool OAIPhonetype_AutocompleteElement_Response::is_pki_phonetype_id_Valid() const{
...
bool OAIPhonetype_AutocompleteElement_Response::is_s_phonetype_name_x_Valid() const{
...
bool OAIPhonetype_AutocompleteElement_Response::is_b_phonetype_isactive_Valid() const{
    return m_b_phonetype_isactive_isValid;
}

bool OAIPhonetype_AutocompleteElement_Response::isSet() const {
...
bool OAIPhonetype_AutocompleteElement_Response::isValid() const {
