...
/*
 * Discussion_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/discussion/{pkiDiscussionID}
 */

#ifndef Discussion_patchObject_v1_Response_H
#define Discussion_patchObject_v1_Response_H
...
class Discussion_patchObject_v1_Response : public Object {
public:
    Discussion_patchObject_v1_Response();
    Discussion_patchObject_v1_Response(const QString &json);
    ~Discussion_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussion_patchObject_v1_Response)

#endif // Discussion_patchObject_v1_Response_H
