...
Ezsignannotation_editObject_v1_Request::Ezsignannotation_editObject_v1_Request(const QString &json) {
...
void Ezsignannotation_editObject_v1_Request::fromJson(const QString &jsonString) {
