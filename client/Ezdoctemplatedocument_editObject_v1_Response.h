...
/*
 * Ezdoctemplatedocument_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezdoctemplatedocument/{pkiEzdoctemplatedocumentID}
 */

#ifndef Ezdoctemplatedocument_editObject_v1_Response_H
#define Ezdoctemplatedocument_editObject_v1_Response_H
...
class Ezdoctemplatedocument_editObject_v1_Response : public Object {
public:
    Ezdoctemplatedocument_editObject_v1_Response();
    Ezdoctemplatedocument_editObject_v1_Response(const QString &json);
    ~Ezdoctemplatedocument_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezdoctemplatedocument_editObject_v1_Response)

#endif // Ezdoctemplatedocument_editObject_v1_Response_H
