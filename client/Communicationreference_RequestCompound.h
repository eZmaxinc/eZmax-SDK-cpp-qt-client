...
/*
 * Communicationreference_RequestCompound.h
 *
 * A Communicationreference Object and children
 */

#ifndef Communicationreference_RequestCompound_H
#define Communicationreference_RequestCompound_H
...
class Communicationreference_RequestCompound : public Object {
public:
    Communicationreference_RequestCompound();
    Communicationreference_RequestCompound(const QString &json);
    ~Communicationreference_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Communicationreference_RequestCompound)

#endif // Communicationreference_RequestCompound_H
