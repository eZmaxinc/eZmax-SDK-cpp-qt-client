...
/*
 * Ezsigntemplatesignature_editObject_v3_Response.h
 *
 * Response for PUT /3/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef Ezsigntemplatesignature_editObject_v3_Response_H
#define Ezsigntemplatesignature_editObject_v3_Response_H
...
class Ezsigntemplatesignature_editObject_v3_Response : public Object {
public:
    Ezsigntemplatesignature_editObject_v3_Response();
    Ezsigntemplatesignature_editObject_v3_Response(const QString &json);
    ~Ezsigntemplatesignature_editObject_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_editObject_v3_Response)

#endif // Ezsigntemplatesignature_editObject_v3_Response_H
