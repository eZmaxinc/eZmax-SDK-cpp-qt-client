...
/*
 * Custom_AutocompleteElement_Response.h
 *
 * Generic AutocompleteElement Response
 */

#ifndef Custom_AutocompleteElement_Response_H
#define Custom_AutocompleteElement_Response_H
...
class Custom_AutocompleteElement_Response : public Object {
public:
    Custom_AutocompleteElement_Response();
    Custom_AutocompleteElement_Response(QString json);
    ~Custom_AutocompleteElement_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Custom_AutocompleteElement_Response)

#endif // Custom_AutocompleteElement_Response_H
