...
#ifndef _ObjectElectronicfundstransferApi_H
#define _ObjectElectronicfundstransferApi_H
...
class ObjectElectronicfundstransferApi : public QObject {
    Q_OBJECT

public:
    ObjectElectronicfundstransferApi(const int timeOut = 0);
    ...
    */
    ...
    /**
    * @param[in]  pki_electronicfundstransfer_id qint32 [required]
    * @param[in]  electronicfundstransfer_import_into_edm_v1_request Electronicfundstransfer_importIntoEDM_v1_Request [required]
    */
    virtual void electronicfundstransferImportIntoEDMV1(const qint32 &pki_electronicfundstransfer_id, const Electronicfundstransfer_importIntoEDM_v1_Request &electronicfundstransfer_import_into_edm_v1_request);
...
private:
    ...
    void electronicfundstransferImportIntoEDMV1Callback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    Q_DECL_DEPRECATED_X("Use electronicfundstransferImportIntoEDMV1SignalError() instead")
    void electronicfundstransferImportIntoEDMV1SignalE(Electronicfundstransfer_importIntoEDM_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    Q_DECL_DEPRECATED_X("Use electronicfundstransferImportIntoEDMV1SignalErrorFull() instead")
    void electronicfundstransferImportIntoEDMV1SignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void electronicfundstransferImportIntoEDMV1SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
