...
void ObjectElectronicfundstransferApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("electronicfundstransferImportIntoEDMV1", defaultConf);
    _serverIndices.insert("electronicfundstransferImportIntoEDMV1", 0);
}
...
void ObjectElectronicfundstransferApi::electronicfundstransferImportIntoEDMV1(const qint32 &pki_electronicfundstransfer_id, const Electronicfundstransfer_importIntoEDM_v1_Request &electronicfundstransfer_import_into_edm_v1_request) {
    QString fullPath = QString(_serverConfigs["electronicfundstransferImportIntoEDMV1"][_serverIndices.value("electronicfundstransferImportIntoEDMV1")].URL()+"/1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/importIntoEDM");
...

    {
        ...
        QByteArray output = electronicfundstransfer_import_into_edm_v1_request.asJson().toUtf8();
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectElectronicfundstransferApi::electronicfundstransferImportIntoEDMV1Callback);
    connect(this, &ObjectElectronicfundstransferApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectElectronicfundstransferApi::electronicfundstransferImportIntoEDMV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Electronicfundstransfer_importIntoEDM_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT electronicfundstransferImportIntoEDMV1Signal(output);
        Q_EMIT electronicfundstransferImportIntoEDMV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT electronicfundstransferImportIntoEDMV1SignalE(output, error_type, error_str);
        Q_EMIT electronicfundstransferImportIntoEDMV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT electronicfundstransferImportIntoEDMV1SignalError(output, error_type, error_str);
        Q_EMIT electronicfundstransferImportIntoEDMV1SignalErrorFull(worker, error_type, error_str);
    }
}
