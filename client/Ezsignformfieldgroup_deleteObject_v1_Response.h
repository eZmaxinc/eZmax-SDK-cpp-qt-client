...
/*
 * Ezsignformfieldgroup_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}
 */

#ifndef Ezsignformfieldgroup_deleteObject_v1_Response_H
#define Ezsignformfieldgroup_deleteObject_v1_Response_H
...
class Ezsignformfieldgroup_deleteObject_v1_Response : public Object {
public:
    Ezsignformfieldgroup_deleteObject_v1_Response();
    Ezsignformfieldgroup_deleteObject_v1_Response(const QString &json);
    ~Ezsignformfieldgroup_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfieldgroup_deleteObject_v1_Response)

#endif // Ezsignformfieldgroup_deleteObject_v1_Response_H
