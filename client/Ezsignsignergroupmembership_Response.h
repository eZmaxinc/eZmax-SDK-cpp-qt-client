...
#ifndef Ezsignsignergroupmembership_Response_H
#define Ezsignsignergroupmembership_Response_H
...
class Ezsignsignergroupmembership_Response : public Object {
public:
    Ezsignsignergroupmembership_Response();
    Ezsignsignergroupmembership_Response(const QString &json);
    ~Ezsignsignergroupmembership_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignergroupmembership_Response)

#endif // Ezsignsignergroupmembership_Response_H
