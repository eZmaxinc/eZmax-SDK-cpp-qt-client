...
Ezsigntemplate_copy_v1_Response_mPayload::Ezsigntemplate_copy_v1_Response_mPayload(const QString &json) {
...
void Ezsigntemplate_copy_v1_Response_mPayload::fromJson(const QString &jsonString) {
