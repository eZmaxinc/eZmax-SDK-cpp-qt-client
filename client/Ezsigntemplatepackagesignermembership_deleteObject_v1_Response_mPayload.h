...
/*
 * Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload.h
 *
 * Payload for DELETE /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}
 */

#ifndef Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload_H
#define Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload_H
...
class Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload : public Object {
public:
    Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload();
    Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload(const QString &json);
    ~Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload)

#endif // Ezsigntemplatepackagesignermembership_deleteObject_v1_Response_mPayload_H
