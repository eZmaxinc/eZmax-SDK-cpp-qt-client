...
Subnet_RequestCompound::Subnet_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Subnet_RequestCompound::Subnet_RequestCompound() {
    this->initializeModel();
}

Subnet_RequestCompound::~Subnet_RequestCompound() {}

void Subnet_RequestCompound::initializeModel() {
...
void Subnet_RequestCompound::fromJson(const QString &jsonString) {
...
void Subnet_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Subnet_RequestCompound::asJson() const {
...
QJsonObject Subnet_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Subnet_RequestCompound::getPkiSubnetId() const {
    return m_pki_subnet_id;
}
void Subnet_RequestCompound::setPkiSubnetId(const qint32 &pki_subnet_id) {
    m_pki_subnet_id = pki_subnet_id;
    m_pki_subnet_id_isSet = true;
}

bool Subnet_RequestCompound::is_pki_subnet_id_Set() const{
    return m_pki_subnet_id_isSet;
}

bool Subnet_RequestCompound::is_pki_subnet_id_Valid() const{
    return m_pki_subnet_id_isValid;
}

qint32 Subnet_RequestCompound::getFkiUserId() const {
    return m_fki_user_id;
}
void Subnet_RequestCompound::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Subnet_RequestCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Subnet_RequestCompound::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Subnet_RequestCompound::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void Subnet_RequestCompound::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool Subnet_RequestCompound::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool Subnet_RequestCompound::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

Multilingual_SubnetDescription Subnet_RequestCompound::getObjSubnetDescription() const {
    return m_obj_subnet_description;
}
void Subnet_RequestCompound::setObjSubnetDescription(const Multilingual_SubnetDescription &obj_subnet_description) {
    m_obj_subnet_description = obj_subnet_description;
    m_obj_subnet_description_isSet = true;
}

bool Subnet_RequestCompound::is_obj_subnet_description_Set() const{
    return m_obj_subnet_description_isSet;
}

bool Subnet_RequestCompound::is_obj_subnet_description_Valid() const{
    return m_obj_subnet_description_isValid;
}

qint64 Subnet_RequestCompound::getISubnetNetwork() const {
    return m_i_subnet_network;
}
void Subnet_RequestCompound::setISubnetNetwork(const qint64 &i_subnet_network) {
    m_i_subnet_network = i_subnet_network;
    m_i_subnet_network_isSet = true;
}

bool Subnet_RequestCompound::is_i_subnet_network_Set() const{
    return m_i_subnet_network_isSet;
}

bool Subnet_RequestCompound::is_i_subnet_network_Valid() const{
    return m_i_subnet_network_isValid;
}

qint64 Subnet_RequestCompound::getISubnetMask() const {
    return m_i_subnet_mask;
}
void Subnet_RequestCompound::setISubnetMask(const qint64 &i_subnet_mask) {
    m_i_subnet_mask = i_subnet_mask;
    m_i_subnet_mask_isSet = true;
}

bool Subnet_RequestCompound::is_i_subnet_mask_Set() const{
    return m_i_subnet_mask_isSet;
}

bool Subnet_RequestCompound::is_i_subnet_mask_Valid() const{
    return m_i_subnet_mask_isValid;
}

bool Subnet_RequestCompound::isSet() const {
...
bool Subnet_RequestCompound::isValid() const {
