...
#ifndef Ezsignfoldersignerassociation_reassign_v1_Response_H
#define Ezsignfoldersignerassociation_reassign_v1_Response_H
...
class Ezsignfoldersignerassociation_reassign_v1_Response : public Object {
public:
    Ezsignfoldersignerassociation_reassign_v1_Response();
    Ezsignfoldersignerassociation_reassign_v1_Response(const QString &json);
    ~Ezsignfoldersignerassociation_reassign_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldersignerassociation_reassign_v1_Response)

#endif // Ezsignfoldersignerassociation_reassign_v1_Response_H
