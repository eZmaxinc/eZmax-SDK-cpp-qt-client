...
/*
 * Discussionmembership_RequestCompound.h
 *
 * A Discussionmembership Object and children
 */

#ifndef Discussionmembership_RequestCompound_H
#define Discussionmembership_RequestCompound_H
...
class Discussionmembership_RequestCompound : public Object {
public:
    Discussionmembership_RequestCompound();
    Discussionmembership_RequestCompound(const QString &json);
    ~Discussionmembership_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussionmembership_RequestCompound)

#endif // Discussionmembership_RequestCompound_H
