...
/*
 * Franchisereferalincome_createObject_v2_Response.h
 *
 * Response for POST /2/object/franchisereferalincome
 */

#ifndef Franchisereferalincome_createObject_v2_Response_H
#define Franchisereferalincome_createObject_v2_Response_H
...
class Franchisereferalincome_createObject_v2_Response_mPayload;
...
public:
    ...
    Franchisereferalincome_createObject_v2_Response_mPayload getMPayload() const;
    void setMPayload(const Franchisereferalincome_createObject_v2_Response_mPayload &m_payload);
...
private:
    ...
    Franchisereferalincome_createObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Franchisereferalincome_createObject_v2_Response)

#endif // Franchisereferalincome_createObject_v2_Response_H
