...
/*
 * OAIEzsignbulksend_Request.h
 *
 * A Ezsignbulksend Object
 */

#ifndef OAIEzsignbulksend_Request_H
#define OAIEzsignbulksend_Request_H
...
class OAIEzsignbulksend_Request : public OAIObject {
public:
    OAIEzsignbulksend_Request();
    OAIEzsignbulksend_Request(QString json);
    ~OAIEzsignbulksend_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksend_Request)

#endif // OAIEzsignbulksend_Request_H
