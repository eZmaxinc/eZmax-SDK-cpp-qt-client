...
OAICustom_Ezsignfoldertype_Response OAIEzsignfolder_ResponseCompound::getObjEzsignfoldertype() const {
    return m_obj_ezsignfoldertype;
}
void OAIEzsignfolder_ResponseCompound::setObjEzsignfoldertype(const OAICustom_Ezsignfoldertype_Response &obj_ezsignfoldertype) {
    m_obj_ezsignfoldertype = obj_ezsignfoldertype;
    m_obj_ezsignfoldertype_isSet = true;
}

bool OAIEzsignfolder_ResponseCompound::is_obj_ezsignfoldertype_Set() const{
    return m_obj_ezsignfoldertype_isSet;
}

bool OAIEzsignfolder_ResponseCompound::is_obj_ezsignfoldertype_Valid() const{
