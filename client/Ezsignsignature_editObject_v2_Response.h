...
/*
 * Ezsignsignature_editObject_v2_Response.h
 *
 * Response for PUT /2/object/ezsignsignature/{pkiEzsignsignatureID}
 */

#ifndef Ezsignsignature_editObject_v2_Response_H
#define Ezsignsignature_editObject_v2_Response_H
...
class Ezsignsignature_editObject_v2_Response : public Object {
public:
    Ezsignsignature_editObject_v2_Response();
    Ezsignsignature_editObject_v2_Response(QString json);
    ~Ezsignsignature_editObject_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignature_editObject_v2_Response)

#endif // Ezsignsignature_editObject_v2_Response_H
