...
/*
 * Ezsignformfield_RequestCompound.h
 *
 * An Ezsignformfield Object and children to create a complete structure
 */

#ifndef Ezsignformfield_RequestCompound_H
#define Ezsignformfield_RequestCompound_H
...
public:
    Ezsignformfield_RequestCompound();
    Ezsignformfield_RequestCompound(const QString &json);
    ~Ezsignformfield_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfield_RequestCompound)

#endif // Ezsignformfield_RequestCompound_H
