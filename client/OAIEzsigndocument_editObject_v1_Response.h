...
/*
 * OAIEzsigndocument_editObject_v1_Response.h
 *
 * Response for the /1/object/ezsigndocument/editObject API Request
 */

#ifndef OAIEzsigndocument_editObject_v1_Response_H
#define OAIEzsigndocument_editObject_v1_Response_H
...
class OAIEzsigndocument_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_editObject_v1_Response();
    OAIEzsigndocument_editObject_v1_Response(QString json);
    ~OAIEzsigndocument_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigndocument_editObject_v1_Response)

#endif // OAIEzsigndocument_editObject_v1_Response_H
