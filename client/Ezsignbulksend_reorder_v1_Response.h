...
#ifndef Ezsignbulksend_reorder_v1_Response_H
#define Ezsignbulksend_reorder_v1_Response_H
...
class Ezsignbulksend_reorder_v1_Response : public Object {
public:
    Ezsignbulksend_reorder_v1_Response();
    Ezsignbulksend_reorder_v1_Response(const QString &json);
    ~Ezsignbulksend_reorder_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_reorder_v1_Response)

#endif // Ezsignbulksend_reorder_v1_Response_H
