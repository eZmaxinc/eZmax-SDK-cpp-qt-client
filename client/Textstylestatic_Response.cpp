...
Textstylestatic_Response::Textstylestatic_Response(const QString &json) {
...
void Textstylestatic_Response::fromJson(const QString &jsonString) {
...
QString Textstylestatic_Response::getSFontName() const {
    return m_s_font_name;
}
void Textstylestatic_Response::setSFontName(const QString &s_font_name) {
    m_s_font_name = s_font_name;
    m_s_font_name_isSet = true;
}

bool Textstylestatic_Response::is_s_font_name_Set() const{
    return m_s_font_name_isSet;
}

bool Textstylestatic_Response::is_s_font_name_Valid() const{
