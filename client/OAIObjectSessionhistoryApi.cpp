...
#include "OAIObjectSessionhistoryApi.h"
...
OAIObjectSessionhistoryApi::~OAIObjectSessionhistoryApi() {
}

void OAIObjectSessionhistoryApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectSessionhistoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectSessionhistoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectSessionhistoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectSessionhistoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectSessionhistoryApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectSessionhistoryApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectSessionhistoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectSessionhistoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectSessionhistoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectSessionhistoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectSessionhistoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectSessionhistoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectSessionhistoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectSessionhistoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectSessionhistoryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectSessionhistoryApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectSessionhistoryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectSessionhistoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectSessionhistoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectSessionhistoryApi::sessionhistoryGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectSessionhistoryApi::sessionhistoryGetListV1Callback);
    connect(this, &OAIObjectSessionhistoryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIObjectSessionhistoryApi::sessionhistoryGetListV1Callback(OAIHttpRequestWorker *worker) {
    ...
    OAISessionhistory_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectSessionhistoryApi::tokenAvailable(){
