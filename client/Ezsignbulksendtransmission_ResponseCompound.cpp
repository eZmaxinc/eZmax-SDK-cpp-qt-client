...
Ezsignbulksendtransmission_ResponseCompound::Ezsignbulksendtransmission_ResponseCompound(const QString &json) {
...
void Ezsignbulksendtransmission_ResponseCompound::fromJson(const QString &jsonString) {
