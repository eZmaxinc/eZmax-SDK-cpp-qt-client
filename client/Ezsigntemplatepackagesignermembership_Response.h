...
#ifndef Ezsigntemplatepackagesignermembership_Response_H
#define Ezsigntemplatepackagesignermembership_Response_H
...
class Ezsigntemplatepackagesignermembership_Response : public Object {
public:
    Ezsigntemplatepackagesignermembership_Response();
    Ezsigntemplatepackagesignermembership_Response(const QString &json);
    ~Ezsigntemplatepackagesignermembership_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagesignermembership_Response)

#endif // Ezsigntemplatepackagesignermembership_Response_H
