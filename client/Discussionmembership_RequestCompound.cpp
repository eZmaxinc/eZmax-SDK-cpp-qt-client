...
Discussionmembership_RequestCompound::Discussionmembership_RequestCompound() {
    this->initializeModel();
}

Discussionmembership_RequestCompound::~Discussionmembership_RequestCompound() {}

void Discussionmembership_RequestCompound::initializeModel() {
...
void Discussionmembership_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Discussionmembership_RequestCompound::asJson() const {
...
QJsonObject Discussionmembership_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Discussionmembership_RequestCompound::getPkiDiscussionmembershipId() const {
    return m_pki_discussionmembership_id;
}
void Discussionmembership_RequestCompound::setPkiDiscussionmembershipId(const qint32 &pki_discussionmembership_id) {
    m_pki_discussionmembership_id = pki_discussionmembership_id;
    m_pki_discussionmembership_id_isSet = true;
}

bool Discussionmembership_RequestCompound::is_pki_discussionmembership_id_Set() const{
    return m_pki_discussionmembership_id_isSet;
}

bool Discussionmembership_RequestCompound::is_pki_discussionmembership_id_Valid() const{
    return m_pki_discussionmembership_id_isValid;
}

qint32 Discussionmembership_RequestCompound::getFkiDiscussionId() const {
    return m_fki_discussion_id;
}
void Discussionmembership_RequestCompound::setFkiDiscussionId(const qint32 &fki_discussion_id) {
    m_fki_discussion_id = fki_discussion_id;
    m_fki_discussion_id_isSet = true;
}

bool Discussionmembership_RequestCompound::is_fki_discussion_id_Set() const{
    return m_fki_discussion_id_isSet;
}

bool Discussionmembership_RequestCompound::is_fki_discussion_id_Valid() const{
    return m_fki_discussion_id_isValid;
}

qint32 Discussionmembership_RequestCompound::getFkiUserId() const {
    return m_fki_user_id;
}
void Discussionmembership_RequestCompound::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Discussionmembership_RequestCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Discussionmembership_RequestCompound::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Discussionmembership_RequestCompound::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Discussionmembership_RequestCompound::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Discussionmembership_RequestCompound::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Discussionmembership_RequestCompound::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

qint32 Discussionmembership_RequestCompound::getFkiModulesectionId() const {
    return m_fki_modulesection_id;
}
void Discussionmembership_RequestCompound::setFkiModulesectionId(const qint32 &fki_modulesection_id) {
    m_fki_modulesection_id = fki_modulesection_id;
    m_fki_modulesection_id_isSet = true;
}

bool Discussionmembership_RequestCompound::is_fki_modulesection_id_Set() const{
    return m_fki_modulesection_id_isSet;
}

bool Discussionmembership_RequestCompound::is_fki_modulesection_id_Valid() const{
    return m_fki_modulesection_id_isValid;
}

QString Discussionmembership_RequestCompound::getDtDiscussionmembershipJoined() const {
    return m_dt_discussionmembership_joined;
}
void Discussionmembership_RequestCompound::setDtDiscussionmembershipJoined(const QString &dt_discussionmembership_joined) {
    m_dt_discussionmembership_joined = dt_discussionmembership_joined;
    m_dt_discussionmembership_joined_isSet = true;
}

bool Discussionmembership_RequestCompound::is_dt_discussionmembership_joined_Set() const{
    return m_dt_discussionmembership_joined_isSet;
}

bool Discussionmembership_RequestCompound::is_dt_discussionmembership_joined_Valid() const{
    return m_dt_discussionmembership_joined_isValid;
}

bool Discussionmembership_RequestCompound::isSet() const {
...
bool Discussionmembership_RequestCompound::isValid() const {
