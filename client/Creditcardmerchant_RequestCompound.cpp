...
Creditcardmerchant_RequestCompound::Creditcardmerchant_RequestCompound(const QString &json) {
...
void Creditcardmerchant_RequestCompound::fromJson(const QString &jsonString) {
...
qint32 Creditcardmerchant_RequestCompound::getFkiCurrencyId() const {
    return m_fki_currency_id;
}
void Creditcardmerchant_RequestCompound::setFkiCurrencyId(const qint32 &fki_currency_id) {
    m_fki_currency_id = fki_currency_id;
    m_fki_currency_id_isSet = true;
}

bool Creditcardmerchant_RequestCompound::is_fki_currency_id_Set() const{
    return m_fki_currency_id_isSet;
}

bool Creditcardmerchant_RequestCompound::is_fki_currency_id_Valid() const{
...
bool Creditcardmerchant_RequestCompound::isValid() const {
    ...
    return m_fki_language_id_isValid && m_fki_currency_id_isValid && m_b_creditcardmerchant_denyvisa_isValid && m_b_creditcardmerchant_denymastercard_isValid && m_b_creditcardmerchant_denyamex_isValid && m_b_creditcardmerchant_isactive_isValid && m_s_creditcardmerchant_description_isValid && m_s_creditcardmerchant_storeid_isValid && true;
}
