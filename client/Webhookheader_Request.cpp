...
Webhookheader_Request::Webhookheader_Request(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Webhookheader_Request::Webhookheader_Request() {
    this->initializeModel();
}

Webhookheader_Request::~Webhookheader_Request() {}

void Webhookheader_Request::initializeModel() {
...
void Webhookheader_Request::fromJson(const QString &jsonString) {
...
void Webhookheader_Request::fromJsonObject(QJsonObject json) {
...
QString Webhookheader_Request::asJson() const {
...
QJsonObject Webhookheader_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Webhookheader_Request::getPkiWebhookheaderId() const {
    return m_pki_webhookheader_id;
}
void Webhookheader_Request::setPkiWebhookheaderId(const qint32 &pki_webhookheader_id) {
    m_pki_webhookheader_id = pki_webhookheader_id;
    m_pki_webhookheader_id_isSet = true;
}

bool Webhookheader_Request::is_pki_webhookheader_id_Set() const{
    return m_pki_webhookheader_id_isSet;
}

bool Webhookheader_Request::is_pki_webhookheader_id_Valid() const{
    return m_pki_webhookheader_id_isValid;
}

QString Webhookheader_Request::getSWebhookheaderName() const {
    return m_s_webhookheader_name;
}
void Webhookheader_Request::setSWebhookheaderName(const QString &s_webhookheader_name) {
    m_s_webhookheader_name = s_webhookheader_name;
    m_s_webhookheader_name_isSet = true;
}

bool Webhookheader_Request::is_s_webhookheader_name_Set() const{
    return m_s_webhookheader_name_isSet;
}

bool Webhookheader_Request::is_s_webhookheader_name_Valid() const{
    return m_s_webhookheader_name_isValid;
}

QString Webhookheader_Request::getSWebhookheaderValue() const {
    return m_s_webhookheader_value;
}
void Webhookheader_Request::setSWebhookheaderValue(const QString &s_webhookheader_value) {
    m_s_webhookheader_value = s_webhookheader_value;
    m_s_webhookheader_value_isSet = true;
}

bool Webhookheader_Request::is_s_webhookheader_value_Set() const{
    return m_s_webhookheader_value_isSet;
}

bool Webhookheader_Request::is_s_webhookheader_value_Valid() const{
    return m_s_webhookheader_value_isValid;
}

bool Webhookheader_Request::isSet() const {
...
bool Webhookheader_Request::isValid() const {
