...
Ezsigndocument_patchObject_v1_Request::Ezsigndocument_patchObject_v1_Request(const QString &json) {
...
void Ezsigndocument_patchObject_v1_Request::fromJson(const QString &jsonString) {
