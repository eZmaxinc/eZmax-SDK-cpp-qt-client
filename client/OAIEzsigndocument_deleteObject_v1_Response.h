...
/*
 * OAIEzsigndocument_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef OAIEzsigndocument_deleteObject_v1_Response_H
#define OAIEzsigndocument_deleteObject_v1_Response_H
...
class OAIEzsigndocument_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_deleteObject_v1_Response();
    OAIEzsigndocument_deleteObject_v1_Response(QString json);
    ~OAIEzsigndocument_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_deleteObject_v1_Response)

#endif // OAIEzsigndocument_deleteObject_v1_Response_H
