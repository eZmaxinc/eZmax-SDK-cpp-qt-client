...
#ifndef Usergroupmembership_Response_H
#define Usergroupmembership_Response_H
...
class Usergroupmembership_Response : public Object {
public:
    Usergroupmembership_Response();
    Usergroupmembership_Response(const QString &json);
    ~Usergroupmembership_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupmembership_Response)

#endif // Usergroupmembership_Response_H
