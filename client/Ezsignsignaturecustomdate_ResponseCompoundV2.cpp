...
Ezsignsignaturecustomdate_ResponseCompoundV2::Ezsignsignaturecustomdate_ResponseCompoundV2(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignaturecustomdate_ResponseCompoundV2::Ezsignsignaturecustomdate_ResponseCompoundV2() {
    this->initializeModel();
}

Ezsignsignaturecustomdate_ResponseCompoundV2::~Ezsignsignaturecustomdate_ResponseCompoundV2() {}

void Ezsignsignaturecustomdate_ResponseCompoundV2::initializeModel() {
...
void Ezsignsignaturecustomdate_ResponseCompoundV2::fromJson(const QString &jsonString) {
...
void Ezsignsignaturecustomdate_ResponseCompoundV2::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignaturecustomdate_ResponseCompoundV2::asJson() const {
...
QJsonObject Ezsignsignaturecustomdate_ResponseCompoundV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignaturecustomdate_ResponseCompoundV2::getPkiEzsignsignaturecustomdateId() const {
    return m_pki_ezsignsignaturecustomdate_id;
}
void Ezsignsignaturecustomdate_ResponseCompoundV2::setPkiEzsignsignaturecustomdateId(const qint32 &pki_ezsignsignaturecustomdate_id) {
    m_pki_ezsignsignaturecustomdate_id = pki_ezsignsignaturecustomdate_id;
    m_pki_ezsignsignaturecustomdate_id_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_pki_ezsignsignaturecustomdate_id_Set() const{
    return m_pki_ezsignsignaturecustomdate_id_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_pki_ezsignsignaturecustomdate_id_Valid() const{
    return m_pki_ezsignsignaturecustomdate_id_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompoundV2::getIEzsignsignaturecustomdateOffsetx() const {
    return m_i_ezsignsignaturecustomdate_offsetx;
}
void Ezsignsignaturecustomdate_ResponseCompoundV2::setIEzsignsignaturecustomdateOffsetx(const qint32 &i_ezsignsignaturecustomdate_offsetx) {
...
bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_i_ezsignsignaturecustomdate_offsetx_Set() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_i_ezsignsignaturecustomdate_offsetx_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompoundV2::getIEzsignsignaturecustomdateOffsety() const {
    return m_i_ezsignsignaturecustomdate_offsety;
}
void Ezsignsignaturecustomdate_ResponseCompoundV2::setIEzsignsignaturecustomdateOffsety(const qint32 &i_ezsignsignaturecustomdate_offsety) {
...
bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_i_ezsignsignaturecustomdate_offsety_Set() const{
    return m_i_ezsignsignaturecustomdate_offsety_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_i_ezsignsignaturecustomdate_offsety_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsety_isValid;
}

QString Ezsignsignaturecustomdate_ResponseCompoundV2::getSEzsignsignaturecustomdateFormat() const {
    return m_s_ezsignsignaturecustomdate_format;
}
void Ezsignsignaturecustomdate_ResponseCompoundV2::setSEzsignsignaturecustomdateFormat(const QString &s_ezsignsignaturecustomdate_format) {
    m_s_ezsignsignaturecustomdate_format = s_ezsignsignaturecustomdate_format;
    m_s_ezsignsignaturecustomdate_format_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_s_ezsignsignaturecustomdate_format_Set() const{
    return m_s_ezsignsignaturecustomdate_format_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::is_s_ezsignsignaturecustomdate_format_Valid() const{
    return m_s_ezsignsignaturecustomdate_format_isValid;
}

bool Ezsignsignaturecustomdate_ResponseCompoundV2::isSet() const {
...
bool Ezsignsignaturecustomdate_ResponseCompoundV2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pki_ezsignsignaturecustomdate_id_isValid && m_i_ezsignsignaturecustomdate_offsetx_isValid && m_i_ezsignsignaturecustomdate_offsety_isValid && m_s_ezsignsignaturecustomdate_format_isValid && true;
}
