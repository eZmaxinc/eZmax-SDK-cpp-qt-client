...
/*
 * Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getEzsignsignaturesAutomatic
 */

#ifndef Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
#define Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
...
class Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload : public Object {
public:
    Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload();
    Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload(const QString &json);
    ~Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload)

#endif // Ezsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
