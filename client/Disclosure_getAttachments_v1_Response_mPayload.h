...
/*
 * Disclosure_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/disclosure/{pkiDisclosureID}/getAttachments
 */

#ifndef Disclosure_getAttachments_v1_Response_mPayload_H
#define Disclosure_getAttachments_v1_Response_mPayload_H
...
class Disclosure_getAttachments_v1_Response_mPayload : public Object {
public:
    Disclosure_getAttachments_v1_Response_mPayload();
    Disclosure_getAttachments_v1_Response_mPayload(const QString &json);
    ~Disclosure_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Disclosure_getAttachments_v1_Response_mPayload)

#endif // Disclosure_getAttachments_v1_Response_mPayload_H
