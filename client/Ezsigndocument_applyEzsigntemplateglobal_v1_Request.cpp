...
Ezsigndocument_applyEzsigntemplateglobal_v1_Request::Ezsigndocument_applyEzsigntemplateglobal_v1_Request(const QString &json) {
...
void Ezsigndocument_applyEzsigntemplateglobal_v1_Request::fromJson(const QString &jsonString) {
