...
/*
 * OAIVariableexpense_editObject_v1_Response.h
 *
 * Response for PUT /1/object/variableexpense/{pkiVariableexpenseID}
 */

#ifndef OAIVariableexpense_editObject_v1_Response_H
#define OAIVariableexpense_editObject_v1_Response_H
...
class OAIVariableexpense_editObject_v1_Response : public OAIObject {
public:
    OAIVariableexpense_editObject_v1_Response();
    OAIVariableexpense_editObject_v1_Response(QString json);
    ~OAIVariableexpense_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIVariableexpense_editObject_v1_Response)

#endif // OAIVariableexpense_editObject_v1_Response_H
