...
#ifndef Ezsigndocument_RequestCompound_H
#define Ezsigndocument_RequestCompound_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_RequestCompound)

#endif // Ezsigndocument_RequestCompound_H
