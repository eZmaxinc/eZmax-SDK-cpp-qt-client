...
Ezsigndocumentlog_ResponseCompound::Ezsigndocumentlog_ResponseCompound(const QString &json) {
...
void Ezsigndocumentlog_ResponseCompound::fromJson(const QString &jsonString) {
