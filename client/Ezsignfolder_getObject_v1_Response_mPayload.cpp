...
Ezsignfolder_getObject_v1_Response_mPayload::Ezsignfolder_getObject_v1_Response_mPayload(const QString &json) {
...
void Ezsignfolder_getObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
...
Field_eEzsignfolderMessageorder Ezsignfolder_getObject_v1_Response_mPayload::getEEzsignfolderMessageorder() const {
    return m_e_ezsignfolder_messageorder;
}
void Ezsignfolder_getObject_v1_Response_mPayload::setEEzsignfolderMessageorder(const Field_eEzsignfolderMessageorder &e_ezsignfolder_messageorder) {
    m_e_ezsignfolder_messageorder = e_ezsignfolder_messageorder;
    m_e_ezsignfolder_messageorder_isSet = true;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::is_e_ezsignfolder_messageorder_Set() const{
    return m_e_ezsignfolder_messageorder_isSet;
}

bool Ezsignfolder_getObject_v1_Response_mPayload::is_e_ezsignfolder_messageorder_Valid() const{
