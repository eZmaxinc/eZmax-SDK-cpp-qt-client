...
#include "OAIEzsigndocument_declineToSign_v1_Response.h"
...
#include "OAIEzsigndocument_getCompletedElements_v1_Response.h"
...
#include "OAIEzsigndocument_submitEzsignform_v1_Response.h"
...
public:
    ...
    */
    ...
    /**
    * @param[in]  pki_ezsigndocument_id qint32 [required]
    * @param[in]  oai_ezsigndocument_decline_to_sign_v1_request OAIEzsigndocument_declineToSign_v1_Request [required]
    */
    void ezsigndocumentDeclineToSignV1(const qint32 &pki_ezsigndocument_id, const OAIEzsigndocument_declineToSign_v1_Request &oai_ezsigndocument_decline_to_sign_v1_request);
    ...
    */
    ...
    /**
    * @param[in]  pki_ezsigndocument_id qint32 [required]
    * @param[in]  oai_ezsigndocument_submit_ezsignform_v1_request OAIEzsigndocument_submitEzsignform_v1_Request [required]
    */
    void ezsigndocumentSubmitEzsignformV1(const qint32 &pki_ezsigndocument_id, const OAIEzsigndocument_submitEzsignform_v1_Request &oai_ezsigndocument_submit_ezsignform_v1_request);
...
private:
    ...
    void ezsigndocumentDeclineToSignV1Callback(OAIHttpRequestWorker *worker);
    ...
    void ezsigndocumentGetCompletedElementsV1Callback(OAIHttpRequestWorker *worker);
    ...
    void ezsigndocumentSubmitEzsignformV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsigndocumentDeclineToSignV1Signal(OAIEzsigndocument_declineToSign_v1_Response summary);
    ...
    void ezsigndocumentGetCompletedElementsV1Signal(OAIEzsigndocument_getCompletedElements_v1_Response summary);
    ...
    void ezsigndocumentSubmitEzsignformV1Signal(OAIEzsigndocument_submitEzsignform_v1_Response summary);
    ...
    void ezsigndocumentDeclineToSignV1SignalFull(OAIHttpRequestWorker *worker, OAIEzsigndocument_declineToSign_v1_Response summary);
    ...
    void ezsigndocumentGetCompletedElementsV1SignalFull(OAIHttpRequestWorker *worker, OAIEzsigndocument_getCompletedElements_v1_Response summary);
    ...
    void ezsigndocumentSubmitEzsignformV1SignalFull(OAIHttpRequestWorker *worker, OAIEzsigndocument_submitEzsignform_v1_Response summary);
    ...
    void ezsigndocumentDeclineToSignV1SignalE(OAIEzsigndocument_declineToSign_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentGetCompletedElementsV1SignalE(OAIEzsigndocument_getCompletedElements_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentSubmitEzsignformV1SignalE(OAIEzsigndocument_submitEzsignform_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentDeclineToSignV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentGetCompletedElementsV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentSubmitEzsignformV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
