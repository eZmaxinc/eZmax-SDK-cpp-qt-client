...
public:
    ...
    void ezsigndocumentEditObjectV1(const qint32 &pki_ezsigndocument_id, const OAIEzsigndocument_editObject_v1_Request &oai_ezsigndocument_edit_object_v1_request);
    void ezsigndocumentGetDownloadUrlV1(const qint32 &pki_ezsigndocument_id, const QString &e_document_type);
    void ezsigndocumentGetObjectGetChildrenV1(const qint32 &pki_ezsigndocument_id);
...
private:
    ...
    void ezsigndocumentEditObjectV1Callback(OAIHttpRequestWorker *worker);
    void ezsigndocumentGetDownloadUrlV1Callback(OAIHttpRequestWorker *worker);
    void ezsigndocumentGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsigndocumentEditObjectV1Signal(OAIEzsigndocument_editObject_v1_Response summary);
    void ezsigndocumentGetDownloadUrlV1Signal(OAIEzsigndocument_getDownloadUrl_v1_Response summary);
    void ezsigndocumentGetObjectGetChildrenV1Signal();
    ...
    void ezsigndocumentEditObjectV1SignalFull(OAIHttpRequestWorker *worker, OAIEzsigndocument_editObject_v1_Response summary);
    ...
    void ezsigndocumentGetObjectGetChildrenV1SignalFull(OAIHttpRequestWorker *worker);
    ...
    void ezsigndocumentEditObjectV1SignalE(OAIEzsigndocument_editObject_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentGetObjectGetChildrenV1SignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentEditObjectV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigndocumentGetObjectGetChildrenV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
