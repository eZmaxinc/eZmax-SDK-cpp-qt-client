...
/*
 * User_RequestCompoundV2.h
 *
 * A User Object and children
 */

#ifndef User_RequestCompoundV2_H
#define User_RequestCompoundV2_H
...
class User_RequestCompoundV2 : public Object {
public:
    User_RequestCompoundV2();
    User_RequestCompoundV2(QString json);
    ~User_RequestCompoundV2() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::User_RequestCompoundV2)

#endif // User_RequestCompoundV2_H
