...
Usergroup_createObject_v1_Response_mPayload::Usergroup_createObject_v1_Response_mPayload(const QString &json) {
...
void Usergroup_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
