...
public:
    ...
    * @param[in]  pki_ezsigntemplatesigner_id qint32 [required]
    */
    Q_DECL_DEPRECATED void ezsigntemplatesignerGetObjectV1(const qint32 &pki_ezsigntemplatesigner_id);
...
private:
    ...
    void ezsigntemplatesignerGetObjectV2Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsigntemplatesignerGetObjectV2Signal(OAIEzsigntemplatesigner_getObject_v2_Response summary);
    ...
    void ezsigntemplatesignerGetObjectV2SignalFull(OAIHttpRequestWorker *worker, OAIEzsigntemplatesigner_getObject_v2_Response summary);
    ...
    void ezsigntemplatesignerGetObjectV2SignalE(OAIEzsigntemplatesigner_getObject_v2_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsigntemplatesignerGetObjectV2SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
