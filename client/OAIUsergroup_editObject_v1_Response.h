...
/*
 * OAIUsergroup_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroup/{pkiUsergroupID}
 */

#ifndef OAIUsergroup_editObject_v1_Response_H
#define OAIUsergroup_editObject_v1_Response_H
...
class OAIUsergroup_editObject_v1_Response : public OAIObject {
public:
    OAIUsergroup_editObject_v1_Response();
    OAIUsergroup_editObject_v1_Response(QString json);
    ~OAIUsergroup_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroup_editObject_v1_Response)

#endif // OAIUsergroup_editObject_v1_Response_H
