...
/*
 * Discussion_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/discussion/{pkiDiscussionID}
 */

#ifndef Discussion_deleteObject_v1_Response_H
#define Discussion_deleteObject_v1_Response_H
...
class Discussion_deleteObject_v1_Response : public Object {
public:
    Discussion_deleteObject_v1_Response();
    Discussion_deleteObject_v1_Response(const QString &json);
    ~Discussion_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussion_deleteObject_v1_Response)

#endif // Discussion_deleteObject_v1_Response_H
