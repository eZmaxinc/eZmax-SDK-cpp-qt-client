...
/*
 * Systemconfiguration_editObject_v2_Response.h
 *
 * Response for PUT /1/object/systemconfiguration/{pkiSystemconfigurationID}
 */

#ifndef Systemconfiguration_editObject_v2_Response_H
#define Systemconfiguration_editObject_v2_Response_H
...
class Systemconfiguration_editObject_v2_Response : public Object {
public:
    Systemconfiguration_editObject_v2_Response();
    Systemconfiguration_editObject_v2_Response(const QString &json);
    ~Systemconfiguration_editObject_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Systemconfiguration_editObject_v2_Response)

#endif // Systemconfiguration_editObject_v2_Response_H
