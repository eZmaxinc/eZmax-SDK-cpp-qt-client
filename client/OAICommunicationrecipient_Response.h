...
/*
 * OAICommunicationrecipient_Response.h
 *
 * A Communicationrecipient Object
 */

#ifndef OAICommunicationrecipient_Response_H
#define OAICommunicationrecipient_Response_H
...
class OAICommunicationrecipient_Response : public OAIObject {
public:
    OAICommunicationrecipient_Response();
    OAICommunicationrecipient_Response(QString json);
    ~OAICommunicationrecipient_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICommunicationrecipient_Response)

#endif // OAICommunicationrecipient_Response_H
