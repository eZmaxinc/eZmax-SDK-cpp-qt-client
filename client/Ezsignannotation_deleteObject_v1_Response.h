...
/*
 * Ezsignannotation_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignannotation/{pkiEzsignannotationID}
 */

#ifndef Ezsignannotation_deleteObject_v1_Response_H
#define Ezsignannotation_deleteObject_v1_Response_H
...
class Ezsignannotation_deleteObject_v1_Response : public Object {
public:
    Ezsignannotation_deleteObject_v1_Response();
    Ezsignannotation_deleteObject_v1_Response(const QString &json);
    ~Ezsignannotation_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignannotation_deleteObject_v1_Response)

#endif // Ezsignannotation_deleteObject_v1_Response_H
