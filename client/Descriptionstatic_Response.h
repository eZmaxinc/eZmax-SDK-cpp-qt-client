...
#ifndef Descriptionstatic_Response_H
#define Descriptionstatic_Response_H
...
class Descriptionstatic_Response : public Object {
public:
    Descriptionstatic_Response();
    Descriptionstatic_Response(QString json);
    ~Descriptionstatic_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Descriptionstatic_Response)

#endif // Descriptionstatic_Response_H
