...
Branding_RequestV2::Branding_RequestV2(const QString &json) {
...
void Branding_RequestV2::fromJson(const QString &jsonString) {
...
qint32 Branding_RequestV2::getFkiDomainId() const {
    return m_fki_domain_id;
}
void Branding_RequestV2::setFkiDomainId(const qint32 &fki_domain_id) {
    m_fki_domain_id = fki_domain_id;
    m_fki_domain_id_isSet = true;
}

bool Branding_RequestV2::is_fki_domain_id_Set() const{
    return m_fki_domain_id_isSet;
}

bool Branding_RequestV2::is_fki_domain_id_Valid() const{
