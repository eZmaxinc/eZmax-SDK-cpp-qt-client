...
User_getList_v1_Response::User_getList_v1_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

User_getList_v1_Response::User_getList_v1_Response() {
    this->initializeModel();
}

User_getList_v1_Response::~User_getList_v1_Response() {}

void User_getList_v1_Response::initializeModel() {
...
void User_getList_v1_Response::fromJson(const QString &jsonString) {
...
void User_getList_v1_Response::fromJsonObject(QJsonObject json) {
...
QString User_getList_v1_Response::asJson() const {
...
QJsonObject User_getList_v1_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload_getList User_getList_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void User_getList_v1_Response::setObjDebugPayload(const Common_Response_objDebugPayload_getList &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool User_getList_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool User_getList_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug User_getList_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void User_getList_v1_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool User_getList_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool User_getList_v1_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

User_getList_v1_Response_mPayload User_getList_v1_Response::getMPayload() const {
    return m_m_payload;
}
void User_getList_v1_Response::setMPayload(const User_getList_v1_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool User_getList_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool User_getList_v1_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool User_getList_v1_Response::isSet() const {
...
bool User_getList_v1_Response::isValid() const {
