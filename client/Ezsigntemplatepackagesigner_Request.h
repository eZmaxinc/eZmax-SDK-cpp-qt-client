...
#ifndef Ezsigntemplatepackagesigner_Request_H
#define Ezsigntemplatepackagesigner_Request_H
...
class Ezsigntemplatepackagesigner_Request : public Object {
public:
    Ezsigntemplatepackagesigner_Request();
    Ezsigntemplatepackagesigner_Request(const QString &json);
    ~Ezsigntemplatepackagesigner_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagesigner_Request)

#endif // Ezsigntemplatepackagesigner_Request_H
