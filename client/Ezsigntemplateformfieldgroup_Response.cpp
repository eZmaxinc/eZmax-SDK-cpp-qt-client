...
Ezsigntemplateformfieldgroup_Response::Ezsigntemplateformfieldgroup_Response(const QString &json) {
...
void Ezsigntemplateformfieldgroup_Response::fromJson(const QString &jsonString) {
...
QString Ezsigntemplateformfieldgroup_Response::getSEzsigntemplateformfieldgroupTextvalidationcustommessage() const {
    return m_s_ezsigntemplateformfieldgroup_textvalidationcustommessage;
}
void Ezsigntemplateformfieldgroup_Response::setSEzsigntemplateformfieldgroupTextvalidationcustommessage(const QString &s_ezsigntemplateformfieldgroup_textvalidationcustommessage) {
...
bool Ezsigntemplateformfieldgroup_Response::is_s_ezsigntemplateformfieldgroup_textvalidationcustommessage_Set() const{
    return m_s_ezsigntemplateformfieldgroup_textvalidationcustommessage_isSet;
}

bool Ezsigntemplateformfieldgroup_Response::is_s_ezsigntemplateformfieldgroup_textvalidationcustommessage_Valid() const{
