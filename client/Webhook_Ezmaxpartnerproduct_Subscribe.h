...
#ifndef Webhook_Ezmaxpartnerproduct_Subscribe_H
#define Webhook_Ezmaxpartnerproduct_Subscribe_H
...
class Webhook_Ezmaxpartnerproduct_Subscribe : public Object {
public:
    Webhook_Ezmaxpartnerproduct_Subscribe();
    Webhook_Ezmaxpartnerproduct_Subscribe(const QString &json);
    ~Webhook_Ezmaxpartnerproduct_Subscribe() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_Ezmaxpartnerproduct_Subscribe)

#endif // Webhook_Ezmaxpartnerproduct_Subscribe_H
