...
Ezsignsignaturepaymentdetail_RequestCompound::Ezsignsignaturepaymentdetail_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignaturepaymentdetail_RequestCompound::Ezsignsignaturepaymentdetail_RequestCompound() {
    this->initializeModel();
}

Ezsignsignaturepaymentdetail_RequestCompound::~Ezsignsignaturepaymentdetail_RequestCompound() {}

void Ezsignsignaturepaymentdetail_RequestCompound::initializeModel() {
...
void Ezsignsignaturepaymentdetail_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsignsignaturepaymentdetail_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignaturepaymentdetail_RequestCompound::asJson() const {
...
QJsonObject Ezsignsignaturepaymentdetail_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignaturepaymentdetail_RequestCompound::getPkiEzsignsignaturepaymentdetailId() const {
    return m_pki_ezsignsignaturepaymentdetail_id;
}
void Ezsignsignaturepaymentdetail_RequestCompound::setPkiEzsignsignaturepaymentdetailId(const qint32 &pki_ezsignsignaturepaymentdetail_id) {
...
bool Ezsignsignaturepaymentdetail_RequestCompound::is_pki_ezsignsignaturepaymentdetail_id_Set() const{
    return m_pki_ezsignsignaturepaymentdetail_id_isSet;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_pki_ezsignsignaturepaymentdetail_id_Valid() const{
    return m_pki_ezsignsignaturepaymentdetail_id_isValid;
}

qint32 Ezsignsignaturepaymentdetail_RequestCompound::getFkiGlaccountcontainerId() const {
    return m_fki_glaccountcontainer_id;
}
void Ezsignsignaturepaymentdetail_RequestCompound::setFkiGlaccountcontainerId(const qint32 &fki_glaccountcontainer_id) {
    m_fki_glaccountcontainer_id = fki_glaccountcontainer_id;
    m_fki_glaccountcontainer_id_isSet = true;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_fki_glaccountcontainer_id_Set() const{
    return m_fki_glaccountcontainer_id_isSet;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_fki_glaccountcontainer_id_Valid() const{
    return m_fki_glaccountcontainer_id_isValid;
}

QString Ezsignsignaturepaymentdetail_RequestCompound::getTEzsignsignaturepaymentdetailDescription() const {
    return m_t_ezsignsignaturepaymentdetail_description;
}
void Ezsignsignaturepaymentdetail_RequestCompound::setTEzsignsignaturepaymentdetailDescription(const QString &t_ezsignsignaturepaymentdetail_description) {
...
bool Ezsignsignaturepaymentdetail_RequestCompound::is_t_ezsignsignaturepaymentdetail_description_Set() const{
    return m_t_ezsignsignaturepaymentdetail_description_isSet;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_t_ezsignsignaturepaymentdetail_description_Valid() const{
    return m_t_ezsignsignaturepaymentdetail_description_isValid;
}

QString Ezsignsignaturepaymentdetail_RequestCompound::getDEzsignsignaturepaymentdetailAmount() const {
    return m_d_ezsignsignaturepaymentdetail_amount;
}
void Ezsignsignaturepaymentdetail_RequestCompound::setDEzsignsignaturepaymentdetailAmount(const QString &d_ezsignsignaturepaymentdetail_amount) {
...
bool Ezsignsignaturepaymentdetail_RequestCompound::is_d_ezsignsignaturepaymentdetail_amount_Set() const{
    return m_d_ezsignsignaturepaymentdetail_amount_isSet;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_d_ezsignsignaturepaymentdetail_amount_Valid() const{
    return m_d_ezsignsignaturepaymentdetail_amount_isValid;
}

Field_eEzsignsignaturepaymentdetailTaxable Ezsignsignaturepaymentdetail_RequestCompound::getEEzsignsignaturepaymentdetailTaxable() const {
    return m_e_ezsignsignaturepaymentdetail_taxable;
}
void Ezsignsignaturepaymentdetail_RequestCompound::setEEzsignsignaturepaymentdetailTaxable(const Field_eEzsignsignaturepaymentdetailTaxable &e_ezsignsignaturepaymentdetail_taxable) {
...
bool Ezsignsignaturepaymentdetail_RequestCompound::is_e_ezsignsignaturepaymentdetail_taxable_Set() const{
    return m_e_ezsignsignaturepaymentdetail_taxable_isSet;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::is_e_ezsignsignaturepaymentdetail_taxable_Valid() const{
    return m_e_ezsignsignaturepaymentdetail_taxable_isValid;
}

bool Ezsignsignaturepaymentdetail_RequestCompound::isSet() const {
...
bool Ezsignsignaturepaymentdetail_RequestCompound::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fki_glaccountcontainer_id_isValid && m_t_ezsignsignaturepaymentdetail_description_isValid && m_d_ezsignsignaturepaymentdetail_amount_isValid && m_e_ezsignsignaturepaymentdetail_taxable_isValid && true;
}
