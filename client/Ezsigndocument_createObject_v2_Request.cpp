...
Ezsigndocument_createObject_v2_Request::Ezsigndocument_createObject_v2_Request(const QString &json) {
...
void Ezsigndocument_createObject_v2_Request::fromJson(const QString &jsonString) {
