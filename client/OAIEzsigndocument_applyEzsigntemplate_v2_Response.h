...
/*
 * OAIEzsigndocument_applyEzsigntemplate_v2_Response.h
 *
 * Response for POST /2/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate
 */

#ifndef OAIEzsigndocument_applyEzsigntemplate_v2_Response_H
#define OAIEzsigndocument_applyEzsigntemplate_v2_Response_H
...
public:
    OAIEzsigndocument_applyEzsigntemplate_v2_Response();
    OAIEzsigndocument_applyEzsigntemplate_v2_Response(QString json);
    ~OAIEzsigndocument_applyEzsigntemplate_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_applyEzsigntemplate_v2_Response)

#endif // OAIEzsigndocument_applyEzsigntemplate_v2_Response_H
