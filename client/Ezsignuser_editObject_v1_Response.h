...
/*
 * Ezsignuser_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignuser/{pkiEzsignuserID}
 */

#ifndef Ezsignuser_editObject_v1_Response_H
#define Ezsignuser_editObject_v1_Response_H
...
class Ezsignuser_editObject_v1_Response : public Object {
public:
    Ezsignuser_editObject_v1_Response();
    Ezsignuser_editObject_v1_Response(const QString &json);
    ~Ezsignuser_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignuser_editObject_v1_Response)

#endif // Ezsignuser_editObject_v1_Response_H
