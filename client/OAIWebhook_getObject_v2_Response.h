...
/*
 * OAIWebhook_getObject_v2_Response.h
 *
 * Response for GET /2/object/webhook/{pkiWebhookID}
 */

#ifndef OAIWebhook_getObject_v2_Response_H
#define OAIWebhook_getObject_v2_Response_H
...
class OAIWebhook_getObject_v2_Response : public OAIObject {
public:
    OAIWebhook_getObject_v2_Response();
    OAIWebhook_getObject_v2_Response(QString json);
    ~OAIWebhook_getObject_v2_Response() override;
...
private:
    ...
    OAIWebhook_getObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIWebhook_getObject_v2_Response)

#endif // OAIWebhook_getObject_v2_Response_H
