...
Ezsignformfield_Response::Ezsignformfield_Response(const QString &json) {
...
void Ezsignformfield_Response::fromJson(const QString &jsonString) {
...
Enum_Horizontalalignment Ezsignformfield_Response::getEEzsignformfieldHorizontalalignment() const {
    return m_e_ezsignformfield_horizontalalignment;
}
void Ezsignformfield_Response::setEEzsignformfieldHorizontalalignment(const Enum_Horizontalalignment &e_ezsignformfield_horizontalalignment) {
...
bool Ezsignformfield_Response::is_e_ezsignformfield_horizontalalignment_Set() const{
    return m_e_ezsignformfield_horizontalalignment_isSet;
}

bool Ezsignformfield_Response::is_e_ezsignformfield_horizontalalignment_Valid() const{
    return m_e_ezsignformfield_horizontalalignment_isValid;
}

Textstylestatic_ResponseCompound Ezsignformfield_Response::getObjTextstylestatic() const {
    return m_obj_textstylestatic;
}
void Ezsignformfield_Response::setObjTextstylestatic(const Textstylestatic_ResponseCompound &obj_textstylestatic) {
    m_obj_textstylestatic = obj_textstylestatic;
    m_obj_textstylestatic_isSet = true;
}

bool Ezsignformfield_Response::is_obj_textstylestatic_Set() const{
    return m_obj_textstylestatic_isSet;
}

bool Ezsignformfield_Response::is_obj_textstylestatic_Valid() const{
