...
OAIListpresentation_Request::OAIListpresentation_Request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListpresentation_Request::OAIListpresentation_Request() {
    this->initializeModel();
}

OAIListpresentation_Request::~OAIListpresentation_Request() {}

void OAIListpresentation_Request::initializeModel() {
...
void OAIListpresentation_Request::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIListpresentation_Request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListpresentation_Request::getSListpresentationDescription() const {
    return s_listpresentation_description;
}
void OAIListpresentation_Request::setSListpresentationDescription(const QString &s_listpresentation_description) {
    this->s_listpresentation_description = s_listpresentation_description;
    this->m_s_listpresentation_description_isSet = true;
}

bool OAIListpresentation_Request::is_s_listpresentation_description_Set() const{
    return m_s_listpresentation_description_isSet;
}

bool OAIListpresentation_Request::is_s_listpresentation_description_Valid() const{
    return m_s_listpresentation_description_isValid;
}

QString OAIListpresentation_Request::getSListpresentationFilter() const {
    return s_listpresentation_filter;
}
void OAIListpresentation_Request::setSListpresentationFilter(const QString &s_listpresentation_filter) {
    this->s_listpresentation_filter = s_listpresentation_filter;
    this->m_s_listpresentation_filter_isSet = true;
}

bool OAIListpresentation_Request::is_s_listpresentation_filter_Set() const{
    return m_s_listpresentation_filter_isSet;
}

bool OAIListpresentation_Request::is_s_listpresentation_filter_Valid() const{
    return m_s_listpresentation_filter_isValid;
}

QString OAIListpresentation_Request::getSListpresentationOrderby() const {
    return s_listpresentation_orderby;
}
void OAIListpresentation_Request::setSListpresentationOrderby(const QString &s_listpresentation_orderby) {
    this->s_listpresentation_orderby = s_listpresentation_orderby;
    this->m_s_listpresentation_orderby_isSet = true;
}

bool OAIListpresentation_Request::is_s_listpresentation_orderby_Set() const{
    return m_s_listpresentation_orderby_isSet;
}

bool OAIListpresentation_Request::is_s_listpresentation_orderby_Valid() const{
    return m_s_listpresentation_orderby_isValid;
}

QList<QString> OAIListpresentation_Request::getASColumnName() const {
    return a_s_column_name;
}
void OAIListpresentation_Request::setASColumnName(const QList<QString> &a_s_column_name) {
    this->a_s_column_name = a_s_column_name;
    this->m_a_s_column_name_isSet = true;
}

bool OAIListpresentation_Request::is_a_s_column_name_Set() const{
    return m_a_s_column_name_isSet;
}

bool OAIListpresentation_Request::is_a_s_column_name_Valid() const{
    return m_a_s_column_name_isValid;
}

qint32 OAIListpresentation_Request::getIListpresentationRowMax() const {
    return i_listpresentation_row_max;
}
void OAIListpresentation_Request::setIListpresentationRowMax(const qint32 &i_listpresentation_row_max) {
    this->i_listpresentation_row_max = i_listpresentation_row_max;
    this->m_i_listpresentation_row_max_isSet = true;
}

bool OAIListpresentation_Request::is_i_listpresentation_row_max_Set() const{
    return m_i_listpresentation_row_max_isSet;
}

bool OAIListpresentation_Request::is_i_listpresentation_row_max_Valid() const{
    return m_i_listpresentation_row_max_isValid;
}

qint32 OAIListpresentation_Request::getIListpresentationRowOffset() const {
    return i_listpresentation_row_offset;
}
void OAIListpresentation_Request::setIListpresentationRowOffset(const qint32 &i_listpresentation_row_offset) {
    this->i_listpresentation_row_offset = i_listpresentation_row_offset;
    this->m_i_listpresentation_row_offset_isSet = true;
}

bool OAIListpresentation_Request::is_i_listpresentation_row_offset_Set() const{
    return m_i_listpresentation_row_offset_isSet;
}

bool OAIListpresentation_Request::is_i_listpresentation_row_offset_Valid() const{
