...
Ezsignfolder_importEzsigntemplatepackage_v2_Request::Ezsignfolder_importEzsigntemplatepackage_v2_Request(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignfolder_importEzsigntemplatepackage_v2_Request::Ezsignfolder_importEzsigntemplatepackage_v2_Request() {
    this->initializeModel();
}

Ezsignfolder_importEzsigntemplatepackage_v2_Request::~Ezsignfolder_importEzsigntemplatepackage_v2_Request() {}

void Ezsignfolder_importEzsigntemplatepackage_v2_Request::initializeModel() {
...
void Ezsignfolder_importEzsigntemplatepackage_v2_Request::fromJson(const QString &jsonString) {
...
void Ezsignfolder_importEzsigntemplatepackage_v2_Request::fromJsonObject(QJsonObject json) {
...
QString Ezsignfolder_importEzsigntemplatepackage_v2_Request::asJson() const {
...
QJsonObject Ezsignfolder_importEzsigntemplatepackage_v2_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignfolder_importEzsigntemplatepackage_v2_Request::getFkiEzsigntemplatepackageId() const {
    return m_fki_ezsigntemplatepackage_id;
}
void Ezsignfolder_importEzsigntemplatepackage_v2_Request::setFkiEzsigntemplatepackageId(const qint32 &fki_ezsigntemplatepackage_id) {
    m_fki_ezsigntemplatepackage_id = fki_ezsigntemplatepackage_id;
    m_fki_ezsigntemplatepackage_id_isSet = true;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_fki_ezsigntemplatepackage_id_Set() const{
    return m_fki_ezsigntemplatepackage_id_isSet;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_fki_ezsigntemplatepackage_id_Valid() const{
    return m_fki_ezsigntemplatepackage_id_isValid;
}

QString Ezsignfolder_importEzsigntemplatepackage_v2_Request::getDtEzsigndocumentDuedate() const {
    return m_dt_ezsigndocument_duedate;
}
void Ezsignfolder_importEzsigntemplatepackage_v2_Request::setDtEzsigndocumentDuedate(const QString &dt_ezsigndocument_duedate) {
    m_dt_ezsigndocument_duedate = dt_ezsigndocument_duedate;
    m_dt_ezsigndocument_duedate_isSet = true;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_dt_ezsigndocument_duedate_Set() const{
    return m_dt_ezsigndocument_duedate_isSet;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_dt_ezsigndocument_duedate_Valid() const{
    return m_dt_ezsigndocument_duedate_isValid;
}

QList<Custom_ImportEzsigntemplatepackageRelation_Request> Ezsignfolder_importEzsigntemplatepackage_v2_Request::getAObjImportEzsigntemplatepackageRelation() const {
    return m_a_obj_import_ezsigntemplatepackage_relation;
}
void Ezsignfolder_importEzsigntemplatepackage_v2_Request::setAObjImportEzsigntemplatepackageRelation(const QList<Custom_ImportEzsigntemplatepackageRelation_Request> &a_obj_import_ezsigntemplatepackage_relation) {
...
bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_a_obj_import_ezsigntemplatepackage_relation_Set() const{
    return m_a_obj_import_ezsigntemplatepackage_relation_isSet;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::is_a_obj_import_ezsigntemplatepackage_relation_Valid() const{
    return m_a_obj_import_ezsigntemplatepackage_relation_isValid;
}

bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::isSet() const {
...
bool Ezsignfolder_importEzsigntemplatepackage_v2_Request::isValid() const {
