...
/*
 * Usergroupexternal_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroupexternal/{pkiUsergroupexternalID}
 */

#ifndef Usergroupexternal_deleteObject_v1_Response_H
#define Usergroupexternal_deleteObject_v1_Response_H
...
class Usergroupexternal_deleteObject_v1_Response : public Object {
public:
    Usergroupexternal_deleteObject_v1_Response();
    Usergroupexternal_deleteObject_v1_Response(const QString &json);
    ~Usergroupexternal_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupexternal_deleteObject_v1_Response)

#endif // Usergroupexternal_deleteObject_v1_Response_H
