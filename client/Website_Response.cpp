...
Website_Response::Website_Response(const QString &json) {
...
void Website_Response::initializeModel() {
...
void Website_Response::fromJson(const QString &jsonString) {
...
void Website_Response::fromJsonObject(QJsonObject json) {
...
QString Website_Response::asJson() const {
...
QJsonObject Website_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Website_Response::getPkiWebsiteId() const {
    return m_pki_website_id;
}
void Website_Response::setPkiWebsiteId(const qint32 &pki_website_id) {
    m_pki_website_id = pki_website_id;
    m_pki_website_id_isSet = true;
}

bool Website_Response::is_pki_website_id_Set() const{
    return m_pki_website_id_isSet;
}

bool Website_Response::is_pki_website_id_Valid() const{
    return m_pki_website_id_isValid;
}

qint32 Website_Response::getFkiWebsitetypeId() const {
    return m_fki_websitetype_id;
}
void Website_Response::setFkiWebsitetypeId(const qint32 &fki_websitetype_id) {
    m_fki_websitetype_id = fki_websitetype_id;
    m_fki_websitetype_id_isSet = true;
}

bool Website_Response::is_fki_websitetype_id_Set() const{
    return m_fki_websitetype_id_isSet;
}

bool Website_Response::is_fki_websitetype_id_Valid() const{
    return m_fki_websitetype_id_isValid;
}

QString Website_Response::getSWebsiteAddress() const {
    return m_s_website_address;
}
void Website_Response::setSWebsiteAddress(const QString &s_website_address) {
    m_s_website_address = s_website_address;
    m_s_website_address_isSet = true;
}

bool Website_Response::is_s_website_address_Set() const{
    return m_s_website_address_isSet;
}

bool Website_Response::is_s_website_address_Valid() const{
    return m_s_website_address_isValid;
}

bool Website_Response::isSet() const {
...
bool Website_Response::isValid() const {
