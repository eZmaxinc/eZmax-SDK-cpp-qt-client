...
/*
 * Userstaged_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/userstaged/{pkiUserstagedID}
 */

#ifndef Userstaged_deleteObject_v1_Response_H
#define Userstaged_deleteObject_v1_Response_H
...
class Userstaged_deleteObject_v1_Response : public Object {
public:
    Userstaged_deleteObject_v1_Response();
    Userstaged_deleteObject_v1_Response(const QString &json);
    ~Userstaged_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Userstaged_deleteObject_v1_Response)

#endif // Userstaged_deleteObject_v1_Response_H
