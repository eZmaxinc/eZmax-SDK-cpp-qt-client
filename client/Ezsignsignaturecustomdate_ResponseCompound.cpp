...
Ezsignsignaturecustomdate_ResponseCompound::Ezsignsignaturecustomdate_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignaturecustomdate_ResponseCompound::Ezsignsignaturecustomdate_ResponseCompound() {
    this->initializeModel();
}

Ezsignsignaturecustomdate_ResponseCompound::~Ezsignsignaturecustomdate_ResponseCompound() {}

void Ezsignsignaturecustomdate_ResponseCompound::initializeModel() {
...
void Ezsignsignaturecustomdate_ResponseCompound::fromJson(const QString &jsonString) {
...
void Ezsignsignaturecustomdate_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignaturecustomdate_ResponseCompound::asJson() const {
...
QJsonObject Ezsignsignaturecustomdate_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignaturecustomdate_ResponseCompound::getPkiEzsignsignaturecustomdateId() const {
    return m_pki_ezsignsignaturecustomdate_id;
}
void Ezsignsignaturecustomdate_ResponseCompound::setPkiEzsignsignaturecustomdateId(const qint32 &pki_ezsignsignaturecustomdate_id) {
    m_pki_ezsignsignaturecustomdate_id = pki_ezsignsignaturecustomdate_id;
    m_pki_ezsignsignaturecustomdate_id_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_pki_ezsignsignaturecustomdate_id_Set() const{
    return m_pki_ezsignsignaturecustomdate_id_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_pki_ezsignsignaturecustomdate_id_Valid() const{
    return m_pki_ezsignsignaturecustomdate_id_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompound::getIEzsignsignaturecustomdateX() const {
    return m_i_ezsignsignaturecustomdate_x;
}
void Ezsignsignaturecustomdate_ResponseCompound::setIEzsignsignaturecustomdateX(const qint32 &i_ezsignsignaturecustomdate_x) {
    m_i_ezsignsignaturecustomdate_x = i_ezsignsignaturecustomdate_x;
    m_i_ezsignsignaturecustomdate_x_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_x_Set() const{
    return m_i_ezsignsignaturecustomdate_x_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_x_Valid() const{
    return m_i_ezsignsignaturecustomdate_x_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompound::getIEzsignsignaturecustomdateY() const {
    return m_i_ezsignsignaturecustomdate_y;
}
void Ezsignsignaturecustomdate_ResponseCompound::setIEzsignsignaturecustomdateY(const qint32 &i_ezsignsignaturecustomdate_y) {
    m_i_ezsignsignaturecustomdate_y = i_ezsignsignaturecustomdate_y;
    m_i_ezsignsignaturecustomdate_y_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_y_Set() const{
    return m_i_ezsignsignaturecustomdate_y_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_y_Valid() const{
    return m_i_ezsignsignaturecustomdate_y_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompound::getIEzsignsignaturecustomdateOffsetx() const {
    return m_i_ezsignsignaturecustomdate_offsetx;
}
void Ezsignsignaturecustomdate_ResponseCompound::setIEzsignsignaturecustomdateOffsetx(const qint32 &i_ezsignsignaturecustomdate_offsetx) {
...
bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_offsetx_Set() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_offsetx_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isValid;
}

qint32 Ezsignsignaturecustomdate_ResponseCompound::getIEzsignsignaturecustomdateOffsety() const {
    return m_i_ezsignsignaturecustomdate_offsety;
}
void Ezsignsignaturecustomdate_ResponseCompound::setIEzsignsignaturecustomdateOffsety(const qint32 &i_ezsignsignaturecustomdate_offsety) {
...
bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_offsety_Set() const{
    return m_i_ezsignsignaturecustomdate_offsety_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_i_ezsignsignaturecustomdate_offsety_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsety_isValid;
}

QString Ezsignsignaturecustomdate_ResponseCompound::getSEzsignsignaturecustomdateFormat() const {
    return m_s_ezsignsignaturecustomdate_format;
}
void Ezsignsignaturecustomdate_ResponseCompound::setSEzsignsignaturecustomdateFormat(const QString &s_ezsignsignaturecustomdate_format) {
    m_s_ezsignsignaturecustomdate_format = s_ezsignsignaturecustomdate_format;
    m_s_ezsignsignaturecustomdate_format_isSet = true;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_s_ezsignsignaturecustomdate_format_Set() const{
    return m_s_ezsignsignaturecustomdate_format_isSet;
}

bool Ezsignsignaturecustomdate_ResponseCompound::is_s_ezsignsignaturecustomdate_format_Valid() const{
    return m_s_ezsignsignaturecustomdate_format_isValid;
}

bool Ezsignsignaturecustomdate_ResponseCompound::isSet() const {
...
bool Ezsignsignaturecustomdate_ResponseCompound::isValid() const {
