...
OAIApikey_ListElement::OAIApikey_ListElement() {
    this->initializeModel();
}

OAIApikey_ListElement::~OAIApikey_ListElement() {}

void OAIApikey_ListElement::initializeModel() {
...
void OAIApikey_ListElement::fromJson(QString jsonString) {
...
QString OAIApikey_ListElement::asJson() const {
...
bool OAIApikey_ListElement::is_pki_apikey_id_Valid() const{
...
bool OAIApikey_ListElement::is_s_apikey_description_x_Valid() const{
...
bool OAIApikey_ListElement::is_s_user_firstname_Valid() const{
...
bool OAIApikey_ListElement::is_s_user_lastname_Valid() const{
...
bool OAIApikey_ListElement::is_b_apikey_isactive_Valid() const{
...
bool OAIApikey_ListElement::is_b_apikey_issigned_Valid() const{
    return m_b_apikey_issigned_isValid;
}

bool OAIApikey_ListElement::isSet() const {
...
bool OAIApikey_ListElement::isValid() const {
