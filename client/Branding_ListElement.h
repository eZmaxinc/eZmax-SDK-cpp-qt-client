...
/*
 * Branding_ListElement.h
 *
 * A Branding List Element
 */

#ifndef Branding_ListElement_H
#define Branding_ListElement_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_ListElement)

#endif // Branding_ListElement_H
