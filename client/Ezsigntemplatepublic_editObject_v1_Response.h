...
/*
 * Ezsigntemplatepublic_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}
 */

#ifndef Ezsigntemplatepublic_editObject_v1_Response_H
#define Ezsigntemplatepublic_editObject_v1_Response_H
...
class Ezsigntemplatepublic_editObject_v1_Response : public Object {
public:
    Ezsigntemplatepublic_editObject_v1_Response();
    Ezsigntemplatepublic_editObject_v1_Response(const QString &json);
    ~Ezsigntemplatepublic_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepublic_editObject_v1_Response)

#endif // Ezsigntemplatepublic_editObject_v1_Response_H
