...
#ifndef Franchisereferalincome_Request_H
#define Franchisereferalincome_Request_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Franchisereferalincome_Request)

#endif // Franchisereferalincome_Request_H
