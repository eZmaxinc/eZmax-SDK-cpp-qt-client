...
Discussionmessage_RequestCompound::Discussionmessage_RequestCompound(const QString &json) {
...
void Discussionmessage_RequestCompound::fromJson(const QString &jsonString) {
