...
/*
 * Webhook_editObject_v1_Response.h
 *
 * Response for PUT /1/object/webhook/{pkiWebhookID}
 */

#ifndef Webhook_editObject_v1_Response_H
#define Webhook_editObject_v1_Response_H
...
class Webhook_editObject_v1_Response : public Object {
public:
    Webhook_editObject_v1_Response();
    Webhook_editObject_v1_Response(const QString &json);
    ~Webhook_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_editObject_v1_Response)

#endif // Webhook_editObject_v1_Response_H
