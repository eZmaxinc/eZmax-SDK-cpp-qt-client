...
/*
 * Ezsignbulksend_ResponseCompoundV4.h
 *
 * An Ezsignbulksend Object and children to create a complete structure
 */

#ifndef Ezsignbulksend_ResponseCompoundV4_H
#define Ezsignbulksend_ResponseCompoundV4_H
...
class Ezsignbulksendsignermapping_ResponseV3;

class Ezsignbulksend_ResponseCompoundV4 : public Object {
public:
    Ezsignbulksend_ResponseCompoundV4();
    Ezsignbulksend_ResponseCompoundV4(const QString &json);
    ~Ezsignbulksend_ResponseCompoundV4() override;
    ...
    QList<Ezsignbulksenddocumentmapping_ResponseCompoundV3> getAObjEzsignbulksenddocumentmapping() const;
    void setAObjEzsignbulksenddocumentmapping(const QList<Ezsignbulksenddocumentmapping_ResponseCompoundV3> &a_obj_ezsignbulksenddocumentmapping);
    bool is_a_obj_ezsignbulksenddocumentmapping_Set() const;
    bool is_a_obj_ezsignbulksenddocumentmapping_Valid() const;

    QList<Ezsignbulksendsignermapping_ResponseV3> getAObjEzsignbulksendsignermapping() const;
    void setAObjEzsignbulksendsignermapping(const QList<Ezsignbulksendsignermapping_ResponseV3> &a_obj_ezsignbulksendsignermapping);
...
private:
    ...
    QList<Ezsignbulksenddocumentmapping_ResponseCompoundV3> m_a_obj_ezsignbulksenddocumentmapping;
    bool m_a_obj_ezsignbulksenddocumentmapping_isSet;
    bool m_a_obj_ezsignbulksenddocumentmapping_isValid;

    QList<Ezsignbulksendsignermapping_ResponseV3> m_a_obj_ezsignbulksendsignermapping;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_ResponseCompoundV4)

#endif // Ezsignbulksend_ResponseCompoundV4_H
