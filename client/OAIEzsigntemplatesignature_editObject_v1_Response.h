...
/*
 * OAIEzsigntemplatesignature_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef OAIEzsigntemplatesignature_editObject_v1_Response_H
#define OAIEzsigntemplatesignature_editObject_v1_Response_H
...
class OAIEzsigntemplatesignature_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatesignature_editObject_v1_Response();
    OAIEzsigntemplatesignature_editObject_v1_Response(QString json);
    ~OAIEzsigntemplatesignature_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesignature_editObject_v1_Response)

#endif // OAIEzsigntemplatesignature_editObject_v1_Response_H
