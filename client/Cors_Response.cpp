...
void Cors_Response::initializeModel() {
...
void Cors_Response::fromJsonObject(QJsonObject json) {
...
QString Cors_Response::asJson() const {
...
QJsonObject Cors_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Cors_Response::getPkiCorsId() const {
    return m_pki_cors_id;
}
void Cors_Response::setPkiCorsId(const qint32 &pki_cors_id) {
    m_pki_cors_id = pki_cors_id;
    m_pki_cors_id_isSet = true;
}

bool Cors_Response::is_pki_cors_id_Set() const{
    return m_pki_cors_id_isSet;
}

bool Cors_Response::is_pki_cors_id_Valid() const{
    return m_pki_cors_id_isValid;
}

qint32 Cors_Response::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void Cors_Response::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool Cors_Response::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool Cors_Response::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

QString Cors_Response::getSCorsEntryurl() const {
    return m_s_cors_entryurl;
}
void Cors_Response::setSCorsEntryurl(const QString &s_cors_entryurl) {
    m_s_cors_entryurl = s_cors_entryurl;
    m_s_cors_entryurl_isSet = true;
}

bool Cors_Response::is_s_cors_entryurl_Set() const{
    return m_s_cors_entryurl_isSet;
}

bool Cors_Response::is_s_cors_entryurl_Valid() const{
    return m_s_cors_entryurl_isValid;
}

bool Cors_Response::isSet() const {
...
bool Cors_Response::isValid() const {
