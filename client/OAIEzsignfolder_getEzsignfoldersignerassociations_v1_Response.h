...
/*
 * OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response.h
 *
 * Response for the /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsignfoldersignerassociations API Request
 */

#ifndef OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response_H
#define OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response_H
...
public:
    OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response();
    OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response(QString json);
    ~OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response)

#endif // OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response_H
