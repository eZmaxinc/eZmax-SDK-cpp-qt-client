...
Ezsignsigningreason_RequestCompound::Ezsignsigningreason_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsigningreason_RequestCompound::Ezsignsigningreason_RequestCompound() {
    this->initializeModel();
}

Ezsignsigningreason_RequestCompound::~Ezsignsigningreason_RequestCompound() {}

void Ezsignsigningreason_RequestCompound::initializeModel() {
...
void Ezsignsigningreason_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsignsigningreason_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsigningreason_RequestCompound::asJson() const {
...
QJsonObject Ezsignsigningreason_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsigningreason_RequestCompound::getPkiEzsignsigningreasonId() const {
    return m_pki_ezsignsigningreason_id;
}
void Ezsignsigningreason_RequestCompound::setPkiEzsignsigningreasonId(const qint32 &pki_ezsignsigningreason_id) {
    m_pki_ezsignsigningreason_id = pki_ezsignsigningreason_id;
    m_pki_ezsignsigningreason_id_isSet = true;
}

bool Ezsignsigningreason_RequestCompound::is_pki_ezsignsigningreason_id_Set() const{
    return m_pki_ezsignsigningreason_id_isSet;
}

bool Ezsignsigningreason_RequestCompound::is_pki_ezsignsigningreason_id_Valid() const{
    return m_pki_ezsignsigningreason_id_isValid;
}

Multilingual_EzsignsigningreasonDescription Ezsignsigningreason_RequestCompound::getObjEzsignsigningreasonDescription() const {
    return m_obj_ezsignsigningreason_description;
}
void Ezsignsigningreason_RequestCompound::setObjEzsignsigningreasonDescription(const Multilingual_EzsignsigningreasonDescription &obj_ezsignsigningreason_description) {
...
bool Ezsignsigningreason_RequestCompound::is_obj_ezsignsigningreason_description_Set() const{
    return m_obj_ezsignsigningreason_description_isSet;
}

bool Ezsignsigningreason_RequestCompound::is_obj_ezsignsigningreason_description_Valid() const{
    return m_obj_ezsignsigningreason_description_isValid;
}

bool Ezsignsigningreason_RequestCompound::isBEzsignsigningreasonIsactive() const {
    return m_b_ezsignsigningreason_isactive;
}
void Ezsignsigningreason_RequestCompound::setBEzsignsigningreasonIsactive(const bool &b_ezsignsigningreason_isactive) {
    m_b_ezsignsigningreason_isactive = b_ezsignsigningreason_isactive;
    m_b_ezsignsigningreason_isactive_isSet = true;
}

bool Ezsignsigningreason_RequestCompound::is_b_ezsignsigningreason_isactive_Set() const{
    return m_b_ezsignsigningreason_isactive_isSet;
}

bool Ezsignsigningreason_RequestCompound::is_b_ezsignsigningreason_isactive_Valid() const{
    return m_b_ezsignsigningreason_isactive_isValid;
}

bool Ezsignsigningreason_RequestCompound::isSet() const {
...
bool Ezsignsigningreason_RequestCompound::isValid() const {
