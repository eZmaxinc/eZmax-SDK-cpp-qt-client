...
qint32 Creditcardmerchant_ResponseCompound::getFkiCurrencyId() const {
    return m_fki_currency_id;
}
void Creditcardmerchant_ResponseCompound::setFkiCurrencyId(const qint32 &fki_currency_id) {
    m_fki_currency_id = fki_currency_id;
    m_fki_currency_id_isSet = true;
}

bool Creditcardmerchant_ResponseCompound::is_fki_currency_id_Set() const{
    return m_fki_currency_id_isSet;
}

bool Creditcardmerchant_ResponseCompound::is_fki_currency_id_Valid() const{
    return m_fki_currency_id_isValid;
}

QString Creditcardmerchant_ResponseCompound::getSCurrencyDescriptionX() const {
    return m_s_currency_description_x;
}
void Creditcardmerchant_ResponseCompound::setSCurrencyDescriptionX(const QString &s_currency_description_x) {
    m_s_currency_description_x = s_currency_description_x;
    m_s_currency_description_x_isSet = true;
}

bool Creditcardmerchant_ResponseCompound::is_s_currency_description_x_Set() const{
    return m_s_currency_description_x_isSet;
}

bool Creditcardmerchant_ResponseCompound::is_s_currency_description_x_Valid() const{
