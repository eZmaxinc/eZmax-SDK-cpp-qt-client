...
/*
 * OAIListpresentation_ResponseCompound.h
 *
 * A Listpresentation Object and children to create a complete structure
 */

#ifndef OAIListpresentation_ResponseCompound_H
#define OAIListpresentation_ResponseCompound_H
...
class OAIListpresentation_ResponseCompound : public OAIObject {
public:
    OAIListpresentation_ResponseCompound();
    OAIListpresentation_ResponseCompound(QString json);
    ~OAIListpresentation_ResponseCompound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListpresentation_ResponseCompound)

#endif // OAIListpresentation_ResponseCompound_H
