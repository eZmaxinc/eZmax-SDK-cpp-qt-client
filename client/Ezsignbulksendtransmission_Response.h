...
#ifndef Ezsignbulksendtransmission_Response_H
#define Ezsignbulksendtransmission_Response_H
...
class Ezsignbulksendtransmission_Response : public Object {
public:
    Ezsignbulksendtransmission_Response();
    Ezsignbulksendtransmission_Response(const QString &json);
    ~Ezsignbulksendtransmission_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksendtransmission_Response)

#endif // Ezsignbulksendtransmission_Response_H
