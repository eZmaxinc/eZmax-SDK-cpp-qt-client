...
/*
 * OAIEzsigntemplatepackagesigner_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}
 */

#ifndef OAIEzsigntemplatepackagesigner_editObject_v1_Response_H
#define OAIEzsigntemplatepackagesigner_editObject_v1_Response_H
...
class OAIEzsigntemplatepackagesigner_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatepackagesigner_editObject_v1_Response();
    OAIEzsigntemplatepackagesigner_editObject_v1_Response(QString json);
    ~OAIEzsigntemplatepackagesigner_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackagesigner_editObject_v1_Response)

#endif // OAIEzsigntemplatepackagesigner_editObject_v1_Response_H
