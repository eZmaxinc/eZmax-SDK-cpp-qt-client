...
/*
 * Ezsigndocument_ResponseCompoundV3.h
 *
 * An Ezsigndocument Object and children to create a complete structure
 */

#ifndef Ezsigndocument_ResponseCompoundV3_H
#define Ezsigndocument_ResponseCompoundV3_H
...
namespace Ezmaxapi {
class Common_Audit;
class Custom_Ezsignfoldersignerassociationstatus_ResponseV3;
...
public:
    ...
    bool isBEzsigndocumentSendtoged() const;
    void setBEzsigndocumentSendtoged(const bool &b_ezsigndocument_sendtoged);
    bool is_b_ezsigndocument_sendtoged_Set() const;
    bool is_b_ezsigndocument_sendtoged_Valid() const;
    ...
    qint32 getIEzsigndocumentSteptotal() const;
    void setIEzsigndocumentSteptotal(const qint32 &i_ezsigndocument_steptotal);
    bool is_i_ezsigndocument_steptotal_Set() const;
    bool is_i_ezsigndocument_steptotal_Valid() const;

    qint32 getIEzsigndocumentStepcurrent() const;
    void setIEzsigndocumentStepcurrent(const qint32 &i_ezsigndocument_stepcurrent);
    bool is_i_ezsigndocument_stepcurrent_Set() const;
    bool is_i_ezsigndocument_stepcurrent_Valid() const;

    QList<Custom_Ezsignfoldersignerassociationstatus_ResponseV3> getAObjEzsignfoldersignerassociationstatus() const;
    void setAObjEzsignfoldersignerassociationstatus(const QList<Custom_Ezsignfoldersignerassociationstatus_ResponseV3> &a_obj_ezsignfoldersignerassociationstatus);
...
private:
    ...
    bool m_b_ezsigndocument_sendtoged;
    bool m_b_ezsigndocument_sendtoged_isSet;
    bool m_b_ezsigndocument_sendtoged_isValid;
    ...
    qint32 m_i_ezsigndocument_steptotal;
    bool m_i_ezsigndocument_steptotal_isSet;
    bool m_i_ezsigndocument_steptotal_isValid;

    qint32 m_i_ezsigndocument_stepcurrent;
    bool m_i_ezsigndocument_stepcurrent_isSet;
    bool m_i_ezsigndocument_stepcurrent_isValid;

    QList<Custom_Ezsignfoldersignerassociationstatus_ResponseV3> m_a_obj_ezsignfoldersignerassociationstatus;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_ResponseCompoundV3)

#endif // Ezsigndocument_ResponseCompoundV3_H
