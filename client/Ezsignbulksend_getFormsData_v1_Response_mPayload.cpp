...
Ezsignbulksend_getFormsData_v1_Response_mPayload::Ezsignbulksend_getFormsData_v1_Response_mPayload(const QString &json) {
...
void Ezsignbulksend_getFormsData_v1_Response_mPayload::fromJson(const QString &jsonString) {
