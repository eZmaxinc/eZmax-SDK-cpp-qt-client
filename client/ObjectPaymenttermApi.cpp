...
#include "ObjectPaymenttermApi.h"
...
ObjectPaymenttermApi::ObjectPaymenttermApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectPaymenttermApi::~ObjectPaymenttermApi() {
}

void ObjectPaymenttermApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectPaymenttermApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectPaymenttermApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectPaymenttermApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectPaymenttermApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectPaymenttermApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectPaymenttermApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectPaymenttermApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectPaymenttermApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectPaymenttermApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectPaymenttermApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectPaymenttermApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectPaymenttermApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectPaymenttermApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectPaymenttermApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectPaymenttermApi::enableResponseCompression() {
...
QString ObjectPaymenttermApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectPaymenttermApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectPaymenttermApi::paymenttermCreateObjectV1(const Paymentterm_createObject_v1_Request &paymentterm_create_object_v1_request) {
...
void ObjectPaymenttermApi::paymenttermCreateObjectV1Callback(HttpRequestWorker *worker) {
    ...
    Paymentterm_createObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectPaymenttermApi::paymenttermEditObjectV1(const qint32 &pki_paymentterm_id, const Paymentterm_editObject_v1_Request &paymentterm_edit_object_v1_request) {
...
void ObjectPaymenttermApi::paymenttermEditObjectV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Paymentterm_editObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectPaymenttermApi::paymenttermGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
...
void ObjectPaymenttermApi::paymenttermGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Paymentterm_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectPaymenttermApi::paymenttermGetListV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Paymentterm_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectPaymenttermApi::paymenttermGetObjectV2(const qint32 &pki_paymentterm_id) {
...
void ObjectPaymenttermApi::paymenttermGetObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Paymentterm_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectPaymenttermApi::tokenAvailable() {
