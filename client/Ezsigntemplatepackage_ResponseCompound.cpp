...
Ezsigntemplatepackage_ResponseCompound::Ezsigntemplatepackage_ResponseCompound(const QString &json) {
...
void Ezsigntemplatepackage_ResponseCompound::fromJson(const QString &jsonString) {
