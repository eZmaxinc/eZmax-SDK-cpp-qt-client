...
#ifndef OAICors_Request_H
#define OAICors_Request_H
...
class OAICors_Request : public OAIObject {
public:
    OAICors_Request();
    OAICors_Request(QString json);
    ~OAICors_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICors_Request)

#endif // OAICors_Request_H
