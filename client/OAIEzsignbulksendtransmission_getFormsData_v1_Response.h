...
private:
    ...
    OAIEzsignbulksendtransmission_getFormsData_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksendtransmission_getFormsData_v1_Response)
