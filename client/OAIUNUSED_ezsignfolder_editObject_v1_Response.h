...
/*
 * OAIUNUSED_ezsignfolder_editObject_v1_Response.h
 *
 * Response for the /1/object/ezsignfolder/editObject API Request
 */

#ifndef OAIUNUSED_ezsignfolder_editObject_v1_Response_H
#define OAIUNUSED_ezsignfolder_editObject_v1_Response_H
...
class OAIUNUSED_ezsignfolder_editObject_v1_Response : public OAIObject {
public:
    OAIUNUSED_ezsignfolder_editObject_v1_Response();
    OAIUNUSED_ezsignfolder_editObject_v1_Response(QString json);
    ~OAIUNUSED_ezsignfolder_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUNUSED_ezsignfolder_editObject_v1_Response)

#endif // OAIUNUSED_ezsignfolder_editObject_v1_Response_H
