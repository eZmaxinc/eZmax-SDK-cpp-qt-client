...
#ifndef Address_Response_H
#define Address_Response_H
...
class Address_Response : public Object {
public:
    Address_Response();
    Address_Response(const QString &json);
    ~Address_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Address_Response)

#endif // Address_Response_H
