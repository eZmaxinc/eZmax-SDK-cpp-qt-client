...
/*
 * OAICustom_EzmaxinvoicingEzsignfolder_Response.h
 *
 * An EzmaxinvoicingEzsignfolder object containing information about the Ezmaxinvoicing for an Ezsignfolder
 */

#ifndef OAICustom_EzmaxinvoicingEzsignfolder_Response_H
#define OAICustom_EzmaxinvoicingEzsignfolder_Response_H
...
class OAICustom_EzmaxinvoicingEzsignfolder_Response : public OAIObject {
public:
    OAICustom_EzmaxinvoicingEzsignfolder_Response();
    OAICustom_EzmaxinvoicingEzsignfolder_Response(QString json);
    ~OAICustom_EzmaxinvoicingEzsignfolder_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_EzmaxinvoicingEzsignfolder_Response)

#endif // OAICustom_EzmaxinvoicingEzsignfolder_Response_H
