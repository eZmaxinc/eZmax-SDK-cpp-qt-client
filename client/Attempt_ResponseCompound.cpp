...
Attempt_ResponseCompound::Attempt_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Attempt_ResponseCompound::Attempt_ResponseCompound() {
    this->initializeModel();
}

Attempt_ResponseCompound::~Attempt_ResponseCompound() {}

void Attempt_ResponseCompound::initializeModel() {
...
void Attempt_ResponseCompound::fromJson(const QString &jsonString) {
...
void Attempt_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Attempt_ResponseCompound::asJson() const {
...
QJsonObject Attempt_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
QString Attempt_ResponseCompound::getDtAttemptStart() const {
    return m_dt_attempt_start;
}
void Attempt_ResponseCompound::setDtAttemptStart(const QString &dt_attempt_start) {
    m_dt_attempt_start = dt_attempt_start;
    m_dt_attempt_start_isSet = true;
}

bool Attempt_ResponseCompound::is_dt_attempt_start_Set() const{
    return m_dt_attempt_start_isSet;
}

bool Attempt_ResponseCompound::is_dt_attempt_start_Valid() const{
    return m_dt_attempt_start_isValid;
}

QString Attempt_ResponseCompound::getSAttemptResult() const {
    return m_s_attempt_result;
}
void Attempt_ResponseCompound::setSAttemptResult(const QString &s_attempt_result) {
    m_s_attempt_result = s_attempt_result;
    m_s_attempt_result_isSet = true;
}

bool Attempt_ResponseCompound::is_s_attempt_result_Set() const{
    return m_s_attempt_result_isSet;
}

bool Attempt_ResponseCompound::is_s_attempt_result_Valid() const{
    return m_s_attempt_result_isValid;
}

qint32 Attempt_ResponseCompound::getIAttemptDuration() const {
    return m_i_attempt_duration;
}
void Attempt_ResponseCompound::setIAttemptDuration(const qint32 &i_attempt_duration) {
    m_i_attempt_duration = i_attempt_duration;
    m_i_attempt_duration_isSet = true;
}

bool Attempt_ResponseCompound::is_i_attempt_duration_Set() const{
    return m_i_attempt_duration_isSet;
}

bool Attempt_ResponseCompound::is_i_attempt_duration_Valid() const{
    return m_i_attempt_duration_isValid;
}

bool Attempt_ResponseCompound::isSet() const {
...
bool Attempt_ResponseCompound::isValid() const {
