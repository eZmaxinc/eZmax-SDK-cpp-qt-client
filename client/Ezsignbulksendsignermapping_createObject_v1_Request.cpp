...
Ezsignbulksendsignermapping_createObject_v1_Request::Ezsignbulksendsignermapping_createObject_v1_Request(const QString &json) {
...
void Ezsignbulksendsignermapping_createObject_v1_Request::fromJson(const QString &jsonString) {
