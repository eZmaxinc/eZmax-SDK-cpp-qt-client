...
/*
 * Notary_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/notary/{pkiNotaryID}/getAttachments
 */

#ifndef Notary_getAttachments_v1_Response_mPayload_H
#define Notary_getAttachments_v1_Response_mPayload_H
...
class Notary_getAttachments_v1_Response_mPayload : public Object {
public:
    Notary_getAttachments_v1_Response_mPayload();
    Notary_getAttachments_v1_Response_mPayload(const QString &json);
    ~Notary_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Notary_getAttachments_v1_Response_mPayload)

#endif // Notary_getAttachments_v1_Response_mPayload_H
