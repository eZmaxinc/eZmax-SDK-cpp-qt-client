...
#ifndef Custom_Ezsignformfield_Request_H
#define Custom_Ezsignformfield_Request_H
...
class Custom_Ezsignformfield_Request : public Object {
public:
    Custom_Ezsignformfield_Request();
    Custom_Ezsignformfield_Request(const QString &json);
    ~Custom_Ezsignformfield_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Custom_Ezsignformfield_Request)

#endif // Custom_Ezsignformfield_Request_H
