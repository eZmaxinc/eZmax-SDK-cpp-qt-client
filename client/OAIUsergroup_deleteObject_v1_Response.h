...
/*
 * OAIUsergroup_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroup/{pkiUsergroupID}
 */

#ifndef OAIUsergroup_deleteObject_v1_Response_H
#define OAIUsergroup_deleteObject_v1_Response_H
...
class OAIUsergroup_deleteObject_v1_Response : public OAIObject {
public:
    OAIUsergroup_deleteObject_v1_Response();
    OAIUsergroup_deleteObject_v1_Response(QString json);
    ~OAIUsergroup_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsergroup_deleteObject_v1_Response)

#endif // OAIUsergroup_deleteObject_v1_Response_H
