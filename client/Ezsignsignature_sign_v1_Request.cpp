...
Ezsignsignature_sign_v1_Request::Ezsignsignature_sign_v1_Request(const QString &json) {
...
void Ezsignsignature_sign_v1_Request::fromJson(const QString &jsonString) {
