...
public:
    OAIObjectFranchisebrokerApi(const QString &scheme = "https", const QString &host = "prod.api.appcluster01.ca-central-1.ezmax.com", int port = 0, const QString &basePath = "/rest", const int timeOut = 0);
    ...
    void franchisebrokerGetAutocompleteV1(const QString &s_selector, const QString &s_query);
