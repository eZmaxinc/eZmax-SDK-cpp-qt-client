...
/*
 * Ezsignfolder_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignfolder/{pkiEzsignfolderID}
 */

#ifndef Ezsignfolder_editObject_v1_Response_H
#define Ezsignfolder_editObject_v1_Response_H
...
class Ezsignfolder_editObject_v1_Response : public Object {
public:
    Ezsignfolder_editObject_v1_Response();
    Ezsignfolder_editObject_v1_Response(QString json);
    ~Ezsignfolder_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_editObject_v1_Response)

#endif // Ezsignfolder_editObject_v1_Response_H
