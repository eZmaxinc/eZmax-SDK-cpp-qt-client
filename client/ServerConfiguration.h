 ...
 */
#ifndef _SERVERVCONFIGURATION_H
#define _SERVERVCONFIGURATION_H
...
public:
     ...
     */
    ServerConfiguration(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables)
