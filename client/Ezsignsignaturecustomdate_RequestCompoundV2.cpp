...
Ezsignsignaturecustomdate_RequestCompoundV2::Ezsignsignaturecustomdate_RequestCompoundV2(const QString &json) {
...
void Ezsignsignaturecustomdate_RequestCompoundV2::fromJson(const QString &jsonString) {
