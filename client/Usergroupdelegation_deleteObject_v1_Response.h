...
/*
 * Usergroupdelegation_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroupdelegation/{pkiUsergroupdelegationID}
 */

#ifndef Usergroupdelegation_deleteObject_v1_Response_H
#define Usergroupdelegation_deleteObject_v1_Response_H
...
class Usergroupdelegation_deleteObject_v1_Response : public Object {
public:
    Usergroupdelegation_deleteObject_v1_Response();
    Usergroupdelegation_deleteObject_v1_Response(const QString &json);
    ~Usergroupdelegation_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupdelegation_deleteObject_v1_Response)

#endif // Usergroupdelegation_deleteObject_v1_Response_H
