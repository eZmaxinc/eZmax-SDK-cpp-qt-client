...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        SerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        SerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(SerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(SerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(SerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(SerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, SerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, SerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), SerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (SerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), SerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
