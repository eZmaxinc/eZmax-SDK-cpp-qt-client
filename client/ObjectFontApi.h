...
#ifndef _ObjectFontApi_H
#define _ObjectFontApi_H
...
class ObjectFontApi : public QObject {
    Q_OBJECT

public:
    ObjectFontApi(const int timeOut = 0);
    ~ObjectFontApi();
    ...
    */
    virtual void fontGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<QString> &s_query = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language = ::Ezmaxapi::OptionalParam<Header_Accept_Language>());
...
private:
    ...
    void fontGetAutocompleteV2Callback(HttpRequestWorker *worker);

Q_SIGNALS:

    void fontGetAutocompleteV2Signal(Font_getAutocomplete_v2_Response summary);
