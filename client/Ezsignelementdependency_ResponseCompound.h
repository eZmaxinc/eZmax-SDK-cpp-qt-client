...
/*
 * Ezsignelementdependency_ResponseCompound.h
 *
 * An Ezsignelementdependency Object and children to create a complete structure
 */

#ifndef Ezsignelementdependency_ResponseCompound_H
#define Ezsignelementdependency_ResponseCompound_H
...
class Ezsignelementdependency_ResponseCompound : public Object {
public:
    Ezsignelementdependency_ResponseCompound();
    Ezsignelementdependency_ResponseCompound(const QString &json);
    ~Ezsignelementdependency_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignelementdependency_ResponseCompound)

#endif // Ezsignelementdependency_ResponseCompound_H
