...
qint32 OAIEzsignsignature_getObject_v1_Response_mPayload::getFkiUserId() const {
    return fki_user_id;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setFkiUserId(const qint32 &fki_user_id) {
    this->fki_user_id = fki_user_id;
    this->m_fki_user_id_isSet = true;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_fki_user_id_Valid() const{
