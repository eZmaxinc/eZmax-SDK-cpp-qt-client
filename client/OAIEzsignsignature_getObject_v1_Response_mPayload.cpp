...
qint32 OAIEzsignsignature_getObject_v1_Response_mPayload::getIEzsignsignatureValidationstep() const {
    return i_ezsignsignature_validationstep;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setIEzsignsignatureValidationstep(const qint32 &i_ezsignsignature_validationstep) {
    this->i_ezsignsignature_validationstep = i_ezsignsignature_validationstep;
    this->m_i_ezsignsignature_validationstep_isSet = true;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_i_ezsignsignature_validationstep_Set() const{
    return m_i_ezsignsignature_validationstep_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_i_ezsignsignature_validationstep_Valid() const{
    return m_i_ezsignsignature_validationstep_isValid;
}

QString OAIEzsignsignature_getObject_v1_Response_mPayload::getSEzsignsignatureAttachmentdescription() const {
    return s_ezsignsignature_attachmentdescription;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setSEzsignsignatureAttachmentdescription(const QString &s_ezsignsignature_attachmentdescription) {
...
bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_s_ezsignsignature_attachmentdescription_Set() const{
    return m_s_ezsignsignature_attachmentdescription_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_s_ezsignsignature_attachmentdescription_Valid() const{
    return m_s_ezsignsignature_attachmentdescription_isValid;
}

OAIField_eEzsignsignatureAttachmentnamesource OAIEzsignsignature_getObject_v1_Response_mPayload::getEEzsignsignatureAttachmentnamesource() const {
    return e_ezsignsignature_attachmentnamesource;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setEEzsignsignatureAttachmentnamesource(const OAIField_eEzsignsignatureAttachmentnamesource &e_ezsignsignature_attachmentnamesource) {
...
bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_e_ezsignsignature_attachmentnamesource_Set() const{
    return m_e_ezsignsignature_attachmentnamesource_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_e_ezsignsignature_attachmentnamesource_Valid() const{
    return m_e_ezsignsignature_attachmentnamesource_isValid;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::isBEzsignsignatureRequired() const {
    return b_ezsignsignature_required;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setBEzsignsignatureRequired(const bool &b_ezsignsignature_required) {
    this->b_ezsignsignature_required = b_ezsignsignature_required;
    this->m_b_ezsignsignature_required_isSet = true;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_b_ezsignsignature_required_Set() const{
    return m_b_ezsignsignature_required_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_b_ezsignsignature_required_Valid() const{
    return m_b_ezsignsignature_required_isValid;
}

qint32 OAIEzsignsignature_getObject_v1_Response_mPayload::getFkiEzsignfoldersignerassociationIdValidation() const {
    return fki_ezsignfoldersignerassociation_id_validation;
}
void OAIEzsignsignature_getObject_v1_Response_mPayload::setFkiEzsignfoldersignerassociationIdValidation(const qint32 &fki_ezsignfoldersignerassociation_id_validation) {
...
bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_fki_ezsignfoldersignerassociation_id_validation_Set() const{
    return m_fki_ezsignfoldersignerassociation_id_validation_isSet;
}

bool OAIEzsignsignature_getObject_v1_Response_mPayload::is_fki_ezsignfoldersignerassociation_id_validation_Valid() const{
