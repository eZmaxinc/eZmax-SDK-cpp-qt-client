...
/*
 * Creditcardmerchant_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/creditcardmerchant/{pkiCreditcardmerchantID}
 */

#ifndef Creditcardmerchant_deleteObject_v1_Response_H
#define Creditcardmerchant_deleteObject_v1_Response_H
...
class Creditcardmerchant_deleteObject_v1_Response : public Object {
public:
    Creditcardmerchant_deleteObject_v1_Response();
    Creditcardmerchant_deleteObject_v1_Response(QString json);
    ~Creditcardmerchant_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardmerchant_deleteObject_v1_Response)

#endif // Creditcardmerchant_deleteObject_v1_Response_H
