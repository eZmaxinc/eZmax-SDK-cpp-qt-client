...
/*
 * OAISspr_sendUsernames_v1_Request.h
 *
 * Request for the /1/module/sspr/sendUsernames API Request
 */

#ifndef OAISspr_sendUsernames_v1_Request_H
#define OAISspr_sendUsernames_v1_Request_H
...
class OAISspr_sendUsernames_v1_Request : public OAIObject {
public:
    OAISspr_sendUsernames_v1_Request();
    OAISspr_sendUsernames_v1_Request(QString json);
    ~OAISspr_sendUsernames_v1_Request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISspr_sendUsernames_v1_Request)

#endif // OAISspr_sendUsernames_v1_Request_H
