...
/*
 * Externalbroker_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/externalbroker/{pkiExternalbrokerID}/getAttachments
 */

#ifndef Externalbroker_getAttachments_v1_Response_mPayload_H
#define Externalbroker_getAttachments_v1_Response_mPayload_H
...
class Externalbroker_getAttachments_v1_Response_mPayload : public Object {
public:
    Externalbroker_getAttachments_v1_Response_mPayload();
    Externalbroker_getAttachments_v1_Response_mPayload(const QString &json);
    ~Externalbroker_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Externalbroker_getAttachments_v1_Response_mPayload)

#endif // Externalbroker_getAttachments_v1_Response_mPayload_H
