...
OAIEzsigndocument_createObject_v2_Response_mPayload::OAIEzsigndocument_createObject_v2_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEzsigndocument_createObject_v2_Response_mPayload::OAIEzsigndocument_createObject_v2_Response_mPayload() {
    this->initializeModel();
}

OAIEzsigndocument_createObject_v2_Response_mPayload::~OAIEzsigndocument_createObject_v2_Response_mPayload() {}

void OAIEzsigndocument_createObject_v2_Response_mPayload::initializeModel() {

    m_a_pki_ezsigndocument_id_isSet = false;
    m_a_pki_ezsigndocument_id_isValid = false;
}

void OAIEzsigndocument_createObject_v2_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIEzsigndocument_createObject_v2_Response_mPayload::asJson() const {
...
bool OAIEzsigndocument_createObject_v2_Response_mPayload::is_a_pki_ezsigndocument_id_Valid() const{
...
bool OAIEzsigndocument_createObject_v2_Response_mPayload::isValid() const {
