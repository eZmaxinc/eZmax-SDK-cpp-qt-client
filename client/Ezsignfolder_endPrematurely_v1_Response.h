...
/*
 * Ezsignfolder_endPrematurely_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/endPrematurely
 */

#ifndef Ezsignfolder_endPrematurely_v1_Response_H
#define Ezsignfolder_endPrematurely_v1_Response_H
...
class Ezsignfolder_endPrematurely_v1_Response : public Object {
public:
    Ezsignfolder_endPrematurely_v1_Response();
    Ezsignfolder_endPrematurely_v1_Response(const QString &json);
    ~Ezsignfolder_endPrematurely_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_endPrematurely_v1_Response)

#endif // Ezsignfolder_endPrematurely_v1_Response_H
