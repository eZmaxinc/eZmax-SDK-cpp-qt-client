...
private:
    ...
    OAIEzsigntemplateformfieldgroup_RequestCompound m_obj_ezsigntemplateformfieldgroup;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplateformfieldgroup_editObject_v1_Request)
