...
Ezsignfoldersignerassociation_ResponseCompound_User::Ezsignfoldersignerassociation_ResponseCompound_User(const QString &json) {
...
void Ezsignfoldersignerassociation_ResponseCompound_User::fromJson(const QString &jsonString) {
...
Field_eUserType Ezsignfoldersignerassociation_ResponseCompound_User::getEUserType() const {
    return m_e_user_type;
}
void Ezsignfoldersignerassociation_ResponseCompound_User::setEUserType(const Field_eUserType &e_user_type) {
    m_e_user_type = e_user_type;
    m_e_user_type_isSet = true;
}

bool Ezsignfoldersignerassociation_ResponseCompound_User::is_e_user_type_Set() const{
    return m_e_user_type_isSet;
}

bool Ezsignfoldersignerassociation_ResponseCompound_User::is_e_user_type_Valid() const{
...
bool Ezsignfoldersignerassociation_ResponseCompound_User::isValid() const {
    ...
    return m_pki_user_id_isValid && m_fki_language_id_isValid && m_s_user_firstname_isValid && m_s_user_lastname_isValid && m_s_email_address_isValid && m_e_user_type_isValid && true;
}
