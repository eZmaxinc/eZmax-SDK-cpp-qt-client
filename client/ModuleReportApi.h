...
#ifndef _ModuleReportApi_H
#define _ModuleReportApi_H
...
class ModuleReportApi : public QObject {
    Q_OBJECT

public:
    ModuleReportApi(const int timeOut = 0);
    ~ModuleReportApi();
...
private:
    ...
    void reportGetReportFromCacheV1Callback(HttpRequestWorker *worker);
