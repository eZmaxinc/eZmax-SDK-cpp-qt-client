...
Ezsigndocument_getObject_v1_Response_mPayload::Ezsigndocument_getObject_v1_Response_mPayload(const QString &json) {
...
void Ezsigndocument_getObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
...
bool Ezsigndocument_getObject_v1_Response_mPayload::isBEzsigndocumentSendtoged() const {
    return m_b_ezsigndocument_sendtoged;
}
void Ezsigndocument_getObject_v1_Response_mPayload::setBEzsigndocumentSendtoged(const bool &b_ezsigndocument_sendtoged) {
    m_b_ezsigndocument_sendtoged = b_ezsigndocument_sendtoged;
    m_b_ezsigndocument_sendtoged_isSet = true;
}

bool Ezsigndocument_getObject_v1_Response_mPayload::is_b_ezsigndocument_sendtoged_Set() const{
    return m_b_ezsigndocument_sendtoged_isSet;
}

bool Ezsigndocument_getObject_v1_Response_mPayload::is_b_ezsigndocument_sendtoged_Valid() const{
