...
Ezsignformfieldgroup_ResponseCompound::Ezsignformfieldgroup_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignformfieldgroup_ResponseCompound::Ezsignformfieldgroup_ResponseCompound() {
    this->initializeModel();
}

Ezsignformfieldgroup_ResponseCompound::~Ezsignformfieldgroup_ResponseCompound() {}

void Ezsignformfieldgroup_ResponseCompound::initializeModel() {
    ...
    m_dt_ezsignformfieldgroup_completed_isSet = false;
    m_dt_ezsignformfieldgroup_completed_isValid = false;
...
void Ezsignformfieldgroup_ResponseCompound::fromJson(const QString &jsonString) {
...
void Ezsignformfieldgroup_ResponseCompound::fromJsonObject(QJsonObject json) {
    ...
    m_dt_ezsignformfieldgroup_completed_isValid = ::Ezmaxapi::fromJsonValue(m_dt_ezsignformfieldgroup_completed, json[QString("dtEzsignformfieldgroupCompleted")]);
    m_dt_ezsignformfieldgroup_completed_isSet = !json[QString("dtEzsignformfieldgroupCompleted")].isNull() && m_dt_ezsignformfieldgroup_completed_isValid;
...
QString Ezsignformfieldgroup_ResponseCompound::asJson() const {
...
QJsonObject Ezsignformfieldgroup_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_dt_ezsignformfieldgroup_completed_isSet) {
        obj.insert(QString("dtEzsignformfieldgroupCompleted"), ::Ezmaxapi::toJsonValue(m_dt_ezsignformfieldgroup_completed));
    }
...
qint32 Ezsignformfieldgroup_ResponseCompound::getPkiEzsignformfieldgroupId() const {
    return m_pki_ezsignformfieldgroup_id;
}
void Ezsignformfieldgroup_ResponseCompound::setPkiEzsignformfieldgroupId(const qint32 &pki_ezsignformfieldgroup_id) {
    m_pki_ezsignformfieldgroup_id = pki_ezsignformfieldgroup_id;
    m_pki_ezsignformfieldgroup_id_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_pki_ezsignformfieldgroup_id_Set() const{
    return m_pki_ezsignformfieldgroup_id_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_pki_ezsignformfieldgroup_id_Valid() const{
    return m_pki_ezsignformfieldgroup_id_isValid;
}

qint32 Ezsignformfieldgroup_ResponseCompound::getFkiEzsigndocumentId() const {
    return m_fki_ezsigndocument_id;
}
void Ezsignformfieldgroup_ResponseCompound::setFkiEzsigndocumentId(const qint32 &fki_ezsigndocument_id) {
    m_fki_ezsigndocument_id = fki_ezsigndocument_id;
    m_fki_ezsigndocument_id_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_fki_ezsigndocument_id_Set() const{
    return m_fki_ezsigndocument_id_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_fki_ezsigndocument_id_Valid() const{
    return m_fki_ezsigndocument_id_isValid;
}

Field_eEzsignformfieldgroupType Ezsignformfieldgroup_ResponseCompound::getEEzsignformfieldgroupType() const {
    return m_e_ezsignformfieldgroup_type;
}
void Ezsignformfieldgroup_ResponseCompound::setEEzsignformfieldgroupType(const Field_eEzsignformfieldgroupType &e_ezsignformfieldgroup_type) {
    m_e_ezsignformfieldgroup_type = e_ezsignformfieldgroup_type;
    m_e_ezsignformfieldgroup_type_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_type_Set() const{
    return m_e_ezsignformfieldgroup_type_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_type_Valid() const{
    return m_e_ezsignformfieldgroup_type_isValid;
}

Field_eEzsignformfieldgroupSignerrequirement Ezsignformfieldgroup_ResponseCompound::getEEzsignformfieldgroupSignerrequirement() const {
    return m_e_ezsignformfieldgroup_signerrequirement;
}
void Ezsignformfieldgroup_ResponseCompound::setEEzsignformfieldgroupSignerrequirement(const Field_eEzsignformfieldgroupSignerrequirement &e_ezsignformfieldgroup_signerrequirement) {
...
bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_signerrequirement_Set() const{
    return m_e_ezsignformfieldgroup_signerrequirement_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_signerrequirement_Valid() const{
    return m_e_ezsignformfieldgroup_signerrequirement_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getSEzsignformfieldgroupLabel() const {
    return m_s_ezsignformfieldgroup_label;
}
void Ezsignformfieldgroup_ResponseCompound::setSEzsignformfieldgroupLabel(const QString &s_ezsignformfieldgroup_label) {
    m_s_ezsignformfieldgroup_label = s_ezsignformfieldgroup_label;
    m_s_ezsignformfieldgroup_label_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_label_Set() const{
    return m_s_ezsignformfieldgroup_label_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_label_Valid() const{
    return m_s_ezsignformfieldgroup_label_isValid;
}

qint32 Ezsignformfieldgroup_ResponseCompound::getIEzsignformfieldgroupStep() const {
    return m_i_ezsignformfieldgroup_step;
}
void Ezsignformfieldgroup_ResponseCompound::setIEzsignformfieldgroupStep(const qint32 &i_ezsignformfieldgroup_step) {
    m_i_ezsignformfieldgroup_step = i_ezsignformfieldgroup_step;
    m_i_ezsignformfieldgroup_step_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_step_Set() const{
    return m_i_ezsignformfieldgroup_step_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_step_Valid() const{
    return m_i_ezsignformfieldgroup_step_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getSEzsignformfieldgroupDefaultvalue() const {
    return m_s_ezsignformfieldgroup_defaultvalue;
}
void Ezsignformfieldgroup_ResponseCompound::setSEzsignformfieldgroupDefaultvalue(const QString &s_ezsignformfieldgroup_defaultvalue) {
...
bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_defaultvalue_Set() const{
    return m_s_ezsignformfieldgroup_defaultvalue_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_defaultvalue_Valid() const{
    return m_s_ezsignformfieldgroup_defaultvalue_isValid;
}

qint32 Ezsignformfieldgroup_ResponseCompound::getIEzsignformfieldgroupFilledmin() const {
    return m_i_ezsignformfieldgroup_filledmin;
}
void Ezsignformfieldgroup_ResponseCompound::setIEzsignformfieldgroupFilledmin(const qint32 &i_ezsignformfieldgroup_filledmin) {
    m_i_ezsignformfieldgroup_filledmin = i_ezsignformfieldgroup_filledmin;
    m_i_ezsignformfieldgroup_filledmin_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_filledmin_Set() const{
    return m_i_ezsignformfieldgroup_filledmin_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_filledmin_Valid() const{
    return m_i_ezsignformfieldgroup_filledmin_isValid;
}

qint32 Ezsignformfieldgroup_ResponseCompound::getIEzsignformfieldgroupFilledmax() const {
    return m_i_ezsignformfieldgroup_filledmax;
}
void Ezsignformfieldgroup_ResponseCompound::setIEzsignformfieldgroupFilledmax(const qint32 &i_ezsignformfieldgroup_filledmax) {
    m_i_ezsignformfieldgroup_filledmax = i_ezsignformfieldgroup_filledmax;
    m_i_ezsignformfieldgroup_filledmax_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_filledmax_Set() const{
    return m_i_ezsignformfieldgroup_filledmax_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_filledmax_Valid() const{
    return m_i_ezsignformfieldgroup_filledmax_isValid;
}

bool Ezsignformfieldgroup_ResponseCompound::isBEzsignformfieldgroupReadonly() const {
    return m_b_ezsignformfieldgroup_readonly;
}
void Ezsignformfieldgroup_ResponseCompound::setBEzsignformfieldgroupReadonly(const bool &b_ezsignformfieldgroup_readonly) {
    m_b_ezsignformfieldgroup_readonly = b_ezsignformfieldgroup_readonly;
    m_b_ezsignformfieldgroup_readonly_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_b_ezsignformfieldgroup_readonly_Set() const{
    return m_b_ezsignformfieldgroup_readonly_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_b_ezsignformfieldgroup_readonly_Valid() const{
    return m_b_ezsignformfieldgroup_readonly_isValid;
}

qint32 Ezsignformfieldgroup_ResponseCompound::getIEzsignformfieldgroupMaxlength() const {
    return m_i_ezsignformfieldgroup_maxlength;
}
void Ezsignformfieldgroup_ResponseCompound::setIEzsignformfieldgroupMaxlength(const qint32 &i_ezsignformfieldgroup_maxlength) {
    m_i_ezsignformfieldgroup_maxlength = i_ezsignformfieldgroup_maxlength;
    m_i_ezsignformfieldgroup_maxlength_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_maxlength_Set() const{
    return m_i_ezsignformfieldgroup_maxlength_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_i_ezsignformfieldgroup_maxlength_Valid() const{
    return m_i_ezsignformfieldgroup_maxlength_isValid;
}

bool Ezsignformfieldgroup_ResponseCompound::isBEzsignformfieldgroupEncrypted() const {
    return m_b_ezsignformfieldgroup_encrypted;
}
void Ezsignformfieldgroup_ResponseCompound::setBEzsignformfieldgroupEncrypted(const bool &b_ezsignformfieldgroup_encrypted) {
    m_b_ezsignformfieldgroup_encrypted = b_ezsignformfieldgroup_encrypted;
    m_b_ezsignformfieldgroup_encrypted_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_b_ezsignformfieldgroup_encrypted_Set() const{
    return m_b_ezsignformfieldgroup_encrypted_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_b_ezsignformfieldgroup_encrypted_Valid() const{
    return m_b_ezsignformfieldgroup_encrypted_isValid;
}

Enum_Textvalidation Ezsignformfieldgroup_ResponseCompound::getEEzsignformfieldgroupTextvalidation() const {
    return m_e_ezsignformfieldgroup_textvalidation;
}
void Ezsignformfieldgroup_ResponseCompound::setEEzsignformfieldgroupTextvalidation(const Enum_Textvalidation &e_ezsignformfieldgroup_textvalidation) {
...
bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_textvalidation_Set() const{
    return m_e_ezsignformfieldgroup_textvalidation_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_textvalidation_Valid() const{
    return m_e_ezsignformfieldgroup_textvalidation_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getSEzsignformfieldgroupRegexp() const {
    return m_s_ezsignformfieldgroup_regexp;
}
void Ezsignformfieldgroup_ResponseCompound::setSEzsignformfieldgroupRegexp(const QString &s_ezsignformfieldgroup_regexp) {
    m_s_ezsignformfieldgroup_regexp = s_ezsignformfieldgroup_regexp;
    m_s_ezsignformfieldgroup_regexp_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_regexp_Set() const{
    return m_s_ezsignformfieldgroup_regexp_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_regexp_Valid() const{
    return m_s_ezsignformfieldgroup_regexp_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getSEzsignformfieldgroupTextvalidationcustommessage() const {
    return m_s_ezsignformfieldgroup_textvalidationcustommessage;
}
void Ezsignformfieldgroup_ResponseCompound::setSEzsignformfieldgroupTextvalidationcustommessage(const QString &s_ezsignformfieldgroup_textvalidationcustommessage) {
...
bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_textvalidationcustommessage_Set() const{
    return m_s_ezsignformfieldgroup_textvalidationcustommessage_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_s_ezsignformfieldgroup_textvalidationcustommessage_Valid() const{
    return m_s_ezsignformfieldgroup_textvalidationcustommessage_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getTEzsignformfieldgroupTooltip() const {
    return m_t_ezsignformfieldgroup_tooltip;
}
void Ezsignformfieldgroup_ResponseCompound::setTEzsignformfieldgroupTooltip(const QString &t_ezsignformfieldgroup_tooltip) {
    m_t_ezsignformfieldgroup_tooltip = t_ezsignformfieldgroup_tooltip;
    m_t_ezsignformfieldgroup_tooltip_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_t_ezsignformfieldgroup_tooltip_Set() const{
    return m_t_ezsignformfieldgroup_tooltip_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_t_ezsignformfieldgroup_tooltip_Valid() const{
    return m_t_ezsignformfieldgroup_tooltip_isValid;
}

Field_eEzsignformfieldgroupTooltipposition Ezsignformfieldgroup_ResponseCompound::getEEzsignformfieldgroupTooltipposition() const {
    return m_e_ezsignformfieldgroup_tooltipposition;
}
void Ezsignformfieldgroup_ResponseCompound::setEEzsignformfieldgroupTooltipposition(const Field_eEzsignformfieldgroupTooltipposition &e_ezsignformfieldgroup_tooltipposition) {
...
bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_tooltipposition_Set() const{
    return m_e_ezsignformfieldgroup_tooltipposition_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_e_ezsignformfieldgroup_tooltipposition_Valid() const{
    return m_e_ezsignformfieldgroup_tooltipposition_isValid;
}

QString Ezsignformfieldgroup_ResponseCompound::getDtEzsignformfieldgroupCompleted() const {
    return m_dt_ezsignformfieldgroup_completed;
}
void Ezsignformfieldgroup_ResponseCompound::setDtEzsignformfieldgroupCompleted(const QString &dt_ezsignformfieldgroup_completed) {
    m_dt_ezsignformfieldgroup_completed = dt_ezsignformfieldgroup_completed;
    m_dt_ezsignformfieldgroup_completed_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_dt_ezsignformfieldgroup_completed_Set() const{
    return m_dt_ezsignformfieldgroup_completed_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_dt_ezsignformfieldgroup_completed_Valid() const{
    return m_dt_ezsignformfieldgroup_completed_isValid;
}

QList<Ezsignformfield_ResponseCompound> Ezsignformfieldgroup_ResponseCompound::getAObjEzsignformfield() const {
    return m_a_obj_ezsignformfield;
}
void Ezsignformfieldgroup_ResponseCompound::setAObjEzsignformfield(const QList<Ezsignformfield_ResponseCompound> &a_obj_ezsignformfield) {
    m_a_obj_ezsignformfield = a_obj_ezsignformfield;
    m_a_obj_ezsignformfield_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_ezsignformfield_Set() const{
    return m_a_obj_ezsignformfield_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_ezsignformfield_Valid() const{
    return m_a_obj_ezsignformfield_isValid;
}

QList<Custom_DropdownElement_ResponseCompound> Ezsignformfieldgroup_ResponseCompound::getAObjDropdownElement() const {
    return m_a_obj_dropdown_element;
}
void Ezsignformfieldgroup_ResponseCompound::setAObjDropdownElement(const QList<Custom_DropdownElement_ResponseCompound> &a_obj_dropdown_element) {
    m_a_obj_dropdown_element = a_obj_dropdown_element;
    m_a_obj_dropdown_element_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_dropdown_element_Set() const{
    return m_a_obj_dropdown_element_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_dropdown_element_Valid() const{
    return m_a_obj_dropdown_element_isValid;
}

QList<Ezsignformfieldgroupsigner_ResponseCompound> Ezsignformfieldgroup_ResponseCompound::getAObjEzsignformfieldgroupsigner() const {
    return m_a_obj_ezsignformfieldgroupsigner;
}
void Ezsignformfieldgroup_ResponseCompound::setAObjEzsignformfieldgroupsigner(const QList<Ezsignformfieldgroupsigner_ResponseCompound> &a_obj_ezsignformfieldgroupsigner) {
    m_a_obj_ezsignformfieldgroupsigner = a_obj_ezsignformfieldgroupsigner;
    m_a_obj_ezsignformfieldgroupsigner_isSet = true;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_ezsignformfieldgroupsigner_Set() const{
    return m_a_obj_ezsignformfieldgroupsigner_isSet;
}

bool Ezsignformfieldgroup_ResponseCompound::is_a_obj_ezsignformfieldgroupsigner_Valid() const{
    return m_a_obj_ezsignformfieldgroupsigner_isValid;
}

bool Ezsignformfieldgroup_ResponseCompound::isSet() const {
...
bool Ezsignformfieldgroup_ResponseCompound::isValid() const {
