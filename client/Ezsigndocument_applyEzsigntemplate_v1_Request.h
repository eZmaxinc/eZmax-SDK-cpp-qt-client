...
#ifndef Ezsigndocument_applyEzsigntemplate_v1_Request_H
#define Ezsigndocument_applyEzsigntemplate_v1_Request_H
...
class Ezsigndocument_applyEzsigntemplate_v1_Request : public Object {
public:
    Ezsigndocument_applyEzsigntemplate_v1_Request();
    Ezsigndocument_applyEzsigntemplate_v1_Request(const QString &json);
    ~Ezsigndocument_applyEzsigntemplate_v1_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_applyEzsigntemplate_v1_Request)

#endif // Ezsigndocument_applyEzsigntemplate_v1_Request_H
