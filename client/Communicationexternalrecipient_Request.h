...
#ifndef Communicationexternalrecipient_Request_H
#define Communicationexternalrecipient_Request_H
...
class Communicationexternalrecipient_Request : public Object {
public:
    Communicationexternalrecipient_Request();
    Communicationexternalrecipient_Request(const QString &json);
    ~Communicationexternalrecipient_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Communicationexternalrecipient_Request)

#endif // Communicationexternalrecipient_Request_H
