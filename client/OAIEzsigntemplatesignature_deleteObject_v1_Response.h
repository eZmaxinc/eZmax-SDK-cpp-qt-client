...
/*
 * OAIEzsigntemplatesignature_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef OAIEzsigntemplatesignature_deleteObject_v1_Response_H
#define OAIEzsigntemplatesignature_deleteObject_v1_Response_H
...
class OAIEzsigntemplatesignature_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatesignature_deleteObject_v1_Response();
    OAIEzsigntemplatesignature_deleteObject_v1_Response(QString json);
    ~OAIEzsigntemplatesignature_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesignature_deleteObject_v1_Response)

#endif // OAIEzsigntemplatesignature_deleteObject_v1_Response_H
