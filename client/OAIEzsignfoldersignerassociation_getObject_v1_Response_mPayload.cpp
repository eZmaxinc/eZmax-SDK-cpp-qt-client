...
OAIUsergroup_ResponseCompound OAIEzsignfoldersignerassociation_getObject_v1_Response_mPayload::getObjUsergroup() const {
    return obj_usergroup;
}
void OAIEzsignfoldersignerassociation_getObject_v1_Response_mPayload::setObjUsergroup(const OAIUsergroup_ResponseCompound &obj_usergroup) {
    this->obj_usergroup = obj_usergroup;
    this->m_obj_usergroup_isSet = true;
}

bool OAIEzsignfoldersignerassociation_getObject_v1_Response_mPayload::is_obj_usergroup_Set() const{
    return m_obj_usergroup_isSet;
}

bool OAIEzsignfoldersignerassociation_getObject_v1_Response_mPayload::is_obj_usergroup_Valid() const{
