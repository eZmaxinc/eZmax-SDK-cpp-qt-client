...
Pdfalevel_AutocompleteElement_Response::Pdfalevel_AutocompleteElement_Response(const QString &json) {
...
void Pdfalevel_AutocompleteElement_Response::fromJson(const QString &jsonString) {
