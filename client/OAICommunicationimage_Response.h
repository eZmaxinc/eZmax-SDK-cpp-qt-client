...
/*
 * OAICommunicationimage_Response.h
 *
 * A Communicationimage Object
 */

#ifndef OAICommunicationimage_Response_H
#define OAICommunicationimage_Response_H
...
class OAICommunicationimage_Response : public OAIObject {
public:
    OAICommunicationimage_Response();
    OAICommunicationimage_Response(QString json);
    ~OAICommunicationimage_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunicationimage_Response)

#endif // OAICommunicationimage_Response_H
