...
/*
 * Activesession_getList_v1_Response.h
 *
 * Response for GET /1/object/activesession/getList
 */

#ifndef Activesession_getList_v1_Response_H
#define Activesession_getList_v1_Response_H
...
class Activesession_getList_v1_Response_mPayload;

class Activesession_getList_v1_Response : public Object {
public:
    Activesession_getList_v1_Response();
    Activesession_getList_v1_Response(const QString &json);
    ~Activesession_getList_v1_Response() override;
    ...
    Activesession_getList_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Activesession_getList_v1_Response_mPayload &m_payload);
...
private:
    ...
    Activesession_getList_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Activesession_getList_v1_Response)

#endif // Activesession_getList_v1_Response_H
