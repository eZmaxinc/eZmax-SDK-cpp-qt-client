...
/*
 * Cors_RequestCompound.h
 *
 * A Cors Object and children
 */

#ifndef Cors_RequestCompound_H
#define Cors_RequestCompound_H
...
class Cors_RequestCompound : public Object {
public:
    Cors_RequestCompound();
    Cors_RequestCompound(const QString &json);
    ~Cors_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Cors_RequestCompound)

#endif // Cors_RequestCompound_H
