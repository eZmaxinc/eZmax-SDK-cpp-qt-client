...
/*
 * Ezsignbulksend_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignbulksend/{pkiEzsignbulksendID}
 */

#ifndef Ezsignbulksend_deleteObject_v1_Response_H
#define Ezsignbulksend_deleteObject_v1_Response_H
...
class Ezsignbulksend_deleteObject_v1_Response : public Object {
public:
    Ezsignbulksend_deleteObject_v1_Response();
    Ezsignbulksend_deleteObject_v1_Response(const QString &json);
    ~Ezsignbulksend_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_deleteObject_v1_Response)

#endif // Ezsignbulksend_deleteObject_v1_Response_H
