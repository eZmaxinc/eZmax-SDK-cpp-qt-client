...
Ezsignbulksendtransmission_Response::Ezsignbulksendtransmission_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignbulksendtransmission_Response::Ezsignbulksendtransmission_Response() {
    this->initializeModel();
}

Ezsignbulksendtransmission_Response::~Ezsignbulksendtransmission_Response() {}

void Ezsignbulksendtransmission_Response::initializeModel() {
...
void Ezsignbulksendtransmission_Response::fromJson(const QString &jsonString) {
...
void Ezsignbulksendtransmission_Response::fromJsonObject(QJsonObject json) {
...
QString Ezsignbulksendtransmission_Response::asJson() const {
...
QJsonObject Ezsignbulksendtransmission_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignbulksendtransmission_Response::getPkiEzsignbulksendtransmissionId() const {
    return m_pki_ezsignbulksendtransmission_id;
}
void Ezsignbulksendtransmission_Response::setPkiEzsignbulksendtransmissionId(const qint32 &pki_ezsignbulksendtransmission_id) {
    m_pki_ezsignbulksendtransmission_id = pki_ezsignbulksendtransmission_id;
    m_pki_ezsignbulksendtransmission_id_isSet = true;
}

bool Ezsignbulksendtransmission_Response::is_pki_ezsignbulksendtransmission_id_Set() const{
    return m_pki_ezsignbulksendtransmission_id_isSet;
}

bool Ezsignbulksendtransmission_Response::is_pki_ezsignbulksendtransmission_id_Valid() const{
    return m_pki_ezsignbulksendtransmission_id_isValid;
}

qint32 Ezsignbulksendtransmission_Response::getFkiEzsignbulksendId() const {
    return m_fki_ezsignbulksend_id;
}
void Ezsignbulksendtransmission_Response::setFkiEzsignbulksendId(const qint32 &fki_ezsignbulksend_id) {
    m_fki_ezsignbulksend_id = fki_ezsignbulksend_id;
    m_fki_ezsignbulksend_id_isSet = true;
}

bool Ezsignbulksendtransmission_Response::is_fki_ezsignbulksend_id_Set() const{
    return m_fki_ezsignbulksend_id_isSet;
}

bool Ezsignbulksendtransmission_Response::is_fki_ezsignbulksend_id_Valid() const{
    return m_fki_ezsignbulksend_id_isValid;
}

QString Ezsignbulksendtransmission_Response::getSEzsignbulksendtransmissionDescription() const {
    return m_s_ezsignbulksendtransmission_description;
}
void Ezsignbulksendtransmission_Response::setSEzsignbulksendtransmissionDescription(const QString &s_ezsignbulksendtransmission_description) {
...
bool Ezsignbulksendtransmission_Response::is_s_ezsignbulksendtransmission_description_Set() const{
    return m_s_ezsignbulksendtransmission_description_isSet;
}

bool Ezsignbulksendtransmission_Response::is_s_ezsignbulksendtransmission_description_Valid() const{
    return m_s_ezsignbulksendtransmission_description_isValid;
}

qint32 Ezsignbulksendtransmission_Response::getIEzsignbulksendtransmissionErrors() const {
    return m_i_ezsignbulksendtransmission_errors;
}
void Ezsignbulksendtransmission_Response::setIEzsignbulksendtransmissionErrors(const qint32 &i_ezsignbulksendtransmission_errors) {
...
bool Ezsignbulksendtransmission_Response::is_i_ezsignbulksendtransmission_errors_Set() const{
    return m_i_ezsignbulksendtransmission_errors_isSet;
}

bool Ezsignbulksendtransmission_Response::is_i_ezsignbulksendtransmission_errors_Valid() const{
    return m_i_ezsignbulksendtransmission_errors_isValid;
}

Common_Audit Ezsignbulksendtransmission_Response::getObjAudit() const {
    return m_obj_audit;
}
void Ezsignbulksendtransmission_Response::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Ezsignbulksendtransmission_Response::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Ezsignbulksendtransmission_Response::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Ezsignbulksendtransmission_Response::isSet() const {
...
bool Ezsignbulksendtransmission_Response::isValid() const {
