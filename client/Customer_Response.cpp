...
Customer_Response::Customer_Response(const QString &json) {
...
void Customer_Response::fromJson(const QString &jsonString) {
...
QString Customer_Response::getSCustomerNote() const {
    return m_s_customer_note;
}
void Customer_Response::setSCustomerNote(const QString &s_customer_note) {
    m_s_customer_note = s_customer_note;
    m_s_customer_note_isSet = true;
}

bool Customer_Response::is_s_customer_note_Set() const{
    return m_s_customer_note_isSet;
}

bool Customer_Response::is_s_customer_note_Valid() const{
