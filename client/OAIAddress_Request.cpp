...
OAIAddress_Request::OAIAddress_Request() {
    this->initializeModel();
}

OAIAddress_Request::~OAIAddress_Request() {}

void OAIAddress_Request::initializeModel() {
...
void OAIAddress_Request::fromJson(QString jsonString) {
...
QString OAIAddress_Request::asJson() const {
...
bool OAIAddress_Request::is_fki_addresstype_id_Valid() const{
...
bool OAIAddress_Request::is_s_address_civic_Valid() const{
...
bool OAIAddress_Request::is_s_address_street_Valid() const{
...
bool OAIAddress_Request::is_s_address_suite_Valid() const{
...
bool OAIAddress_Request::is_s_address_city_Valid() const{
...
bool OAIAddress_Request::is_fki_province_id_Valid() const{
...
bool OAIAddress_Request::is_fki_country_id_Valid() const{
...
bool OAIAddress_Request::is_s_address_zip_Valid() const{
    return m_s_address_zip_isValid;
}

bool OAIAddress_Request::isSet() const {
...
bool OAIAddress_Request::isValid() const {
