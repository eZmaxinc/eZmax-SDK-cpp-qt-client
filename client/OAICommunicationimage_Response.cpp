...
#include "OAICommunicationimage_Response.h"
...
OAICommunicationimage_Response::OAICommunicationimage_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommunicationimage_Response::OAICommunicationimage_Response() {
    this->initializeModel();
}

OAICommunicationimage_Response::~OAICommunicationimage_Response() {}

void OAICommunicationimage_Response::initializeModel() {
...
void OAICommunicationimage_Response::fromJson(QString jsonString) {
...
void OAICommunicationimage_Response::fromJsonObject(QJsonObject json) {
...
QString OAICommunicationimage_Response::asJson() const {
...
QJsonObject OAICommunicationimage_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICommunicationimage_Response::getPkiCommunicationimageId() const {
    return pki_communicationimage_id;
}
void OAICommunicationimage_Response::setPkiCommunicationimageId(const qint32 &pki_communicationimage_id) {
    this->pki_communicationimage_id = pki_communicationimage_id;
    this->m_pki_communicationimage_id_isSet = true;
}

bool OAICommunicationimage_Response::is_pki_communicationimage_id_Set() const{
    return m_pki_communicationimage_id_isSet;
}

bool OAICommunicationimage_Response::is_pki_communicationimage_id_Valid() const{
    return m_pki_communicationimage_id_isValid;
}

qint32 OAICommunicationimage_Response::getFkiImageId() const {
    return fki_image_id;
}
void OAICommunicationimage_Response::setFkiImageId(const qint32 &fki_image_id) {
    this->fki_image_id = fki_image_id;
    this->m_fki_image_id_isSet = true;
}

bool OAICommunicationimage_Response::is_fki_image_id_Set() const{
    return m_fki_image_id_isSet;
}

bool OAICommunicationimage_Response::is_fki_image_id_Valid() const{
    return m_fki_image_id_isValid;
}

QString OAICommunicationimage_Response::getSCommunicationimageName() const {
    return s_communicationimage_name;
}
void OAICommunicationimage_Response::setSCommunicationimageName(const QString &s_communicationimage_name) {
    this->s_communicationimage_name = s_communicationimage_name;
    this->m_s_communicationimage_name_isSet = true;
}

bool OAICommunicationimage_Response::is_s_communicationimage_name_Set() const{
    return m_s_communicationimage_name_isSet;
}

bool OAICommunicationimage_Response::is_s_communicationimage_name_Valid() const{
    return m_s_communicationimage_name_isValid;
}

bool OAICommunicationimage_Response::isSet() const {
...
bool OAICommunicationimage_Response::isValid() const {
