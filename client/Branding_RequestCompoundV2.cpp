...
Branding_RequestCompoundV2::Branding_RequestCompoundV2() {
    this->initializeModel();
}

Branding_RequestCompoundV2::~Branding_RequestCompoundV2() {}

void Branding_RequestCompoundV2::initializeModel() {
...
void Branding_RequestCompoundV2::fromJsonObject(QJsonObject json) {
...
QString Branding_RequestCompoundV2::asJson() const {
...
QJsonObject Branding_RequestCompoundV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 Branding_RequestCompoundV2::getPkiBrandingId() const {
    return m_pki_branding_id;
}
void Branding_RequestCompoundV2::setPkiBrandingId(const qint32 &pki_branding_id) {
    m_pki_branding_id = pki_branding_id;
    m_pki_branding_id_isSet = true;
}

bool Branding_RequestCompoundV2::is_pki_branding_id_Set() const{
    return m_pki_branding_id_isSet;
}

bool Branding_RequestCompoundV2::is_pki_branding_id_Valid() const{
    return m_pki_branding_id_isValid;
}

qint32 Branding_RequestCompoundV2::getFkiDomainId() const {
    return m_fki_domain_id;
}
void Branding_RequestCompoundV2::setFkiDomainId(const qint32 &fki_domain_id) {
    m_fki_domain_id = fki_domain_id;
    m_fki_domain_id_isSet = true;
}

bool Branding_RequestCompoundV2::is_fki_domain_id_Set() const{
    return m_fki_domain_id_isSet;
}

bool Branding_RequestCompoundV2::is_fki_domain_id_Valid() const{
    return m_fki_domain_id_isValid;
}

Multilingual_BrandingDescription Branding_RequestCompoundV2::getObjBrandingDescription() const {
    return m_obj_branding_description;
}
void Branding_RequestCompoundV2::setObjBrandingDescription(const Multilingual_BrandingDescription &obj_branding_description) {
    m_obj_branding_description = obj_branding_description;
    m_obj_branding_description_isSet = true;
}

bool Branding_RequestCompoundV2::is_obj_branding_description_Set() const{
    return m_obj_branding_description_isSet;
}

bool Branding_RequestCompoundV2::is_obj_branding_description_Valid() const{
    return m_obj_branding_description_isValid;
}

Field_eBrandingLogo Branding_RequestCompoundV2::getEBrandingLogo() const {
    return m_e_branding_logo;
}
void Branding_RequestCompoundV2::setEBrandingLogo(const Field_eBrandingLogo &e_branding_logo) {
    m_e_branding_logo = e_branding_logo;
    m_e_branding_logo_isSet = true;
}

bool Branding_RequestCompoundV2::is_e_branding_logo_Set() const{
    return m_e_branding_logo_isSet;
}

bool Branding_RequestCompoundV2::is_e_branding_logo_Valid() const{
    return m_e_branding_logo_isValid;
}

Field_eBrandingAlignlogo Branding_RequestCompoundV2::getEBrandingAlignlogo() const {
    return m_e_branding_alignlogo;
}
void Branding_RequestCompoundV2::setEBrandingAlignlogo(const Field_eBrandingAlignlogo &e_branding_alignlogo) {
    m_e_branding_alignlogo = e_branding_alignlogo;
    m_e_branding_alignlogo_isSet = true;
}

bool Branding_RequestCompoundV2::is_e_branding_alignlogo_Set() const{
    return m_e_branding_alignlogo_isSet;
}

bool Branding_RequestCompoundV2::is_e_branding_alignlogo_Valid() const{
    return m_e_branding_alignlogo_isValid;
}

QByteArray Branding_RequestCompoundV2::getSBrandingBase64() const {
    return m_s_branding_base64;
}
void Branding_RequestCompoundV2::setSBrandingBase64(const QByteArray &s_branding_base64) {
    m_s_branding_base64 = s_branding_base64;
    m_s_branding_base64_isSet = true;
}

bool Branding_RequestCompoundV2::is_s_branding_base64_Set() const{
    return m_s_branding_base64_isSet;
}

bool Branding_RequestCompoundV2::is_s_branding_base64_Valid() const{
    return m_s_branding_base64_isValid;
}

qint32 Branding_RequestCompoundV2::getIBrandingColor() const {
    return m_i_branding_color;
}
void Branding_RequestCompoundV2::setIBrandingColor(const qint32 &i_branding_color) {
    m_i_branding_color = i_branding_color;
    m_i_branding_color_isSet = true;
}

bool Branding_RequestCompoundV2::is_i_branding_color_Set() const{
    return m_i_branding_color_isSet;
}

bool Branding_RequestCompoundV2::is_i_branding_color_Valid() const{
    return m_i_branding_color_isValid;
}

QString Branding_RequestCompoundV2::getSBrandingName() const {
    return m_s_branding_name;
}
void Branding_RequestCompoundV2::setSBrandingName(const QString &s_branding_name) {
    m_s_branding_name = s_branding_name;
    m_s_branding_name_isSet = true;
}

bool Branding_RequestCompoundV2::is_s_branding_name_Set() const{
    return m_s_branding_name_isSet;
}

bool Branding_RequestCompoundV2::is_s_branding_name_Valid() const{
    return m_s_branding_name_isValid;
}

QString Branding_RequestCompoundV2::getSEmailAddress() const {
    return m_s_email_address;
}
void Branding_RequestCompoundV2::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Branding_RequestCompoundV2::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Branding_RequestCompoundV2::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

bool Branding_RequestCompoundV2::isBBrandingIsactive() const {
    return m_b_branding_isactive;
}
void Branding_RequestCompoundV2::setBBrandingIsactive(const bool &b_branding_isactive) {
    m_b_branding_isactive = b_branding_isactive;
    m_b_branding_isactive_isSet = true;
}

bool Branding_RequestCompoundV2::is_b_branding_isactive_Set() const{
    return m_b_branding_isactive_isSet;
}

bool Branding_RequestCompoundV2::is_b_branding_isactive_Valid() const{
    return m_b_branding_isactive_isValid;
}

bool Branding_RequestCompoundV2::isSet() const {
...
bool Branding_RequestCompoundV2::isValid() const {
