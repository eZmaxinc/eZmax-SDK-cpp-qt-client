...
/*
 * Cors_getObject_v2_Response.h
 *
 * Response for GET /2/object/cors/{pkiCorsID}
 */

#ifndef Cors_getObject_v2_Response_H
#define Cors_getObject_v2_Response_H
...
class Cors_getObject_v2_Response_mPayload;

class Cors_getObject_v2_Response : public Object {
public:
    Cors_getObject_v2_Response();
    Cors_getObject_v2_Response(const QString &json);
    ~Cors_getObject_v2_Response() override;
    ...
    Cors_getObject_v2_Response_mPayload getMPayload() const;
    void setMPayload(const Cors_getObject_v2_Response_mPayload &m_payload);
...
private:
    ...
    Cors_getObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Cors_getObject_v2_Response)

#endif // Cors_getObject_v2_Response_H
