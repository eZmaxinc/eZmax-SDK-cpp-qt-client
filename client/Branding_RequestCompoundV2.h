...
/*
 * Branding_RequestCompoundV2.h
 *
 * A Branding Object and children
 */

#ifndef Branding_RequestCompoundV2_H
#define Branding_RequestCompoundV2_H
...
class Branding_RequestCompoundV2 : public Object {
public:
    Branding_RequestCompoundV2();
    Branding_RequestCompoundV2(const QString &json);
    ~Branding_RequestCompoundV2() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_RequestCompoundV2)

#endif // Branding_RequestCompoundV2_H
