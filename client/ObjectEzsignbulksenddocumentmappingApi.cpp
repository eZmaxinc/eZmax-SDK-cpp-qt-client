...
void ObjectEzsignbulksenddocumentmappingApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ezsignbulksenddocumentmappingGetObjectV3", defaultConf);
    _serverIndices.insert("ezsignbulksenddocumentmappingGetObjectV3", 0);
}
...
void ObjectEzsignbulksenddocumentmappingApi::setServerIndex(int serverIndex) {
...
void ObjectEzsignbulksenddocumentmappingApi::ezsignbulksenddocumentmappingGetObjectV3(const qint32 &pki_ezsignbulksenddocumentmapping_id) {
    QString fullPath = QString(_serverConfigs["ezsignbulksenddocumentmappingGetObjectV3"][_serverIndices.value("ezsignbulksenddocumentmappingGetObjectV3")].URL()+"/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignbulksenddocumentmappingApi::ezsignbulksenddocumentmappingGetObjectV3Callback);
    connect(this, &ObjectEzsignbulksenddocumentmappingApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignbulksenddocumentmappingApi::ezsignbulksenddocumentmappingGetObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignbulksenddocumentmapping_getObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignbulksenddocumentmappingGetObjectV3Signal(output);
        Q_EMIT ezsignbulksenddocumentmappingGetObjectV3SignalFull(worker, output);
    } else {
        Q_EMIT ezsignbulksenddocumentmappingGetObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsignbulksenddocumentmappingGetObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}
