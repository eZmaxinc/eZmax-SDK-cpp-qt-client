...
#ifndef Paymentterm_Response_H
#define Paymentterm_Response_H
...
class Paymentterm_Response : public Object {
public:
    Paymentterm_Response();
    Paymentterm_Response(const QString &json);
    ~Paymentterm_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentterm_Response)

#endif // Paymentterm_Response_H
