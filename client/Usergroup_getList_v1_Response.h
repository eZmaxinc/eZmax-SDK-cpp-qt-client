...
/*
 * Usergroup_getList_v1_Response.h
 *
 * Response for GET /1/object/usergroup/getList
 */

#ifndef Usergroup_getList_v1_Response_H
#define Usergroup_getList_v1_Response_H
...
class Usergroup_getList_v1_Response_mPayload;
...
public:
    ...
    Usergroup_getList_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Usergroup_getList_v1_Response_mPayload &m_payload);
...
private:
    ...
    Usergroup_getList_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroup_getList_v1_Response)

#endif // Usergroup_getList_v1_Response_H
