...
/*
 * Creditcardclient_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/creditcardclient/{pkiCreditcardclientID}
 */

#ifndef Creditcardclient_deleteObject_v1_Response_H
#define Creditcardclient_deleteObject_v1_Response_H
...
class Creditcardclient_deleteObject_v1_Response : public Object {
public:
    Creditcardclient_deleteObject_v1_Response();
    Creditcardclient_deleteObject_v1_Response(const QString &json);
    ~Creditcardclient_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardclient_deleteObject_v1_Response)

#endif // Creditcardclient_deleteObject_v1_Response_H
