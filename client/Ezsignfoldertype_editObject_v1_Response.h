...
/*
 * Ezsignfoldertype_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef Ezsignfoldertype_editObject_v1_Response_H
#define Ezsignfoldertype_editObject_v1_Response_H
...
class Ezsignfoldertype_editObject_v1_Response : public Object {
public:
    Ezsignfoldertype_editObject_v1_Response();
    Ezsignfoldertype_editObject_v1_Response(QString json);
    ~Ezsignfoldertype_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_editObject_v1_Response)

#endif // Ezsignfoldertype_editObject_v1_Response_H
