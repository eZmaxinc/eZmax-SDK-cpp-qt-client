...
bool OAIWebhook_ResponseCompound::isValid() const {
    ...
    return m_s_webhook_event_isValid && m_pki_webhook_id_isValid && m_s_webhook_description_isValid && m_e_webhook_module_isValid && m_s_webhook_url_isValid && m_s_webhook_emailfailed_isValid && m_b_webhook_skipsslvalidation_isValid && true;
}
