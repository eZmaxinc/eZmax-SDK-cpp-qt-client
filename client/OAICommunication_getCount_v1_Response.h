...
#define OAICommunication_getCount_v1_Response_H
...
class OAICommunication_getCount_v1_Response : public OAIObject {
public:
    OAICommunication_getCount_v1_Response();
    OAICommunication_getCount_v1_Response(QString json);
    ~OAICommunication_getCount_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunication_getCount_v1_Response)

#endif // OAICommunication_getCount_v1_Response_H
