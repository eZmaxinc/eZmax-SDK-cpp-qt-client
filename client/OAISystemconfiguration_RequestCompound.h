...
/*
 * OAISystemconfiguration_RequestCompound.h
 *
 * A Systemconfiguration Object and children
 */

#ifndef OAISystemconfiguration_RequestCompound_H
#define OAISystemconfiguration_RequestCompound_H
...
public:
    OAISystemconfiguration_RequestCompound();
    OAISystemconfiguration_RequestCompound(QString json);
    ~OAISystemconfiguration_RequestCompound() override;
