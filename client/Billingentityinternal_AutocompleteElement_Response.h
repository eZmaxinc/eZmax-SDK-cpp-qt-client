...
/*
 * Billingentityinternal_AutocompleteElement_Response.h
 *
 * A Billingentityinternal AutocompleteElement Response
 */

#ifndef Billingentityinternal_AutocompleteElement_Response_H
#define Billingentityinternal_AutocompleteElement_Response_H
...
class Billingentityinternal_AutocompleteElement_Response : public Object {
public:
    Billingentityinternal_AutocompleteElement_Response();
    Billingentityinternal_AutocompleteElement_Response(const QString &json);
    ~Billingentityinternal_AutocompleteElement_Response() override;
...
private:
    ...
    bool m_b_billingentityinternal_isactive;
...
Q_DECLARE_METATYPE(Ezmaxapi::Billingentityinternal_AutocompleteElement_Response)

#endif // Billingentityinternal_AutocompleteElement_Response_H
