...
OAIPermission_createObject_v1_Response_mPayload::OAIPermission_createObject_v1_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPermission_createObject_v1_Response_mPayload::OAIPermission_createObject_v1_Response_mPayload() {
    this->initializeModel();
}

OAIPermission_createObject_v1_Response_mPayload::~OAIPermission_createObject_v1_Response_mPayload() {}

void OAIPermission_createObject_v1_Response_mPayload::initializeModel() {

    m_a_pki_permission_id_isSet = false;
    m_a_pki_permission_id_isValid = false;
}

void OAIPermission_createObject_v1_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIPermission_createObject_v1_Response_mPayload::asJson() const {
...
bool OAIPermission_createObject_v1_Response_mPayload::is_a_pki_permission_id_Valid() const{
...
bool OAIPermission_createObject_v1_Response_mPayload::isValid() const {
