...
Descriptionstatic_Response::Descriptionstatic_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

Descriptionstatic_Response::Descriptionstatic_Response() {
    this->initializeModel();
}

Descriptionstatic_Response::~Descriptionstatic_Response() {}

void Descriptionstatic_Response::initializeModel() {
...
void Descriptionstatic_Response::fromJson(QString jsonString) {
...
void Descriptionstatic_Response::fromJsonObject(QJsonObject json) {
...
QString Descriptionstatic_Response::asJson() const {
...
QJsonObject Descriptionstatic_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Descriptionstatic_Response::getPkiDescriptionstaticId() const {
    return m_pki_descriptionstatic_id;
}
void Descriptionstatic_Response::setPkiDescriptionstaticId(const qint32 &pki_descriptionstatic_id) {
    m_pki_descriptionstatic_id = pki_descriptionstatic_id;
    m_pki_descriptionstatic_id_isSet = true;
}

bool Descriptionstatic_Response::is_pki_descriptionstatic_id_Set() const{
    return m_pki_descriptionstatic_id_isSet;
}

bool Descriptionstatic_Response::is_pki_descriptionstatic_id_Valid() const{
    return m_pki_descriptionstatic_id_isValid;
}

QString Descriptionstatic_Response::getSDescriptionstaticDescription() const {
    return m_s_descriptionstatic_description;
}
void Descriptionstatic_Response::setSDescriptionstaticDescription(const QString &s_descriptionstatic_description) {
    m_s_descriptionstatic_description = s_descriptionstatic_description;
    m_s_descriptionstatic_description_isSet = true;
}

bool Descriptionstatic_Response::is_s_descriptionstatic_description_Set() const{
    return m_s_descriptionstatic_description_isSet;
}

bool Descriptionstatic_Response::is_s_descriptionstatic_description_Valid() const{
    return m_s_descriptionstatic_description_isValid;
}

bool Descriptionstatic_Response::isSet() const {
...
bool Descriptionstatic_Response::isValid() const {
