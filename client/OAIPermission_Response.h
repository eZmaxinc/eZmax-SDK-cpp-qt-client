...
/*
 * OAIPermission_Response.h
 *
 * A Permission Object
 */

#ifndef OAIPermission_Response_H
#define OAIPermission_Response_H
...
class OAIPermission_Response : public OAIObject {
public:
    OAIPermission_Response();
    OAIPermission_Response(QString json);
    ~OAIPermission_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPermission_Response)

#endif // OAIPermission_Response_H
