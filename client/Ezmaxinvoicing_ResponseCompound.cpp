...
Ezmaxinvoicing_ResponseCompound::Ezmaxinvoicing_ResponseCompound(const QString &json) {
...
void Ezmaxinvoicing_ResponseCompound::fromJson(const QString &jsonString) {
