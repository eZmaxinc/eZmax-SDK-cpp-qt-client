...
QString OAIBranding_RequestCompound::getSBrandingName() const {
    return m_s_branding_name;
}
void OAIBranding_RequestCompound::setSBrandingName(const QString &s_branding_name) {
    m_s_branding_name = s_branding_name;
    m_s_branding_name_isSet = true;
}

bool OAIBranding_RequestCompound::is_s_branding_name_Set() const{
    return m_s_branding_name_isSet;
}

bool OAIBranding_RequestCompound::is_s_branding_name_Valid() const{
    return m_s_branding_name_isValid;
}

QString OAIBranding_RequestCompound::getSEmailAddress() const {
    return m_s_email_address;
}
void OAIBranding_RequestCompound::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool OAIBranding_RequestCompound::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool OAIBranding_RequestCompound::is_s_email_address_Valid() const{
