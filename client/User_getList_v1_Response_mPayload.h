...
/*
 * User_getList_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/user/getList
 */

#ifndef User_getList_v1_Response_mPayload_H
#define User_getList_v1_Response_mPayload_H
...
namespace Ezmaxapi {
class User_ListElement;

class User_getList_v1_Response_mPayload : public Object {
public:
    User_getList_v1_Response_mPayload();
    User_getList_v1_Response_mPayload(const QString &json);
    ~User_getList_v1_Response_mPayload() override;
    ...
    QList<User_ListElement> getAObjUser() const;
    void setAObjUser(const QList<User_ListElement> &a_obj_user);
...
private:
    ...
    QList<User_ListElement> m_a_obj_user;
...
Q_DECLARE_METATYPE(Ezmaxapi::User_getList_v1_Response_mPayload)

#endif // User_getList_v1_Response_mPayload_H
