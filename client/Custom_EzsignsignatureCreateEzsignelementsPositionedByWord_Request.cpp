...
Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request() {
    this->initializeModel();
}

Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::~Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request() {}

void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::initializeModel() {
...
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::fromJsonObject(QJsonObject json) {
...
QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::asJson() const {
...
QJsonObject Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getPkiEzsignsignatureId() const {
    return m_pki_ezsignsignature_id;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setPkiEzsignsignatureId(const qint32 &pki_ezsignsignature_id) {
    m_pki_ezsignsignature_id = pki_ezsignsignature_id;
    m_pki_ezsignsignature_id_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_pki_ezsignsignature_id_Set() const{
    return m_pki_ezsignsignature_id_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_pki_ezsignsignature_id_Valid() const{
    return m_pki_ezsignsignature_id_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getFkiEzsignfoldersignerassociationId() const {
    return m_fki_ezsignfoldersignerassociation_id;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setFkiEzsignfoldersignerassociationId(const qint32 &fki_ezsignfoldersignerassociation_id) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_fki_ezsignfoldersignerassociation_id_Set() const{
...
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureX() const {
    return m_i_ezsignsignature_x;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureX(const qint32 &i_ezsignsignature_x) {
    m_i_ezsignsignature_x = i_ezsignsignature_x;
    m_i_ezsignsignature_x_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_x_Set() const{
    return m_i_ezsignsignature_x_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_x_Valid() const{
    return m_i_ezsignsignature_x_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureY() const {
    return m_i_ezsignsignature_y;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureY(const qint32 &i_ezsignsignature_y) {
    m_i_ezsignsignature_y = i_ezsignsignature_y;
    m_i_ezsignsignature_y_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_y_Set() const{
    return m_i_ezsignsignature_y_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_y_Valid() const{
    return m_i_ezsignsignature_y_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureWidth() const {
    return m_i_ezsignsignature_width;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureWidth(const qint32 &i_ezsignsignature_width) {
    m_i_ezsignsignature_width = i_ezsignsignature_width;
    m_i_ezsignsignature_width_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_width_Set() const{
    return m_i_ezsignsignature_width_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_width_Valid() const{
    return m_i_ezsignsignature_width_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureHeight() const {
    return m_i_ezsignsignature_height;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureHeight(const qint32 &i_ezsignsignature_height) {
    m_i_ezsignsignature_height = i_ezsignsignature_height;
    m_i_ezsignsignature_height_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_height_Set() const{
    return m_i_ezsignsignature_height_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_height_Valid() const{
    return m_i_ezsignsignature_height_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureStep() const {
    return m_i_ezsignsignature_step;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureStep(const qint32 &i_ezsignsignature_step) {
    m_i_ezsignsignature_step = i_ezsignsignature_step;
    m_i_ezsignsignature_step_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_step_Set() const{
    return m_i_ezsignsignature_step_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_step_Valid() const{
    return m_i_ezsignsignature_step_isValid;
}

Field_eEzsignsignatureType Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureType() const {
    return m_e_ezsignsignature_type;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureType(const Field_eEzsignsignatureType &e_ezsignsignature_type) {
    m_e_ezsignsignature_type = e_ezsignsignature_type;
    m_e_ezsignsignature_type_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_type_Set() const{
...
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setFkiEzsigndocumentId(const qint32 &fki_ezsigndocument_id) {
    m_fki_ezsigndocument_id = fki_ezsigndocument_id;
    m_fki_ezsigndocument_id_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_fki_ezsigndocument_id_Set() const{
    return m_fki_ezsigndocument_id_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_fki_ezsigndocument_id_Valid() const{
    return m_fki_ezsigndocument_id_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getTEzsignsignatureTooltip() const {
    return m_t_ezsignsignature_tooltip;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setTEzsignsignatureTooltip(const QString &t_ezsignsignature_tooltip) {
    m_t_ezsignsignature_tooltip = t_ezsignsignature_tooltip;
    m_t_ezsignsignature_tooltip_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_t_ezsignsignature_tooltip_Set() const{
    return m_t_ezsignsignature_tooltip_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_t_ezsignsignature_tooltip_Valid() const{
    return m_t_ezsignsignature_tooltip_isValid;
}

Field_eEzsignsignatureTooltipposition Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureTooltipposition() const {
    return m_e_ezsignsignature_tooltipposition;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureTooltipposition(const Field_eEzsignsignatureTooltipposition &e_ezsignsignature_tooltipposition) {
    m_e_ezsignsignature_tooltipposition = e_ezsignsignature_tooltipposition;
    m_e_ezsignsignature_tooltipposition_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_tooltipposition_Set() const{
    return m_e_ezsignsignature_tooltipposition_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_tooltipposition_Valid() const{
    return m_e_ezsignsignature_tooltipposition_isValid;
}

Field_eEzsignsignatureFont Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureFont() const {
    return m_e_ezsignsignature_font;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureFont(const Field_eEzsignsignatureFont &e_ezsignsignature_font) {
    m_e_ezsignsignature_font = e_ezsignsignature_font;
    m_e_ezsignsignature_font_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_font_Set() const{
    return m_e_ezsignsignature_font_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_font_Valid() const{
    return m_e_ezsignsignature_font_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getFkiEzsignfoldersignerassociationIdValidation() const {
    return m_fki_ezsignfoldersignerassociation_id_validation;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setFkiEzsignfoldersignerassociationIdValidation(const qint32 &fki_ezsignfoldersignerassociation_id_validation) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_fki_ezsignfoldersignerassociation_id_validation_Set() const{
    return m_fki_ezsignfoldersignerassociation_id_validation_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_fki_ezsignfoldersignerassociation_id_validation_Valid() const{
    return m_fki_ezsignfoldersignerassociation_id_validation_isValid;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::isBEzsignsignatureHandwritten() const {
    return m_b_ezsignsignature_handwritten;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setBEzsignsignatureHandwritten(const bool &b_ezsignsignature_handwritten) {
    m_b_ezsignsignature_handwritten = b_ezsignsignature_handwritten;
    m_b_ezsignsignature_handwritten_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_handwritten_Set() const{
    return m_b_ezsignsignature_handwritten_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_handwritten_Valid() const{
    return m_b_ezsignsignature_handwritten_isValid;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::isBEzsignsignatureReason() const {
    return m_b_ezsignsignature_reason;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setBEzsignsignatureReason(const bool &b_ezsignsignature_reason) {
    m_b_ezsignsignature_reason = b_ezsignsignature_reason;
    m_b_ezsignsignature_reason_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_reason_Set() const{
    return m_b_ezsignsignature_reason_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_reason_Valid() const{
    return m_b_ezsignsignature_reason_isValid;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::isBEzsignsignatureRequired() const {
    return m_b_ezsignsignature_required;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setBEzsignsignatureRequired(const bool &b_ezsignsignature_required) {
    m_b_ezsignsignature_required = b_ezsignsignature_required;
    m_b_ezsignsignature_required_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_required_Set() const{
    return m_b_ezsignsignature_required_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_required_Valid() const{
    return m_b_ezsignsignature_required_isValid;
}

Field_eEzsignsignatureAttachmentnamesource Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureAttachmentnamesource() const {
    return m_e_ezsignsignature_attachmentnamesource;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureAttachmentnamesource(const Field_eEzsignsignatureAttachmentnamesource &e_ezsignsignature_attachmentnamesource) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_attachmentnamesource_Set() const{
    return m_e_ezsignsignature_attachmentnamesource_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_attachmentnamesource_Valid() const{
    return m_e_ezsignsignature_attachmentnamesource_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getSEzsignsignatureAttachmentdescription() const {
    return m_s_ezsignsignature_attachmentdescription;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setSEzsignsignatureAttachmentdescription(const QString &s_ezsignsignature_attachmentdescription) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_attachmentdescription_Set() const{
    return m_s_ezsignsignature_attachmentdescription_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_attachmentdescription_Valid() const{
    return m_s_ezsignsignature_attachmentdescription_isValid;
}

Field_eEzsignsignatureConsultationtrigger Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureConsultationtrigger() const {
    return m_e_ezsignsignature_consultationtrigger;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureConsultationtrigger(const Field_eEzsignsignatureConsultationtrigger &e_ezsignsignature_consultationtrigger) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_consultationtrigger_Set() const{
    return m_e_ezsignsignature_consultationtrigger_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_consultationtrigger_Valid() const{
    return m_e_ezsignsignature_consultationtrigger_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureValidationstep() const {
    return m_i_ezsignsignature_validationstep;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureValidationstep(const qint32 &i_ezsignsignature_validationstep) {
    m_i_ezsignsignature_validationstep = i_ezsignsignature_validationstep;
    m_i_ezsignsignature_validationstep_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_validationstep_Set() const{
    return m_i_ezsignsignature_validationstep_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_validationstep_Valid() const{
    return m_i_ezsignsignature_validationstep_isValid;
}

qint32 Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getIEzsignsignatureMaxlength() const {
    return m_i_ezsignsignature_maxlength;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setIEzsignsignatureMaxlength(const qint32 &i_ezsignsignature_maxlength) {
    m_i_ezsignsignature_maxlength = i_ezsignsignature_maxlength;
    m_i_ezsignsignature_maxlength_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_maxlength_Set() const{
    return m_i_ezsignsignature_maxlength_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_i_ezsignsignature_maxlength_Valid() const{
    return m_i_ezsignsignature_maxlength_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getSEzsignsignatureDefaultvalue() const {
    return m_s_ezsignsignature_defaultvalue;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setSEzsignsignatureDefaultvalue(const QString &s_ezsignsignature_defaultvalue) {
    m_s_ezsignsignature_defaultvalue = s_ezsignsignature_defaultvalue;
    m_s_ezsignsignature_defaultvalue_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_defaultvalue_Set() const{
    return m_s_ezsignsignature_defaultvalue_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_defaultvalue_Valid() const{
    return m_s_ezsignsignature_defaultvalue_isValid;
}

Enum_Textvalidation Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureTextvalidation() const {
    return m_e_ezsignsignature_textvalidation;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureTextvalidation(const Enum_Textvalidation &e_ezsignsignature_textvalidation) {
    m_e_ezsignsignature_textvalidation = e_ezsignsignature_textvalidation;
    m_e_ezsignsignature_textvalidation_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_textvalidation_Set() const{
    return m_e_ezsignsignature_textvalidation_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_textvalidation_Valid() const{
    return m_e_ezsignsignature_textvalidation_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getSEzsignsignatureTextvalidationcustommessage() const {
    return m_s_ezsignsignature_textvalidationcustommessage;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setSEzsignsignatureTextvalidationcustommessage(const QString &s_ezsignsignature_textvalidationcustommessage) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_textvalidationcustommessage_Set() const{
    return m_s_ezsignsignature_textvalidationcustommessage_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_textvalidationcustommessage_Valid() const{
    return m_s_ezsignsignature_textvalidationcustommessage_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getSEzsignsignatureRegexp() const {
    return m_s_ezsignsignature_regexp;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setSEzsignsignatureRegexp(const QString &s_ezsignsignature_regexp) {
    m_s_ezsignsignature_regexp = s_ezsignsignature_regexp;
    m_s_ezsignsignature_regexp_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_regexp_Set() const{
    return m_s_ezsignsignature_regexp_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_regexp_Valid() const{
    return m_s_ezsignsignature_regexp_isValid;
}

Field_eEzsignsignatureDependencyrequirement Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getEEzsignsignatureDependencyrequirement() const {
    return m_e_ezsignsignature_dependencyrequirement;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setEEzsignsignatureDependencyrequirement(const Field_eEzsignsignatureDependencyrequirement &e_ezsignsignature_dependencyrequirement) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_dependencyrequirement_Set() const{
    return m_e_ezsignsignature_dependencyrequirement_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_e_ezsignsignature_dependencyrequirement_Valid() const{
    return m_e_ezsignsignature_dependencyrequirement_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getSEzsignsignatureCreditcardamountdescription() const {
    return m_s_ezsignsignature_creditcardamountdescription;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setSEzsignsignatureCreditcardamountdescription(const QString &s_ezsignsignature_creditcardamountdescription) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_creditcardamountdescription_Set() const{
    return m_s_ezsignsignature_creditcardamountdescription_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_s_ezsignsignature_creditcardamountdescription_Valid() const{
    return m_s_ezsignsignature_creditcardamountdescription_isValid;
}

QString Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getDEzsignsignatureCreditcardamount() const {
    return m_d_ezsignsignature_creditcardamount;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setDEzsignsignatureCreditcardamount(const QString &d_ezsignsignature_creditcardamount) {
    m_d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount;
    m_d_ezsignsignature_creditcardamount_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_d_ezsignsignature_creditcardamount_Set() const{
    return m_d_ezsignsignature_creditcardamount_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_d_ezsignsignature_creditcardamount_Valid() const{
...
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setBEzsignsignatureCustomdate(const bool &b_ezsignsignature_customdate) {
    m_b_ezsignsignature_customdate = b_ezsignsignature_customdate;
    m_b_ezsignsignature_customdate_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_customdate_Set() const{
    return m_b_ezsignsignature_customdate_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_b_ezsignsignature_customdate_Valid() const{
    return m_b_ezsignsignature_customdate_isValid;
}

QList<Ezsignsignaturecustomdate_RequestCompound> Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getAObjEzsignsignaturecustomdate() const {
    return m_a_obj_ezsignsignaturecustomdate;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setAObjEzsignsignaturecustomdate(const QList<Ezsignsignaturecustomdate_RequestCompound> &a_obj_ezsignsignaturecustomdate) {
    m_a_obj_ezsignsignaturecustomdate = a_obj_ezsignsignaturecustomdate;
    m_a_obj_ezsignsignaturecustomdate_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignsignaturecustomdate_Set() const{
    return m_a_obj_ezsignsignaturecustomdate_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignsignaturecustomdate_Valid() const{
    return m_a_obj_ezsignsignaturecustomdate_isValid;
}

QList<Ezsignelementdependency_RequestCompound> Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getAObjEzsignelementdependency() const {
    return m_a_obj_ezsignelementdependency;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setAObjEzsignelementdependency(const QList<Ezsignelementdependency_RequestCompound> &a_obj_ezsignelementdependency) {
    m_a_obj_ezsignelementdependency = a_obj_ezsignelementdependency;
    m_a_obj_ezsignelementdependency_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignelementdependency_Set() const{
    return m_a_obj_ezsignelementdependency_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignelementdependency_Valid() const{
    return m_a_obj_ezsignelementdependency_isValid;
}

QList<Ezsignsignaturepaymentdetail_RequestCompound> Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getAObjEzsignsignaturepaymentdetail() const {
    return m_a_obj_ezsignsignaturepaymentdetail;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setAObjEzsignsignaturepaymentdetail(const QList<Ezsignsignaturepaymentdetail_RequestCompound> &a_obj_ezsignsignaturepaymentdetail) {
    m_a_obj_ezsignsignaturepaymentdetail = a_obj_ezsignsignaturepaymentdetail;
    m_a_obj_ezsignsignaturepaymentdetail_isSet = true;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignsignaturepaymentdetail_Set() const{
    return m_a_obj_ezsignsignaturepaymentdetail_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_a_obj_ezsignsignaturepaymentdetail_Valid() const{
    return m_a_obj_ezsignsignaturepaymentdetail_isValid;
}

Custom_CreateEzsignelementsPositionedByWord_Request Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::getObjCreateezsignelementspositionedbyword() const {
    return m_obj_createezsignelementspositionedbyword;
}
void Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::setObjCreateezsignelementspositionedbyword(const Custom_CreateEzsignelementsPositionedByWord_Request &obj_createezsignelementspositionedbyword) {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_obj_createezsignelementspositionedbyword_Set() const{
    return m_obj_createezsignelementspositionedbyword_isSet;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::is_obj_createezsignelementspositionedbyword_Valid() const{
    return m_obj_createezsignelementspositionedbyword_isValid;
}

bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::isSet() const {
...
bool Custom_EzsignsignatureCreateEzsignelementsPositionedByWord_Request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fki_ezsignfoldersignerassociation_id_isValid && m_i_ezsignpage_pagenumber_isValid && m_i_ezsignsignature_x_isValid && m_i_ezsignsignature_y_isValid && m_i_ezsignsignature_step_isValid && m_e_ezsignsignature_type_isValid && m_fki_ezsigndocument_id_isValid && m_obj_createezsignelementspositionedbyword_isValid && true;
}
