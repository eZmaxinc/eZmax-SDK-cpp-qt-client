...
/*
 * OAIUsergroup_editUsergroupdelegations_v1_Request.h
 *
 * Request for PUT /1/object/usergroup/{pkiUsergroupID}/editUsergroupdelegations
 */

#ifndef OAIUsergroup_editUsergroupdelegations_v1_Request_H
#define OAIUsergroup_editUsergroupdelegations_v1_Request_H
...
class OAIUsergroup_editUsergroupdelegations_v1_Request : public OAIObject {
public:
    OAIUsergroup_editUsergroupdelegations_v1_Request();
    OAIUsergroup_editUsergroupdelegations_v1_Request(QString json);
    ~OAIUsergroup_editUsergroupdelegations_v1_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroup_editUsergroupdelegations_v1_Request)

#endif // OAIUsergroup_editUsergroupdelegations_v1_Request_H
