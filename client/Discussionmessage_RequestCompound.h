...
/*
 * Discussionmessage_RequestCompound.h
 *
 * A Discussionmessage Object and children
 */

#ifndef Discussionmessage_RequestCompound_H
#define Discussionmessage_RequestCompound_H
...
class Discussionmessage_RequestCompound : public Object {
public:
    Discussionmessage_RequestCompound();
    Discussionmessage_RequestCompound(const QString &json);
    ~Discussionmessage_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussionmessage_RequestCompound)

#endif // Discussionmessage_RequestCompound_H
