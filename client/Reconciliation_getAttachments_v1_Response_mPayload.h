...
/*
 * Reconciliation_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/reconciliation/{pkiReconciliationID}/getAttachments
 */

#ifndef Reconciliation_getAttachments_v1_Response_mPayload_H
#define Reconciliation_getAttachments_v1_Response_mPayload_H
...
class Reconciliation_getAttachments_v1_Response_mPayload : public Object {
public:
    Reconciliation_getAttachments_v1_Response_mPayload();
    Reconciliation_getAttachments_v1_Response_mPayload(const QString &json);
    ~Reconciliation_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Reconciliation_getAttachments_v1_Response_mPayload)

#endif // Reconciliation_getAttachments_v1_Response_mPayload_H
