...
Creditcarddetail_ResponseCompound::Creditcarddetail_ResponseCompound(const QString &json) {
...
void Creditcarddetail_ResponseCompound::fromJson(const QString &jsonString) {
