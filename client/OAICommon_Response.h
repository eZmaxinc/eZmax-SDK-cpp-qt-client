...
/*
 * OAICommon_Response.h
 *
 * All API response will inherit this based Response
 */

#ifndef OAICommon_Response_H
#define OAICommon_Response_H
...
class OAICommon_Response : public OAIObject {
public:
    OAICommon_Response();
    OAICommon_Response(QString json);
    ~OAICommon_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICommon_Response)

#endif // OAICommon_Response_H
