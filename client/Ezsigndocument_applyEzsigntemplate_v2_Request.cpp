...
Ezsigndocument_applyEzsigntemplate_v2_Request::Ezsigndocument_applyEzsigntemplate_v2_Request(const QString &json) {
...
void Ezsigndocument_applyEzsigntemplate_v2_Request::fromJson(const QString &jsonString) {
