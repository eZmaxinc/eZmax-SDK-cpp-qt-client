...
Ezsigndocument_editObject_v1_Request::Ezsigndocument_editObject_v1_Request(const QString &json) {
...
void Ezsigndocument_editObject_v1_Request::initializeModel() {

    m_obj_ezsigndocument_isSet = false;
    m_obj_ezsigndocument_isValid = false;
}

void Ezsigndocument_editObject_v1_Request::fromJson(const QString &jsonString) {
...
void Ezsigndocument_editObject_v1_Request::fromJsonObject(QJsonObject json) {
...
QString Ezsigndocument_editObject_v1_Request::asJson() const {
...
QJsonObject Ezsigndocument_editObject_v1_Request::asJsonObject() const {
    QJsonObject obj;
...
bool Ezsigndocument_editObject_v1_Request::is_obj_ezsigndocument_Set() const{
    return m_obj_ezsigndocument_isSet;
}

bool Ezsigndocument_editObject_v1_Request::is_obj_ezsigndocument_Valid() const{
    return m_obj_ezsigndocument_isValid;
}

bool Ezsigndocument_editObject_v1_Request::isSet() const {
...
bool Ezsigndocument_editObject_v1_Request::isValid() const {
