...
User_AutocompleteElement_Response::User_AutocompleteElement_Response(const QString &json) {
...
void User_AutocompleteElement_Response::fromJson(const QString &jsonString) {
