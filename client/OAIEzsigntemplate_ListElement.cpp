...
bool OAIEzsigntemplate_ListElement::isValid() const {
    ...
    return m_pki_ezsigntemplate_id_isValid && m_fki_ezsignfoldertype_id_isValid && m_fki_language_id_isValid && m_s_ezsigntemplate_description_isValid && m_i_ezsigntemplatedocument_pagetotal_isValid && m_i_ezsigntemplate_signaturetotal_isValid && m_b_ezsigntemplate_incomplete_isValid && m_s_ezsignfoldertype_name_x_isValid && true;
}
