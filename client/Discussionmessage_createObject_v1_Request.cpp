...
Discussionmessage_createObject_v1_Request::Discussionmessage_createObject_v1_Request(const QString &json) {
...
void Discussionmessage_createObject_v1_Request::fromJson(const QString &jsonString) {
