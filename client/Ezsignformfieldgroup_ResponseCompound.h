...
/*
 * Ezsignformfieldgroup_ResponseCompound.h
 *
 * An Ezsignformfieldgroup Object and children to create a complete structure
 */

#ifndef Ezsignformfieldgroup_ResponseCompound_H
#define Ezsignformfieldgroup_ResponseCompound_H
...
namespace Ezmaxapi {
class Ezsignformfield_ResponseCompound;
class Custom_DropdownElement_ResponseCompound;
class Ezsignformfieldgroupsigner_ResponseCompound;

class Ezsignformfieldgroup_ResponseCompound : public Object {
public:
    Ezsignformfieldgroup_ResponseCompound();
    Ezsignformfieldgroup_ResponseCompound(const QString &json);
    ~Ezsignformfieldgroup_ResponseCompound() override;
    ...
    QString getDtEzsignformfieldgroupCompleted() const;
    void setDtEzsignformfieldgroupCompleted(const QString &dt_ezsignformfieldgroup_completed);
    bool is_dt_ezsignformfieldgroup_completed_Set() const;
    bool is_dt_ezsignformfieldgroup_completed_Valid() const;

    QList<Ezsignformfield_ResponseCompound> getAObjEzsignformfield() const;
    void setAObjEzsignformfield(const QList<Ezsignformfield_ResponseCompound> &a_obj_ezsignformfield);
    ...
    QList<Ezsignformfieldgroupsigner_ResponseCompound> getAObjEzsignformfieldgroupsigner() const;
    void setAObjEzsignformfieldgroupsigner(const QList<Ezsignformfieldgroupsigner_ResponseCompound> &a_obj_ezsignformfieldgroupsigner);
...
private:
    ...
    QString m_dt_ezsignformfieldgroup_completed;
    bool m_dt_ezsignformfieldgroup_completed_isSet;
    bool m_dt_ezsignformfieldgroup_completed_isValid;

    QList<Ezsignformfield_ResponseCompound> m_a_obj_ezsignformfield;
    ...
    QList<Ezsignformfieldgroupsigner_ResponseCompound> m_a_obj_ezsignformfieldgroupsigner;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfieldgroup_ResponseCompound)

#endif // Ezsignformfieldgroup_ResponseCompound_H
