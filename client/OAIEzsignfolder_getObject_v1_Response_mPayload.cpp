...
QString OAIEzsignfolder_getObject_v1_Response_mPayload::getDtEzsignfolderScheduleddestruction() const {
    return dt_ezsignfolder_scheduleddestruction;
}
void OAIEzsignfolder_getObject_v1_Response_mPayload::setDtEzsignfolderScheduleddestruction(const QString &dt_ezsignfolder_scheduleddestruction) {
...
bool OAIEzsignfolder_getObject_v1_Response_mPayload::is_dt_ezsignfolder_scheduleddestruction_Set() const{
    return m_dt_ezsignfolder_scheduleddestruction_isSet;
}

bool OAIEzsignfolder_getObject_v1_Response_mPayload::is_dt_ezsignfolder_scheduleddestruction_Valid() const{
