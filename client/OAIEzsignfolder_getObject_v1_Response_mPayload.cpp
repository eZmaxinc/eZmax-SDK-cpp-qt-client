...
OAICustom_Ezsignfoldertype_Response OAIEzsignfolder_getObject_v1_Response_mPayload::getObjEzsignfoldertype() const {
    return m_obj_ezsignfoldertype;
}
void OAIEzsignfolder_getObject_v1_Response_mPayload::setObjEzsignfoldertype(const OAICustom_Ezsignfoldertype_Response &obj_ezsignfoldertype) {
    m_obj_ezsignfoldertype = obj_ezsignfoldertype;
    m_obj_ezsignfoldertype_isSet = true;
}

bool OAIEzsignfolder_getObject_v1_Response_mPayload::is_obj_ezsignfoldertype_Set() const{
    return m_obj_ezsignfoldertype_isSet;
}

bool OAIEzsignfolder_getObject_v1_Response_mPayload::is_obj_ezsignfoldertype_Valid() const{
