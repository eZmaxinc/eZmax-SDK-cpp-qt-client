...
Webhook_Request::Webhook_Request(const QString &json) {
...
void Webhook_Request::fromJson(const QString &jsonString) {
...
qint32 Webhook_Request::getFkiAuthenticationexternalId() const {
    return m_fki_authenticationexternal_id;
}
void Webhook_Request::setFkiAuthenticationexternalId(const qint32 &fki_authenticationexternal_id) {
    m_fki_authenticationexternal_id = fki_authenticationexternal_id;
    m_fki_authenticationexternal_id_isSet = true;
}

bool Webhook_Request::is_fki_authenticationexternal_id_Set() const{
    return m_fki_authenticationexternal_id_isSet;
}

bool Webhook_Request::is_fki_authenticationexternal_id_Valid() const{
...
Field_eWebhookRealestateevent Webhook_Request::getEWebhookRealestateevent() const {
    return m_e_webhook_realestateevent;
}
void Webhook_Request::setEWebhookRealestateevent(const Field_eWebhookRealestateevent &e_webhook_realestateevent) {
    m_e_webhook_realestateevent = e_webhook_realestateevent;
    m_e_webhook_realestateevent_isSet = true;
}

bool Webhook_Request::is_e_webhook_realestateevent_Set() const{
    return m_e_webhook_realestateevent_isSet;
}

bool Webhook_Request::is_e_webhook_realestateevent_Valid() const{
