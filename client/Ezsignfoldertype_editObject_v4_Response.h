...
/*
 * Ezsignfoldertype_editObject_v4_Response.h
 *
 * Response for PUT /4/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef Ezsignfoldertype_editObject_v4_Response_H
#define Ezsignfoldertype_editObject_v4_Response_H
...
class Ezsignfoldertype_editObject_v4_Response : public Object {
public:
    Ezsignfoldertype_editObject_v4_Response();
    Ezsignfoldertype_editObject_v4_Response(const QString &json);
    ~Ezsignfoldertype_editObject_v4_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_editObject_v4_Response)

#endif // Ezsignfoldertype_editObject_v4_Response_H
