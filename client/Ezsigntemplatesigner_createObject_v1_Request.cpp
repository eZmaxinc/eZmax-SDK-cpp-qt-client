...
Ezsigntemplatesigner_createObject_v1_Request::Ezsigntemplatesigner_createObject_v1_Request(const QString &json) {
...
void Ezsigntemplatesigner_createObject_v1_Request::fromJson(const QString &jsonString) {
