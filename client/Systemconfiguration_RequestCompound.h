...
/*
 * Systemconfiguration_RequestCompound.h
 *
 * A Systemconfiguration Object and children
 */

#ifndef Systemconfiguration_RequestCompound_H
#define Systemconfiguration_RequestCompound_H
...
class Systemconfiguration_RequestCompound : public Object {
public:
    Systemconfiguration_RequestCompound();
    Systemconfiguration_RequestCompound(QString json);
    ~Systemconfiguration_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Systemconfiguration_RequestCompound)

#endif // Systemconfiguration_RequestCompound_H
