...
OAISubnet_Response::OAISubnet_Response() {
    this->initializeModel();
}

OAISubnet_Response::~OAISubnet_Response() {}

void OAISubnet_Response::initializeModel() {
...
void OAISubnet_Response::fromJson(QString jsonString) {
...
QString OAISubnet_Response::asJson() const {
...
qint32 OAISubnet_Response::getPkiSubnetId() const {
    return m_pki_subnet_id;
}
void OAISubnet_Response::setPkiSubnetId(const qint32 &pki_subnet_id) {
    m_pki_subnet_id = pki_subnet_id;
    m_pki_subnet_id_isSet = true;
}

bool OAISubnet_Response::is_pki_subnet_id_Set() const{
    return m_pki_subnet_id_isSet;
}

bool OAISubnet_Response::is_pki_subnet_id_Valid() const{
    return m_pki_subnet_id_isValid;
}

qint32 OAISubnet_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void OAISubnet_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool OAISubnet_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool OAISubnet_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 OAISubnet_Response::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void OAISubnet_Response::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool OAISubnet_Response::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool OAISubnet_Response::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

OAIMultilingual_SubnetDescription OAISubnet_Response::getObjSubnetDescription() const {
    return m_obj_subnet_description;
}
void OAISubnet_Response::setObjSubnetDescription(const OAIMultilingual_SubnetDescription &obj_subnet_description) {
    m_obj_subnet_description = obj_subnet_description;
    m_obj_subnet_description_isSet = true;
}

bool OAISubnet_Response::is_obj_subnet_description_Set() const{
    return m_obj_subnet_description_isSet;
}

bool OAISubnet_Response::is_obj_subnet_description_Valid() const{
...
bool OAISubnet_Response::is_i_subnet_network_Set() const{
    return m_i_subnet_network_isSet;
}

bool OAISubnet_Response::is_i_subnet_network_Valid() const{
...
bool OAISubnet_Response::is_i_subnet_mask_Set() const{
    return m_i_subnet_mask_isSet;
}

bool OAISubnet_Response::is_i_subnet_mask_Valid() const{
    return m_i_subnet_mask_isValid;
}

bool OAISubnet_Response::isSet() const {
...
bool OAISubnet_Response::isValid() const {
