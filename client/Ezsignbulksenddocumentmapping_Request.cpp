...
Ezsignbulksenddocumentmapping_Request::Ezsignbulksenddocumentmapping_Request(const QString &json) {
...
void Ezsignbulksenddocumentmapping_Request::fromJson(const QString &jsonString) {
