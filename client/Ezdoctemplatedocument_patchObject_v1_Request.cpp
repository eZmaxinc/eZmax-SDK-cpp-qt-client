...
Ezdoctemplatedocument_patchObject_v1_Request::Ezdoctemplatedocument_patchObject_v1_Request(const QString &json) {
...
void Ezdoctemplatedocument_patchObject_v1_Request::fromJson(const QString &jsonString) {
