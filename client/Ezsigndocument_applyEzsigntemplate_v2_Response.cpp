...
Ezsigndocument_applyEzsigntemplate_v2_Response::Ezsigndocument_applyEzsigntemplate_v2_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsigndocument_applyEzsigntemplate_v2_Response::Ezsigndocument_applyEzsigntemplate_v2_Response() {
    this->initializeModel();
}

Ezsigndocument_applyEzsigntemplate_v2_Response::~Ezsigndocument_applyEzsigntemplate_v2_Response() {}

void Ezsigndocument_applyEzsigntemplate_v2_Response::initializeModel() {
...
void Ezsigndocument_applyEzsigntemplate_v2_Response::fromJson(const QString &jsonString) {
...
void Ezsigndocument_applyEzsigntemplate_v2_Response::fromJsonObject(QJsonObject json) {
...
QJsonObject Ezsigndocument_applyEzsigntemplate_v2_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload Ezsigndocument_applyEzsigntemplate_v2_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Ezsigndocument_applyEzsigntemplate_v2_Response::setObjDebugPayload(const Common_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Ezsigndocument_applyEzsigntemplate_v2_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Ezsigndocument_applyEzsigntemplate_v2_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Ezsigndocument_applyEzsigntemplate_v2_Response::getObjDebug() const {
    return m_obj_debug;
}
void Ezsigndocument_applyEzsigntemplate_v2_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Ezsigndocument_applyEzsigntemplate_v2_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Ezsigndocument_applyEzsigntemplate_v2_Response::is_obj_debug_Valid() const{
...
bool Ezsigndocument_applyEzsigntemplate_v2_Response::isValid() const {
