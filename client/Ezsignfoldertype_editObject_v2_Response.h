...
/*
 * Ezsignfoldertype_editObject_v2_Response.h
 *
 * Response for PUT /2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef Ezsignfoldertype_editObject_v2_Response_H
#define Ezsignfoldertype_editObject_v2_Response_H
...
class Ezsignfoldertype_editObject_v2_Response : public Object {
public:
    Ezsignfoldertype_editObject_v2_Response();
    Ezsignfoldertype_editObject_v2_Response(QString json);
    ~Ezsignfoldertype_editObject_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_editObject_v2_Response)

#endif // Ezsignfoldertype_editObject_v2_Response_H
