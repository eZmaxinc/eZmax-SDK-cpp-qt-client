...
public:
    ...
    Ezsignfolder_ResponseCompound getMPayload() const;
    void setMPayload(const Ezsignfolder_ResponseCompound &m_payload);
...
private:
    ...
    Ezsignfolder_ResponseCompound m_m_payload;
