...
/*
 * Ezsignfolder_getObject_v1_Response.h
 *
 * Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}
 */

#ifndef Ezsignfolder_getObject_v1_Response_H
#define Ezsignfolder_getObject_v1_Response_H
...
class Ezsignfolder_getObject_v1_Response : public Object {
public:
    Ezsignfolder_getObject_v1_Response();
    Ezsignfolder_getObject_v1_Response(const QString &json);
    ~Ezsignfolder_getObject_v1_Response() override;
    ...
    Ezsignfolder_getObject_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Ezsignfolder_getObject_v1_Response_mPayload &m_payload);
...
private:
    ...
    Ezsignfolder_getObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_getObject_v1_Response)

#endif // Ezsignfolder_getObject_v1_Response_H
