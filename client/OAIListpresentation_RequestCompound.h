...
/*
 * OAIListpresentation_RequestCompound.h
 *
 * A Listpresentation Object and children to create a complete structure
 */

#ifndef OAIListpresentation_RequestCompound_H
#define OAIListpresentation_RequestCompound_H
...
class OAIListpresentation_RequestCompound : public OAIObject {
public:
    OAIListpresentation_RequestCompound();
    OAIListpresentation_RequestCompound(QString json);
    ~OAIListpresentation_RequestCompound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListpresentation_RequestCompound)

#endif // OAIListpresentation_RequestCompound_H
