...
#include "OAIObjectPhonetypeApi.h"
...
OAIObjectPhonetypeApi::~OAIObjectPhonetypeApi() {
}

void OAIObjectPhonetypeApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectPhonetypeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectPhonetypeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectPhonetypeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectPhonetypeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectPhonetypeApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectPhonetypeApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectPhonetypeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectPhonetypeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectPhonetypeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectPhonetypeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectPhonetypeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectPhonetypeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectPhonetypeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectPhonetypeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectPhonetypeApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectPhonetypeApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectPhonetypeApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectPhonetypeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectPhonetypeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectPhonetypeApi::phonetypeGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectPhonetypeApi::phonetypeGetAutocompleteV2Callback);
    connect(this, &OAIObjectPhonetypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIObjectPhonetypeApi::phonetypeGetAutocompleteV2Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIPhonetype_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectPhonetypeApi::tokenAvailable(){
