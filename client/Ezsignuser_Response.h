...
#ifndef Ezsignuser_Response_H
#define Ezsignuser_Response_H
...
class Ezsignuser_Response : public Object {
public:
    Ezsignuser_Response();
    Ezsignuser_Response(const QString &json);
    ~Ezsignuser_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignuser_Response)

#endif // Ezsignuser_Response_H
