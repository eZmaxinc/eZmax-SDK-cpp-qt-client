...
Ezsigntemplate_RequestCompoundV3::Ezsigntemplate_RequestCompoundV3(const QString &json) {
...
void Ezsigntemplate_RequestCompoundV3::fromJson(const QString &jsonString) {
