...
#ifndef Common_Reportcellstylecustom_H
#define Common_Reportcellstylecustom_H
...
class Common_Reportcellstylecustom : public Object {
public:
    Common_Reportcellstylecustom();
    Common_Reportcellstylecustom(const QString &json);
    ~Common_Reportcellstylecustom() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Common_Reportcellstylecustom)

#endif // Common_Reportcellstylecustom_H
