...
/*
 * Ezsignfolder_dispose_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/dispose
 */

#ifndef Ezsignfolder_dispose_v1_Response_H
#define Ezsignfolder_dispose_v1_Response_H
...
class Ezsignfolder_dispose_v1_Response : public Object {
public:
    Ezsignfolder_dispose_v1_Response();
    Ezsignfolder_dispose_v1_Response(const QString &json);
    ~Ezsignfolder_dispose_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_dispose_v1_Response)

#endif // Ezsignfolder_dispose_v1_Response_H
