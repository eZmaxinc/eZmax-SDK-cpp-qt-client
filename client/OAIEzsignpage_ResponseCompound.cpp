...
QString OAIEzsignpage_ResponseCompound::getSImageUrl() const {
    return s_image_url;
}
void OAIEzsignpage_ResponseCompound::setSImageUrl(const QString &s_image_url) {
    this->s_image_url = s_image_url;
    this->m_s_image_url_isSet = true;
}

bool OAIEzsignpage_ResponseCompound::is_s_image_url_Set() const{
    return m_s_image_url_isSet;
}

bool OAIEzsignpage_ResponseCompound::is_s_image_url_Valid() const{
