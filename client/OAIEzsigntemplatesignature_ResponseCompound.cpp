...
qint32 OAIEzsigntemplatesignature_ResponseCompound::getIEzsigntemplatesignatureWidth() const {
    return m_i_ezsigntemplatesignature_width;
}
void OAIEzsigntemplatesignature_ResponseCompound::setIEzsigntemplatesignatureWidth(const qint32 &i_ezsigntemplatesignature_width) {
    m_i_ezsigntemplatesignature_width = i_ezsigntemplatesignature_width;
    m_i_ezsigntemplatesignature_width_isSet = true;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_width_Set() const{
    return m_i_ezsigntemplatesignature_width_isSet;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_width_Valid() const{
    return m_i_ezsigntemplatesignature_width_isValid;
}

qint32 OAIEzsigntemplatesignature_ResponseCompound::getIEzsigntemplatesignatureHeight() const {
    return m_i_ezsigntemplatesignature_height;
}
void OAIEzsigntemplatesignature_ResponseCompound::setIEzsigntemplatesignatureHeight(const qint32 &i_ezsigntemplatesignature_height) {
    m_i_ezsigntemplatesignature_height = i_ezsigntemplatesignature_height;
    m_i_ezsigntemplatesignature_height_isSet = true;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_height_Set() const{
    return m_i_ezsigntemplatesignature_height_isSet;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_height_Valid() const{
...
qint32 OAIEzsigntemplatesignature_ResponseCompound::getIEzsigntemplatesignatureMaxlength() const {
    return m_i_ezsigntemplatesignature_maxlength;
}
void OAIEzsigntemplatesignature_ResponseCompound::setIEzsigntemplatesignatureMaxlength(const qint32 &i_ezsigntemplatesignature_maxlength) {
...
bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_maxlength_Set() const{
    return m_i_ezsigntemplatesignature_maxlength_isSet;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_maxlength_Valid() const{
    return m_i_ezsigntemplatesignature_maxlength_isValid;
}

QString OAIEzsigntemplatesignature_ResponseCompound::getSEzsigntemplatesignatureRegexp() const {
    return m_s_ezsigntemplatesignature_regexp;
}
void OAIEzsigntemplatesignature_ResponseCompound::setSEzsigntemplatesignatureRegexp(const QString &s_ezsigntemplatesignature_regexp) {
    m_s_ezsigntemplatesignature_regexp = s_ezsigntemplatesignature_regexp;
    m_s_ezsigntemplatesignature_regexp_isSet = true;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_regexp_Set() const{
    return m_s_ezsigntemplatesignature_regexp_isSet;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_regexp_Valid() const{
    return m_s_ezsigntemplatesignature_regexp_isValid;
}

OAIEnum_Textvalidation OAIEzsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignatureTextvalidation() const {
    return m_e_ezsigntemplatesignature_textvalidation;
}
void OAIEzsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignatureTextvalidation(const OAIEnum_Textvalidation &e_ezsigntemplatesignature_textvalidation) {
...
bool OAIEzsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_textvalidation_Set() const{
    return m_e_ezsigntemplatesignature_textvalidation_isSet;
}

bool OAIEzsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_textvalidation_Valid() const{
