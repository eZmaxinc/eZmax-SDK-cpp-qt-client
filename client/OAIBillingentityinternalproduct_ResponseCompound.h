...
/*
 * OAIBillingentityinternalproduct_ResponseCompound.h
 *
 * A Billingentityinternalproduct Object
 */

#ifndef OAIBillingentityinternalproduct_ResponseCompound_H
#define OAIBillingentityinternalproduct_ResponseCompound_H
...
class OAIBillingentityinternalproduct_ResponseCompound : public OAIObject {
public:
    OAIBillingentityinternalproduct_ResponseCompound();
    OAIBillingentityinternalproduct_ResponseCompound(QString json);
    ~OAIBillingentityinternalproduct_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBillingentityinternalproduct_ResponseCompound)

#endif // OAIBillingentityinternalproduct_ResponseCompound_H
