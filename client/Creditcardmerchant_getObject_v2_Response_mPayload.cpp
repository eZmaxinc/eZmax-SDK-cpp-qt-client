...
Creditcardmerchant_getObject_v2_Response_mPayload::Creditcardmerchant_getObject_v2_Response_mPayload(const QString &json) {
...
void Creditcardmerchant_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
