...
/*
 * OAIWebhook_editObject_v1_Response.h
 *
 * Response for PUT /1/object/webhook/{pkiWebhookID}
 */

#ifndef OAIWebhook_editObject_v1_Response_H
#define OAIWebhook_editObject_v1_Response_H
...
class OAIWebhook_editObject_v1_Response : public OAIObject {
public:
    OAIWebhook_editObject_v1_Response();
    OAIWebhook_editObject_v1_Response(QString json);
    ~OAIWebhook_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIWebhook_editObject_v1_Response)

#endif // OAIWebhook_editObject_v1_Response_H
