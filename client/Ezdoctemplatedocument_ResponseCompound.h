...
/*
 * Ezdoctemplatedocument_ResponseCompound.h
 *
 * A Ezdoctemplatedocument Object
 */

#ifndef Ezdoctemplatedocument_ResponseCompound_H
#define Ezdoctemplatedocument_ResponseCompound_H
...
class Ezdoctemplatedocument_ResponseCompound : public Object {
public:
    Ezdoctemplatedocument_ResponseCompound();
    Ezdoctemplatedocument_ResponseCompound(const QString &json);
    ~Ezdoctemplatedocument_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezdoctemplatedocument_ResponseCompound)

#endif // Ezdoctemplatedocument_ResponseCompound_H
