...
/*
 * OAIBranding_RequestCompound.h
 *
 * A Branding Object and children
 */

#ifndef OAIBranding_RequestCompound_H
#define OAIBranding_RequestCompound_H
...
class OAIBranding_RequestCompound : public OAIObject {
public:
    OAIBranding_RequestCompound();
    OAIBranding_RequestCompound(QString json);
    ~OAIBranding_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBranding_RequestCompound)

#endif // OAIBranding_RequestCompound_H
