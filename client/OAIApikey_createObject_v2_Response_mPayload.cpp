...
OAIApikey_createObject_v2_Response_mPayload::OAIApikey_createObject_v2_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApikey_createObject_v2_Response_mPayload::OAIApikey_createObject_v2_Response_mPayload() {
    this->initializeModel();
}

OAIApikey_createObject_v2_Response_mPayload::~OAIApikey_createObject_v2_Response_mPayload() {}

void OAIApikey_createObject_v2_Response_mPayload::initializeModel() {

    m_a_obj_apikey_isSet = false;
    m_a_obj_apikey_isValid = false;
}

void OAIApikey_createObject_v2_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIApikey_createObject_v2_Response_mPayload::asJson() const {
...
bool OAIApikey_createObject_v2_Response_mPayload::is_a_obj_apikey_Valid() const{
...
bool OAIApikey_createObject_v2_Response_mPayload::isValid() const {
