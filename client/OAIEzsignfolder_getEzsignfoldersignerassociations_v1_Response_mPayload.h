...
namespace Ezmaxapi {
class OAICustom_EzsignfoldersignerassociationActionableElement_Response;
...
public:
    ...
    QList<OAICustom_EzsignfoldersignerassociationActionableElement_Response> getAObjEzsignfoldersignerassociation() const;
    void setAObjEzsignfoldersignerassociation(const QList<OAICustom_EzsignfoldersignerassociationActionableElement_Response> &a_obj_ezsignfoldersignerassociation);
...
private:
    ...
    QList<OAICustom_EzsignfoldersignerassociationActionableElement_Response> m_a_obj_ezsignfoldersignerassociation;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_getEzsignfoldersignerassociations_v1_Response_mPayload)
