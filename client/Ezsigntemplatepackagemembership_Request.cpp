...
Ezsigntemplatepackagemembership_Request::Ezsigntemplatepackagemembership_Request(const QString &json) {
...
void Ezsigntemplatepackagemembership_Request::fromJson(const QString &jsonString) {
