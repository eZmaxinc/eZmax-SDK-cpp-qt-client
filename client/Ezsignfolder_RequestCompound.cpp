...
Ezsignfolder_RequestCompound::Ezsignfolder_RequestCompound(const QString &json) {
...
void Ezsignfolder_RequestCompound::fromJson(const QString &jsonString) {
...
qint32 Ezsignfolder_RequestCompound::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void Ezsignfolder_RequestCompound::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool Ezsignfolder_RequestCompound::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool Ezsignfolder_RequestCompound::is_fki_timezone_id_Valid() const{
