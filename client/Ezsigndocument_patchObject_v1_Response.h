...
/*
 * Ezsigndocument_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef Ezsigndocument_patchObject_v1_Response_H
#define Ezsigndocument_patchObject_v1_Response_H
...
class Ezsigndocument_patchObject_v1_Response : public Object {
public:
    Ezsigndocument_patchObject_v1_Response();
    Ezsigndocument_patchObject_v1_Response(const QString &json);
    ~Ezsigndocument_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_patchObject_v1_Response)

#endif // Ezsigndocument_patchObject_v1_Response_H
