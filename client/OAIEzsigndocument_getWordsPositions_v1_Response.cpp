...
OAIEzsigndocument_getWordsPositions_v1_Response::OAIEzsigndocument_getWordsPositions_v1_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEzsigndocument_getWordsPositions_v1_Response::OAIEzsigndocument_getWordsPositions_v1_Response() {
    this->initializeModel();
}

OAIEzsigndocument_getWordsPositions_v1_Response::~OAIEzsigndocument_getWordsPositions_v1_Response() {}

void OAIEzsigndocument_getWordsPositions_v1_Response::initializeModel() {
...
void OAIEzsigndocument_getWordsPositions_v1_Response::fromJson(QString jsonString) {
...
void OAIEzsigndocument_getWordsPositions_v1_Response::fromJsonObject(QJsonObject json) {
...
QString OAIEzsigndocument_getWordsPositions_v1_Response::asJson() const {
...
OAICommon_Response_objDebugPayload OAIEzsigndocument_getWordsPositions_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void OAIEzsigndocument_getWordsPositions_v1_Response::setObjDebugPayload(const OAICommon_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool OAIEzsigndocument_getWordsPositions_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool OAIEzsigndocument_getWordsPositions_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

OAICommon_Response_objDebug OAIEzsigndocument_getWordsPositions_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void OAIEzsigndocument_getWordsPositions_v1_Response::setObjDebug(const OAICommon_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool OAIEzsigndocument_getWordsPositions_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool OAIEzsigndocument_getWordsPositions_v1_Response::is_obj_debug_Valid() const{
...
bool OAIEzsigndocument_getWordsPositions_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool OAIEzsigndocument_getWordsPositions_v1_Response::is_m_payload_Valid() const{
...
bool OAIEzsigndocument_getWordsPositions_v1_Response::isValid() const {
