...
qint32 OAISubnet_RequestCompound::getISubnetNetwork() const {
    return i_subnet_network;
}
void OAISubnet_RequestCompound::setISubnetNetwork(const qint32 &i_subnet_network) {
...
qint32 OAISubnet_RequestCompound::getISubnetMask() const {
    return i_subnet_mask;
}
void OAISubnet_RequestCompound::setISubnetMask(const qint32 &i_subnet_mask) {
