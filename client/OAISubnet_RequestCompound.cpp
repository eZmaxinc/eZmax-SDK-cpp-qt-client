...
OAISubnet_RequestCompound::OAISubnet_RequestCompound(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubnet_RequestCompound::OAISubnet_RequestCompound() {
    this->initializeModel();
}

OAISubnet_RequestCompound::~OAISubnet_RequestCompound() {}

void OAISubnet_RequestCompound::initializeModel() {
...
void OAISubnet_RequestCompound::fromJson(QString jsonString) {
...
void OAISubnet_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString OAISubnet_RequestCompound::asJson() const {
...
QJsonObject OAISubnet_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISubnet_RequestCompound::getPkiSubnetId() const {
    return pki_subnet_id;
}
void OAISubnet_RequestCompound::setPkiSubnetId(const qint32 &pki_subnet_id) {
    this->pki_subnet_id = pki_subnet_id;
    this->m_pki_subnet_id_isSet = true;
}

bool OAISubnet_RequestCompound::is_pki_subnet_id_Set() const{
    return m_pki_subnet_id_isSet;
}

bool OAISubnet_RequestCompound::is_pki_subnet_id_Valid() const{
    return m_pki_subnet_id_isValid;
}

qint32 OAISubnet_RequestCompound::getFkiUserId() const {
    return fki_user_id;
}
void OAISubnet_RequestCompound::setFkiUserId(const qint32 &fki_user_id) {
    this->fki_user_id = fki_user_id;
    this->m_fki_user_id_isSet = true;
}

bool OAISubnet_RequestCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool OAISubnet_RequestCompound::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 OAISubnet_RequestCompound::getFkiApikeyId() const {
    return fki_apikey_id;
}
void OAISubnet_RequestCompound::setFkiApikeyId(const qint32 &fki_apikey_id) {
    this->fki_apikey_id = fki_apikey_id;
    this->m_fki_apikey_id_isSet = true;
}

bool OAISubnet_RequestCompound::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool OAISubnet_RequestCompound::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

OAIMultilingual_SubnetDescription OAISubnet_RequestCompound::getObjSubnetDescription() const {
    return obj_subnet_description;
}
void OAISubnet_RequestCompound::setObjSubnetDescription(const OAIMultilingual_SubnetDescription &obj_subnet_description) {
    this->obj_subnet_description = obj_subnet_description;
    this->m_obj_subnet_description_isSet = true;
}

bool OAISubnet_RequestCompound::is_obj_subnet_description_Set() const{
    return m_obj_subnet_description_isSet;
}

bool OAISubnet_RequestCompound::is_obj_subnet_description_Valid() const{
    return m_obj_subnet_description_isValid;
}

qint64 OAISubnet_RequestCompound::getISubnetNetwork() const {
    return i_subnet_network;
}
void OAISubnet_RequestCompound::setISubnetNetwork(const qint64 &i_subnet_network) {
    this->i_subnet_network = i_subnet_network;
    this->m_i_subnet_network_isSet = true;
}

bool OAISubnet_RequestCompound::is_i_subnet_network_Set() const{
    return m_i_subnet_network_isSet;
}

bool OAISubnet_RequestCompound::is_i_subnet_network_Valid() const{
    return m_i_subnet_network_isValid;
}

qint64 OAISubnet_RequestCompound::getISubnetMask() const {
    return i_subnet_mask;
}
void OAISubnet_RequestCompound::setISubnetMask(const qint64 &i_subnet_mask) {
    this->i_subnet_mask = i_subnet_mask;
    this->m_i_subnet_mask_isSet = true;
}

bool OAISubnet_RequestCompound::is_i_subnet_mask_Set() const{
    return m_i_subnet_mask_isSet;
}

bool OAISubnet_RequestCompound::is_i_subnet_mask_Valid() const{
    return m_i_subnet_mask_isValid;
}

bool OAISubnet_RequestCompound::isSet() const {
...
bool OAISubnet_RequestCompound::isValid() const {
