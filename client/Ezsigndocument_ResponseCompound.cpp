...
Ezsigndocument_ResponseCompound::Ezsigndocument_ResponseCompound(const QString &json) {
...
void Ezsigndocument_ResponseCompound::fromJson(const QString &jsonString) {
...
bool Ezsigndocument_ResponseCompound::isBEzsigndocumentSendtoged() const {
    return m_b_ezsigndocument_sendtoged;
}
void Ezsigndocument_ResponseCompound::setBEzsigndocumentSendtoged(const bool &b_ezsigndocument_sendtoged) {
    m_b_ezsigndocument_sendtoged = b_ezsigndocument_sendtoged;
    m_b_ezsigndocument_sendtoged_isSet = true;
}

bool Ezsigndocument_ResponseCompound::is_b_ezsigndocument_sendtoged_Set() const{
    return m_b_ezsigndocument_sendtoged_isSet;
}

bool Ezsigndocument_ResponseCompound::is_b_ezsigndocument_sendtoged_Valid() const{
