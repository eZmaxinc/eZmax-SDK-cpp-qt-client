...
/*
 * OAICors_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/cors/{pkiCorsID}
 */

#ifndef OAICors_deleteObject_v1_Response_H
#define OAICors_deleteObject_v1_Response_H
...
class OAICors_deleteObject_v1_Response : public OAIObject {
public:
    OAICors_deleteObject_v1_Response();
    OAICors_deleteObject_v1_Response(QString json);
    ~OAICors_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICors_deleteObject_v1_Response)

#endif // OAICors_deleteObject_v1_Response_H
