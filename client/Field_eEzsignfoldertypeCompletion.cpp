...
Field_eEzsignfoldertypeCompletion::Field_eEzsignfoldertypeCompletion(const QString &json) {
...
void Field_eEzsignfoldertypeCompletion::fromJson(const QString &jsonString) {
    ...
    if ( jsonString.compare("PerEzsigndocument", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eField_eEzsignfoldertypeCompletion::PEREZSIGNFOLDERSTEPSYNC;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString Field_eEzsignfoldertypeCompletion::asJson() const {
    ...
    switch (m_value){
        ...
        case eField_eEzsignfoldertypeCompletion::PEREZSIGNFOLDER:
            val = "PerEzsignfolder";
            break;
        case eField_eEzsignfoldertypeCompletion::PEREZSIGNFOLDERSTEPSYNC:
