...
/*
 * Ezsignbulksenddocumentmapping_RequestCompound.h
 *
 * A Ezsignbulksenddocumentmapping Object and children
 */

#ifndef Ezsignbulksenddocumentmapping_RequestCompound_H
#define Ezsignbulksenddocumentmapping_RequestCompound_H
...
class Ezsignbulksenddocumentmapping_RequestCompound : public Object {
public:
    Ezsignbulksenddocumentmapping_RequestCompound();
    Ezsignbulksenddocumentmapping_RequestCompound(const QString &json);
    ~Ezsignbulksenddocumentmapping_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksenddocumentmapping_RequestCompound)

#endif // Ezsignbulksenddocumentmapping_RequestCompound_H
