...
Ezsignfoldersignerassociation_RequestCompound::Ezsignfoldersignerassociation_RequestCompound(const QString &json) {
...
void Ezsignfoldersignerassociation_RequestCompound::fromJson(const QString &jsonString) {
