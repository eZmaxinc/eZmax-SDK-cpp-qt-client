...
#ifndef Ezsigntemplatedocument_flatten_v1_Response_H
#define Ezsigntemplatedocument_flatten_v1_Response_H
...
class Ezsigntemplatedocument_flatten_v1_Response : public Object {
public:
    Ezsigntemplatedocument_flatten_v1_Response();
    Ezsigntemplatedocument_flatten_v1_Response(const QString &json);
    ~Ezsigntemplatedocument_flatten_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatedocument_flatten_v1_Response)

#endif // Ezsigntemplatedocument_flatten_v1_Response_H
