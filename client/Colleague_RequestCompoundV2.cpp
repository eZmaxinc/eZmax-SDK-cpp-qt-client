...
Colleague_RequestCompoundV2::Colleague_RequestCompoundV2() {
    this->initializeModel();
}

Colleague_RequestCompoundV2::~Colleague_RequestCompoundV2() {}

void Colleague_RequestCompoundV2::initializeModel() {
...
void Colleague_RequestCompoundV2::fromJsonObject(QJsonObject json) {
...
QString Colleague_RequestCompoundV2::asJson() const {
...
QJsonObject Colleague_RequestCompoundV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 Colleague_RequestCompoundV2::getPkiColleagueId() const {
    return m_pki_colleague_id;
}
void Colleague_RequestCompoundV2::setPkiColleagueId(const qint32 &pki_colleague_id) {
    m_pki_colleague_id = pki_colleague_id;
    m_pki_colleague_id_isSet = true;
}

bool Colleague_RequestCompoundV2::is_pki_colleague_id_Set() const{
    return m_pki_colleague_id_isSet;
}

bool Colleague_RequestCompoundV2::is_pki_colleague_id_Valid() const{
    return m_pki_colleague_id_isValid;
}

qint32 Colleague_RequestCompoundV2::getFkiUserId() const {
    return m_fki_user_id;
}
void Colleague_RequestCompoundV2::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Colleague_RequestCompoundV2::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Colleague_RequestCompoundV2::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Colleague_RequestCompoundV2::getFkiUserIdColleague() const {
    return m_fki_user_id_colleague;
}
void Colleague_RequestCompoundV2::setFkiUserIdColleague(const qint32 &fki_user_id_colleague) {
    m_fki_user_id_colleague = fki_user_id_colleague;
    m_fki_user_id_colleague_isSet = true;
}

bool Colleague_RequestCompoundV2::is_fki_user_id_colleague_Set() const{
    return m_fki_user_id_colleague_isSet;
}

bool Colleague_RequestCompoundV2::is_fki_user_id_colleague_Valid() const{
    return m_fki_user_id_colleague_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueEzsignemail() const {
    return m_b_colleague_ezsignemail;
}
void Colleague_RequestCompoundV2::setBColleagueEzsignemail(const bool &b_colleague_ezsignemail) {
    m_b_colleague_ezsignemail = b_colleague_ezsignemail;
    m_b_colleague_ezsignemail_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_ezsignemail_Set() const{
    return m_b_colleague_ezsignemail_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_ezsignemail_Valid() const{
    return m_b_colleague_ezsignemail_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueFinancial() const {
    return m_b_colleague_financial;
}
void Colleague_RequestCompoundV2::setBColleagueFinancial(const bool &b_colleague_financial) {
    m_b_colleague_financial = b_colleague_financial;
    m_b_colleague_financial_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_financial_Set() const{
    return m_b_colleague_financial_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_financial_Valid() const{
    return m_b_colleague_financial_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueUsecloneemail() const {
    return m_b_colleague_usecloneemail;
}
void Colleague_RequestCompoundV2::setBColleagueUsecloneemail(const bool &b_colleague_usecloneemail) {
    m_b_colleague_usecloneemail = b_colleague_usecloneemail;
    m_b_colleague_usecloneemail_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_usecloneemail_Set() const{
    return m_b_colleague_usecloneemail_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_usecloneemail_Valid() const{
    return m_b_colleague_usecloneemail_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueAttachment() const {
    return m_b_colleague_attachment;
}
void Colleague_RequestCompoundV2::setBColleagueAttachment(const bool &b_colleague_attachment) {
    m_b_colleague_attachment = b_colleague_attachment;
    m_b_colleague_attachment_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_attachment_Set() const{
    return m_b_colleague_attachment_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_attachment_Valid() const{
    return m_b_colleague_attachment_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueCanafe() const {
    return m_b_colleague_canafe;
}
void Colleague_RequestCompoundV2::setBColleagueCanafe(const bool &b_colleague_canafe) {
    m_b_colleague_canafe = b_colleague_canafe;
    m_b_colleague_canafe_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_canafe_Set() const{
    return m_b_colleague_canafe_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_canafe_Valid() const{
    return m_b_colleague_canafe_isValid;
}

bool Colleague_RequestCompoundV2::isBColleaguePermission() const {
    return m_b_colleague_permission;
}
void Colleague_RequestCompoundV2::setBColleaguePermission(const bool &b_colleague_permission) {
    m_b_colleague_permission = b_colleague_permission;
    m_b_colleague_permission_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_permission_Set() const{
    return m_b_colleague_permission_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_permission_Valid() const{
    return m_b_colleague_permission_isValid;
}

bool Colleague_RequestCompoundV2::isBColleagueRealestatecompleted() const {
    return m_b_colleague_realestatecompleted;
}
void Colleague_RequestCompoundV2::setBColleagueRealestatecompleted(const bool &b_colleague_realestatecompleted) {
    m_b_colleague_realestatecompleted = b_colleague_realestatecompleted;
    m_b_colleague_realestatecompleted_isSet = true;
}

bool Colleague_RequestCompoundV2::is_b_colleague_realestatecompleted_Set() const{
    return m_b_colleague_realestatecompleted_isSet;
}

bool Colleague_RequestCompoundV2::is_b_colleague_realestatecompleted_Valid() const{
    return m_b_colleague_realestatecompleted_isValid;
}

QString Colleague_RequestCompoundV2::getDtColleagueFrom() const {
    return m_dt_colleague_from;
}
void Colleague_RequestCompoundV2::setDtColleagueFrom(const QString &dt_colleague_from) {
    m_dt_colleague_from = dt_colleague_from;
    m_dt_colleague_from_isSet = true;
}

bool Colleague_RequestCompoundV2::is_dt_colleague_from_Set() const{
    return m_dt_colleague_from_isSet;
}

bool Colleague_RequestCompoundV2::is_dt_colleague_from_Valid() const{
    return m_dt_colleague_from_isValid;
}

QString Colleague_RequestCompoundV2::getDtColleagueTo() const {
    return m_dt_colleague_to;
}
void Colleague_RequestCompoundV2::setDtColleagueTo(const QString &dt_colleague_to) {
    m_dt_colleague_to = dt_colleague_to;
    m_dt_colleague_to_isSet = true;
}

bool Colleague_RequestCompoundV2::is_dt_colleague_to_Set() const{
    return m_dt_colleague_to_isSet;
}

bool Colleague_RequestCompoundV2::is_dt_colleague_to_Valid() const{
    return m_dt_colleague_to_isValid;
}

Field_eColleagueEzsign Colleague_RequestCompoundV2::getEColleagueEzsign() const {
    return m_e_colleague_ezsign;
}
void Colleague_RequestCompoundV2::setEColleagueEzsign(const Field_eColleagueEzsign &e_colleague_ezsign) {
    m_e_colleague_ezsign = e_colleague_ezsign;
    m_e_colleague_ezsign_isSet = true;
}

bool Colleague_RequestCompoundV2::is_e_colleague_ezsign_Set() const{
    return m_e_colleague_ezsign_isSet;
}

bool Colleague_RequestCompoundV2::is_e_colleague_ezsign_Valid() const{
    return m_e_colleague_ezsign_isValid;
}

Field_eColleagueRealestateinprogess Colleague_RequestCompoundV2::getEColleagueRealestateinprogress() const {
    return m_e_colleague_realestateinprogress;
}
void Colleague_RequestCompoundV2::setEColleagueRealestateinprogress(const Field_eColleagueRealestateinprogess &e_colleague_realestateinprogress) {
    m_e_colleague_realestateinprogress = e_colleague_realestateinprogress;
    m_e_colleague_realestateinprogress_isSet = true;
}

bool Colleague_RequestCompoundV2::is_e_colleague_realestateinprogress_Set() const{
    return m_e_colleague_realestateinprogress_isSet;
}

bool Colleague_RequestCompoundV2::is_e_colleague_realestateinprogress_Valid() const{
    return m_e_colleague_realestateinprogress_isValid;
}

bool Colleague_RequestCompoundV2::isSet() const {
...
bool Colleague_RequestCompoundV2::isValid() const {
