...
/*
 * OAIWebhook_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/webhook/{pkiWebhookID}
 */

#ifndef OAIWebhook_getObject_v1_Response_mPayload_H
#define OAIWebhook_getObject_v1_Response_mPayload_H
...
class OAIWebhook_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIWebhook_getObject_v1_Response_mPayload();
    OAIWebhook_getObject_v1_Response_mPayload(QString json);
    ~OAIWebhook_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_getObject_v1_Response_mPayload)

#endif // OAIWebhook_getObject_v1_Response_mPayload_H
