...
/*
 * Variableexpense_editObject_v1_Response.h
 *
 * Response for PUT /1/object/variableexpense/{pkiVariableexpenseID}
 */

#ifndef Variableexpense_editObject_v1_Response_H
#define Variableexpense_editObject_v1_Response_H
...
class Variableexpense_editObject_v1_Response : public Object {
public:
    Variableexpense_editObject_v1_Response();
    Variableexpense_editObject_v1_Response(const QString &json);
    ~Variableexpense_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Variableexpense_editObject_v1_Response)

#endif // Variableexpense_editObject_v1_Response_H
