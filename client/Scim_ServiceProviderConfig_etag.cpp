...
Scim_ServiceProviderConfig_etag::Scim_ServiceProviderConfig_etag(const QString &json) {
...
void Scim_ServiceProviderConfig_etag::fromJson(const QString &jsonString) {
