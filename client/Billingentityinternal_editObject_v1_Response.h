...
/*
 * Billingentityinternal_editObject_v1_Response.h
 *
 * Response for PUT /1/object/billingentityinternal/{pkiBillingentityinternalID}
 */

#ifndef Billingentityinternal_editObject_v1_Response_H
#define Billingentityinternal_editObject_v1_Response_H
...
class Billingentityinternal_editObject_v1_Response : public Object {
public:
    Billingentityinternal_editObject_v1_Response();
    Billingentityinternal_editObject_v1_Response(const QString &json);
    ~Billingentityinternal_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Billingentityinternal_editObject_v1_Response)

#endif // Billingentityinternal_editObject_v1_Response_H
