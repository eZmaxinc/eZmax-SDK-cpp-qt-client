...
/*
 * OAIEzsigntemplatepackage_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}
 */

#ifndef OAIEzsigntemplatepackage_editObject_v1_Response_H
#define OAIEzsigntemplatepackage_editObject_v1_Response_H
...
class OAIEzsigntemplatepackage_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatepackage_editObject_v1_Response();
    OAIEzsigntemplatepackage_editObject_v1_Response(QString json);
    ~OAIEzsigntemplatepackage_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackage_editObject_v1_Response)

#endif // OAIEzsigntemplatepackage_editObject_v1_Response_H
