...
/*
 * OAIEzsigndocument_Response_allOf.h
 *
 * 
 */

#ifndef OAIEzsigndocument_Response_allOf_H
#define OAIEzsigndocument_Response_allOf_H
...
class OAIEzsigndocument_Response_allOf : public OAIObject {
public:
    OAIEzsigndocument_Response_allOf();
    OAIEzsigndocument_Response_allOf(QString json);
    ~OAIEzsigndocument_Response_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigndocument_Response_allOf)

#endif // OAIEzsigndocument_Response_allOf_H
