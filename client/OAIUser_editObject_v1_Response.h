...
/*
 * OAIUser_editObject_v1_Response.h
 *
 * Response for PUT /1/object/user/{pkiUserID}
 */

#ifndef OAIUser_editObject_v1_Response_H
#define OAIUser_editObject_v1_Response_H
...
class OAIUser_editObject_v1_Response : public OAIObject {
public:
    OAIUser_editObject_v1_Response();
    OAIUser_editObject_v1_Response(QString json);
    ~OAIUser_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUser_editObject_v1_Response)

#endif // OAIUser_editObject_v1_Response_H
