...
void OAIUser_createObject_v1_Response_mPayload::fromJsonObject(QJsonObject json) {
    ...
    m_a_pki_user_id_isValid = ::OpenAPI::fromJsonValue(m_a_pki_user_id, json[QString("a_pkiUserID")]);
...
QJsonObject OAIUser_createObject_v1_Response_mPayload::asJsonObject() const {
    ...
    if (m_a_pki_user_id.size() > 0) {
        obj.insert(QString("a_pkiUserID"), ::OpenAPI::toJsonValue(m_a_pki_user_id));
    }
    return obj;
}
