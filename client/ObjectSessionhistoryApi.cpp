...
ObjectSessionhistoryApi::ObjectSessionhistoryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectSessionhistoryApi::~ObjectSessionhistoryApi() {
}

void ObjectSessionhistoryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("sessionhistoryGetListV1", defaultConf);
    _serverIndices.insert("sessionhistoryGetListV1", 0);
}
...
*/
int ObjectSessionhistoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void ObjectSessionhistoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectSessionhistoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectSessionhistoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectSessionhistoryApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectSessionhistoryApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectSessionhistoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectSessionhistoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectSessionhistoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int ObjectSessionhistoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void ObjectSessionhistoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void ObjectSessionhistoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectSessionhistoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectSessionhistoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectSessionhistoryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void ObjectSessionhistoryApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString ObjectSessionhistoryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString ObjectSessionhistoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectSessionhistoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectSessionhistoryApi::sessionhistoryGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectSessionhistoryApi::sessionhistoryGetListV1Callback);
    connect(this, &ObjectSessionhistoryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void ObjectSessionhistoryApi::sessionhistoryGetListV1Callback(HttpRequestWorker *worker) {
    ...
    Sessionhistory_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sessionhistoryGetListV1Signal(output);
        Q_EMIT sessionhistoryGetListV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sessionhistoryGetListV1SignalE(output, error_type, error_str);
        Q_EMIT sessionhistoryGetListV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sessionhistoryGetListV1SignalError(output, error_type, error_str);
        Q_EMIT sessionhistoryGetListV1SignalErrorFull(worker, error_type, error_str);
    }
}

void ObjectSessionhistoryApi::tokenAvailable(){
