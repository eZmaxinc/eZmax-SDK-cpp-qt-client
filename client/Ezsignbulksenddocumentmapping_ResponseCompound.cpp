...
Ezsignbulksenddocumentmapping_ResponseCompound::Ezsignbulksenddocumentmapping_ResponseCompound(const QString &json) {
...
void Ezsignbulksenddocumentmapping_ResponseCompound::fromJson(const QString &jsonString) {
