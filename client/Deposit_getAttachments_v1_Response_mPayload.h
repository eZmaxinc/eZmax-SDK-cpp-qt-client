...
/*
 * Deposit_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/deposit/{pkiDepositID}/getAttachments
 */

#ifndef Deposit_getAttachments_v1_Response_mPayload_H
#define Deposit_getAttachments_v1_Response_mPayload_H
...
class Deposit_getAttachments_v1_Response_mPayload : public Object {
public:
    Deposit_getAttachments_v1_Response_mPayload();
    Deposit_getAttachments_v1_Response_mPayload(const QString &json);
    ~Deposit_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Deposit_getAttachments_v1_Response_mPayload)

#endif // Deposit_getAttachments_v1_Response_mPayload_H
