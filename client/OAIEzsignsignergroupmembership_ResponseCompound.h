...
/*
 * OAIEzsignsignergroupmembership_ResponseCompound.h
 *
 * A Ezsignsignergroupmembership Object
 */

#ifndef OAIEzsignsignergroupmembership_ResponseCompound_H
#define OAIEzsignsignergroupmembership_ResponseCompound_H
...
class OAIEzsignsignergroupmembership_ResponseCompound : public OAIObject {
public:
    OAIEzsignsignergroupmembership_ResponseCompound();
    OAIEzsignsignergroupmembership_ResponseCompound(QString json);
    ~OAIEzsignsignergroupmembership_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignergroupmembership_ResponseCompound)

#endif // OAIEzsignsignergroupmembership_ResponseCompound_H
