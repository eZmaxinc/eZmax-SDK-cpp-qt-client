...
void Subnet_Request::initializeModel() {
...
void Subnet_Request::fromJsonObject(QJsonObject json) {
...
QString Subnet_Request::asJson() const {
...
QJsonObject Subnet_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Subnet_Request::getPkiSubnetId() const {
    return m_pki_subnet_id;
}
void Subnet_Request::setPkiSubnetId(const qint32 &pki_subnet_id) {
    m_pki_subnet_id = pki_subnet_id;
    m_pki_subnet_id_isSet = true;
}

bool Subnet_Request::is_pki_subnet_id_Set() const{
    return m_pki_subnet_id_isSet;
}

bool Subnet_Request::is_pki_subnet_id_Valid() const{
    return m_pki_subnet_id_isValid;
}

qint32 Subnet_Request::getFkiUserId() const {
    return m_fki_user_id;
}
void Subnet_Request::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Subnet_Request::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Subnet_Request::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Subnet_Request::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void Subnet_Request::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool Subnet_Request::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool Subnet_Request::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

Multilingual_SubnetDescription Subnet_Request::getObjSubnetDescription() const {
    return m_obj_subnet_description;
}
void Subnet_Request::setObjSubnetDescription(const Multilingual_SubnetDescription &obj_subnet_description) {
    m_obj_subnet_description = obj_subnet_description;
    m_obj_subnet_description_isSet = true;
}

bool Subnet_Request::is_obj_subnet_description_Set() const{
    return m_obj_subnet_description_isSet;
}

bool Subnet_Request::is_obj_subnet_description_Valid() const{
    return m_obj_subnet_description_isValid;
}

qint64 Subnet_Request::getISubnetNetwork() const {
    return m_i_subnet_network;
}
void Subnet_Request::setISubnetNetwork(const qint64 &i_subnet_network) {
    m_i_subnet_network = i_subnet_network;
    m_i_subnet_network_isSet = true;
}

bool Subnet_Request::is_i_subnet_network_Set() const{
    return m_i_subnet_network_isSet;
}

bool Subnet_Request::is_i_subnet_network_Valid() const{
    return m_i_subnet_network_isValid;
}

qint64 Subnet_Request::getISubnetMask() const {
    return m_i_subnet_mask;
}
void Subnet_Request::setISubnetMask(const qint64 &i_subnet_mask) {
    m_i_subnet_mask = i_subnet_mask;
    m_i_subnet_mask_isSet = true;
}

bool Subnet_Request::is_i_subnet_mask_Set() const{
    return m_i_subnet_mask_isSet;
}

bool Subnet_Request::is_i_subnet_mask_Valid() const{
    return m_i_subnet_mask_isValid;
}

bool Subnet_Request::isSet() const {
...
bool Subnet_Request::isValid() const {
