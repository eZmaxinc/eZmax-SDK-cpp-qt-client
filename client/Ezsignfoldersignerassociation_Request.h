...
#ifndef Ezsignfoldersignerassociation_Request_H
#define Ezsignfoldersignerassociation_Request_H
...
class Ezsignfoldersignerassociation_Request : public Object {
public:
    Ezsignfoldersignerassociation_Request();
    Ezsignfoldersignerassociation_Request(const QString &json);
    ~Ezsignfoldersignerassociation_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldersignerassociation_Request)

#endif // Ezsignfoldersignerassociation_Request_H
