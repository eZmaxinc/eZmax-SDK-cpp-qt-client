...
/*
 * Common_getReport_v1_Response.h
 *
 * Response for POST /1/report/xxx/xxx and /1/module/report/getReportFromCache
 */

#ifndef Common_getReport_v1_Response_H
#define Common_getReport_v1_Response_H
...
class Common_getReport_v1_Response_mPayload;

class Common_getReport_v1_Response : public Object {
public:
    Common_getReport_v1_Response();
    Common_getReport_v1_Response(const QString &json);
    ~Common_getReport_v1_Response() override;
    ...
    Common_getReport_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Common_getReport_v1_Response_mPayload &m_payload);
...
private:
    ...
    Common_getReport_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Common_getReport_v1_Response)

#endif // Common_getReport_v1_Response_H
