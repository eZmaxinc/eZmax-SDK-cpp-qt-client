...
#include "Websocket_Response_Error_V1.h"
...
Websocket_Response_Error_V1::Websocket_Response_Error_V1(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Websocket_Response_Error_V1::Websocket_Response_Error_V1() {
    this->initializeModel();
}

Websocket_Response_Error_V1::~Websocket_Response_Error_V1() {}

void Websocket_Response_Error_V1::initializeModel() {
...
void Websocket_Response_Error_V1::fromJson(const QString &jsonString) {
...
void Websocket_Response_Error_V1::fromJsonObject(QJsonObject json) {
...
QString Websocket_Response_Error_V1::asJson() const {
...
QJsonObject Websocket_Response_Error_V1::asJsonObject() const {
    QJsonObject obj;
...
QString Websocket_Response_Error_V1::getEWebsocketMessagetype() const {
    return m_e_websocket_messagetype;
}
void Websocket_Response_Error_V1::setEWebsocketMessagetype(const QString &e_websocket_messagetype) {
    m_e_websocket_messagetype = e_websocket_messagetype;
    m_e_websocket_messagetype_isSet = true;
}

bool Websocket_Response_Error_V1::is_e_websocket_messagetype_Set() const{
    return m_e_websocket_messagetype_isSet;
}

bool Websocket_Response_Error_V1::is_e_websocket_messagetype_Valid() const{
    return m_e_websocket_messagetype_isValid;
}

QString Websocket_Response_Error_V1::getSWebsocketChannel() const {
    return m_s_websocket_channel;
}
void Websocket_Response_Error_V1::setSWebsocketChannel(const QString &s_websocket_channel) {
    m_s_websocket_channel = s_websocket_channel;
    m_s_websocket_channel_isSet = true;
}

bool Websocket_Response_Error_V1::is_s_websocket_channel_Set() const{
    return m_s_websocket_channel_isSet;
}

bool Websocket_Response_Error_V1::is_s_websocket_channel_Valid() const{
    return m_s_websocket_channel_isValid;
}

Websocket_Response_Error_V1_mPayload Websocket_Response_Error_V1::getMPayload() const {
    return m_m_payload;
}
void Websocket_Response_Error_V1::setMPayload(const Websocket_Response_Error_V1_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Websocket_Response_Error_V1::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Websocket_Response_Error_V1::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Websocket_Response_Error_V1::isSet() const {
...
bool Websocket_Response_Error_V1::isValid() const {
