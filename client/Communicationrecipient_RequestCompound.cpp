...
qint32 Communicationrecipient_RequestCompound::getFkiAgentincorporationId() const {
    return m_fki_agentincorporation_id;
}
void Communicationrecipient_RequestCompound::setFkiAgentincorporationId(const qint32 &fki_agentincorporation_id) {
    m_fki_agentincorporation_id = fki_agentincorporation_id;
    m_fki_agentincorporation_id_isSet = true;
}

bool Communicationrecipient_RequestCompound::is_fki_agentincorporation_id_Set() const{
    return m_fki_agentincorporation_id_isSet;
}

bool Communicationrecipient_RequestCompound::is_fki_agentincorporation_id_Valid() const{
