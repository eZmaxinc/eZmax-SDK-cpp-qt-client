...
Communicationrecipient_RequestCompound::Communicationrecipient_RequestCompound(const QString &json) {
...
void Communicationrecipient_RequestCompound::fromJson(const QString &jsonString) {
