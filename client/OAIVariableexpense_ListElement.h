...
/*
 * OAIVariableexpense_ListElement.h
 *
 * A Variableexpense List Element
 */

#ifndef OAIVariableexpense_ListElement_H
#define OAIVariableexpense_ListElement_H
...
class OAIVariableexpense_ListElement : public OAIObject {
public:
    OAIVariableexpense_ListElement();
    OAIVariableexpense_ListElement(QString json);
    ~OAIVariableexpense_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIVariableexpense_ListElement)

#endif // OAIVariableexpense_ListElement_H
