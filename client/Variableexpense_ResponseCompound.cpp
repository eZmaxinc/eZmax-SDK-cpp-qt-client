...
Variableexpense_ResponseCompound::Variableexpense_ResponseCompound() {
    this->initializeModel();
}

Variableexpense_ResponseCompound::~Variableexpense_ResponseCompound() {}

void Variableexpense_ResponseCompound::initializeModel() {
...
void Variableexpense_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Variableexpense_ResponseCompound::asJson() const {
...
QJsonObject Variableexpense_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Variableexpense_ResponseCompound::getPkiVariableexpenseId() const {
    return m_pki_variableexpense_id;
}
void Variableexpense_ResponseCompound::setPkiVariableexpenseId(const qint32 &pki_variableexpense_id) {
    m_pki_variableexpense_id = pki_variableexpense_id;
    m_pki_variableexpense_id_isSet = true;
}

bool Variableexpense_ResponseCompound::is_pki_variableexpense_id_Set() const{
    return m_pki_variableexpense_id_isSet;
}

bool Variableexpense_ResponseCompound::is_pki_variableexpense_id_Valid() const{
    return m_pki_variableexpense_id_isValid;
}

QString Variableexpense_ResponseCompound::getSVariableexpenseCode() const {
    return m_s_variableexpense_code;
}
void Variableexpense_ResponseCompound::setSVariableexpenseCode(const QString &s_variableexpense_code) {
    m_s_variableexpense_code = s_variableexpense_code;
    m_s_variableexpense_code_isSet = true;
}

bool Variableexpense_ResponseCompound::is_s_variableexpense_code_Set() const{
    return m_s_variableexpense_code_isSet;
}

bool Variableexpense_ResponseCompound::is_s_variableexpense_code_Valid() const{
    return m_s_variableexpense_code_isValid;
}

Multilingual_VariableexpenseDescription Variableexpense_ResponseCompound::getObjVariableexpenseDescription() const {
    return m_obj_variableexpense_description;
}
void Variableexpense_ResponseCompound::setObjVariableexpenseDescription(const Multilingual_VariableexpenseDescription &obj_variableexpense_description) {
    m_obj_variableexpense_description = obj_variableexpense_description;
    m_obj_variableexpense_description_isSet = true;
}

bool Variableexpense_ResponseCompound::is_obj_variableexpense_description_Set() const{
    return m_obj_variableexpense_description_isSet;
}

bool Variableexpense_ResponseCompound::is_obj_variableexpense_description_Valid() const{
    return m_obj_variableexpense_description_isValid;
}

Field_eVariableexpenseTaxable Variableexpense_ResponseCompound::getEVariableexpenseTaxable() const {
    return m_e_variableexpense_taxable;
}
void Variableexpense_ResponseCompound::setEVariableexpenseTaxable(const Field_eVariableexpenseTaxable &e_variableexpense_taxable) {
    m_e_variableexpense_taxable = e_variableexpense_taxable;
    m_e_variableexpense_taxable_isSet = true;
}

bool Variableexpense_ResponseCompound::is_e_variableexpense_taxable_Set() const{
    return m_e_variableexpense_taxable_isSet;
}

bool Variableexpense_ResponseCompound::is_e_variableexpense_taxable_Valid() const{
    return m_e_variableexpense_taxable_isValid;
}

bool Variableexpense_ResponseCompound::isBVariableexpenseIsactive() const {
    return m_b_variableexpense_isactive;
}
void Variableexpense_ResponseCompound::setBVariableexpenseIsactive(const bool &b_variableexpense_isactive) {
    m_b_variableexpense_isactive = b_variableexpense_isactive;
    m_b_variableexpense_isactive_isSet = true;
}

bool Variableexpense_ResponseCompound::is_b_variableexpense_isactive_Set() const{
    return m_b_variableexpense_isactive_isSet;
}

bool Variableexpense_ResponseCompound::is_b_variableexpense_isactive_Valid() const{
    return m_b_variableexpense_isactive_isValid;
}

bool Variableexpense_ResponseCompound::isSet() const {
...
bool Variableexpense_ResponseCompound::isValid() const {
