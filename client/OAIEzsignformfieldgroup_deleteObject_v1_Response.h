...
/*
 * OAIEzsignformfieldgroup_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}
 */

#ifndef OAIEzsignformfieldgroup_deleteObject_v1_Response_H
#define OAIEzsignformfieldgroup_deleteObject_v1_Response_H
...
class OAIEzsignformfieldgroup_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsignformfieldgroup_deleteObject_v1_Response();
    OAIEzsignformfieldgroup_deleteObject_v1_Response(QString json);
    ~OAIEzsignformfieldgroup_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignformfieldgroup_deleteObject_v1_Response)

#endif // OAIEzsignformfieldgroup_deleteObject_v1_Response_H
