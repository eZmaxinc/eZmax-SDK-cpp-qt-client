...
/*
 * Ezsigntemplateformfieldgroup_createObject_v1_Response.h
 *
 * Response for POST /1/object/ezsigntemplateformfieldgroup
 */

#ifndef Ezsigntemplateformfieldgroup_createObject_v1_Response_H
#define Ezsigntemplateformfieldgroup_createObject_v1_Response_H
...
class Ezsigntemplateformfieldgroup_createObject_v1_Response_mPayload;
...
public:
    ...
    Ezsigntemplateformfieldgroup_createObject_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Ezsigntemplateformfieldgroup_createObject_v1_Response_mPayload &m_payload);
...
private:
    ...
    Ezsigntemplateformfieldgroup_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateformfieldgroup_createObject_v1_Response)

#endif // Ezsigntemplateformfieldgroup_createObject_v1_Response_H
