...
OAIList_saveListpresentation_v1_Response::OAIList_saveListpresentation_v1_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIList_saveListpresentation_v1_Response::OAIList_saveListpresentation_v1_Response() {
    this->initializeModel();
}
...
void OAIList_saveListpresentation_v1_Response::fromJson(QString jsonString) {
...
QString OAIList_saveListpresentation_v1_Response::asJson() const {
...
void OAIList_saveListpresentation_v1_Response::setObjDebugPayload(const OAICommon_Response_objDebugPayload &obj_debug_payload) {
    this->obj_debug_payload = obj_debug_payload;
    this->m_obj_debug_payload_isSet = true;
}

bool OAIList_saveListpresentation_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool OAIList_saveListpresentation_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

OAICommon_Response_objDebug OAIList_saveListpresentation_v1_Response::getObjDebug() const {
    return obj_debug;
}
void OAIList_saveListpresentation_v1_Response::setObjDebug(const OAICommon_Response_objDebug &obj_debug) {
    this->obj_debug = obj_debug;
    this->m_obj_debug_isSet = true;
}

bool OAIList_saveListpresentation_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool OAIList_saveListpresentation_v1_Response::is_obj_debug_Valid() const{
