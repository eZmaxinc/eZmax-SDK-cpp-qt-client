...
Ezsigndocument_Response::Ezsigndocument_Response(const QString &json) {
...
void Ezsigndocument_Response::fromJson(const QString &jsonString) {
...
qint32 Ezsigndocument_Response::getIEzsigndocumentFormfieldtotal() const {
    return m_i_ezsigndocument_formfieldtotal;
}
void Ezsigndocument_Response::setIEzsigndocumentFormfieldtotal(const qint32 &i_ezsigndocument_formfieldtotal) {
    m_i_ezsigndocument_formfieldtotal = i_ezsigndocument_formfieldtotal;
    m_i_ezsigndocument_formfieldtotal_isSet = true;
}

bool Ezsigndocument_Response::is_i_ezsigndocument_formfieldtotal_Set() const{
    return m_i_ezsigndocument_formfieldtotal_isSet;
}

bool Ezsigndocument_Response::is_i_ezsigndocument_formfieldtotal_Valid() const{
...
bool Ezsigndocument_Response::isBEzsigndocumentSendtoged() const {
    return m_b_ezsigndocument_sendtoged;
}
void Ezsigndocument_Response::setBEzsigndocumentSendtoged(const bool &b_ezsigndocument_sendtoged) {
    m_b_ezsigndocument_sendtoged = b_ezsigndocument_sendtoged;
    m_b_ezsigndocument_sendtoged_isSet = true;
}

bool Ezsigndocument_Response::is_b_ezsigndocument_sendtoged_Set() const{
    return m_b_ezsigndocument_sendtoged_isSet;
}

bool Ezsigndocument_Response::is_b_ezsigndocument_sendtoged_Valid() const{
...
qint32 Ezsigndocument_Response::getIEzsigndocumentEzsigndiscussiontotal() const {
    return m_i_ezsigndocument_ezsigndiscussiontotal;
}
void Ezsigndocument_Response::setIEzsigndocumentEzsigndiscussiontotal(const qint32 &i_ezsigndocument_ezsigndiscussiontotal) {
...
bool Ezsigndocument_Response::is_i_ezsigndocument_ezsigndiscussiontotal_Set() const{
    return m_i_ezsigndocument_ezsigndiscussiontotal_isSet;
}

bool Ezsigndocument_Response::is_i_ezsigndocument_ezsigndiscussiontotal_Valid() const{
