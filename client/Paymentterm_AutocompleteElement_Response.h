...
/*
 * Paymentterm_AutocompleteElement_Response.h
 *
 * A Paymentterm AutocompleteElement Response
 */

#ifndef Paymentterm_AutocompleteElement_Response_H
#define Paymentterm_AutocompleteElement_Response_H
...
class Paymentterm_AutocompleteElement_Response : public Object {
public:
    Paymentterm_AutocompleteElement_Response();
    Paymentterm_AutocompleteElement_Response(const QString &json);
    ~Paymentterm_AutocompleteElement_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentterm_AutocompleteElement_Response)

#endif // Paymentterm_AutocompleteElement_Response_H
