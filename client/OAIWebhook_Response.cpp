...
bool OAIWebhook_Response::isBWebhookTest() const {
    return b_webhook_test;
}
void OAIWebhook_Response::setBWebhookTest(const bool &b_webhook_test) {
    this->b_webhook_test = b_webhook_test;
    this->m_b_webhook_test_isSet = true;
}

bool OAIWebhook_Response::is_b_webhook_test_Set() const{
    return m_b_webhook_test_isSet;
}

bool OAIWebhook_Response::is_b_webhook_test_Valid() const{
...
bool OAIWebhook_Response::isValid() const {
    ...
    return m_pks_customer_code_isValid && m_pki_webhook_id_isValid && m_e_webhook_module_isValid && m_s_webhook_url_isValid && m_b_webhook_test_isValid && m_b_webhook_skipsslvalidation_isValid && m_s_webhook_emailfailed_isValid && true;
}
