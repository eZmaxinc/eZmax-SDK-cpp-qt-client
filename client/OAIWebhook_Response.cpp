...
bool OAIWebhook_Response::is_s_webhook_description_Valid() const{
...
bool OAIWebhook_Response::is_fki_ezsignfoldertype_id_Valid() const{
...
bool OAIWebhook_Response::is_s_ezsignfoldertype_name_x_Valid() const{
...
bool OAIWebhook_Response::is_b_webhook_isactive_Valid() const{
...
bool OAIWebhook_Response::is_b_webhook_skipsslvalidation_Valid() const{
