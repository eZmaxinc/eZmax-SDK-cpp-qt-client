...
/*
 * OAICors_editObject_v1_Response.h
 *
 * Response for PUT /1/object/cors/{pkiCorsID}
 */

#ifndef OAICors_editObject_v1_Response_H
#define OAICors_editObject_v1_Response_H
...
class OAICors_editObject_v1_Response : public OAIObject {
public:
    OAICors_editObject_v1_Response();
    OAICors_editObject_v1_Response(QString json);
    ~OAICors_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICors_editObject_v1_Response)

#endif // OAICors_editObject_v1_Response_H
