...
Discussionmessage_patchObject_v1_Request::Discussionmessage_patchObject_v1_Request(const QString &json) {
...
void Discussionmessage_patchObject_v1_Request::fromJson(const QString &jsonString) {
