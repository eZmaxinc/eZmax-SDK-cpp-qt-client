...
#ifndef Ezsigntemplatesignaturecustomdate_Response_H
#define Ezsigntemplatesignaturecustomdate_Response_H
...
class Ezsigntemplatesignaturecustomdate_Response : public Object {
public:
    Ezsigntemplatesignaturecustomdate_Response();
    Ezsigntemplatesignaturecustomdate_Response(const QString &json);
    ~Ezsigntemplatesignaturecustomdate_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignaturecustomdate_Response)

#endif // Ezsigntemplatesignaturecustomdate_Response_H
