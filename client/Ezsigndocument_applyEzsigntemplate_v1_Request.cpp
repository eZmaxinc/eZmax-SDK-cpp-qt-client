...
Ezsigndocument_applyEzsigntemplate_v1_Request::Ezsigndocument_applyEzsigntemplate_v1_Request(const QString &json) {
...
void Ezsigndocument_applyEzsigntemplate_v1_Request::initializeModel() {
...
void Ezsigndocument_applyEzsigntemplate_v1_Request::fromJson(const QString &jsonString) {
...
void Ezsigndocument_applyEzsigntemplate_v1_Request::fromJsonObject(QJsonObject json) {
...
QString Ezsigndocument_applyEzsigntemplate_v1_Request::asJson() const {
...
QJsonObject Ezsigndocument_applyEzsigntemplate_v1_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsigndocument_applyEzsigntemplate_v1_Request::getFkiEzsigntemplateId() const {
    return m_fki_ezsigntemplate_id;
}
void Ezsigndocument_applyEzsigntemplate_v1_Request::setFkiEzsigntemplateId(const qint32 &fki_ezsigntemplate_id) {
    m_fki_ezsigntemplate_id = fki_ezsigntemplate_id;
    m_fki_ezsigntemplate_id_isSet = true;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_fki_ezsigntemplate_id_Set() const{
    return m_fki_ezsigntemplate_id_isSet;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_fki_ezsigntemplate_id_Valid() const{
    return m_fki_ezsigntemplate_id_isValid;
}

QList<QString> Ezsigndocument_applyEzsigntemplate_v1_Request::getASEzsigntemplatesigner() const {
    return m_a_s_ezsigntemplatesigner;
}
void Ezsigndocument_applyEzsigntemplate_v1_Request::setASEzsigntemplatesigner(const QList<QString> &a_s_ezsigntemplatesigner) {
    m_a_s_ezsigntemplatesigner = a_s_ezsigntemplatesigner;
    m_a_s_ezsigntemplatesigner_isSet = true;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_a_s_ezsigntemplatesigner_Set() const{
    return m_a_s_ezsigntemplatesigner_isSet;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_a_s_ezsigntemplatesigner_Valid() const{
    return m_a_s_ezsigntemplatesigner_isValid;
}

QList<qint32> Ezsigndocument_applyEzsigntemplate_v1_Request::getAPkiEzsignfoldersignerassociationId() const {
    return m_a_pki_ezsignfoldersignerassociation_id;
}
void Ezsigndocument_applyEzsigntemplate_v1_Request::setAPkiEzsignfoldersignerassociationId(const QList<qint32> &a_pki_ezsignfoldersignerassociation_id) {
...
bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_a_pki_ezsignfoldersignerassociation_id_Set() const{
    return m_a_pki_ezsignfoldersignerassociation_id_isSet;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::is_a_pki_ezsignfoldersignerassociation_id_Valid() const{
    return m_a_pki_ezsignfoldersignerassociation_id_isValid;
}

bool Ezsigndocument_applyEzsigntemplate_v1_Request::isSet() const {
...
bool Ezsigndocument_applyEzsigntemplate_v1_Request::isValid() const {
