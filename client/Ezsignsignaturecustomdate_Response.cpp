...
Ezsignsignaturecustomdate_Response::Ezsignsignaturecustomdate_Response(const QString &json) {
...
void Ezsignsignaturecustomdate_Response::fromJson(const QString &jsonString) {
