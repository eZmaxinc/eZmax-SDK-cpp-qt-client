...
public:
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1(const qint32 &pki_ezsignfoldersignerassociation_id);
...
private:
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1Signal();
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1SignalFull(OAIHttpRequestWorker *worker);
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1SignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsignfoldersignerassociationGetObjectGetChildrenV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
