...
Ezsigntemplatesignaturecustomdate_RequestV2::Ezsigntemplatesignaturecustomdate_RequestV2(const QString &json) {
...
void Ezsigntemplatesignaturecustomdate_RequestV2::fromJson(const QString &jsonString) {
