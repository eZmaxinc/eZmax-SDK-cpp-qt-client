...
void ObjectEzsigntemplatepackagesignerApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ezsigntemplatepackagesignerCreateObjectV2", defaultConf);
    _serverIndices.insert("ezsigntemplatepackagesignerCreateObjectV2", 0);
    ...
    _serverConfigs.insert("ezsigntemplatepackagesignerEditObjectV2", defaultConf);
    _serverIndices.insert("ezsigntemplatepackagesignerEditObjectV2", 0);
    ...
    _serverConfigs.insert("ezsigntemplatepackagesignerGetObjectV3", defaultConf);
    _serverIndices.insert("ezsigntemplatepackagesignerGetObjectV3", 0);
}
...
void ObjectEzsigntemplatepackagesignerApi::setServerIndex(int serverIndex) {
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV2(const Ezsigntemplatepackagesigner_createObject_v2_Request &ezsigntemplatepackagesigner_create_object_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsigntemplatepackagesignerCreateObjectV2"][_serverIndices.value("ezsigntemplatepackagesignerCreateObjectV2")].URL()+"/2/object/ezsigntemplatepackagesigner");
...

    {
        ...
        QByteArray output = ezsigntemplatepackagesigner_create_object_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV2Callback);
    connect(this, &ObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigntemplatepackagesigner_createObject_v2_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsigntemplatepackagesignerCreateObjectV2Signal(output);
        Q_EMIT ezsigntemplatepackagesignerCreateObjectV2SignalFull(worker, output);
    } else {
        Q_EMIT ezsigntemplatepackagesignerCreateObjectV2SignalError(output, error_type, error_str);
        Q_EMIT ezsigntemplatepackagesignerCreateObjectV2SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV2(const qint32 &pki_ezsigntemplatepackagesigner_id, const Ezsigntemplatepackagesigner_editObject_v2_Request &ezsigntemplatepackagesigner_edit_object_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsigntemplatepackagesignerEditObjectV2"][_serverIndices.value("ezsigntemplatepackagesignerEditObjectV2")].URL()+"/2/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}");
...

    {
        ...
        QByteArray output = ezsigntemplatepackagesigner_edit_object_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV2Callback);
    connect(this, &ObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigntemplatepackagesigner_editObject_v2_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsigntemplatepackagesignerEditObjectV2Signal(output);
        Q_EMIT ezsigntemplatepackagesignerEditObjectV2SignalFull(worker, output);
    } else {
        Q_EMIT ezsigntemplatepackagesignerEditObjectV2SignalError(output, error_type, error_str);
        Q_EMIT ezsigntemplatepackagesignerEditObjectV2SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV3(const qint32 &pki_ezsigntemplatepackagesigner_id) {
    QString fullPath = QString(_serverConfigs["ezsigntemplatepackagesignerGetObjectV3"][_serverIndices.value("ezsigntemplatepackagesignerGetObjectV3")].URL()+"/3/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV3Callback);
    connect(this, &ObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigntemplatepackagesigner_getObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsigntemplatepackagesignerGetObjectV3Signal(output);
        Q_EMIT ezsigntemplatepackagesignerGetObjectV3SignalFull(worker, output);
    } else {
        Q_EMIT ezsigntemplatepackagesignerGetObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsigntemplatepackagesignerGetObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}
