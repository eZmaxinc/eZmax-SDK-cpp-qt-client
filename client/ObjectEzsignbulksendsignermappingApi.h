...
#include "Ezsignbulksendsignermapping_createObject_v2_Request.h"
#include "Ezsignbulksendsignermapping_createObject_v2_Response.h"
...
#include "Ezsignbulksendsignermapping_getObject_v3_Response.h"
#include <QString>
...
public:
    ...
    */
    Q_DECL_DEPRECATED virtual void ezsignbulksendsignermappingCreateObjectV1(const Ezsignbulksendsignermapping_createObject_v1_Request &ezsignbulksendsignermapping_create_object_v1_request);

    /**
    * @param[in]  ezsignbulksendsignermapping_create_object_v2_request Ezsignbulksendsignermapping_createObject_v2_Request [required]
    */
    virtual void ezsignbulksendsignermappingCreateObjectV2(const Ezsignbulksendsignermapping_createObject_v2_Request &ezsignbulksendsignermapping_create_object_v2_request);
    ...
    * @param[in]  pki_ezsignbulksendsignermapping_id qint32 [required]
    */
    Q_DECL_DEPRECATED virtual void ezsignbulksendsignermappingGetObjectV2(const qint32 &pki_ezsignbulksendsignermapping_id);

    /**
    * @param[in]  pki_ezsignbulksendsignermapping_id qint32 [required]
    */
    virtual void ezsignbulksendsignermappingGetObjectV3(const qint32 &pki_ezsignbulksendsignermapping_id);
...
private:
    ...
    void ezsignbulksendsignermappingCreateObjectV2Callback(HttpRequestWorker *worker);
    ...
    void ezsignbulksendsignermappingGetObjectV3Callback(HttpRequestWorker *worker);

Q_SIGNALS:

    void ezsignbulksendsignermappingCreateObjectV1Signal(Ezsignbulksendsignermapping_createObject_v1_Response summary);
    void ezsignbulksendsignermappingCreateObjectV2Signal(Ezsignbulksendsignermapping_createObject_v2_Response summary);
    ...
    void ezsignbulksendsignermappingGetObjectV3Signal(Ezsignbulksendsignermapping_getObject_v3_Response summary);
    ...
    void ezsignbulksendsignermappingCreateObjectV2SignalFull(HttpRequestWorker *worker, Ezsignbulksendsignermapping_createObject_v2_Response summary);
    ...
    void ezsignbulksendsignermappingGetObjectV3SignalFull(HttpRequestWorker *worker, Ezsignbulksendsignermapping_getObject_v3_Response summary);
    ...
    void ezsignbulksendsignermappingCreateObjectV2SignalError(Ezsignbulksendsignermapping_createObject_v2_Response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsignbulksendsignermappingGetObjectV3SignalError(Ezsignbulksendsignermapping_getObject_v3_Response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsignbulksendsignermappingCreateObjectV2SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsignbulksendsignermappingGetObjectV3SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
