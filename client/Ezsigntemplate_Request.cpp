...
QString Ezsigntemplate_Request::getSEzsigntemplateFilenamepattern() const {
    return m_s_ezsigntemplate_filenamepattern;
}
void Ezsigntemplate_Request::setSEzsigntemplateFilenamepattern(const QString &s_ezsigntemplate_filenamepattern) {
    m_s_ezsigntemplate_filenamepattern = s_ezsigntemplate_filenamepattern;
    m_s_ezsigntemplate_filenamepattern_isSet = true;
}

bool Ezsigntemplate_Request::is_s_ezsigntemplate_filenamepattern_Set() const{
    return m_s_ezsigntemplate_filenamepattern_isSet;
}

bool Ezsigntemplate_Request::is_s_ezsigntemplate_filenamepattern_Valid() const{
