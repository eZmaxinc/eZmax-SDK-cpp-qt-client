...
/*
 * Lead_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/lead/{pkiLeadID}/getAttachments
 */

#ifndef Lead_getAttachments_v1_Response_mPayload_H
#define Lead_getAttachments_v1_Response_mPayload_H
...
class Lead_getAttachments_v1_Response_mPayload : public Object {
public:
    Lead_getAttachments_v1_Response_mPayload();
    Lead_getAttachments_v1_Response_mPayload(const QString &json);
    ~Lead_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Lead_getAttachments_v1_Response_mPayload)

#endif // Lead_getAttachments_v1_Response_mPayload_H
