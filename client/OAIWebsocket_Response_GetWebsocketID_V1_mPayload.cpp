...
OAIWebsocket_Response_GetWebsocketID_V1_mPayload::OAIWebsocket_Response_GetWebsocketID_V1_mPayload() {
    this->initializeModel();
}

OAIWebsocket_Response_GetWebsocketID_V1_mPayload::~OAIWebsocket_Response_GetWebsocketID_V1_mPayload() {}

void OAIWebsocket_Response_GetWebsocketID_V1_mPayload::initializeModel() {

    m_s_websocket_id_isSet = false;
    m_s_websocket_id_isValid = false;
}

void OAIWebsocket_Response_GetWebsocketID_V1_mPayload::fromJson(QString jsonString) {
...
QString OAIWebsocket_Response_GetWebsocketID_V1_mPayload::asJson() const {
...
bool OAIWebsocket_Response_GetWebsocketID_V1_mPayload::is_s_websocket_id_Valid() const{
    return m_s_websocket_id_isValid;
}

bool OAIWebsocket_Response_GetWebsocketID_V1_mPayload::isSet() const {
...
bool OAIWebsocket_Response_GetWebsocketID_V1_mPayload::isValid() const {
