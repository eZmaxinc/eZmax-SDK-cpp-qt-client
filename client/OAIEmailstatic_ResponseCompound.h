...
/*
 * OAIEmailstatic_ResponseCompound.h
 *
 * An Emailstatic Object and children to create a complete structure
 */

#ifndef OAIEmailstatic_ResponseCompound_H
#define OAIEmailstatic_ResponseCompound_H
...
public:
    OAIEmailstatic_ResponseCompound();
    OAIEmailstatic_ResponseCompound(QString json);
    ~OAIEmailstatic_ResponseCompound() override;
