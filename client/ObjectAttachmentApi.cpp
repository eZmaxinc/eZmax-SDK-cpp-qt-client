...
ObjectAttachmentApi::ObjectAttachmentApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectAttachmentApi::~ObjectAttachmentApi() {
}

void ObjectAttachmentApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("attachmentDownloadV1", defaultConf);
 ...
 */
int ObjectAttachmentApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectAttachmentApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectAttachmentApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectAttachmentApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectAttachmentApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectAttachmentApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectAttachmentApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectAttachmentApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectAttachmentApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectAttachmentApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectAttachmentApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectAttachmentApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectAttachmentApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectAttachmentApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectAttachmentApi::enableResponseCompression() {
...
QString ObjectAttachmentApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectAttachmentApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectAttachmentApi::attachmentDownloadV1(const qint32 &pki_attachment_id) {
    QString fullPath = QString(_serverConfigs["attachmentDownloadV1"][_serverIndices.value("attachmentDownloadV1")].URL()+"/1/object/attachment/{pkiAttachmentID}/download");
...
void ObjectAttachmentApi::attachmentDownloadV1Callback(HttpRequestWorker *worker) {
...
void ObjectAttachmentApi::attachmentGetAttachmentlogsV1(const qint32 &pki_attachment_id) {
    QString fullPath = QString(_serverConfigs["attachmentGetAttachmentlogsV1"][_serverIndices.value("attachmentGetAttachmentlogsV1")].URL()+"/1/object/attachment/{pkiAttachmentID}/getAttachmentlogs");
...
void ObjectAttachmentApi::attachmentGetAttachmentlogsV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Attachment_getAttachmentlogs_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectAttachmentApi::tokenAvailable() {
