...
bool OAIApikey_ResponseCompound::is_fki_user_id_Valid() const{
...
bool OAIApikey_ResponseCompound::is_obj_contact_name_Valid() const{
...
bool OAIApikey_ResponseCompound::is_s_apikey_apikey_Valid() const{
...
bool OAIApikey_ResponseCompound::is_s_apikey_secret_Valid() const{
...
bool OAIApikey_ResponseCompound::is_b_apikey_isactive_Valid() const{
...
bool OAIApikey_ResponseCompound::is_b_apikey_issigned_Valid() const{
