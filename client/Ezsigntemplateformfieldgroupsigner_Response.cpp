...
Ezsigntemplateformfieldgroupsigner_Response::Ezsigntemplateformfieldgroupsigner_Response(const QString &json) {
...
void Ezsigntemplateformfieldgroupsigner_Response::fromJson(const QString &jsonString) {
