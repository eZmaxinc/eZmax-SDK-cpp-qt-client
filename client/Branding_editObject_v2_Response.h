...
/*
 * Branding_editObject_v2_Response.h
 *
 * Response for PUT /2/object/branding/{pkiBrandingID}
 */

#ifndef Branding_editObject_v2_Response_H
#define Branding_editObject_v2_Response_H
...
class Branding_editObject_v2_Response : public Object {
public:
    Branding_editObject_v2_Response();
    Branding_editObject_v2_Response(const QString &json);
    ~Branding_editObject_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_editObject_v2_Response)

#endif // Branding_editObject_v2_Response_H
