...
/*
 * Usergroup_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroup/{pkiUsergroupID}
 */

#ifndef Usergroup_editObject_v1_Response_H
#define Usergroup_editObject_v1_Response_H
...
class Usergroup_editObject_v1_Response : public Object {
public:
    Usergroup_editObject_v1_Response();
    Usergroup_editObject_v1_Response(const QString &json);
    ~Usergroup_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroup_editObject_v1_Response)

#endif // Usergroup_editObject_v1_Response_H
