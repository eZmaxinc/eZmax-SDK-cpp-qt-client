...
/*
 * Ezsignsignaturecustomdate_ResponseCompound.h
 *
 * An Ezsignsignaturecustomdate Object and children to create a complete structure
 */

#ifndef Ezsignsignaturecustomdate_ResponseCompound_H
#define Ezsignsignaturecustomdate_ResponseCompound_H
...
class Ezsignsignaturecustomdate_ResponseCompound : public Object {
public:
    Ezsignsignaturecustomdate_ResponseCompound();
    Ezsignsignaturecustomdate_ResponseCompound(const QString &json);
    ~Ezsignsignaturecustomdate_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturecustomdate_ResponseCompound)

#endif // Ezsignsignaturecustomdate_ResponseCompound_H
