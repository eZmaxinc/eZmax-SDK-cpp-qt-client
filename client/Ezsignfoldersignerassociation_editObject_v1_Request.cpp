...
Ezsignfoldersignerassociation_editObject_v1_Request::Ezsignfoldersignerassociation_editObject_v1_Request(const QString &json) {
...
void Ezsignfoldersignerassociation_editObject_v1_Request::fromJson(const QString &jsonString) {
