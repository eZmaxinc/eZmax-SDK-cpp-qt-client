...
Ezsignbulksend_ResponseCompound::Ezsignbulksend_ResponseCompound(const QString &json) {
...
void Ezsignbulksend_ResponseCompound::fromJson(const QString &jsonString) {
