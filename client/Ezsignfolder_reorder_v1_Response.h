...
/*
 * Ezsignfolder_reorder_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/reorder
 */

#ifndef Ezsignfolder_reorder_v1_Response_H
#define Ezsignfolder_reorder_v1_Response_H
...
class Ezsignfolder_reorder_v1_Response : public Object {
public:
    Ezsignfolder_reorder_v1_Response();
    Ezsignfolder_reorder_v1_Response(QString json);
    ~Ezsignfolder_reorder_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_reorder_v1_Response)

#endif // Ezsignfolder_reorder_v1_Response_H
