...
Ezsignimportfolder_ResponseCompound::Ezsignimportfolder_ResponseCompound(const QString &json) {
...
void Ezsignimportfolder_ResponseCompound::fromJson(const QString &jsonString) {
