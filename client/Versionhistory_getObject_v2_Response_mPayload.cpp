...
Versionhistory_getObject_v2_Response_mPayload::Versionhistory_getObject_v2_Response_mPayload(const QString &json) {
...
void Versionhistory_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
