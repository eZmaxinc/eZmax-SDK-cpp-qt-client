...
/*
 * OAIEzsignformfieldgroup_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}
 */

#ifndef OAIEzsignformfieldgroup_getObject_v1_Response_mPayload_H
#define OAIEzsignformfieldgroup_getObject_v1_Response_mPayload_H
...
class OAIEzsignformfieldgroup_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsignformfieldgroup_getObject_v1_Response_mPayload();
    OAIEzsignformfieldgroup_getObject_v1_Response_mPayload(QString json);
    ~OAIEzsignformfieldgroup_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsignformfieldgroup_getObject_v1_Response_mPayload)

#endif // OAIEzsignformfieldgroup_getObject_v1_Response_mPayload_H
