...
public:
    ...
    void ezsignfolderGetObjectGetChildrenV1(const qint32 &pki_ezsignfolder_id);
...
private:
    ...
    void ezsignfolderGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void ezsignfolderGetObjectGetChildrenV1Signal();
    ...
    void ezsignfolderGetObjectGetChildrenV1SignalFull(OAIHttpRequestWorker *worker);
    ...
    void ezsignfolderGetObjectGetChildrenV1SignalE(QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void ezsignfolderGetObjectGetChildrenV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
