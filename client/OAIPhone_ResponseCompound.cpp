...
QString OAIPhone_ResponseCompound::getSPhoneRegion() const {
    return s_phone_region;
}
void OAIPhone_ResponseCompound::setSPhoneRegion(const QString &s_phone_region) {
    this->s_phone_region = s_phone_region;
    this->m_s_phone_region_isSet = true;
}

bool OAIPhone_ResponseCompound::is_s_phone_region_Set() const{
    return m_s_phone_region_isSet;
}

bool OAIPhone_ResponseCompound::is_s_phone_region_Valid() const{
    return m_s_phone_region_isValid;
}

QString OAIPhone_ResponseCompound::getSPhoneExchange() const {
    return s_phone_exchange;
}
void OAIPhone_ResponseCompound::setSPhoneExchange(const QString &s_phone_exchange) {
    this->s_phone_exchange = s_phone_exchange;
    this->m_s_phone_exchange_isSet = true;
}

bool OAIPhone_ResponseCompound::is_s_phone_exchange_Set() const{
    return m_s_phone_exchange_isSet;
}

bool OAIPhone_ResponseCompound::is_s_phone_exchange_Valid() const{
    return m_s_phone_exchange_isValid;
}

QString OAIPhone_ResponseCompound::getIPhoneNumber() const {
    return i_phone_number;
}
void OAIPhone_ResponseCompound::setIPhoneNumber(const QString &i_phone_number) {
    this->i_phone_number = i_phone_number;
    this->m_i_phone_number_isSet = true;
}

bool OAIPhone_ResponseCompound::is_i_phone_number_Set() const{
    return m_i_phone_number_isSet;
}

bool OAIPhone_ResponseCompound::is_i_phone_number_Valid() const{
...
QString OAIPhone_ResponseCompound::getSPhoneInternational() const {
    return s_phone_international;
}
void OAIPhone_ResponseCompound::setSPhoneInternational(const QString &s_phone_international) {
    this->s_phone_international = s_phone_international;
    this->m_s_phone_international_isSet = true;
}

bool OAIPhone_ResponseCompound::is_s_phone_international_Set() const{
    return m_s_phone_international_isSet;
}

bool OAIPhone_ResponseCompound::is_s_phone_international_Valid() const{
