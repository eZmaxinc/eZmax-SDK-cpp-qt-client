...
Branding_ResponseCompoundV3::Branding_ResponseCompoundV3(const QString &json) {
...
void Branding_ResponseCompoundV3::initializeModel() {
    ...
    m_fki_domain_id_isSet = false;
    m_fki_domain_id_isValid = false;
...
void Branding_ResponseCompoundV3::fromJson(const QString &jsonString) {
...
void Branding_ResponseCompoundV3::fromJsonObject(QJsonObject json) {
    ...
    m_fki_domain_id_isValid = ::Ezmaxapi::fromJsonValue(m_fki_domain_id, json[QString("fkiDomainID")]);
    m_fki_domain_id_isSet = !json[QString("fkiDomainID")].isNull() && m_fki_domain_id_isValid;
...
QJsonObject Branding_ResponseCompoundV3::asJsonObject() const {
    ...
    if (m_fki_domain_id_isSet) {
        obj.insert(QString("fkiDomainID"), ::Ezmaxapi::toJsonValue(m_fki_domain_id));
    }
...
qint32 Branding_ResponseCompoundV3::getFkiDomainId() const {
    return m_fki_domain_id;
}
void Branding_ResponseCompoundV3::setFkiDomainId(const qint32 &fki_domain_id) {
    m_fki_domain_id = fki_domain_id;
    m_fki_domain_id_isSet = true;
}

bool Branding_ResponseCompoundV3::is_fki_domain_id_Set() const{
    return m_fki_domain_id_isSet;
}

bool Branding_ResponseCompoundV3::is_fki_domain_id_Valid() const{
    return m_fki_domain_id_isValid;
}

QString Branding_ResponseCompoundV3::getSDomainName() const {
    return m_s_domain_name;
}
void Branding_ResponseCompoundV3::setSDomainName(const QString &s_domain_name) {
    m_s_domain_name = s_domain_name;
    m_s_domain_name_isSet = true;
}

bool Branding_ResponseCompoundV3::is_s_domain_name_Set() const{
    return m_s_domain_name_isSet;
}

bool Branding_ResponseCompoundV3::is_s_domain_name_Valid() const{
