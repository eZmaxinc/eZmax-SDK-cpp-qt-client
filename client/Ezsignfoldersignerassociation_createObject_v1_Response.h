...
#ifndef Ezsignfoldersignerassociation_createObject_v1_Response_H
#define Ezsignfoldersignerassociation_createObject_v1_Response_H
...
class Ezsignfoldersignerassociation_createObject_v1_Response : public Object {
public:
    Ezsignfoldersignerassociation_createObject_v1_Response();
    Ezsignfoldersignerassociation_createObject_v1_Response(const QString &json);
    ~Ezsignfoldersignerassociation_createObject_v1_Response() override;
    ...
    Ezsignfoldersignerassociation_createObject_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Ezsignfoldersignerassociation_createObject_v1_Response_mPayload &m_payload);
...
private:
    ...
    Ezsignfoldersignerassociation_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldersignerassociation_createObject_v1_Response)

#endif // Ezsignfoldersignerassociation_createObject_v1_Response_H
