...
Ezsignannotation_RequestCompound::Ezsignannotation_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignannotation_RequestCompound::Ezsignannotation_RequestCompound() {
    this->initializeModel();
}

Ezsignannotation_RequestCompound::~Ezsignannotation_RequestCompound() {}

void Ezsignannotation_RequestCompound::initializeModel() {
...
void Ezsignannotation_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsignannotation_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignannotation_RequestCompound::asJson() const {
...
QJsonObject Ezsignannotation_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignannotation_RequestCompound::getPkiEzsignannotationId() const {
    return m_pki_ezsignannotation_id;
}
void Ezsignannotation_RequestCompound::setPkiEzsignannotationId(const qint32 &pki_ezsignannotation_id) {
    m_pki_ezsignannotation_id = pki_ezsignannotation_id;
    m_pki_ezsignannotation_id_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_pki_ezsignannotation_id_Set() const{
    return m_pki_ezsignannotation_id_isSet;
}

bool Ezsignannotation_RequestCompound::is_pki_ezsignannotation_id_Valid() const{
    return m_pki_ezsignannotation_id_isValid;
}

qint32 Ezsignannotation_RequestCompound::getFkiEzsigndocumentId() const {
    return m_fki_ezsigndocument_id;
}
void Ezsignannotation_RequestCompound::setFkiEzsigndocumentId(const qint32 &fki_ezsigndocument_id) {
    m_fki_ezsigndocument_id = fki_ezsigndocument_id;
    m_fki_ezsigndocument_id_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_fki_ezsigndocument_id_Set() const{
    return m_fki_ezsigndocument_id_isSet;
}

bool Ezsignannotation_RequestCompound::is_fki_ezsigndocument_id_Valid() const{
    return m_fki_ezsigndocument_id_isValid;
}

Enum_Horizontalalignment Ezsignannotation_RequestCompound::getEEzsignannotationHorizontalalignment() const {
    return m_e_ezsignannotation_horizontalalignment;
}
void Ezsignannotation_RequestCompound::setEEzsignannotationHorizontalalignment(const Enum_Horizontalalignment &e_ezsignannotation_horizontalalignment) {
...
bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_horizontalalignment_Set() const{
    return m_e_ezsignannotation_horizontalalignment_isSet;
}

bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_horizontalalignment_Valid() const{
    return m_e_ezsignannotation_horizontalalignment_isValid;
}

Enum_Verticalalignment Ezsignannotation_RequestCompound::getEEzsignannotationVerticalalignment() const {
    return m_e_ezsignannotation_verticalalignment;
}
void Ezsignannotation_RequestCompound::setEEzsignannotationVerticalalignment(const Enum_Verticalalignment &e_ezsignannotation_verticalalignment) {
...
bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_verticalalignment_Set() const{
    return m_e_ezsignannotation_verticalalignment_isSet;
}

bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_verticalalignment_Valid() const{
    return m_e_ezsignannotation_verticalalignment_isValid;
}

Field_eEzsignannotationType Ezsignannotation_RequestCompound::getEEzsignannotationType() const {
    return m_e_ezsignannotation_type;
}
void Ezsignannotation_RequestCompound::setEEzsignannotationType(const Field_eEzsignannotationType &e_ezsignannotation_type) {
    m_e_ezsignannotation_type = e_ezsignannotation_type;
    m_e_ezsignannotation_type_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_type_Set() const{
    return m_e_ezsignannotation_type_isSet;
}

bool Ezsignannotation_RequestCompound::is_e_ezsignannotation_type_Valid() const{
    return m_e_ezsignannotation_type_isValid;
}

qint32 Ezsignannotation_RequestCompound::getIEzsignannotationX() const {
    return m_i_ezsignannotation_x;
}
void Ezsignannotation_RequestCompound::setIEzsignannotationX(const qint32 &i_ezsignannotation_x) {
    m_i_ezsignannotation_x = i_ezsignannotation_x;
    m_i_ezsignannotation_x_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_x_Set() const{
    return m_i_ezsignannotation_x_isSet;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_x_Valid() const{
    return m_i_ezsignannotation_x_isValid;
}

qint32 Ezsignannotation_RequestCompound::getIEzsignannotationY() const {
    return m_i_ezsignannotation_y;
}
void Ezsignannotation_RequestCompound::setIEzsignannotationY(const qint32 &i_ezsignannotation_y) {
    m_i_ezsignannotation_y = i_ezsignannotation_y;
    m_i_ezsignannotation_y_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_y_Set() const{
    return m_i_ezsignannotation_y_isSet;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_y_Valid() const{
    return m_i_ezsignannotation_y_isValid;
}

qint32 Ezsignannotation_RequestCompound::getIEzsignannotationWidth() const {
    return m_i_ezsignannotation_width;
}
void Ezsignannotation_RequestCompound::setIEzsignannotationWidth(const qint32 &i_ezsignannotation_width) {
    m_i_ezsignannotation_width = i_ezsignannotation_width;
    m_i_ezsignannotation_width_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_width_Set() const{
    return m_i_ezsignannotation_width_isSet;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_width_Valid() const{
    return m_i_ezsignannotation_width_isValid;
}

qint32 Ezsignannotation_RequestCompound::getIEzsignannotationHeight() const {
    return m_i_ezsignannotation_height;
}
void Ezsignannotation_RequestCompound::setIEzsignannotationHeight(const qint32 &i_ezsignannotation_height) {
    m_i_ezsignannotation_height = i_ezsignannotation_height;
    m_i_ezsignannotation_height_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_height_Set() const{
    return m_i_ezsignannotation_height_isSet;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignannotation_height_Valid() const{
    return m_i_ezsignannotation_height_isValid;
}

QString Ezsignannotation_RequestCompound::getSEzsignannotationText() const {
    return m_s_ezsignannotation_text;
}
void Ezsignannotation_RequestCompound::setSEzsignannotationText(const QString &s_ezsignannotation_text) {
    m_s_ezsignannotation_text = s_ezsignannotation_text;
    m_s_ezsignannotation_text_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_s_ezsignannotation_text_Set() const{
    return m_s_ezsignannotation_text_isSet;
}

bool Ezsignannotation_RequestCompound::is_s_ezsignannotation_text_Valid() const{
    return m_s_ezsignannotation_text_isValid;
}

qint32 Ezsignannotation_RequestCompound::getIEzsignpagePagenumber() const {
    return m_i_ezsignpage_pagenumber;
}
void Ezsignannotation_RequestCompound::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Ezsignannotation_RequestCompound::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

Textstylestatic_RequestCompound Ezsignannotation_RequestCompound::getObjTextstylestatic() const {
    return m_obj_textstylestatic;
}
void Ezsignannotation_RequestCompound::setObjTextstylestatic(const Textstylestatic_RequestCompound &obj_textstylestatic) {
    m_obj_textstylestatic = obj_textstylestatic;
    m_obj_textstylestatic_isSet = true;
}

bool Ezsignannotation_RequestCompound::is_obj_textstylestatic_Set() const{
    return m_obj_textstylestatic_isSet;
}

bool Ezsignannotation_RequestCompound::is_obj_textstylestatic_Valid() const{
    return m_obj_textstylestatic_isValid;
}

bool Ezsignannotation_RequestCompound::isSet() const {
...
bool Ezsignannotation_RequestCompound::isValid() const {
