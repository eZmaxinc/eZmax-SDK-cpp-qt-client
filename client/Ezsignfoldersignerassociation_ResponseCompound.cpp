...
Ezsignfoldersignerassociation_ResponseCompound::Ezsignfoldersignerassociation_ResponseCompound(const QString &json) {
...
void Ezsignfoldersignerassociation_ResponseCompound::fromJson(const QString &jsonString) {
