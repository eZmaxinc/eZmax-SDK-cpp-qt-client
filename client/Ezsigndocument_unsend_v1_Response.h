...
#ifndef Ezsigndocument_unsend_v1_Response_H
#define Ezsigndocument_unsend_v1_Response_H
...
class Ezsigndocument_unsend_v1_Response : public Object {
public:
    Ezsigndocument_unsend_v1_Response();
    Ezsigndocument_unsend_v1_Response(const QString &json);
    ~Ezsigndocument_unsend_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_unsend_v1_Response)

#endif // Ezsigndocument_unsend_v1_Response_H
