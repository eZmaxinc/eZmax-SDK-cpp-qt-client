...
/*
 * Custom_DropdownElement_Request.h
 *
 * Generic DropdownElement Request
 */

#ifndef Custom_DropdownElement_Request_H
#define Custom_DropdownElement_Request_H
...
class Custom_DropdownElement_Request : public Object {
public:
    Custom_DropdownElement_Request();
    Custom_DropdownElement_Request(const QString &json);
    ~Custom_DropdownElement_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Custom_DropdownElement_Request)

#endif // Custom_DropdownElement_Request_H
