...
#ifndef Ezsigntemplatedocument_Request_H
#define Ezsigntemplatedocument_Request_H
...
class Ezsigntemplatedocument_Request : public Object {
public:
    Ezsigntemplatedocument_Request();
    Ezsigntemplatedocument_Request(const QString &json);
    ~Ezsigntemplatedocument_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatedocument_Request)

#endif // Ezsigntemplatedocument_Request_H
