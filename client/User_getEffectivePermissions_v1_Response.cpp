...
User_getEffectivePermissions_v1_Response::User_getEffectivePermissions_v1_Response(const QString &json) {
...
void User_getEffectivePermissions_v1_Response::fromJson(const QString &jsonString) {
