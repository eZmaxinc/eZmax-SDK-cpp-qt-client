...
#include "OAIUsergroup_Response.h"
...
OAIUsergroup_Response::OAIUsergroup_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsergroup_Response::OAIUsergroup_Response() {
    this->initializeModel();
}

OAIUsergroup_Response::~OAIUsergroup_Response() {}

void OAIUsergroup_Response::initializeModel() {
...
void OAIUsergroup_Response::fromJson(QString jsonString) {
...
QString OAIUsergroup_Response::asJson() const {
...
bool OAIUsergroup_Response::is_pki_usergroup_id_Valid() const{
...
bool OAIUsergroup_Response::is_obj_usergroup_name_Valid() const{
    return m_obj_usergroup_name_isValid;
}

bool OAIUsergroup_Response::isSet() const {
...
bool OAIUsergroup_Response::isValid() const {
