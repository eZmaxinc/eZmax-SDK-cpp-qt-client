...
private:
    ...
    OAIEzsigntemplatepackagesigner_RequestCompound m_obj_ezsigntemplatepackagesigner;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackagesigner_editObject_v1_Request)
