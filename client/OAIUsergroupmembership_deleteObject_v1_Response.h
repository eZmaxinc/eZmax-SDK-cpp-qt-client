...
/*
 * OAIUsergroupmembership_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroupmembership/{pkiUsergroupmembershipID}
 */

#ifndef OAIUsergroupmembership_deleteObject_v1_Response_H
#define OAIUsergroupmembership_deleteObject_v1_Response_H
...
class OAIUsergroupmembership_deleteObject_v1_Response : public OAIObject {
public:
    OAIUsergroupmembership_deleteObject_v1_Response();
    OAIUsergroupmembership_deleteObject_v1_Response(QString json);
    ~OAIUsergroupmembership_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupmembership_deleteObject_v1_Response)

#endif // OAIUsergroupmembership_deleteObject_v1_Response_H
