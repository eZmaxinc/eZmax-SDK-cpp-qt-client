...
Website_ResponseCompound::Website_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Website_ResponseCompound::Website_ResponseCompound() {
    this->initializeModel();
}

Website_ResponseCompound::~Website_ResponseCompound() {}

void Website_ResponseCompound::initializeModel() {
...
void Website_ResponseCompound::fromJson(const QString &jsonString) {
...
void Website_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Website_ResponseCompound::asJson() const {
...
QJsonObject Website_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Website_ResponseCompound::getPkiWebsiteId() const {
    return m_pki_website_id;
}
void Website_ResponseCompound::setPkiWebsiteId(const qint32 &pki_website_id) {
    m_pki_website_id = pki_website_id;
    m_pki_website_id_isSet = true;
}

bool Website_ResponseCompound::is_pki_website_id_Set() const{
    return m_pki_website_id_isSet;
}

bool Website_ResponseCompound::is_pki_website_id_Valid() const{
    return m_pki_website_id_isValid;
}

qint32 Website_ResponseCompound::getFkiWebsitetypeId() const {
    return m_fki_websitetype_id;
}
void Website_ResponseCompound::setFkiWebsitetypeId(const qint32 &fki_websitetype_id) {
    m_fki_websitetype_id = fki_websitetype_id;
    m_fki_websitetype_id_isSet = true;
}

bool Website_ResponseCompound::is_fki_websitetype_id_Set() const{
    return m_fki_websitetype_id_isSet;
}

bool Website_ResponseCompound::is_fki_websitetype_id_Valid() const{
    return m_fki_websitetype_id_isValid;
}

QString Website_ResponseCompound::getSWebsiteAddress() const {
    return m_s_website_address;
}
void Website_ResponseCompound::setSWebsiteAddress(const QString &s_website_address) {
    m_s_website_address = s_website_address;
    m_s_website_address_isSet = true;
}

bool Website_ResponseCompound::is_s_website_address_Set() const{
    return m_s_website_address_isSet;
}

bool Website_ResponseCompound::is_s_website_address_Valid() const{
    return m_s_website_address_isValid;
}

bool Website_ResponseCompound::isSet() const {
...
bool Website_ResponseCompound::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pki_website_id_isValid && m_fki_websitetype_id_isValid && m_s_website_address_isValid && true;
}
