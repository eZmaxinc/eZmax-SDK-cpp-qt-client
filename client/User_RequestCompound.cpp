...
User_RequestCompound::User_RequestCompound(const QString &json) {
...
void User_RequestCompound::fromJson(const QString &jsonString) {
...
bool User_RequestCompound::isBUserEzsigntemplaterolegrouping() const {
    return m_b_user_ezsigntemplaterolegrouping;
}
void User_RequestCompound::setBUserEzsigntemplaterolegrouping(const bool &b_user_ezsigntemplaterolegrouping) {
    m_b_user_ezsigntemplaterolegrouping = b_user_ezsigntemplaterolegrouping;
    m_b_user_ezsigntemplaterolegrouping_isSet = true;
}

bool User_RequestCompound::is_b_user_ezsigntemplaterolegrouping_Set() const{
    return m_b_user_ezsigntemplaterolegrouping_isSet;
}

bool User_RequestCompound::is_b_user_ezsigntemplaterolegrouping_Valid() const{
