...
Usergroupexternalmembership_ResponseCompound::Usergroupexternalmembership_ResponseCompound(const QString &json) {
...
void Usergroupexternalmembership_ResponseCompound::fromJson(const QString &jsonString) {
