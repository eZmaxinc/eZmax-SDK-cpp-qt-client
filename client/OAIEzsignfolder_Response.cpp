...
QString OAIEzsignfolder_Response::getDtEzsignfolderScheduleddestruction() const {
    return dt_ezsignfolder_scheduleddestruction;
}
void OAIEzsignfolder_Response::setDtEzsignfolderScheduleddestruction(const QString &dt_ezsignfolder_scheduleddestruction) {
...
bool OAIEzsignfolder_Response::is_dt_ezsignfolder_scheduleddestruction_Set() const{
    return m_dt_ezsignfolder_scheduleddestruction_isSet;
}

bool OAIEzsignfolder_Response::is_dt_ezsignfolder_scheduleddestruction_Valid() const{
