...
/*
 * Ezsigntemplatesigner_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}
 */

#ifndef Ezsigntemplatesigner_editObject_v1_Response_H
#define Ezsigntemplatesigner_editObject_v1_Response_H
...
class Ezsigntemplatesigner_editObject_v1_Response : public Object {
public:
    Ezsigntemplatesigner_editObject_v1_Response();
    Ezsigntemplatesigner_editObject_v1_Response(const QString &json);
    ~Ezsigntemplatesigner_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesigner_editObject_v1_Response)

#endif // Ezsigntemplatesigner_editObject_v1_Response_H
