...
/*
 * OAIEzsign_suggestTemplates_v1_Response.h
 *
 * Response for GET /1/module/ezsign/suggestTemplates
 */

#ifndef OAIEzsign_suggestTemplates_v1_Response_H
#define OAIEzsign_suggestTemplates_v1_Response_H
...
class OAIEzsign_suggestTemplates_v1_Response : public OAIObject {
public:
    OAIEzsign_suggestTemplates_v1_Response();
    OAIEzsign_suggestTemplates_v1_Response(QString json);
    ~OAIEzsign_suggestTemplates_v1_Response() override;
...
private:
    ...
    OAIEzsign_suggestTemplates_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsign_suggestTemplates_v1_Response)

#endif // OAIEzsign_suggestTemplates_v1_Response_H
