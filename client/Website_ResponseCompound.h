...
/*
 * Website_ResponseCompound.h
 *
 * A Website Object and children to create a complete structure
 */

#ifndef Website_ResponseCompound_H
#define Website_ResponseCompound_H
...
class Website_ResponseCompound : public Object {
public:
    Website_ResponseCompound();
    Website_ResponseCompound(const QString &json);
    ~Website_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Website_ResponseCompound)

#endif // Website_ResponseCompound_H
