...
void OAIObjectEzsigntemplatesignerApi::ezsigntemplatesignerGetObjectV2(const qint32 &pki_ezsigntemplatesigner_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigntemplatesignerApi::ezsigntemplatesignerGetObjectV2Callback);
    connect(this, &OAIObjectEzsigntemplatesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsigntemplatesignerApi::ezsigntemplatesignerGetObjectV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsigntemplatesigner_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
