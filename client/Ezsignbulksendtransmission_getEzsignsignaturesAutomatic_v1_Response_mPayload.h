...
/*
 * Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getEzsignsignaturesAutomatic
 */

#ifndef Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
#define Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
...
class Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload : public Object {
public:
    Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload();
    Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload(const QString &json);
    ~Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload)

#endif // Ezsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
