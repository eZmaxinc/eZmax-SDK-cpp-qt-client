...
Ezsignfolder_createObject_v2_Request::Ezsignfolder_createObject_v2_Request(const QString &json) {
...
void Ezsignfolder_createObject_v2_Request::fromJson(const QString &jsonString) {
