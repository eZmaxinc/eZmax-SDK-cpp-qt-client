...
/*
 * OAIBranding_editObject_v1_Response.h
 *
 * Response for PUT /1/object/branding/{pkiBrandingID}
 */

#ifndef OAIBranding_editObject_v1_Response_H
#define OAIBranding_editObject_v1_Response_H
...
class OAIBranding_editObject_v1_Response : public OAIObject {
public:
    OAIBranding_editObject_v1_Response();
    OAIBranding_editObject_v1_Response(QString json);
    ~OAIBranding_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBranding_editObject_v1_Response)

#endif // OAIBranding_editObject_v1_Response_H
