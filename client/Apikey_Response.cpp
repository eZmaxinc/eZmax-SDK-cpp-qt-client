...
qint32 Apikey_Response::getFkiEzmaxpartnerproductstageId() const {
    return m_fki_ezmaxpartnerproductstage_id;
}
void Apikey_Response::setFkiEzmaxpartnerproductstageId(const qint32 &fki_ezmaxpartnerproductstage_id) {
    m_fki_ezmaxpartnerproductstage_id = fki_ezmaxpartnerproductstage_id;
    m_fki_ezmaxpartnerproductstage_id_isSet = true;
}

bool Apikey_Response::is_fki_ezmaxpartnerproductstage_id_Set() const{
    return m_fki_ezmaxpartnerproductstage_id_isSet;
}

bool Apikey_Response::is_fki_ezmaxpartnerproductstage_id_Valid() const{
