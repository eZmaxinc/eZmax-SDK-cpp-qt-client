...
/*
 * Cors_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/cors/{pkiCorsID}
 */

#ifndef Cors_deleteObject_v1_Response_H
#define Cors_deleteObject_v1_Response_H
...
class Cors_deleteObject_v1_Response : public Object {
public:
    Cors_deleteObject_v1_Response();
    Cors_deleteObject_v1_Response(const QString &json);
    ~Cors_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Cors_deleteObject_v1_Response)

#endif // Cors_deleteObject_v1_Response_H
