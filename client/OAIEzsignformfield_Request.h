...
/*
 * OAIEzsignformfield_Request.h
 *
 * A Ezsignformfield Object
 */

#ifndef OAIEzsignformfield_Request_H
#define OAIEzsignformfield_Request_H
...
class OAIEzsignformfield_Request : public OAIObject {
public:
    OAIEzsignformfield_Request();
    OAIEzsignformfield_Request(QString json);
    ~OAIEzsignformfield_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignformfield_Request)

#endif // OAIEzsignformfield_Request_H
