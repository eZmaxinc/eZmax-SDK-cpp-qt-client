...
_serverConfigs.insert("ezsignfolderGetObjectGetChildrenV1",defaultConf);
_serverIndices.insert("ezsignfolderGetObjectGetChildrenV1",0);
...
void OAIObjectEzsignfolderApi::ezsignfolderDeleteObjectV1(const qint32 &pki_ezsignfolder_id) {
    ...
    fullPath.replace(pki_ezsignfolder_idPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(pki_ezsignfolder_id)));
...
void OAIObjectEzsignfolderApi::ezsignfolderGetObjectGetChildrenV1(const qint32 &pki_ezsignfolder_id) {
    QString fullPath = QString(_serverConfigs["ezsignfolderGetObjectGetChildrenV1"][_serverIndices.value("ezsignfolderGetObjectGetChildrenV1")].URL()+"/1/object/ezsignfolder/{pkiEzsignfolderID}/getChildren");
    QString pki_ezsignfolder_idPathParam("{");
    pki_ezsignfolder_idPathParam.append("pkiEzsignfolderID").append("}");
    fullPath.replace(pki_ezsignfolder_idPathParam, QUrl::toPercentEncoding(::OpenAPI::toStringValue(pki_ezsignfolder_id)));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfolderApi::ezsignfolderGetObjectGetChildrenV1Callback);
    connect(this, &OAIObjectEzsignfolderApi::abortRequestsSignal, worker, &QObject::deleteLater); 
    worker->execute(&input);
}

void OAIObjectEzsignfolderApi::ezsignfolderGetObjectGetChildrenV1Callback(OAIHttpRequestWorker *worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit ezsignfolderGetObjectGetChildrenV1Signal();
        emit ezsignfolderGetObjectGetChildrenV1SignalFull(worker);
    } else {
        emit ezsignfolderGetObjectGetChildrenV1SignalE(error_type, error_str);
        emit ezsignfolderGetObjectGetChildrenV1SignalEFull(worker, error_type, error_str);
    }
}
