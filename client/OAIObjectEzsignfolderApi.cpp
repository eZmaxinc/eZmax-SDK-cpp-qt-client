...
void OAIObjectEzsignfolderApi::ezsignfolderGetEzsignfoldersignerassociationsmineV1(const qint32 &pki_ezsignfolder_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfolderApi::ezsignfolderGetEzsignfoldersignerassociationsmineV1Callback);
    connect(this, &OAIObjectEzsignfolderApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfolderApi::ezsignfolderGetEzsignfoldersignerassociationsmineV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfolder_getEzsignfoldersignerassociationsmine_v1_Response output(QString(worker->response));
    worker->deleteLater();
