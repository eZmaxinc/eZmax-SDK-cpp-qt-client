...
#ifndef OAISubnet_Request_H
#define OAISubnet_Request_H
...
class OAISubnet_Request : public OAIObject {
public:
    OAISubnet_Request();
    OAISubnet_Request(QString json);
    ~OAISubnet_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISubnet_Request)

#endif // OAISubnet_Request_H
