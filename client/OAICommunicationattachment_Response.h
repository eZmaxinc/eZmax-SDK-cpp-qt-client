...
/*
 * OAICommunicationattachment_Response.h
 *
 * A Communicationattachment Object
 */

#ifndef OAICommunicationattachment_Response_H
#define OAICommunicationattachment_Response_H
...
public:
    OAICommunicationattachment_Response();
    OAICommunicationattachment_Response(QString json);
    ~OAICommunicationattachment_Response() override;
