...
void Activesession_ResponseCompound_User::initializeModel() {
    ...
    m_b_user_addmeinezsignfolder_isSet = false;
    m_b_user_addmeinezsignfolder_isValid = false;
    ...
    m_i_user_frontendgoal_isSet = false;
...
void Activesession_ResponseCompound_User::fromJsonObject(QJsonObject json) {
    ...
    m_b_user_addmeinezsignfolder_isValid = ::Ezmaxapi::fromJsonValue(m_b_user_addmeinezsignfolder, json[QString("bUserAddmeinezsignfolder")]);
    m_b_user_addmeinezsignfolder_isSet = !json[QString("bUserAddmeinezsignfolder")].isNull() && m_b_user_addmeinezsignfolder_isValid;
    ...
    m_i_user_frontendgoal_isValid = ::Ezmaxapi::fromJsonValue(m_i_user_frontendgoal, json[QString("iUserFrontendgoal")]);
    m_i_user_frontendgoal_isSet = !json[QString("iUserFrontendgoal")].isNull() && m_i_user_frontendgoal_isValid;
}
...
QJsonObject Activesession_ResponseCompound_User::asJsonObject() const {
    ...
    if (m_b_user_addmeinezsignfolder_isSet) {
        obj.insert(QString("bUserAddmeinezsignfolder"), ::Ezmaxapi::toJsonValue(m_b_user_addmeinezsignfolder));
    }
    ...
    if (m_i_user_frontendgoal_isSet) {
        obj.insert(QString("iUserFrontendgoal"), ::Ezmaxapi::toJsonValue(m_i_user_frontendgoal));
    }
    return obj;
}
...
bool Activesession_ResponseCompound_User::isBUserAddmeinezsignfolder() const {
    return m_b_user_addmeinezsignfolder;
}
void Activesession_ResponseCompound_User::setBUserAddmeinezsignfolder(const bool &b_user_addmeinezsignfolder) {
    m_b_user_addmeinezsignfolder = b_user_addmeinezsignfolder;
    m_b_user_addmeinezsignfolder_isSet = true;
}

bool Activesession_ResponseCompound_User::is_b_user_addmeinezsignfolder_Set() const{
    return m_b_user_addmeinezsignfolder_isSet;
}

bool Activesession_ResponseCompound_User::is_b_user_addmeinezsignfolder_Valid() const{
    return m_b_user_addmeinezsignfolder_isValid;
}
...
qint32 Activesession_ResponseCompound_User::getIUserFrontendgoal() const {
    return m_i_user_frontendgoal;
}
void Activesession_ResponseCompound_User::setIUserFrontendgoal(const qint32 &i_user_frontendgoal) {
    m_i_user_frontendgoal = i_user_frontendgoal;
    m_i_user_frontendgoal_isSet = true;
}

bool Activesession_ResponseCompound_User::is_i_user_frontendgoal_Set() const{
    return m_i_user_frontendgoal_isSet;
}

bool Activesession_ResponseCompound_User::is_i_user_frontendgoal_Valid() const{
    return m_i_user_frontendgoal_isValid;
}
...
bool Activesession_ResponseCompound_User::isValid() const {
    ...
    return m_pki_user_id_isValid && m_fki_timezone_id_isValid && m_s_user_firstname_isValid && m_s_user_lastname_isValid && m_b_user_addmeinezsignfolder_isValid && m_e_user_ezsignsendreminderfrequency_isValid && m_i_user_interfacecolor_isValid && m_b_user_interfacedark_isValid && m_i_user_listresult_isValid && m_i_user_frontendgoal_isValid && true;
}
