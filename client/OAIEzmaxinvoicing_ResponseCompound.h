...
/*
 * OAIEzmaxinvoicing_ResponseCompound.h
 *
 * A Ezmaxinvoicing Object
 */

#ifndef OAIEzmaxinvoicing_ResponseCompound_H
#define OAIEzmaxinvoicing_ResponseCompound_H
...
class OAIEzmaxinvoicing_ResponseCompound : public OAIObject {
public:
    OAIEzmaxinvoicing_ResponseCompound();
    OAIEzmaxinvoicing_ResponseCompound(QString json);
    ~OAIEzmaxinvoicing_ResponseCompound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzmaxinvoicing_ResponseCompound)

#endif // OAIEzmaxinvoicing_ResponseCompound_H
