...
Branding_ResponseV3::Branding_ResponseV3(const QString &json) {
...
void Branding_ResponseV3::fromJson(const QString &jsonString) {
...
qint32 Branding_ResponseV3::getFkiDomainId() const {
    return m_fki_domain_id;
}
void Branding_ResponseV3::setFkiDomainId(const qint32 &fki_domain_id) {
    m_fki_domain_id = fki_domain_id;
    m_fki_domain_id_isSet = true;
}

bool Branding_ResponseV3::is_fki_domain_id_Set() const{
    return m_fki_domain_id_isSet;
}

bool Branding_ResponseV3::is_fki_domain_id_Valid() const{
    return m_fki_domain_id_isValid;
}

QString Branding_ResponseV3::getSDomainName() const {
    return m_s_domain_name;
}
void Branding_ResponseV3::setSDomainName(const QString &s_domain_name) {
    m_s_domain_name = s_domain_name;
    m_s_domain_name_isSet = true;
}

bool Branding_ResponseV3::is_s_domain_name_Set() const{
    return m_s_domain_name_isSet;
}

bool Branding_ResponseV3::is_s_domain_name_Valid() const{
