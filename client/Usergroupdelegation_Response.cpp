...
Usergroupdelegation_Response::Usergroupdelegation_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Usergroupdelegation_Response::Usergroupdelegation_Response() {
    this->initializeModel();
}

Usergroupdelegation_Response::~Usergroupdelegation_Response() {}

void Usergroupdelegation_Response::initializeModel() {
...
void Usergroupdelegation_Response::fromJson(const QString &jsonString) {
...
void Usergroupdelegation_Response::fromJsonObject(QJsonObject json) {
...
QString Usergroupdelegation_Response::asJson() const {
...
QJsonObject Usergroupdelegation_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Usergroupdelegation_Response::getPkiUsergroupdelegationId() const {
    return m_pki_usergroupdelegation_id;
}
void Usergroupdelegation_Response::setPkiUsergroupdelegationId(const qint32 &pki_usergroupdelegation_id) {
    m_pki_usergroupdelegation_id = pki_usergroupdelegation_id;
    m_pki_usergroupdelegation_id_isSet = true;
}

bool Usergroupdelegation_Response::is_pki_usergroupdelegation_id_Set() const{
    return m_pki_usergroupdelegation_id_isSet;
}

bool Usergroupdelegation_Response::is_pki_usergroupdelegation_id_Valid() const{
    return m_pki_usergroupdelegation_id_isValid;
}

qint32 Usergroupdelegation_Response::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Usergroupdelegation_Response::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Usergroupdelegation_Response::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Usergroupdelegation_Response::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

qint32 Usergroupdelegation_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Usergroupdelegation_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Usergroupdelegation_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Usergroupdelegation_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

QString Usergroupdelegation_Response::getSUserFirstname() const {
    return m_s_user_firstname;
}
void Usergroupdelegation_Response::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool Usergroupdelegation_Response::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool Usergroupdelegation_Response::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString Usergroupdelegation_Response::getSUserLastname() const {
    return m_s_user_lastname;
}
void Usergroupdelegation_Response::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool Usergroupdelegation_Response::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool Usergroupdelegation_Response::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString Usergroupdelegation_Response::getSUserLoginname() const {
    return m_s_user_loginname;
}
void Usergroupdelegation_Response::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool Usergroupdelegation_Response::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool Usergroupdelegation_Response::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString Usergroupdelegation_Response::getSEmailAddress() const {
    return m_s_email_address;
}
void Usergroupdelegation_Response::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Usergroupdelegation_Response::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Usergroupdelegation_Response::is_s_email_address_Valid() const{
...
void Usergroupdelegation_Response::setSUsergroupNameX(const QString &s_usergroup_name_x) {
    m_s_usergroup_name_x = s_usergroup_name_x;
    m_s_usergroup_name_x_isSet = true;
}

bool Usergroupdelegation_Response::is_s_usergroup_name_x_Set() const{
    return m_s_usergroup_name_x_isSet;
}

bool Usergroupdelegation_Response::is_s_usergroup_name_x_Valid() const{
    return m_s_usergroup_name_x_isValid;
}

bool Usergroupdelegation_Response::isSet() const {
