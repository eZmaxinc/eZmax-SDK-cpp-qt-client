...
/*
 * Webhook_sendWebhook_v1_Response.h
 *
 * Response for POST /1/object/webhook/sendWebhook
 */

#ifndef Webhook_sendWebhook_v1_Response_H
#define Webhook_sendWebhook_v1_Response_H
...
class Webhook_sendWebhook_v1_Response : public Object {
public:
    Webhook_sendWebhook_v1_Response();
    Webhook_sendWebhook_v1_Response(const QString &json);
    ~Webhook_sendWebhook_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_sendWebhook_v1_Response)

#endif // Webhook_sendWebhook_v1_Response_H
