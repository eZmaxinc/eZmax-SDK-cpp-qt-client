...
private:
    ...
    QList<OAIEzsigntemplatepackagesigner_RequestCompound> m_a_obj_ezsigntemplatepackagesigner;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request)
