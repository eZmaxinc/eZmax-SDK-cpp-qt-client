...
Common_Reportrow::Common_Reportrow(const QString &json) {
...
void Common_Reportrow::initializeModel() {
    ...
    m_obj_reportcellstyle_custom_isSet = false;
    m_obj_reportcellstyle_custom_isValid = false;
}

void Common_Reportrow::fromJson(const QString &jsonString) {
...
void Common_Reportrow::fromJsonObject(QJsonObject json) {
    ...
    m_obj_reportcellstyle_custom_isValid = ::Ezmaxapi::fromJsonValue(m_obj_reportcellstyle_custom, json[QString("objReportcellstyleCustom")]);
    m_obj_reportcellstyle_custom_isSet = !json[QString("objReportcellstyleCustom")].isNull() && m_obj_reportcellstyle_custom_isValid;
}
...
QJsonObject Common_Reportrow::asJsonObject() const {
    ...
    if (m_obj_reportcellstyle_custom.isSet()) {
        obj.insert(QString("objReportcellstyleCustom"), ::Ezmaxapi::toJsonValue(m_obj_reportcellstyle_custom));
    }
    return obj;
}
...
Common_Reportcellstylecustom Common_Reportrow::getObjReportcellstyleCustom() const {
    return m_obj_reportcellstyle_custom;
}
void Common_Reportrow::setObjReportcellstyleCustom(const Common_Reportcellstylecustom &obj_reportcellstyle_custom) {
    m_obj_reportcellstyle_custom = obj_reportcellstyle_custom;
    m_obj_reportcellstyle_custom_isSet = true;
}

bool Common_Reportrow::is_obj_reportcellstyle_custom_Set() const{
    return m_obj_reportcellstyle_custom_isSet;
}

bool Common_Reportrow::is_obj_reportcellstyle_custom_Valid() const{
    return m_obj_reportcellstyle_custom_isValid;
}
