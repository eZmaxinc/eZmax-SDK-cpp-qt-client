...
/*
 * OAIUser_createObject_v1_Response_mPayload.h
 *
 * Payload for POST /1/object/user
 */

#ifndef OAIUser_createObject_v1_Response_mPayload_H
#define OAIUser_createObject_v1_Response_mPayload_H
...
public:
    OAIUser_createObject_v1_Response_mPayload();
    OAIUser_createObject_v1_Response_mPayload(QString json);
    ~OAIUser_createObject_v1_Response_mPayload() override;
