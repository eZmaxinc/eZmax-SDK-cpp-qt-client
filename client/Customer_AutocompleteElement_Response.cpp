...
Customer_AutocompleteElement_Response::Customer_AutocompleteElement_Response(const QString &json) {
...
void Customer_AutocompleteElement_Response::fromJson(const QString &jsonString) {
