...
#ifndef Ezsignsignaturepaymentdetail_Request_H
#define Ezsignsignaturepaymentdetail_Request_H
...
class Ezsignsignaturepaymentdetail_Request : public Object {
public:
    Ezsignsignaturepaymentdetail_Request();
    Ezsignsignaturepaymentdetail_Request(const QString &json);
    ~Ezsignsignaturepaymentdetail_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturepaymentdetail_Request)

#endif // Ezsignsignaturepaymentdetail_Request_H
