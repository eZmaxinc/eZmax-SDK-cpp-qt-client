...
Ezsignsignature_Response::Ezsignsignature_Response(const QString &json) {
...
void Ezsignsignature_Response::fromJson(const QString &jsonString) {
...
qint32 Ezsignsignature_Response::getFkiFontId() const {
    return m_fki_font_id;
}
void Ezsignsignature_Response::setFkiFontId(const qint32 &fki_font_id) {
    m_fki_font_id = fki_font_id;
    m_fki_font_id_isSet = true;
}

bool Ezsignsignature_Response::is_fki_font_id_Set() const{
    return m_fki_font_id_isSet;
}

bool Ezsignsignature_Response::is_fki_font_id_Valid() const{
    return m_fki_font_id_isValid;
}

qint32 Ezsignsignature_Response::getFkiPaymentgatewayId() const {
    return m_fki_paymentgateway_id;
}
void Ezsignsignature_Response::setFkiPaymentgatewayId(const qint32 &fki_paymentgateway_id) {
    m_fki_paymentgateway_id = fki_paymentgateway_id;
    m_fki_paymentgateway_id_isSet = true;
}

bool Ezsignsignature_Response::is_fki_paymentgateway_id_Set() const{
    return m_fki_paymentgateway_id_isSet;
}

bool Ezsignsignature_Response::is_fki_paymentgateway_id_Valid() const{
    return m_fki_paymentgateway_id_isValid;
}

QString Ezsignsignature_Response::getSCurrencyDescriptionX() const {
    return m_s_currency_description_x;
}
void Ezsignsignature_Response::setSCurrencyDescriptionX(const QString &s_currency_description_x) {
    m_s_currency_description_x = s_currency_description_x;
    m_s_currency_description_x_isSet = true;
}

bool Ezsignsignature_Response::is_s_currency_description_x_Set() const{
    return m_s_currency_description_x_isSet;
}

bool Ezsignsignature_Response::is_s_currency_description_x_Valid() const{
    return m_s_currency_description_x_isValid;
}

QString Ezsignsignature_Response::getDEzsignsignatureCreditcardamount() const {
    return m_d_ezsignsignature_creditcardamount;
}
void Ezsignsignature_Response::setDEzsignsignatureCreditcardamount(const QString &d_ezsignsignature_creditcardamount) {
    m_d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount;
    m_d_ezsignsignature_creditcardamount_isSet = true;
}

bool Ezsignsignature_Response::is_d_ezsignsignature_creditcardamount_Set() const{
    return m_d_ezsignsignature_creditcardamount_isSet;
}

bool Ezsignsignature_Response::is_d_ezsignsignature_creditcardamount_Valid() const{
    return m_d_ezsignsignature_creditcardamount_isValid;
}

QString Ezsignsignature_Response::getSEzsignsignatureCreditcardamountdescription() const {
    return m_s_ezsignsignature_creditcardamountdescription;
}
void Ezsignsignature_Response::setSEzsignsignatureCreditcardamountdescription(const QString &s_ezsignsignature_creditcardamountdescription) {
...
bool Ezsignsignature_Response::is_s_ezsignsignature_creditcardamountdescription_Set() const{
    return m_s_ezsignsignature_creditcardamountdescription_isSet;
}

bool Ezsignsignature_Response::is_s_ezsignsignature_creditcardamountdescription_Valid() const{
    return m_s_ezsignsignature_creditcardamountdescription_isValid;
}

bool Ezsignsignature_Response::isBEzsignsignatureCreditcardcustomamount() const {
    return m_b_ezsignsignature_creditcardcustomamount;
}
void Ezsignsignature_Response::setBEzsignsignatureCreditcardcustomamount(const bool &b_ezsignsignature_creditcardcustomamount) {
...
bool Ezsignsignature_Response::is_b_ezsignsignature_creditcardcustomamount_Set() const{
    return m_b_ezsignsignature_creditcardcustomamount_isSet;
}

bool Ezsignsignature_Response::is_b_ezsignsignature_creditcardcustomamount_Valid() const{
...
Field_eEzsignsignatureSignaturepad Ezsignsignature_Response::getEEzsignsignatureSignaturepad() const {
    return m_e_ezsignsignature_signaturepad;
}
void Ezsignsignature_Response::setEEzsignsignatureSignaturepad(const Field_eEzsignsignatureSignaturepad &e_ezsignsignature_signaturepad) {
    m_e_ezsignsignature_signaturepad = e_ezsignsignature_signaturepad;
    m_e_ezsignsignature_signaturepad_isSet = true;
}

bool Ezsignsignature_Response::is_e_ezsignsignature_signaturepad_Set() const{
    return m_e_ezsignsignature_signaturepad_isSet;
}

bool Ezsignsignature_Response::is_e_ezsignsignature_signaturepad_Valid() const{
    return m_e_ezsignsignature_signaturepad_isValid;
}

Field_eEzsignsignatureSignaturepadrequired Ezsignsignature_Response::getEEzsignsignatureSignaturepadrequired() const {
    return m_e_ezsignsignature_signaturepadrequired;
}
void Ezsignsignature_Response::setEEzsignsignatureSignaturepadrequired(const Field_eEzsignsignatureSignaturepadrequired &e_ezsignsignature_signaturepadrequired) {
...
bool Ezsignsignature_Response::is_e_ezsignsignature_signaturepadrequired_Set() const{
    return m_e_ezsignsignature_signaturepadrequired_isSet;
}

bool Ezsignsignature_Response::is_e_ezsignsignature_signaturepadrequired_Valid() const{
...
Field_eEzsignsignatureConsultationtrigger Ezsignsignature_Response::getEEzsignsignatureConsultationtrigger() const {
    return m_e_ezsignsignature_consultationtrigger;
}
void Ezsignsignature_Response::setEEzsignsignatureConsultationtrigger(const Field_eEzsignsignatureConsultationtrigger &e_ezsignsignature_consultationtrigger) {
...
bool Ezsignsignature_Response::is_e_ezsignsignature_consultationtrigger_Set() const{
    return m_e_ezsignsignature_consultationtrigger_isSet;
}

bool Ezsignsignature_Response::is_e_ezsignsignature_consultationtrigger_Valid() const{
    return m_e_ezsignsignature_consultationtrigger_isValid;
}

bool Ezsignsignature_Response::isBEzsignsignatureHandwritten() const {
    return m_b_ezsignsignature_handwritten;
}
void Ezsignsignature_Response::setBEzsignsignatureHandwritten(const bool &b_ezsignsignature_handwritten) {
    m_b_ezsignsignature_handwritten = b_ezsignsignature_handwritten;
    m_b_ezsignsignature_handwritten_isSet = true;
}

bool Ezsignsignature_Response::is_b_ezsignsignature_handwritten_Set() const{
    return m_b_ezsignsignature_handwritten_isSet;
}

bool Ezsignsignature_Response::is_b_ezsignsignature_handwritten_Valid() const{
    return m_b_ezsignsignature_handwritten_isValid;
}

bool Ezsignsignature_Response::isBEzsignsignatureReason() const {
    return m_b_ezsignsignature_reason;
}
void Ezsignsignature_Response::setBEzsignsignatureReason(const bool &b_ezsignsignature_reason) {
    m_b_ezsignsignature_reason = b_ezsignsignature_reason;
    m_b_ezsignsignature_reason_isSet = true;
}

bool Ezsignsignature_Response::is_b_ezsignsignature_reason_Set() const{
    return m_b_ezsignsignature_reason_isSet;
}

bool Ezsignsignature_Response::is_b_ezsignsignature_reason_Valid() const{
...
QString Ezsignsignature_Response::getSEzsignsignatureTextvalidationcustommessage() const {
    return m_s_ezsignsignature_textvalidationcustommessage;
}
void Ezsignsignature_Response::setSEzsignsignatureTextvalidationcustommessage(const QString &s_ezsignsignature_textvalidationcustommessage) {
...
bool Ezsignsignature_Response::is_s_ezsignsignature_textvalidationcustommessage_Set() const{
    return m_s_ezsignsignature_textvalidationcustommessage_isSet;
}

bool Ezsignsignature_Response::is_s_ezsignsignature_textvalidationcustommessage_Valid() const{
...
QString Ezsignsignature_Response::getSEzsignsignatureDefaultvalue() const {
    return m_s_ezsignsignature_defaultvalue;
}
void Ezsignsignature_Response::setSEzsignsignatureDefaultvalue(const QString &s_ezsignsignature_defaultvalue) {
    m_s_ezsignsignature_defaultvalue = s_ezsignsignature_defaultvalue;
    m_s_ezsignsignature_defaultvalue_isSet = true;
}

bool Ezsignsignature_Response::is_s_ezsignsignature_defaultvalue_Set() const{
    return m_s_ezsignsignature_defaultvalue_isSet;
}

bool Ezsignsignature_Response::is_s_ezsignsignature_defaultvalue_Valid() const{
