...
/*
 * Ezsignfoldertype_RequestCompound.h
 *
 * A Ezsignfoldertype Object and children
 */

#ifndef Ezsignfoldertype_RequestCompound_H
#define Ezsignfoldertype_RequestCompound_H
...
class Ezsignfoldertype_RequestCompound : public Object {
public:
    Ezsignfoldertype_RequestCompound();
    Ezsignfoldertype_RequestCompound(QString json);
    ~Ezsignfoldertype_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_RequestCompound)

#endif // Ezsignfoldertype_RequestCompound_H
