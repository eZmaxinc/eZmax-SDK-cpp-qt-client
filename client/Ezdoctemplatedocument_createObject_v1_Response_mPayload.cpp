...
Ezdoctemplatedocument_createObject_v1_Response_mPayload::Ezdoctemplatedocument_createObject_v1_Response_mPayload(const QString &json) {
...
void Ezdoctemplatedocument_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
