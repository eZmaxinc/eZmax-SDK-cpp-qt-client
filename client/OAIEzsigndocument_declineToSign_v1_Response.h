...
/*
 * OAIEzsigndocument_declineToSign_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/declineToSign
 */

#ifndef OAIEzsigndocument_declineToSign_v1_Response_H
#define OAIEzsigndocument_declineToSign_v1_Response_H
...
class OAIEzsigndocument_declineToSign_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_declineToSign_v1_Response();
    OAIEzsigndocument_declineToSign_v1_Response(QString json);
    ~OAIEzsigndocument_declineToSign_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_declineToSign_v1_Response)

#endif // OAIEzsigndocument_declineToSign_v1_Response_H
