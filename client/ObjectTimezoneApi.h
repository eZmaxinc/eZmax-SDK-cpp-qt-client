...
#ifndef _ObjectTimezoneApi_H
#define _ObjectTimezoneApi_H
...
class ObjectTimezoneApi : public QObject {
    Q_OBJECT

public:
    ObjectTimezoneApi(const int timeOut = 0);
    ~ObjectTimezoneApi();
