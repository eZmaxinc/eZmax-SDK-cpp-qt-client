...
/*
 * Ezsignfoldertype_editObject_v3_Response.h
 *
 * Response for PUT /3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef Ezsignfoldertype_editObject_v3_Response_H
#define Ezsignfoldertype_editObject_v3_Response_H
...
class Ezsignfoldertype_editObject_v3_Response : public Object {
public:
    Ezsignfoldertype_editObject_v3_Response();
    Ezsignfoldertype_editObject_v3_Response(const QString &json);
    ~Ezsignfoldertype_editObject_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldertype_editObject_v3_Response)

#endif // Ezsignfoldertype_editObject_v3_Response_H
