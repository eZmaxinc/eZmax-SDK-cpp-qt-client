...
/*
 * Permission_editObject_v1_Response.h
 *
 * Response for PUT /1/object/permission/{pkiPermissionID}
 */

#ifndef Permission_editObject_v1_Response_H
#define Permission_editObject_v1_Response_H
...
class Permission_editObject_v1_Response : public Object {
public:
    Permission_editObject_v1_Response();
    Permission_editObject_v1_Response(const QString &json);
    ~Permission_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Permission_editObject_v1_Response)

#endif // Permission_editObject_v1_Response_H
