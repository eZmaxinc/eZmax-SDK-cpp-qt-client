...
#ifndef Ezsignfolder_unsend_v1_Response_H
#define Ezsignfolder_unsend_v1_Response_H
...
class Ezsignfolder_unsend_v1_Response : public Object {
public:
    Ezsignfolder_unsend_v1_Response();
    Ezsignfolder_unsend_v1_Response(const QString &json);
    ~Ezsignfolder_unsend_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_unsend_v1_Response)

#endif // Ezsignfolder_unsend_v1_Response_H
