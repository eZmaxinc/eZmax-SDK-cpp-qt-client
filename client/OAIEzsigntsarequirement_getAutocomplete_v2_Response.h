...
/*
 * OAIEzsigntsarequirement_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/ezsigntsarequirement/getAutocomplete
 */

#ifndef OAIEzsigntsarequirement_getAutocomplete_v2_Response_H
#define OAIEzsigntsarequirement_getAutocomplete_v2_Response_H
...
class OAIEzsigntsarequirement_getAutocomplete_v2_Response : public OAIObject {
public:
    OAIEzsigntsarequirement_getAutocomplete_v2_Response();
    OAIEzsigntsarequirement_getAutocomplete_v2_Response(QString json);
    ~OAIEzsigntsarequirement_getAutocomplete_v2_Response() override;
...
private:
    ...
    OAIEzsigntsarequirement_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntsarequirement_getAutocomplete_v2_Response)

#endif // OAIEzsigntsarequirement_getAutocomplete_v2_Response_H
