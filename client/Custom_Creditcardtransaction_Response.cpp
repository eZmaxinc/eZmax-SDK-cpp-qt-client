...
Custom_Creditcardtransaction_Response::Custom_Creditcardtransaction_Response(const QString &json) {
...
void Custom_Creditcardtransaction_Response::fromJson(const QString &jsonString) {
