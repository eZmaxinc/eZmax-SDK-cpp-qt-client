...
/*
 * Ezsigndiscussion_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigndiscussion/{pkiEzsigndiscussionID}
 */

#ifndef Ezsigndiscussion_deleteObject_v1_Response_H
#define Ezsigndiscussion_deleteObject_v1_Response_H
...
class Ezsigndiscussion_deleteObject_v1_Response : public Object {
public:
    Ezsigndiscussion_deleteObject_v1_Response();
    Ezsigndiscussion_deleteObject_v1_Response(const QString &json);
    ~Ezsigndiscussion_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndiscussion_deleteObject_v1_Response)

#endif // Ezsigndiscussion_deleteObject_v1_Response_H
