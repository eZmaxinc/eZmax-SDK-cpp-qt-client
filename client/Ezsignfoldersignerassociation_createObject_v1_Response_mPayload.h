...
#ifndef Ezsignfoldersignerassociation_createObject_v1_Response_mPayload_H
#define Ezsignfoldersignerassociation_createObject_v1_Response_mPayload_H
...
class Ezsignfoldersignerassociation_createObject_v1_Response_mPayload : public Object {
public:
    Ezsignfoldersignerassociation_createObject_v1_Response_mPayload();
    Ezsignfoldersignerassociation_createObject_v1_Response_mPayload(const QString &json);
    ~Ezsignfoldersignerassociation_createObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfoldersignerassociation_createObject_v1_Response_mPayload)

#endif // Ezsignfoldersignerassociation_createObject_v1_Response_mPayload_H
