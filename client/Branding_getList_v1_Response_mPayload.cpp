...
Branding_getList_v1_Response_mPayload::Branding_getList_v1_Response_mPayload(const QString &json) {
...
void Branding_getList_v1_Response_mPayload::fromJson(const QString &jsonString) {
