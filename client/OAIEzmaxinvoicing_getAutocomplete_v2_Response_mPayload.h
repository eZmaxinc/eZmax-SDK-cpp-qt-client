...
private:
    ...
    QList<OAIEzmaxinvoicing_AutocompleteElement_Response> m_a_obj_ezmaxinvoicing;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzmaxinvoicing_getAutocomplete_v2_Response_mPayload)
