...
void OAICustom_Creditcardtransaction_Response::initializeModel() {
    ...
    m_s_creditcardtype_codename_isSet = false;
    m_s_creditcardtype_codename_isValid = false;
...
void OAICustom_Creditcardtransaction_Response::fromJsonObject(QJsonObject json) {
    ...
    m_s_creditcardtype_codename_isValid = ::OpenAPI::fromJsonValue(s_creditcardtype_codename, json[QString("sCreditcardtypeCodename")]);
    m_s_creditcardtype_codename_isSet = !json[QString("sCreditcardtypeCodename")].isNull() && m_s_creditcardtype_codename_isValid;
...
QJsonObject OAICustom_Creditcardtransaction_Response::asJsonObject() const {
    QJsonObject obj;
    if (m_s_creditcardtype_codename_isSet) {
        obj.insert(QString("sCreditcardtypeCodename"), ::OpenAPI::toJsonValue(s_creditcardtype_codename));
    }
...
QString OAICustom_Creditcardtransaction_Response::getSCreditcardtypeCodename() const {
    return s_creditcardtype_codename;
}
void OAICustom_Creditcardtransaction_Response::setSCreditcardtypeCodename(const QString &s_creditcardtype_codename) {
    this->s_creditcardtype_codename = s_creditcardtype_codename;
    this->m_s_creditcardtype_codename_isSet = true;
}

bool OAICustom_Creditcardtransaction_Response::is_s_creditcardtype_codename_Set() const{
    return m_s_creditcardtype_codename_isSet;
}

bool OAICustom_Creditcardtransaction_Response::is_s_creditcardtype_codename_Valid() const{
    return m_s_creditcardtype_codename_isValid;
}
...
bool OAICustom_Creditcardtransaction_Response::isValid() const {
    ...
    return m_s_creditcardtype_codename_isValid && m_d_creditcardtransaction_amount_isValid && m_s_creditcardtransaction_partiallydecryptednumber_isValid && m_s_creditcardtransaction_referencenumber_isValid && true;
}
