...
Ezsignsigningreason_ResponseCompound::Ezsignsigningreason_ResponseCompound(const QString &json) {
...
void Ezsignsigningreason_ResponseCompound::fromJson(const QString &jsonString) {
