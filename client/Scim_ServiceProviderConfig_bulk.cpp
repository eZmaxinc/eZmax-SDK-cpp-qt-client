...
Scim_ServiceProviderConfig_bulk::Scim_ServiceProviderConfig_bulk(const QString &json) {
...
void Scim_ServiceProviderConfig_bulk::fromJson(const QString &jsonString) {
