...
Cors_getObject_v2_Response::Cors_getObject_v2_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Cors_getObject_v2_Response::Cors_getObject_v2_Response() {
    this->initializeModel();
}

Cors_getObject_v2_Response::~Cors_getObject_v2_Response() {}

void Cors_getObject_v2_Response::initializeModel() {
...
void Cors_getObject_v2_Response::fromJson(const QString &jsonString) {
...
void Cors_getObject_v2_Response::fromJsonObject(QJsonObject json) {
...
QString Cors_getObject_v2_Response::asJson() const {
...
QJsonObject Cors_getObject_v2_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload Cors_getObject_v2_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Cors_getObject_v2_Response::setObjDebugPayload(const Common_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Cors_getObject_v2_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Cors_getObject_v2_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Cors_getObject_v2_Response::getObjDebug() const {
    return m_obj_debug;
}
void Cors_getObject_v2_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Cors_getObject_v2_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Cors_getObject_v2_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

Cors_getObject_v2_Response_mPayload Cors_getObject_v2_Response::getMPayload() const {
    return m_m_payload;
}
void Cors_getObject_v2_Response::setMPayload(const Cors_getObject_v2_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Cors_getObject_v2_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Cors_getObject_v2_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Cors_getObject_v2_Response::isSet() const {
...
bool Cors_getObject_v2_Response::isValid() const {
