...
#ifndef Ezsignfolder_getObject_v1_Response_mPayload_H
#define Ezsignfolder_getObject_v1_Response_mPayload_H
...
class Ezsignfolder_getObject_v1_Response_mPayload : public Object {
public:
    Ezsignfolder_getObject_v1_Response_mPayload();
    Ezsignfolder_getObject_v1_Response_mPayload(const QString &json);
    ~Ezsignfolder_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_getObject_v1_Response_mPayload)

#endif // Ezsignfolder_getObject_v1_Response_mPayload_H
