...
Ezsignbulksendsignermapping_Response::Ezsignbulksendsignermapping_Response(const QString &json) {
...
void Ezsignbulksendsignermapping_Response::fromJson(const QString &jsonString) {
...
bool Ezsignbulksendsignermapping_Response::isBEzsignbulksendsignermappingReceivecopy() const {
    return m_b_ezsignbulksendsignermapping_receivecopy;
}
void Ezsignbulksendsignermapping_Response::setBEzsignbulksendsignermappingReceivecopy(const bool &b_ezsignbulksendsignermapping_receivecopy) {
...
bool Ezsignbulksendsignermapping_Response::is_b_ezsignbulksendsignermapping_receivecopy_Set() const{
    return m_b_ezsignbulksendsignermapping_receivecopy_isSet;
}

bool Ezsignbulksendsignermapping_Response::is_b_ezsignbulksendsignermapping_receivecopy_Valid() const{
