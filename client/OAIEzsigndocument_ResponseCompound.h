...
/*
 * OAIEzsigndocument_ResponseCompound.h
 *
 * An Ezsigndocument Object and children to create a complete structure
 */

#ifndef OAIEzsigndocument_ResponseCompound_H
#define OAIEzsigndocument_ResponseCompound_H
...
class OAIEzsigndocument_ResponseCompound : public OAIObject {
public:
    OAIEzsigndocument_ResponseCompound();
    OAIEzsigndocument_ResponseCompound(QString json);
    ~OAIEzsigndocument_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_ResponseCompound)

#endif // OAIEzsigndocument_ResponseCompound_H
