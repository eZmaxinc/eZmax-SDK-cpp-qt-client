...
qint32 OAIEmail_Request::getPkiEmailId() const {
    return m_pki_email_id;
}
void OAIEmail_Request::setPkiEmailId(const qint32 &pki_email_id) {
    m_pki_email_id = pki_email_id;
    m_pki_email_id_isSet = true;
}

bool OAIEmail_Request::is_pki_email_id_Set() const{
    return m_pki_email_id_isSet;
}

bool OAIEmail_Request::is_pki_email_id_Valid() const{
