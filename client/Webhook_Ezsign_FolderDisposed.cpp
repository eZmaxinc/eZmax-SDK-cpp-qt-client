...
#include "Webhook_Ezsign_FolderDisposed.h"
...
Webhook_Ezsign_FolderDisposed::Webhook_Ezsign_FolderDisposed(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Webhook_Ezsign_FolderDisposed::Webhook_Ezsign_FolderDisposed() {
    this->initializeModel();
}

Webhook_Ezsign_FolderDisposed::~Webhook_Ezsign_FolderDisposed() {}

void Webhook_Ezsign_FolderDisposed::initializeModel() {
...
void Webhook_Ezsign_FolderDisposed::fromJson(const QString &jsonString) {
...
void Webhook_Ezsign_FolderDisposed::fromJsonObject(QJsonObject json) {
...
QString Webhook_Ezsign_FolderDisposed::asJson() const {
...
QJsonObject Webhook_Ezsign_FolderDisposed::asJsonObject() const {
    QJsonObject obj;
...
Custom_Webhook_Response Webhook_Ezsign_FolderDisposed::getObjWebhook() const {
    return m_obj_webhook;
}
void Webhook_Ezsign_FolderDisposed::setObjWebhook(const Custom_Webhook_Response &obj_webhook) {
    m_obj_webhook = obj_webhook;
    m_obj_webhook_isSet = true;
}

bool Webhook_Ezsign_FolderDisposed::is_obj_webhook_Set() const{
    return m_obj_webhook_isSet;
}

bool Webhook_Ezsign_FolderDisposed::is_obj_webhook_Valid() const{
    return m_obj_webhook_isValid;
}

QList<Attempt_ResponseCompound> Webhook_Ezsign_FolderDisposed::getAObjAttempt() const {
    return m_a_obj_attempt;
}
void Webhook_Ezsign_FolderDisposed::setAObjAttempt(const QList<Attempt_ResponseCompound> &a_obj_attempt) {
    m_a_obj_attempt = a_obj_attempt;
    m_a_obj_attempt_isSet = true;
}

bool Webhook_Ezsign_FolderDisposed::is_a_obj_attempt_Set() const{
    return m_a_obj_attempt_isSet;
}

bool Webhook_Ezsign_FolderDisposed::is_a_obj_attempt_Valid() const{
    return m_a_obj_attempt_isValid;
}

Ezsignfolder_Response Webhook_Ezsign_FolderDisposed::getObjEzsignfolder() const {
    return m_obj_ezsignfolder;
}
void Webhook_Ezsign_FolderDisposed::setObjEzsignfolder(const Ezsignfolder_Response &obj_ezsignfolder) {
    m_obj_ezsignfolder = obj_ezsignfolder;
    m_obj_ezsignfolder_isSet = true;
}

bool Webhook_Ezsign_FolderDisposed::is_obj_ezsignfolder_Set() const{
    return m_obj_ezsignfolder_isSet;
}

bool Webhook_Ezsign_FolderDisposed::is_obj_ezsignfolder_Valid() const{
    return m_obj_ezsignfolder_isValid;
}

bool Webhook_Ezsign_FolderDisposed::isSet() const {
...
bool Webhook_Ezsign_FolderDisposed::isValid() const {
