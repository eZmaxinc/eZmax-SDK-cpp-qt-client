...
OAIEzsignformfieldgroupsigner_ResponseCompound OAIEzsignformfieldgroup_getObject_v1_Response_mPayload::getAObjEzsignformfieldgroupsigner() const {
    return a_obj_ezsignformfieldgroupsigner;
}
void OAIEzsignformfieldgroup_getObject_v1_Response_mPayload::setAObjEzsignformfieldgroupsigner(const OAIEzsignformfieldgroupsigner_ResponseCompound &a_obj_ezsignformfieldgroupsigner) {
