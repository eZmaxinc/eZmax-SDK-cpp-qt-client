...
#ifndef Ezsigntemplateelementdependency_Response_H
#define Ezsigntemplateelementdependency_Response_H
...
class Ezsigntemplateelementdependency_Response : public Object {
public:
    Ezsigntemplateelementdependency_Response();
    Ezsigntemplateelementdependency_Response(const QString &json);
    ~Ezsigntemplateelementdependency_Response() override;
    ...
    qint32 getFkiEzsigntemplateformfieldId() const;
    void setFkiEzsigntemplateformfieldId(const qint32 &fki_ezsigntemplateformfield_id);
    bool is_fki_ezsigntemplateformfield_id_Set() const;
    bool is_fki_ezsigntemplateformfield_id_Valid() const;

    qint32 getFkiEzsigntemplatesignatureId() const;
    void setFkiEzsigntemplatesignatureId(const qint32 &fki_ezsigntemplatesignature_id);
    bool is_fki_ezsigntemplatesignature_id_Set() const;
    bool is_fki_ezsigntemplatesignature_id_Valid() const;
...
private:
    ...
    qint32 m_fki_ezsigntemplateformfield_id;
    bool m_fki_ezsigntemplateformfield_id_isSet;
    bool m_fki_ezsigntemplateformfield_id_isValid;

    qint32 m_fki_ezsigntemplatesignature_id;
    bool m_fki_ezsigntemplatesignature_id_isSet;
    bool m_fki_ezsigntemplatesignature_id_isValid;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateelementdependency_Response)

#endif // Ezsigntemplateelementdependency_Response_H
