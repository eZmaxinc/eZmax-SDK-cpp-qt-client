...
/*
 * Clonehistory_getList_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/clonehistory/getList
 */

#ifndef Clonehistory_getList_v1_Response_mPayload_H
#define Clonehistory_getList_v1_Response_mPayload_H
...
namespace Ezmaxapi {
class Clonehistory_ListElement;
...
public:
    ...
    QList<Clonehistory_ListElement> getAObjClonehistory() const;
    void setAObjClonehistory(const QList<Clonehistory_ListElement> &a_obj_clonehistory);
...
private:
    ...
    QList<Clonehistory_ListElement> m_a_obj_clonehistory;
...
Q_DECLARE_METATYPE(Ezmaxapi::Clonehistory_getList_v1_Response_mPayload)

#endif // Clonehistory_getList_v1_Response_mPayload_H
