...
Webhook_Userstaged_UserstagedCreated::Webhook_Userstaged_UserstagedCreated(const QString &json) {
...
void Webhook_Userstaged_UserstagedCreated::fromJson(const QString &jsonString) {
