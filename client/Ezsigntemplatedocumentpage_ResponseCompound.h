...
/*
 * Ezsigntemplatedocumentpage_ResponseCompound.h
 *
 * An Ezsigntemplatedocumentpage Object and children to create a complete structure
 */

#ifndef Ezsigntemplatedocumentpage_ResponseCompound_H
#define Ezsigntemplatedocumentpage_ResponseCompound_H
...
class Ezsigntemplatedocumentpage_ResponseCompound : public Object {
public:
    Ezsigntemplatedocumentpage_ResponseCompound();
    Ezsigntemplatedocumentpage_ResponseCompound(const QString &json);
    ~Ezsigntemplatedocumentpage_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatedocumentpage_ResponseCompound)

#endif // Ezsigntemplatedocumentpage_ResponseCompound_H
