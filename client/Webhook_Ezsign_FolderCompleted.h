...
#ifndef Webhook_Ezsign_FolderCompleted_H
#define Webhook_Ezsign_FolderCompleted_H
...
class Webhook_Ezsign_FolderCompleted : public Object {
public:
    Webhook_Ezsign_FolderCompleted();
    Webhook_Ezsign_FolderCompleted(const QString &json);
    ~Webhook_Ezsign_FolderCompleted() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_Ezsign_FolderCompleted)

#endif // Webhook_Ezsign_FolderCompleted_H
