...
/*
 * Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload.h
 *
 * Response for GET /1/object/inscriptiontemp/{pkiInscriptiontempID}/getCommunicationrecipients
 */

#ifndef Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload_H
#define Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload_H
...
class Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload : public Object {
public:
    Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload();
    Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload(const QString &json);
    ~Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload)

#endif // Inscriptiontemp_getCommunicationrecipients_v1_Response_mPayload_H
