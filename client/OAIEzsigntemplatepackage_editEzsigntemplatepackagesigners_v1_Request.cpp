...
OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request() {
    this->initializeModel();
}

OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::~OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request() {}

void OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::initializeModel() {

    m_a_obj_ezsigntemplatepackagesigner_isSet = false;
    m_a_obj_ezsigntemplatepackagesigner_isValid = false;
}

void OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::fromJson(QString jsonString) {
...
QString OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::asJson() const {
...
bool OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::is_a_obj_ezsigntemplatepackagesigner_Valid() const{
...
bool OAIEzsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request::isValid() const {
