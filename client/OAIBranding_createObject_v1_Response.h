...
/*
 * OAIBranding_createObject_v1_Response.h
 *
 * Response for POST /1/object/branding
 */

#ifndef OAIBranding_createObject_v1_Response_H
#define OAIBranding_createObject_v1_Response_H
...
class OAIBranding_createObject_v1_Response : public OAIObject {
public:
    OAIBranding_createObject_v1_Response();
    OAIBranding_createObject_v1_Response(QString json);
    ~OAIBranding_createObject_v1_Response() override;
...
private:
    ...
    OAIBranding_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBranding_createObject_v1_Response)

#endif // OAIBranding_createObject_v1_Response_H
