...
/*
 * OAIVariableexpense_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/variableexpense/{pkiVariableexpenseID}
 */

#ifndef OAIVariableexpense_deleteObject_v1_Response_H
#define OAIVariableexpense_deleteObject_v1_Response_H
...
class OAIVariableexpense_deleteObject_v1_Response : public OAIObject {
public:
    OAIVariableexpense_deleteObject_v1_Response();
    OAIVariableexpense_deleteObject_v1_Response(QString json);
    ~OAIVariableexpense_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariableexpense_deleteObject_v1_Response)

#endif // OAIVariableexpense_deleteObject_v1_Response_H
