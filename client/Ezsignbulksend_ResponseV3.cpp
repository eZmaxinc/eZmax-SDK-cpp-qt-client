...
#include "Ezsignbulksend_ResponseV3.h"
...
Ezsignbulksend_ResponseV3::Ezsignbulksend_ResponseV3(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignbulksend_ResponseV3::Ezsignbulksend_ResponseV3() {
    this->initializeModel();
}

Ezsignbulksend_ResponseV3::~Ezsignbulksend_ResponseV3() {}

void Ezsignbulksend_ResponseV3::initializeModel() {
...
void Ezsignbulksend_ResponseV3::fromJson(const QString &jsonString) {
...
void Ezsignbulksend_ResponseV3::fromJsonObject(QJsonObject json) {
...
QString Ezsignbulksend_ResponseV3::asJson() const {
...
QJsonObject Ezsignbulksend_ResponseV3::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignbulksend_ResponseV3::getPkiEzsignbulksendId() const {
    return m_pki_ezsignbulksend_id;
}
void Ezsignbulksend_ResponseV3::setPkiEzsignbulksendId(const qint32 &pki_ezsignbulksend_id) {
    m_pki_ezsignbulksend_id = pki_ezsignbulksend_id;
    m_pki_ezsignbulksend_id_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_pki_ezsignbulksend_id_Set() const{
    return m_pki_ezsignbulksend_id_isSet;
}

bool Ezsignbulksend_ResponseV3::is_pki_ezsignbulksend_id_Valid() const{
    return m_pki_ezsignbulksend_id_isValid;
}

qint32 Ezsignbulksend_ResponseV3::getFkiEzsignfoldertypeId() const {
    return m_fki_ezsignfoldertype_id;
}
void Ezsignbulksend_ResponseV3::setFkiEzsignfoldertypeId(const qint32 &fki_ezsignfoldertype_id) {
    m_fki_ezsignfoldertype_id = fki_ezsignfoldertype_id;
    m_fki_ezsignfoldertype_id_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_fki_ezsignfoldertype_id_Set() const{
    return m_fki_ezsignfoldertype_id_isSet;
}

bool Ezsignbulksend_ResponseV3::is_fki_ezsignfoldertype_id_Valid() const{
    return m_fki_ezsignfoldertype_id_isValid;
}

qint32 Ezsignbulksend_ResponseV3::getFkiLanguageId() const {
    return m_fki_language_id;
}
void Ezsignbulksend_ResponseV3::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool Ezsignbulksend_ResponseV3::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

QString Ezsignbulksend_ResponseV3::getSLanguageNameX() const {
    return m_s_language_name_x;
}
void Ezsignbulksend_ResponseV3::setSLanguageNameX(const QString &s_language_name_x) {
    m_s_language_name_x = s_language_name_x;
    m_s_language_name_x_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_s_language_name_x_Set() const{
    return m_s_language_name_x_isSet;
}

bool Ezsignbulksend_ResponseV3::is_s_language_name_x_Valid() const{
    return m_s_language_name_x_isValid;
}

Field_eEzsignbulksendEzsignformfieldorder Ezsignbulksend_ResponseV3::getEEzsignbulksendEzsignformfieldorder() const {
    return m_e_ezsignbulksend_ezsignformfieldorder;
}
void Ezsignbulksend_ResponseV3::setEEzsignbulksendEzsignformfieldorder(const Field_eEzsignbulksendEzsignformfieldorder &e_ezsignbulksend_ezsignformfieldorder) {
...
bool Ezsignbulksend_ResponseV3::is_e_ezsignbulksend_ezsignformfieldorder_Set() const{
    return m_e_ezsignbulksend_ezsignformfieldorder_isSet;
}

bool Ezsignbulksend_ResponseV3::is_e_ezsignbulksend_ezsignformfieldorder_Valid() const{
    return m_e_ezsignbulksend_ezsignformfieldorder_isValid;
}

Field_eEzsignfoldertypePrivacylevel Ezsignbulksend_ResponseV3::getEEzsignfoldertypePrivacylevel() const {
    return m_e_ezsignfoldertype_privacylevel;
}
void Ezsignbulksend_ResponseV3::setEEzsignfoldertypePrivacylevel(const Field_eEzsignfoldertypePrivacylevel &e_ezsignfoldertype_privacylevel) {
    m_e_ezsignfoldertype_privacylevel = e_ezsignfoldertype_privacylevel;
    m_e_ezsignfoldertype_privacylevel_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_e_ezsignfoldertype_privacylevel_Set() const{
    return m_e_ezsignfoldertype_privacylevel_isSet;
}

bool Ezsignbulksend_ResponseV3::is_e_ezsignfoldertype_privacylevel_Valid() const{
    return m_e_ezsignfoldertype_privacylevel_isValid;
}

QString Ezsignbulksend_ResponseV3::getSEzsignfoldertypeNameX() const {
    return m_s_ezsignfoldertype_name_x;
}
void Ezsignbulksend_ResponseV3::setSEzsignfoldertypeNameX(const QString &s_ezsignfoldertype_name_x) {
    m_s_ezsignfoldertype_name_x = s_ezsignfoldertype_name_x;
    m_s_ezsignfoldertype_name_x_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_s_ezsignfoldertype_name_x_Set() const{
    return m_s_ezsignfoldertype_name_x_isSet;
}

bool Ezsignbulksend_ResponseV3::is_s_ezsignfoldertype_name_x_Valid() const{
    return m_s_ezsignfoldertype_name_x_isValid;
}

QString Ezsignbulksend_ResponseV3::getSEzsignbulksendDescription() const {
    return m_s_ezsignbulksend_description;
}
void Ezsignbulksend_ResponseV3::setSEzsignbulksendDescription(const QString &s_ezsignbulksend_description) {
    m_s_ezsignbulksend_description = s_ezsignbulksend_description;
    m_s_ezsignbulksend_description_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_s_ezsignbulksend_description_Set() const{
    return m_s_ezsignbulksend_description_isSet;
}

bool Ezsignbulksend_ResponseV3::is_s_ezsignbulksend_description_Valid() const{
    return m_s_ezsignbulksend_description_isValid;
}

QString Ezsignbulksend_ResponseV3::getTEzsignbulksendNote() const {
    return m_t_ezsignbulksend_note;
}
void Ezsignbulksend_ResponseV3::setTEzsignbulksendNote(const QString &t_ezsignbulksend_note) {
    m_t_ezsignbulksend_note = t_ezsignbulksend_note;
    m_t_ezsignbulksend_note_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_t_ezsignbulksend_note_Set() const{
    return m_t_ezsignbulksend_note_isSet;
}

bool Ezsignbulksend_ResponseV3::is_t_ezsignbulksend_note_Valid() const{
    return m_t_ezsignbulksend_note_isValid;
}

bool Ezsignbulksend_ResponseV3::isBEzsignbulksendNeedvalidation() const {
    return m_b_ezsignbulksend_needvalidation;
}
void Ezsignbulksend_ResponseV3::setBEzsignbulksendNeedvalidation(const bool &b_ezsignbulksend_needvalidation) {
    m_b_ezsignbulksend_needvalidation = b_ezsignbulksend_needvalidation;
    m_b_ezsignbulksend_needvalidation_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_b_ezsignbulksend_needvalidation_Set() const{
    return m_b_ezsignbulksend_needvalidation_isSet;
}

bool Ezsignbulksend_ResponseV3::is_b_ezsignbulksend_needvalidation_Valid() const{
    return m_b_ezsignbulksend_needvalidation_isValid;
}

bool Ezsignbulksend_ResponseV3::isBEzsignbulksendIsactive() const {
    return m_b_ezsignbulksend_isactive;
}
void Ezsignbulksend_ResponseV3::setBEzsignbulksendIsactive(const bool &b_ezsignbulksend_isactive) {
    m_b_ezsignbulksend_isactive = b_ezsignbulksend_isactive;
    m_b_ezsignbulksend_isactive_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_b_ezsignbulksend_isactive_Set() const{
    return m_b_ezsignbulksend_isactive_isSet;
}

bool Ezsignbulksend_ResponseV3::is_b_ezsignbulksend_isactive_Valid() const{
    return m_b_ezsignbulksend_isactive_isValid;
}

Common_Audit Ezsignbulksend_ResponseV3::getObjAudit() const {
    return m_obj_audit;
}
void Ezsignbulksend_ResponseV3::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Ezsignbulksend_ResponseV3::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Ezsignbulksend_ResponseV3::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Ezsignbulksend_ResponseV3::isSet() const {
...
bool Ezsignbulksend_ResponseV3::isValid() const {
