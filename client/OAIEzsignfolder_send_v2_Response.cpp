...
OAIEzsignfolder_send_v2_Response::OAIEzsignfolder_send_v2_Response() {
    this->initializeModel();
}

OAIEzsignfolder_send_v2_Response::~OAIEzsignfolder_send_v2_Response() {}

void OAIEzsignfolder_send_v2_Response::initializeModel() {
...
void OAIEzsignfolder_send_v2_Response::fromJson(QString jsonString) {
...
QString OAIEzsignfolder_send_v2_Response::asJson() const {
...
OAICommon_Response_objDebugPayload OAIEzsignfolder_send_v2_Response::getObjDebugPayload() const {
    return obj_debug_payload;
}
void OAIEzsignfolder_send_v2_Response::setObjDebugPayload(const OAICommon_Response_objDebugPayload &obj_debug_payload) {
    this->obj_debug_payload = obj_debug_payload;
    this->m_obj_debug_payload_isSet = true;
}

bool OAIEzsignfolder_send_v2_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool OAIEzsignfolder_send_v2_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

OAICommon_Response_objDebug OAIEzsignfolder_send_v2_Response::getObjDebug() const {
    return obj_debug;
}
void OAIEzsignfolder_send_v2_Response::setObjDebug(const OAICommon_Response_objDebug &obj_debug) {
    this->obj_debug = obj_debug;
    this->m_obj_debug_isSet = true;
}

bool OAIEzsignfolder_send_v2_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool OAIEzsignfolder_send_v2_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

bool OAIEzsignfolder_send_v2_Response::isSet() const {
...
bool OAIEzsignfolder_send_v2_Response::isValid() const {
