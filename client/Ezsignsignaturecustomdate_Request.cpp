...
Ezsignsignaturecustomdate_Request::Ezsignsignaturecustomdate_Request(const QString &json) {
...
void Ezsignsignaturecustomdate_Request::fromJson(const QString &jsonString) {
