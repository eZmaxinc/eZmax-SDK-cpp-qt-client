...
Ezsignsignature_sign_v1_Response::Ezsignsignature_sign_v1_Response(const QString &json) {
...
void Ezsignsignature_sign_v1_Response::fromJson(const QString &jsonString) {
