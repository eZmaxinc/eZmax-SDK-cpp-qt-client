...
void ObjectEzsignbulksendtransmissionApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ezsignbulksendtransmissionGetBatchFileV1", defaultConf);
    _serverIndices.insert("ezsignbulksendtransmissionGetBatchFileV1", 0);
...
void ObjectEzsignbulksendtransmissionApi::ezsignbulksendtransmissionGetBatchFileV1(const qint32 &pki_ezsignbulksendtransmission_id, const ::Ezmaxapi::OptionalParam<bool> &b_include_signed, const ::Ezmaxapi::OptionalParam<bool> &b_include_attachment, const ::Ezmaxapi::OptionalParam<bool> &b_include_proofdocument, const ::Ezmaxapi::OptionalParam<bool> &b_include_proof) {
    QString fullPath = QString(_serverConfigs["ezsignbulksendtransmissionGetBatchFileV1"][_serverIndices.value("ezsignbulksendtransmissionGetBatchFileV1")].URL()+"/1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getBatchFile");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignbulksendtransmissionApi::ezsignbulksendtransmissionGetBatchFileV1Callback);
...
void ObjectEzsignbulksendtransmissionApi::ezsignbulksendtransmissionGetBatchFileV1Callback(HttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1Signal(output);
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1SignalE(output, error_type, error_str);
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1SignalError(output, error_type, error_str);
        Q_EMIT ezsignbulksendtransmissionGetBatchFileV1SignalErrorFull(worker, error_type, error_str);
    }
}
