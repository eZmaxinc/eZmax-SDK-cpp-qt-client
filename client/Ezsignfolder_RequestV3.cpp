...
Ezsignfolder_RequestV3::Ezsignfolder_RequestV3(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignfolder_RequestV3::Ezsignfolder_RequestV3() {
    this->initializeModel();
}

Ezsignfolder_RequestV3::~Ezsignfolder_RequestV3() {}

void Ezsignfolder_RequestV3::initializeModel() {
...
void Ezsignfolder_RequestV3::fromJson(const QString &jsonString) {
...
void Ezsignfolder_RequestV3::fromJsonObject(QJsonObject json) {
...
QString Ezsignfolder_RequestV3::asJson() const {
...
QJsonObject Ezsignfolder_RequestV3::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignfolder_RequestV3::getPkiEzsignfolderId() const {
    return m_pki_ezsignfolder_id;
}
void Ezsignfolder_RequestV3::setPkiEzsignfolderId(const qint32 &pki_ezsignfolder_id) {
    m_pki_ezsignfolder_id = pki_ezsignfolder_id;
    m_pki_ezsignfolder_id_isSet = true;
}

bool Ezsignfolder_RequestV3::is_pki_ezsignfolder_id_Set() const{
    return m_pki_ezsignfolder_id_isSet;
}

bool Ezsignfolder_RequestV3::is_pki_ezsignfolder_id_Valid() const{
    return m_pki_ezsignfolder_id_isValid;
}

qint32 Ezsignfolder_RequestV3::getFkiEzsignfoldertypeId() const {
    return m_fki_ezsignfoldertype_id;
}
void Ezsignfolder_RequestV3::setFkiEzsignfoldertypeId(const qint32 &fki_ezsignfoldertype_id) {
    m_fki_ezsignfoldertype_id = fki_ezsignfoldertype_id;
    m_fki_ezsignfoldertype_id_isSet = true;
}

bool Ezsignfolder_RequestV3::is_fki_ezsignfoldertype_id_Set() const{
    return m_fki_ezsignfoldertype_id_isSet;
}

bool Ezsignfolder_RequestV3::is_fki_ezsignfoldertype_id_Valid() const{
    return m_fki_ezsignfoldertype_id_isValid;
}

qint32 Ezsignfolder_RequestV3::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void Ezsignfolder_RequestV3::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool Ezsignfolder_RequestV3::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool Ezsignfolder_RequestV3::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

qint32 Ezsignfolder_RequestV3::getFkiEzsigntsarequirementId() const {
    return m_fki_ezsigntsarequirement_id;
}
void Ezsignfolder_RequestV3::setFkiEzsigntsarequirementId(const qint32 &fki_ezsigntsarequirement_id) {
    m_fki_ezsigntsarequirement_id = fki_ezsigntsarequirement_id;
    m_fki_ezsigntsarequirement_id_isSet = true;
}

bool Ezsignfolder_RequestV3::is_fki_ezsigntsarequirement_id_Set() const{
    return m_fki_ezsigntsarequirement_id_isSet;
}

bool Ezsignfolder_RequestV3::is_fki_ezsigntsarequirement_id_Valid() const{
    return m_fki_ezsigntsarequirement_id_isValid;
}

Field_eEzsignfolderDocumentdependency Ezsignfolder_RequestV3::getEEzsignfolderDocumentdependency() const {
    return m_e_ezsignfolder_documentdependency;
}
void Ezsignfolder_RequestV3::setEEzsignfolderDocumentdependency(const Field_eEzsignfolderDocumentdependency &e_ezsignfolder_documentdependency) {
    m_e_ezsignfolder_documentdependency = e_ezsignfolder_documentdependency;
    m_e_ezsignfolder_documentdependency_isSet = true;
}

bool Ezsignfolder_RequestV3::is_e_ezsignfolder_documentdependency_Set() const{
    return m_e_ezsignfolder_documentdependency_isSet;
}

bool Ezsignfolder_RequestV3::is_e_ezsignfolder_documentdependency_Valid() const{
    return m_e_ezsignfolder_documentdependency_isValid;
}

QString Ezsignfolder_RequestV3::getSEzsignfolderDescription() const {
    return m_s_ezsignfolder_description;
}
void Ezsignfolder_RequestV3::setSEzsignfolderDescription(const QString &s_ezsignfolder_description) {
    m_s_ezsignfolder_description = s_ezsignfolder_description;
    m_s_ezsignfolder_description_isSet = true;
}

bool Ezsignfolder_RequestV3::is_s_ezsignfolder_description_Set() const{
    return m_s_ezsignfolder_description_isSet;
}

bool Ezsignfolder_RequestV3::is_s_ezsignfolder_description_Valid() const{
    return m_s_ezsignfolder_description_isValid;
}

QString Ezsignfolder_RequestV3::getTEzsignfolderNote() const {
    return m_t_ezsignfolder_note;
}
void Ezsignfolder_RequestV3::setTEzsignfolderNote(const QString &t_ezsignfolder_note) {
    m_t_ezsignfolder_note = t_ezsignfolder_note;
    m_t_ezsignfolder_note_isSet = true;
}

bool Ezsignfolder_RequestV3::is_t_ezsignfolder_note_Set() const{
    return m_t_ezsignfolder_note_isSet;
}

bool Ezsignfolder_RequestV3::is_t_ezsignfolder_note_Valid() const{
    return m_t_ezsignfolder_note_isValid;
}

QString Ezsignfolder_RequestV3::getTEzsignfolderMessage() const {
    return m_t_ezsignfolder_message;
}
void Ezsignfolder_RequestV3::setTEzsignfolderMessage(const QString &t_ezsignfolder_message) {
    m_t_ezsignfolder_message = t_ezsignfolder_message;
    m_t_ezsignfolder_message_isSet = true;
}

bool Ezsignfolder_RequestV3::is_t_ezsignfolder_message_Set() const{
    return m_t_ezsignfolder_message_isSet;
}

bool Ezsignfolder_RequestV3::is_t_ezsignfolder_message_Valid() const{
    return m_t_ezsignfolder_message_isValid;
}

qint32 Ezsignfolder_RequestV3::getIEzsignfolderSendreminderfirstdays() const {
    return m_i_ezsignfolder_sendreminderfirstdays;
}
void Ezsignfolder_RequestV3::setIEzsignfolderSendreminderfirstdays(const qint32 &i_ezsignfolder_sendreminderfirstdays) {
...
bool Ezsignfolder_RequestV3::is_i_ezsignfolder_sendreminderfirstdays_Set() const{
    return m_i_ezsignfolder_sendreminderfirstdays_isSet;
}

bool Ezsignfolder_RequestV3::is_i_ezsignfolder_sendreminderfirstdays_Valid() const{
    return m_i_ezsignfolder_sendreminderfirstdays_isValid;
}

qint32 Ezsignfolder_RequestV3::getIEzsignfolderSendreminderotherdays() const {
    return m_i_ezsignfolder_sendreminderotherdays;
}
void Ezsignfolder_RequestV3::setIEzsignfolderSendreminderotherdays(const qint32 &i_ezsignfolder_sendreminderotherdays) {
...
bool Ezsignfolder_RequestV3::is_i_ezsignfolder_sendreminderotherdays_Set() const{
    return m_i_ezsignfolder_sendreminderotherdays_isSet;
}

bool Ezsignfolder_RequestV3::is_i_ezsignfolder_sendreminderotherdays_Valid() const{
    return m_i_ezsignfolder_sendreminderotherdays_isValid;
}

QString Ezsignfolder_RequestV3::getSEzsignfolderExternalid() const {
    return m_s_ezsignfolder_externalid;
}
void Ezsignfolder_RequestV3::setSEzsignfolderExternalid(const QString &s_ezsignfolder_externalid) {
    m_s_ezsignfolder_externalid = s_ezsignfolder_externalid;
    m_s_ezsignfolder_externalid_isSet = true;
}

bool Ezsignfolder_RequestV3::is_s_ezsignfolder_externalid_Set() const{
    return m_s_ezsignfolder_externalid_isSet;
}

bool Ezsignfolder_RequestV3::is_s_ezsignfolder_externalid_Valid() const{
    return m_s_ezsignfolder_externalid_isValid;
}

bool Ezsignfolder_RequestV3::isSet() const {
...
bool Ezsignfolder_RequestV3::isValid() const {
