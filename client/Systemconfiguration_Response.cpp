...
Systemconfiguration_Response::Systemconfiguration_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Systemconfiguration_Response::Systemconfiguration_Response() {
    this->initializeModel();
}

Systemconfiguration_Response::~Systemconfiguration_Response() {}

void Systemconfiguration_Response::initializeModel() {
    ...
    m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet = false;
    m_b_systemconfiguration_allowcomplexcreditcardsignature_isValid = false;
...
void Systemconfiguration_Response::fromJson(const QString &jsonString) {
...
void Systemconfiguration_Response::fromJsonObject(QJsonObject json) {
    ...
    m_b_systemconfiguration_allowcomplexcreditcardsignature_isValid = ::Ezmaxapi::fromJsonValue(m_b_systemconfiguration_allowcomplexcreditcardsignature, json[QString("bSystemconfigurationAllowcomplexcreditcardsignature")]);
    m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet = !json[QString("bSystemconfigurationAllowcomplexcreditcardsignature")].isNull() && m_b_systemconfiguration_allowcomplexcreditcardsignature_isValid;
...
QJsonObject Systemconfiguration_Response::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet) {
        obj.insert(QString("bSystemconfigurationAllowcomplexcreditcardsignature"), ::Ezmaxapi::toJsonValue(m_b_systemconfiguration_allowcomplexcreditcardsignature));
    }
...
qint32 Systemconfiguration_Response::getPkiSystemconfigurationId() const {
    return m_pki_systemconfiguration_id;
}
void Systemconfiguration_Response::setPkiSystemconfigurationId(const qint32 &pki_systemconfiguration_id) {
    m_pki_systemconfiguration_id = pki_systemconfiguration_id;
    m_pki_systemconfiguration_id_isSet = true;
}

bool Systemconfiguration_Response::is_pki_systemconfiguration_id_Set() const{
    return m_pki_systemconfiguration_id_isSet;
}

bool Systemconfiguration_Response::is_pki_systemconfiguration_id_Valid() const{
    return m_pki_systemconfiguration_id_isValid;
}

qint32 Systemconfiguration_Response::getFkiSystemconfigurationtypeId() const {
    return m_fki_systemconfigurationtype_id;
}
void Systemconfiguration_Response::setFkiSystemconfigurationtypeId(const qint32 &fki_systemconfigurationtype_id) {
    m_fki_systemconfigurationtype_id = fki_systemconfigurationtype_id;
    m_fki_systemconfigurationtype_id_isSet = true;
}

bool Systemconfiguration_Response::is_fki_systemconfigurationtype_id_Set() const{
...
qint32 Systemconfiguration_Response::getFkiTimezoneIdDefault() const {
    return m_fki_timezone_id_default;
}
void Systemconfiguration_Response::setFkiTimezoneIdDefault(const qint32 &fki_timezone_id_default) {
    m_fki_timezone_id_default = fki_timezone_id_default;
    m_fki_timezone_id_default_isSet = true;
}

bool Systemconfiguration_Response::is_fki_timezone_id_default_Set() const{
    return m_fki_timezone_id_default_isSet;
}

bool Systemconfiguration_Response::is_fki_timezone_id_default_Valid() const{
    return m_fki_timezone_id_default_isValid;
}

QString Systemconfiguration_Response::getSTimezoneNameDefault() const {
    return m_s_timezone_name_default;
}
void Systemconfiguration_Response::setSTimezoneNameDefault(const QString &s_timezone_name_default) {
    m_s_timezone_name_default = s_timezone_name_default;
    m_s_timezone_name_default_isSet = true;
}

bool Systemconfiguration_Response::is_s_timezone_name_default_Set() const{
    return m_s_timezone_name_default_isSet;
}

bool Systemconfiguration_Response::is_s_timezone_name_default_Valid() const{
...
void Systemconfiguration_Response::setSSystemconfigurationtypeDescriptionX(const QString &s_systemconfigurationtype_description_x) {
...
bool Systemconfiguration_Response::is_s_systemconfigurationtype_description_x_Set() const{
    return m_s_systemconfigurationtype_description_x_isSet;
}

bool Systemconfiguration_Response::is_s_systemconfigurationtype_description_x_Valid() const{
    return m_s_systemconfigurationtype_description_x_isValid;
}

Field_eSystemconfigurationNewexternaluseraction Systemconfiguration_Response::getESystemconfigurationNewexternaluseraction() const {
    return m_e_systemconfiguration_newexternaluseraction;
}
void Systemconfiguration_Response::setESystemconfigurationNewexternaluseraction(const Field_eSystemconfigurationNewexternaluseraction &e_systemconfiguration_newexternaluseraction) {
...
bool Systemconfiguration_Response::is_e_systemconfiguration_newexternaluseraction_Set() const{
    return m_e_systemconfiguration_newexternaluseraction_isSet;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_newexternaluseraction_Valid() const{
    return m_e_systemconfiguration_newexternaluseraction_isValid;
}

Field_eSystemconfigurationLanguage1 Systemconfiguration_Response::getESystemconfigurationLanguage1() const {
    return m_e_systemconfiguration_language1;
}
void Systemconfiguration_Response::setESystemconfigurationLanguage1(const Field_eSystemconfigurationLanguage1 &e_systemconfiguration_language1) {
    m_e_systemconfiguration_language1 = e_systemconfiguration_language1;
    m_e_systemconfiguration_language1_isSet = true;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_language1_Set() const{
    return m_e_systemconfiguration_language1_isSet;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_language1_Valid() const{
    return m_e_systemconfiguration_language1_isValid;
}

Field_eSystemconfigurationLanguage2 Systemconfiguration_Response::getESystemconfigurationLanguage2() const {
    return m_e_systemconfiguration_language2;
}
void Systemconfiguration_Response::setESystemconfigurationLanguage2(const Field_eSystemconfigurationLanguage2 &e_systemconfiguration_language2) {
    m_e_systemconfiguration_language2 = e_systemconfiguration_language2;
    m_e_systemconfiguration_language2_isSet = true;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_language2_Set() const{
    return m_e_systemconfiguration_language2_isSet;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_language2_Valid() const{
    return m_e_systemconfiguration_language2_isValid;
}

Field_eSystemconfigurationEzsign Systemconfiguration_Response::getESystemconfigurationEzsign() const {
    return m_e_systemconfiguration_ezsign;
}
void Systemconfiguration_Response::setESystemconfigurationEzsign(const Field_eSystemconfigurationEzsign &e_systemconfiguration_ezsign) {
    m_e_systemconfiguration_ezsign = e_systemconfiguration_ezsign;
    m_e_systemconfiguration_ezsign_isSet = true;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_ezsign_Set() const{
    return m_e_systemconfiguration_ezsign_isSet;
}

bool Systemconfiguration_Response::is_e_systemconfiguration_ezsign_Valid() const{
...
void Systemconfiguration_Response::setBSystemconfigurationEzsignpersonnal(const bool &b_systemconfiguration_ezsignpersonnal) {
...
bool Systemconfiguration_Response::is_b_systemconfiguration_ezsignpersonnal_Set() const{
...
bool Systemconfiguration_Response::isBSystemconfigurationAllowcomplexcreditcardsignature() const {
    return m_b_systemconfiguration_allowcomplexcreditcardsignature;
}
void Systemconfiguration_Response::setBSystemconfigurationAllowcomplexcreditcardsignature(const bool &b_systemconfiguration_allowcomplexcreditcardsignature) {
    m_b_systemconfiguration_allowcomplexcreditcardsignature = b_systemconfiguration_allowcomplexcreditcardsignature;
    m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet = true;
}

bool Systemconfiguration_Response::is_b_systemconfiguration_allowcomplexcreditcardsignature_Set() const{
    return m_b_systemconfiguration_allowcomplexcreditcardsignature_isSet;
}

bool Systemconfiguration_Response::is_b_systemconfiguration_allowcomplexcreditcardsignature_Valid() const{
    return m_b_systemconfiguration_allowcomplexcreditcardsignature_isValid;
}

bool Systemconfiguration_Response::isBSystemconfigurationSspr() const {
    return m_b_systemconfiguration_sspr;
}
void Systemconfiguration_Response::setBSystemconfigurationSspr(const bool &b_systemconfiguration_sspr) {
    m_b_systemconfiguration_sspr = b_systemconfiguration_sspr;
    m_b_systemconfiguration_sspr_isSet = true;
}

bool Systemconfiguration_Response::is_b_systemconfiguration_sspr_Set() const{
    return m_b_systemconfiguration_sspr_isSet;
}

bool Systemconfiguration_Response::is_b_systemconfiguration_sspr_Valid() const{
    return m_b_systemconfiguration_sspr_isValid;
}

QString Systemconfiguration_Response::getDtSystemconfigurationReadonlyexpirationstart() const {
    return m_dt_systemconfiguration_readonlyexpirationstart;
}
void Systemconfiguration_Response::setDtSystemconfigurationReadonlyexpirationstart(const QString &dt_systemconfiguration_readonlyexpirationstart) {
...
bool Systemconfiguration_Response::is_dt_systemconfiguration_readonlyexpirationstart_Set() const{
    return m_dt_systemconfiguration_readonlyexpirationstart_isSet;
}

bool Systemconfiguration_Response::is_dt_systemconfiguration_readonlyexpirationstart_Valid() const{
    return m_dt_systemconfiguration_readonlyexpirationstart_isValid;
}

QString Systemconfiguration_Response::getDtSystemconfigurationReadonlyexpirationend() const {
    return m_dt_systemconfiguration_readonlyexpirationend;
}
void Systemconfiguration_Response::setDtSystemconfigurationReadonlyexpirationend(const QString &dt_systemconfiguration_readonlyexpirationend) {
...
bool Systemconfiguration_Response::is_dt_systemconfiguration_readonlyexpirationend_Set() const{
    return m_dt_systemconfiguration_readonlyexpirationend_isSet;
}

bool Systemconfiguration_Response::is_dt_systemconfiguration_readonlyexpirationend_Valid() const{
...
qint32 Systemconfiguration_Response::getISystemconfigurationEzsignreminderhoursend() const {
    return m_i_systemconfiguration_ezsignreminderhoursend;
}
void Systemconfiguration_Response::setISystemconfigurationEzsignreminderhoursend(const qint32 &i_systemconfiguration_ezsignreminderhoursend) {
...
bool Systemconfiguration_Response::is_i_systemconfiguration_ezsignreminderhoursend_Set() const{
    return m_i_systemconfiguration_ezsignreminderhoursend_isSet;
}

bool Systemconfiguration_Response::is_i_systemconfiguration_ezsignreminderhoursend_Valid() const{
