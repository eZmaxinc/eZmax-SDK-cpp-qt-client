...
Ezsignsignatureattachment_Response::Ezsignsignatureattachment_Response(const QString &json) {
...
void Ezsignsignatureattachment_Response::fromJson(const QString &jsonString) {
