...
Usergroup_createObject_v1_Request::Usergroup_createObject_v1_Request(const QString &json) {
...
void Usergroup_createObject_v1_Request::fromJson(const QString &jsonString) {
