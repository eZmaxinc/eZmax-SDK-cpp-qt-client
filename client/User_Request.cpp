...
User_Request::User_Request(const QString &json) {
...
void User_Request::initializeModel() {
...
void User_Request::fromJson(const QString &jsonString) {
...
void User_Request::fromJsonObject(QJsonObject json) {
...
QString User_Request::asJson() const {
...
QJsonObject User_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 User_Request::getPkiUserId() const {
    return m_pki_user_id;
}
void User_Request::setPkiUserId(const qint32 &pki_user_id) {
    m_pki_user_id = pki_user_id;
    m_pki_user_id_isSet = true;
}

bool User_Request::is_pki_user_id_Set() const{
    return m_pki_user_id_isSet;
}

bool User_Request::is_pki_user_id_Valid() const{
    return m_pki_user_id_isValid;
}

qint32 User_Request::getFkiAgentId() const {
    return m_fki_agent_id;
}
void User_Request::setFkiAgentId(const qint32 &fki_agent_id) {
    m_fki_agent_id = fki_agent_id;
    m_fki_agent_id_isSet = true;
}

bool User_Request::is_fki_agent_id_Set() const{
    return m_fki_agent_id_isSet;
}

bool User_Request::is_fki_agent_id_Valid() const{
    return m_fki_agent_id_isValid;
}

qint32 User_Request::getFkiBrokerId() const {
    return m_fki_broker_id;
}
void User_Request::setFkiBrokerId(const qint32 &fki_broker_id) {
    m_fki_broker_id = fki_broker_id;
    m_fki_broker_id_isSet = true;
}

bool User_Request::is_fki_broker_id_Set() const{
    return m_fki_broker_id_isSet;
}

bool User_Request::is_fki_broker_id_Valid() const{
    return m_fki_broker_id_isValid;
}

qint32 User_Request::getFkiAssistantId() const {
    return m_fki_assistant_id;
}
void User_Request::setFkiAssistantId(const qint32 &fki_assistant_id) {
    m_fki_assistant_id = fki_assistant_id;
    m_fki_assistant_id_isSet = true;
}

bool User_Request::is_fki_assistant_id_Set() const{
    return m_fki_assistant_id_isSet;
}

bool User_Request::is_fki_assistant_id_Valid() const{
    return m_fki_assistant_id_isValid;
}

qint32 User_Request::getFkiEmployeeId() const {
    return m_fki_employee_id;
}
void User_Request::setFkiEmployeeId(const qint32 &fki_employee_id) {
    m_fki_employee_id = fki_employee_id;
    m_fki_employee_id_isSet = true;
}

bool User_Request::is_fki_employee_id_Set() const{
    return m_fki_employee_id_isSet;
}

bool User_Request::is_fki_employee_id_Valid() const{
    return m_fki_employee_id_isValid;
}

qint32 User_Request::getFkiCompanyIdDefault() const {
    return m_fki_company_id_default;
}
void User_Request::setFkiCompanyIdDefault(const qint32 &fki_company_id_default) {
    m_fki_company_id_default = fki_company_id_default;
    m_fki_company_id_default_isSet = true;
}

bool User_Request::is_fki_company_id_default_Set() const{
    return m_fki_company_id_default_isSet;
}

bool User_Request::is_fki_company_id_default_Valid() const{
    return m_fki_company_id_default_isValid;
}

qint32 User_Request::getFkiDepartmentIdDefault() const {
    return m_fki_department_id_default;
}
void User_Request::setFkiDepartmentIdDefault(const qint32 &fki_department_id_default) {
    m_fki_department_id_default = fki_department_id_default;
    m_fki_department_id_default_isSet = true;
}

bool User_Request::is_fki_department_id_default_Set() const{
    return m_fki_department_id_default_isSet;
}

bool User_Request::is_fki_department_id_default_Valid() const{
    return m_fki_department_id_default_isValid;
}

qint32 User_Request::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void User_Request::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool User_Request::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool User_Request::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

qint32 User_Request::getFkiLanguageId() const {
    return m_fki_language_id;
}
void User_Request::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool User_Request::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool User_Request::is_fki_language_id_Valid() const{
...
bool User_Request::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool User_Request::is_obj_email_Valid() const{
    return m_obj_email_isValid;
}

qint32 User_Request::getFkiBillingentityinternalId() const {
    return m_fki_billingentityinternal_id;
}
void User_Request::setFkiBillingentityinternalId(const qint32 &fki_billingentityinternal_id) {
    m_fki_billingentityinternal_id = fki_billingentityinternal_id;
    m_fki_billingentityinternal_id_isSet = true;
}

bool User_Request::is_fki_billingentityinternal_id_Set() const{
    return m_fki_billingentityinternal_id_isSet;
}

bool User_Request::is_fki_billingentityinternal_id_Valid() const{
...
bool User_Request::is_obj_phone_home_Set() const{
    return m_obj_phone_home_isSet;
}

bool User_Request::is_obj_phone_home_Valid() const{
...
bool User_Request::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool User_Request::is_obj_phone_sms_Valid() const{
    return m_obj_phone_sms_isValid;
}

qint32 User_Request::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void User_Request::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool User_Request::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool User_Request::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

QString User_Request::getSUserSecretresponse() const {
    return m_s_user_secretresponse;
}
void User_Request::setSUserSecretresponse(const QString &s_user_secretresponse) {
    m_s_user_secretresponse = s_user_secretresponse;
    m_s_user_secretresponse_isSet = true;
}

bool User_Request::is_s_user_secretresponse_Set() const{
    return m_s_user_secretresponse_isSet;
}

bool User_Request::is_s_user_secretresponse_Valid() const{
    return m_s_user_secretresponse_isValid;
}

qint32 User_Request::getFkiModuleIdForm() const {
    return m_fki_module_id_form;
}
void User_Request::setFkiModuleIdForm(const qint32 &fki_module_id_form) {
    m_fki_module_id_form = fki_module_id_form;
    m_fki_module_id_form_isSet = true;
}

bool User_Request::is_fki_module_id_form_Set() const{
    return m_fki_module_id_form_isSet;
}

bool User_Request::is_fki_module_id_form_Valid() const{
    return m_fki_module_id_form_isValid;
}

Field_eUserType User_Request::getEUserType() const {
    return m_e_user_type;
}
void User_Request::setEUserType(const Field_eUserType &e_user_type) {
    m_e_user_type = e_user_type;
    m_e_user_type_isSet = true;
}

bool User_Request::is_e_user_type_Set() const{
    return m_e_user_type_isSet;
}

bool User_Request::is_e_user_type_Valid() const{
    return m_e_user_type_isValid;
}

Field_eUserLogintype User_Request::getEUserLogintype() const {
    return m_e_user_logintype;
}
void User_Request::setEUserLogintype(const Field_eUserLogintype &e_user_logintype) {
    m_e_user_logintype = e_user_logintype;
    m_e_user_logintype_isSet = true;
}

bool User_Request::is_e_user_logintype_Set() const{
    return m_e_user_logintype_isSet;
}

bool User_Request::is_e_user_logintype_Valid() const{
    return m_e_user_logintype_isValid;
}

QString User_Request::getSUserFirstname() const {
    return m_s_user_firstname;
}
void User_Request::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool User_Request::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool User_Request::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString User_Request::getSUserLastname() const {
    return m_s_user_lastname;
}
void User_Request::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool User_Request::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool User_Request::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString User_Request::getSUserLoginname() const {
    return m_s_user_loginname;
}
void User_Request::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool User_Request::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool User_Request::is_s_user_loginname_Valid() const{
...
void User_Request::setEUserEzsignaccess(const Field_eUserEzsignaccess &e_user_ezsignaccess) {
    m_e_user_ezsignaccess = e_user_ezsignaccess;
    m_e_user_ezsignaccess_isSet = true;
}

bool User_Request::is_e_user_ezsignaccess_Set() const{
    return m_e_user_ezsignaccess_isSet;
}

bool User_Request::is_e_user_ezsignaccess_Valid() const{
    return m_e_user_ezsignaccess_isValid;
}

bool User_Request::isBUserIsactive() const {
    return m_b_user_isactive;
}
void User_Request::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool User_Request::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool User_Request::is_b_user_isactive_Valid() const{
    return m_b_user_isactive_isValid;
}

bool User_Request::isBUserValidatebyadministration() const {
    return m_b_user_validatebyadministration;
}
void User_Request::setBUserValidatebyadministration(const bool &b_user_validatebyadministration) {
    m_b_user_validatebyadministration = b_user_validatebyadministration;
    m_b_user_validatebyadministration_isSet = true;
}

bool User_Request::is_b_user_validatebyadministration_Set() const{
    return m_b_user_validatebyadministration_isSet;
}

bool User_Request::is_b_user_validatebyadministration_Valid() const{
    return m_b_user_validatebyadministration_isValid;
}

bool User_Request::isBUserValidatebydirector() const {
    return m_b_user_validatebydirector;
}
void User_Request::setBUserValidatebydirector(const bool &b_user_validatebydirector) {
    m_b_user_validatebydirector = b_user_validatebydirector;
    m_b_user_validatebydirector_isSet = true;
}

bool User_Request::is_b_user_validatebydirector_Set() const{
    return m_b_user_validatebydirector_isSet;
}

bool User_Request::is_b_user_validatebydirector_Valid() const{
    return m_b_user_validatebydirector_isValid;
}

bool User_Request::isBUserAttachmentautoverified() const {
    return m_b_user_attachmentautoverified;
}
void User_Request::setBUserAttachmentautoverified(const bool &b_user_attachmentautoverified) {
    m_b_user_attachmentautoverified = b_user_attachmentautoverified;
    m_b_user_attachmentautoverified_isSet = true;
}

bool User_Request::is_b_user_attachmentautoverified_Set() const{
    return m_b_user_attachmentautoverified_isSet;
}

bool User_Request::is_b_user_attachmentautoverified_Valid() const{
    return m_b_user_attachmentautoverified_isValid;
}

bool User_Request::isBUserChangepassword() const {
    return m_b_user_changepassword;
}
void User_Request::setBUserChangepassword(const bool &b_user_changepassword) {
    m_b_user_changepassword = b_user_changepassword;
    m_b_user_changepassword_isSet = true;
}

bool User_Request::is_b_user_changepassword_Set() const{
    return m_b_user_changepassword_isSet;
}

bool User_Request::is_b_user_changepassword_Valid() const{
    return m_b_user_changepassword_isValid;
}

bool User_Request::isBUserEzsigntemplaterolegrouping() const {
    return m_b_user_ezsigntemplaterolegrouping;
}
void User_Request::setBUserEzsigntemplaterolegrouping(const bool &b_user_ezsigntemplaterolegrouping) {
    m_b_user_ezsigntemplaterolegrouping = b_user_ezsigntemplaterolegrouping;
    m_b_user_ezsigntemplaterolegrouping_isSet = true;
}

bool User_Request::is_b_user_ezsigntemplaterolegrouping_Set() const{
    return m_b_user_ezsigntemplaterolegrouping_isSet;
}

bool User_Request::is_b_user_ezsigntemplaterolegrouping_Valid() const{
    return m_b_user_ezsigntemplaterolegrouping_isValid;
}

bool User_Request::isSet() const {
...
bool User_Request::isValid() const {
