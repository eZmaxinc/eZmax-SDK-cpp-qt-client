...
/*
 * OAIEzsignsignergroupmembership_RequestCompound.h
 *
 * A Ezsignsignergroupmembership Object and children
 */

#ifndef OAIEzsignsignergroupmembership_RequestCompound_H
#define OAIEzsignsignergroupmembership_RequestCompound_H
...
class OAIEzsignsignergroupmembership_RequestCompound : public OAIObject {
public:
    OAIEzsignsignergroupmembership_RequestCompound();
    OAIEzsignsignergroupmembership_RequestCompound(QString json);
    ~OAIEzsignsignergroupmembership_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignergroupmembership_RequestCompound)

#endif // OAIEzsignsignergroupmembership_RequestCompound_H
