...
Ezsignsigner_Request::Ezsignsigner_Request(const QString &json) {
...
void Ezsignsigner_Request::initializeModel() {
...
void Ezsignsigner_Request::fromJson(const QString &jsonString) {
...
void Ezsignsigner_Request::fromJsonObject(QJsonObject json) {
...
QString Ezsignsigner_Request::asJson() const {
...
QJsonObject Ezsignsigner_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsigner_Request::getFkiUserlogintypeId() const {
    return m_fki_userlogintype_id;
}
void Ezsignsigner_Request::setFkiUserlogintypeId(const qint32 &fki_userlogintype_id) {
    m_fki_userlogintype_id = fki_userlogintype_id;
    m_fki_userlogintype_id_isSet = true;
}

bool Ezsignsigner_Request::is_fki_userlogintype_id_Set() const{
    return m_fki_userlogintype_id_isSet;
}

bool Ezsignsigner_Request::is_fki_userlogintype_id_Valid() const{
    return m_fki_userlogintype_id_isValid;
}

qint32 Ezsignsigner_Request::getFkiTaxassignmentId() const {
    return m_fki_taxassignment_id;
}
void Ezsignsigner_Request::setFkiTaxassignmentId(const qint32 &fki_taxassignment_id) {
    m_fki_taxassignment_id = fki_taxassignment_id;
    m_fki_taxassignment_id_isSet = true;
}

bool Ezsignsigner_Request::is_fki_taxassignment_id_Set() const{
    return m_fki_taxassignment_id_isSet;
}

bool Ezsignsigner_Request::is_fki_taxassignment_id_Valid() const{
    return m_fki_taxassignment_id_isValid;
}

qint32 Ezsignsigner_Request::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void Ezsignsigner_Request::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool Ezsignsigner_Request::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool Ezsignsigner_Request::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

QString Ezsignsigner_Request::getEEzsignsignerLogintype() const {
    return m_e_ezsignsigner_logintype;
}
void Ezsignsigner_Request::setEEzsignsignerLogintype(const QString &e_ezsignsigner_logintype) {
    m_e_ezsignsigner_logintype = e_ezsignsigner_logintype;
    m_e_ezsignsigner_logintype_isSet = true;
}

bool Ezsignsigner_Request::is_e_ezsignsigner_logintype_Set() const{
    return m_e_ezsignsigner_logintype_isSet;
}

bool Ezsignsigner_Request::is_e_ezsignsigner_logintype_Valid() const{
    return m_e_ezsignsigner_logintype_isValid;
}

QString Ezsignsigner_Request::getSEzsignsignerSecretanswer() const {
    return m_s_ezsignsigner_secretanswer;
}
void Ezsignsigner_Request::setSEzsignsignerSecretanswer(const QString &s_ezsignsigner_secretanswer) {
    m_s_ezsignsigner_secretanswer = s_ezsignsigner_secretanswer;
    m_s_ezsignsigner_secretanswer_isSet = true;
}

bool Ezsignsigner_Request::is_s_ezsignsigner_secretanswer_Set() const{
    return m_s_ezsignsigner_secretanswer_isSet;
}

bool Ezsignsigner_Request::is_s_ezsignsigner_secretanswer_Valid() const{
    return m_s_ezsignsigner_secretanswer_isValid;
}

bool Ezsignsigner_Request::isSet() const {
...
bool Ezsignsigner_Request::isValid() const {
