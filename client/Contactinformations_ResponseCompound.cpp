...
Contactinformations_ResponseCompound::Contactinformations_ResponseCompound(const QString &json) {
...
void Contactinformations_ResponseCompound::fromJson(const QString &jsonString) {
