...
private:
    ...
    QList<OAIEzsignformfieldgroupsigner_RequestCompound> m_a_obj_ezsignformfieldgroupsigner;
    ...
    QList<OAIEzsignformfield_RequestCompound> m_a_obj_ezsignformfield;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignformfieldgroup_RequestCompound)
