...
class Permission_Request : public Object {
public:
    Permission_Request();
    Permission_Request(const QString &json);
    ~Permission_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Permission_Request)

#endif // Permission_Request_H
