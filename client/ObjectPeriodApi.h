...
#ifndef _ObjectPeriodApi_H
#define _ObjectPeriodApi_H
...
class ObjectPeriodApi : public QObject {
    Q_OBJECT

public:
    ObjectPeriodApi(const int timeOut = 0);
    ~ObjectPeriodApi();
