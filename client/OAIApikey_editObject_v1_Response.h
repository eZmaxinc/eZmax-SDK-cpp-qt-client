...
/*
 * OAIApikey_editObject_v1_Response.h
 *
 * Response for PUT /1/object/apikey/{pkiApikeyID}
 */

#ifndef OAIApikey_editObject_v1_Response_H
#define OAIApikey_editObject_v1_Response_H
...
class OAIApikey_editObject_v1_Response : public OAIObject {
public:
    OAIApikey_editObject_v1_Response();
    OAIApikey_editObject_v1_Response(QString json);
    ~OAIApikey_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIApikey_editObject_v1_Response)

#endif // OAIApikey_editObject_v1_Response_H
