...
/*
 * Ezsignformfieldgroup_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignformfieldgroup/{pkiEzsignfoldersignerassociationID}
 */

#ifndef Ezsignformfieldgroup_editObject_v1_Response_H
#define Ezsignformfieldgroup_editObject_v1_Response_H
...
class Ezsignformfieldgroup_editObject_v1_Response : public Object {
public:
    Ezsignformfieldgroup_editObject_v1_Response();
    Ezsignformfieldgroup_editObject_v1_Response(const QString &json);
    ~Ezsignformfieldgroup_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfieldgroup_editObject_v1_Response)

#endif // Ezsignformfieldgroup_editObject_v1_Response_H
