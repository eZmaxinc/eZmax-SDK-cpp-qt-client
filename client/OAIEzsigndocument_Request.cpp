...
QString OAIEzsigndocument_Request::getSEzsigndocumentFilename() const {
    return s_ezsigndocument_filename;
}
void OAIEzsigndocument_Request::setSEzsigndocumentFilename(const QString &s_ezsigndocument_filename) {
    this->s_ezsigndocument_filename = s_ezsigndocument_filename;
    this->m_s_ezsigndocument_filename_isSet = true;
}

bool OAIEzsigndocument_Request::is_s_ezsigndocument_filename_Set() const{
    return m_s_ezsigndocument_filename_isSet;
}

bool OAIEzsigndocument_Request::is_s_ezsigndocument_filename_Valid() const{
