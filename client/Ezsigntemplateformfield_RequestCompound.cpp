...
Ezsigntemplateformfield_RequestCompound::Ezsigntemplateformfield_RequestCompound(const QString &json) {
...
void Ezsigntemplateformfield_RequestCompound::fromJson(const QString &jsonString) {
