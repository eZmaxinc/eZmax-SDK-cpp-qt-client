...
Signature_ResponseV3::Signature_ResponseV3(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Signature_ResponseV3::Signature_ResponseV3() {
    this->initializeModel();
}

Signature_ResponseV3::~Signature_ResponseV3() {}

void Signature_ResponseV3::initializeModel() {
...
void Signature_ResponseV3::fromJson(const QString &jsonString) {
...
void Signature_ResponseV3::fromJsonObject(QJsonObject json) {
...
QString Signature_ResponseV3::asJson() const {
...
QJsonObject Signature_ResponseV3::asJsonObject() const {
    QJsonObject obj;
...
qint32 Signature_ResponseV3::getPkiSignatureId() const {
    return m_pki_signature_id;
}
void Signature_ResponseV3::setPkiSignatureId(const qint32 &pki_signature_id) {
    m_pki_signature_id = pki_signature_id;
    m_pki_signature_id_isSet = true;
}

bool Signature_ResponseV3::is_pki_signature_id_Set() const{
    return m_pki_signature_id_isSet;
}

bool Signature_ResponseV3::is_pki_signature_id_Valid() const{
    return m_pki_signature_id_isValid;
}

qint32 Signature_ResponseV3::getFkiFontId() const {
    return m_fki_font_id;
}
void Signature_ResponseV3::setFkiFontId(const qint32 &fki_font_id) {
    m_fki_font_id = fki_font_id;
    m_fki_font_id_isSet = true;
}

bool Signature_ResponseV3::is_fki_font_id_Set() const{
    return m_fki_font_id_isSet;
}

bool Signature_ResponseV3::is_fki_font_id_Valid() const{
    return m_fki_font_id_isValid;
}

Field_eSignaturePreference Signature_ResponseV3::getESignaturePreference() const {
    return m_e_signature_preference;
}
void Signature_ResponseV3::setESignaturePreference(const Field_eSignaturePreference &e_signature_preference) {
    m_e_signature_preference = e_signature_preference;
    m_e_signature_preference_isSet = true;
}

bool Signature_ResponseV3::is_e_signature_preference_Set() const{
    return m_e_signature_preference_isSet;
}

bool Signature_ResponseV3::is_e_signature_preference_Valid() const{
    return m_e_signature_preference_isValid;
}

bool Signature_ResponseV3::isBSignatureSvg() const {
    return m_b_signature_svg;
}
void Signature_ResponseV3::setBSignatureSvg(const bool &b_signature_svg) {
    m_b_signature_svg = b_signature_svg;
    m_b_signature_svg_isSet = true;
}

bool Signature_ResponseV3::is_b_signature_svg_Set() const{
    return m_b_signature_svg_isSet;
}

bool Signature_ResponseV3::is_b_signature_svg_Valid() const{
    return m_b_signature_svg_isValid;
}

bool Signature_ResponseV3::isBSignatureSvginitials() const {
    return m_b_signature_svginitials;
}
void Signature_ResponseV3::setBSignatureSvginitials(const bool &b_signature_svginitials) {
    m_b_signature_svginitials = b_signature_svginitials;
    m_b_signature_svginitials_isSet = true;
}

bool Signature_ResponseV3::is_b_signature_svginitials_Set() const{
    return m_b_signature_svginitials_isSet;
}

bool Signature_ResponseV3::is_b_signature_svginitials_Valid() const{
    return m_b_signature_svginitials_isValid;
}

bool Signature_ResponseV3::isSet() const {
...
bool Signature_ResponseV3::isValid() const {
