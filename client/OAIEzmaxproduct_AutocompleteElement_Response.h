...
/*
 * OAIEzmaxproduct_AutocompleteElement_Response.h
 *
 * A Ezmaxproduct AutocompleteElement Response
 */

#ifndef OAIEzmaxproduct_AutocompleteElement_Response_H
#define OAIEzmaxproduct_AutocompleteElement_Response_H
...
class OAIEzmaxproduct_AutocompleteElement_Response : public OAIObject {
public:
    OAIEzmaxproduct_AutocompleteElement_Response();
    OAIEzmaxproduct_AutocompleteElement_Response(QString json);
    ~OAIEzmaxproduct_AutocompleteElement_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzmaxproduct_AutocompleteElement_Response)

#endif // OAIEzmaxproduct_AutocompleteElement_Response_H
