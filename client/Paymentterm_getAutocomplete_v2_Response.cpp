...
Paymentterm_getAutocomplete_v2_Response::Paymentterm_getAutocomplete_v2_Response(const QString &json) {
...
void Paymentterm_getAutocomplete_v2_Response::fromJson(const QString &jsonString) {
