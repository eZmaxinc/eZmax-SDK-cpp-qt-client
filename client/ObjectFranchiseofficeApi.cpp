...
ObjectFranchiseofficeApi::ObjectFranchiseofficeApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectFranchiseofficeApi::~ObjectFranchiseofficeApi() {
}

void ObjectFranchiseofficeApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("franchiseofficeGetAutocompleteV2", defaultConf);
    _serverIndices.insert("franchiseofficeGetAutocompleteV2", 0);
}
 ...
 */
int ObjectFranchiseofficeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectFranchiseofficeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectFranchiseofficeApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectFranchiseofficeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectFranchiseofficeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectFranchiseofficeApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectFranchiseofficeApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectFranchiseofficeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectFranchiseofficeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectFranchiseofficeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectFranchiseofficeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectFranchiseofficeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectFranchiseofficeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectFranchiseofficeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectFranchiseofficeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectFranchiseofficeApi::enableResponseCompression() {
...
QString ObjectFranchiseofficeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectFranchiseofficeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectFranchiseofficeApi::franchiseofficeGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
    QString fullPath = QString(_serverConfigs["franchiseofficeGetAutocompleteV2"][_serverIndices.value("franchiseofficeGetAutocompleteV2")].URL()+"/2/object/franchiseoffice/getAutocomplete/{sSelector}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectFranchiseofficeApi::franchiseofficeGetAutocompleteV2Callback);
...
void ObjectFranchiseofficeApi::franchiseofficeGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    ...
    Franchiseoffice_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectFranchiseofficeApi::tokenAvailable() {
