...
Ezsignfoldertype_getAutocomplete_v2_Response_mPayload::Ezsignfoldertype_getAutocomplete_v2_Response_mPayload(const QString &json) {
...
void Ezsignfoldertype_getAutocomplete_v2_Response_mPayload::fromJson(const QString &jsonString) {
