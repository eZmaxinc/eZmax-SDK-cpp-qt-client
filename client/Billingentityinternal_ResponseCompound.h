...
/*
 * Billingentityinternal_ResponseCompound.h
 *
 * A Billingentityinternal Object
 */

#ifndef Billingentityinternal_ResponseCompound_H
#define Billingentityinternal_ResponseCompound_H
...
class Billingentityinternalproduct_ResponseCompound;
...
public:
    ...
    QList<Billingentityinternalproduct_ResponseCompound> getAObjBillingentityinternalproduct() const;
    void setAObjBillingentityinternalproduct(const QList<Billingentityinternalproduct_ResponseCompound> &a_obj_billingentityinternalproduct);
...
private:
    ...
    QList<Billingentityinternalproduct_ResponseCompound> m_a_obj_billingentityinternalproduct;
...
Q_DECLARE_METATYPE(Ezmaxapi::Billingentityinternal_ResponseCompound)

#endif // Billingentityinternal_ResponseCompound_H
