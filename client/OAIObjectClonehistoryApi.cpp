...
#include "OAIObjectClonehistoryApi.h"
...
OAIObjectClonehistoryApi::OAIObjectClonehistoryApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIObjectClonehistoryApi::~OAIObjectClonehistoryApi() {
}

void OAIObjectClonehistoryApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("clonehistoryGetListV1", defaultConf);
    _serverIndices.insert("clonehistoryGetListV1", 0);
}
...
*/
int OAIObjectClonehistoryApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectClonehistoryApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectClonehistoryApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectClonehistoryApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectClonehistoryApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectClonehistoryApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectClonehistoryApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectClonehistoryApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectClonehistoryApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectClonehistoryApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectClonehistoryApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectClonehistoryApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectClonehistoryApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectClonehistoryApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectClonehistoryApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectClonehistoryApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectClonehistoryApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectClonehistoryApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectClonehistoryApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectClonehistoryApi::clonehistoryGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectClonehistoryApi::clonehistoryGetListV1Callback);
    connect(this, &OAIObjectClonehistoryApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIObjectClonehistoryApi::clonehistoryGetListV1Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIClonehistory_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectClonehistoryApi::tokenAvailable(){
