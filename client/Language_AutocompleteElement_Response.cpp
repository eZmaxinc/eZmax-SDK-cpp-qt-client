...
Language_AutocompleteElement_Response::Language_AutocompleteElement_Response(const QString &json) {
...
void Language_AutocompleteElement_Response::fromJson(const QString &jsonString) {
