...
Authenticationexternal_ResponseCompound::Authenticationexternal_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Authenticationexternal_ResponseCompound::Authenticationexternal_ResponseCompound() {
    this->initializeModel();
}

Authenticationexternal_ResponseCompound::~Authenticationexternal_ResponseCompound() {}

void Authenticationexternal_ResponseCompound::initializeModel() {
...
void Authenticationexternal_ResponseCompound::fromJson(const QString &jsonString) {
...
void Authenticationexternal_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Authenticationexternal_ResponseCompound::asJson() const {
...
QJsonObject Authenticationexternal_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Authenticationexternal_ResponseCompound::getPkiAuthenticationexternalId() const {
    return m_pki_authenticationexternal_id;
}
void Authenticationexternal_ResponseCompound::setPkiAuthenticationexternalId(const qint32 &pki_authenticationexternal_id) {
    m_pki_authenticationexternal_id = pki_authenticationexternal_id;
    m_pki_authenticationexternal_id_isSet = true;
}

bool Authenticationexternal_ResponseCompound::is_pki_authenticationexternal_id_Set() const{
    return m_pki_authenticationexternal_id_isSet;
}

bool Authenticationexternal_ResponseCompound::is_pki_authenticationexternal_id_Valid() const{
    return m_pki_authenticationexternal_id_isValid;
}

QString Authenticationexternal_ResponseCompound::getSAuthenticationexternalDescription() const {
    return m_s_authenticationexternal_description;
}
void Authenticationexternal_ResponseCompound::setSAuthenticationexternalDescription(const QString &s_authenticationexternal_description) {
...
bool Authenticationexternal_ResponseCompound::is_s_authenticationexternal_description_Set() const{
    return m_s_authenticationexternal_description_isSet;
}

bool Authenticationexternal_ResponseCompound::is_s_authenticationexternal_description_Valid() const{
    return m_s_authenticationexternal_description_isValid;
}

Field_eAuthenticationexternalType Authenticationexternal_ResponseCompound::getEAuthenticationexternalType() const {
    return m_e_authenticationexternal_type;
}
void Authenticationexternal_ResponseCompound::setEAuthenticationexternalType(const Field_eAuthenticationexternalType &e_authenticationexternal_type) {
    m_e_authenticationexternal_type = e_authenticationexternal_type;
    m_e_authenticationexternal_type_isSet = true;
}

bool Authenticationexternal_ResponseCompound::is_e_authenticationexternal_type_Set() const{
    return m_e_authenticationexternal_type_isSet;
}

bool Authenticationexternal_ResponseCompound::is_e_authenticationexternal_type_Valid() const{
    return m_e_authenticationexternal_type_isValid;
}

bool Authenticationexternal_ResponseCompound::isBAuthenticationexternalConnected() const {
    return m_b_authenticationexternal_connected;
}
void Authenticationexternal_ResponseCompound::setBAuthenticationexternalConnected(const bool &b_authenticationexternal_connected) {
    m_b_authenticationexternal_connected = b_authenticationexternal_connected;
    m_b_authenticationexternal_connected_isSet = true;
}

bool Authenticationexternal_ResponseCompound::is_b_authenticationexternal_connected_Set() const{
    return m_b_authenticationexternal_connected_isSet;
}

bool Authenticationexternal_ResponseCompound::is_b_authenticationexternal_connected_Valid() const{
    return m_b_authenticationexternal_connected_isValid;
}

QString Authenticationexternal_ResponseCompound::getSAuthenticationexternalAuthorizationurl() const {
    return m_s_authenticationexternal_authorizationurl;
}
void Authenticationexternal_ResponseCompound::setSAuthenticationexternalAuthorizationurl(const QString &s_authenticationexternal_authorizationurl) {
...
bool Authenticationexternal_ResponseCompound::is_s_authenticationexternal_authorizationurl_Set() const{
    return m_s_authenticationexternal_authorizationurl_isSet;
}

bool Authenticationexternal_ResponseCompound::is_s_authenticationexternal_authorizationurl_Valid() const{
    return m_s_authenticationexternal_authorizationurl_isValid;
}

Common_Audit Authenticationexternal_ResponseCompound::getObjAudit() const {
    return m_obj_audit;
}
void Authenticationexternal_ResponseCompound::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Authenticationexternal_ResponseCompound::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Authenticationexternal_ResponseCompound::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Authenticationexternal_ResponseCompound::isSet() const {
...
bool Authenticationexternal_ResponseCompound::isValid() const {
