...
/*
 * OAIUser_createEzsignuser_v1_Response.h
 *
 * Response for the /1/module/user/createEzsignuser API Request
 */

#ifndef OAIUser_createEzsignuser_v1_Response_H
#define OAIUser_createEzsignuser_v1_Response_H
...
public:
    OAIUser_createEzsignuser_v1_Response();
    OAIUser_createEzsignuser_v1_Response(QString json);
    ~OAIUser_createEzsignuser_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_createEzsignuser_v1_Response)

#endif // OAIUser_createEzsignuser_v1_Response_H
