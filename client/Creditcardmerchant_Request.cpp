...
Creditcardmerchant_Request::Creditcardmerchant_Request(const QString &json) {
...
void Creditcardmerchant_Request::fromJson(const QString &jsonString) {
...
qint32 Creditcardmerchant_Request::getFkiCurrencyId() const {
    return m_fki_currency_id;
}
void Creditcardmerchant_Request::setFkiCurrencyId(const qint32 &fki_currency_id) {
    m_fki_currency_id = fki_currency_id;
    m_fki_currency_id_isSet = true;
}

bool Creditcardmerchant_Request::is_fki_currency_id_Set() const{
    return m_fki_currency_id_isSet;
}

bool Creditcardmerchant_Request::is_fki_currency_id_Valid() const{
