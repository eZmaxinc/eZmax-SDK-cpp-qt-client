...
ObjectEzsigntsarequirementApi::ObjectEzsigntsarequirementApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectEzsigntsarequirementApi::~ObjectEzsigntsarequirementApi() {
}

void ObjectEzsigntsarequirementApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectEzsigntsarequirementApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectEzsigntsarequirementApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectEzsigntsarequirementApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectEzsigntsarequirementApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectEzsigntsarequirementApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectEzsigntsarequirementApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectEzsigntsarequirementApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectEzsigntsarequirementApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectEzsigntsarequirementApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectEzsigntsarequirementApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectEzsigntsarequirementApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectEzsigntsarequirementApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectEzsigntsarequirementApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectEzsigntsarequirementApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectEzsigntsarequirementApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectEzsigntsarequirementApi::enableResponseCompression() {
...
QString ObjectEzsigntsarequirementApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectEzsigntsarequirementApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectEzsigntsarequirementApi::ezsigntsarequirementGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<qint32> &fki_ezsignfoldertype_id, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigntsarequirementApi::ezsigntsarequirementGetAutocompleteV2Callback);
...
void ObjectEzsigntsarequirementApi::ezsigntsarequirementGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    ...
    Ezsigntsarequirement_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigntsarequirementApi::tokenAvailable() {
