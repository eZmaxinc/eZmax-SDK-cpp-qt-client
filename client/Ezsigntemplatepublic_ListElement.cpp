...
Ezsigntemplatepublic_ListElement::Ezsigntemplatepublic_ListElement(const QString &json) {
...
void Ezsigntemplatepublic_ListElement::fromJson(const QString &jsonString) {
