...
Invoice_getAttachments_v1_Response_mPayload::Invoice_getAttachments_v1_Response_mPayload(const QString &json) {
...
void Invoice_getAttachments_v1_Response_mPayload::fromJson(const QString &jsonString) {
