...
Permission_createObject_v1_Request::Permission_createObject_v1_Request(const QString &json) {
...
void Permission_createObject_v1_Request::fromJson(const QString &jsonString) {
