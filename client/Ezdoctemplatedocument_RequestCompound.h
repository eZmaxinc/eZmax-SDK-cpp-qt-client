...
/*
 * Ezdoctemplatedocument_RequestCompound.h
 *
 * A Ezdoctemplatedocument Object and children
 */

#ifndef Ezdoctemplatedocument_RequestCompound_H
#define Ezdoctemplatedocument_RequestCompound_H
...
class Ezdoctemplatedocument_RequestCompound : public Object {
public:
    Ezdoctemplatedocument_RequestCompound();
    Ezdoctemplatedocument_RequestCompound(const QString &json);
    ~Ezdoctemplatedocument_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezdoctemplatedocument_RequestCompound)

#endif // Ezdoctemplatedocument_RequestCompound_H
