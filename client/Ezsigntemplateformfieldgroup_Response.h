...
#ifndef Ezsigntemplateformfieldgroup_Response_H
#define Ezsigntemplateformfieldgroup_Response_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateformfieldgroup_Response)

#endif // Ezsigntemplateformfieldgroup_Response_H
