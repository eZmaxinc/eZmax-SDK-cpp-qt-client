...
/*
 * OAIEzsigntemplateformfieldgroup_getObject_v1_Response.h
 *
 * Response for GET /1/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}
 */

#ifndef OAIEzsigntemplateformfieldgroup_getObject_v1_Response_H
#define OAIEzsigntemplateformfieldgroup_getObject_v1_Response_H
...
class OAIEzsigntemplateformfieldgroup_getObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplateformfieldgroup_getObject_v1_Response();
    OAIEzsigntemplateformfieldgroup_getObject_v1_Response(QString json);
    ~OAIEzsigntemplateformfieldgroup_getObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplateformfieldgroup_getObject_v1_Response)

#endif // OAIEzsigntemplateformfieldgroup_getObject_v1_Response_H
