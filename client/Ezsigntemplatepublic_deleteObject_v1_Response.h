...
/*
 * Ezsigntemplatepublic_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}
 */

#ifndef Ezsigntemplatepublic_deleteObject_v1_Response_H
#define Ezsigntemplatepublic_deleteObject_v1_Response_H
...
class Ezsigntemplatepublic_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplatepublic_deleteObject_v1_Response();
    Ezsigntemplatepublic_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplatepublic_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepublic_deleteObject_v1_Response)

#endif // Ezsigntemplatepublic_deleteObject_v1_Response_H
