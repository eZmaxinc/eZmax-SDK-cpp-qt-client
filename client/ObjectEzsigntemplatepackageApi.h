...
#include "Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Request.h"
...
#include "Ezsigntemplatepackage_getObject_v3_Response.h"
...
public:
    ...
    */
    Q_DECL_DEPRECATED virtual void ezsigntemplatepackageEditEzsigntemplatepackagesignersV1(const qint32 &pki_ezsigntemplatepackage_id, const Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v1_Request &ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v1_request);

    /**
    * @param[in]  pki_ezsigntemplatepackage_id qint32 [required]
    * @param[in]  ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Request [required]
    */
    virtual void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2(const qint32 &pki_ezsigntemplatepackage_id, const Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Request &ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request);
    ...
    * @param[in]  pki_ezsigntemplatepackage_id qint32 [required]
    */
    Q_DECL_DEPRECATED virtual void ezsigntemplatepackageGetObjectV2(const qint32 &pki_ezsigntemplatepackage_id);

    /**
    * @param[in]  pki_ezsigntemplatepackage_id qint32 [required]
    */
    virtual void ezsigntemplatepackageGetObjectV3(const qint32 &pki_ezsigntemplatepackage_id);
...
private:
    ...
    void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Callback(HttpRequestWorker *worker);
    ...
    void ezsigntemplatepackageGetObjectV3Callback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Signal(Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Response summary);
    ...
    void ezsigntemplatepackageGetObjectV3Signal(Ezsigntemplatepackage_getObject_v3_Response summary);
    ...
    void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2SignalFull(HttpRequestWorker *worker, Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Response summary);
    ...
    void ezsigntemplatepackageGetObjectV3SignalFull(HttpRequestWorker *worker, Ezsigntemplatepackage_getObject_v3_Response summary);
    ...
    void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2SignalError(Ezsigntemplatepackage_editEzsigntemplatepackagesigners_v2_Response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsigntemplatepackageGetObjectV3SignalError(Ezsigntemplatepackage_getObject_v3_Response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsigntemplatepackageGetObjectV3SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
