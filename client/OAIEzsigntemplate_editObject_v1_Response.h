...
/*
 * OAIEzsigntemplate_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplate/{pkiEzsigntemplateID}
 */

#ifndef OAIEzsigntemplate_editObject_v1_Response_H
#define OAIEzsigntemplate_editObject_v1_Response_H
...
class OAIEzsigntemplate_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplate_editObject_v1_Response();
    OAIEzsigntemplate_editObject_v1_Response(QString json);
    ~OAIEzsigntemplate_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplate_editObject_v1_Response)

#endif // OAIEzsigntemplate_editObject_v1_Response_H
