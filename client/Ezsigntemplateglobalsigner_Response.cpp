...
Ezsigntemplateglobalsigner_Response::Ezsigntemplateglobalsigner_Response(const QString &json) {
...
void Ezsigntemplateglobalsigner_Response::fromJson(const QString &jsonString) {
