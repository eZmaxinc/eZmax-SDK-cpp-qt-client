...
OAISignature_createObject_v1_Request::OAISignature_createObject_v1_Request() {
    this->initializeModel();
}

OAISignature_createObject_v1_Request::~OAISignature_createObject_v1_Request() {}

void OAISignature_createObject_v1_Request::initializeModel() {

    m_a_obj_signature_isSet = false;
    m_a_obj_signature_isValid = false;
}

void OAISignature_createObject_v1_Request::fromJson(QString jsonString) {
...
QString OAISignature_createObject_v1_Request::asJson() const {
...
bool OAISignature_createObject_v1_Request::is_a_obj_signature_Valid() const{
...
bool OAISignature_createObject_v1_Request::isValid() const {
