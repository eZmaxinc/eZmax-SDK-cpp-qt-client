...
/*
 * Branding_getList_v1_Response.h
 *
 * Response for GET /1/object/branding/getList
 */

#ifndef Branding_getList_v1_Response_H
#define Branding_getList_v1_Response_H
...
class Branding_getList_v1_Response_mPayload;

class Branding_getList_v1_Response : public Object {
public:
    Branding_getList_v1_Response();
    Branding_getList_v1_Response(const QString &json);
    ~Branding_getList_v1_Response() override;
    ...
    Branding_getList_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Branding_getList_v1_Response_mPayload &m_payload);
...
private:
    ...
    Branding_getList_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_getList_v1_Response)

#endif // Branding_getList_v1_Response_H
