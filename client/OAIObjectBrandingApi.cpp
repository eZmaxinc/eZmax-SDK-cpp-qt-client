...
void OAIObjectBrandingApi::brandingGetAutocompleteV1(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &s_query, const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
