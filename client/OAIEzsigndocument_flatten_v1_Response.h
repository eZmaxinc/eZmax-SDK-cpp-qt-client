...
/*
 * OAIEzsigndocument_flatten_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/flatten
 */

#ifndef OAIEzsigndocument_flatten_v1_Response_H
#define OAIEzsigndocument_flatten_v1_Response_H
...
class OAIEzsigndocument_flatten_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_flatten_v1_Response();
    OAIEzsigndocument_flatten_v1_Response(QString json);
    ~OAIEzsigndocument_flatten_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_flatten_v1_Response)

#endif // OAIEzsigndocument_flatten_v1_Response_H
