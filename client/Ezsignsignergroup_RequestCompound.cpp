...
Ezsignsignergroup_RequestCompound::Ezsignsignergroup_RequestCompound(const QString &json) {
...
void Ezsignsignergroup_RequestCompound::fromJson(const QString &jsonString) {
