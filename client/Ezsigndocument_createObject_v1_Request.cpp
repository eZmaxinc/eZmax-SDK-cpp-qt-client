...
Ezsigndocument_createObject_v1_Request::Ezsigndocument_createObject_v1_Request(const QString &json) {
...
void Ezsigndocument_createObject_v1_Request::fromJson(const QString &jsonString) {
