...
/*
 * OAIPermission_ResponseCompound.h
 *
 * A Permission Object and children to create a complete structure
 */

#ifndef OAIPermission_ResponseCompound_H
#define OAIPermission_ResponseCompound_H
...
public:
    OAIPermission_ResponseCompound();
    OAIPermission_ResponseCompound(QString json);
    ~OAIPermission_ResponseCompound() override;
