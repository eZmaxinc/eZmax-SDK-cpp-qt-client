...
/*
 * OAISystemconfiguration_editObject_v1_Response.h
 *
 * Response for PUT /1/object/systemconfiguration/{pkiSystemconfigurationID}
 */

#ifndef OAISystemconfiguration_editObject_v1_Response_H
#define OAISystemconfiguration_editObject_v1_Response_H
...
class OAISystemconfiguration_editObject_v1_Response : public OAIObject {
public:
    OAISystemconfiguration_editObject_v1_Response();
    OAISystemconfiguration_editObject_v1_Response(QString json);
    ~OAISystemconfiguration_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISystemconfiguration_editObject_v1_Response)

#endif // OAISystemconfiguration_editObject_v1_Response_H
