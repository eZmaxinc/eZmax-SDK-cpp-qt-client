...
/*
 * OAIEzsignfolder_reorder_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/reorder
 */

#ifndef OAIEzsignfolder_reorder_v1_Response_H
#define OAIEzsignfolder_reorder_v1_Response_H
...
class OAIEzsignfolder_reorder_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_reorder_v1_Response();
    OAIEzsignfolder_reorder_v1_Response(QString json);
    ~OAIEzsignfolder_reorder_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_reorder_v1_Response)

#endif // OAIEzsignfolder_reorder_v1_Response_H
