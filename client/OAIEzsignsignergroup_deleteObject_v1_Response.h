...
/*
 * OAIEzsignsignergroup_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}
 */

#ifndef OAIEzsignsignergroup_deleteObject_v1_Response_H
#define OAIEzsignsignergroup_deleteObject_v1_Response_H
...
class OAIEzsignsignergroup_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsignsignergroup_deleteObject_v1_Response();
    OAIEzsignsignergroup_deleteObject_v1_Response(QString json);
    ~OAIEzsignsignergroup_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignergroup_deleteObject_v1_Response)

#endif // OAIEzsignsignergroup_deleteObject_v1_Response_H
