...
/*
 * Ezsigntemplateannotation_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplateannotation/{pkiEzsigntemplateannotationID}
 */

#ifndef Ezsigntemplateannotation_deleteObject_v1_Response_H
#define Ezsigntemplateannotation_deleteObject_v1_Response_H
...
class Ezsigntemplateannotation_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplateannotation_deleteObject_v1_Response();
    Ezsigntemplateannotation_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplateannotation_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateannotation_deleteObject_v1_Response)

#endif // Ezsigntemplateannotation_deleteObject_v1_Response_H
