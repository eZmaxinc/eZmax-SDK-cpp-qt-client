...
/*
 * Ezsigndocument_getObject_v1_Response.h
 *
 * Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef Ezsigndocument_getObject_v1_Response_H
#define Ezsigndocument_getObject_v1_Response_H
...
public:
    Ezsigndocument_getObject_v1_Response();
    Ezsigndocument_getObject_v1_Response(const QString &json);
    ~Ezsigndocument_getObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_getObject_v1_Response)

#endif // Ezsigndocument_getObject_v1_Response_H
