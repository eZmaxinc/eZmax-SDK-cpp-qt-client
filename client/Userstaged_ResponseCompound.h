...
/*
 * Userstaged_ResponseCompound.h
 *
 * A Userstaged Object
 */

#ifndef Userstaged_ResponseCompound_H
#define Userstaged_ResponseCompound_H
...
class Userstaged_ResponseCompound : public Object {
public:
    Userstaged_ResponseCompound();
    Userstaged_ResponseCompound(const QString &json);
    ~Userstaged_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Userstaged_ResponseCompound)

#endif // Userstaged_ResponseCompound_H
