...
Department_getAutocomplete_v2_Response_mPayload::Department_getAutocomplete_v2_Response_mPayload(const QString &json) {
...
void Department_getAutocomplete_v2_Response_mPayload::fromJson(const QString &jsonString) {
