...
#ifndef Ezsignfolder_send_v3_Response_H
#define Ezsignfolder_send_v3_Response_H
...
class Ezsignfolder_send_v3_Response : public Object {
public:
    Ezsignfolder_send_v3_Response();
    Ezsignfolder_send_v3_Response(const QString &json);
    ~Ezsignfolder_send_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_send_v3_Response)

#endif // Ezsignfolder_send_v3_Response_H
