...
#ifndef Variableexpense_Response_H
#define Variableexpense_Response_H
...
class Variableexpense_Response : public Object {
public:
    Variableexpense_Response();
    Variableexpense_Response(const QString &json);
    ~Variableexpense_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Variableexpense_Response)

#endif // Variableexpense_Response_H
