...
Paymentgateway_ResponseCompound::Paymentgateway_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Paymentgateway_ResponseCompound::Paymentgateway_ResponseCompound() {
    this->initializeModel();
}

Paymentgateway_ResponseCompound::~Paymentgateway_ResponseCompound() {}

void Paymentgateway_ResponseCompound::initializeModel() {
...
void Paymentgateway_ResponseCompound::fromJson(const QString &jsonString) {
...
void Paymentgateway_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Paymentgateway_ResponseCompound::asJson() const {
...
QJsonObject Paymentgateway_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Paymentgateway_ResponseCompound::getPkiPaymentgatewayId() const {
    return m_pki_paymentgateway_id;
}
void Paymentgateway_ResponseCompound::setPkiPaymentgatewayId(const qint32 &pki_paymentgateway_id) {
    m_pki_paymentgateway_id = pki_paymentgateway_id;
    m_pki_paymentgateway_id_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_pki_paymentgateway_id_Set() const{
    return m_pki_paymentgateway_id_isSet;
}

bool Paymentgateway_ResponseCompound::is_pki_paymentgateway_id_Valid() const{
    return m_pki_paymentgateway_id_isValid;
}

qint32 Paymentgateway_ResponseCompound::getFkiCreditcardmerchantId() const {
    return m_fki_creditcardmerchant_id;
}
void Paymentgateway_ResponseCompound::setFkiCreditcardmerchantId(const qint32 &fki_creditcardmerchant_id) {
    m_fki_creditcardmerchant_id = fki_creditcardmerchant_id;
    m_fki_creditcardmerchant_id_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_fki_creditcardmerchant_id_Set() const{
    return m_fki_creditcardmerchant_id_isSet;
}

bool Paymentgateway_ResponseCompound::is_fki_creditcardmerchant_id_Valid() const{
    return m_fki_creditcardmerchant_id_isValid;
}

QString Paymentgateway_ResponseCompound::getSCreditcardmerchantDescription() const {
    return m_s_creditcardmerchant_description;
}
void Paymentgateway_ResponseCompound::setSCreditcardmerchantDescription(const QString &s_creditcardmerchant_description) {
    m_s_creditcardmerchant_description = s_creditcardmerchant_description;
    m_s_creditcardmerchant_description_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_s_creditcardmerchant_description_Set() const{
    return m_s_creditcardmerchant_description_isSet;
}

bool Paymentgateway_ResponseCompound::is_s_creditcardmerchant_description_Valid() const{
    return m_s_creditcardmerchant_description_isValid;
}

Field_ePaymentgatewayProcessor Paymentgateway_ResponseCompound::getEPaymentgatewayProcessor() const {
    return m_e_paymentgateway_processor;
}
void Paymentgateway_ResponseCompound::setEPaymentgatewayProcessor(const Field_ePaymentgatewayProcessor &e_paymentgateway_processor) {
    m_e_paymentgateway_processor = e_paymentgateway_processor;
    m_e_paymentgateway_processor_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_e_paymentgateway_processor_Set() const{
    return m_e_paymentgateway_processor_isSet;
}

bool Paymentgateway_ResponseCompound::is_e_paymentgateway_processor_Valid() const{
    return m_e_paymentgateway_processor_isValid;
}

Multilingual_PaymentgatewayDescription Paymentgateway_ResponseCompound::getObjPaymentgatewayDescription() const {
    return m_obj_paymentgateway_description;
}
void Paymentgateway_ResponseCompound::setObjPaymentgatewayDescription(const Multilingual_PaymentgatewayDescription &obj_paymentgateway_description) {
    m_obj_paymentgateway_description = obj_paymentgateway_description;
    m_obj_paymentgateway_description_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_obj_paymentgateway_description_Set() const{
    return m_obj_paymentgateway_description_isSet;
}

bool Paymentgateway_ResponseCompound::is_obj_paymentgateway_description_Valid() const{
    return m_obj_paymentgateway_description_isValid;
}

Creditcardmerchant_ResponseCompound Paymentgateway_ResponseCompound::getObjCreditcardmerchant() const {
    return m_obj_creditcardmerchant;
}
void Paymentgateway_ResponseCompound::setObjCreditcardmerchant(const Creditcardmerchant_ResponseCompound &obj_creditcardmerchant) {
    m_obj_creditcardmerchant = obj_creditcardmerchant;
    m_obj_creditcardmerchant_isSet = true;
}

bool Paymentgateway_ResponseCompound::is_obj_creditcardmerchant_Set() const{
    return m_obj_creditcardmerchant_isSet;
}

bool Paymentgateway_ResponseCompound::is_obj_creditcardmerchant_Valid() const{
    return m_obj_creditcardmerchant_isValid;
}

bool Paymentgateway_ResponseCompound::isSet() const {
...
bool Paymentgateway_ResponseCompound::isValid() const {
