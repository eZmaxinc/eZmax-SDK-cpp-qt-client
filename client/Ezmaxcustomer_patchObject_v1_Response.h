...
/*
 * Ezmaxcustomer_patchObject_v1_Response.h
 *
 * Request for PATCH /1/object/ezmaxcustomer/{pkiEzmaxcustomerID}
 */

#ifndef Ezmaxcustomer_patchObject_v1_Response_H
#define Ezmaxcustomer_patchObject_v1_Response_H
...
class Ezmaxcustomer_patchObject_v1_Response : public Object {
public:
    Ezmaxcustomer_patchObject_v1_Response();
    Ezmaxcustomer_patchObject_v1_Response(const QString &json);
    ~Ezmaxcustomer_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxcustomer_patchObject_v1_Response)

#endif // Ezmaxcustomer_patchObject_v1_Response_H
