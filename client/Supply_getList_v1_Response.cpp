...
Supply_getList_v1_Response::Supply_getList_v1_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Supply_getList_v1_Response::Supply_getList_v1_Response() {
    this->initializeModel();
}

Supply_getList_v1_Response::~Supply_getList_v1_Response() {}

void Supply_getList_v1_Response::initializeModel() {
...
void Supply_getList_v1_Response::fromJson(const QString &jsonString) {
...
void Supply_getList_v1_Response::fromJsonObject(QJsonObject json) {
...
QString Supply_getList_v1_Response::asJson() const {
...
QJsonObject Supply_getList_v1_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload_getList Supply_getList_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Supply_getList_v1_Response::setObjDebugPayload(const Common_Response_objDebugPayload_getList &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Supply_getList_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Supply_getList_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Supply_getList_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void Supply_getList_v1_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Supply_getList_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Supply_getList_v1_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

Supply_getList_v1_Response_mPayload Supply_getList_v1_Response::getMPayload() const {
    return m_m_payload;
}
void Supply_getList_v1_Response::setMPayload(const Supply_getList_v1_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Supply_getList_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Supply_getList_v1_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Supply_getList_v1_Response::isSet() const {
...
bool Supply_getList_v1_Response::isValid() const {
