...
Custom_Ezsignsignaturestatus_Response::Custom_Ezsignsignaturestatus_Response(const QString &json) {
...
void Custom_Ezsignsignaturestatus_Response::fromJson(const QString &jsonString) {
