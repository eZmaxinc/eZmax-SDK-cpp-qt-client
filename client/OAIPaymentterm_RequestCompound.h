...
/*
 * OAIPaymentterm_RequestCompound.h
 *
 * A Paymentterm Object and children
 */

#ifndef OAIPaymentterm_RequestCompound_H
#define OAIPaymentterm_RequestCompound_H
...
class OAIPaymentterm_RequestCompound : public OAIObject {
public:
    OAIPaymentterm_RequestCompound();
    OAIPaymentterm_RequestCompound(QString json);
    ~OAIPaymentterm_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPaymentterm_RequestCompound)

#endif // OAIPaymentterm_RequestCompound_H
