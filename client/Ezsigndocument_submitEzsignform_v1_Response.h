...
/*
 * Ezsigndocument_submitEzsignform_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/submitEzsignform
 */

#ifndef Ezsigndocument_submitEzsignform_v1_Response_H
#define Ezsigndocument_submitEzsignform_v1_Response_H
...
class Ezsigndocument_submitEzsignform_v1_Response : public Object {
public:
    Ezsigndocument_submitEzsignform_v1_Response();
    Ezsigndocument_submitEzsignform_v1_Response(const QString &json);
    ~Ezsigndocument_submitEzsignform_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_submitEzsignform_v1_Response)

#endif // Ezsigndocument_submitEzsignform_v1_Response_H
