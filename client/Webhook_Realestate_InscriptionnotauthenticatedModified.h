...
public:
    ...
    Inscriptionnotauthenticated_Response getObjEzmaxpartnerproduct() const;
    void setObjEzmaxpartnerproduct(const Inscriptionnotauthenticated_Response &obj_ezmaxpartnerproduct);
...
private:
    ...
    Inscriptionnotauthenticated_Response m_obj_ezmaxpartnerproduct;
