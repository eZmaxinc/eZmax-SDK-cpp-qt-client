...
/*
 * OAIEmail_ResponseCompound.h
 *
 * An Email Object and children to create a complete structure
 */

#ifndef OAIEmail_ResponseCompound_H
#define OAIEmail_ResponseCompound_H
...
class OAIEmail_ResponseCompound : public OAIObject {
public:
    OAIEmail_ResponseCompound();
    OAIEmail_ResponseCompound(QString json);
    ~OAIEmail_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEmail_ResponseCompound)

#endif // OAIEmail_ResponseCompound_H
