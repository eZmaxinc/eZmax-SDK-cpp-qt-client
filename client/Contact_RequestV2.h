...
#ifndef Contact_RequestV2_H
#define Contact_RequestV2_H
...
class Contact_RequestV2 : public Object {
public:
    Contact_RequestV2();
    Contact_RequestV2(const QString &json);
    ~Contact_RequestV2() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Contact_RequestV2)

#endif // Contact_RequestV2_H
