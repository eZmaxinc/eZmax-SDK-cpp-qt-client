...
Permission_editObject_v1_Request::Permission_editObject_v1_Request(const QString &json) {
...
void Permission_editObject_v1_Request::fromJson(const QString &jsonString) {
