...
/*
 * Ezsigntemplatesignaturecustomdate_ResponseCompoundV2.h
 *
 * An Ezsigntemplatesignaturecustomdate Object and children to create a complete structure
 */

#ifndef Ezsigntemplatesignaturecustomdate_ResponseCompoundV2_H
#define Ezsigntemplatesignaturecustomdate_ResponseCompoundV2_H
...
class Ezsigntemplatesignaturecustomdate_ResponseCompoundV2 : public Object {
public:
    Ezsigntemplatesignaturecustomdate_ResponseCompoundV2();
    Ezsigntemplatesignaturecustomdate_ResponseCompoundV2(const QString &json);
    ~Ezsigntemplatesignaturecustomdate_ResponseCompoundV2() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignaturecustomdate_ResponseCompoundV2)

#endif // Ezsigntemplatesignaturecustomdate_ResponseCompoundV2_H
