...
private:
    ...
    OAIEzsigntemplatedocument_getEzsigntemplatedocumentpages_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatedocument_getEzsigntemplatedocumentpages_v1_Response)
