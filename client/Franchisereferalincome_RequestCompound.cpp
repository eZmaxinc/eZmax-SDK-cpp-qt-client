...
Franchisereferalincome_RequestCompound::Franchisereferalincome_RequestCompound(const QString &json) {
...
void Franchisereferalincome_RequestCompound::fromJson(const QString &jsonString) {
