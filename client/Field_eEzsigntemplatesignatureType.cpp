...
Field_eEzsigntemplatesignatureType::Field_eEzsigntemplatesignatureType(const QString &json) {
...
void Field_eEzsigntemplatesignatureType::fromJson(const QString &jsonString) {
