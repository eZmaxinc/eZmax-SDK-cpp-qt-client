...
qint32 Systemconfiguration_RequestCompound::getFkiBrandingId() const {
    return m_fki_branding_id;
}
void Systemconfiguration_RequestCompound::setFkiBrandingId(const qint32 &fki_branding_id) {
    m_fki_branding_id = fki_branding_id;
    m_fki_branding_id_isSet = true;
}

bool Systemconfiguration_RequestCompound::is_fki_branding_id_Set() const{
    return m_fki_branding_id_isSet;
}

bool Systemconfiguration_RequestCompound::is_fki_branding_id_Valid() const{
