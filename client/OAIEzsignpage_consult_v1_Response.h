...
/*
 * OAIEzsignpage_consult_v1_Response.h
 *
 * Response for POST /1/object/ezsignpage/{pkiEzsignpageID}/consult
 */

#ifndef OAIEzsignpage_consult_v1_Response_H
#define OAIEzsignpage_consult_v1_Response_H
...
class OAIEzsignpage_consult_v1_Response : public OAIObject {
public:
    OAIEzsignpage_consult_v1_Response();
    OAIEzsignpage_consult_v1_Response(QString json);
    ~OAIEzsignpage_consult_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignpage_consult_v1_Response)

#endif // OAIEzsignpage_consult_v1_Response_H
