...
private:
    ...
    QList<OAIEzsigntemplatepackage_RequestCompound> m_a_obj_ezsigntemplatepackage;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackage_createObject_v1_Request)
