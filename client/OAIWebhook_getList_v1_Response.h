...
/*
 * OAIWebhook_getList_v1_Response.h
 *
 * Response for GET /1/object/webhook/getList
 */

#ifndef OAIWebhook_getList_v1_Response_H
#define OAIWebhook_getList_v1_Response_H
...
class OAIWebhook_getList_v1_Response : public OAIObject {
public:
    OAIWebhook_getList_v1_Response();
    OAIWebhook_getList_v1_Response(QString json);
    ~OAIWebhook_getList_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_getList_v1_Response)

#endif // OAIWebhook_getList_v1_Response_H
