...
#ifndef Ezdoctemplatedocument_Request_H
#define Ezdoctemplatedocument_Request_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezdoctemplatedocument_Request)

#endif // Ezdoctemplatedocument_Request_H
