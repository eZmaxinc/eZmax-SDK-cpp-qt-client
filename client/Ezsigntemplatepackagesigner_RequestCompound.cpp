...
Ezsigntemplatepackagesigner_RequestCompound::Ezsigntemplatepackagesigner_RequestCompound(const QString &json) {
...
void Ezsigntemplatepackagesigner_RequestCompound::fromJson(const QString &jsonString) {
