...
Branding_Request::Branding_Request(QString json) {
...
void Branding_Request::initializeModel() {
...
void Branding_Request::fromJson(QString jsonString) {
...
void Branding_Request::fromJsonObject(QJsonObject json) {
...
QString Branding_Request::asJson() const {
...
QJsonObject Branding_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Branding_Request::getPkiBrandingId() const {
    return m_pki_branding_id;
}
void Branding_Request::setPkiBrandingId(const qint32 &pki_branding_id) {
    m_pki_branding_id = pki_branding_id;
    m_pki_branding_id_isSet = true;
}

bool Branding_Request::is_pki_branding_id_Set() const{
    return m_pki_branding_id_isSet;
}

bool Branding_Request::is_pki_branding_id_Valid() const{
    return m_pki_branding_id_isValid;
}

Multilingual_BrandingDescription Branding_Request::getObjBrandingDescription() const {
    return m_obj_branding_description;
}
void Branding_Request::setObjBrandingDescription(const Multilingual_BrandingDescription &obj_branding_description) {
    m_obj_branding_description = obj_branding_description;
    m_obj_branding_description_isSet = true;
}

bool Branding_Request::is_obj_branding_description_Set() const{
    return m_obj_branding_description_isSet;
}

bool Branding_Request::is_obj_branding_description_Valid() const{
    return m_obj_branding_description_isValid;
}

Field_eBrandingLogo Branding_Request::getEBrandingLogo() const {
    return m_e_branding_logo;
}
void Branding_Request::setEBrandingLogo(const Field_eBrandingLogo &e_branding_logo) {
    m_e_branding_logo = e_branding_logo;
    m_e_branding_logo_isSet = true;
}

bool Branding_Request::is_e_branding_logo_Set() const{
    return m_e_branding_logo_isSet;
}

bool Branding_Request::is_e_branding_logo_Valid() const{
    return m_e_branding_logo_isValid;
}

QByteArray Branding_Request::getSBrandingBase64() const {
    return m_s_branding_base64;
}
void Branding_Request::setSBrandingBase64(const QByteArray &s_branding_base64) {
    m_s_branding_base64 = s_branding_base64;
    m_s_branding_base64_isSet = true;
}

bool Branding_Request::is_s_branding_base64_Set() const{
    return m_s_branding_base64_isSet;
}

bool Branding_Request::is_s_branding_base64_Valid() const{
    return m_s_branding_base64_isValid;
}

Field_eBrandingLogointerface Branding_Request::getEBrandingLogointerface() const {
    return m_e_branding_logointerface;
}
void Branding_Request::setEBrandingLogointerface(const Field_eBrandingLogointerface &e_branding_logointerface) {
    m_e_branding_logointerface = e_branding_logointerface;
    m_e_branding_logointerface_isSet = true;
}

bool Branding_Request::is_e_branding_logointerface_Set() const{
    return m_e_branding_logointerface_isSet;
}

bool Branding_Request::is_e_branding_logointerface_Valid() const{
    return m_e_branding_logointerface_isValid;
}

QByteArray Branding_Request::getSBrandingLogointerfaceBase64() const {
    return m_s_branding_logointerface_base64;
}
void Branding_Request::setSBrandingLogointerfaceBase64(const QByteArray &s_branding_logointerface_base64) {
    m_s_branding_logointerface_base64 = s_branding_logointerface_base64;
    m_s_branding_logointerface_base64_isSet = true;
}

bool Branding_Request::is_s_branding_logointerface_base64_Set() const{
    return m_s_branding_logointerface_base64_isSet;
}

bool Branding_Request::is_s_branding_logointerface_base64_Valid() const{
    return m_s_branding_logointerface_base64_isValid;
}

qint32 Branding_Request::getIBrandingColortext() const {
    return m_i_branding_colortext;
}
void Branding_Request::setIBrandingColortext(const qint32 &i_branding_colortext) {
    m_i_branding_colortext = i_branding_colortext;
    m_i_branding_colortext_isSet = true;
}

bool Branding_Request::is_i_branding_colortext_Set() const{
    return m_i_branding_colortext_isSet;
}

bool Branding_Request::is_i_branding_colortext_Valid() const{
    return m_i_branding_colortext_isValid;
}

qint32 Branding_Request::getIBrandingColortextlinkbox() const {
    return m_i_branding_colortextlinkbox;
}
void Branding_Request::setIBrandingColortextlinkbox(const qint32 &i_branding_colortextlinkbox) {
    m_i_branding_colortextlinkbox = i_branding_colortextlinkbox;
    m_i_branding_colortextlinkbox_isSet = true;
}

bool Branding_Request::is_i_branding_colortextlinkbox_Set() const{
    return m_i_branding_colortextlinkbox_isSet;
}

bool Branding_Request::is_i_branding_colortextlinkbox_Valid() const{
    return m_i_branding_colortextlinkbox_isValid;
}

qint32 Branding_Request::getIBrandingColortextbutton() const {
    return m_i_branding_colortextbutton;
}
void Branding_Request::setIBrandingColortextbutton(const qint32 &i_branding_colortextbutton) {
    m_i_branding_colortextbutton = i_branding_colortextbutton;
    m_i_branding_colortextbutton_isSet = true;
}

bool Branding_Request::is_i_branding_colortextbutton_Set() const{
    return m_i_branding_colortextbutton_isSet;
}

bool Branding_Request::is_i_branding_colortextbutton_Valid() const{
    return m_i_branding_colortextbutton_isValid;
}

qint32 Branding_Request::getIBrandingColorbackground() const {
    return m_i_branding_colorbackground;
}
void Branding_Request::setIBrandingColorbackground(const qint32 &i_branding_colorbackground) {
    m_i_branding_colorbackground = i_branding_colorbackground;
    m_i_branding_colorbackground_isSet = true;
}

bool Branding_Request::is_i_branding_colorbackground_Set() const{
    return m_i_branding_colorbackground_isSet;
}

bool Branding_Request::is_i_branding_colorbackground_Valid() const{
    return m_i_branding_colorbackground_isValid;
}

qint32 Branding_Request::getIBrandingColorbackgroundbutton() const {
    return m_i_branding_colorbackgroundbutton;
}
void Branding_Request::setIBrandingColorbackgroundbutton(const qint32 &i_branding_colorbackgroundbutton) {
    m_i_branding_colorbackgroundbutton = i_branding_colorbackgroundbutton;
    m_i_branding_colorbackgroundbutton_isSet = true;
}

bool Branding_Request::is_i_branding_colorbackgroundbutton_Set() const{
    return m_i_branding_colorbackgroundbutton_isSet;
}

bool Branding_Request::is_i_branding_colorbackgroundbutton_Valid() const{
    return m_i_branding_colorbackgroundbutton_isValid;
}

qint32 Branding_Request::getIBrandingColorbackgroundsmallbox() const {
    return m_i_branding_colorbackgroundsmallbox;
}
void Branding_Request::setIBrandingColorbackgroundsmallbox(const qint32 &i_branding_colorbackgroundsmallbox) {
    m_i_branding_colorbackgroundsmallbox = i_branding_colorbackgroundsmallbox;
    m_i_branding_colorbackgroundsmallbox_isSet = true;
}

bool Branding_Request::is_i_branding_colorbackgroundsmallbox_Set() const{
    return m_i_branding_colorbackgroundsmallbox_isSet;
}

bool Branding_Request::is_i_branding_colorbackgroundsmallbox_Valid() const{
    return m_i_branding_colorbackgroundsmallbox_isValid;
}

qint32 Branding_Request::getIBrandingInterfacecolor() const {
    return m_i_branding_interfacecolor;
}
void Branding_Request::setIBrandingInterfacecolor(const qint32 &i_branding_interfacecolor) {
    m_i_branding_interfacecolor = i_branding_interfacecolor;
    m_i_branding_interfacecolor_isSet = true;
}

bool Branding_Request::is_i_branding_interfacecolor_Set() const{
    return m_i_branding_interfacecolor_isSet;
}

bool Branding_Request::is_i_branding_interfacecolor_Valid() const{
    return m_i_branding_interfacecolor_isValid;
}

QString Branding_Request::getSBrandingName() const {
    return m_s_branding_name;
}
void Branding_Request::setSBrandingName(const QString &s_branding_name) {
    m_s_branding_name = s_branding_name;
    m_s_branding_name_isSet = true;
}

bool Branding_Request::is_s_branding_name_Set() const{
    return m_s_branding_name_isSet;
}

bool Branding_Request::is_s_branding_name_Valid() const{
    return m_s_branding_name_isValid;
}

QString Branding_Request::getSEmailAddress() const {
    return m_s_email_address;
}
void Branding_Request::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Branding_Request::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Branding_Request::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

bool Branding_Request::isBBrandingIsactive() const {
    return m_b_branding_isactive;
}
void Branding_Request::setBBrandingIsactive(const bool &b_branding_isactive) {
    m_b_branding_isactive = b_branding_isactive;
    m_b_branding_isactive_isSet = true;
}

bool Branding_Request::is_b_branding_isactive_Set() const{
    return m_b_branding_isactive_isSet;
}

bool Branding_Request::is_b_branding_isactive_Valid() const{
    return m_b_branding_isactive_isValid;
}

bool Branding_Request::isSet() const {
...
bool Branding_Request::isValid() const {
