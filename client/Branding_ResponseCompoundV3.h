...
/*
 * Branding_ResponseCompoundV3.h
 *
 * A Branding Object
 */

#ifndef Branding_ResponseCompoundV3_H
#define Branding_ResponseCompoundV3_H
...
class Branding_ResponseCompoundV3 : public Object {
public:
    Branding_ResponseCompoundV3();
    Branding_ResponseCompoundV3(const QString &json);
    ~Branding_ResponseCompoundV3() override;
    ...
    qint32 getFkiDomainId() const;
    void setFkiDomainId(const qint32 &fki_domain_id);
    bool is_fki_domain_id_Set() const;
    bool is_fki_domain_id_Valid() const;
    ...
    QString getSBrandingLogoemailurl() const;
    void setSBrandingLogoemailurl(const QString &s_branding_logoemailurl);
    bool is_s_branding_logoemailurl_Set() const;
    bool is_s_branding_logoemailurl_Valid() const;
...
private:
    ...
    qint32 m_fki_domain_id;
    bool m_fki_domain_id_isSet;
    bool m_fki_domain_id_isValid;
    ...
    QString m_s_branding_logoemailurl;
    bool m_s_branding_logoemailurl_isSet;
    bool m_s_branding_logoemailurl_isValid;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_ResponseCompoundV3)

#endif // Branding_ResponseCompoundV3_H
