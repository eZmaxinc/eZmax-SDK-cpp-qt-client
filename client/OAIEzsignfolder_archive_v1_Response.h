...
/*
 * OAIEzsignfolder_archive_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/archive
 */

#ifndef OAIEzsignfolder_archive_v1_Response_H
#define OAIEzsignfolder_archive_v1_Response_H
...
class OAIEzsignfolder_archive_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_archive_v1_Response();
    OAIEzsignfolder_archive_v1_Response(QString json);
    ~OAIEzsignfolder_archive_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_archive_v1_Response)

#endif // OAIEzsignfolder_archive_v1_Response_H
