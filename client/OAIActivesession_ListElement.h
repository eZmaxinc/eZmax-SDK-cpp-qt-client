...
/*
 * OAIActivesession_ListElement.h
 *
 * A Activesession List Element
 */

#ifndef OAIActivesession_ListElement_H
#define OAIActivesession_ListElement_H
...
class OAIActivesession_ListElement : public OAIObject {
public:
    OAIActivesession_ListElement();
    OAIActivesession_ListElement(QString json);
    ~OAIActivesession_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIActivesession_ListElement)

#endif // OAIActivesession_ListElement_H
