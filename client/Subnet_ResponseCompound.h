...
/*
 * Subnet_ResponseCompound.h
 *
 * A Subnet Object
 */

#ifndef Subnet_ResponseCompound_H
#define Subnet_ResponseCompound_H
...
class Subnet_ResponseCompound : public Object {
public:
    Subnet_ResponseCompound();
    Subnet_ResponseCompound(const QString &json);
    ~Subnet_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Subnet_ResponseCompound)

#endif // Subnet_ResponseCompound_H
