...
ObjectSystemconfigurationApi::ObjectSystemconfigurationApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectSystemconfigurationApi::~ObjectSystemconfigurationApi() {
}

void ObjectSystemconfigurationApi::initializeServerConfigs() {
    //Default server
 ...
 */
int ObjectSystemconfigurationApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
 ...
 */
void ObjectSystemconfigurationApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectSystemconfigurationApi::setServerIndex(int serverIndex) {
    for (auto keyIt = _serverIndices.keyBegin(); keyIt != _serverIndices.keyEnd(); keyIt++) {
        setServerIndex(*keyIt, serverIndex);
    }
}

void ObjectSystemconfigurationApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectSystemconfigurationApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectSystemconfigurationApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectSystemconfigurationApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectSystemconfigurationApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectSystemconfigurationApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectSystemconfigurationApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
 ...
 */
int ObjectSystemconfigurationApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
 ...
 * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
 */
void ObjectSystemconfigurationApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectSystemconfigurationApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectSystemconfigurationApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectSystemconfigurationApi::enableResponseCompression() {
...
QString ObjectSystemconfigurationApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectSystemconfigurationApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectSystemconfigurationApi::systemconfigurationGetObjectV2(const qint32 &pki_systemconfiguration_id) {
...
void ObjectSystemconfigurationApi::systemconfigurationGetObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Systemconfiguration_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectSystemconfigurationApi::tokenAvailable() {
