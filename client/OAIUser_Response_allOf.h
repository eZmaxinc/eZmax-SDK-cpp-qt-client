...
/*
 * OAIUser_Response_allOf.h
 *
 * 
 */

#ifndef OAIUser_Response_allOf_H
#define OAIUser_Response_allOf_H
...
class OAIUser_Response_allOf : public OAIObject {
public:
    OAIUser_Response_allOf();
    OAIUser_Response_allOf(QString json);
    ~OAIUser_Response_allOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_Response_allOf)

#endif // OAIUser_Response_allOf_H
