...
#define Ezsignfolder_send_v1_Response_H
...
class Ezsignfolder_send_v1_Response : public Object {
public:
    Ezsignfolder_send_v1_Response();
    Ezsignfolder_send_v1_Response(const QString &json);
    ~Ezsignfolder_send_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_send_v1_Response)

#endif // Ezsignfolder_send_v1_Response_H
