...
Custom_Notificationtestgetnotificationtests_Response::Custom_Notificationtestgetnotificationtests_Response() {
    this->initializeModel();
}

Custom_Notificationtestgetnotificationtests_Response::~Custom_Notificationtestgetnotificationtests_Response() {}

void Custom_Notificationtestgetnotificationtests_Response::initializeModel() {
...
void Custom_Notificationtestgetnotificationtests_Response::fromJsonObject(QJsonObject json) {
    ...
    m_e_notificationpreference_status_isValid = ::Ezmaxapi::fromJsonValue(m_e_notificationpreference_status, json[QString("eNotificationpreferenceStatus")]);
    ...
    m_i_notificationtest_isValid = ::Ezmaxapi::fromJsonValue(m_i_notificationtest, json[QString("iNotificationtest")]);
    m_i_notificationtest_isSet = !json[QString("iNotificationtest")].isNull() && m_i_notificationtest_isValid;
}

QString Custom_Notificationtestgetnotificationtests_Response::asJson() const {
...
QJsonObject Custom_Notificationtestgetnotificationtests_Response::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_e_notificationpreference_status.isSet()) {
        obj.insert(QString("eNotificationpreferenceStatus"), ::Ezmaxapi::toJsonValue(m_e_notificationpreference_status));
    }
    if (m_i_notificationtest_isSet) {
        obj.insert(QString("iNotificationtest"), ::Ezmaxapi::toJsonValue(m_i_notificationtest));
    }
    return obj;
}

qint32 Custom_Notificationtestgetnotificationtests_Response::getPkiNotificationtestId() const {
    return m_pki_notificationtest_id;
}
void Custom_Notificationtestgetnotificationtests_Response::setPkiNotificationtestId(const qint32 &pki_notificationtest_id) {
    m_pki_notificationtest_id = pki_notificationtest_id;
    m_pki_notificationtest_id_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_pki_notificationtest_id_Set() const{
    return m_pki_notificationtest_id_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_pki_notificationtest_id_Valid() const{
    return m_pki_notificationtest_id_isValid;
}

Multilingual_NotificationtestName Custom_Notificationtestgetnotificationtests_Response::getObjNotificationtestName() const {
    return m_obj_notificationtest_name;
}
void Custom_Notificationtestgetnotificationtests_Response::setObjNotificationtestName(const Multilingual_NotificationtestName &obj_notificationtest_name) {
    m_obj_notificationtest_name = obj_notificationtest_name;
    m_obj_notificationtest_name_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_obj_notificationtest_name_Set() const{
    return m_obj_notificationtest_name_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_obj_notificationtest_name_Valid() const{
    return m_obj_notificationtest_name_isValid;
}

qint32 Custom_Notificationtestgetnotificationtests_Response::getFkiNotificationsubsectionId() const {
    return m_fki_notificationsubsection_id;
}
void Custom_Notificationtestgetnotificationtests_Response::setFkiNotificationsubsectionId(const qint32 &fki_notificationsubsection_id) {
    m_fki_notificationsubsection_id = fki_notificationsubsection_id;
    m_fki_notificationsubsection_id_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_fki_notificationsubsection_id_Set() const{
    return m_fki_notificationsubsection_id_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_fki_notificationsubsection_id_Valid() const{
    return m_fki_notificationsubsection_id_isValid;
}

QString Custom_Notificationtestgetnotificationtests_Response::getSNotificationtestFunction() const {
    return m_s_notificationtest_function;
}
void Custom_Notificationtestgetnotificationtests_Response::setSNotificationtestFunction(const QString &s_notificationtest_function) {
    m_s_notificationtest_function = s_notificationtest_function;
    m_s_notificationtest_function_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_s_notificationtest_function_Set() const{
    return m_s_notificationtest_function_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_s_notificationtest_function_Valid() const{
    return m_s_notificationtest_function_isValid;
}

QString Custom_Notificationtestgetnotificationtests_Response::getSNotificationtestNameX() const {
    return m_s_notificationtest_name_x;
}
void Custom_Notificationtestgetnotificationtests_Response::setSNotificationtestNameX(const QString &s_notificationtest_name_x) {
    m_s_notificationtest_name_x = s_notificationtest_name_x;
    m_s_notificationtest_name_x_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_s_notificationtest_name_x_Set() const{
    return m_s_notificationtest_name_x_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_s_notificationtest_name_x_Valid() const{
    return m_s_notificationtest_name_x_isValid;
}

Field_eNotificationpreferenceStatus Custom_Notificationtestgetnotificationtests_Response::getENotificationpreferenceStatus() const {
    return m_e_notificationpreference_status;
}
void Custom_Notificationtestgetnotificationtests_Response::setENotificationpreferenceStatus(const Field_eNotificationpreferenceStatus &e_notificationpreference_status) {
    m_e_notificationpreference_status = e_notificationpreference_status;
    m_e_notificationpreference_status_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_e_notificationpreference_status_Set() const{
    return m_e_notificationpreference_status_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_e_notificationpreference_status_Valid() const{
    return m_e_notificationpreference_status_isValid;
}

qint32 Custom_Notificationtestgetnotificationtests_Response::getINotificationtest() const {
    return m_i_notificationtest;
}
void Custom_Notificationtestgetnotificationtests_Response::setINotificationtest(const qint32 &i_notificationtest) {
    m_i_notificationtest = i_notificationtest;
    m_i_notificationtest_isSet = true;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_i_notificationtest_Set() const{
    return m_i_notificationtest_isSet;
}

bool Custom_Notificationtestgetnotificationtests_Response::is_i_notificationtest_Valid() const{
    return m_i_notificationtest_isValid;
}

bool Custom_Notificationtestgetnotificationtests_Response::isSet() const {
...
bool Custom_Notificationtestgetnotificationtests_Response::isValid() const {
