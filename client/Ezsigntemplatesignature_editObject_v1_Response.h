...
/*
 * Ezsigntemplatesignature_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef Ezsigntemplatesignature_editObject_v1_Response_H
#define Ezsigntemplatesignature_editObject_v1_Response_H
...
class Ezsigntemplatesignature_editObject_v1_Response : public Object {
public:
    Ezsigntemplatesignature_editObject_v1_Response();
    Ezsigntemplatesignature_editObject_v1_Response(QString json);
    ~Ezsigntemplatesignature_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_editObject_v1_Response)

#endif // Ezsigntemplatesignature_editObject_v1_Response_H
