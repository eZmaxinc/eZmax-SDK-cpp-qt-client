...
void ObjectEzsignfoldersignerassociationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ezsignfoldersignerassociationCreateEmbeddedUrlV2", defaultConf);
    _serverIndices.insert("ezsignfoldersignerassociationCreateEmbeddedUrlV2", 0);
    ...
    _serverConfigs.insert("ezsignfoldersignerassociationCreateObjectV3", defaultConf);
    _serverIndices.insert("ezsignfoldersignerassociationCreateObjectV3", 0);
    ...
    _serverConfigs.insert("ezsignfoldersignerassociationEditObjectV2", defaultConf);
    _serverIndices.insert("ezsignfoldersignerassociationEditObjectV2", 0);
    ...
    _serverConfigs.insert("ezsignfoldersignerassociationGetObjectV3", defaultConf);
    _serverIndices.insert("ezsignfoldersignerassociationGetObjectV3", 0);
    ...
    _serverConfigs.insert("ezsignfoldersignerassociationReassignV1", defaultConf);
    _serverIndices.insert("ezsignfoldersignerassociationReassignV1", 0);
}
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateEmbeddedUrlV2(const qint32 &pki_ezsignfoldersignerassociation_id, const Ezsignfoldersignerassociation_createEmbeddedUrl_v2_Request &ezsignfoldersignerassociation_create_embedded_url_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsignfoldersignerassociationCreateEmbeddedUrlV2"][_serverIndices.value("ezsignfoldersignerassociationCreateEmbeddedUrlV2")].URL()+"/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/createEmbeddedUrl");
...

    {
        ...
        QByteArray output = ezsignfoldersignerassociation_create_embedded_url_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateEmbeddedUrlV2Callback);
    connect(this, &ObjectEzsignfoldersignerassociationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateEmbeddedUrlV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignfoldersignerassociation_createEmbeddedUrl_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateObjectV3(const Ezsignfoldersignerassociation_createObject_v3_Request &ezsignfoldersignerassociation_create_object_v3_request) {
    QString fullPath = QString(_serverConfigs["ezsignfoldersignerassociationCreateObjectV3"][_serverIndices.value("ezsignfoldersignerassociationCreateObjectV3")].URL()+"/3/object/ezsignfoldersignerassociation");
...

    {
        ...
        QByteArray output = ezsignfoldersignerassociation_create_object_v3_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateObjectV3Callback);
    connect(this, &ObjectEzsignfoldersignerassociationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationCreateObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignfoldersignerassociation_createObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignfoldersignerassociationCreateObjectV3Signal(output);
        Q_EMIT ezsignfoldersignerassociationCreateObjectV3SignalFull(worker, output);
    } else {
        Q_EMIT ezsignfoldersignerassociationCreateObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsignfoldersignerassociationCreateObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationEditObjectV2(const qint32 &pki_ezsignfoldersignerassociation_id, const Ezsignfoldersignerassociation_editObject_v2_Request &ezsignfoldersignerassociation_edit_object_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsignfoldersignerassociationEditObjectV2"][_serverIndices.value("ezsignfoldersignerassociationEditObjectV2")].URL()+"/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}");
...

    {
        ...
        QByteArray output = ezsignfoldersignerassociation_edit_object_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationEditObjectV2Callback);
    connect(this, &ObjectEzsignfoldersignerassociationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationEditObjectV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignfoldersignerassociation_editObject_v2_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignfoldersignerassociationEditObjectV2Signal(output);
        Q_EMIT ezsignfoldersignerassociationEditObjectV2SignalFull(worker, output);
    } else {
        Q_EMIT ezsignfoldersignerassociationEditObjectV2SignalError(output, error_type, error_str);
        Q_EMIT ezsignfoldersignerassociationEditObjectV2SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationGetObjectV3(const qint32 &pki_ezsignfoldersignerassociation_id) {
    QString fullPath = QString(_serverConfigs["ezsignfoldersignerassociationGetObjectV3"][_serverIndices.value("ezsignfoldersignerassociationGetObjectV3")].URL()+"/3/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationGetObjectV3Callback);
    connect(this, &ObjectEzsignfoldersignerassociationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationGetObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignfoldersignerassociation_getObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignfoldersignerassociationGetObjectV3Signal(output);
        Q_EMIT ezsignfoldersignerassociationGetObjectV3SignalFull(worker, output);
    } else {
        Q_EMIT ezsignfoldersignerassociationGetObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsignfoldersignerassociationGetObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationReassignV1(const qint32 &pki_ezsignfoldersignerassociation_id, const Ezsignfoldersignerassociation_reassign_v1_Request &ezsignfoldersignerassociation_reassign_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsignfoldersignerassociationReassignV1"][_serverIndices.value("ezsignfoldersignerassociationReassignV1")].URL()+"/1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/reassign");
...

    {
        ...
        QByteArray output = ezsignfoldersignerassociation_reassign_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
...
void ObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationReassignV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
