...
#ifndef Branding_Request_H
#define Branding_Request_H
...
class Branding_Request : public Object {
public:
    Branding_Request();
    Branding_Request(QString json);
    ~Branding_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_Request)

#endif // Branding_Request_H
