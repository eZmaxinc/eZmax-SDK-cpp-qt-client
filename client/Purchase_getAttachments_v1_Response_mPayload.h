...
/*
 * Purchase_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/purchase/{pkiPurchaseID}/getAttachments
 */

#ifndef Purchase_getAttachments_v1_Response_mPayload_H
#define Purchase_getAttachments_v1_Response_mPayload_H
...
class Purchase_getAttachments_v1_Response_mPayload : public Object {
public:
    Purchase_getAttachments_v1_Response_mPayload();
    Purchase_getAttachments_v1_Response_mPayload(const QString &json);
    ~Purchase_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Purchase_getAttachments_v1_Response_mPayload)

#endif // Purchase_getAttachments_v1_Response_mPayload_H
