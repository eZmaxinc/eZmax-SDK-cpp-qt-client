...
Ezsignfolder_createObject_v1_Request::Ezsignfolder_createObject_v1_Request(const QString &json) {
...
void Ezsignfolder_createObject_v1_Request::fromJson(const QString &jsonString) {
