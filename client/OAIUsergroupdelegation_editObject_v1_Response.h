...
/*
 * OAIUsergroupdelegation_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroupdelegation/{pkiUsergroupdelegationID}
 */

#ifndef OAIUsergroupdelegation_editObject_v1_Response_H
#define OAIUsergroupdelegation_editObject_v1_Response_H
...
class OAIUsergroupdelegation_editObject_v1_Response : public OAIObject {
public:
    OAIUsergroupdelegation_editObject_v1_Response();
    OAIUsergroupdelegation_editObject_v1_Response(QString json);
    ~OAIUsergroupdelegation_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupdelegation_editObject_v1_Response)

#endif // OAIUsergroupdelegation_editObject_v1_Response_H
