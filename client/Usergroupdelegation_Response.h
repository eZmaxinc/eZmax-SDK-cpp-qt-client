...
#ifndef Usergroupdelegation_Response_H
#define Usergroupdelegation_Response_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupdelegation_Response)

#endif // Usergroupdelegation_Response_H
