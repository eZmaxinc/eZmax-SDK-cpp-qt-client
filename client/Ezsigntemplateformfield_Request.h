...
#ifndef Ezsigntemplateformfield_Request_H
#define Ezsigntemplateformfield_Request_H
...
public:
    ...
    Ezsigntemplateformfield_Request(const QString &json);
    ~Ezsigntemplateformfield_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateformfield_Request)

#endif // Ezsigntemplateformfield_Request_H
