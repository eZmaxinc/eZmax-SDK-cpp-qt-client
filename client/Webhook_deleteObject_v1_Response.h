...
/*
 * Webhook_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/webhook/{pkiWebhookID}
 */

#ifndef Webhook_deleteObject_v1_Response_H
#define Webhook_deleteObject_v1_Response_H
...
class Webhook_deleteObject_v1_Response : public Object {
public:
    Webhook_deleteObject_v1_Response();
    Webhook_deleteObject_v1_Response(const QString &json);
    ~Webhook_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_deleteObject_v1_Response)

#endif // Webhook_deleteObject_v1_Response_H
