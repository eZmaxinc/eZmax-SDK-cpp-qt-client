...
/*
 * OAIUsergroup_createObject_v1_Response.h
 *
 * Response for POST /1/object/usergroup
 */

#ifndef OAIUsergroup_createObject_v1_Response_H
#define OAIUsergroup_createObject_v1_Response_H
...
class OAIUsergroup_createObject_v1_Response : public OAIObject {
public:
    OAIUsergroup_createObject_v1_Response();
    OAIUsergroup_createObject_v1_Response(QString json);
    ~OAIUsergroup_createObject_v1_Response() override;
...
private:
    ...
    OAIUsergroup_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroup_createObject_v1_Response)

#endif // OAIUsergroup_createObject_v1_Response_H
