...
Common_getReport_v1_Response_mPayload::Common_getReport_v1_Response_mPayload(const QString &json) {
...
void Common_getReport_v1_Response_mPayload::fromJson(const QString &jsonString) {
