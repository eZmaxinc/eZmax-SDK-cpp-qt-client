...
#ifndef Contact_Request_H
#define Contact_Request_H
...
class Contact_Request : public Object {
public:
    Contact_Request();
    Contact_Request(const QString &json);
    ~Contact_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Contact_Request)

#endif // Contact_Request_H
