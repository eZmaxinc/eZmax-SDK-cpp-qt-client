...
/*
 * OAIEzsigntemplatesigner_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}
 */

#ifndef OAIEzsigntemplatesigner_editObject_v1_Response_H
#define OAIEzsigntemplatesigner_editObject_v1_Response_H
...
class OAIEzsigntemplatesigner_editObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatesigner_editObject_v1_Response();
    OAIEzsigntemplatesigner_editObject_v1_Response(QString json);
    ~OAIEzsigntemplatesigner_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesigner_editObject_v1_Response)

#endif // OAIEzsigntemplatesigner_editObject_v1_Response_H
