...
Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::Ezsignbulksend_createEzsignbulksendtransmission_v2_Request(const QString &json) {
...
void Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::fromJson(const QString &jsonString) {
...
qint32 Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool Ezsignbulksend_createEzsignbulksendtransmission_v2_Request::is_fki_secretquestion_id_Valid() const{
