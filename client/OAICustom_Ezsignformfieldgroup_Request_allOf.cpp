...
#include "OAICustom_Ezsignformfieldgroup_Request_allOf.h"
...
OAICustom_Ezsignformfieldgroup_Request_allOf::OAICustom_Ezsignformfieldgroup_Request_allOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustom_Ezsignformfieldgroup_Request_allOf::OAICustom_Ezsignformfieldgroup_Request_allOf() {
    this->initializeModel();
}

OAICustom_Ezsignformfieldgroup_Request_allOf::~OAICustom_Ezsignformfieldgroup_Request_allOf() {}

void OAICustom_Ezsignformfieldgroup_Request_allOf::initializeModel() {
...
void OAICustom_Ezsignformfieldgroup_Request_allOf::fromJson(QString jsonString) {
...
void OAICustom_Ezsignformfieldgroup_Request_allOf::fromJsonObject(QJsonObject json) {
...
QString OAICustom_Ezsignformfieldgroup_Request_allOf::asJson() const {
...
QJsonObject OAICustom_Ezsignformfieldgroup_Request_allOf::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICustom_Ezsignformfieldgroup_Request_allOf::getPkiEzsignformfieldgroupId() const {
    return pki_ezsignformfieldgroup_id;
}
void OAICustom_Ezsignformfieldgroup_Request_allOf::setPkiEzsignformfieldgroupId(const qint32 &pki_ezsignformfieldgroup_id) {
    this->pki_ezsignformfieldgroup_id = pki_ezsignformfieldgroup_id;
    this->m_pki_ezsignformfieldgroup_id_isSet = true;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_pki_ezsignformfieldgroup_id_Set() const{
    return m_pki_ezsignformfieldgroup_id_isSet;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_pki_ezsignformfieldgroup_id_Valid() const{
    return m_pki_ezsignformfieldgroup_id_isValid;
}

QString OAICustom_Ezsignformfieldgroup_Request_allOf::getSEzsignformfieldgroupLabel() const {
    return s_ezsignformfieldgroup_label;
}
void OAICustom_Ezsignformfieldgroup_Request_allOf::setSEzsignformfieldgroupLabel(const QString &s_ezsignformfieldgroup_label) {
    this->s_ezsignformfieldgroup_label = s_ezsignformfieldgroup_label;
    this->m_s_ezsignformfieldgroup_label_isSet = true;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_s_ezsignformfieldgroup_label_Set() const{
    return m_s_ezsignformfieldgroup_label_isSet;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_s_ezsignformfieldgroup_label_Valid() const{
    return m_s_ezsignformfieldgroup_label_isValid;
}

QList<OAICustom_Ezsignformfield_Request> OAICustom_Ezsignformfieldgroup_Request_allOf::getAObjEzsignformfield() const {
    return a_obj_ezsignformfield;
}
void OAICustom_Ezsignformfieldgroup_Request_allOf::setAObjEzsignformfield(const QList<OAICustom_Ezsignformfield_Request> &a_obj_ezsignformfield) {
    this->a_obj_ezsignformfield = a_obj_ezsignformfield;
    this->m_a_obj_ezsignformfield_isSet = true;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_a_obj_ezsignformfield_Set() const{
    return m_a_obj_ezsignformfield_isSet;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::is_a_obj_ezsignformfield_Valid() const{
    return m_a_obj_ezsignformfield_isValid;
}

bool OAICustom_Ezsignformfieldgroup_Request_allOf::isSet() const {
...
bool OAICustom_Ezsignformfieldgroup_Request_allOf::isValid() const {
