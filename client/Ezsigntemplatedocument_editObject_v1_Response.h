...
/*
 * Ezsigntemplatedocument_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}
 */

#ifndef Ezsigntemplatedocument_editObject_v1_Response_H
#define Ezsigntemplatedocument_editObject_v1_Response_H
...
class Ezsigntemplatedocument_editObject_v1_Response : public Object {
public:
    Ezsigntemplatedocument_editObject_v1_Response();
    Ezsigntemplatedocument_editObject_v1_Response(const QString &json);
    ~Ezsigntemplatedocument_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatedocument_editObject_v1_Response)

#endif // Ezsigntemplatedocument_editObject_v1_Response_H
