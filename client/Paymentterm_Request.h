...
#ifndef Paymentterm_Request_H
#define Paymentterm_Request_H
...
class Paymentterm_Request : public Object {
public:
    Paymentterm_Request();
    Paymentterm_Request(const QString &json);
    ~Paymentterm_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Paymentterm_Request)

#endif // Paymentterm_Request_H
