...
/*
 * OAIEzsignbulksendsignermapping_Response.h
 *
 * A Ezsignbulksendsignermapping Object
 */

#ifndef OAIEzsignbulksendsignermapping_Response_H
#define OAIEzsignbulksendsignermapping_Response_H
...
class OAIEzsignbulksendsignermapping_Response : public OAIObject {
public:
    OAIEzsignbulksendsignermapping_Response();
    OAIEzsignbulksendsignermapping_Response(QString json);
    ~OAIEzsignbulksendsignermapping_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksendsignermapping_Response)

#endif // OAIEzsignbulksendsignermapping_Response_H
