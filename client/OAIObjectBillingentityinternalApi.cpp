...
#include "OAIObjectBillingentityinternalApi.h"
...
OAIObjectBillingentityinternalApi::OAIObjectBillingentityinternalApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIObjectBillingentityinternalApi::~OAIObjectBillingentityinternalApi() {
}

void OAIObjectBillingentityinternalApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectBillingentityinternalApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectBillingentityinternalApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectBillingentityinternalApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectBillingentityinternalApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectBillingentityinternalApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectBillingentityinternalApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectBillingentityinternalApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectBillingentityinternalApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectBillingentityinternalApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectBillingentityinternalApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectBillingentityinternalApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectBillingentityinternalApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectBillingentityinternalApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectBillingentityinternalApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectBillingentityinternalApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectBillingentityinternalApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectBillingentityinternalApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectBillingentityinternalApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectBillingentityinternalApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectBillingentityinternalApi::billingentityinternalGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectBillingentityinternalApi::billingentityinternalGetAutocompleteV2Callback);
    connect(this, &OAIObjectBillingentityinternalApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectBillingentityinternalApi::billingentityinternalGetAutocompleteV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBillingentityinternal_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectBillingentityinternalApi::tokenAvailable(){
