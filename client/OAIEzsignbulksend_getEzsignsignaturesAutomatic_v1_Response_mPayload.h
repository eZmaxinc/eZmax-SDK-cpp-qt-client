...
/*
 * OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getEzsignsignaturesAutomatic
 */

#ifndef OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
#define OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
...
class OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload();
    OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload(QString json);
    ~OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload)

#endif // OAIEzsignbulksend_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
