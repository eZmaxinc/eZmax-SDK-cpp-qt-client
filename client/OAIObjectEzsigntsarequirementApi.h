...
public:
    ...
    */
    void ezsigntsarequirementGetAutocompleteV1(const QString &s_selector, const ::OpenAPI::OptionalParam<qint32> &fki_ezsignfoldertype_id = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &s_query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language = ::OpenAPI::OptionalParam<OAIHeader_Accept_Language>());
