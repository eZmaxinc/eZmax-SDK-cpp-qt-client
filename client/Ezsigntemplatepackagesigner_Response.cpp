...
Ezsigntemplatepackagesigner_Response::Ezsigntemplatepackagesigner_Response(const QString &json) {
...
void Ezsigntemplatepackagesigner_Response::fromJson(const QString &jsonString) {
...
qint32 Ezsigntemplatepackagesigner_Response::getFkiEzdoctemplatedocumentId() const {
    return m_fki_ezdoctemplatedocument_id;
}
void Ezsigntemplatepackagesigner_Response::setFkiEzdoctemplatedocumentId(const qint32 &fki_ezdoctemplatedocument_id) {
    m_fki_ezdoctemplatedocument_id = fki_ezdoctemplatedocument_id;
    m_fki_ezdoctemplatedocument_id_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_ezdoctemplatedocument_id_Set() const{
    return m_fki_ezdoctemplatedocument_id_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_ezdoctemplatedocument_id_Valid() const{
    return m_fki_ezdoctemplatedocument_id_isValid;
}

qint32 Ezsigntemplatepackagesigner_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Ezsigntemplatepackagesigner_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Ezsigntemplatepackagesigner_Response::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Ezsigntemplatepackagesigner_Response::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

QString Ezsigntemplatepackagesigner_Response::getSEzdoctemplatedocumentNameX() const {
    return m_s_ezdoctemplatedocument_name_x;
}
void Ezsigntemplatepackagesigner_Response::setSEzdoctemplatedocumentNameX(const QString &s_ezdoctemplatedocument_name_x) {
    m_s_ezdoctemplatedocument_name_x = s_ezdoctemplatedocument_name_x;
    m_s_ezdoctemplatedocument_name_x_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_s_ezdoctemplatedocument_name_x_Set() const{
    return m_s_ezdoctemplatedocument_name_x_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_s_ezdoctemplatedocument_name_x_Valid() const{
    return m_s_ezdoctemplatedocument_name_x_isValid;
}

bool Ezsigntemplatepackagesigner_Response::isBEzsigntemplatepackagesignerReceivecopy() const {
    return m_b_ezsigntemplatepackagesigner_receivecopy;
}
void Ezsigntemplatepackagesigner_Response::setBEzsigntemplatepackagesignerReceivecopy(const bool &b_ezsigntemplatepackagesigner_receivecopy) {
...
bool Ezsigntemplatepackagesigner_Response::is_b_ezsigntemplatepackagesigner_receivecopy_Set() const{
    return m_b_ezsigntemplatepackagesigner_receivecopy_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_b_ezsigntemplatepackagesigner_receivecopy_Valid() const{
    return m_b_ezsigntemplatepackagesigner_receivecopy_isValid;
}

Field_eEzsigntemplatepackagesignerMapping Ezsigntemplatepackagesigner_Response::getEEzsigntemplatepackagesignerMapping() const {
    return m_e_ezsigntemplatepackagesigner_mapping;
}
void Ezsigntemplatepackagesigner_Response::setEEzsigntemplatepackagesignerMapping(const Field_eEzsigntemplatepackagesignerMapping &e_ezsigntemplatepackagesigner_mapping) {
...
bool Ezsigntemplatepackagesigner_Response::is_e_ezsigntemplatepackagesigner_mapping_Set() const{
    return m_e_ezsigntemplatepackagesigner_mapping_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_e_ezsigntemplatepackagesigner_mapping_Valid() const{
...
QString Ezsigntemplatepackagesigner_Response::getSUserName() const {
    return m_s_user_name;
}
void Ezsigntemplatepackagesigner_Response::setSUserName(const QString &s_user_name) {
    m_s_user_name = s_user_name;
    m_s_user_name_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_s_user_name_Set() const{
    return m_s_user_name_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_s_user_name_Valid() const{
    return m_s_user_name_isValid;
}

QString Ezsigntemplatepackagesigner_Response::getSUsergroupNameX() const {
    return m_s_usergroup_name_x;
}
void Ezsigntemplatepackagesigner_Response::setSUsergroupNameX(const QString &s_usergroup_name_x) {
    m_s_usergroup_name_x = s_usergroup_name_x;
    m_s_usergroup_name_x_isSet = true;
}

bool Ezsigntemplatepackagesigner_Response::is_s_usergroup_name_x_Set() const{
    return m_s_usergroup_name_x_isSet;
}

bool Ezsigntemplatepackagesigner_Response::is_s_usergroup_name_x_Valid() const{
