...
public:
    ...
    */
    ...
    /**
    * @param[in]  pki_customer_id qint32 [required]
    * @param[in]  customer_import_into_edm_v1_request Customer_importIntoEDM_v1_Request [required]
    */
    virtual void customerImportIntoEDMV1(const qint32 &pki_customer_id, const Customer_importIntoEDM_v1_Request &customer_import_into_edm_v1_request);
...
Q_SIGNALS:
    ...
    Q_DECL_DEPRECATED_X("Use customerImportIntoEDMV1SignalError() instead")
    ...
    Q_DECL_DEPRECATED_X("Use customerImportIntoEDMV1SignalErrorFull() instead")
    void customerImportIntoEDMV1SignalEFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
