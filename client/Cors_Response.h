...
#ifndef Cors_Response_H
#define Cors_Response_H
...
class Cors_Response : public Object {
public:
    Cors_Response();
    Cors_Response(const QString &json);
    ~Cors_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Cors_Response)

#endif // Cors_Response_H
