...
Ezsignsignergroupmembership_Response::Ezsignsignergroupmembership_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignergroupmembership_Response::Ezsignsignergroupmembership_Response() {
    this->initializeModel();
}

Ezsignsignergroupmembership_Response::~Ezsignsignergroupmembership_Response() {}

void Ezsignsignergroupmembership_Response::initializeModel() {
...
void Ezsignsignergroupmembership_Response::fromJson(const QString &jsonString) {
...
void Ezsignsignergroupmembership_Response::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignergroupmembership_Response::asJson() const {
...
QJsonObject Ezsignsignergroupmembership_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignergroupmembership_Response::getPkiEzsignsignergroupmembershipId() const {
    return m_pki_ezsignsignergroupmembership_id;
}
void Ezsignsignergroupmembership_Response::setPkiEzsignsignergroupmembershipId(const qint32 &pki_ezsignsignergroupmembership_id) {
    m_pki_ezsignsignergroupmembership_id = pki_ezsignsignergroupmembership_id;
    m_pki_ezsignsignergroupmembership_id_isSet = true;
}

bool Ezsignsignergroupmembership_Response::is_pki_ezsignsignergroupmembership_id_Set() const{
    return m_pki_ezsignsignergroupmembership_id_isSet;
}

bool Ezsignsignergroupmembership_Response::is_pki_ezsignsignergroupmembership_id_Valid() const{
    return m_pki_ezsignsignergroupmembership_id_isValid;
}

qint32 Ezsignsignergroupmembership_Response::getFkiEzsignsignergroupId() const {
    return m_fki_ezsignsignergroup_id;
}
void Ezsignsignergroupmembership_Response::setFkiEzsignsignergroupId(const qint32 &fki_ezsignsignergroup_id) {
    m_fki_ezsignsignergroup_id = fki_ezsignsignergroup_id;
    m_fki_ezsignsignergroup_id_isSet = true;
}

bool Ezsignsignergroupmembership_Response::is_fki_ezsignsignergroup_id_Set() const{
    return m_fki_ezsignsignergroup_id_isSet;
}

bool Ezsignsignergroupmembership_Response::is_fki_ezsignsignergroup_id_Valid() const{
    return m_fki_ezsignsignergroup_id_isValid;
}

qint32 Ezsignsignergroupmembership_Response::getFkiEzsignsignerId() const {
    return m_fki_ezsignsigner_id;
}
void Ezsignsignergroupmembership_Response::setFkiEzsignsignerId(const qint32 &fki_ezsignsigner_id) {
    m_fki_ezsignsigner_id = fki_ezsignsigner_id;
    m_fki_ezsignsigner_id_isSet = true;
}

bool Ezsignsignergroupmembership_Response::is_fki_ezsignsigner_id_Set() const{
    return m_fki_ezsignsigner_id_isSet;
}

bool Ezsignsignergroupmembership_Response::is_fki_ezsignsigner_id_Valid() const{
    return m_fki_ezsignsigner_id_isValid;
}

qint32 Ezsignsignergroupmembership_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Ezsignsignergroupmembership_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Ezsignsignergroupmembership_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Ezsignsignergroupmembership_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Ezsignsignergroupmembership_Response::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Ezsignsignergroupmembership_Response::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Ezsignsignergroupmembership_Response::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Ezsignsignergroupmembership_Response::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

bool Ezsignsignergroupmembership_Response::isSet() const {
...
bool Ezsignsignergroupmembership_Response::isValid() const {
