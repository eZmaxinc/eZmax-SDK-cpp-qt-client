...
/*
 * OAIUsergroupmembership_Request.h
 *
 * A Usergroupmembership Object
 */

#ifndef OAIUsergroupmembership_Request_H
#define OAIUsergroupmembership_Request_H
...
class OAIUsergroupmembership_Request : public OAIObject {
public:
    OAIUsergroupmembership_Request();
    OAIUsergroupmembership_Request(QString json);
    ~OAIUsergroupmembership_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupmembership_Request)

#endif // OAIUsergroupmembership_Request_H
