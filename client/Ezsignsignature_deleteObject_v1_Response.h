...
/*
 * Ezsignsignature_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignsignature/{pkiEzsignsignatureID}
 */

#ifndef Ezsignsignature_deleteObject_v1_Response_H
#define Ezsignsignature_deleteObject_v1_Response_H
...
class Ezsignsignature_deleteObject_v1_Response : public Object {
public:
    Ezsignsignature_deleteObject_v1_Response();
    Ezsignsignature_deleteObject_v1_Response(const QString &json);
    ~Ezsignsignature_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignature_deleteObject_v1_Response)

#endif // Ezsignsignature_deleteObject_v1_Response_H
