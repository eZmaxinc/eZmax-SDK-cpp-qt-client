...
#ifndef Ezmaxinvoicinguser_Response_H
#define Ezmaxinvoicinguser_Response_H
...
class Ezmaxinvoicinguser_Response : public Object {
public:
    Ezmaxinvoicinguser_Response();
    Ezmaxinvoicinguser_Response(const QString &json);
    ~Ezmaxinvoicinguser_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxinvoicinguser_Response)

#endif // Ezmaxinvoicinguser_Response_H
