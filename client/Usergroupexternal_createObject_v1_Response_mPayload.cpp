...
Usergroupexternal_createObject_v1_Response_mPayload::Usergroupexternal_createObject_v1_Response_mPayload(const QString &json) {
...
void Usergroupexternal_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
