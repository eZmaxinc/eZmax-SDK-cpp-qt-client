...
/*
 * Officetaxreport_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/officetaxreport/{pkiOfficetaxreportID}/getAttachments
 */

#ifndef Officetaxreport_getAttachments_v1_Response_mPayload_H
#define Officetaxreport_getAttachments_v1_Response_mPayload_H
...
class Officetaxreport_getAttachments_v1_Response_mPayload : public Object {
public:
    Officetaxreport_getAttachments_v1_Response_mPayload();
    Officetaxreport_getAttachments_v1_Response_mPayload(const QString &json);
    ~Officetaxreport_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Officetaxreport_getAttachments_v1_Response_mPayload)

#endif // Officetaxreport_getAttachments_v1_Response_mPayload_H
