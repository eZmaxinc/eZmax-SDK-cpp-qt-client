...
Ezsignfolder_ResponseCompound::Ezsignfolder_ResponseCompound(const QString &json) {
...
void Ezsignfolder_ResponseCompound::fromJson(const QString &jsonString) {
...
Field_eEzsignfolderMessageorder Ezsignfolder_ResponseCompound::getEEzsignfolderMessageorder() const {
    return m_e_ezsignfolder_messageorder;
}
void Ezsignfolder_ResponseCompound::setEEzsignfolderMessageorder(const Field_eEzsignfolderMessageorder &e_ezsignfolder_messageorder) {
    m_e_ezsignfolder_messageorder = e_ezsignfolder_messageorder;
    m_e_ezsignfolder_messageorder_isSet = true;
}

bool Ezsignfolder_ResponseCompound::is_e_ezsignfolder_messageorder_Set() const{
    return m_e_ezsignfolder_messageorder_isSet;
}

bool Ezsignfolder_ResponseCompound::is_e_ezsignfolder_messageorder_Valid() const{
