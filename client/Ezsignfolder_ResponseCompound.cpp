...
Object Ezsignfolder_ResponseCompound::getObjEzsignfoldertype() const {
    return m_obj_ezsignfoldertype;
}
void Ezsignfolder_ResponseCompound::setObjEzsignfoldertype(const Object &obj_ezsignfoldertype) {
