...
Variableexpense_editObject_v1_Request::Variableexpense_editObject_v1_Request(const QString &json) {
...
void Variableexpense_editObject_v1_Request::fromJson(const QString &jsonString) {
