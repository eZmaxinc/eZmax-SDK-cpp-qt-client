...
Discussionmembership_Response::Discussionmembership_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Discussionmembership_Response::Discussionmembership_Response() {
    this->initializeModel();
}

Discussionmembership_Response::~Discussionmembership_Response() {}

void Discussionmembership_Response::initializeModel() {
...
void Discussionmembership_Response::fromJson(const QString &jsonString) {
...
void Discussionmembership_Response::fromJsonObject(QJsonObject json) {
...
QString Discussionmembership_Response::asJson() const {
...
QJsonObject Discussionmembership_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Discussionmembership_Response::getPkiDiscussionmembershipId() const {
    return m_pki_discussionmembership_id;
}
void Discussionmembership_Response::setPkiDiscussionmembershipId(const qint32 &pki_discussionmembership_id) {
    m_pki_discussionmembership_id = pki_discussionmembership_id;
    m_pki_discussionmembership_id_isSet = true;
}

bool Discussionmembership_Response::is_pki_discussionmembership_id_Set() const{
    return m_pki_discussionmembership_id_isSet;
}

bool Discussionmembership_Response::is_pki_discussionmembership_id_Valid() const{
    return m_pki_discussionmembership_id_isValid;
}

qint32 Discussionmembership_Response::getFkiDiscussionId() const {
    return m_fki_discussion_id;
}
void Discussionmembership_Response::setFkiDiscussionId(const qint32 &fki_discussion_id) {
    m_fki_discussion_id = fki_discussion_id;
    m_fki_discussion_id_isSet = true;
}

bool Discussionmembership_Response::is_fki_discussion_id_Set() const{
    return m_fki_discussion_id_isSet;
}

bool Discussionmembership_Response::is_fki_discussion_id_Valid() const{
    return m_fki_discussion_id_isValid;
}

qint32 Discussionmembership_Response::getFkiUserId() const {
    return m_fki_user_id;
}
void Discussionmembership_Response::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Discussionmembership_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Discussionmembership_Response::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Discussionmembership_Response::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Discussionmembership_Response::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Discussionmembership_Response::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Discussionmembership_Response::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

qint32 Discussionmembership_Response::getFkiModulesectionId() const {
    return m_fki_modulesection_id;
}
void Discussionmembership_Response::setFkiModulesectionId(const qint32 &fki_modulesection_id) {
    m_fki_modulesection_id = fki_modulesection_id;
    m_fki_modulesection_id_isSet = true;
}

bool Discussionmembership_Response::is_fki_modulesection_id_Set() const{
    return m_fki_modulesection_id_isSet;
}

bool Discussionmembership_Response::is_fki_modulesection_id_Valid() const{
    return m_fki_modulesection_id_isValid;
}

QString Discussionmembership_Response::getSDiscussionmembershipDescription() const {
    return m_s_discussionmembership_description;
}
void Discussionmembership_Response::setSDiscussionmembershipDescription(const QString &s_discussionmembership_description) {
    m_s_discussionmembership_description = s_discussionmembership_description;
    m_s_discussionmembership_description_isSet = true;
}

bool Discussionmembership_Response::is_s_discussionmembership_description_Set() const{
    return m_s_discussionmembership_description_isSet;
}

bool Discussionmembership_Response::is_s_discussionmembership_description_Valid() const{
    return m_s_discussionmembership_description_isValid;
}

QString Discussionmembership_Response::getDtDiscussionmembershipJoined() const {
    return m_dt_discussionmembership_joined;
}
void Discussionmembership_Response::setDtDiscussionmembershipJoined(const QString &dt_discussionmembership_joined) {
    m_dt_discussionmembership_joined = dt_discussionmembership_joined;
    m_dt_discussionmembership_joined_isSet = true;
}

bool Discussionmembership_Response::is_dt_discussionmembership_joined_Set() const{
    return m_dt_discussionmembership_joined_isSet;
}

bool Discussionmembership_Response::is_dt_discussionmembership_joined_Valid() const{
    return m_dt_discussionmembership_joined_isValid;
}

bool Discussionmembership_Response::isSet() const {
...
bool Discussionmembership_Response::isValid() const {
