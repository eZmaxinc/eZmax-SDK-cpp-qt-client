...
Notificationsubsection_Response::Notificationsubsection_Response(const QString &json) {
...
void Notificationsubsection_Response::fromJson(const QString &jsonString) {
