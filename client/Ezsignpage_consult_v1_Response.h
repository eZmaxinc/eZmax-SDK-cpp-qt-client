...
#ifndef Ezsignpage_consult_v1_Response_H
#define Ezsignpage_consult_v1_Response_H
...
class Ezsignpage_consult_v1_Response : public Object {
public:
    Ezsignpage_consult_v1_Response();
    Ezsignpage_consult_v1_Response(const QString &json);
    ~Ezsignpage_consult_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignpage_consult_v1_Response)

#endif // Ezsignpage_consult_v1_Response_H
