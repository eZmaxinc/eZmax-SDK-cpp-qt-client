...
#ifndef Ezsignsigningreason_Response_H
#define Ezsignsigningreason_Response_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsigningreason_Response)

#endif // Ezsignsigningreason_Response_H
