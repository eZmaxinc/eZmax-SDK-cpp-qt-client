...
#ifndef Ezsignbulksenddocumentmapping_Response_H
#define Ezsignbulksenddocumentmapping_Response_H
...
class Ezsignbulksenddocumentmapping_Response : public Object {
public:
    Ezsignbulksenddocumentmapping_Response();
    Ezsignbulksenddocumentmapping_Response(const QString &json);
    ~Ezsignbulksenddocumentmapping_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksenddocumentmapping_Response)

#endif // Ezsignbulksenddocumentmapping_Response_H
