...
Province_AutocompleteElement_Response::Province_AutocompleteElement_Response(const QString &json) {
...
void Province_AutocompleteElement_Response::fromJson(const QString &jsonString) {
