...
Ezsigntemplateformfieldgroup_deleteObject_v1_Response::Ezsigntemplateformfieldgroup_deleteObject_v1_Response(const QString &json) {
...
void Ezsigntemplateformfieldgroup_deleteObject_v1_Response::fromJson(const QString &jsonString) {
