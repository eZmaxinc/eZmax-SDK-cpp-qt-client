...
Billingentityinternal_ResponseCompound::Billingentityinternal_ResponseCompound(const QString &json) {
...
void Billingentityinternal_ResponseCompound::fromJson(const QString &jsonString) {
