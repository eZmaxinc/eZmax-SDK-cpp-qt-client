...
/*
 * Ezsignannotation_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignannotation/{pkiEzsignannotationID}
 */

#ifndef Ezsignannotation_editObject_v1_Response_H
#define Ezsignannotation_editObject_v1_Response_H
...
class Ezsignannotation_editObject_v1_Response : public Object {
public:
    Ezsignannotation_editObject_v1_Response();
    Ezsignannotation_editObject_v1_Response(const QString &json);
    ~Ezsignannotation_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignannotation_editObject_v1_Response)

#endif // Ezsignannotation_editObject_v1_Response_H
