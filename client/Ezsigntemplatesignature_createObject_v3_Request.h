...
/*
 * Ezsigntemplatesignature_createObject_v3_Request.h
 *
 * Request for POST /3/object/ezsigntemplatesignature
 */

#ifndef Ezsigntemplatesignature_createObject_v3_Request_H
#define Ezsigntemplatesignature_createObject_v3_Request_H
...
class Ezsigntemplatesignature_createObject_v3_Request : public Object {
public:
    Ezsigntemplatesignature_createObject_v3_Request();
    Ezsigntemplatesignature_createObject_v3_Request(const QString &json);
    ~Ezsigntemplatesignature_createObject_v3_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_createObject_v3_Request)

#endif // Ezsigntemplatesignature_createObject_v3_Request_H
