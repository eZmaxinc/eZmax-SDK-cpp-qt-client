...
/*
 * Apikey_editObject_v1_Response.h
 *
 * Response for PUT /1/object/apikey/{pkiApikeyID}
 */

#ifndef Apikey_editObject_v1_Response_H
#define Apikey_editObject_v1_Response_H
...
class Apikey_editObject_v1_Response : public Object {
public:
    Apikey_editObject_v1_Response();
    Apikey_editObject_v1_Response(const QString &json);
    ~Apikey_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Apikey_editObject_v1_Response)

#endif // Apikey_editObject_v1_Response_H
