...
/*
 * Ezsignsignergroup_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}
 */

#ifndef Ezsignsignergroup_deleteObject_v1_Response_H
#define Ezsignsignergroup_deleteObject_v1_Response_H
...
class Ezsignsignergroup_deleteObject_v1_Response : public Object {
public:
    Ezsignsignergroup_deleteObject_v1_Response();
    Ezsignsignergroup_deleteObject_v1_Response(const QString &json);
    ~Ezsignsignergroup_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignergroup_deleteObject_v1_Response)

#endif // Ezsignsignergroup_deleteObject_v1_Response_H
