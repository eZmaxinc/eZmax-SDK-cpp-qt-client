...
private:
    ...
    OAIEzsignfoldersignerassociation_getInPersonLoginUrl_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfoldersignerassociation_getInPersonLoginUrl_v1_Response)
