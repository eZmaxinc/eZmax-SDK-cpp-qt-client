...
/*
 * OAIEzsigndocument_applyEzsigntemplate_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate
 */

#ifndef OAIEzsigndocument_applyEzsigntemplate_v1_Response_H
#define OAIEzsigndocument_applyEzsigntemplate_v1_Response_H
...
class OAIEzsigndocument_applyEzsigntemplate_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_applyEzsigntemplate_v1_Response();
    OAIEzsigndocument_applyEzsigntemplate_v1_Response(QString json);
    ~OAIEzsigndocument_applyEzsigntemplate_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_applyEzsigntemplate_v1_Response)

#endif // OAIEzsigndocument_applyEzsigntemplate_v1_Response_H
