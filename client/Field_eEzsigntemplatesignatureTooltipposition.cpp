...
Field_eEzsigntemplatesignatureTooltipposition::Field_eEzsigntemplatesignatureTooltipposition(const QString &json) {
...
void Field_eEzsigntemplatesignatureTooltipposition::fromJson(const QString &jsonString) {
