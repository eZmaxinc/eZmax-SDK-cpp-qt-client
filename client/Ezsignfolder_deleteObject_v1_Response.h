...
/*
 * Ezsignfolder_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignfolder/{pkiEzsignfolderID}
 */

#ifndef Ezsignfolder_deleteObject_v1_Response_H
#define Ezsignfolder_deleteObject_v1_Response_H
...
class Ezsignfolder_deleteObject_v1_Response : public Object {
public:
    Ezsignfolder_deleteObject_v1_Response();
    Ezsignfolder_deleteObject_v1_Response(const QString &json);
    ~Ezsignfolder_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_deleteObject_v1_Response)

#endif // Ezsignfolder_deleteObject_v1_Response_H
