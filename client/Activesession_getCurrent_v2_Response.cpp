...
Activesession_getCurrent_v2_Response::Activesession_getCurrent_v2_Response(const QString &json) {
...
void Activesession_getCurrent_v2_Response::fromJson(const QString &jsonString) {
