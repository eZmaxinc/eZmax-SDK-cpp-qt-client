...
/*
 * OAIEzsignsignature_sign_v1_Response.h
 *
 * Response for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign
 */

#ifndef OAIEzsignsignature_sign_v1_Response_H
#define OAIEzsignsignature_sign_v1_Response_H
...
class OAIEzsignsignature_sign_v1_Response : public OAIObject {
public:
    OAIEzsignsignature_sign_v1_Response();
    OAIEzsignsignature_sign_v1_Response(QString json);
    ~OAIEzsignsignature_sign_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsignsignature_sign_v1_Response)

#endif // OAIEzsignsignature_sign_v1_Response_H
