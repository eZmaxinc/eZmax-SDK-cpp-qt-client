...
/*
 * Ezsigntemplatedocument_getWordsPositions_v1_Request.h
 *
 * Request for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions
 */

#ifndef Ezsigntemplatedocument_getWordsPositions_v1_Request_H
#define Ezsigntemplatedocument_getWordsPositions_v1_Request_H
...
class Ezsigntemplatedocument_getWordsPositions_v1_Request : public Object {
public:
    Ezsigntemplatedocument_getWordsPositions_v1_Request();
    Ezsigntemplatedocument_getWordsPositions_v1_Request(const QString &json);
    ~Ezsigntemplatedocument_getWordsPositions_v1_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatedocument_getWordsPositions_v1_Request)

#endif // Ezsigntemplatedocument_getWordsPositions_v1_Request_H
