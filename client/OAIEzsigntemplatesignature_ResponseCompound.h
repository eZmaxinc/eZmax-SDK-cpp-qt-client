...
private:
    ...
    QList<OAIEzsigntemplatesignaturecustomdate_ResponseCompound> m_a_obj_ezsigntemplatesignaturecustomdate;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesignature_ResponseCompound)
