...
Ezsignuser_getObject_v2_Response_mPayload::Ezsignuser_getObject_v2_Response_mPayload(const QString &json) {
...
void Ezsignuser_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
