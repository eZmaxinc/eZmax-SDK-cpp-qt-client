...
#ifndef Ezsigndiscussion_Response_H
#define Ezsigndiscussion_Response_H
...
class Ezsigndiscussion_Response : public Object {
public:
    Ezsigndiscussion_Response();
    Ezsigndiscussion_Response(const QString &json);
    ~Ezsigndiscussion_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndiscussion_Response)

#endif // Ezsigndiscussion_Response_H
