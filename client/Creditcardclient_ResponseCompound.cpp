...
Creditcardclient_ResponseCompound::Creditcardclient_ResponseCompound(const QString &json) {
...
void Creditcardclient_ResponseCompound::fromJson(const QString &jsonString) {
