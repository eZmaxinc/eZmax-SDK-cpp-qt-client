...
Ezsigntemplate_ResponseCompoundV3::Ezsigntemplate_ResponseCompoundV3(const QString &json) {
...
void Ezsigntemplate_ResponseCompoundV3::fromJson(const QString &jsonString) {
...
QList<Ezsigntemplateannotation_ResponseCompound> Ezsigntemplate_ResponseCompoundV3::getAObjEzsigntemplateannotation() const {
    return m_a_obj_ezsigntemplateannotation;
}
void Ezsigntemplate_ResponseCompoundV3::setAObjEzsigntemplateannotation(const QList<Ezsigntemplateannotation_ResponseCompound> &a_obj_ezsigntemplateannotation) {
    m_a_obj_ezsigntemplateannotation = a_obj_ezsigntemplateannotation;
    m_a_obj_ezsigntemplateannotation_isSet = true;
}

bool Ezsigntemplate_ResponseCompoundV3::is_a_obj_ezsigntemplateannotation_Set() const{
    return m_a_obj_ezsigntemplateannotation_isSet;
}

bool Ezsigntemplate_ResponseCompoundV3::is_a_obj_ezsigntemplateannotation_Valid() const{
