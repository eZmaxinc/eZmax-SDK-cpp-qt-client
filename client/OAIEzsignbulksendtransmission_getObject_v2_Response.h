...
/*
 * OAIEzsignbulksendtransmission_getObject_v2_Response.h
 *
 * Response for GET /2/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}
 */

#ifndef OAIEzsignbulksendtransmission_getObject_v2_Response_H
#define OAIEzsignbulksendtransmission_getObject_v2_Response_H
...
class OAIEzsignbulksendtransmission_getObject_v2_Response : public OAIObject {
public:
    OAIEzsignbulksendtransmission_getObject_v2_Response();
    OAIEzsignbulksendtransmission_getObject_v2_Response(QString json);
    ~OAIEzsignbulksendtransmission_getObject_v2_Response() override;
...
private:
    ...
    OAIEzsignbulksendtransmission_getObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksendtransmission_getObject_v2_Response)

#endif // OAIEzsignbulksendtransmission_getObject_v2_Response_H
