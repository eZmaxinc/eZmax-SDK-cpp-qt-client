...
public:
    ...
    QString getSCreditcardtypeCodename() const;
    void setSCreditcardtypeCodename(const QString &s_creditcardtype_codename);
    bool is_s_creditcardtype_codename_Set() const;
    bool is_s_creditcardtype_codename_Valid() const;
...
private:
    ...
    QString s_creditcardtype_codename;
    bool m_s_creditcardtype_codename_isSet;
    bool m_s_creditcardtype_codename_isValid;
