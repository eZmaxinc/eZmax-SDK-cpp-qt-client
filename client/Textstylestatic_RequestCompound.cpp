...
Textstylestatic_RequestCompound::Textstylestatic_RequestCompound(const QString &json) {
...
void Textstylestatic_RequestCompound::fromJson(const QString &jsonString) {
