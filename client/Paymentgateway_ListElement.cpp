...
bool Paymentgateway_ListElement::isBPaymentgatewayIsactive() const {
    return m_b_paymentgateway_isactive;
}
void Paymentgateway_ListElement::setBPaymentgatewayIsactive(const bool &b_paymentgateway_isactive) {
    m_b_paymentgateway_isactive = b_paymentgateway_isactive;
    m_b_paymentgateway_isactive_isSet = true;
}

bool Paymentgateway_ListElement::is_b_paymentgateway_isactive_Set() const{
    return m_b_paymentgateway_isactive_isSet;
}

bool Paymentgateway_ListElement::is_b_paymentgateway_isactive_Valid() const{
...
bool Paymentgateway_ListElement::isValid() const {
    ...
    return m_pki_paymentgateway_id_isValid && m_fki_creditcardmerchant_id_isValid && m_e_paymentgateway_processor_isValid && m_s_paymentgateway_description_x_isValid && m_b_paymentgateway_isactive_isValid && true;
}
