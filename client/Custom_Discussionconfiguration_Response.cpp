...
Custom_Discussionconfiguration_Response::Custom_Discussionconfiguration_Response(const QString &json) {
...
void Custom_Discussionconfiguration_Response::fromJson(const QString &jsonString) {
