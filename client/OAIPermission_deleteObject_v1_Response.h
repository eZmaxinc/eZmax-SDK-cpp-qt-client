...
/*
 * OAIPermission_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/permission/{pkiPermissionID}
 */

#ifndef OAIPermission_deleteObject_v1_Response_H
#define OAIPermission_deleteObject_v1_Response_H
...
class OAIPermission_deleteObject_v1_Response : public OAIObject {
public:
    OAIPermission_deleteObject_v1_Response();
    OAIPermission_deleteObject_v1_Response(QString json);
    ~OAIPermission_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPermission_deleteObject_v1_Response)

#endif // OAIPermission_deleteObject_v1_Response_H
