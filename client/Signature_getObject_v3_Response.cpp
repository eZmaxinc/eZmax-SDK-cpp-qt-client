...
Signature_getObject_v3_Response::Signature_getObject_v3_Response(const QString &json) {
...
void Signature_getObject_v3_Response::fromJson(const QString &jsonString) {
