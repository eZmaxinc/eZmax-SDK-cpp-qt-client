...
/*
 * OAIEzsignfolder_send_v3_Response.h
 *
 * Response for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/send
 */

#ifndef OAIEzsignfolder_send_v3_Response_H
#define OAIEzsignfolder_send_v3_Response_H
...
class OAIEzsignfolder_send_v3_Response : public OAIObject {
public:
    OAIEzsignfolder_send_v3_Response();
    OAIEzsignfolder_send_v3_Response(QString json);
    ~OAIEzsignfolder_send_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_send_v3_Response)

#endif // OAIEzsignfolder_send_v3_Response_H
