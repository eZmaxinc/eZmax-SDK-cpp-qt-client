...
#ifndef Ezsignfolder_reorder_v2_Response_H
#define Ezsignfolder_reorder_v2_Response_H
...
class Ezsignfolder_reorder_v2_Response : public Object {
public:
    Ezsignfolder_reorder_v2_Response();
    Ezsignfolder_reorder_v2_Response(const QString &json);
    ~Ezsignfolder_reorder_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_reorder_v2_Response)

#endif // Ezsignfolder_reorder_v2_Response_H
