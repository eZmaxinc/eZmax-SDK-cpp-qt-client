...
/*
 * OAIModule_Response.h
 *
 * A Module Object
 */

#ifndef OAIModule_Response_H
#define OAIModule_Response_H
...
class OAIModule_Response : public OAIObject {
public:
    OAIModule_Response();
    OAIModule_Response(QString json);
    ~OAIModule_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIModule_Response)

#endif // OAIModule_Response_H
