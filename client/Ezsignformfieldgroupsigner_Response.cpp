...
Ezsignformfieldgroupsigner_Response::Ezsignformfieldgroupsigner_Response(const QString &json) {
...
void Ezsignformfieldgroupsigner_Response::fromJson(const QString &jsonString) {
