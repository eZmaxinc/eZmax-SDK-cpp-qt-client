...
Phone_RequestCompoundV2::Phone_RequestCompoundV2() {
    this->initializeModel();
}

Phone_RequestCompoundV2::~Phone_RequestCompoundV2() {}

void Phone_RequestCompoundV2::initializeModel() {
...
void Phone_RequestCompoundV2::fromJsonObject(QJsonObject json) {
...
QString Phone_RequestCompoundV2::asJson() const {
...
QJsonObject Phone_RequestCompoundV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 Phone_RequestCompoundV2::getPkiPhoneId() const {
    return m_pki_phone_id;
}
void Phone_RequestCompoundV2::setPkiPhoneId(const qint32 &pki_phone_id) {
    m_pki_phone_id = pki_phone_id;
    m_pki_phone_id_isSet = true;
}

bool Phone_RequestCompoundV2::is_pki_phone_id_Set() const{
    return m_pki_phone_id_isSet;
}

bool Phone_RequestCompoundV2::is_pki_phone_id_Valid() const{
    return m_pki_phone_id_isValid;
}

qint32 Phone_RequestCompoundV2::getFkiPhonetypeId() const {
    return m_fki_phonetype_id;
}
void Phone_RequestCompoundV2::setFkiPhonetypeId(const qint32 &fki_phonetype_id) {
    m_fki_phonetype_id = fki_phonetype_id;
    m_fki_phonetype_id_isSet = true;
}

bool Phone_RequestCompoundV2::is_fki_phonetype_id_Set() const{
    return m_fki_phonetype_id_isSet;
}

bool Phone_RequestCompoundV2::is_fki_phonetype_id_Valid() const{
    return m_fki_phonetype_id_isValid;
}

QString Phone_RequestCompoundV2::getSPhoneExtension() const {
    return m_s_phone_extension;
}
void Phone_RequestCompoundV2::setSPhoneExtension(const QString &s_phone_extension) {
    m_s_phone_extension = s_phone_extension;
    m_s_phone_extension_isSet = true;
}

bool Phone_RequestCompoundV2::is_s_phone_extension_Set() const{
    return m_s_phone_extension_isSet;
}

bool Phone_RequestCompoundV2::is_s_phone_extension_Valid() const{
    return m_s_phone_extension_isValid;
}

QString Phone_RequestCompoundV2::getSPhoneE164() const {
    return m_s_phone_e164;
}
void Phone_RequestCompoundV2::setSPhoneE164(const QString &s_phone_e164) {
    m_s_phone_e164 = s_phone_e164;
    m_s_phone_e164_isSet = true;
}

bool Phone_RequestCompoundV2::is_s_phone_e164_Set() const{
    return m_s_phone_e164_isSet;
}

bool Phone_RequestCompoundV2::is_s_phone_e164_Valid() const{
    return m_s_phone_e164_isValid;
}

bool Phone_RequestCompoundV2::isSet() const {
...
bool Phone_RequestCompoundV2::isValid() const {
