...
OAIEzsignfoldertype_getList_v1_Response::OAIEzsignfoldertype_getList_v1_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEzsignfoldertype_getList_v1_Response::OAIEzsignfoldertype_getList_v1_Response() {
    this->initializeModel();
}

OAIEzsignfoldertype_getList_v1_Response::~OAIEzsignfoldertype_getList_v1_Response() {}

void OAIEzsignfoldertype_getList_v1_Response::initializeModel() {
...
void OAIEzsignfoldertype_getList_v1_Response::fromJson(QString jsonString) {
...
void OAIEzsignfoldertype_getList_v1_Response::fromJsonObject(QJsonObject json) {
...
QString OAIEzsignfoldertype_getList_v1_Response::asJson() const {
...
QJsonObject OAIEzsignfoldertype_getList_v1_Response::asJsonObject() const {
    QJsonObject obj;
    if (m_payload.isSet()) {
...
OAIEzsignfoldertype_getList_v1_Response_mPayload OAIEzsignfoldertype_getList_v1_Response::getMPayload() const {
    return m_payload;
}
void OAIEzsignfoldertype_getList_v1_Response::setMPayload(const OAIEzsignfoldertype_getList_v1_Response_mPayload &m_payload) {
    this->m_payload = m_payload;
    this->m_m_payload_isSet = true;
}

bool OAIEzsignfoldertype_getList_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool OAIEzsignfoldertype_getList_v1_Response::is_m_payload_Valid() const{
...
bool OAIEzsignfoldertype_getList_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool OAIEzsignfoldertype_getList_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

OAICommon_Response_objDebug OAIEzsignfoldertype_getList_v1_Response::getObjDebug() const {
    return obj_debug;
}
void OAIEzsignfoldertype_getList_v1_Response::setObjDebug(const OAICommon_Response_objDebug &obj_debug) {
    this->obj_debug = obj_debug;
    this->m_obj_debug_isSet = true;
}

bool OAIEzsignfoldertype_getList_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool OAIEzsignfoldertype_getList_v1_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

bool OAIEzsignfoldertype_getList_v1_Response::isSet() const {
...
bool OAIEzsignfoldertype_getList_v1_Response::isValid() const {
