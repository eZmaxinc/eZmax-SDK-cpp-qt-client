...
Webhook_regenerateApikey_v1_Response_mPayload::Webhook_regenerateApikey_v1_Response_mPayload(const QString &json) {
...
void Webhook_regenerateApikey_v1_Response_mPayload::fromJson(const QString &jsonString) {
