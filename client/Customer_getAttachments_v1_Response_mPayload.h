...
/*
 * Customer_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/customer/{pkiCustomerID}/getAttachments
 */

#ifndef Customer_getAttachments_v1_Response_mPayload_H
#define Customer_getAttachments_v1_Response_mPayload_H
...
class Customer_getAttachments_v1_Response_mPayload : public Object {
public:
    Customer_getAttachments_v1_Response_mPayload();
    Customer_getAttachments_v1_Response_mPayload(const QString &json);
    ~Customer_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Customer_getAttachments_v1_Response_mPayload)

#endif // Customer_getAttachments_v1_Response_mPayload_H
