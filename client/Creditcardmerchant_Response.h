...
#ifndef Creditcardmerchant_Response_H
#define Creditcardmerchant_Response_H
...
class Creditcardmerchant_Response : public Object {
public:
    Creditcardmerchant_Response();
    Creditcardmerchant_Response(const QString &json);
    ~Creditcardmerchant_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardmerchant_Response)

#endif // Creditcardmerchant_Response_H
