...
/*
 * Discussionmessage_ResponseCompound.h
 *
 * A Discussionmessage Object and children
 */

#ifndef Discussionmessage_ResponseCompound_H
#define Discussionmessage_ResponseCompound_H
...
class Discussionmessage_ResponseCompound : public Object {
public:
    Discussionmessage_ResponseCompound();
    Discussionmessage_ResponseCompound(const QString &json);
    ~Discussionmessage_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussionmessage_ResponseCompound)

#endif // Discussionmessage_ResponseCompound_H
