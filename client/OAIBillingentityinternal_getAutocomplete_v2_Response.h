...
private:
    ...
    OAIBillingentityinternal_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBillingentityinternal_getAutocomplete_v2_Response)
