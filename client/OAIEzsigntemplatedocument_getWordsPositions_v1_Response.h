...
/*
 * OAIEzsigntemplatedocument_getWordsPositions_v1_Response.h
 *
 * Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions
 */

#ifndef OAIEzsigntemplatedocument_getWordsPositions_v1_Response_H
#define OAIEzsigntemplatedocument_getWordsPositions_v1_Response_H
...
class OAIEzsigntemplatedocument_getWordsPositions_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatedocument_getWordsPositions_v1_Response();
    OAIEzsigntemplatedocument_getWordsPositions_v1_Response(QString json);
    ~OAIEzsigntemplatedocument_getWordsPositions_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplatedocument_getWordsPositions_v1_Response)

#endif // OAIEzsigntemplatedocument_getWordsPositions_v1_Response_H
