...
/*
 * Branding_RequestCompound.h
 *
 * A Branding Object and children
 */

#ifndef Branding_RequestCompound_H
#define Branding_RequestCompound_H
...
class Branding_RequestCompound : public Object {
public:
    Branding_RequestCompound();
    Branding_RequestCompound(QString json);
    ~Branding_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_RequestCompound)

#endif // Branding_RequestCompound_H
