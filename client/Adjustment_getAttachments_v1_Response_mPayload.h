...
/*
 * Adjustment_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/adjustment/{pkiAdjustmentID}/getAttachments
 */

#ifndef Adjustment_getAttachments_v1_Response_mPayload_H
#define Adjustment_getAttachments_v1_Response_mPayload_H
...
class Adjustment_getAttachments_v1_Response_mPayload : public Object {
public:
    Adjustment_getAttachments_v1_Response_mPayload();
    Adjustment_getAttachments_v1_Response_mPayload(const QString &json);
    ~Adjustment_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Adjustment_getAttachments_v1_Response_mPayload)

#endif // Adjustment_getAttachments_v1_Response_mPayload_H
