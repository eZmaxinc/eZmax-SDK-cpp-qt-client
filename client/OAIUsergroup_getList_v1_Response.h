...
/*
 * OAIUsergroup_getList_v1_Response.h
 *
 * Response for GET /1/object/usergroup/getList
 */

#ifndef OAIUsergroup_getList_v1_Response_H
#define OAIUsergroup_getList_v1_Response_H
...
class OAIUsergroup_getList_v1_Response : public OAIObject {
public:
    OAIUsergroup_getList_v1_Response();
    OAIUsergroup_getList_v1_Response(QString json);
    ~OAIUsergroup_getList_v1_Response() override;
...
private:
    ...
    OAIUsergroup_getList_v1_Response_mPayload m_m_payload;
