...
/*
 * Ezsigndocument_applyEzsigntemplate_v3_Response.h
 *
 * Response for POST /3/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate
 */

#ifndef Ezsigndocument_applyEzsigntemplate_v3_Response_H
#define Ezsigndocument_applyEzsigntemplate_v3_Response_H
...
class Ezsigndocument_applyEzsigntemplate_v3_Response : public Object {
public:
    Ezsigndocument_applyEzsigntemplate_v3_Response();
    Ezsigndocument_applyEzsigntemplate_v3_Response(const QString &json);
    ~Ezsigndocument_applyEzsigntemplate_v3_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_applyEzsigntemplate_v3_Response)

#endif // Ezsigndocument_applyEzsigntemplate_v3_Response_H
