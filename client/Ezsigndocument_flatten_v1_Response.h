...
#ifndef Ezsigndocument_flatten_v1_Response_H
#define Ezsigndocument_flatten_v1_Response_H
...
class Ezsigndocument_flatten_v1_Response : public Object {
public:
    Ezsigndocument_flatten_v1_Response();
    Ezsigndocument_flatten_v1_Response(const QString &json);
    ~Ezsigndocument_flatten_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_flatten_v1_Response)

#endif // Ezsigndocument_flatten_v1_Response_H
