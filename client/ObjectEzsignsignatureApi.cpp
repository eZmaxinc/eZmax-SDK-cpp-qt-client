...
void ObjectEzsignsignatureApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ezsignsignatureCreateObjectV3", defaultConf);
    _serverIndices.insert("ezsignsignatureCreateObjectV3", 0);
    _serverConfigs.insert("ezsignsignatureCreateObjectV4", defaultConf);
...
void ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV3(const Ezsignsignature_createObject_v3_Request &ezsignsignature_create_object_v3_request) {
    QString fullPath = QString(_serverConfigs["ezsignsignatureCreateObjectV3"][_serverIndices.value("ezsignsignatureCreateObjectV3")].URL()+"/3/object/ezsignsignature");
...

    {
        ...
        QByteArray output = ezsignsignature_create_object_v3_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV3Callback);
    connect(this, &ObjectEzsignsignatureApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsignature_createObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignsignatureCreateObjectV3Signal(output);
        Q_EMIT ezsignsignatureCreateObjectV3SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ezsignsignatureCreateObjectV3SignalE(output, error_type, error_str);
        Q_EMIT ezsignsignatureCreateObjectV3SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ezsignsignatureCreateObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsignsignatureCreateObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}

void ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV4(const Ezsignsignature_createObject_v4_Request &ezsignsignature_create_object_v4_request) {
    QString fullPath = QString(_serverConfigs["ezsignsignatureCreateObjectV4"][_serverIndices.value("ezsignsignatureCreateObjectV4")].URL()+"/4/object/ezsignsignature");
...

    {
        ...
        QByteArray output = ezsignsignature_create_object_v4_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV4Callback);
    connect(this, &ObjectEzsignsignatureApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignsignatureApi::ezsignsignatureCreateObjectV4Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsignature_createObject_v4_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignsignatureCreateObjectV4Signal(output);
        Q_EMIT ezsignsignatureCreateObjectV4SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ezsignsignatureCreateObjectV4SignalE(output, error_type, error_str);
        Q_EMIT ezsignsignatureCreateObjectV4SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ezsignsignatureCreateObjectV4SignalError(output, error_type, error_str);
        Q_EMIT ezsignsignatureCreateObjectV4SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsignsignatureApi::ezsignsignatureEditObjectV3(const qint32 &pki_ezsignsignature_id, const Ezsignsignature_editObject_v3_Request &ezsignsignature_edit_object_v3_request) {
...

    {
        ...
        QByteArray output = ezsignsignature_edit_object_v3_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignsignatureApi::ezsignsignatureEditObjectV3Callback);
    connect(this, &ObjectEzsignsignatureApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignsignatureApi::ezsignsignatureEditObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsignature_editObject_v3_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignsignatureEditObjectV3Signal(output);
        Q_EMIT ezsignsignatureEditObjectV3SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ezsignsignatureEditObjectV3SignalE(output, error_type, error_str);
        Q_EMIT ezsignsignatureEditObjectV3SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ezsignsignatureEditObjectV3SignalError(output, error_type, error_str);
        Q_EMIT ezsignsignatureEditObjectV3SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsignsignatureApi::ezsignsignatureGetObjectV4(const qint32 &pki_ezsignsignature_id) {
    QString fullPath = QString(_serverConfigs["ezsignsignatureGetObjectV4"][_serverIndices.value("ezsignsignatureGetObjectV4")].URL()+"/4/object/ezsignsignature/{pkiEzsignsignatureID}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsignsignatureApi::ezsignsignatureGetObjectV4Callback);
    connect(this, &ObjectEzsignsignatureApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsignsignatureApi::ezsignsignatureGetObjectV4Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsignsignature_getObject_v4_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsignsignatureGetObjectV4Signal(output);
        Q_EMIT ezsignsignatureGetObjectV4SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ezsignsignatureGetObjectV4SignalE(output, error_type, error_str);
        Q_EMIT ezsignsignatureGetObjectV4SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ezsignsignatureGetObjectV4SignalError(output, error_type, error_str);
        Q_EMIT ezsignsignatureGetObjectV4SignalErrorFull(worker, error_type, error_str);
    }
}
