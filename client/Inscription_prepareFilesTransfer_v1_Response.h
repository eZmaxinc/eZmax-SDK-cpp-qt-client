...
/*
 * Inscription_prepareFilesTransfer_v1_Response.h
 *
 * Response for POST /1/object/inscription/{pkiInscriptionID}/prepareFilesTransfer
 */

#ifndef Inscription_prepareFilesTransfer_v1_Response_H
#define Inscription_prepareFilesTransfer_v1_Response_H
...
class Inscription_prepareFilesTransfer_v1_Response_mPayload;
...
public:
    ...
    Inscription_prepareFilesTransfer_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Inscription_prepareFilesTransfer_v1_Response_mPayload &m_payload);
...
private:
    ...
    Inscription_prepareFilesTransfer_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Inscription_prepareFilesTransfer_v1_Response)

#endif // Inscription_prepareFilesTransfer_v1_Response_H
