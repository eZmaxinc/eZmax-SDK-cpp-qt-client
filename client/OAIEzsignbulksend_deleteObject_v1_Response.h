...
/*
 * OAIEzsignbulksend_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignbulksend/{pkiEzsignbulksendID}
 */

#ifndef OAIEzsignbulksend_deleteObject_v1_Response_H
#define OAIEzsignbulksend_deleteObject_v1_Response_H
...
class OAIEzsignbulksend_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsignbulksend_deleteObject_v1_Response();
    OAIEzsignbulksend_deleteObject_v1_Response(QString json);
    ~OAIEzsignbulksend_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksend_deleteObject_v1_Response)

#endif // OAIEzsignbulksend_deleteObject_v1_Response_H
