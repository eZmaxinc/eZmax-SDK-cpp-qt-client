...
void User_Response::initializeModel() {
...
void User_Response::fromJsonObject(QJsonObject json) {
...
QString User_Response::asJson() const {
...
QJsonObject User_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 User_Response::getPkiUserId() const {
    return m_pki_user_id;
}
void User_Response::setPkiUserId(const qint32 &pki_user_id) {
    m_pki_user_id = pki_user_id;
    m_pki_user_id_isSet = true;
}

bool User_Response::is_pki_user_id_Set() const{
    return m_pki_user_id_isSet;
}

bool User_Response::is_pki_user_id_Valid() const{
    return m_pki_user_id_isValid;
}

qint32 User_Response::getFkiAgentId() const {
    return m_fki_agent_id;
}
void User_Response::setFkiAgentId(const qint32 &fki_agent_id) {
    m_fki_agent_id = fki_agent_id;
    m_fki_agent_id_isSet = true;
}

bool User_Response::is_fki_agent_id_Set() const{
    return m_fki_agent_id_isSet;
}

bool User_Response::is_fki_agent_id_Valid() const{
    return m_fki_agent_id_isValid;
}

qint32 User_Response::getFkiBrokerId() const {
    return m_fki_broker_id;
}
void User_Response::setFkiBrokerId(const qint32 &fki_broker_id) {
    m_fki_broker_id = fki_broker_id;
    m_fki_broker_id_isSet = true;
}

bool User_Response::is_fki_broker_id_Set() const{
    return m_fki_broker_id_isSet;
}

bool User_Response::is_fki_broker_id_Valid() const{
    return m_fki_broker_id_isValid;
}

qint32 User_Response::getFkiAssistantId() const {
    return m_fki_assistant_id;
}
void User_Response::setFkiAssistantId(const qint32 &fki_assistant_id) {
    m_fki_assistant_id = fki_assistant_id;
    m_fki_assistant_id_isSet = true;
}

bool User_Response::is_fki_assistant_id_Set() const{
    return m_fki_assistant_id_isSet;
}

bool User_Response::is_fki_assistant_id_Valid() const{
    return m_fki_assistant_id_isValid;
}

qint32 User_Response::getFkiEmployeeId() const {
    return m_fki_employee_id;
}
void User_Response::setFkiEmployeeId(const qint32 &fki_employee_id) {
    m_fki_employee_id = fki_employee_id;
    m_fki_employee_id_isSet = true;
}

bool User_Response::is_fki_employee_id_Set() const{
...
void User_Response::setFkiCompanyIdDefault(const qint32 &fki_company_id_default) {
    m_fki_company_id_default = fki_company_id_default;
    m_fki_company_id_default_isSet = true;
}

bool User_Response::is_fki_company_id_default_Set() const{
    return m_fki_company_id_default_isSet;
}

bool User_Response::is_fki_company_id_default_Valid() const{
    return m_fki_company_id_default_isValid;
}

QString User_Response::getSCompanyNameX() const {
    return m_s_company_name_x;
}
void User_Response::setSCompanyNameX(const QString &s_company_name_x) {
    m_s_company_name_x = s_company_name_x;
    m_s_company_name_x_isSet = true;
}

bool User_Response::is_s_company_name_x_Set() const{
    return m_s_company_name_x_isSet;
}

bool User_Response::is_s_company_name_x_Valid() const{
    return m_s_company_name_x_isValid;
}

qint32 User_Response::getFkiDepartmentIdDefault() const {
    return m_fki_department_id_default;
}
void User_Response::setFkiDepartmentIdDefault(const qint32 &fki_department_id_default) {
    m_fki_department_id_default = fki_department_id_default;
    m_fki_department_id_default_isSet = true;
}

bool User_Response::is_fki_department_id_default_Set() const{
    return m_fki_department_id_default_isSet;
}

bool User_Response::is_fki_department_id_default_Valid() const{
    return m_fki_department_id_default_isValid;
}

QString User_Response::getSDepartmentNameX() const {
    return m_s_department_name_x;
}
void User_Response::setSDepartmentNameX(const QString &s_department_name_x) {
    m_s_department_name_x = s_department_name_x;
    m_s_department_name_x_isSet = true;
}

bool User_Response::is_s_department_name_x_Set() const{
    return m_s_department_name_x_isSet;
}

bool User_Response::is_s_department_name_x_Valid() const{
    return m_s_department_name_x_isValid;
}

qint32 User_Response::getFkiTimezoneId() const {
    return m_fki_timezone_id;
}
void User_Response::setFkiTimezoneId(const qint32 &fki_timezone_id) {
    m_fki_timezone_id = fki_timezone_id;
    m_fki_timezone_id_isSet = true;
}

bool User_Response::is_fki_timezone_id_Set() const{
    return m_fki_timezone_id_isSet;
}

bool User_Response::is_fki_timezone_id_Valid() const{
    return m_fki_timezone_id_isValid;
}

QString User_Response::getSTimezoneName() const {
    return m_s_timezone_name;
}
void User_Response::setSTimezoneName(const QString &s_timezone_name) {
    m_s_timezone_name = s_timezone_name;
    m_s_timezone_name_isSet = true;
}

bool User_Response::is_s_timezone_name_Set() const{
    return m_s_timezone_name_isSet;
}

bool User_Response::is_s_timezone_name_Valid() const{
    return m_s_timezone_name_isValid;
}

qint32 User_Response::getFkiLanguageId() const {
    return m_fki_language_id;
}
void User_Response::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool User_Response::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool User_Response::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

QString User_Response::getSLanguageNameX() const {
    return m_s_language_name_x;
}
void User_Response::setSLanguageNameX(const QString &s_language_name_x) {
    m_s_language_name_x = s_language_name_x;
    m_s_language_name_x_isSet = true;
}

bool User_Response::is_s_language_name_x_Set() const{
    return m_s_language_name_x_isSet;
}

bool User_Response::is_s_language_name_x_Valid() const{
    return m_s_language_name_x_isValid;
}

Email_ResponseCompound User_Response::getObjEmail() const {
    return m_obj_email;
}
void User_Response::setObjEmail(const Email_ResponseCompound &obj_email) {
    m_obj_email = obj_email;
    m_obj_email_isSet = true;
}

bool User_Response::is_obj_email_Set() const{
    return m_obj_email_isSet;
}

bool User_Response::is_obj_email_Valid() const{
    return m_obj_email_isValid;
}

qint32 User_Response::getFkiBillingentityinternalId() const {
    return m_fki_billingentityinternal_id;
}
void User_Response::setFkiBillingentityinternalId(const qint32 &fki_billingentityinternal_id) {
    m_fki_billingentityinternal_id = fki_billingentityinternal_id;
    m_fki_billingentityinternal_id_isSet = true;
}

bool User_Response::is_fki_billingentityinternal_id_Set() const{
    return m_fki_billingentityinternal_id_isSet;
}

bool User_Response::is_fki_billingentityinternal_id_Valid() const{
    return m_fki_billingentityinternal_id_isValid;
}

QString User_Response::getSBillingentityinternalDescriptionX() const {
    return m_s_billingentityinternal_description_x;
}
void User_Response::setSBillingentityinternalDescriptionX(const QString &s_billingentityinternal_description_x) {
...
bool User_Response::is_s_billingentityinternal_description_x_Set() const{
    return m_s_billingentityinternal_description_x_isSet;
}

bool User_Response::is_s_billingentityinternal_description_x_Valid() const{
    return m_s_billingentityinternal_description_x_isValid;
}

Phone_ResponseCompound User_Response::getObjPhoneHome() const {
    return m_obj_phone_home;
}
void User_Response::setObjPhoneHome(const Phone_ResponseCompound &obj_phone_home) {
    m_obj_phone_home = obj_phone_home;
    m_obj_phone_home_isSet = true;
}

bool User_Response::is_obj_phone_home_Set() const{
    return m_obj_phone_home_isSet;
}

bool User_Response::is_obj_phone_home_Valid() const{
    return m_obj_phone_home_isValid;
}

Phone_ResponseCompound User_Response::getObjPhoneSms() const {
    return m_obj_phone_sms;
}
void User_Response::setObjPhoneSms(const Phone_ResponseCompound &obj_phone_sms) {
    m_obj_phone_sms = obj_phone_sms;
    m_obj_phone_sms_isSet = true;
}

bool User_Response::is_obj_phone_sms_Set() const{
    return m_obj_phone_sms_isSet;
}

bool User_Response::is_obj_phone_sms_Valid() const{
    return m_obj_phone_sms_isValid;
}

qint32 User_Response::getFkiSecretquestionId() const {
    return m_fki_secretquestion_id;
}
void User_Response::setFkiSecretquestionId(const qint32 &fki_secretquestion_id) {
    m_fki_secretquestion_id = fki_secretquestion_id;
    m_fki_secretquestion_id_isSet = true;
}

bool User_Response::is_fki_secretquestion_id_Set() const{
    return m_fki_secretquestion_id_isSet;
}

bool User_Response::is_fki_secretquestion_id_Valid() const{
    return m_fki_secretquestion_id_isValid;
}

qint32 User_Response::getFkiModuleIdForm() const {
    return m_fki_module_id_form;
}
void User_Response::setFkiModuleIdForm(const qint32 &fki_module_id_form) {
    m_fki_module_id_form = fki_module_id_form;
    m_fki_module_id_form_isSet = true;
}

bool User_Response::is_fki_module_id_form_Set() const{
    return m_fki_module_id_form_isSet;
}

bool User_Response::is_fki_module_id_form_Valid() const{
    return m_fki_module_id_form_isValid;
}

QString User_Response::getSModuleNameX() const {
    return m_s_module_name_x;
}
void User_Response::setSModuleNameX(const QString &s_module_name_x) {
    m_s_module_name_x = s_module_name_x;
    m_s_module_name_x_isSet = true;
}

bool User_Response::is_s_module_name_x_Set() const{
    return m_s_module_name_x_isSet;
}

bool User_Response::is_s_module_name_x_Valid() const{
    return m_s_module_name_x_isValid;
}

Field_eUserOrigin User_Response::getEUserOrigin() const {
    return m_e_user_origin;
}
void User_Response::setEUserOrigin(const Field_eUserOrigin &e_user_origin) {
    m_e_user_origin = e_user_origin;
    m_e_user_origin_isSet = true;
}

bool User_Response::is_e_user_origin_Set() const{
    return m_e_user_origin_isSet;
}

bool User_Response::is_e_user_origin_Valid() const{
    return m_e_user_origin_isValid;
}

Field_eUserType User_Response::getEUserType() const {
    return m_e_user_type;
}
void User_Response::setEUserType(const Field_eUserType &e_user_type) {
    m_e_user_type = e_user_type;
    m_e_user_type_isSet = true;
}

bool User_Response::is_e_user_type_Set() const{
    return m_e_user_type_isSet;
}

bool User_Response::is_e_user_type_Valid() const{
    return m_e_user_type_isValid;
}

Field_eUserLogintype User_Response::getEUserLogintype() const {
    return m_e_user_logintype;
}
void User_Response::setEUserLogintype(const Field_eUserLogintype &e_user_logintype) {
    m_e_user_logintype = e_user_logintype;
    m_e_user_logintype_isSet = true;
}

bool User_Response::is_e_user_logintype_Set() const{
    return m_e_user_logintype_isSet;
}

bool User_Response::is_e_user_logintype_Valid() const{
    return m_e_user_logintype_isValid;
}

QString User_Response::getSUserFirstname() const {
    return m_s_user_firstname;
}
void User_Response::setSUserFirstname(const QString &s_user_firstname) {
    m_s_user_firstname = s_user_firstname;
    m_s_user_firstname_isSet = true;
}

bool User_Response::is_s_user_firstname_Set() const{
    return m_s_user_firstname_isSet;
}

bool User_Response::is_s_user_firstname_Valid() const{
    return m_s_user_firstname_isValid;
}

QString User_Response::getSUserLastname() const {
    return m_s_user_lastname;
}
void User_Response::setSUserLastname(const QString &s_user_lastname) {
    m_s_user_lastname = s_user_lastname;
    m_s_user_lastname_isSet = true;
}

bool User_Response::is_s_user_lastname_Set() const{
    return m_s_user_lastname_isSet;
}

bool User_Response::is_s_user_lastname_Valid() const{
    return m_s_user_lastname_isValid;
}

QString User_Response::getSUserLoginname() const {
    return m_s_user_loginname;
}
void User_Response::setSUserLoginname(const QString &s_user_loginname) {
    m_s_user_loginname = s_user_loginname;
    m_s_user_loginname_isSet = true;
}

bool User_Response::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool User_Response::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString User_Response::getSUserJobtitle() const {
    return m_s_user_jobtitle;
}
void User_Response::setSUserJobtitle(const QString &s_user_jobtitle) {
    m_s_user_jobtitle = s_user_jobtitle;
    m_s_user_jobtitle_isSet = true;
}

bool User_Response::is_s_user_jobtitle_Set() const{
    return m_s_user_jobtitle_isSet;
}

bool User_Response::is_s_user_jobtitle_Valid() const{
    return m_s_user_jobtitle_isValid;
}

Field_eUserEzsignaccess User_Response::getEUserEzsignaccess() const {
    return m_e_user_ezsignaccess;
}
void User_Response::setEUserEzsignaccess(const Field_eUserEzsignaccess &e_user_ezsignaccess) {
    m_e_user_ezsignaccess = e_user_ezsignaccess;
    m_e_user_ezsignaccess_isSet = true;
}

bool User_Response::is_e_user_ezsignaccess_Set() const{
    return m_e_user_ezsignaccess_isSet;
}

bool User_Response::is_e_user_ezsignaccess_Valid() const{
    return m_e_user_ezsignaccess_isValid;
}

QString User_Response::getDtUserLastlogondate() const {
    return m_dt_user_lastlogondate;
}
void User_Response::setDtUserLastlogondate(const QString &dt_user_lastlogondate) {
    m_dt_user_lastlogondate = dt_user_lastlogondate;
    m_dt_user_lastlogondate_isSet = true;
}

bool User_Response::is_dt_user_lastlogondate_Set() const{
    return m_dt_user_lastlogondate_isSet;
}

bool User_Response::is_dt_user_lastlogondate_Valid() const{
    return m_dt_user_lastlogondate_isValid;
}

QString User_Response::getDtUserPasswordchanged() const {
    return m_dt_user_passwordchanged;
}
void User_Response::setDtUserPasswordchanged(const QString &dt_user_passwordchanged) {
    m_dt_user_passwordchanged = dt_user_passwordchanged;
    m_dt_user_passwordchanged_isSet = true;
}

bool User_Response::is_dt_user_passwordchanged_Set() const{
    return m_dt_user_passwordchanged_isSet;
}

bool User_Response::is_dt_user_passwordchanged_Valid() const{
    return m_dt_user_passwordchanged_isValid;
}

QString User_Response::getDtUserEzsignprepaidexpiration() const {
    return m_dt_user_ezsignprepaidexpiration;
}
void User_Response::setDtUserEzsignprepaidexpiration(const QString &dt_user_ezsignprepaidexpiration) {
    m_dt_user_ezsignprepaidexpiration = dt_user_ezsignprepaidexpiration;
    m_dt_user_ezsignprepaidexpiration_isSet = true;
}

bool User_Response::is_dt_user_ezsignprepaidexpiration_Set() const{
    return m_dt_user_ezsignprepaidexpiration_isSet;
}

bool User_Response::is_dt_user_ezsignprepaidexpiration_Valid() const{
    return m_dt_user_ezsignprepaidexpiration_isValid;
}

bool User_Response::isBUserIsactive() const {
    return m_b_user_isactive;
}
void User_Response::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool User_Response::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool User_Response::is_b_user_isactive_Valid() const{
...
void User_Response::setBUserValidatebyadministration(const bool &b_user_validatebyadministration) {
    m_b_user_validatebyadministration = b_user_validatebyadministration;
    m_b_user_validatebyadministration_isSet = true;
}

bool User_Response::is_b_user_validatebyadministration_Set() const{
    return m_b_user_validatebyadministration_isSet;
}

bool User_Response::is_b_user_validatebyadministration_Valid() const{
    return m_b_user_validatebyadministration_isValid;
}

bool User_Response::isBUserValidatebydirector() const {
    return m_b_user_validatebydirector;
}
void User_Response::setBUserValidatebydirector(const bool &b_user_validatebydirector) {
    m_b_user_validatebydirector = b_user_validatebydirector;
    m_b_user_validatebydirector_isSet = true;
}

bool User_Response::is_b_user_validatebydirector_Set() const{
    return m_b_user_validatebydirector_isSet;
}

bool User_Response::is_b_user_validatebydirector_Valid() const{
    return m_b_user_validatebydirector_isValid;
}

bool User_Response::isBUserAttachmentautoverified() const {
    return m_b_user_attachmentautoverified;
}
void User_Response::setBUserAttachmentautoverified(const bool &b_user_attachmentautoverified) {
    m_b_user_attachmentautoverified = b_user_attachmentautoverified;
    m_b_user_attachmentautoverified_isSet = true;
}

bool User_Response::is_b_user_attachmentautoverified_Set() const{
    return m_b_user_attachmentautoverified_isSet;
}

bool User_Response::is_b_user_attachmentautoverified_Valid() const{
    return m_b_user_attachmentautoverified_isValid;
}

bool User_Response::isBUserChangepassword() const {
    return m_b_user_changepassword;
}
void User_Response::setBUserChangepassword(const bool &b_user_changepassword) {
    m_b_user_changepassword = b_user_changepassword;
    m_b_user_changepassword_isSet = true;
}

bool User_Response::is_b_user_changepassword_Set() const{
    return m_b_user_changepassword_isSet;
}

bool User_Response::is_b_user_changepassword_Valid() const{
...
void User_Response::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool User_Response::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool User_Response::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool User_Response::isSet() const {
...
bool User_Response::isValid() const {
