...
/*
 * OAIEzsigntemplate_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplate/{pkiEzsigntemplateID}
 */

#ifndef OAIEzsigntemplate_deleteObject_v1_Response_H
#define OAIEzsigntemplate_deleteObject_v1_Response_H
...
class OAIEzsigntemplate_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplate_deleteObject_v1_Response();
    OAIEzsigntemplate_deleteObject_v1_Response(QString json);
    ~OAIEzsigntemplate_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplate_deleteObject_v1_Response)

#endif // OAIEzsigntemplate_deleteObject_v1_Response_H
