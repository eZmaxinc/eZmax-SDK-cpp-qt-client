...
/*
 * OAIUsergroupdelegation_ResponseCompound.h
 *
 * A Usergroupdelegation Object
 */

#ifndef OAIUsergroupdelegation_ResponseCompound_H
#define OAIUsergroupdelegation_ResponseCompound_H
...
public:
    OAIUsergroupdelegation_ResponseCompound();
    OAIUsergroupdelegation_ResponseCompound(QString json);
    ~OAIUsergroupdelegation_ResponseCompound() override;
