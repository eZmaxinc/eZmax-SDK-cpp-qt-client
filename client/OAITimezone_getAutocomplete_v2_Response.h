...
/*
 * OAITimezone_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/timezone/getAutocomplete
 */

#ifndef OAITimezone_getAutocomplete_v2_Response_H
#define OAITimezone_getAutocomplete_v2_Response_H
...
class OAITimezone_getAutocomplete_v2_Response : public OAIObject {
public:
    OAITimezone_getAutocomplete_v2_Response();
    OAITimezone_getAutocomplete_v2_Response(QString json);
    ~OAITimezone_getAutocomplete_v2_Response() override;
...
private:
    ...
    OAITimezone_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAITimezone_getAutocomplete_v2_Response)

#endif // OAITimezone_getAutocomplete_v2_Response_H
