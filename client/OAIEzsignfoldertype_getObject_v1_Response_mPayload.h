...
/*
 * OAIEzsignfoldertype_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef OAIEzsignfoldertype_getObject_v1_Response_mPayload_H
#define OAIEzsignfoldertype_getObject_v1_Response_mPayload_H
...
class OAIEzsignfoldertype_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsignfoldertype_getObject_v1_Response_mPayload();
    OAIEzsignfoldertype_getObject_v1_Response_mPayload(QString json);
    ~OAIEzsignfoldertype_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsignfoldertype_getObject_v1_Response_mPayload)

#endif // OAIEzsignfoldertype_getObject_v1_Response_mPayload_H
