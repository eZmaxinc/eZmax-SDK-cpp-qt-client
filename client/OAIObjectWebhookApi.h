...
public:
    ...
    * @param[in]  pki_webhook_id qint32 [required]
    */
    void webhookTestUrlV1(const qint32 &pki_webhook_id);
...
private:
    ...
    void webhookTestUrlV1Callback(OAIHttpRequestWorker *worker);
...
signals:
    ...
    void webhookTestUrlV1Signal(OAIWebhook_test_v1_Response summary);
    ...
    void webhookTestUrlV1SignalFull(OAIHttpRequestWorker *worker, OAIWebhook_test_v1_Response summary);
    ...
    void webhookTestUrlV1SignalE(OAIWebhook_test_v1_Response summary, QNetworkReply::NetworkError error_type, QString error_str);
    ...
    void webhookTestUrlV1SignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
