...
/*
 * Inscriptionchecklist_getAutocomplete_v3_Response.h
 *
 * Response for GET /3/object/inscriptionchecklist/getAutocomplete
 */

#ifndef Inscriptionchecklist_getAutocomplete_v3_Response_H
#define Inscriptionchecklist_getAutocomplete_v3_Response_H
...
class Inscriptionchecklist_getAutocomplete_v3_Response_mPayload;
...
public:
    ...
    Inscriptionchecklist_getAutocomplete_v3_Response_mPayload getMPayload() const;
    void setMPayload(const Inscriptionchecklist_getAutocomplete_v3_Response_mPayload &m_payload);
...
private:
    ...
    Inscriptionchecklist_getAutocomplete_v3_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Inscriptionchecklist_getAutocomplete_v3_Response)

#endif // Inscriptionchecklist_getAutocomplete_v3_Response_H
