...
/*
 * User_sendPasswordReset_v1_Response.h
 *
 * Response for POST /1/object/user/{pkiUserID}/sendPasswordReset
 */

#ifndef User_sendPasswordReset_v1_Response_H
#define User_sendPasswordReset_v1_Response_H
...
class User_sendPasswordReset_v1_Response : public Object {
public:
    User_sendPasswordReset_v1_Response();
    User_sendPasswordReset_v1_Response(const QString &json);
    ~User_sendPasswordReset_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::User_sendPasswordReset_v1_Response)

#endif // User_sendPasswordReset_v1_Response_H
