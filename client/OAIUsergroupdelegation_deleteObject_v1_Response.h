...
/*
 * OAIUsergroupdelegation_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/usergroupdelegation/{pkiUsergroupdelegationID}
 */

#ifndef OAIUsergroupdelegation_deleteObject_v1_Response_H
#define OAIUsergroupdelegation_deleteObject_v1_Response_H
...
class OAIUsergroupdelegation_deleteObject_v1_Response : public OAIObject {
public:
    OAIUsergroupdelegation_deleteObject_v1_Response();
    OAIUsergroupdelegation_deleteObject_v1_Response(QString json);
    ~OAIUsergroupdelegation_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupdelegation_deleteObject_v1_Response)

#endif // OAIUsergroupdelegation_deleteObject_v1_Response_H
