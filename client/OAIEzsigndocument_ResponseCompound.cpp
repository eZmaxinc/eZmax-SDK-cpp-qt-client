...
qint32 OAIEzsigndocument_ResponseCompound::getFkiEzsignfoldersignerassociationIdDeclinedtosign() const {
    return m_fki_ezsignfoldersignerassociation_id_declinedtosign;
}
void OAIEzsigndocument_ResponseCompound::setFkiEzsignfoldersignerassociationIdDeclinedtosign(const qint32 &fki_ezsignfoldersignerassociation_id_declinedtosign) {
...
bool OAIEzsigndocument_ResponseCompound::is_fki_ezsignfoldersignerassociation_id_declinedtosign_Set() const{
    return m_fki_ezsignfoldersignerassociation_id_declinedtosign_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_fki_ezsignfoldersignerassociation_id_declinedtosign_Valid() const{
...
QString OAIEzsigndocument_ResponseCompound::getDtEzsignformCompleted() const {
    return m_dt_ezsignform_completed;
}
void OAIEzsigndocument_ResponseCompound::setDtEzsignformCompleted(const QString &dt_ezsignform_completed) {
    m_dt_ezsignform_completed = dt_ezsignform_completed;
    m_dt_ezsignform_completed_isSet = true;
}

bool OAIEzsigndocument_ResponseCompound::is_dt_ezsignform_completed_Set() const{
    return m_dt_ezsignform_completed_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_dt_ezsignform_completed_Valid() const{
...
QString OAIEzsigndocument_ResponseCompound::getTEzsigndocumentDeclinedtosignreason() const {
    return m_t_ezsigndocument_declinedtosignreason;
}
void OAIEzsigndocument_ResponseCompound::setTEzsigndocumentDeclinedtosignreason(const QString &t_ezsigndocument_declinedtosignreason) {
...
bool OAIEzsigndocument_ResponseCompound::is_t_ezsigndocument_declinedtosignreason_Set() const{
    return m_t_ezsigndocument_declinedtosignreason_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_t_ezsigndocument_declinedtosignreason_Valid() const{
...
bool OAIEzsigndocument_ResponseCompound::isBEzsigndocumentEzsignform() const {
    return m_b_ezsigndocument_ezsignform;
}
void OAIEzsigndocument_ResponseCompound::setBEzsigndocumentEzsignform(const bool &b_ezsigndocument_ezsignform) {
    m_b_ezsigndocument_ezsignform = b_ezsigndocument_ezsignform;
    m_b_ezsigndocument_ezsignform_isSet = true;
}

bool OAIEzsigndocument_ResponseCompound::is_b_ezsigndocument_ezsignform_Set() const{
    return m_b_ezsigndocument_ezsignform_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_b_ezsigndocument_ezsignform_Valid() const{
    return m_b_ezsigndocument_ezsignform_isValid;
}

bool OAIEzsigndocument_ResponseCompound::isBEzsigndocumentHassignedsignatures() const {
    return m_b_ezsigndocument_hassignedsignatures;
}
void OAIEzsigndocument_ResponseCompound::setBEzsigndocumentHassignedsignatures(const bool &b_ezsigndocument_hassignedsignatures) {
...
bool OAIEzsigndocument_ResponseCompound::is_b_ezsigndocument_hassignedsignatures_Set() const{
    return m_b_ezsigndocument_hassignedsignatures_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_b_ezsigndocument_hassignedsignatures_Valid() const{
...
QString OAIEzsigndocument_ResponseCompound::getSEzsigndocumentExternalid() const {
    return m_s_ezsigndocument_externalid;
}
void OAIEzsigndocument_ResponseCompound::setSEzsigndocumentExternalid(const QString &s_ezsigndocument_externalid) {
    m_s_ezsigndocument_externalid = s_ezsigndocument_externalid;
    m_s_ezsigndocument_externalid_isSet = true;
}

bool OAIEzsigndocument_ResponseCompound::is_s_ezsigndocument_externalid_Set() const{
    return m_s_ezsigndocument_externalid_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_s_ezsigndocument_externalid_Valid() const{
    return m_s_ezsigndocument_externalid_isValid;
}

OAIComputed_eEzsigndocumentSteptype OAIEzsigndocument_ResponseCompound::getEEzsigndocumentSteptype() const {
    return m_e_ezsigndocument_steptype;
}
void OAIEzsigndocument_ResponseCompound::setEEzsigndocumentSteptype(const OAIComputed_eEzsigndocumentSteptype &e_ezsigndocument_steptype) {
    m_e_ezsigndocument_steptype = e_ezsigndocument_steptype;
    m_e_ezsigndocument_steptype_isSet = true;
}

bool OAIEzsigndocument_ResponseCompound::is_e_ezsigndocument_steptype_Set() const{
    return m_e_ezsigndocument_steptype_isSet;
}

bool OAIEzsigndocument_ResponseCompound::is_e_ezsigndocument_steptype_Valid() const{
