...
#ifndef Ezsignformfield_Response_H
#define Ezsignformfield_Response_H
...
class Ezsignformfield_Response : public Object {
public:
    Ezsignformfield_Response();
    Ezsignformfield_Response(const QString &json);
    ~Ezsignformfield_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignformfield_Response)

#endif // Ezsignformfield_Response_H
