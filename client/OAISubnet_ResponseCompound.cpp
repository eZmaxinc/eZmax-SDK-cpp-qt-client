...
qint32 OAISubnet_ResponseCompound::getISubnetNetwork() const {
    return i_subnet_network;
}
void OAISubnet_ResponseCompound::setISubnetNetwork(const qint32 &i_subnet_network) {
...
qint32 OAISubnet_ResponseCompound::getISubnetMask() const {
    return i_subnet_mask;
}
void OAISubnet_ResponseCompound::setISubnetMask(const qint32 &i_subnet_mask) {
