...
qint32 OAIEzsignsignature_ResponseCompound::getFkiUserId() const {
    return fki_user_id;
}
void OAIEzsignsignature_ResponseCompound::setFkiUserId(const qint32 &fki_user_id) {
    this->fki_user_id = fki_user_id;
    this->m_fki_user_id_isSet = true;
}

bool OAIEzsignsignature_ResponseCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool OAIEzsignsignature_ResponseCompound::is_fki_user_id_Valid() const{
