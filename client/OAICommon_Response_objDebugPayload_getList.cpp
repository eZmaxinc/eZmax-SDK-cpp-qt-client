...
bool OAICommon_Response_objDebugPayload_getList::isValid() const {
    ...
    return m_i_version_min_isValid && m_i_version_max_isValid && m_a_required_permission_isValid && m_b_version_deprecated_isValid && m_a_filter_isValid && m_a_order_by_isValid && true;
}
