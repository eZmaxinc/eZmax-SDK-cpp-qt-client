...
#ifndef Ezsigntemplatepublic_Response_H
#define Ezsigntemplatepublic_Response_H
...
class Ezsigntemplatepublic_Response : public Object {
public:
    Ezsigntemplatepublic_Response();
    Ezsigntemplatepublic_Response(const QString &json);
    ~Ezsigntemplatepublic_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepublic_Response)

#endif // Ezsigntemplatepublic_Response_H
