...
Franchiseoffice_AutocompleteElement_Response::Franchiseoffice_AutocompleteElement_Response(const QString &json) {
...
void Franchiseoffice_AutocompleteElement_Response::fromJson(const QString &jsonString) {
