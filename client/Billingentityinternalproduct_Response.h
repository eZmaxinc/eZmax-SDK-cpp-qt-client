...
#ifndef Billingentityinternalproduct_Response_H
#define Billingentityinternalproduct_Response_H
...
class Billingentityinternalproduct_Response : public Object {
public:
    Billingentityinternalproduct_Response();
    Billingentityinternalproduct_Response(const QString &json);
    ~Billingentityinternalproduct_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Billingentityinternalproduct_Response)

#endif // Billingentityinternalproduct_Response_H
