...
OAIEmailtype_AutocompleteElement_Response::OAIEmailtype_AutocompleteElement_Response() {
    this->initializeModel();
}

OAIEmailtype_AutocompleteElement_Response::~OAIEmailtype_AutocompleteElement_Response() {}

void OAIEmailtype_AutocompleteElement_Response::initializeModel() {
...
void OAIEmailtype_AutocompleteElement_Response::fromJson(QString jsonString) {
...
QString OAIEmailtype_AutocompleteElement_Response::asJson() const {
...
bool OAIEmailtype_AutocompleteElement_Response::is_pki_emailtype_id_Valid() const{
...
bool OAIEmailtype_AutocompleteElement_Response::is_s_emailtype_name_x_Valid() const{
...
bool OAIEmailtype_AutocompleteElement_Response::is_b_emailtype_isactive_Valid() const{
    return m_b_emailtype_isactive_isValid;
}

bool OAIEmailtype_AutocompleteElement_Response::isSet() const {
...
bool OAIEmailtype_AutocompleteElement_Response::isValid() const {
