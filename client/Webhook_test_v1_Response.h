...
#ifndef Webhook_test_v1_Response_H
#define Webhook_test_v1_Response_H
...
class Webhook_test_v1_Response : public Object {
public:
    Webhook_test_v1_Response();
    Webhook_test_v1_Response(const QString &json);
    ~Webhook_test_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_test_v1_Response)

#endif // Webhook_test_v1_Response_H
