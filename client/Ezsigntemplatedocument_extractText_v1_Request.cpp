...
Ezsigntemplatedocument_extractText_v1_Request::Ezsigntemplatedocument_extractText_v1_Request(const QString &json) {
...
void Ezsigntemplatedocument_extractText_v1_Request::fromJson(const QString &jsonString) {
