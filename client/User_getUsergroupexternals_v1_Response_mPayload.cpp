...
User_getUsergroupexternals_v1_Response_mPayload::User_getUsergroupexternals_v1_Response_mPayload(const QString &json) {
...
void User_getUsergroupexternals_v1_Response_mPayload::fromJson(const QString &jsonString) {
