...
/*
 * OAIEzsigndocument_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef OAIEzsigndocument_patchObject_v1_Response_H
#define OAIEzsigndocument_patchObject_v1_Response_H
...
class OAIEzsigndocument_patchObject_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_patchObject_v1_Response();
    OAIEzsigndocument_patchObject_v1_Response(QString json);
    ~OAIEzsigndocument_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_patchObject_v1_Response)

#endif // OAIEzsigndocument_patchObject_v1_Response_H
