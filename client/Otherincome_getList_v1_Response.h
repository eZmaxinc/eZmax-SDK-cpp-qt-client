...
/*
 * Otherincome_getList_v1_Response.h
 *
 * Response for GET /1/object/otherincome/getList
 */

#ifndef Otherincome_getList_v1_Response_H
#define Otherincome_getList_v1_Response_H
...
class Otherincome_getList_v1_Response_mPayload;
...
public:
    ...
    Otherincome_getList_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Otherincome_getList_v1_Response_mPayload &m_payload);
...
private:
    ...
    Otherincome_getList_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Otherincome_getList_v1_Response)

#endif // Otherincome_getList_v1_Response_H
