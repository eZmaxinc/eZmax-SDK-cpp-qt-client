...
/*
 * Ezsignfolder_getCommunicationList_v1_Response_mPayload.h
 *
 * Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationList
 */

#ifndef Ezsignfolder_getCommunicationList_v1_Response_mPayload_H
#define Ezsignfolder_getCommunicationList_v1_Response_mPayload_H
...
class Ezsignfolder_getCommunicationList_v1_Response_mPayload : public Object {
public:
    Ezsignfolder_getCommunicationList_v1_Response_mPayload();
    Ezsignfolder_getCommunicationList_v1_Response_mPayload(const QString &json);
    ~Ezsignfolder_getCommunicationList_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_getCommunicationList_v1_Response_mPayload)

#endif // Ezsignfolder_getCommunicationList_v1_Response_mPayload_H
