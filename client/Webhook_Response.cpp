...
Webhook_Response::Webhook_Response(const QString &json) {
...
void Webhook_Response::fromJson(const QString &jsonString) {
...
qint32 Webhook_Response::getFkiAuthenticationexternalId() const {
    return m_fki_authenticationexternal_id;
}
void Webhook_Response::setFkiAuthenticationexternalId(const qint32 &fki_authenticationexternal_id) {
    m_fki_authenticationexternal_id = fki_authenticationexternal_id;
    m_fki_authenticationexternal_id_isSet = true;
}

bool Webhook_Response::is_fki_authenticationexternal_id_Set() const{
    return m_fki_authenticationexternal_id_isSet;
}

bool Webhook_Response::is_fki_authenticationexternal_id_Valid() const{
...
Field_eWebhookEzmaxpartnerevent Webhook_Response::getEWebhookEzmaxpartnerevent() const {
    return m_e_webhook_ezmaxpartnerevent;
}
void Webhook_Response::setEWebhookEzmaxpartnerevent(const Field_eWebhookEzmaxpartnerevent &e_webhook_ezmaxpartnerevent) {
    m_e_webhook_ezmaxpartnerevent = e_webhook_ezmaxpartnerevent;
    m_e_webhook_ezmaxpartnerevent_isSet = true;
}

bool Webhook_Response::is_e_webhook_ezmaxpartnerevent_Set() const{
    return m_e_webhook_ezmaxpartnerevent_isSet;
}

bool Webhook_Response::is_e_webhook_ezmaxpartnerevent_Valid() const{
...
Field_eWebhookRealestateevent Webhook_Response::getEWebhookRealestateevent() const {
    return m_e_webhook_realestateevent;
}
void Webhook_Response::setEWebhookRealestateevent(const Field_eWebhookRealestateevent &e_webhook_realestateevent) {
    m_e_webhook_realestateevent = e_webhook_realestateevent;
    m_e_webhook_realestateevent_isSet = true;
}

bool Webhook_Response::is_e_webhook_realestateevent_Set() const{
    return m_e_webhook_realestateevent_isSet;
}

bool Webhook_Response::is_e_webhook_realestateevent_Valid() const{
...
QString Webhook_Response::getSWebhookApikey() const {
    return m_s_webhook_apikey;
}
void Webhook_Response::setSWebhookApikey(const QString &s_webhook_apikey) {
    m_s_webhook_apikey = s_webhook_apikey;
    m_s_webhook_apikey_isSet = true;
}

bool Webhook_Response::is_s_webhook_apikey_Set() const{
    return m_s_webhook_apikey_isSet;
}

bool Webhook_Response::is_s_webhook_apikey_Valid() const{
    return m_s_webhook_apikey_isValid;
}

QString Webhook_Response::getSWebhookSecret() const {
    return m_s_webhook_secret;
}
void Webhook_Response::setSWebhookSecret(const QString &s_webhook_secret) {
    m_s_webhook_secret = s_webhook_secret;
    m_s_webhook_secret_isSet = true;
}

bool Webhook_Response::is_s_webhook_secret_Set() const{
    return m_s_webhook_secret_isSet;
}

bool Webhook_Response::is_s_webhook_secret_Valid() const{
...
bool Webhook_Response::isBWebhookIssigned() const {
    return m_b_webhook_issigned;
}
void Webhook_Response::setBWebhookIssigned(const bool &b_webhook_issigned) {
    m_b_webhook_issigned = b_webhook_issigned;
    m_b_webhook_issigned_isSet = true;
}

bool Webhook_Response::is_b_webhook_issigned_Set() const{
    return m_b_webhook_issigned_isSet;
}

bool Webhook_Response::is_b_webhook_issigned_Valid() const{
...
QString Webhook_Response::getSAuthenticationexternalDescription() const {
    return m_s_authenticationexternal_description;
}
void Webhook_Response::setSAuthenticationexternalDescription(const QString &s_authenticationexternal_description) {
...
bool Webhook_Response::is_s_authenticationexternal_description_Set() const{
    return m_s_authenticationexternal_description_isSet;
}

bool Webhook_Response::is_s_authenticationexternal_description_Valid() const{
