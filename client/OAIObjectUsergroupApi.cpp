...
#include "OAIObjectUsergroupApi.h"
...
OAIObjectUsergroupApi::OAIObjectUsergroupApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIObjectUsergroupApi::~OAIObjectUsergroupApi() {
}

void OAIObjectUsergroupApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectUsergroupApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectUsergroupApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectUsergroupApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectUsergroupApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectUsergroupApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectUsergroupApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectUsergroupApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectUsergroupApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectUsergroupApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectUsergroupApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectUsergroupApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectUsergroupApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectUsergroupApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectUsergroupApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectUsergroupApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectUsergroupApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectUsergroupApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectUsergroupApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectUsergroupApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectUsergroupApi::usergroupEditPermissionsV1(const qint32 &pki_usergroup_id, const OAIUsergroup_editPermissions_v1_Request &oai_usergroup_edit_permissions_v1_request) {
...

    {
        ...
        QByteArray output = oai_usergroup_edit_permissions_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectUsergroupApi::usergroupEditPermissionsV1Callback);
    connect(this, &OAIObjectUsergroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectUsergroupApi::usergroupEditPermissionsV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUsergroup_editPermissions_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectUsergroupApi::usergroupEditUsergroupmembershipsV1(const qint32 &pki_usergroup_id, const OAIUsergroup_editUsergroupmemberships_v1_Request &oai_usergroup_edit_usergroupmemberships_v1_request) {
...

    {
        ...
        QByteArray output = oai_usergroup_edit_usergroupmemberships_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectUsergroupApi::usergroupEditUsergroupmembershipsV1Callback);
    connect(this, &OAIObjectUsergroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectUsergroupApi::usergroupEditUsergroupmembershipsV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUsergroup_editUsergroupmemberships_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectUsergroupApi::usergroupGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectUsergroupApi::usergroupGetAutocompleteV2Callback);
    connect(this, &OAIObjectUsergroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectUsergroupApi::usergroupGetAutocompleteV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUsergroup_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectUsergroupApi::usergroupGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<OAIHeader_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
...
void OAIObjectUsergroupApi::usergroupGetPermissionsV1(const qint32 &pki_usergroup_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectUsergroupApi::usergroupGetPermissionsV1Callback);
    connect(this, &OAIObjectUsergroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectUsergroupApi::usergroupGetPermissionsV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUsergroup_getPermissions_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectUsergroupApi::usergroupGetUsergroupmembershipsV1(const qint32 &pki_usergroup_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectUsergroupApi::usergroupGetUsergroupmembershipsV1Callback);
    connect(this, &OAIObjectUsergroupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectUsergroupApi::usergroupGetUsergroupmembershipsV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUsergroup_getUsergroupmemberships_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectUsergroupApi::tokenAvailable(){
