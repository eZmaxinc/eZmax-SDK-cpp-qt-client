...
/*
 * Email_ResponseCompound.h
 *
 * An Email Object and children to create a complete structure
 */

#ifndef Email_ResponseCompound_H
#define Email_ResponseCompound_H
...
class Email_ResponseCompound : public Object {
public:
    Email_ResponseCompound();
    Email_ResponseCompound(const QString &json);
    ~Email_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Email_ResponseCompound)

#endif // Email_ResponseCompound_H
