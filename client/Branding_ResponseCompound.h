...
/*
 * Branding_ResponseCompound.h
 *
 * A Branding Object
 */

#ifndef Branding_ResponseCompound_H
#define Branding_ResponseCompound_H
...
class Branding_ResponseCompound : public Object {
public:
    Branding_ResponseCompound();
    Branding_ResponseCompound(QString json);
    ~Branding_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Branding_ResponseCompound)

#endif // Branding_ResponseCompound_H
