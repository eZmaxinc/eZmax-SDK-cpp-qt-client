...
/*
 * Discussion_RequestCompound.h
 *
 * A Discussion Object and children
 */

#ifndef Discussion_RequestCompound_H
#define Discussion_RequestCompound_H
...
class Discussion_RequestCompound : public Object {
public:
    Discussion_RequestCompound();
    Discussion_RequestCompound(const QString &json);
    ~Discussion_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussion_RequestCompound)

#endif // Discussion_RequestCompound_H
