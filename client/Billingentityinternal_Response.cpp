...
Billingentityinternal_Response::Billingentityinternal_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Billingentityinternal_Response::Billingentityinternal_Response() {
    this->initializeModel();
}

Billingentityinternal_Response::~Billingentityinternal_Response() {}

void Billingentityinternal_Response::initializeModel() {
...
void Billingentityinternal_Response::fromJson(const QString &jsonString) {
...
void Billingentityinternal_Response::fromJsonObject(QJsonObject json) {
...
QString Billingentityinternal_Response::asJson() const {
...
QJsonObject Billingentityinternal_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Billingentityinternal_Response::getPkiBillingentityinternalId() const {
    return m_pki_billingentityinternal_id;
}
void Billingentityinternal_Response::setPkiBillingentityinternalId(const qint32 &pki_billingentityinternal_id) {
    m_pki_billingentityinternal_id = pki_billingentityinternal_id;
    m_pki_billingentityinternal_id_isSet = true;
}

bool Billingentityinternal_Response::is_pki_billingentityinternal_id_Set() const{
    return m_pki_billingentityinternal_id_isSet;
}

bool Billingentityinternal_Response::is_pki_billingentityinternal_id_Valid() const{
    return m_pki_billingentityinternal_id_isValid;
}

Multilingual_BillingentityinternalDescription Billingentityinternal_Response::getObjBillingentityinternalDescription() const {
    return m_obj_billingentityinternal_description;
}
void Billingentityinternal_Response::setObjBillingentityinternalDescription(const Multilingual_BillingentityinternalDescription &obj_billingentityinternal_description) {
...
bool Billingentityinternal_Response::is_obj_billingentityinternal_description_Set() const{
    return m_obj_billingentityinternal_description_isSet;
}

bool Billingentityinternal_Response::is_obj_billingentityinternal_description_Valid() const{
    return m_obj_billingentityinternal_description_isValid;
}

bool Billingentityinternal_Response::isSet() const {
...
bool Billingentityinternal_Response::isValid() const {
