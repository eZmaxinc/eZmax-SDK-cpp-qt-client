...
/*
 * Broker_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/broker/{pkiBrokerID}/getAttachments
 */

#ifndef Broker_getAttachments_v1_Response_mPayload_H
#define Broker_getAttachments_v1_Response_mPayload_H
...
class Broker_getAttachments_v1_Response_mPayload : public Object {
public:
    Broker_getAttachments_v1_Response_mPayload();
    Broker_getAttachments_v1_Response_mPayload(const QString &json);
    ~Broker_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Broker_getAttachments_v1_Response_mPayload)

#endif // Broker_getAttachments_v1_Response_mPayload_H
