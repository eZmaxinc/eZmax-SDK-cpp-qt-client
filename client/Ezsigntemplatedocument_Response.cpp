...
Ezsigntemplatedocument_Response::Ezsigntemplatedocument_Response(const QString &json) {
...
void Ezsigntemplatedocument_Response::fromJson(const QString &jsonString) {
