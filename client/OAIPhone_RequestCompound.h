...
/*
 * OAIPhone_RequestCompound.h
 *
 * A Phone Object and children to create a complete structure
 */

#ifndef OAIPhone_RequestCompound_H
#define OAIPhone_RequestCompound_H
...
class OAIPhone_RequestCompound : public OAIObject {
public:
    OAIPhone_RequestCompound();
    OAIPhone_RequestCompound(QString json);
    ~OAIPhone_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPhone_RequestCompound)

#endif // OAIPhone_RequestCompound_H
