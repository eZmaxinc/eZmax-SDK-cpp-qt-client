...
/*
 * User_editObject_v1_Response.h
 *
 * Response for PUT /1/object/user/{pkiUserID}
 */

#ifndef User_editObject_v1_Response_H
#define User_editObject_v1_Response_H
...
class User_editObject_v1_Response : public Object {
public:
    User_editObject_v1_Response();
    User_editObject_v1_Response(const QString &json);
    ~User_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::User_editObject_v1_Response)

#endif // User_editObject_v1_Response_H
