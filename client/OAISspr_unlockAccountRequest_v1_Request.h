...
/*
 * OAISspr_unlockAccountRequest_v1_Request.h
 *
 * Request for the /1/module/sspr/unlockAccountRequest API Request
 */

#ifndef OAISspr_unlockAccountRequest_v1_Request_H
#define OAISspr_unlockAccountRequest_v1_Request_H
...
class OAISspr_unlockAccountRequest_v1_Request : public OAIObject {
public:
    OAISspr_unlockAccountRequest_v1_Request();
    OAISspr_unlockAccountRequest_v1_Request(QString json);
    ~OAISspr_unlockAccountRequest_v1_Request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISspr_unlockAccountRequest_v1_Request)

#endif // OAISspr_unlockAccountRequest_v1_Request_H
