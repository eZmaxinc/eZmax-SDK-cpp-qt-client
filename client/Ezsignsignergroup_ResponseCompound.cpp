...
Ezsignsignergroup_ResponseCompound::Ezsignsignergroup_ResponseCompound(const QString &json) {
...
void Ezsignsignergroup_ResponseCompound::fromJson(const QString &jsonString) {
