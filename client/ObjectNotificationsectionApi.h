...
#ifndef _ObjectNotificationsectionApi_H
#define _ObjectNotificationsectionApi_H
...
class ObjectNotificationsectionApi : public QObject {
    Q_OBJECT

public:
    ObjectNotificationsectionApi(const int timeOut = 0);
