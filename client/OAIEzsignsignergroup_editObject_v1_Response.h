...
/*
 * OAIEzsignsignergroup_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}
 */

#ifndef OAIEzsignsignergroup_editObject_v1_Response_H
#define OAIEzsignsignergroup_editObject_v1_Response_H
...
class OAIEzsignsignergroup_editObject_v1_Response : public OAIObject {
public:
    OAIEzsignsignergroup_editObject_v1_Response();
    OAIEzsignsignergroup_editObject_v1_Response(QString json);
    ~OAIEzsignsignergroup_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignergroup_editObject_v1_Response)

#endif // OAIEzsignsignergroup_editObject_v1_Response_H
