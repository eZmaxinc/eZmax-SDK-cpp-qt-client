...
/*
 * OAIEzsigntemplateformfield_RequestCompound.h
 *
 * An Ezsigntemplateformfield Object and children to create a complete structure
 */

#ifndef OAIEzsigntemplateformfield_RequestCompound_H
#define OAIEzsigntemplateformfield_RequestCompound_H
...
class OAIEzsigntemplateformfield_RequestCompound : public OAIObject {
public:
    OAIEzsigntemplateformfield_RequestCompound();
    OAIEzsigntemplateformfield_RequestCompound(QString json);
    ~OAIEzsigntemplateformfield_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplateformfield_RequestCompound)

#endif // OAIEzsigntemplateformfield_RequestCompound_H
