...
Field_eEzsigntemplateelementdependencyOperator::Field_eEzsigntemplateelementdependencyOperator(const QString &json) {
...
void Field_eEzsigntemplateelementdependencyOperator::fromJson(const QString &jsonString) {
