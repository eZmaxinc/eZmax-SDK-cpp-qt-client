...
Supply_Response::Supply_Response(const QString &json) {
...
void Supply_Response::initializeModel() {
...
void Supply_Response::fromJson(const QString &jsonString) {
...
void Supply_Response::fromJsonObject(QJsonObject json) {
...
QString Supply_Response::asJson() const {
...
QJsonObject Supply_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Supply_Response::getPkiSupplyId() const {
    return m_pki_supply_id;
}
void Supply_Response::setPkiSupplyId(const qint32 &pki_supply_id) {
    m_pki_supply_id = pki_supply_id;
    m_pki_supply_id_isSet = true;
}

bool Supply_Response::is_pki_supply_id_Set() const{
    return m_pki_supply_id_isSet;
}

bool Supply_Response::is_pki_supply_id_Valid() const{
    return m_pki_supply_id_isValid;
}

qint32 Supply_Response::getFkiGlaccountId() const {
    return m_fki_glaccount_id;
}
void Supply_Response::setFkiGlaccountId(const qint32 &fki_glaccount_id) {
    m_fki_glaccount_id = fki_glaccount_id;
    m_fki_glaccount_id_isSet = true;
}

bool Supply_Response::is_fki_glaccount_id_Set() const{
    return m_fki_glaccount_id_isSet;
}

bool Supply_Response::is_fki_glaccount_id_Valid() const{
    return m_fki_glaccount_id_isValid;
}

qint32 Supply_Response::getFkiGlaccountcontainerId() const {
    return m_fki_glaccountcontainer_id;
}
void Supply_Response::setFkiGlaccountcontainerId(const qint32 &fki_glaccountcontainer_id) {
    m_fki_glaccountcontainer_id = fki_glaccountcontainer_id;
    m_fki_glaccountcontainer_id_isSet = true;
}

bool Supply_Response::is_fki_glaccountcontainer_id_Set() const{
    return m_fki_glaccountcontainer_id_isSet;
}

bool Supply_Response::is_fki_glaccountcontainer_id_Valid() const{
    return m_fki_glaccountcontainer_id_isValid;
}

qint32 Supply_Response::getFkiVariableexpenseId() const {
    return m_fki_variableexpense_id;
}
void Supply_Response::setFkiVariableexpenseId(const qint32 &fki_variableexpense_id) {
    m_fki_variableexpense_id = fki_variableexpense_id;
    m_fki_variableexpense_id_isSet = true;
}

bool Supply_Response::is_fki_variableexpense_id_Set() const{
    return m_fki_variableexpense_id_isSet;
}

bool Supply_Response::is_fki_variableexpense_id_Valid() const{
    return m_fki_variableexpense_id_isValid;
}

QString Supply_Response::getSSupplyCode() const {
    return m_s_supply_code;
}
void Supply_Response::setSSupplyCode(const QString &s_supply_code) {
    m_s_supply_code = s_supply_code;
    m_s_supply_code_isSet = true;
}

bool Supply_Response::is_s_supply_code_Set() const{
    return m_s_supply_code_isSet;
}

bool Supply_Response::is_s_supply_code_Valid() const{
    return m_s_supply_code_isValid;
}

Multilingual_SupplyDescription Supply_Response::getObjSupplyDescription() const {
    return m_obj_supply_description;
}
void Supply_Response::setObjSupplyDescription(const Multilingual_SupplyDescription &obj_supply_description) {
    m_obj_supply_description = obj_supply_description;
    m_obj_supply_description_isSet = true;
}

bool Supply_Response::is_obj_supply_description_Set() const{
    return m_obj_supply_description_isSet;
}

bool Supply_Response::is_obj_supply_description_Valid() const{
    return m_obj_supply_description_isValid;
}

QString Supply_Response::getDSupplyUnitprice() const {
    return m_d_supply_unitprice;
}
void Supply_Response::setDSupplyUnitprice(const QString &d_supply_unitprice) {
    m_d_supply_unitprice = d_supply_unitprice;
    m_d_supply_unitprice_isSet = true;
}

bool Supply_Response::is_d_supply_unitprice_Set() const{
    return m_d_supply_unitprice_isSet;
}

bool Supply_Response::is_d_supply_unitprice_Valid() const{
    return m_d_supply_unitprice_isValid;
}

bool Supply_Response::isBSupplyIsactive() const {
    return m_b_supply_isactive;
}
void Supply_Response::setBSupplyIsactive(const bool &b_supply_isactive) {
    m_b_supply_isactive = b_supply_isactive;
    m_b_supply_isactive_isSet = true;
}

bool Supply_Response::is_b_supply_isactive_Set() const{
    return m_b_supply_isactive_isSet;
}

bool Supply_Response::is_b_supply_isactive_Valid() const{
    return m_b_supply_isactive_isValid;
}

bool Supply_Response::isBSupplyVariableprice() const {
    return m_b_supply_variableprice;
}
void Supply_Response::setBSupplyVariableprice(const bool &b_supply_variableprice) {
    m_b_supply_variableprice = b_supply_variableprice;
    m_b_supply_variableprice_isSet = true;
}

bool Supply_Response::is_b_supply_variableprice_Set() const{
    return m_b_supply_variableprice_isSet;
}

bool Supply_Response::is_b_supply_variableprice_Valid() const{
    return m_b_supply_variableprice_isValid;
}

QString Supply_Response::getSGlaccountDescriptionX() const {
    return m_s_glaccount_description_x;
}
void Supply_Response::setSGlaccountDescriptionX(const QString &s_glaccount_description_x) {
    m_s_glaccount_description_x = s_glaccount_description_x;
    m_s_glaccount_description_x_isSet = true;
}

bool Supply_Response::is_s_glaccount_description_x_Set() const{
    return m_s_glaccount_description_x_isSet;
}

bool Supply_Response::is_s_glaccount_description_x_Valid() const{
    return m_s_glaccount_description_x_isValid;
}

QString Supply_Response::getSGlaccountcontainerLongdescriptionX() const {
    return m_s_glaccountcontainer_longdescription_x;
}
void Supply_Response::setSGlaccountcontainerLongdescriptionX(const QString &s_glaccountcontainer_longdescription_x) {
...
bool Supply_Response::is_s_glaccountcontainer_longdescription_x_Set() const{
    return m_s_glaccountcontainer_longdescription_x_isSet;
}

bool Supply_Response::is_s_glaccountcontainer_longdescription_x_Valid() const{
    return m_s_glaccountcontainer_longdescription_x_isValid;
}

QString Supply_Response::getSVariableexpenseDescriptionX() const {
    return m_s_variableexpense_description_x;
}
void Supply_Response::setSVariableexpenseDescriptionX(const QString &s_variableexpense_description_x) {
    m_s_variableexpense_description_x = s_variableexpense_description_x;
    m_s_variableexpense_description_x_isSet = true;
}

bool Supply_Response::is_s_variableexpense_description_x_Set() const{
    return m_s_variableexpense_description_x_isSet;
}

bool Supply_Response::is_s_variableexpense_description_x_Valid() const{
    return m_s_variableexpense_description_x_isValid;
}

bool Supply_Response::isSet() const {
...
bool Supply_Response::isValid() const {
