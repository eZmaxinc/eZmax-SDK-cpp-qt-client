...
/*
 * OAIBranding_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/branding/{pkiBrandingID}
 */

#ifndef OAIBranding_getObject_v1_Response_mPayload_H
#define OAIBranding_getObject_v1_Response_mPayload_H
...
class OAIBranding_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIBranding_getObject_v1_Response_mPayload();
    OAIBranding_getObject_v1_Response_mPayload(QString json);
    ~OAIBranding_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranding_getObject_v1_Response_mPayload)

#endif // OAIBranding_getObject_v1_Response_mPayload_H
