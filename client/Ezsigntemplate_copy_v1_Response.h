...
#ifndef Ezsigntemplate_copy_v1_Response_H
#define Ezsigntemplate_copy_v1_Response_H
...
class Ezsigntemplate_copy_v1_Response_mPayload;

class Ezsigntemplate_copy_v1_Response : public Object {
public:
    Ezsigntemplate_copy_v1_Response();
    Ezsigntemplate_copy_v1_Response(const QString &json);
    ~Ezsigntemplate_copy_v1_Response() override;
    ...
    Ezsigntemplate_copy_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Ezsigntemplate_copy_v1_Response_mPayload &m_payload);
...
private:
    ...
    Ezsigntemplate_copy_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplate_copy_v1_Response)

#endif // Ezsigntemplate_copy_v1_Response_H
