...
Contact_RequestCompoundV2::Contact_RequestCompoundV2(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Contact_RequestCompoundV2::Contact_RequestCompoundV2() {
    this->initializeModel();
}

Contact_RequestCompoundV2::~Contact_RequestCompoundV2() {}

void Contact_RequestCompoundV2::initializeModel() {
...
void Contact_RequestCompoundV2::fromJson(const QString &jsonString) {
...
void Contact_RequestCompoundV2::fromJsonObject(QJsonObject json) {
...
QString Contact_RequestCompoundV2::asJson() const {
...
QJsonObject Contact_RequestCompoundV2::asJsonObject() const {
    QJsonObject obj;
...
qint32 Contact_RequestCompoundV2::getFkiContacttitleId() const {
    return m_fki_contacttitle_id;
}
void Contact_RequestCompoundV2::setFkiContacttitleId(const qint32 &fki_contacttitle_id) {
    m_fki_contacttitle_id = fki_contacttitle_id;
    m_fki_contacttitle_id_isSet = true;
}

bool Contact_RequestCompoundV2::is_fki_contacttitle_id_Set() const{
    return m_fki_contacttitle_id_isSet;
}

bool Contact_RequestCompoundV2::is_fki_contacttitle_id_Valid() const{
    return m_fki_contacttitle_id_isValid;
}

qint32 Contact_RequestCompoundV2::getFkiLanguageId() const {
    return m_fki_language_id;
}
void Contact_RequestCompoundV2::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool Contact_RequestCompoundV2::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool Contact_RequestCompoundV2::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

Field_eContactType Contact_RequestCompoundV2::getEContactType() const {
    return m_e_contact_type;
}
void Contact_RequestCompoundV2::setEContactType(const Field_eContactType &e_contact_type) {
    m_e_contact_type = e_contact_type;
    m_e_contact_type_isSet = true;
}

bool Contact_RequestCompoundV2::is_e_contact_type_Set() const{
    return m_e_contact_type_isSet;
}

bool Contact_RequestCompoundV2::is_e_contact_type_Valid() const{
    return m_e_contact_type_isValid;
}

QString Contact_RequestCompoundV2::getSContactFirstname() const {
    return m_s_contact_firstname;
}
void Contact_RequestCompoundV2::setSContactFirstname(const QString &s_contact_firstname) {
    m_s_contact_firstname = s_contact_firstname;
    m_s_contact_firstname_isSet = true;
}

bool Contact_RequestCompoundV2::is_s_contact_firstname_Set() const{
    return m_s_contact_firstname_isSet;
}

bool Contact_RequestCompoundV2::is_s_contact_firstname_Valid() const{
    return m_s_contact_firstname_isValid;
}

QString Contact_RequestCompoundV2::getSContactLastname() const {
    return m_s_contact_lastname;
}
void Contact_RequestCompoundV2::setSContactLastname(const QString &s_contact_lastname) {
    m_s_contact_lastname = s_contact_lastname;
    m_s_contact_lastname_isSet = true;
}

bool Contact_RequestCompoundV2::is_s_contact_lastname_Set() const{
    return m_s_contact_lastname_isSet;
}

bool Contact_RequestCompoundV2::is_s_contact_lastname_Valid() const{
    return m_s_contact_lastname_isValid;
}

QString Contact_RequestCompoundV2::getSContactCompany() const {
    return m_s_contact_company;
}
void Contact_RequestCompoundV2::setSContactCompany(const QString &s_contact_company) {
    m_s_contact_company = s_contact_company;
    m_s_contact_company_isSet = true;
}

bool Contact_RequestCompoundV2::is_s_contact_company_Set() const{
    return m_s_contact_company_isSet;
}

bool Contact_RequestCompoundV2::is_s_contact_company_Valid() const{
    return m_s_contact_company_isValid;
}

QString Contact_RequestCompoundV2::getDtContactBirthdate() const {
    return m_dt_contact_birthdate;
}
void Contact_RequestCompoundV2::setDtContactBirthdate(const QString &dt_contact_birthdate) {
    m_dt_contact_birthdate = dt_contact_birthdate;
    m_dt_contact_birthdate_isSet = true;
}

bool Contact_RequestCompoundV2::is_dt_contact_birthdate_Set() const{
    return m_dt_contact_birthdate_isSet;
}

bool Contact_RequestCompoundV2::is_dt_contact_birthdate_Valid() const{
    return m_dt_contact_birthdate_isValid;
}

QString Contact_RequestCompoundV2::getSContactOccupation() const {
    return m_s_contact_occupation;
}
void Contact_RequestCompoundV2::setSContactOccupation(const QString &s_contact_occupation) {
    m_s_contact_occupation = s_contact_occupation;
    m_s_contact_occupation_isSet = true;
}

bool Contact_RequestCompoundV2::is_s_contact_occupation_Set() const{
    return m_s_contact_occupation_isSet;
}

bool Contact_RequestCompoundV2::is_s_contact_occupation_Valid() const{
    return m_s_contact_occupation_isValid;
}

QString Contact_RequestCompoundV2::getTContactNote() const {
    return m_t_contact_note;
}
void Contact_RequestCompoundV2::setTContactNote(const QString &t_contact_note) {
    m_t_contact_note = t_contact_note;
    m_t_contact_note_isSet = true;
}

bool Contact_RequestCompoundV2::is_t_contact_note_Set() const{
    return m_t_contact_note_isSet;
}

bool Contact_RequestCompoundV2::is_t_contact_note_Valid() const{
    return m_t_contact_note_isValid;
}

bool Contact_RequestCompoundV2::isBContactIsactive() const {
    return m_b_contact_isactive;
}
void Contact_RequestCompoundV2::setBContactIsactive(const bool &b_contact_isactive) {
    m_b_contact_isactive = b_contact_isactive;
    m_b_contact_isactive_isSet = true;
}

bool Contact_RequestCompoundV2::is_b_contact_isactive_Set() const{
    return m_b_contact_isactive_isSet;
}

bool Contact_RequestCompoundV2::is_b_contact_isactive_Valid() const{
    return m_b_contact_isactive_isValid;
}

Contactinformations_RequestCompoundV2 Contact_RequestCompoundV2::getObjContactinformations() const {
    return m_obj_contactinformations;
}
void Contact_RequestCompoundV2::setObjContactinformations(const Contactinformations_RequestCompoundV2 &obj_contactinformations) {
    m_obj_contactinformations = obj_contactinformations;
    m_obj_contactinformations_isSet = true;
}

bool Contact_RequestCompoundV2::is_obj_contactinformations_Set() const{
    return m_obj_contactinformations_isSet;
}

bool Contact_RequestCompoundV2::is_obj_contactinformations_Valid() const{
    return m_obj_contactinformations_isValid;
}

bool Contact_RequestCompoundV2::isSet() const {
...
bool Contact_RequestCompoundV2::isValid() const {
