...
/*
 * Invoice_getCommunicationrecipients_v1_Response_mPayload.h
 *
 * Response for GET /1/object/invoice/{pkiInvoiceID}/getCommunicationrecipients
 */

#ifndef Invoice_getCommunicationrecipients_v1_Response_mPayload_H
#define Invoice_getCommunicationrecipients_v1_Response_mPayload_H
...
class Invoice_getCommunicationrecipients_v1_Response_mPayload : public Object {
public:
    Invoice_getCommunicationrecipients_v1_Response_mPayload();
    Invoice_getCommunicationrecipients_v1_Response_mPayload(const QString &json);
    ~Invoice_getCommunicationrecipients_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Invoice_getCommunicationrecipients_v1_Response_mPayload)

#endif // Invoice_getCommunicationrecipients_v1_Response_mPayload_H
