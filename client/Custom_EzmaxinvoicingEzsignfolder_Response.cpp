...
Custom_EzmaxinvoicingEzsignfolder_Response::Custom_EzmaxinvoicingEzsignfolder_Response(const QString &json) {
...
void Custom_EzmaxinvoicingEzsignfolder_Response::fromJson(const QString &jsonString) {
...
bool Custom_EzmaxinvoicingEzsignfolder_Response::isValid() const {
    ...
    return m_fki_ezsignfolder_id_isValid && m_s_ezsignfolder_description_isValid && m_b_ezsigntsarequirement_billable_isValid && m_b_ezsignfolder_mfaused_isValid && m_b_ezsignfolder_allowed_isValid && true;
}
