...
Ezsignsignergroup_getObject_v2_Response_mPayload::Ezsignsignergroup_getObject_v2_Response_mPayload(const QString &json) {
...
void Ezsignsignergroup_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
