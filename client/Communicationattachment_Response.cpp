...
Communicationattachment_Response::Communicationattachment_Response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

Communicationattachment_Response::Communicationattachment_Response() {
    this->initializeModel();
}

Communicationattachment_Response::~Communicationattachment_Response() {}

void Communicationattachment_Response::initializeModel() {
...
void Communicationattachment_Response::fromJson(QString jsonString) {
...
void Communicationattachment_Response::fromJsonObject(QJsonObject json) {
...
QString Communicationattachment_Response::asJson() const {
...
QJsonObject Communicationattachment_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Communicationattachment_Response::getPkiCommunicationattachmentId() const {
    return m_pki_communicationattachment_id;
}
void Communicationattachment_Response::setPkiCommunicationattachmentId(const qint32 &pki_communicationattachment_id) {
    m_pki_communicationattachment_id = pki_communicationattachment_id;
    m_pki_communicationattachment_id_isSet = true;
}

bool Communicationattachment_Response::is_pki_communicationattachment_id_Set() const{
    return m_pki_communicationattachment_id_isSet;
}

bool Communicationattachment_Response::is_pki_communicationattachment_id_Valid() const{
    return m_pki_communicationattachment_id_isValid;
}

qint32 Communicationattachment_Response::getFkiAttachmentId() const {
    return m_fki_attachment_id;
}
void Communicationattachment_Response::setFkiAttachmentId(const qint32 &fki_attachment_id) {
    m_fki_attachment_id = fki_attachment_id;
    m_fki_attachment_id_isSet = true;
}

bool Communicationattachment_Response::is_fki_attachment_id_Set() const{
    return m_fki_attachment_id_isSet;
}

bool Communicationattachment_Response::is_fki_attachment_id_Valid() const{
    return m_fki_attachment_id_isValid;
}

qint32 Communicationattachment_Response::getFkiInvoiceId() const {
    return m_fki_invoice_id;
}
void Communicationattachment_Response::setFkiInvoiceId(const qint32 &fki_invoice_id) {
    m_fki_invoice_id = fki_invoice_id;
    m_fki_invoice_id_isSet = true;
}

bool Communicationattachment_Response::is_fki_invoice_id_Set() const{
    return m_fki_invoice_id_isSet;
}

bool Communicationattachment_Response::is_fki_invoice_id_Valid() const{
    return m_fki_invoice_id_isValid;
}

qint32 Communicationattachment_Response::getFkiSalarypreparationId() const {
    return m_fki_salarypreparation_id;
}
void Communicationattachment_Response::setFkiSalarypreparationId(const qint32 &fki_salarypreparation_id) {
    m_fki_salarypreparation_id = fki_salarypreparation_id;
    m_fki_salarypreparation_id_isSet = true;
}

bool Communicationattachment_Response::is_fki_salarypreparation_id_Set() const{
    return m_fki_salarypreparation_id_isSet;
}

bool Communicationattachment_Response::is_fki_salarypreparation_id_Valid() const{
    return m_fki_salarypreparation_id_isValid;
}

QString Communicationattachment_Response::getSCommunicationattachmentName() const {
    return m_s_communicationattachment_name;
}
void Communicationattachment_Response::setSCommunicationattachmentName(const QString &s_communicationattachment_name) {
    m_s_communicationattachment_name = s_communicationattachment_name;
    m_s_communicationattachment_name_isSet = true;
}

bool Communicationattachment_Response::is_s_communicationattachment_name_Set() const{
    return m_s_communicationattachment_name_isSet;
}

bool Communicationattachment_Response::is_s_communicationattachment_name_Valid() const{
    return m_s_communicationattachment_name_isValid;
}

QString Communicationattachment_Response::getSDownloadUrl() const {
    return m_s_download_url;
}
void Communicationattachment_Response::setSDownloadUrl(const QString &s_download_url) {
    m_s_download_url = s_download_url;
    m_s_download_url_isSet = true;
}

bool Communicationattachment_Response::is_s_download_url_Set() const{
    return m_s_download_url_isSet;
}

bool Communicationattachment_Response::is_s_download_url_Valid() const{
    return m_s_download_url_isValid;
}

bool Communicationattachment_Response::isSet() const {
...
bool Communicationattachment_Response::isValid() const {
