...
qint32 OAIEzsignfoldersignerassociation_Response::getFkiEzsignsignerId() const {
    return fki_ezsignsigner_id;
}
void OAIEzsignfoldersignerassociation_Response::setFkiEzsignsignerId(const qint32 &fki_ezsignsigner_id) {
    this->fki_ezsignsigner_id = fki_ezsignsigner_id;
    this->m_fki_ezsignsigner_id_isSet = true;
}

bool OAIEzsignfoldersignerassociation_Response::is_fki_ezsignsigner_id_Set() const{
    return m_fki_ezsignsigner_id_isSet;
}

bool OAIEzsignfoldersignerassociation_Response::is_fki_ezsignsigner_id_Valid() const{
    return m_fki_ezsignsigner_id_isValid;
}

qint32 OAIEzsignfoldersignerassociation_Response::getFkiUserId() const {
    return fki_user_id;
}
void OAIEzsignfoldersignerassociation_Response::setFkiUserId(const qint32 &fki_user_id) {
    this->fki_user_id = fki_user_id;
    this->m_fki_user_id_isSet = true;
}

bool OAIEzsignfoldersignerassociation_Response::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool OAIEzsignfoldersignerassociation_Response::is_fki_user_id_Valid() const{
