...
/*
 * Ezsigntemplatepublic_ListElement.h
 *
 * A Ezsigntemplatepublic List Element
 */

#ifndef Ezsigntemplatepublic_ListElement_H
#define Ezsigntemplatepublic_ListElement_H
...
class Ezsigntemplatepublic_ListElement : public Object {
public:
    Ezsigntemplatepublic_ListElement();
    Ezsigntemplatepublic_ListElement(const QString &json);
    ~Ezsigntemplatepublic_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepublic_ListElement)

#endif // Ezsigntemplatepublic_ListElement_H
