...
#ifndef User_createEzsignuser_v1_Response_H
#define User_createEzsignuser_v1_Response_H
...
class User_createEzsignuser_v1_Response : public Object {
public:
    User_createEzsignuser_v1_Response();
    User_createEzsignuser_v1_Response(const QString &json);
    ~User_createEzsignuser_v1_Response() override;
    ...
    User_createEzsignuser_v1_Response_mPayload getMPayload() const;
    void setMPayload(const User_createEzsignuser_v1_Response_mPayload &m_payload);
...
private:
    ...
    User_createEzsignuser_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::User_createEzsignuser_v1_Response)

#endif // User_createEzsignuser_v1_Response_H
