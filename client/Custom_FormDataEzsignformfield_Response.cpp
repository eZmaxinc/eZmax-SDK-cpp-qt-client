...
Custom_FormDataEzsignformfield_Response::Custom_FormDataEzsignformfield_Response(const QString &json) {
...
void Custom_FormDataEzsignformfield_Response::fromJson(const QString &jsonString) {
