...
QString OAIEzsigntemplatedocumentpage_Response::getSImageUrl() const {
    return s_image_url;
}
void OAIEzsigntemplatedocumentpage_Response::setSImageUrl(const QString &s_image_url) {
    this->s_image_url = s_image_url;
    this->m_s_image_url_isSet = true;
}

bool OAIEzsigntemplatedocumentpage_Response::is_s_image_url_Set() const{
    return m_s_image_url_isSet;
}

bool OAIEzsigntemplatedocumentpage_Response::is_s_image_url_Valid() const{
