...
Billingentityinternal_RequestCompound::Billingentityinternal_RequestCompound(const QString &json) {
...
void Billingentityinternal_RequestCompound::fromJson(const QString &jsonString) {
