...
/*
 * OAIApikey_regenerate_v1_Response.h
 *
 * Response for GET /1/object/apikey/{pkiApikeyID}/regenerate
 */

#ifndef OAIApikey_regenerate_v1_Response_H
#define OAIApikey_regenerate_v1_Response_H
...
class OAIApikey_regenerate_v1_Response : public OAIObject {
public:
    OAIApikey_regenerate_v1_Response();
    OAIApikey_regenerate_v1_Response(QString json);
    ~OAIApikey_regenerate_v1_Response() override;
...
private:
    ...
    OAIApikey_regenerate_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIApikey_regenerate_v1_Response)

#endif // OAIApikey_regenerate_v1_Response_H
