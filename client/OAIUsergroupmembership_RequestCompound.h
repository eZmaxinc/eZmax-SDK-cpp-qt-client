...
/*
 * OAIUsergroupmembership_RequestCompound.h
 *
 * A Usergroupmembership Object and children
 */

#ifndef OAIUsergroupmembership_RequestCompound_H
#define OAIUsergroupmembership_RequestCompound_H
...
class OAIUsergroupmembership_RequestCompound : public OAIObject {
public:
    OAIUsergroupmembership_RequestCompound();
    OAIUsergroupmembership_RequestCompound(QString json);
    ~OAIUsergroupmembership_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupmembership_RequestCompound)

#endif // OAIUsergroupmembership_RequestCompound_H
