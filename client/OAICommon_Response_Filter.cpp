...
QMap<QString, QString> OAICommon_Response_Filter::getAAutoTypeHaving() const {
    return m_a_auto_type_having;
}
void OAICommon_Response_Filter::setAAutoTypeHaving(const QMap<QString, QString> &a_auto_type_having) {
    m_a_auto_type_having = a_auto_type_having;
    m_a_auto_type_having_isSet = true;
}

bool OAICommon_Response_Filter::is_a_auto_type_having_Set() const{
    return m_a_auto_type_having_isSet;
}

bool OAICommon_Response_Filter::is_a_auto_type_having_Valid() const{
