...
/*
 * Usergroupmembership_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroupmembership/{pkiUsergroupmembershipID}
 */

#ifndef Usergroupmembership_editObject_v1_Response_H
#define Usergroupmembership_editObject_v1_Response_H
...
class Usergroupmembership_editObject_v1_Response : public Object {
public:
    Usergroupmembership_editObject_v1_Response();
    Usergroupmembership_editObject_v1_Response(const QString &json);
    ~Usergroupmembership_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupmembership_editObject_v1_Response)

#endif // Usergroupmembership_editObject_v1_Response_H
