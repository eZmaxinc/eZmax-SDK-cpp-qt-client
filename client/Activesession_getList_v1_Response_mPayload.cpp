...
Activesession_getList_v1_Response_mPayload::Activesession_getList_v1_Response_mPayload(const QString &json) {
...
void Activesession_getList_v1_Response_mPayload::fromJson(const QString &jsonString) {
