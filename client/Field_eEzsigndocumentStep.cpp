...
void Field_eEzsigndocumentStep::fromJson(const QString &jsonString) {
    ...
    else if ( jsonString.compare("PendingPrematurelyEnded", Qt::CaseInsensitive) == 0) {
        m_value = eField_eEzsigndocumentStep::PENDINGPREMATURELYENDED;
        m_value_isSet = m_value_isValid = true;
    }
...
QString Field_eEzsigndocumentStep::asJson() const {
    ...
    switch (m_value){
        ...
        case eField_eEzsigndocumentStep::DECLINEDTOSIGN:
            val = "DeclinedToSign";
            break;
        case eField_eEzsigndocumentStep::PENDINGPREMATURELYENDED:
            val = "PendingPrematurelyEnded";
            break;
