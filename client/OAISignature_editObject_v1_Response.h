...
/*
 * OAISignature_editObject_v1_Response.h
 *
 * Response for PUT /1/object/signature/{pkiSignatureID}
 */

#ifndef OAISignature_editObject_v1_Response_H
#define OAISignature_editObject_v1_Response_H
...
class OAISignature_editObject_v1_Response : public OAIObject {
public:
    OAISignature_editObject_v1_Response();
    OAISignature_editObject_v1_Response(QString json);
    ~OAISignature_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISignature_editObject_v1_Response)

#endif // OAISignature_editObject_v1_Response_H
