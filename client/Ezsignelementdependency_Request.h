...
#ifndef Ezsignelementdependency_Request_H
#define Ezsignelementdependency_Request_H
...
class Ezsignelementdependency_Request : public Object {
public:
    Ezsignelementdependency_Request();
    Ezsignelementdependency_Request(const QString &json);
    ~Ezsignelementdependency_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignelementdependency_Request)

#endif // Ezsignelementdependency_Request_H
