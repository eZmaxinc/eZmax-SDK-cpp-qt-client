...
Ezsignbulksenddocumentmapping_RequestCompound::Ezsignbulksenddocumentmapping_RequestCompound(const QString &json) {
...
void Ezsignbulksenddocumentmapping_RequestCompound::fromJson(const QString &jsonString) {
