...
/*
 * Ezsignbulksendsignermapping_ResponseCompound.h
 *
 * A Ezsignbulksendsignermapping Object
 */

#ifndef Ezsignbulksendsignermapping_ResponseCompound_H
#define Ezsignbulksendsignermapping_ResponseCompound_H
...
class Ezsignbulksendsignermapping_ResponseCompound : public Object {
public:
    Ezsignbulksendsignermapping_ResponseCompound();
    Ezsignbulksendsignermapping_ResponseCompound(const QString &json);
    ~Ezsignbulksendsignermapping_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksendsignermapping_ResponseCompound)

#endif // Ezsignbulksendsignermapping_ResponseCompound_H
