...
Webhook_Ezsign_EzsignsignerConnect::Webhook_Ezsign_EzsignsignerConnect(const QString &json) {
...
void Webhook_Ezsign_EzsignsignerConnect::fromJson(const QString &jsonString) {
