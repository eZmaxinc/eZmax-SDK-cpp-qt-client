...
Authenticationexternal_RequestCompound::Authenticationexternal_RequestCompound(const QString &json) {
...
void Authenticationexternal_RequestCompound::fromJson(const QString &jsonString) {
