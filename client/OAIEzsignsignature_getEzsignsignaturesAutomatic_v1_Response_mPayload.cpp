...
OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload() {
    this->initializeModel();
}

OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::~OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload() {}

void OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::initializeModel() {
...
void OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::asJson() const {
...
bool OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::is_a_e_ezsignsignature_type_Valid() const{
...
bool OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::is_a_obj_ezsignfolder_Valid() const{
...
bool OAIEzsignsignature_getEzsignsignaturesAutomatic_v1_Response_mPayload::isValid() const {
