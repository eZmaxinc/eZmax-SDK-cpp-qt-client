...
Apikey_ResponseCompound::Apikey_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Apikey_ResponseCompound::Apikey_ResponseCompound() {
    this->initializeModel();
}

Apikey_ResponseCompound::~Apikey_ResponseCompound() {}

void Apikey_ResponseCompound::initializeModel() {
...
void Apikey_ResponseCompound::fromJson(const QString &jsonString) {
...
void Apikey_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Apikey_ResponseCompound::asJson() const {
...
QJsonObject Apikey_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Apikey_ResponseCompound::getPkiApikeyId() const {
    return m_pki_apikey_id;
}
void Apikey_ResponseCompound::setPkiApikeyId(const qint32 &pki_apikey_id) {
    m_pki_apikey_id = pki_apikey_id;
    m_pki_apikey_id_isSet = true;
}

bool Apikey_ResponseCompound::is_pki_apikey_id_Set() const{
    return m_pki_apikey_id_isSet;
}

bool Apikey_ResponseCompound::is_pki_apikey_id_Valid() const{
    return m_pki_apikey_id_isValid;
}

qint32 Apikey_ResponseCompound::getFkiUserId() const {
    return m_fki_user_id;
}
void Apikey_ResponseCompound::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Apikey_ResponseCompound::is_fki_user_id_Set() const{
...
void Apikey_ResponseCompound::setObjApikeyDescription(const Multilingual_ApikeyDescription &obj_apikey_description) {
    m_obj_apikey_description = obj_apikey_description;
    m_obj_apikey_description_isSet = true;
}

bool Apikey_ResponseCompound::is_obj_apikey_description_Set() const{
    return m_obj_apikey_description_isSet;
}

bool Apikey_ResponseCompound::is_obj_apikey_description_Valid() const{
    return m_obj_apikey_description_isValid;
}

Custom_ContactName_Response Apikey_ResponseCompound::getObjContactName() const {
    return m_obj_contact_name;
}
void Apikey_ResponseCompound::setObjContactName(const Custom_ContactName_Response &obj_contact_name) {
    m_obj_contact_name = obj_contact_name;
    m_obj_contact_name_isSet = true;
}

bool Apikey_ResponseCompound::is_obj_contact_name_Set() const{
    return m_obj_contact_name_isSet;
}

bool Apikey_ResponseCompound::is_obj_contact_name_Valid() const{
    return m_obj_contact_name_isValid;
}

QString Apikey_ResponseCompound::getSApikeyApikey() const {
    return m_s_apikey_apikey;
}
void Apikey_ResponseCompound::setSApikeyApikey(const QString &s_apikey_apikey) {
    m_s_apikey_apikey = s_apikey_apikey;
    m_s_apikey_apikey_isSet = true;
}

bool Apikey_ResponseCompound::is_s_apikey_apikey_Set() const{
    return m_s_apikey_apikey_isSet;
}

bool Apikey_ResponseCompound::is_s_apikey_apikey_Valid() const{
    return m_s_apikey_apikey_isValid;
}

QString Apikey_ResponseCompound::getSApikeySecret() const {
    return m_s_apikey_secret;
}
void Apikey_ResponseCompound::setSApikeySecret(const QString &s_apikey_secret) {
    m_s_apikey_secret = s_apikey_secret;
    m_s_apikey_secret_isSet = true;
}

bool Apikey_ResponseCompound::is_s_apikey_secret_Set() const{
    return m_s_apikey_secret_isSet;
}

bool Apikey_ResponseCompound::is_s_apikey_secret_Valid() const{
    return m_s_apikey_secret_isValid;
}

bool Apikey_ResponseCompound::isBApikeyIsactive() const {
    return m_b_apikey_isactive;
}
void Apikey_ResponseCompound::setBApikeyIsactive(const bool &b_apikey_isactive) {
    m_b_apikey_isactive = b_apikey_isactive;
    m_b_apikey_isactive_isSet = true;
}

bool Apikey_ResponseCompound::is_b_apikey_isactive_Set() const{
    return m_b_apikey_isactive_isSet;
}

bool Apikey_ResponseCompound::is_b_apikey_isactive_Valid() const{
    return m_b_apikey_isactive_isValid;
}

bool Apikey_ResponseCompound::isBApikeyIssigned() const {
    return m_b_apikey_issigned;
}
void Apikey_ResponseCompound::setBApikeyIssigned(const bool &b_apikey_issigned) {
    m_b_apikey_issigned = b_apikey_issigned;
    m_b_apikey_issigned_isSet = true;
}

bool Apikey_ResponseCompound::is_b_apikey_issigned_Set() const{
    return m_b_apikey_issigned_isSet;
}

bool Apikey_ResponseCompound::is_b_apikey_issigned_Valid() const{
    return m_b_apikey_issigned_isValid;
}

Common_Audit Apikey_ResponseCompound::getObjAudit() const {
    return m_obj_audit;
}
void Apikey_ResponseCompound::setObjAudit(const Common_Audit &obj_audit) {
    m_obj_audit = obj_audit;
    m_obj_audit_isSet = true;
}

bool Apikey_ResponseCompound::is_obj_audit_Set() const{
    return m_obj_audit_isSet;
}

bool Apikey_ResponseCompound::is_obj_audit_Valid() const{
    return m_obj_audit_isValid;
}

bool Apikey_ResponseCompound::isSet() const {
...
bool Apikey_ResponseCompound::isValid() const {
