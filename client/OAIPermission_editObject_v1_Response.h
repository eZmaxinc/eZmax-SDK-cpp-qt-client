...
/*
 * OAIPermission_editObject_v1_Response.h
 *
 * Response for PUT /1/object/permission/{pkiPermissionID}
 */

#ifndef OAIPermission_editObject_v1_Response_H
#define OAIPermission_editObject_v1_Response_H
...
class OAIPermission_editObject_v1_Response : public OAIObject {
public:
    OAIPermission_editObject_v1_Response();
    OAIPermission_editObject_v1_Response(QString json);
    ~OAIPermission_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPermission_editObject_v1_Response)

#endif // OAIPermission_editObject_v1_Response_H
