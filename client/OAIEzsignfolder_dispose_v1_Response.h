...
/*
 * OAIEzsignfolder_dispose_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/dispose
 */

#ifndef OAIEzsignfolder_dispose_v1_Response_H
#define OAIEzsignfolder_dispose_v1_Response_H
...
class OAIEzsignfolder_dispose_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_dispose_v1_Response();
    OAIEzsignfolder_dispose_v1_Response(QString json);
    ~OAIEzsignfolder_dispose_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_dispose_v1_Response)

#endif // OAIEzsignfolder_dispose_v1_Response_H
