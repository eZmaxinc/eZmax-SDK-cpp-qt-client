...
#ifndef _ObjectUsergroupexternalApi_H
#define _ObjectUsergroupexternalApi_H
...
class ObjectUsergroupexternalApi : public QObject {
    Q_OBJECT

public:
    ObjectUsergroupexternalApi(const int timeOut = 0);
...
private:
    ...
    void usergroupexternalEditObjectV1Callback(HttpRequestWorker *worker);
    void usergroupexternalGetAutocompleteV2Callback(HttpRequestWorker *worker);
    void usergroupexternalGetListV1Callback(HttpRequestWorker *worker);
    void usergroupexternalGetObjectV2Callback(HttpRequestWorker *worker);
    void usergroupexternalGetUsergroupexternalmembershipsV1Callback(HttpRequestWorker *worker);
    void usergroupexternalGetUsergroupsV1Callback(HttpRequestWorker *worker);
