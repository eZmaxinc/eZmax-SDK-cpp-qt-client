...
/*
 * Ezsignsigner_ResponseCompound_Contact.h
 *
 * A Ezsignsigner-&gt;Contact Object and children to create a complete structure
 */

#ifndef Ezsignsigner_ResponseCompound_Contact_H
#define Ezsignsigner_ResponseCompound_Contact_H
...
class Ezsignsigner_ResponseCompound_Contact : public Object {
public:
    Ezsignsigner_ResponseCompound_Contact();
    Ezsignsigner_ResponseCompound_Contact(const QString &json);
    ~Ezsignsigner_ResponseCompound_Contact() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsigner_ResponseCompound_Contact)

#endif // Ezsignsigner_ResponseCompound_Contact_H
