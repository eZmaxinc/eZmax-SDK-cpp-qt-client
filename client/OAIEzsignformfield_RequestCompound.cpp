...
OAIEzsignformfield_RequestCompound::OAIEzsignformfield_RequestCompound() {
    this->initializeModel();
}

OAIEzsignformfield_RequestCompound::~OAIEzsignformfield_RequestCompound() {}

void OAIEzsignformfield_RequestCompound::initializeModel() {
...
void OAIEzsignformfield_RequestCompound::fromJson(QString jsonString) {
...
QString OAIEzsignformfield_RequestCompound::asJson() const {
...
qint32 OAIEzsignformfield_RequestCompound::getPkiEzsignformfieldId() const {
    return pki_ezsignformfield_id;
}
void OAIEzsignformfield_RequestCompound::setPkiEzsignformfieldId(const qint32 &pki_ezsignformfield_id) {
    this->pki_ezsignformfield_id = pki_ezsignformfield_id;
    this->m_pki_ezsignformfield_id_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_pki_ezsignformfield_id_Set() const{
    return m_pki_ezsignformfield_id_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_pki_ezsignformfield_id_Valid() const{
    return m_pki_ezsignformfield_id_isValid;
}

qint32 OAIEzsignformfield_RequestCompound::getIEzsignpagePagenumber() const {
    return i_ezsignpage_pagenumber;
}
void OAIEzsignformfield_RequestCompound::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    this->i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    this->m_i_ezsignpage_pagenumber_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

QString OAIEzsignformfield_RequestCompound::getSEzsignformfieldLabel() const {
    return s_ezsignformfield_label;
}
void OAIEzsignformfield_RequestCompound::setSEzsignformfieldLabel(const QString &s_ezsignformfield_label) {
    this->s_ezsignformfield_label = s_ezsignformfield_label;
    this->m_s_ezsignformfield_label_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_label_Set() const{
    return m_s_ezsignformfield_label_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_label_Valid() const{
    return m_s_ezsignformfield_label_isValid;
}

QString OAIEzsignformfield_RequestCompound::getSEzsignformfieldValue() const {
    return s_ezsignformfield_value;
}
void OAIEzsignformfield_RequestCompound::setSEzsignformfieldValue(const QString &s_ezsignformfield_value) {
    this->s_ezsignformfield_value = s_ezsignformfield_value;
    this->m_s_ezsignformfield_value_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_value_Set() const{
    return m_s_ezsignformfield_value_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_value_Valid() const{
    return m_s_ezsignformfield_value_isValid;
}

qint32 OAIEzsignformfield_RequestCompound::getIEzsignformfieldX() const {
    return i_ezsignformfield_x;
}
void OAIEzsignformfield_RequestCompound::setIEzsignformfieldX(const qint32 &i_ezsignformfield_x) {
    this->i_ezsignformfield_x = i_ezsignformfield_x;
    this->m_i_ezsignformfield_x_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_x_Set() const{
    return m_i_ezsignformfield_x_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_x_Valid() const{
    return m_i_ezsignformfield_x_isValid;
}

qint32 OAIEzsignformfield_RequestCompound::getIEzsignformfieldY() const {
    return i_ezsignformfield_y;
}
void OAIEzsignformfield_RequestCompound::setIEzsignformfieldY(const qint32 &i_ezsignformfield_y) {
    this->i_ezsignformfield_y = i_ezsignformfield_y;
    this->m_i_ezsignformfield_y_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_y_Set() const{
    return m_i_ezsignformfield_y_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_y_Valid() const{
    return m_i_ezsignformfield_y_isValid;
}

qint32 OAIEzsignformfield_RequestCompound::getIEzsignformfieldWidth() const {
    return i_ezsignformfield_width;
}
void OAIEzsignformfield_RequestCompound::setIEzsignformfieldWidth(const qint32 &i_ezsignformfield_width) {
    this->i_ezsignformfield_width = i_ezsignformfield_width;
    this->m_i_ezsignformfield_width_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_width_Set() const{
    return m_i_ezsignformfield_width_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_width_Valid() const{
    return m_i_ezsignformfield_width_isValid;
}

qint32 OAIEzsignformfield_RequestCompound::getIEzsignformfieldHeight() const {
    return i_ezsignformfield_height;
}
void OAIEzsignformfield_RequestCompound::setIEzsignformfieldHeight(const qint32 &i_ezsignformfield_height) {
    this->i_ezsignformfield_height = i_ezsignformfield_height;
    this->m_i_ezsignformfield_height_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_height_Set() const{
    return m_i_ezsignformfield_height_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_i_ezsignformfield_height_Valid() const{
    return m_i_ezsignformfield_height_isValid;
}

bool OAIEzsignformfield_RequestCompound::isBEzsignformfieldSelected() const {
    return b_ezsignformfield_selected;
}
void OAIEzsignformfield_RequestCompound::setBEzsignformfieldSelected(const bool &b_ezsignformfield_selected) {
    this->b_ezsignformfield_selected = b_ezsignformfield_selected;
    this->m_b_ezsignformfield_selected_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_b_ezsignformfield_selected_Set() const{
    return m_b_ezsignformfield_selected_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_b_ezsignformfield_selected_Valid() const{
    return m_b_ezsignformfield_selected_isValid;
}

QString OAIEzsignformfield_RequestCompound::getSEzsignformfieldEnteredvalue() const {
    return s_ezsignformfield_enteredvalue;
}
void OAIEzsignformfield_RequestCompound::setSEzsignformfieldEnteredvalue(const QString &s_ezsignformfield_enteredvalue) {
    this->s_ezsignformfield_enteredvalue = s_ezsignformfield_enteredvalue;
    this->m_s_ezsignformfield_enteredvalue_isSet = true;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_enteredvalue_Set() const{
    return m_s_ezsignformfield_enteredvalue_isSet;
}

bool OAIEzsignformfield_RequestCompound::is_s_ezsignformfield_enteredvalue_Valid() const{
    return m_s_ezsignformfield_enteredvalue_isValid;
}

bool OAIEzsignformfield_RequestCompound::isSet() const {
...
bool OAIEzsignformfield_RequestCompound::isValid() const {
