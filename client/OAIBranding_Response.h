...
/*
 * OAIBranding_Response.h
 *
 * A Branding Object
 */

#ifndef OAIBranding_Response_H
#define OAIBranding_Response_H
...
class OAIBranding_Response : public OAIObject {
public:
    OAIBranding_Response();
    OAIBranding_Response(QString json);
    ~OAIBranding_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBranding_Response)

#endif // OAIBranding_Response_H
