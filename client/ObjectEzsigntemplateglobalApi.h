...
#ifndef _ObjectEzsigntemplateglobalApi_H
#define _ObjectEzsigntemplateglobalApi_H
...
class ObjectEzsigntemplateglobalApi : public QObject {
    Q_OBJECT

public:
    ObjectEzsigntemplateglobalApi(const int timeOut = 0);
