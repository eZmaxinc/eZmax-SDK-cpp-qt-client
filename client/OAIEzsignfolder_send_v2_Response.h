...
/*
 * OAIEzsignfolder_send_v2_Response.h
 *
 * Response for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/send
 */

#ifndef OAIEzsignfolder_send_v2_Response_H
#define OAIEzsignfolder_send_v2_Response_H
...
class OAIEzsignfolder_send_v2_Response : public OAIObject {
public:
    OAIEzsignfolder_send_v2_Response();
    OAIEzsignfolder_send_v2_Response(QString json);
    ~OAIEzsignfolder_send_v2_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_send_v2_Response)

#endif // OAIEzsignfolder_send_v2_Response_H
