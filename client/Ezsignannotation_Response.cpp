...
Ezsignannotation_Response::Ezsignannotation_Response(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignannotation_Response::Ezsignannotation_Response() {
    this->initializeModel();
}

Ezsignannotation_Response::~Ezsignannotation_Response() {}

void Ezsignannotation_Response::initializeModel() {
...
void Ezsignannotation_Response::fromJson(const QString &jsonString) {
...
void Ezsignannotation_Response::fromJsonObject(QJsonObject json) {
...
QString Ezsignannotation_Response::asJson() const {
...
QJsonObject Ezsignannotation_Response::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignannotation_Response::getPkiEzsignannotationId() const {
    return m_pki_ezsignannotation_id;
}
void Ezsignannotation_Response::setPkiEzsignannotationId(const qint32 &pki_ezsignannotation_id) {
    m_pki_ezsignannotation_id = pki_ezsignannotation_id;
    m_pki_ezsignannotation_id_isSet = true;
}

bool Ezsignannotation_Response::is_pki_ezsignannotation_id_Set() const{
    return m_pki_ezsignannotation_id_isSet;
}

bool Ezsignannotation_Response::is_pki_ezsignannotation_id_Valid() const{
    return m_pki_ezsignannotation_id_isValid;
}

qint32 Ezsignannotation_Response::getFkiEzsigndocumentId() const {
    return m_fki_ezsigndocument_id;
}
void Ezsignannotation_Response::setFkiEzsigndocumentId(const qint32 &fki_ezsigndocument_id) {
    m_fki_ezsigndocument_id = fki_ezsigndocument_id;
    m_fki_ezsigndocument_id_isSet = true;
}

bool Ezsignannotation_Response::is_fki_ezsigndocument_id_Set() const{
    return m_fki_ezsigndocument_id_isSet;
}

bool Ezsignannotation_Response::is_fki_ezsigndocument_id_Valid() const{
    return m_fki_ezsigndocument_id_isValid;
}

Enum_Horizontalalignment Ezsignannotation_Response::getEEzsignannotationHorizontalalignment() const {
    return m_e_ezsignannotation_horizontalalignment;
}
void Ezsignannotation_Response::setEEzsignannotationHorizontalalignment(const Enum_Horizontalalignment &e_ezsignannotation_horizontalalignment) {
...
bool Ezsignannotation_Response::is_e_ezsignannotation_horizontalalignment_Set() const{
    return m_e_ezsignannotation_horizontalalignment_isSet;
}

bool Ezsignannotation_Response::is_e_ezsignannotation_horizontalalignment_Valid() const{
    return m_e_ezsignannotation_horizontalalignment_isValid;
}

Enum_Verticalalignment Ezsignannotation_Response::getEEzsignannotationVerticalalignment() const {
    return m_e_ezsignannotation_verticalalignment;
}
void Ezsignannotation_Response::setEEzsignannotationVerticalalignment(const Enum_Verticalalignment &e_ezsignannotation_verticalalignment) {
...
bool Ezsignannotation_Response::is_e_ezsignannotation_verticalalignment_Set() const{
    return m_e_ezsignannotation_verticalalignment_isSet;
}

bool Ezsignannotation_Response::is_e_ezsignannotation_verticalalignment_Valid() const{
    return m_e_ezsignannotation_verticalalignment_isValid;
}

Field_eEzsignannotationType Ezsignannotation_Response::getEEzsignannotationType() const {
    return m_e_ezsignannotation_type;
}
void Ezsignannotation_Response::setEEzsignannotationType(const Field_eEzsignannotationType &e_ezsignannotation_type) {
    m_e_ezsignannotation_type = e_ezsignannotation_type;
    m_e_ezsignannotation_type_isSet = true;
}

bool Ezsignannotation_Response::is_e_ezsignannotation_type_Set() const{
    return m_e_ezsignannotation_type_isSet;
}

bool Ezsignannotation_Response::is_e_ezsignannotation_type_Valid() const{
    return m_e_ezsignannotation_type_isValid;
}

qint32 Ezsignannotation_Response::getIEzsignannotationX() const {
    return m_i_ezsignannotation_x;
}
void Ezsignannotation_Response::setIEzsignannotationX(const qint32 &i_ezsignannotation_x) {
    m_i_ezsignannotation_x = i_ezsignannotation_x;
    m_i_ezsignannotation_x_isSet = true;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_x_Set() const{
    return m_i_ezsignannotation_x_isSet;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_x_Valid() const{
    return m_i_ezsignannotation_x_isValid;
}

qint32 Ezsignannotation_Response::getIEzsignannotationY() const {
    return m_i_ezsignannotation_y;
}
void Ezsignannotation_Response::setIEzsignannotationY(const qint32 &i_ezsignannotation_y) {
    m_i_ezsignannotation_y = i_ezsignannotation_y;
    m_i_ezsignannotation_y_isSet = true;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_y_Set() const{
    return m_i_ezsignannotation_y_isSet;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_y_Valid() const{
    return m_i_ezsignannotation_y_isValid;
}

qint32 Ezsignannotation_Response::getIEzsignannotationWidth() const {
    return m_i_ezsignannotation_width;
}
void Ezsignannotation_Response::setIEzsignannotationWidth(const qint32 &i_ezsignannotation_width) {
    m_i_ezsignannotation_width = i_ezsignannotation_width;
    m_i_ezsignannotation_width_isSet = true;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_width_Set() const{
    return m_i_ezsignannotation_width_isSet;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_width_Valid() const{
    return m_i_ezsignannotation_width_isValid;
}

qint32 Ezsignannotation_Response::getIEzsignannotationHeight() const {
    return m_i_ezsignannotation_height;
}
void Ezsignannotation_Response::setIEzsignannotationHeight(const qint32 &i_ezsignannotation_height) {
    m_i_ezsignannotation_height = i_ezsignannotation_height;
    m_i_ezsignannotation_height_isSet = true;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_height_Set() const{
    return m_i_ezsignannotation_height_isSet;
}

bool Ezsignannotation_Response::is_i_ezsignannotation_height_Valid() const{
    return m_i_ezsignannotation_height_isValid;
}

QString Ezsignannotation_Response::getSEzsignannotationText() const {
    return m_s_ezsignannotation_text;
}
void Ezsignannotation_Response::setSEzsignannotationText(const QString &s_ezsignannotation_text) {
    m_s_ezsignannotation_text = s_ezsignannotation_text;
    m_s_ezsignannotation_text_isSet = true;
}

bool Ezsignannotation_Response::is_s_ezsignannotation_text_Set() const{
    return m_s_ezsignannotation_text_isSet;
}

bool Ezsignannotation_Response::is_s_ezsignannotation_text_Valid() const{
    return m_s_ezsignannotation_text_isValid;
}

qint32 Ezsignannotation_Response::getIEzsignpagePagenumber() const {
    return m_i_ezsignpage_pagenumber;
}
void Ezsignannotation_Response::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Ezsignannotation_Response::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Ezsignannotation_Response::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

bool Ezsignannotation_Response::isSet() const {
...
bool Ezsignannotation_Response::isValid() const {
