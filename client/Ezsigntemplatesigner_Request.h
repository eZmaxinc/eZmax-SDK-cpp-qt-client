...
#ifndef Ezsigntemplatesigner_Request_H
#define Ezsigntemplatesigner_Request_H
...
class Ezsigntemplatesigner_Request : public Object {
public:
    Ezsigntemplatesigner_Request();
    Ezsigntemplatesigner_Request(const QString &json);
    ~Ezsigntemplatesigner_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesigner_Request)

#endif // Ezsigntemplatesigner_Request_H
