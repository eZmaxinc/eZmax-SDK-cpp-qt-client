...
/*
 * OAIEzsignfoldertype_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/ezsignfoldertype/getAutocomplete
 */

#ifndef OAIEzsignfoldertype_getAutocomplete_v2_Response_H
#define OAIEzsignfoldertype_getAutocomplete_v2_Response_H
...
class OAIEzsignfoldertype_getAutocomplete_v2_Response : public OAIObject {
public:
    OAIEzsignfoldertype_getAutocomplete_v2_Response();
    OAIEzsignfoldertype_getAutocomplete_v2_Response(QString json);
    ~OAIEzsignfoldertype_getAutocomplete_v2_Response() override;
...
private:
    ...
    OAIEzsignfoldertype_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfoldertype_getAutocomplete_v2_Response)

#endif // OAIEzsignfoldertype_getAutocomplete_v2_Response_H
