...
/*
 * Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload.h
 *
 * Payload for POST /1/object/ezsigntemplatepackagemembership
 */

#ifndef Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload_H
#define Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload_H
...
class Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload : public Object {
public:
    Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload();
    Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload(const QString &json);
    ~Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload)

#endif // Ezsigntemplatepackagemembership_createObject_v1_Response_mPayload_H
