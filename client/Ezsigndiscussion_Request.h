...
#ifndef Ezsigndiscussion_Request_H
#define Ezsigndiscussion_Request_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndiscussion_Request)

#endif // Ezsigndiscussion_Request_H
