...
#ifndef Creditcardclient_Response_H
#define Creditcardclient_Response_H
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardclient_Response)

#endif // Creditcardclient_Response_H
