...
/*
 * Creditcardclient_RequestCompound.h
 *
 * A Creditcardclient Object and children
 */

#ifndef Creditcardclient_RequestCompound_H
#define Creditcardclient_RequestCompound_H
...
class Creditcardclient_RequestCompound : public Object {
public:
    Creditcardclient_RequestCompound();
    Creditcardclient_RequestCompound(const QString &json);
    ~Creditcardclient_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardclient_RequestCompound)

#endif // Creditcardclient_RequestCompound_H
