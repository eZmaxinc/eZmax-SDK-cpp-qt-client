...
void OAIObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationPatchObjectV1(const qint32 &pki_ezsignfoldersignerassociation_id, const OAIEzsignfoldersignerassociation_patchObject_v1_Request &oai_ezsignfoldersignerassociation_patch_object_v1_request) {
...

    {
        ...
        QByteArray output = oai_ezsignfoldersignerassociation_patch_object_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationPatchObjectV1Callback);
    connect(this, &OAIObjectEzsignfoldersignerassociationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldersignerassociationApi::ezsignfoldersignerassociationPatchObjectV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldersignerassociation_patchObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
