...
Ezsignformfieldgroupsigner_Request::Ezsignformfieldgroupsigner_Request(const QString &json) {
...
void Ezsignformfieldgroupsigner_Request::fromJson(const QString &jsonString) {
