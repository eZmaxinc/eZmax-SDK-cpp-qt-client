...
/*
 * Ezsigndocument_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigndocument/{pkiEzsigndocumentID}
 */

#ifndef Ezsigndocument_deleteObject_v1_Response_H
#define Ezsigndocument_deleteObject_v1_Response_H
...
class Ezsigndocument_deleteObject_v1_Response : public Object {
public:
    Ezsigndocument_deleteObject_v1_Response();
    Ezsigndocument_deleteObject_v1_Response(const QString &json);
    ~Ezsigndocument_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_deleteObject_v1_Response)

#endif // Ezsigndocument_deleteObject_v1_Response_H
