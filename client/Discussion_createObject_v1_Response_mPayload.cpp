...
Discussion_createObject_v1_Response_mPayload::Discussion_createObject_v1_Response_mPayload(const QString &json) {
...
void Discussion_createObject_v1_Response_mPayload::fromJson(const QString &jsonString) {
