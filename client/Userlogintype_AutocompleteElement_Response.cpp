...
Userlogintype_AutocompleteElement_Response::Userlogintype_AutocompleteElement_Response(const QString &json) {
...
void Userlogintype_AutocompleteElement_Response::fromJson(const QString &jsonString) {
