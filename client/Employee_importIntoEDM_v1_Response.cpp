...
Employee_importIntoEDM_v1_Response::Employee_importIntoEDM_v1_Response() {
    this->initializeModel();
}

Employee_importIntoEDM_v1_Response::~Employee_importIntoEDM_v1_Response() {}

void Employee_importIntoEDM_v1_Response::initializeModel() {
...
void Employee_importIntoEDM_v1_Response::fromJsonObject(QJsonObject json) {
...
QString Employee_importIntoEDM_v1_Response::asJson() const {
...
QJsonObject Employee_importIntoEDM_v1_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload Employee_importIntoEDM_v1_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Employee_importIntoEDM_v1_Response::setObjDebugPayload(const Common_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Employee_importIntoEDM_v1_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Employee_importIntoEDM_v1_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Employee_importIntoEDM_v1_Response::getObjDebug() const {
    return m_obj_debug;
}
void Employee_importIntoEDM_v1_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Employee_importIntoEDM_v1_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Employee_importIntoEDM_v1_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

Employee_importIntoEDM_v1_Response_mPayload Employee_importIntoEDM_v1_Response::getMPayload() const {
    return m_m_payload;
}
void Employee_importIntoEDM_v1_Response::setMPayload(const Employee_importIntoEDM_v1_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Employee_importIntoEDM_v1_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Employee_importIntoEDM_v1_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Employee_importIntoEDM_v1_Response::isSet() const {
...
bool Employee_importIntoEDM_v1_Response::isValid() const {
