...
#ifndef Ezsignbulksend_Request_H
#define Ezsignbulksend_Request_H
...
class Ezsignbulksend_Request : public Object {
public:
    Ezsignbulksend_Request();
    Ezsignbulksend_Request(const QString &json);
    ~Ezsignbulksend_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_Request)

#endif // Ezsignbulksend_Request_H
