...
/*
 * OAIPermission_Request.h
 *
 * A Permission Object
 */

#ifndef OAIPermission_Request_H
#define OAIPermission_Request_H
...
class OAIPermission_Request : public OAIObject {
public:
    OAIPermission_Request();
    OAIPermission_Request(QString json);
    ~OAIPermission_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPermission_Request)

#endif // OAIPermission_Request_H
