...
#ifndef Userstaged_map_v1_Response_H
#define Userstaged_map_v1_Response_H
...
class Userstaged_map_v1_Response : public Object {
public:
    Userstaged_map_v1_Response();
    Userstaged_map_v1_Response(const QString &json);
    ~Userstaged_map_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Userstaged_map_v1_Response)

#endif // Userstaged_map_v1_Response_H
