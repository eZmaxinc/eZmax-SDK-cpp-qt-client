...
Multilingual_NotificationsubsectionName::Multilingual_NotificationsubsectionName(const QString &json) {
...
void Multilingual_NotificationsubsectionName::fromJson(const QString &jsonString) {
