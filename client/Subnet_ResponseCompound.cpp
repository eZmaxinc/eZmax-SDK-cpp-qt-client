...
Subnet_ResponseCompound::Subnet_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Subnet_ResponseCompound::Subnet_ResponseCompound() {
    this->initializeModel();
}

Subnet_ResponseCompound::~Subnet_ResponseCompound() {}

void Subnet_ResponseCompound::initializeModel() {
...
void Subnet_ResponseCompound::fromJson(const QString &jsonString) {
...
void Subnet_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Subnet_ResponseCompound::asJson() const {
...
QJsonObject Subnet_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Subnet_ResponseCompound::getPkiSubnetId() const {
    return m_pki_subnet_id;
}
void Subnet_ResponseCompound::setPkiSubnetId(const qint32 &pki_subnet_id) {
    m_pki_subnet_id = pki_subnet_id;
    m_pki_subnet_id_isSet = true;
}

bool Subnet_ResponseCompound::is_pki_subnet_id_Set() const{
    return m_pki_subnet_id_isSet;
}

bool Subnet_ResponseCompound::is_pki_subnet_id_Valid() const{
    return m_pki_subnet_id_isValid;
}

qint32 Subnet_ResponseCompound::getFkiUserId() const {
    return m_fki_user_id;
}
void Subnet_ResponseCompound::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Subnet_ResponseCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Subnet_ResponseCompound::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Subnet_ResponseCompound::getFkiApikeyId() const {
    return m_fki_apikey_id;
}
void Subnet_ResponseCompound::setFkiApikeyId(const qint32 &fki_apikey_id) {
    m_fki_apikey_id = fki_apikey_id;
    m_fki_apikey_id_isSet = true;
}

bool Subnet_ResponseCompound::is_fki_apikey_id_Set() const{
    return m_fki_apikey_id_isSet;
}

bool Subnet_ResponseCompound::is_fki_apikey_id_Valid() const{
    return m_fki_apikey_id_isValid;
}

Multilingual_SubnetDescription Subnet_ResponseCompound::getObjSubnetDescription() const {
    return m_obj_subnet_description;
}
void Subnet_ResponseCompound::setObjSubnetDescription(const Multilingual_SubnetDescription &obj_subnet_description) {
    m_obj_subnet_description = obj_subnet_description;
    m_obj_subnet_description_isSet = true;
}

bool Subnet_ResponseCompound::is_obj_subnet_description_Set() const{
    return m_obj_subnet_description_isSet;
}

bool Subnet_ResponseCompound::is_obj_subnet_description_Valid() const{
    return m_obj_subnet_description_isValid;
}

qint64 Subnet_ResponseCompound::getISubnetNetwork() const {
    return m_i_subnet_network;
}
void Subnet_ResponseCompound::setISubnetNetwork(const qint64 &i_subnet_network) {
    m_i_subnet_network = i_subnet_network;
    m_i_subnet_network_isSet = true;
}

bool Subnet_ResponseCompound::is_i_subnet_network_Set() const{
    return m_i_subnet_network_isSet;
}

bool Subnet_ResponseCompound::is_i_subnet_network_Valid() const{
    return m_i_subnet_network_isValid;
}

qint64 Subnet_ResponseCompound::getISubnetMask() const {
    return m_i_subnet_mask;
}
void Subnet_ResponseCompound::setISubnetMask(const qint64 &i_subnet_mask) {
    m_i_subnet_mask = i_subnet_mask;
    m_i_subnet_mask_isSet = true;
}

bool Subnet_ResponseCompound::is_i_subnet_mask_Set() const{
    return m_i_subnet_mask_isSet;
}

bool Subnet_ResponseCompound::is_i_subnet_mask_Valid() const{
    return m_i_subnet_mask_isValid;
}

bool Subnet_ResponseCompound::isSet() const {
...
bool Subnet_ResponseCompound::isValid() const {
