...
/*
 * OAIEzsigntemplatesigner_createObject_v1_Response.h
 *
 * Response for POST /1/object/ezsigntemplatesigner
 */

#ifndef OAIEzsigntemplatesigner_createObject_v1_Response_H
#define OAIEzsigntemplatesigner_createObject_v1_Response_H
...
class OAIEzsigntemplatesigner_createObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatesigner_createObject_v1_Response();
    OAIEzsigntemplatesigner_createObject_v1_Response(QString json);
    ~OAIEzsigntemplatesigner_createObject_v1_Response() override;
...
private:
    ...
    OAIEzsigntemplatesigner_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesigner_createObject_v1_Response)

#endif // OAIEzsigntemplatesigner_createObject_v1_Response_H
