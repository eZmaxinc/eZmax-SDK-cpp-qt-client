...
bool Activesession_getCurrent_v1_Response_mPayload::isBActivesessionAttachment() const {
    return m_b_activesession_attachment;
}
void Activesession_getCurrent_v1_Response_mPayload::setBActivesessionAttachment(const bool &b_activesession_attachment) {
    m_b_activesession_attachment = b_activesession_attachment;
    m_b_activesession_attachment_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_attachment_Set() const{
    return m_b_activesession_attachment_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_attachment_Valid() const{
    return m_b_activesession_attachment_isValid;
}

bool Activesession_getCurrent_v1_Response_mPayload::isBActivesessionCanafe() const {
    return m_b_activesession_canafe;
}
void Activesession_getCurrent_v1_Response_mPayload::setBActivesessionCanafe(const bool &b_activesession_canafe) {
    m_b_activesession_canafe = b_activesession_canafe;
    m_b_activesession_canafe_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_canafe_Set() const{
    return m_b_activesession_canafe_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_canafe_Valid() const{
    return m_b_activesession_canafe_isValid;
}

bool Activesession_getCurrent_v1_Response_mPayload::isBActivesessionFinancial() const {
    return m_b_activesession_financial;
}
void Activesession_getCurrent_v1_Response_mPayload::setBActivesessionFinancial(const bool &b_activesession_financial) {
    m_b_activesession_financial = b_activesession_financial;
    m_b_activesession_financial_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_financial_Set() const{
    return m_b_activesession_financial_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_financial_Valid() const{
    return m_b_activesession_financial_isValid;
}

bool Activesession_getCurrent_v1_Response_mPayload::isBActivesessionRealestatecompleted() const {
    return m_b_activesession_realestatecompleted;
}
void Activesession_getCurrent_v1_Response_mPayload::setBActivesessionRealestatecompleted(const bool &b_activesession_realestatecompleted) {
...
bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_realestatecompleted_Set() const{
    return m_b_activesession_realestatecompleted_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_activesession_realestatecompleted_Valid() const{
    return m_b_activesession_realestatecompleted_isValid;
}

Field_eActivesessionEzsign Activesession_getCurrent_v1_Response_mPayload::getEActivesessionEzsign() const {
    return m_e_activesession_ezsign;
}
void Activesession_getCurrent_v1_Response_mPayload::setEActivesessionEzsign(const Field_eActivesessionEzsign &e_activesession_ezsign) {
    m_e_activesession_ezsign = e_activesession_ezsign;
    m_e_activesession_ezsign_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsign_Set() const{
    return m_e_activesession_ezsign_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsign_Valid() const{
    return m_e_activesession_ezsign_isValid;
}

Field_eActivesessionEzsignaccess Activesession_getCurrent_v1_Response_mPayload::getEActivesessionEzsignaccess() const {
    return m_e_activesession_ezsignaccess;
}
void Activesession_getCurrent_v1_Response_mPayload::setEActivesessionEzsignaccess(const Field_eActivesessionEzsignaccess &e_activesession_ezsignaccess) {
    m_e_activesession_ezsignaccess = e_activesession_ezsignaccess;
    m_e_activesession_ezsignaccess_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsignaccess_Set() const{
    return m_e_activesession_ezsignaccess_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsignaccess_Valid() const{
    return m_e_activesession_ezsignaccess_isValid;
}

Field_eActivesessionEzsignprepaid Activesession_getCurrent_v1_Response_mPayload::getEActivesessionEzsignprepaid() const {
    return m_e_activesession_ezsignprepaid;
}
void Activesession_getCurrent_v1_Response_mPayload::setEActivesessionEzsignprepaid(const Field_eActivesessionEzsignprepaid &e_activesession_ezsignprepaid) {
    m_e_activesession_ezsignprepaid = e_activesession_ezsignprepaid;
    m_e_activesession_ezsignprepaid_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsignprepaid_Set() const{
    return m_e_activesession_ezsignprepaid_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_ezsignprepaid_Valid() const{
    return m_e_activesession_ezsignprepaid_isValid;
}

Field_eActivesessionRealestateinprogress Activesession_getCurrent_v1_Response_mPayload::getEActivesessionRealestateinprogress() const {
    return m_e_activesession_realestateinprogress;
}
void Activesession_getCurrent_v1_Response_mPayload::setEActivesessionRealestateinprogress(const Field_eActivesessionRealestateinprogress &e_activesession_realestateinprogress) {
...
bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_realestateinprogress_Set() const{
    return m_e_activesession_realestateinprogress_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_e_activesession_realestateinprogress_Valid() const{
...
qint32 Activesession_getCurrent_v1_Response_mPayload::getFkiEzsignuserId() const {
    return m_fki_ezsignuser_id;
}
void Activesession_getCurrent_v1_Response_mPayload::setFkiEzsignuserId(const qint32 &fki_ezsignuser_id) {
    m_fki_ezsignuser_id = fki_ezsignuser_id;
    m_fki_ezsignuser_id_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_fki_ezsignuser_id_Set() const{
    return m_fki_ezsignuser_id_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_fki_ezsignuser_id_Valid() const{
...
bool Activesession_getCurrent_v1_Response_mPayload::isBUserEzsigntrial() const {
    return m_b_user_ezsigntrial;
}
void Activesession_getCurrent_v1_Response_mPayload::setBUserEzsigntrial(const bool &b_user_ezsigntrial) {
    m_b_user_ezsigntrial = b_user_ezsigntrial;
    m_b_user_ezsigntrial_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_user_ezsigntrial_Set() const{
    return m_b_user_ezsigntrial_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_b_user_ezsigntrial_Valid() const{
...
QString Activesession_getCurrent_v1_Response_mPayload::getDtUserNpsrequest() const {
    return m_dt_user_npsrequest;
}
void Activesession_getCurrent_v1_Response_mPayload::setDtUserNpsrequest(const QString &dt_user_npsrequest) {
    m_dt_user_npsrequest = dt_user_npsrequest;
    m_dt_user_npsrequest_isSet = true;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_dt_user_npsrequest_Set() const{
    return m_dt_user_npsrequest_isSet;
}

bool Activesession_getCurrent_v1_Response_mPayload::is_dt_user_npsrequest_Valid() const{
