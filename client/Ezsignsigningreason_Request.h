...
#ifndef Ezsignsigningreason_Request_H
#define Ezsignsigningreason_Request_H
...
class Ezsignsigningreason_Request : public Object {
public:
    Ezsignsigningreason_Request();
    Ezsignsigningreason_Request(const QString &json);
    ~Ezsignsigningreason_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsigningreason_Request)

#endif // Ezsignsigningreason_Request_H
