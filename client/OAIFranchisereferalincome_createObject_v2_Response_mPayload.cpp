...
OAIFranchisereferalincome_createObject_v2_Response_mPayload::OAIFranchisereferalincome_createObject_v2_Response_mPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFranchisereferalincome_createObject_v2_Response_mPayload::OAIFranchisereferalincome_createObject_v2_Response_mPayload() {
    this->initializeModel();
}

OAIFranchisereferalincome_createObject_v2_Response_mPayload::~OAIFranchisereferalincome_createObject_v2_Response_mPayload() {}

void OAIFranchisereferalincome_createObject_v2_Response_mPayload::initializeModel() {

    m_a_pki_franchisereferalincome_id_isSet = false;
    m_a_pki_franchisereferalincome_id_isValid = false;
}

void OAIFranchisereferalincome_createObject_v2_Response_mPayload::fromJson(QString jsonString) {
...
QString OAIFranchisereferalincome_createObject_v2_Response_mPayload::asJson() const {
...
bool OAIFranchisereferalincome_createObject_v2_Response_mPayload::is_a_pki_franchisereferalincome_id_Valid() const{
...
bool OAIFranchisereferalincome_createObject_v2_Response_mPayload::isValid() const {
