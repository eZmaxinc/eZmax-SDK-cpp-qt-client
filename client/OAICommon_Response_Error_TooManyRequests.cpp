...
QString OAICommon_Response_Error_TooManyRequests::getEErrorCode() const {
    return e_error_code;
}
void OAICommon_Response_Error_TooManyRequests::setEErrorCode(const QString &e_error_code) {
