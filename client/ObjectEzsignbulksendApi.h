...
#include "Ezsignbulksend_getObject_v4_Response.h"
...
public:
    ...
    * @param[in]  pki_ezsignbulksend_id qint32 [required]
    */
    Q_DECL_DEPRECATED virtual void ezsignbulksendGetObjectV3(const qint32 &pki_ezsignbulksend_id);

    /**
    * @param[in]  pki_ezsignbulksend_id qint32 [required]
    */
    virtual void ezsignbulksendGetObjectV4(const qint32 &pki_ezsignbulksend_id);
...
private:
    ...
    void ezsignbulksendGetObjectV4Callback(HttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void ezsignbulksendGetObjectV4Signal(Ezsignbulksend_getObject_v4_Response summary);
    ...
    void ezsignbulksendGetObjectV4SignalFull(HttpRequestWorker *worker, Ezsignbulksend_getObject_v4_Response summary);
    ...
    void ezsignbulksendGetObjectV4SignalError(Ezsignbulksend_getObject_v4_Response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void ezsignbulksendGetObjectV4SignalErrorFull(HttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
