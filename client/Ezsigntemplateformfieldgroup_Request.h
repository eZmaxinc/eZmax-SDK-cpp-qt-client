...
#ifndef Ezsigntemplateformfieldgroup_Request_H
#define Ezsigntemplateformfieldgroup_Request_H
...
class Ezsigntemplateformfieldgroup_Request : public Object {
public:
    Ezsigntemplateformfieldgroup_Request();
    Ezsigntemplateformfieldgroup_Request(const QString &json);
    ~Ezsigntemplateformfieldgroup_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplateformfieldgroup_Request)

#endif // Ezsigntemplateformfieldgroup_Request_H
