...
/*
 * OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}
 */

#ifndef OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload_H
#define OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload_H
...
class OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload();
    OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload(QString json);
    ~OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload)

#endif // OAIEzsigntemplatepackagesignermembership_getObject_v1_Response_mPayload_H
