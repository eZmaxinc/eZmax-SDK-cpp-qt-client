...
/*
 * Signature_editObject_v1_Response.h
 *
 * Response for PUT /1/object/signature/{pkiSignatureID}
 */

#ifndef Signature_editObject_v1_Response_H
#define Signature_editObject_v1_Response_H
...
class Signature_editObject_v1_Response : public Object {
public:
    Signature_editObject_v1_Response();
    Signature_editObject_v1_Response(const QString &json);
    ~Signature_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Signature_editObject_v1_Response)

#endif // Signature_editObject_v1_Response_H
