...
/*
 * Ezsignbulksend_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsignbulksend/{pkiEzsignbulksendID}
 */

#ifndef Ezsignbulksend_editObject_v1_Response_H
#define Ezsignbulksend_editObject_v1_Response_H
...
class Ezsignbulksend_editObject_v1_Response : public Object {
public:
    Ezsignbulksend_editObject_v1_Response();
    Ezsignbulksend_editObject_v1_Response(QString json);
    ~Ezsignbulksend_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignbulksend_editObject_v1_Response)

#endif // Ezsignbulksend_editObject_v1_Response_H
