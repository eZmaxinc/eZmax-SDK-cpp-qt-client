...
#ifndef Ezsignfolder_RequestCompound_H
#define Ezsignfolder_RequestCompound_H
...
class Ezsignfolder_RequestCompound : public Object {
public:
    Ezsignfolder_RequestCompound();
    Ezsignfolder_RequestCompound(const QString &json);
    ~Ezsignfolder_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_RequestCompound)

#endif // Ezsignfolder_RequestCompound_H
