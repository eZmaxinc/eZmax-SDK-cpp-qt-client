...
/*
 * OAIEzsigndocument_getCompletedElements_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements
 */

#ifndef OAIEzsigndocument_getCompletedElements_v1_Response_mPayload_H
#define OAIEzsigndocument_getCompletedElements_v1_Response_mPayload_H
...
class OAIEzsigndocument_getCompletedElements_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsigndocument_getCompletedElements_v1_Response_mPayload();
    OAIEzsigndocument_getCompletedElements_v1_Response_mPayload(QString json);
    ~OAIEzsigndocument_getCompletedElements_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_getCompletedElements_v1_Response_mPayload)

#endif // OAIEzsigndocument_getCompletedElements_v1_Response_mPayload_H
