...
Ezsignsignature_Request::Ezsignsignature_Request(const QString &json) {
...
void Ezsignsignature_Request::initializeModel() {
...
void Ezsignsignature_Request::fromJson(const QString &jsonString) {
...
void Ezsignsignature_Request::fromJsonObject(QJsonObject json) {
...
QJsonObject Ezsignsignature_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignature_Request::getPkiEzsignsignatureId() const {
    return m_pki_ezsignsignature_id;
}
void Ezsignsignature_Request::setPkiEzsignsignatureId(const qint32 &pki_ezsignsignature_id) {
    m_pki_ezsignsignature_id = pki_ezsignsignature_id;
    m_pki_ezsignsignature_id_isSet = true;
}

bool Ezsignsignature_Request::is_pki_ezsignsignature_id_Set() const{
    return m_pki_ezsignsignature_id_isSet;
}

bool Ezsignsignature_Request::is_pki_ezsignsignature_id_Valid() const{
    return m_pki_ezsignsignature_id_isValid;
}

qint32 Ezsignsignature_Request::getFkiEzsignfoldersignerassociationId() const {
    return m_fki_ezsignfoldersignerassociation_id;
}
void Ezsignsignature_Request::setFkiEzsignfoldersignerassociationId(const qint32 &fki_ezsignfoldersignerassociation_id) {
...
bool Ezsignsignature_Request::is_fki_ezsignfoldersignerassociation_id_Set() const{
...
void Ezsignsignature_Request::setIEzsignpagePagenumber(const qint32 &i_ezsignpage_pagenumber) {
    m_i_ezsignpage_pagenumber = i_ezsignpage_pagenumber;
    m_i_ezsignpage_pagenumber_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignpage_pagenumber_Set() const{
    return m_i_ezsignpage_pagenumber_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignpage_pagenumber_Valid() const{
    return m_i_ezsignpage_pagenumber_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureX() const {
    return m_i_ezsignsignature_x;
}
void Ezsignsignature_Request::setIEzsignsignatureX(const qint32 &i_ezsignsignature_x) {
    m_i_ezsignsignature_x = i_ezsignsignature_x;
    m_i_ezsignsignature_x_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_x_Set() const{
    return m_i_ezsignsignature_x_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_x_Valid() const{
    return m_i_ezsignsignature_x_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureY() const {
    return m_i_ezsignsignature_y;
}
void Ezsignsignature_Request::setIEzsignsignatureY(const qint32 &i_ezsignsignature_y) {
    m_i_ezsignsignature_y = i_ezsignsignature_y;
    m_i_ezsignsignature_y_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_y_Set() const{
    return m_i_ezsignsignature_y_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_y_Valid() const{
    return m_i_ezsignsignature_y_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureWidth() const {
    return m_i_ezsignsignature_width;
}
void Ezsignsignature_Request::setIEzsignsignatureWidth(const qint32 &i_ezsignsignature_width) {
    m_i_ezsignsignature_width = i_ezsignsignature_width;
    m_i_ezsignsignature_width_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_width_Set() const{
    return m_i_ezsignsignature_width_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_width_Valid() const{
    return m_i_ezsignsignature_width_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureHeight() const {
    return m_i_ezsignsignature_height;
}
void Ezsignsignature_Request::setIEzsignsignatureHeight(const qint32 &i_ezsignsignature_height) {
    m_i_ezsignsignature_height = i_ezsignsignature_height;
    m_i_ezsignsignature_height_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_height_Set() const{
    return m_i_ezsignsignature_height_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_height_Valid() const{
    return m_i_ezsignsignature_height_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureStep() const {
    return m_i_ezsignsignature_step;
}
void Ezsignsignature_Request::setIEzsignsignatureStep(const qint32 &i_ezsignsignature_step) {
    m_i_ezsignsignature_step = i_ezsignsignature_step;
    m_i_ezsignsignature_step_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_step_Set() const{
    return m_i_ezsignsignature_step_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_step_Valid() const{
    return m_i_ezsignsignature_step_isValid;
}

Field_eEzsignsignatureType Ezsignsignature_Request::getEEzsignsignatureType() const {
    return m_e_ezsignsignature_type;
}
void Ezsignsignature_Request::setEEzsignsignatureType(const Field_eEzsignsignatureType &e_ezsignsignature_type) {
    m_e_ezsignsignature_type = e_ezsignsignature_type;
    m_e_ezsignsignature_type_isSet = true;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_type_Set() const{
    return m_e_ezsignsignature_type_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_type_Valid() const{
    return m_e_ezsignsignature_type_isValid;
}

Field_eEzsignsignatureSignaturepad Ezsignsignature_Request::getEEzsignsignatureSignaturepad() const {
    return m_e_ezsignsignature_signaturepad;
}
void Ezsignsignature_Request::setEEzsignsignatureSignaturepad(const Field_eEzsignsignatureSignaturepad &e_ezsignsignature_signaturepad) {
    m_e_ezsignsignature_signaturepad = e_ezsignsignature_signaturepad;
    m_e_ezsignsignature_signaturepad_isSet = true;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_signaturepad_Set() const{
    return m_e_ezsignsignature_signaturepad_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_signaturepad_Valid() const{
    return m_e_ezsignsignature_signaturepad_isValid;
}

Field_eEzsignsignatureSignaturepadrequired Ezsignsignature_Request::getEEzsignsignatureSignaturepadrequired() const {
    return m_e_ezsignsignature_signaturepadrequired;
}
void Ezsignsignature_Request::setEEzsignsignatureSignaturepadrequired(const Field_eEzsignsignatureSignaturepadrequired &e_ezsignsignature_signaturepadrequired) {
...
bool Ezsignsignature_Request::is_e_ezsignsignature_signaturepadrequired_Set() const{
    return m_e_ezsignsignature_signaturepadrequired_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_signaturepadrequired_Valid() const{
    return m_e_ezsignsignature_signaturepadrequired_isValid;
}

qint32 Ezsignsignature_Request::getFkiEzsigndocumentId() const {
    return m_fki_ezsigndocument_id;
}
void Ezsignsignature_Request::setFkiEzsigndocumentId(const qint32 &fki_ezsigndocument_id) {
    m_fki_ezsigndocument_id = fki_ezsigndocument_id;
    m_fki_ezsigndocument_id_isSet = true;
}

bool Ezsignsignature_Request::is_fki_ezsigndocument_id_Set() const{
    return m_fki_ezsigndocument_id_isSet;
}

bool Ezsignsignature_Request::is_fki_ezsigndocument_id_Valid() const{
    return m_fki_ezsigndocument_id_isValid;
}

QString Ezsignsignature_Request::getTEzsignsignatureTooltip() const {
    return m_t_ezsignsignature_tooltip;
}
void Ezsignsignature_Request::setTEzsignsignatureTooltip(const QString &t_ezsignsignature_tooltip) {
    m_t_ezsignsignature_tooltip = t_ezsignsignature_tooltip;
    m_t_ezsignsignature_tooltip_isSet = true;
}

bool Ezsignsignature_Request::is_t_ezsignsignature_tooltip_Set() const{
    return m_t_ezsignsignature_tooltip_isSet;
}

bool Ezsignsignature_Request::is_t_ezsignsignature_tooltip_Valid() const{
    return m_t_ezsignsignature_tooltip_isValid;
}

Field_eEzsignsignatureTooltipposition Ezsignsignature_Request::getEEzsignsignatureTooltipposition() const {
    return m_e_ezsignsignature_tooltipposition;
}
void Ezsignsignature_Request::setEEzsignsignatureTooltipposition(const Field_eEzsignsignatureTooltipposition &e_ezsignsignature_tooltipposition) {
    m_e_ezsignsignature_tooltipposition = e_ezsignsignature_tooltipposition;
    m_e_ezsignsignature_tooltipposition_isSet = true;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_tooltipposition_Set() const{
    return m_e_ezsignsignature_tooltipposition_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_tooltipposition_Valid() const{
    return m_e_ezsignsignature_tooltipposition_isValid;
}

Field_eEzsignsignatureFont Ezsignsignature_Request::getEEzsignsignatureFont() const {
    return m_e_ezsignsignature_font;
}
void Ezsignsignature_Request::setEEzsignsignatureFont(const Field_eEzsignsignatureFont &e_ezsignsignature_font) {
    m_e_ezsignsignature_font = e_ezsignsignature_font;
    m_e_ezsignsignature_font_isSet = true;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_font_Set() const{
    return m_e_ezsignsignature_font_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_font_Valid() const{
    return m_e_ezsignsignature_font_isValid;
}

qint32 Ezsignsignature_Request::getFkiEzsignfoldersignerassociationIdValidation() const {
    return m_fki_ezsignfoldersignerassociation_id_validation;
}
void Ezsignsignature_Request::setFkiEzsignfoldersignerassociationIdValidation(const qint32 &fki_ezsignfoldersignerassociation_id_validation) {
...
bool Ezsignsignature_Request::is_fki_ezsignfoldersignerassociation_id_validation_Set() const{
    return m_fki_ezsignfoldersignerassociation_id_validation_isSet;
}

bool Ezsignsignature_Request::is_fki_ezsignfoldersignerassociation_id_validation_Valid() const{
    return m_fki_ezsignfoldersignerassociation_id_validation_isValid;
}

bool Ezsignsignature_Request::isBEzsignsignatureHandwritten() const {
    return m_b_ezsignsignature_handwritten;
}
void Ezsignsignature_Request::setBEzsignsignatureHandwritten(const bool &b_ezsignsignature_handwritten) {
    m_b_ezsignsignature_handwritten = b_ezsignsignature_handwritten;
    m_b_ezsignsignature_handwritten_isSet = true;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_handwritten_Set() const{
    return m_b_ezsignsignature_handwritten_isSet;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_handwritten_Valid() const{
    return m_b_ezsignsignature_handwritten_isValid;
}

bool Ezsignsignature_Request::isBEzsignsignatureReason() const {
    return m_b_ezsignsignature_reason;
}
void Ezsignsignature_Request::setBEzsignsignatureReason(const bool &b_ezsignsignature_reason) {
    m_b_ezsignsignature_reason = b_ezsignsignature_reason;
    m_b_ezsignsignature_reason_isSet = true;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_reason_Set() const{
    return m_b_ezsignsignature_reason_isSet;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_reason_Valid() const{
    return m_b_ezsignsignature_reason_isValid;
}

bool Ezsignsignature_Request::isBEzsignsignatureRequired() const {
    return m_b_ezsignsignature_required;
}
void Ezsignsignature_Request::setBEzsignsignatureRequired(const bool &b_ezsignsignature_required) {
    m_b_ezsignsignature_required = b_ezsignsignature_required;
    m_b_ezsignsignature_required_isSet = true;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_required_Set() const{
    return m_b_ezsignsignature_required_isSet;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_required_Valid() const{
    return m_b_ezsignsignature_required_isValid;
}

Field_eEzsignsignatureAttachmentnamesource Ezsignsignature_Request::getEEzsignsignatureAttachmentnamesource() const {
    return m_e_ezsignsignature_attachmentnamesource;
}
void Ezsignsignature_Request::setEEzsignsignatureAttachmentnamesource(const Field_eEzsignsignatureAttachmentnamesource &e_ezsignsignature_attachmentnamesource) {
...
bool Ezsignsignature_Request::is_e_ezsignsignature_attachmentnamesource_Set() const{
    return m_e_ezsignsignature_attachmentnamesource_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_attachmentnamesource_Valid() const{
    return m_e_ezsignsignature_attachmentnamesource_isValid;
}

QString Ezsignsignature_Request::getSEzsignsignatureAttachmentdescription() const {
    return m_s_ezsignsignature_attachmentdescription;
}
void Ezsignsignature_Request::setSEzsignsignatureAttachmentdescription(const QString &s_ezsignsignature_attachmentdescription) {
...
bool Ezsignsignature_Request::is_s_ezsignsignature_attachmentdescription_Set() const{
    return m_s_ezsignsignature_attachmentdescription_isSet;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_attachmentdescription_Valid() const{
    return m_s_ezsignsignature_attachmentdescription_isValid;
}

Field_eEzsignsignatureConsultationtrigger Ezsignsignature_Request::getEEzsignsignatureConsultationtrigger() const {
    return m_e_ezsignsignature_consultationtrigger;
}
void Ezsignsignature_Request::setEEzsignsignatureConsultationtrigger(const Field_eEzsignsignatureConsultationtrigger &e_ezsignsignature_consultationtrigger) {
...
bool Ezsignsignature_Request::is_e_ezsignsignature_consultationtrigger_Set() const{
    return m_e_ezsignsignature_consultationtrigger_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_consultationtrigger_Valid() const{
    return m_e_ezsignsignature_consultationtrigger_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureValidationstep() const {
    return m_i_ezsignsignature_validationstep;
}
void Ezsignsignature_Request::setIEzsignsignatureValidationstep(const qint32 &i_ezsignsignature_validationstep) {
    m_i_ezsignsignature_validationstep = i_ezsignsignature_validationstep;
    m_i_ezsignsignature_validationstep_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_validationstep_Set() const{
    return m_i_ezsignsignature_validationstep_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_validationstep_Valid() const{
    return m_i_ezsignsignature_validationstep_isValid;
}

qint32 Ezsignsignature_Request::getIEzsignsignatureMaxlength() const {
    return m_i_ezsignsignature_maxlength;
}
void Ezsignsignature_Request::setIEzsignsignatureMaxlength(const qint32 &i_ezsignsignature_maxlength) {
    m_i_ezsignsignature_maxlength = i_ezsignsignature_maxlength;
    m_i_ezsignsignature_maxlength_isSet = true;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_maxlength_Set() const{
    return m_i_ezsignsignature_maxlength_isSet;
}

bool Ezsignsignature_Request::is_i_ezsignsignature_maxlength_Valid() const{
    return m_i_ezsignsignature_maxlength_isValid;
}

QString Ezsignsignature_Request::getSEzsignsignatureDefaultvalue() const {
    return m_s_ezsignsignature_defaultvalue;
}
void Ezsignsignature_Request::setSEzsignsignatureDefaultvalue(const QString &s_ezsignsignature_defaultvalue) {
    m_s_ezsignsignature_defaultvalue = s_ezsignsignature_defaultvalue;
    m_s_ezsignsignature_defaultvalue_isSet = true;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_defaultvalue_Set() const{
    return m_s_ezsignsignature_defaultvalue_isSet;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_defaultvalue_Valid() const{
    return m_s_ezsignsignature_defaultvalue_isValid;
}

Enum_Textvalidation Ezsignsignature_Request::getEEzsignsignatureTextvalidation() const {
    return m_e_ezsignsignature_textvalidation;
}
void Ezsignsignature_Request::setEEzsignsignatureTextvalidation(const Enum_Textvalidation &e_ezsignsignature_textvalidation) {
    m_e_ezsignsignature_textvalidation = e_ezsignsignature_textvalidation;
    m_e_ezsignsignature_textvalidation_isSet = true;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_textvalidation_Set() const{
    return m_e_ezsignsignature_textvalidation_isSet;
}

bool Ezsignsignature_Request::is_e_ezsignsignature_textvalidation_Valid() const{
    return m_e_ezsignsignature_textvalidation_isValid;
}

QString Ezsignsignature_Request::getSEzsignsignatureTextvalidationcustommessage() const {
    return m_s_ezsignsignature_textvalidationcustommessage;
}
void Ezsignsignature_Request::setSEzsignsignatureTextvalidationcustommessage(const QString &s_ezsignsignature_textvalidationcustommessage) {
...
bool Ezsignsignature_Request::is_s_ezsignsignature_textvalidationcustommessage_Set() const{
    return m_s_ezsignsignature_textvalidationcustommessage_isSet;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_textvalidationcustommessage_Valid() const{
    return m_s_ezsignsignature_textvalidationcustommessage_isValid;
}

QString Ezsignsignature_Request::getSEzsignsignatureRegexp() const {
    return m_s_ezsignsignature_regexp;
}
void Ezsignsignature_Request::setSEzsignsignatureRegexp(const QString &s_ezsignsignature_regexp) {
    m_s_ezsignsignature_regexp = s_ezsignsignature_regexp;
    m_s_ezsignsignature_regexp_isSet = true;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_regexp_Set() const{
    return m_s_ezsignsignature_regexp_isSet;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_regexp_Valid() const{
...
QString Ezsignsignature_Request::getSEzsignsignatureCreditcardamountdescription() const {
    return m_s_ezsignsignature_creditcardamountdescription;
}
void Ezsignsignature_Request::setSEzsignsignatureCreditcardamountdescription(const QString &s_ezsignsignature_creditcardamountdescription) {
...
bool Ezsignsignature_Request::is_s_ezsignsignature_creditcardamountdescription_Set() const{
    return m_s_ezsignsignature_creditcardamountdescription_isSet;
}

bool Ezsignsignature_Request::is_s_ezsignsignature_creditcardamountdescription_Valid() const{
    return m_s_ezsignsignature_creditcardamountdescription_isValid;
}

QString Ezsignsignature_Request::getDEzsignsignatureCreditcardamount() const {
    return m_d_ezsignsignature_creditcardamount;
}
void Ezsignsignature_Request::setDEzsignsignatureCreditcardamount(const QString &d_ezsignsignature_creditcardamount) {
    m_d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount;
    m_d_ezsignsignature_creditcardamount_isSet = true;
}

bool Ezsignsignature_Request::is_d_ezsignsignature_creditcardamount_Set() const{
    return m_d_ezsignsignature_creditcardamount_isSet;
}

bool Ezsignsignature_Request::is_d_ezsignsignature_creditcardamount_Valid() const{
    return m_d_ezsignsignature_creditcardamount_isValid;
}

bool Ezsignsignature_Request::isBEzsignsignatureCreditcardcustomamount() const {
    return m_b_ezsignsignature_creditcardcustomamount;
}
void Ezsignsignature_Request::setBEzsignsignatureCreditcardcustomamount(const bool &b_ezsignsignature_creditcardcustomamount) {
...
bool Ezsignsignature_Request::is_b_ezsignsignature_creditcardcustomamount_Set() const{
    return m_b_ezsignsignature_creditcardcustomamount_isSet;
}

bool Ezsignsignature_Request::is_b_ezsignsignature_creditcardcustomamount_Valid() const{
...
bool Ezsignsignature_Request::isValid() const {
