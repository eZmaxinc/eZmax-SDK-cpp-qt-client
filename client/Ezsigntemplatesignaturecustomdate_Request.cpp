...
Ezsigntemplatesignaturecustomdate_Request::Ezsigntemplatesignaturecustomdate_Request(const QString &json) {
...
void Ezsigntemplatesignaturecustomdate_Request::fromJson(const QString &jsonString) {
