...
Ezsigntemplateglobal_getObject_v2_Response_mPayload::Ezsigntemplateglobal_getObject_v2_Response_mPayload(const QString &json) {
...
void Ezsigntemplateglobal_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
