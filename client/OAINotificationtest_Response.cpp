...
bool OAINotificationtest_Response::isValid() const {
    ...
    return m_pki_notificationtest_id_isValid && m_fki_notificationsubsection_id_isValid && m_s_notificationtest_function_isValid && m_s_notificationtest_name_x_isValid && true;
}
