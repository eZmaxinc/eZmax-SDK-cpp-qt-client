...
QString OAIEzsigndocument_RequestCompound::getSEzsigndocumentFilename() const {
    return s_ezsigndocument_filename;
}
void OAIEzsigndocument_RequestCompound::setSEzsigndocumentFilename(const QString &s_ezsigndocument_filename) {
    this->s_ezsigndocument_filename = s_ezsigndocument_filename;
    this->m_s_ezsigndocument_filename_isSet = true;
}

bool OAIEzsigndocument_RequestCompound::is_s_ezsigndocument_filename_Set() const{
    return m_s_ezsigndocument_filename_isSet;
}

bool OAIEzsigndocument_RequestCompound::is_s_ezsigndocument_filename_Valid() const{
...
bool OAIEzsigndocument_RequestCompound::isValid() const {
    ...
    return m_e_ezsigndocument_source_isValid && m_e_ezsigndocument_format_isValid && m_fki_ezsignfolder_id_isValid && m_dt_ezsigndocument_duedate_isValid && m_fki_language_id_isValid && m_s_ezsigndocument_filename_isValid && m_s_ezsigndocument_name_isValid && true;
}
