...
Ezsigntemplate_RequestCompound::Ezsigntemplate_RequestCompound(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsigntemplate_RequestCompound::Ezsigntemplate_RequestCompound() {
    this->initializeModel();
}

Ezsigntemplate_RequestCompound::~Ezsigntemplate_RequestCompound() {}

void Ezsigntemplate_RequestCompound::initializeModel() {
...
void Ezsigntemplate_RequestCompound::fromJson(QString jsonString) {
...
void Ezsigntemplate_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsigntemplate_RequestCompound::asJson() const {
...
QJsonObject Ezsigntemplate_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsigntemplate_RequestCompound::getPkiEzsigntemplateId() const {
    return m_pki_ezsigntemplate_id;
}
void Ezsigntemplate_RequestCompound::setPkiEzsigntemplateId(const qint32 &pki_ezsigntemplate_id) {
    m_pki_ezsigntemplate_id = pki_ezsigntemplate_id;
    m_pki_ezsigntemplate_id_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_pki_ezsigntemplate_id_Set() const{
    return m_pki_ezsigntemplate_id_isSet;
}

bool Ezsigntemplate_RequestCompound::is_pki_ezsigntemplate_id_Valid() const{
    return m_pki_ezsigntemplate_id_isValid;
}

qint32 Ezsigntemplate_RequestCompound::getFkiEzsignfoldertypeId() const {
    return m_fki_ezsignfoldertype_id;
}
void Ezsigntemplate_RequestCompound::setFkiEzsignfoldertypeId(const qint32 &fki_ezsignfoldertype_id) {
    m_fki_ezsignfoldertype_id = fki_ezsignfoldertype_id;
    m_fki_ezsignfoldertype_id_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_fki_ezsignfoldertype_id_Set() const{
    return m_fki_ezsignfoldertype_id_isSet;
}

bool Ezsigntemplate_RequestCompound::is_fki_ezsignfoldertype_id_Valid() const{
    return m_fki_ezsignfoldertype_id_isValid;
}

qint32 Ezsigntemplate_RequestCompound::getFkiLanguageId() const {
    return m_fki_language_id;
}
void Ezsigntemplate_RequestCompound::setFkiLanguageId(const qint32 &fki_language_id) {
    m_fki_language_id = fki_language_id;
    m_fki_language_id_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool Ezsigntemplate_RequestCompound::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

QString Ezsigntemplate_RequestCompound::getSEzsigntemplateDescription() const {
    return m_s_ezsigntemplate_description;
}
void Ezsigntemplate_RequestCompound::setSEzsigntemplateDescription(const QString &s_ezsigntemplate_description) {
    m_s_ezsigntemplate_description = s_ezsigntemplate_description;
    m_s_ezsigntemplate_description_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_s_ezsigntemplate_description_Set() const{
    return m_s_ezsigntemplate_description_isSet;
}

bool Ezsigntemplate_RequestCompound::is_s_ezsigntemplate_description_Valid() const{
    return m_s_ezsigntemplate_description_isValid;
}

QString Ezsigntemplate_RequestCompound::getSEzsigntemplateFilenamepattern() const {
    return m_s_ezsigntemplate_filenamepattern;
}
void Ezsigntemplate_RequestCompound::setSEzsigntemplateFilenamepattern(const QString &s_ezsigntemplate_filenamepattern) {
    m_s_ezsigntemplate_filenamepattern = s_ezsigntemplate_filenamepattern;
    m_s_ezsigntemplate_filenamepattern_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_s_ezsigntemplate_filenamepattern_Set() const{
    return m_s_ezsigntemplate_filenamepattern_isSet;
}

bool Ezsigntemplate_RequestCompound::is_s_ezsigntemplate_filenamepattern_Valid() const{
    return m_s_ezsigntemplate_filenamepattern_isValid;
}

bool Ezsigntemplate_RequestCompound::isBEzsigntemplateAdminonly() const {
    return m_b_ezsigntemplate_adminonly;
}
void Ezsigntemplate_RequestCompound::setBEzsigntemplateAdminonly(const bool &b_ezsigntemplate_adminonly) {
    m_b_ezsigntemplate_adminonly = b_ezsigntemplate_adminonly;
    m_b_ezsigntemplate_adminonly_isSet = true;
}

bool Ezsigntemplate_RequestCompound::is_b_ezsigntemplate_adminonly_Set() const{
    return m_b_ezsigntemplate_adminonly_isSet;
}

bool Ezsigntemplate_RequestCompound::is_b_ezsigntemplate_adminonly_Valid() const{
    return m_b_ezsigntemplate_adminonly_isValid;
}

bool Ezsigntemplate_RequestCompound::isSet() const {
...
bool Ezsigntemplate_RequestCompound::isValid() const {
