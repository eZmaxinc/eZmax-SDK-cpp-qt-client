...
void ObjectEzsignsignergroupmembershipApi::setServerIndex(int serverIndex) {
...
void ObjectEzsignsignergroupmembershipApi::ezsignsignergroupmembershipDeleteObjectV1Callback(HttpRequestWorker *worker) {
    ...
    Ezsignsignergroupmembership_deleteObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
