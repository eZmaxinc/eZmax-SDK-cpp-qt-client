...
Websocket_Response_Information_V1::Websocket_Response_Information_V1(const QString &json) {
...
void Websocket_Response_Information_V1::fromJson(const QString &jsonString) {
