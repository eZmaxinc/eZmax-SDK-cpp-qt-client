...
Custom_Ezsignformfield_Request::Custom_Ezsignformfield_Request(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Custom_Ezsignformfield_Request::Custom_Ezsignformfield_Request() {
    this->initializeModel();
}

Custom_Ezsignformfield_Request::~Custom_Ezsignformfield_Request() {}

void Custom_Ezsignformfield_Request::initializeModel() {
...
void Custom_Ezsignformfield_Request::fromJson(const QString &jsonString) {
...
void Custom_Ezsignformfield_Request::fromJsonObject(QJsonObject json) {
...
QString Custom_Ezsignformfield_Request::asJson() const {
...
QJsonObject Custom_Ezsignformfield_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Custom_Ezsignformfield_Request::getPkiEzsignformfieldId() const {
    return m_pki_ezsignformfield_id;
}
void Custom_Ezsignformfield_Request::setPkiEzsignformfieldId(const qint32 &pki_ezsignformfield_id) {
    m_pki_ezsignformfield_id = pki_ezsignformfield_id;
    m_pki_ezsignformfield_id_isSet = true;
}

bool Custom_Ezsignformfield_Request::is_pki_ezsignformfield_id_Set() const{
    return m_pki_ezsignformfield_id_isSet;
}

bool Custom_Ezsignformfield_Request::is_pki_ezsignformfield_id_Valid() const{
    return m_pki_ezsignformfield_id_isValid;
}

QString Custom_Ezsignformfield_Request::getSEzsignformfieldLabel() const {
    return m_s_ezsignformfield_label;
}
void Custom_Ezsignformfield_Request::setSEzsignformfieldLabel(const QString &s_ezsignformfield_label) {
    m_s_ezsignformfield_label = s_ezsignformfield_label;
    m_s_ezsignformfield_label_isSet = true;
}

bool Custom_Ezsignformfield_Request::is_s_ezsignformfield_label_Set() const{
    return m_s_ezsignformfield_label_isSet;
}

bool Custom_Ezsignformfield_Request::is_s_ezsignformfield_label_Valid() const{
    return m_s_ezsignformfield_label_isValid;
}

bool Custom_Ezsignformfield_Request::isBEzsignformfieldSelected() const {
    return m_b_ezsignformfield_selected;
}
void Custom_Ezsignformfield_Request::setBEzsignformfieldSelected(const bool &b_ezsignformfield_selected) {
    m_b_ezsignformfield_selected = b_ezsignformfield_selected;
    m_b_ezsignformfield_selected_isSet = true;
}

bool Custom_Ezsignformfield_Request::is_b_ezsignformfield_selected_Set() const{
    return m_b_ezsignformfield_selected_isSet;
}

bool Custom_Ezsignformfield_Request::is_b_ezsignformfield_selected_Valid() const{
    return m_b_ezsignformfield_selected_isValid;
}

QString Custom_Ezsignformfield_Request::getSEzsignformfieldEnteredvalue() const {
    return m_s_ezsignformfield_enteredvalue;
}
void Custom_Ezsignformfield_Request::setSEzsignformfieldEnteredvalue(const QString &s_ezsignformfield_enteredvalue) {
    m_s_ezsignformfield_enteredvalue = s_ezsignformfield_enteredvalue;
    m_s_ezsignformfield_enteredvalue_isSet = true;
}

bool Custom_Ezsignformfield_Request::is_s_ezsignformfield_enteredvalue_Set() const{
    return m_s_ezsignformfield_enteredvalue_isSet;
}

bool Custom_Ezsignformfield_Request::is_s_ezsignformfield_enteredvalue_Valid() const{
    return m_s_ezsignformfield_enteredvalue_isValid;
}

bool Custom_Ezsignformfield_Request::isSet() const {
...
bool Custom_Ezsignformfield_Request::isValid() const {
