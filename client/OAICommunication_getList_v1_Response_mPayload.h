...
#define OAICommunication_getList_v1_Response_mPayload_H
...
class OAICommunication_getList_v1_Response_mPayload : public OAIObject {
public:
    OAICommunication_getList_v1_Response_mPayload();
    OAICommunication_getList_v1_Response_mPayload(QString json);
    ~OAICommunication_getList_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunication_getList_v1_Response_mPayload)

#endif // OAICommunication_getList_v1_Response_mPayload_H
