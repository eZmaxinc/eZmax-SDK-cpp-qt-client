...
/*
 * Usergroupexternal_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroupexternal/{pkiUsergroupexternalID}
 */

#ifndef Usergroupexternal_editObject_v1_Response_H
#define Usergroupexternal_editObject_v1_Response_H
...
class Usergroupexternal_editObject_v1_Response : public Object {
public:
    Usergroupexternal_editObject_v1_Response();
    Usergroupexternal_editObject_v1_Response(const QString &json);
    ~Usergroupexternal_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupexternal_editObject_v1_Response)

#endif // Usergroupexternal_editObject_v1_Response_H
