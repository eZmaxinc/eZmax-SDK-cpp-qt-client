...
Ezsigntemplate_createObject_v3_Request::Ezsigntemplate_createObject_v3_Request(const QString &json) {
...
void Ezsigntemplate_createObject_v3_Request::fromJson(const QString &jsonString) {
