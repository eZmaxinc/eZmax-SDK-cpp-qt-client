...
/*
 * OAIEzsignsignaturecustomdate_RequestCompound.h
 *
 * An Ezsignsignaturecustomdate Object and children to create a complete structure
 */

#ifndef OAIEzsignsignaturecustomdate_RequestCompound_H
#define OAIEzsignsignaturecustomdate_RequestCompound_H
...
class OAIEzsignsignaturecustomdate_RequestCompound : public OAIObject {
public:
    OAIEzsignsignaturecustomdate_RequestCompound();
    OAIEzsignsignaturecustomdate_RequestCompound(QString json);
    ~OAIEzsignsignaturecustomdate_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignaturecustomdate_RequestCompound)

#endif // OAIEzsignsignaturecustomdate_RequestCompound_H
