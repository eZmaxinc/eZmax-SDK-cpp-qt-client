...
Supply_RequestCompound::Supply_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Supply_RequestCompound::Supply_RequestCompound() {
    this->initializeModel();
}

Supply_RequestCompound::~Supply_RequestCompound() {}

void Supply_RequestCompound::initializeModel() {
...
void Supply_RequestCompound::fromJson(const QString &jsonString) {
...
void Supply_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Supply_RequestCompound::asJson() const {
...
QJsonObject Supply_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Supply_RequestCompound::getPkiSupplyId() const {
    return m_pki_supply_id;
}
void Supply_RequestCompound::setPkiSupplyId(const qint32 &pki_supply_id) {
    m_pki_supply_id = pki_supply_id;
    m_pki_supply_id_isSet = true;
}

bool Supply_RequestCompound::is_pki_supply_id_Set() const{
    return m_pki_supply_id_isSet;
}

bool Supply_RequestCompound::is_pki_supply_id_Valid() const{
    return m_pki_supply_id_isValid;
}

qint32 Supply_RequestCompound::getFkiGlaccountId() const {
    return m_fki_glaccount_id;
}
void Supply_RequestCompound::setFkiGlaccountId(const qint32 &fki_glaccount_id) {
    m_fki_glaccount_id = fki_glaccount_id;
    m_fki_glaccount_id_isSet = true;
}

bool Supply_RequestCompound::is_fki_glaccount_id_Set() const{
    return m_fki_glaccount_id_isSet;
}

bool Supply_RequestCompound::is_fki_glaccount_id_Valid() const{
    return m_fki_glaccount_id_isValid;
}

qint32 Supply_RequestCompound::getFkiGlaccountcontainerId() const {
    return m_fki_glaccountcontainer_id;
}
void Supply_RequestCompound::setFkiGlaccountcontainerId(const qint32 &fki_glaccountcontainer_id) {
    m_fki_glaccountcontainer_id = fki_glaccountcontainer_id;
    m_fki_glaccountcontainer_id_isSet = true;
}

bool Supply_RequestCompound::is_fki_glaccountcontainer_id_Set() const{
    return m_fki_glaccountcontainer_id_isSet;
}

bool Supply_RequestCompound::is_fki_glaccountcontainer_id_Valid() const{
    return m_fki_glaccountcontainer_id_isValid;
}

qint32 Supply_RequestCompound::getFkiVariableexpenseId() const {
    return m_fki_variableexpense_id;
}
void Supply_RequestCompound::setFkiVariableexpenseId(const qint32 &fki_variableexpense_id) {
    m_fki_variableexpense_id = fki_variableexpense_id;
    m_fki_variableexpense_id_isSet = true;
}

bool Supply_RequestCompound::is_fki_variableexpense_id_Set() const{
    return m_fki_variableexpense_id_isSet;
}

bool Supply_RequestCompound::is_fki_variableexpense_id_Valid() const{
    return m_fki_variableexpense_id_isValid;
}

QString Supply_RequestCompound::getSSupplyCode() const {
    return m_s_supply_code;
}
void Supply_RequestCompound::setSSupplyCode(const QString &s_supply_code) {
    m_s_supply_code = s_supply_code;
    m_s_supply_code_isSet = true;
}

bool Supply_RequestCompound::is_s_supply_code_Set() const{
    return m_s_supply_code_isSet;
}

bool Supply_RequestCompound::is_s_supply_code_Valid() const{
    return m_s_supply_code_isValid;
}

Multilingual_SupplyDescription Supply_RequestCompound::getObjSupplyDescription() const {
    return m_obj_supply_description;
}
void Supply_RequestCompound::setObjSupplyDescription(const Multilingual_SupplyDescription &obj_supply_description) {
    m_obj_supply_description = obj_supply_description;
    m_obj_supply_description_isSet = true;
}

bool Supply_RequestCompound::is_obj_supply_description_Set() const{
    return m_obj_supply_description_isSet;
}

bool Supply_RequestCompound::is_obj_supply_description_Valid() const{
    return m_obj_supply_description_isValid;
}

QString Supply_RequestCompound::getDSupplyUnitprice() const {
    return m_d_supply_unitprice;
}
void Supply_RequestCompound::setDSupplyUnitprice(const QString &d_supply_unitprice) {
    m_d_supply_unitprice = d_supply_unitprice;
    m_d_supply_unitprice_isSet = true;
}

bool Supply_RequestCompound::is_d_supply_unitprice_Set() const{
    return m_d_supply_unitprice_isSet;
}

bool Supply_RequestCompound::is_d_supply_unitprice_Valid() const{
    return m_d_supply_unitprice_isValid;
}

bool Supply_RequestCompound::isBSupplyIsactive() const {
    return m_b_supply_isactive;
}
void Supply_RequestCompound::setBSupplyIsactive(const bool &b_supply_isactive) {
    m_b_supply_isactive = b_supply_isactive;
    m_b_supply_isactive_isSet = true;
}

bool Supply_RequestCompound::is_b_supply_isactive_Set() const{
    return m_b_supply_isactive_isSet;
}

bool Supply_RequestCompound::is_b_supply_isactive_Valid() const{
    return m_b_supply_isactive_isValid;
}

bool Supply_RequestCompound::isBSupplyVariableprice() const {
    return m_b_supply_variableprice;
}
void Supply_RequestCompound::setBSupplyVariableprice(const bool &b_supply_variableprice) {
    m_b_supply_variableprice = b_supply_variableprice;
    m_b_supply_variableprice_isSet = true;
}

bool Supply_RequestCompound::is_b_supply_variableprice_Set() const{
    return m_b_supply_variableprice_isSet;
}

bool Supply_RequestCompound::is_b_supply_variableprice_Valid() const{
    return m_b_supply_variableprice_isValid;
}

bool Supply_RequestCompound::isSet() const {
...
bool Supply_RequestCompound::isValid() const {
