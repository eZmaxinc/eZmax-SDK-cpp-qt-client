...
/*
 * Ezsigntemplatesignature_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}
 */

#ifndef Ezsigntemplatesignature_deleteObject_v1_Response_H
#define Ezsigntemplatesignature_deleteObject_v1_Response_H
...
class Ezsigntemplatesignature_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplatesignature_deleteObject_v1_Response();
    Ezsigntemplatesignature_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplatesignature_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_deleteObject_v1_Response)

#endif // Ezsigntemplatesignature_deleteObject_v1_Response_H
