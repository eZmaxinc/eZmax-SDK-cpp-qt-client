...
#ifndef _ObjectFranchiseofficeApi_H
#define _ObjectFranchiseofficeApi_H
...
class ObjectFranchiseofficeApi : public QObject {
    Q_OBJECT

public:
    ObjectFranchiseofficeApi(const int timeOut = 0);
    ...
    */
    virtual void franchiseofficeGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<QString> &s_query = ::Ezmaxapi::OptionalParam<QString>(), const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language = ::Ezmaxapi::OptionalParam<Header_Accept_Language>());
...
private:
    ...
    void franchiseofficeGetAutocompleteV2Callback(HttpRequestWorker *worker);

Q_SIGNALS:

    void franchiseofficeGetAutocompleteV2Signal(Franchiseoffice_getAutocomplete_v2_Response summary);
