...
Ezsignannotation_createObject_v1_Request::Ezsignannotation_createObject_v1_Request(const QString &json) {
...
void Ezsignannotation_createObject_v1_Request::fromJson(const QString &jsonString) {
