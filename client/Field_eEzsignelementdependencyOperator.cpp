...
Field_eEzsignelementdependencyOperator::Field_eEzsignelementdependencyOperator(const QString &json) {
...
void Field_eEzsignelementdependencyOperator::fromJson(const QString &jsonString) {
