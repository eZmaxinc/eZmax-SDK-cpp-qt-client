...
/*
 * Ezmaxinvoicingcommission_ResponseCompound.h
 *
 * A Ezmaxinvoicingcommission Object
 */

#ifndef Ezmaxinvoicingcommission_ResponseCompound_H
#define Ezmaxinvoicingcommission_ResponseCompound_H
...
class Ezmaxinvoicingcommission_ResponseCompound : public Object {
public:
    Ezmaxinvoicingcommission_ResponseCompound();
    Ezmaxinvoicingcommission_ResponseCompound(const QString &json);
    ~Ezmaxinvoicingcommission_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxinvoicingcommission_ResponseCompound)

#endif // Ezmaxinvoicingcommission_ResponseCompound_H
