...
Ezsignsignaturecustomdate_RequestCompound::Ezsignsignaturecustomdate_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignaturecustomdate_RequestCompound::Ezsignsignaturecustomdate_RequestCompound() {
    this->initializeModel();
}

Ezsignsignaturecustomdate_RequestCompound::~Ezsignsignaturecustomdate_RequestCompound() {}

void Ezsignsignaturecustomdate_RequestCompound::initializeModel() {
...
void Ezsignsignaturecustomdate_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsignsignaturecustomdate_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignaturecustomdate_RequestCompound::asJson() const {
...
QJsonObject Ezsignsignaturecustomdate_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignaturecustomdate_RequestCompound::getPkiEzsignsignaturecustomdateId() const {
    return m_pki_ezsignsignaturecustomdate_id;
}
void Ezsignsignaturecustomdate_RequestCompound::setPkiEzsignsignaturecustomdateId(const qint32 &pki_ezsignsignaturecustomdate_id) {
    m_pki_ezsignsignaturecustomdate_id = pki_ezsignsignaturecustomdate_id;
    m_pki_ezsignsignaturecustomdate_id_isSet = true;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_pki_ezsignsignaturecustomdate_id_Set() const{
    return m_pki_ezsignsignaturecustomdate_id_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_pki_ezsignsignaturecustomdate_id_Valid() const{
    return m_pki_ezsignsignaturecustomdate_id_isValid;
}

qint32 Ezsignsignaturecustomdate_RequestCompound::getIEzsignsignaturecustomdateX() const {
    return m_i_ezsignsignaturecustomdate_x;
}
void Ezsignsignaturecustomdate_RequestCompound::setIEzsignsignaturecustomdateX(const qint32 &i_ezsignsignaturecustomdate_x) {
    m_i_ezsignsignaturecustomdate_x = i_ezsignsignaturecustomdate_x;
    m_i_ezsignsignaturecustomdate_x_isSet = true;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_x_Set() const{
    return m_i_ezsignsignaturecustomdate_x_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_x_Valid() const{
    return m_i_ezsignsignaturecustomdate_x_isValid;
}

qint32 Ezsignsignaturecustomdate_RequestCompound::getIEzsignsignaturecustomdateY() const {
    return m_i_ezsignsignaturecustomdate_y;
}
void Ezsignsignaturecustomdate_RequestCompound::setIEzsignsignaturecustomdateY(const qint32 &i_ezsignsignaturecustomdate_y) {
    m_i_ezsignsignaturecustomdate_y = i_ezsignsignaturecustomdate_y;
    m_i_ezsignsignaturecustomdate_y_isSet = true;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_y_Set() const{
    return m_i_ezsignsignaturecustomdate_y_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_y_Valid() const{
    return m_i_ezsignsignaturecustomdate_y_isValid;
}

qint32 Ezsignsignaturecustomdate_RequestCompound::getIEzsignsignaturecustomdateOffsetx() const {
    return m_i_ezsignsignaturecustomdate_offsetx;
}
void Ezsignsignaturecustomdate_RequestCompound::setIEzsignsignaturecustomdateOffsetx(const qint32 &i_ezsignsignaturecustomdate_offsetx) {
...
bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_offsetx_Set() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_offsetx_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsetx_isValid;
}

qint32 Ezsignsignaturecustomdate_RequestCompound::getIEzsignsignaturecustomdateOffsety() const {
    return m_i_ezsignsignaturecustomdate_offsety;
}
void Ezsignsignaturecustomdate_RequestCompound::setIEzsignsignaturecustomdateOffsety(const qint32 &i_ezsignsignaturecustomdate_offsety) {
...
bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_offsety_Set() const{
    return m_i_ezsignsignaturecustomdate_offsety_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_i_ezsignsignaturecustomdate_offsety_Valid() const{
    return m_i_ezsignsignaturecustomdate_offsety_isValid;
}

QString Ezsignsignaturecustomdate_RequestCompound::getSEzsignsignaturecustomdateFormat() const {
    return m_s_ezsignsignaturecustomdate_format;
}
void Ezsignsignaturecustomdate_RequestCompound::setSEzsignsignaturecustomdateFormat(const QString &s_ezsignsignaturecustomdate_format) {
    m_s_ezsignsignaturecustomdate_format = s_ezsignsignaturecustomdate_format;
    m_s_ezsignsignaturecustomdate_format_isSet = true;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_s_ezsignsignaturecustomdate_format_Set() const{
    return m_s_ezsignsignaturecustomdate_format_isSet;
}

bool Ezsignsignaturecustomdate_RequestCompound::is_s_ezsignsignaturecustomdate_format_Valid() const{
    return m_s_ezsignsignaturecustomdate_format_isValid;
}

bool Ezsignsignaturecustomdate_RequestCompound::isSet() const {
...
bool Ezsignsignaturecustomdate_RequestCompound::isValid() const {
