...
Ezsignsignaturecustomdate_RequestCompound::Ezsignsignaturecustomdate_RequestCompound(QString json) {
...
void Ezsignsignaturecustomdate_RequestCompound::fromJson(QString jsonString) {
