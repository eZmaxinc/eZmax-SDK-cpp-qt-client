...
/*
 * OAIEzsignfolder_disposeEzsignfolders_v1_Response.h
 *
 * Response for POST /1/object/ezsignfolder/disposeEzsignfolders
 */

#ifndef OAIEzsignfolder_disposeEzsignfolders_v1_Response_H
#define OAIEzsignfolder_disposeEzsignfolders_v1_Response_H
...
class OAIEzsignfolder_disposeEzsignfolders_v1_Response : public OAIObject {
public:
    OAIEzsignfolder_disposeEzsignfolders_v1_Response();
    OAIEzsignfolder_disposeEzsignfolders_v1_Response(QString json);
    ~OAIEzsignfolder_disposeEzsignfolders_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_disposeEzsignfolders_v1_Response)

#endif // OAIEzsignfolder_disposeEzsignfolders_v1_Response_H
