...
/*
 * Authenticationexternal_ListElement.h
 *
 * A Authenticationexternal List Element
 */

#ifndef Authenticationexternal_ListElement_H
#define Authenticationexternal_ListElement_H
...
class Authenticationexternal_ListElement : public Object {
public:
    Authenticationexternal_ListElement();
    Authenticationexternal_ListElement(const QString &json);
    ~Authenticationexternal_ListElement() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Authenticationexternal_ListElement)

#endif // Authenticationexternal_ListElement_H
