...
/*
 * OAISignature_getObject_v2_Response.h
 *
 * Response for GET /2/object/signature/{pkiSignatureID}
 */

#ifndef OAISignature_getObject_v2_Response_H
#define OAISignature_getObject_v2_Response_H
...
class OAISignature_getObject_v2_Response : public OAIObject {
public:
    OAISignature_getObject_v2_Response();
    OAISignature_getObject_v2_Response(QString json);
    ~OAISignature_getObject_v2_Response() override;
...
private:
    ...
    OAISignature_getObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISignature_getObject_v2_Response)

#endif // OAISignature_getObject_v2_Response_H
