...
/*
 * Ezsignimportfolder_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsignimportfolder/{pkiEzsignimportfolderID}
 */

#ifndef Ezsignimportfolder_deleteObject_v1_Response_H
#define Ezsignimportfolder_deleteObject_v1_Response_H
...
class Ezsignimportfolder_deleteObject_v1_Response : public Object {
public:
    Ezsignimportfolder_deleteObject_v1_Response();
    Ezsignimportfolder_deleteObject_v1_Response(const QString &json);
    ~Ezsignimportfolder_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignimportfolder_deleteObject_v1_Response)

#endif // Ezsignimportfolder_deleteObject_v1_Response_H
