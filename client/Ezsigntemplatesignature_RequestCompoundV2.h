...
/*
 * Ezsigntemplatesignature_RequestCompoundV2.h
 *
 * A Ezsigntemplatesignature Object and children
 */

#ifndef Ezsigntemplatesignature_RequestCompoundV2_H
#define Ezsigntemplatesignature_RequestCompoundV2_H
...
namespace Ezmaxapi {
class Ezsigntemplatesignaturecustomdate_RequestCompoundV2;
class Ezsigntemplateelementdependency_RequestCompound;
class Ezsigntemplatesignaturepaymentdetail_RequestCompound;

class Ezsigntemplatesignature_RequestCompoundV2 : public Object {
public:
    Ezsigntemplatesignature_RequestCompoundV2();
    Ezsigntemplatesignature_RequestCompoundV2(const QString &json);
    ~Ezsigntemplatesignature_RequestCompoundV2() override;
    ...
    QString getSEzsigntemplatesignatureCreditcardamountdescription() const;
    void setSEzsigntemplatesignatureCreditcardamountdescription(const QString &s_ezsigntemplatesignature_creditcardamountdescription);
    bool is_s_ezsigntemplatesignature_creditcardamountdescription_Set() const;
    bool is_s_ezsigntemplatesignature_creditcardamountdescription_Valid() const;

    QString getDEzsigntemplatesignatureCreditcardamount() const;
    void setDEzsigntemplatesignatureCreditcardamount(const QString &d_ezsigntemplatesignature_creditcardamount);
    bool is_d_ezsigntemplatesignature_creditcardamount_Set() const;
    bool is_d_ezsigntemplatesignature_creditcardamount_Valid() const;
    ...
    QList<Ezsigntemplatesignaturecustomdate_RequestCompoundV2> getAObjEzsigntemplatesignaturecustomdate() const;
    void setAObjEzsigntemplatesignaturecustomdate(const QList<Ezsigntemplatesignaturecustomdate_RequestCompoundV2> &a_obj_ezsigntemplatesignaturecustomdate);
    ...
    QList<Ezsigntemplatesignaturepaymentdetail_RequestCompound> getAObjEzsigntemplatesignaturepaymentdetail() const;
    void setAObjEzsigntemplatesignaturepaymentdetail(const QList<Ezsigntemplatesignaturepaymentdetail_RequestCompound> &a_obj_ezsigntemplatesignaturepaymentdetail);
    bool is_a_obj_ezsigntemplatesignaturepaymentdetail_Set() const;
    bool is_a_obj_ezsigntemplatesignaturepaymentdetail_Valid() const;
...
private:
    ...
    QString m_s_ezsigntemplatesignature_creditcardamountdescription;
    bool m_s_ezsigntemplatesignature_creditcardamountdescription_isSet;
    bool m_s_ezsigntemplatesignature_creditcardamountdescription_isValid;

    QString m_d_ezsigntemplatesignature_creditcardamount;
    bool m_d_ezsigntemplatesignature_creditcardamount_isSet;
    bool m_d_ezsigntemplatesignature_creditcardamount_isValid;
    ...
    QList<Ezsigntemplatesignaturecustomdate_RequestCompoundV2> m_a_obj_ezsigntemplatesignaturecustomdate;
    ...
    QList<Ezsigntemplatesignaturepaymentdetail_RequestCompound> m_a_obj_ezsigntemplatesignaturepaymentdetail;
    bool m_a_obj_ezsigntemplatesignaturepaymentdetail_isSet;
    bool m_a_obj_ezsigntemplatesignaturepaymentdetail_isValid;
};

} // namespace Ezmaxapi

Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesignature_RequestCompoundV2)

#endif // Ezsigntemplatesignature_RequestCompoundV2_H
