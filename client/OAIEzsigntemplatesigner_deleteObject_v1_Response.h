...
/*
 * OAIEzsigntemplatesigner_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}
 */

#ifndef OAIEzsigntemplatesigner_deleteObject_v1_Response_H
#define OAIEzsigntemplatesigner_deleteObject_v1_Response_H
...
class OAIEzsigntemplatesigner_deleteObject_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatesigner_deleteObject_v1_Response();
    OAIEzsigntemplatesigner_deleteObject_v1_Response(QString json);
    ~OAIEzsigntemplatesigner_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatesigner_deleteObject_v1_Response)

#endif // OAIEzsigntemplatesigner_deleteObject_v1_Response_H
