...
/*
 * OAISubnet_editObject_v1_Response.h
 *
 * Response for PUT /1/object/subnet/{pkiSubnetID}
 */

#ifndef OAISubnet_editObject_v1_Response_H
#define OAISubnet_editObject_v1_Response_H
...
class OAISubnet_editObject_v1_Response : public OAIObject {
public:
    OAISubnet_editObject_v1_Response();
    OAISubnet_editObject_v1_Response(QString json);
    ~OAISubnet_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISubnet_editObject_v1_Response)

#endif // OAISubnet_editObject_v1_Response_H
