...
Ezsigntemplatepublic_getObject_v2_Response_mPayload::Ezsigntemplatepublic_getObject_v2_Response_mPayload(const QString &json) {
...
void Ezsigntemplatepublic_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
