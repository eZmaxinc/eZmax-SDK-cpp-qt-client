...
Ezsignfolder_editObject_v3_Request::Ezsignfolder_editObject_v3_Request(const QString &json) {
...
void Ezsignfolder_editObject_v3_Request::fromJson(const QString &jsonString) {
