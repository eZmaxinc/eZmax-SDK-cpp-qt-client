...
Usergroupmembership_ResponseCompound::Usergroupmembership_ResponseCompound(const QString &json) {
...
void Usergroupmembership_ResponseCompound::fromJson(const QString &jsonString) {
...
bool Usergroupmembership_ResponseCompound::isBUserIsactive() const {
    return m_b_user_isactive;
}
void Usergroupmembership_ResponseCompound::setBUserIsactive(const bool &b_user_isactive) {
    m_b_user_isactive = b_user_isactive;
    m_b_user_isactive_isSet = true;
}

bool Usergroupmembership_ResponseCompound::is_b_user_isactive_Set() const{
    return m_b_user_isactive_isSet;
}

bool Usergroupmembership_ResponseCompound::is_b_user_isactive_Valid() const{
