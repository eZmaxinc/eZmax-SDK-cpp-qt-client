...
Timezone_AutocompleteElement_Response::Timezone_AutocompleteElement_Response(const QString &json) {
...
void Timezone_AutocompleteElement_Response::fromJson(const QString &jsonString) {
