...
/*
 * Ezsigntemplatesigner_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}
 */

#ifndef Ezsigntemplatesigner_deleteObject_v1_Response_H
#define Ezsigntemplatesigner_deleteObject_v1_Response_H
...
class Ezsigntemplatesigner_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplatesigner_deleteObject_v1_Response();
    Ezsigntemplatesigner_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplatesigner_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatesigner_deleteObject_v1_Response)

#endif // Ezsigntemplatesigner_deleteObject_v1_Response_H
