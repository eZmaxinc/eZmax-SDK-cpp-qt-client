...
/*
 * OAIVariableexpense_Request.h
 *
 * A Variableexpense Object
 */

#ifndef OAIVariableexpense_Request_H
#define OAIVariableexpense_Request_H
...
class OAIVariableexpense_Request : public OAIObject {
public:
    OAIVariableexpense_Request();
    OAIVariableexpense_Request(QString json);
    ~OAIVariableexpense_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIVariableexpense_Request)

#endif // OAIVariableexpense_Request_H
