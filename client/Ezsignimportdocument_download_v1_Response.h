...
#ifndef Ezsignimportdocument_download_v1_Response_H
#define Ezsignimportdocument_download_v1_Response_H
...
class Ezsignimportdocument_download_v1_Response : public Object {
public:
    Ezsignimportdocument_download_v1_Response();
    Ezsignimportdocument_download_v1_Response(const QString &json);
    ~Ezsignimportdocument_download_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignimportdocument_download_v1_Response)

#endif // Ezsignimportdocument_download_v1_Response_H
