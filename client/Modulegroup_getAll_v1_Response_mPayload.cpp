...
Modulegroup_getAll_v1_Response_mPayload::Modulegroup_getAll_v1_Response_mPayload(const QString &json) {
...
void Modulegroup_getAll_v1_Response_mPayload::fromJson(const QString &jsonString) {
