...
/*
 * Ezsigndocument_endPrematurely_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/endPrematurely
 */

#ifndef Ezsigndocument_endPrematurely_v1_Response_H
#define Ezsigndocument_endPrematurely_v1_Response_H
...
class Ezsigndocument_endPrematurely_v1_Response : public Object {
public:
    Ezsigndocument_endPrematurely_v1_Response();
    Ezsigndocument_endPrematurely_v1_Response(const QString &json);
    ~Ezsigndocument_endPrematurely_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_endPrematurely_v1_Response)

#endif // Ezsigndocument_endPrematurely_v1_Response_H
