...
#ifndef Webhook_Ezsign_DocumentCompleted_H
#define Webhook_Ezsign_DocumentCompleted_H
...
class Webhook_Ezsign_DocumentCompleted : public Object {
public:
    Webhook_Ezsign_DocumentCompleted();
    Webhook_Ezsign_DocumentCompleted(const QString &json);
    ~Webhook_Ezsign_DocumentCompleted() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_Ezsign_DocumentCompleted)

#endif // Webhook_Ezsign_DocumentCompleted_H
