...
#define OAICommunication_getList_v1_Response_H
...
public:
    OAICommunication_getList_v1_Response();
    OAICommunication_getList_v1_Response(QString json);
    ~OAICommunication_getList_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunication_getList_v1_Response)

#endif // OAICommunication_getList_v1_Response_H
