...
Ezsignfoldertype_getObject_v4_Response::Ezsignfoldertype_getObject_v4_Response() {
    this->initializeModel();
}

Ezsignfoldertype_getObject_v4_Response::~Ezsignfoldertype_getObject_v4_Response() {}

void Ezsignfoldertype_getObject_v4_Response::initializeModel() {
...
void Ezsignfoldertype_getObject_v4_Response::fromJsonObject(QJsonObject json) {
...
QString Ezsignfoldertype_getObject_v4_Response::asJson() const {
...
QJsonObject Ezsignfoldertype_getObject_v4_Response::asJsonObject() const {
    QJsonObject obj;
...
Common_Response_objDebugPayload Ezsignfoldertype_getObject_v4_Response::getObjDebugPayload() const {
    return m_obj_debug_payload;
}
void Ezsignfoldertype_getObject_v4_Response::setObjDebugPayload(const Common_Response_objDebugPayload &obj_debug_payload) {
    m_obj_debug_payload = obj_debug_payload;
    m_obj_debug_payload_isSet = true;
}

bool Ezsignfoldertype_getObject_v4_Response::is_obj_debug_payload_Set() const{
    return m_obj_debug_payload_isSet;
}

bool Ezsignfoldertype_getObject_v4_Response::is_obj_debug_payload_Valid() const{
    return m_obj_debug_payload_isValid;
}

Common_Response_objDebug Ezsignfoldertype_getObject_v4_Response::getObjDebug() const {
    return m_obj_debug;
}
void Ezsignfoldertype_getObject_v4_Response::setObjDebug(const Common_Response_objDebug &obj_debug) {
    m_obj_debug = obj_debug;
    m_obj_debug_isSet = true;
}

bool Ezsignfoldertype_getObject_v4_Response::is_obj_debug_Set() const{
    return m_obj_debug_isSet;
}

bool Ezsignfoldertype_getObject_v4_Response::is_obj_debug_Valid() const{
    return m_obj_debug_isValid;
}

Ezsignfoldertype_getObject_v4_Response_mPayload Ezsignfoldertype_getObject_v4_Response::getMPayload() const {
    return m_m_payload;
}
void Ezsignfoldertype_getObject_v4_Response::setMPayload(const Ezsignfoldertype_getObject_v4_Response_mPayload &m_payload) {
    m_m_payload = m_payload;
    m_m_payload_isSet = true;
}

bool Ezsignfoldertype_getObject_v4_Response::is_m_payload_Set() const{
    return m_m_payload_isSet;
}

bool Ezsignfoldertype_getObject_v4_Response::is_m_payload_Valid() const{
    return m_m_payload_isValid;
}

bool Ezsignfoldertype_getObject_v4_Response::isSet() const {
...
bool Ezsignfoldertype_getObject_v4_Response::isValid() const {
