...
#define OAIEzsigndocument_editEzsignsignatures_v1_Response_H
...
class OAIEzsigndocument_editEzsignsignatures_v1_Response : public OAIObject {
public:
    OAIEzsigndocument_editEzsignsignatures_v1_Response();
    OAIEzsigndocument_editEzsignsignatures_v1_Response(QString json);
    ~OAIEzsigndocument_editEzsignsignatures_v1_Response() override;
...
private:
    ...
    OAIEzsigndocument_editEzsignsignatures_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigndocument_editEzsignsignatures_v1_Response)

#endif // OAIEzsigndocument_editEzsignsignatures_v1_Response_H
