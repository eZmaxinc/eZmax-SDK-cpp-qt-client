...
/*
 * OAITextstylestatic_ResponseCompound.h
 *
 * A Textstylestatic Object
 */

#ifndef OAITextstylestatic_ResponseCompound_H
#define OAITextstylestatic_ResponseCompound_H
...
class OAITextstylestatic_ResponseCompound : public OAIObject {
public:
    OAITextstylestatic_ResponseCompound();
    OAITextstylestatic_ResponseCompound(QString json);
    ~OAITextstylestatic_ResponseCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAITextstylestatic_ResponseCompound)

#endif // OAITextstylestatic_ResponseCompound_H
