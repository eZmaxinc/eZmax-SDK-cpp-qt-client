...
Custom_DropdownElement_Response::Custom_DropdownElement_Response(const QString &json) {
...
void Custom_DropdownElement_Response::fromJson(const QString &jsonString) {
