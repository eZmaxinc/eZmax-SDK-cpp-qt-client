...
/*
 * Ezsigntemplate_editObject_v1_Response.h
 *
 * Response for PUT /1/object/ezsigntemplate/{pkiEzsigntemplateID}
 */

#ifndef Ezsigntemplate_editObject_v1_Response_H
#define Ezsigntemplate_editObject_v1_Response_H
...
class Ezsigntemplate_editObject_v1_Response : public Object {
public:
    Ezsigntemplate_editObject_v1_Response();
    Ezsigntemplate_editObject_v1_Response(QString json);
    ~Ezsigntemplate_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplate_editObject_v1_Response)

#endif // Ezsigntemplate_editObject_v1_Response_H
