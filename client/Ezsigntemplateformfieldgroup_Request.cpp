...
Ezsigntemplateformfieldgroup_Request::Ezsigntemplateformfieldgroup_Request(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsigntemplateformfieldgroup_Request::Ezsigntemplateformfieldgroup_Request() {
    this->initializeModel();
}

Ezsigntemplateformfieldgroup_Request::~Ezsigntemplateformfieldgroup_Request() {}

void Ezsigntemplateformfieldgroup_Request::initializeModel() {
...
void Ezsigntemplateformfieldgroup_Request::fromJson(const QString &jsonString) {
...
void Ezsigntemplateformfieldgroup_Request::fromJsonObject(QJsonObject json) {
...
QString Ezsigntemplateformfieldgroup_Request::asJson() const {
...
QJsonObject Ezsigntemplateformfieldgroup_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsigntemplateformfieldgroup_Request::getPkiEzsigntemplateformfieldgroupId() const {
    return m_pki_ezsigntemplateformfieldgroup_id;
}
void Ezsigntemplateformfieldgroup_Request::setPkiEzsigntemplateformfieldgroupId(const qint32 &pki_ezsigntemplateformfieldgroup_id) {
...
bool Ezsigntemplateformfieldgroup_Request::is_pki_ezsigntemplateformfieldgroup_id_Set() const{
    return m_pki_ezsigntemplateformfieldgroup_id_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_pki_ezsigntemplateformfieldgroup_id_Valid() const{
    return m_pki_ezsigntemplateformfieldgroup_id_isValid;
}

qint32 Ezsigntemplateformfieldgroup_Request::getFkiEzsigntemplatedocumentId() const {
    return m_fki_ezsigntemplatedocument_id;
}
void Ezsigntemplateformfieldgroup_Request::setFkiEzsigntemplatedocumentId(const qint32 &fki_ezsigntemplatedocument_id) {
    m_fki_ezsigntemplatedocument_id = fki_ezsigntemplatedocument_id;
    m_fki_ezsigntemplatedocument_id_isSet = true;
}

bool Ezsigntemplateformfieldgroup_Request::is_fki_ezsigntemplatedocument_id_Set() const{
    return m_fki_ezsigntemplatedocument_id_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_fki_ezsigntemplatedocument_id_Valid() const{
    return m_fki_ezsigntemplatedocument_id_isValid;
}

Field_eEzsigntemplateformfieldgroupType Ezsigntemplateformfieldgroup_Request::getEEzsigntemplateformfieldgroupType() const {
    return m_e_ezsigntemplateformfieldgroup_type;
}
void Ezsigntemplateformfieldgroup_Request::setEEzsigntemplateformfieldgroupType(const Field_eEzsigntemplateformfieldgroupType &e_ezsigntemplateformfieldgroup_type) {
...
bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_type_Set() const{
    return m_e_ezsigntemplateformfieldgroup_type_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_type_Valid() const{
    return m_e_ezsigntemplateformfieldgroup_type_isValid;
}

Field_eEzsigntemplateformfieldgroupSignerrequirement Ezsigntemplateformfieldgroup_Request::getEEzsigntemplateformfieldgroupSignerrequirement() const {
    return m_e_ezsigntemplateformfieldgroup_signerrequirement;
}
void Ezsigntemplateformfieldgroup_Request::setEEzsigntemplateformfieldgroupSignerrequirement(const Field_eEzsigntemplateformfieldgroupSignerrequirement &e_ezsigntemplateformfieldgroup_signerrequirement) {
...
bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_signerrequirement_Set() const{
    return m_e_ezsigntemplateformfieldgroup_signerrequirement_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_signerrequirement_Valid() const{
    return m_e_ezsigntemplateformfieldgroup_signerrequirement_isValid;
}

QString Ezsigntemplateformfieldgroup_Request::getSEzsigntemplateformfieldgroupLabel() const {
    return m_s_ezsigntemplateformfieldgroup_label;
}
void Ezsigntemplateformfieldgroup_Request::setSEzsigntemplateformfieldgroupLabel(const QString &s_ezsigntemplateformfieldgroup_label) {
...
bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_label_Set() const{
    return m_s_ezsigntemplateformfieldgroup_label_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_label_Valid() const{
    return m_s_ezsigntemplateformfieldgroup_label_isValid;
}

qint32 Ezsigntemplateformfieldgroup_Request::getIEzsigntemplateformfieldgroupStep() const {
    return m_i_ezsigntemplateformfieldgroup_step;
}
void Ezsigntemplateformfieldgroup_Request::setIEzsigntemplateformfieldgroupStep(const qint32 &i_ezsigntemplateformfieldgroup_step) {
...
bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_step_Set() const{
    return m_i_ezsigntemplateformfieldgroup_step_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_step_Valid() const{
    return m_i_ezsigntemplateformfieldgroup_step_isValid;
}

QString Ezsigntemplateformfieldgroup_Request::getSEzsigntemplateformfieldgroupDefaultvalue() const {
    return m_s_ezsigntemplateformfieldgroup_defaultvalue;
}
void Ezsigntemplateformfieldgroup_Request::setSEzsigntemplateformfieldgroupDefaultvalue(const QString &s_ezsigntemplateformfieldgroup_defaultvalue) {
...
bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_defaultvalue_Set() const{
    return m_s_ezsigntemplateformfieldgroup_defaultvalue_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_defaultvalue_Valid() const{
    return m_s_ezsigntemplateformfieldgroup_defaultvalue_isValid;
}

qint32 Ezsigntemplateformfieldgroup_Request::getIEzsigntemplateformfieldgroupFilledmin() const {
    return m_i_ezsigntemplateformfieldgroup_filledmin;
}
void Ezsigntemplateformfieldgroup_Request::setIEzsigntemplateformfieldgroupFilledmin(const qint32 &i_ezsigntemplateformfieldgroup_filledmin) {
...
bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_filledmin_Set() const{
    return m_i_ezsigntemplateformfieldgroup_filledmin_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_filledmin_Valid() const{
    return m_i_ezsigntemplateformfieldgroup_filledmin_isValid;
}

qint32 Ezsigntemplateformfieldgroup_Request::getIEzsigntemplateformfieldgroupFilledmax() const {
    return m_i_ezsigntemplateformfieldgroup_filledmax;
}
void Ezsigntemplateformfieldgroup_Request::setIEzsigntemplateformfieldgroupFilledmax(const qint32 &i_ezsigntemplateformfieldgroup_filledmax) {
...
bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_filledmax_Set() const{
    return m_i_ezsigntemplateformfieldgroup_filledmax_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_filledmax_Valid() const{
    return m_i_ezsigntemplateformfieldgroup_filledmax_isValid;
}

bool Ezsigntemplateformfieldgroup_Request::isBEzsigntemplateformfieldgroupReadonly() const {
    return m_b_ezsigntemplateformfieldgroup_readonly;
}
void Ezsigntemplateformfieldgroup_Request::setBEzsigntemplateformfieldgroupReadonly(const bool &b_ezsigntemplateformfieldgroup_readonly) {
...
bool Ezsigntemplateformfieldgroup_Request::is_b_ezsigntemplateformfieldgroup_readonly_Set() const{
    return m_b_ezsigntemplateformfieldgroup_readonly_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_b_ezsigntemplateformfieldgroup_readonly_Valid() const{
    return m_b_ezsigntemplateformfieldgroup_readonly_isValid;
}

qint32 Ezsigntemplateformfieldgroup_Request::getIEzsigntemplateformfieldgroupMaxlength() const {
    return m_i_ezsigntemplateformfieldgroup_maxlength;
}
void Ezsigntemplateformfieldgroup_Request::setIEzsigntemplateformfieldgroupMaxlength(const qint32 &i_ezsigntemplateformfieldgroup_maxlength) {
...
bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_maxlength_Set() const{
    return m_i_ezsigntemplateformfieldgroup_maxlength_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_i_ezsigntemplateformfieldgroup_maxlength_Valid() const{
    return m_i_ezsigntemplateformfieldgroup_maxlength_isValid;
}

bool Ezsigntemplateformfieldgroup_Request::isBEzsigntemplateformfieldgroupEncrypted() const {
    return m_b_ezsigntemplateformfieldgroup_encrypted;
}
void Ezsigntemplateformfieldgroup_Request::setBEzsigntemplateformfieldgroupEncrypted(const bool &b_ezsigntemplateformfieldgroup_encrypted) {
...
bool Ezsigntemplateformfieldgroup_Request::is_b_ezsigntemplateformfieldgroup_encrypted_Set() const{
    return m_b_ezsigntemplateformfieldgroup_encrypted_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_b_ezsigntemplateformfieldgroup_encrypted_Valid() const{
    return m_b_ezsigntemplateformfieldgroup_encrypted_isValid;
}

QString Ezsigntemplateformfieldgroup_Request::getSEzsigntemplateformfieldgroupRegexp() const {
    return m_s_ezsigntemplateformfieldgroup_regexp;
}
void Ezsigntemplateformfieldgroup_Request::setSEzsigntemplateformfieldgroupRegexp(const QString &s_ezsigntemplateformfieldgroup_regexp) {
...
bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_regexp_Set() const{
    return m_s_ezsigntemplateformfieldgroup_regexp_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_s_ezsigntemplateformfieldgroup_regexp_Valid() const{
...
void Ezsigntemplateformfieldgroup_Request::setEEzsigntemplateformfieldgroupTextvalidation(const Enum_Textvalidation &e_ezsigntemplateformfieldgroup_textvalidation) {
...
bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_textvalidation_Set() const{
    return m_e_ezsigntemplateformfieldgroup_textvalidation_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_textvalidation_Valid() const{
    return m_e_ezsigntemplateformfieldgroup_textvalidation_isValid;
}

QString Ezsigntemplateformfieldgroup_Request::getTEzsigntemplateformfieldgroupTooltip() const {
    return m_t_ezsigntemplateformfieldgroup_tooltip;
}
void Ezsigntemplateformfieldgroup_Request::setTEzsigntemplateformfieldgroupTooltip(const QString &t_ezsigntemplateformfieldgroup_tooltip) {
...
bool Ezsigntemplateformfieldgroup_Request::is_t_ezsigntemplateformfieldgroup_tooltip_Set() const{
    return m_t_ezsigntemplateformfieldgroup_tooltip_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_t_ezsigntemplateformfieldgroup_tooltip_Valid() const{
    return m_t_ezsigntemplateformfieldgroup_tooltip_isValid;
}

Field_eEzsigntemplateformfieldgroupTooltipposition Ezsigntemplateformfieldgroup_Request::getEEzsigntemplateformfieldgroupTooltipposition() const {
    return m_e_ezsigntemplateformfieldgroup_tooltipposition;
}
void Ezsigntemplateformfieldgroup_Request::setEEzsigntemplateformfieldgroupTooltipposition(const Field_eEzsigntemplateformfieldgroupTooltipposition &e_ezsigntemplateformfieldgroup_tooltipposition) {
...
bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_tooltipposition_Set() const{
    return m_e_ezsigntemplateformfieldgroup_tooltipposition_isSet;
}

bool Ezsigntemplateformfieldgroup_Request::is_e_ezsigntemplateformfieldgroup_tooltipposition_Valid() const{
    return m_e_ezsigntemplateformfieldgroup_tooltipposition_isValid;
}

bool Ezsigntemplateformfieldgroup_Request::isSet() const {
