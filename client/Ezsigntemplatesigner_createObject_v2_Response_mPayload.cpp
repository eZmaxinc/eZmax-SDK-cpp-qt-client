...
#include "Ezsigntemplatesigner_createObject_v2_Response_mPayload.h"
...
Ezsigntemplatesigner_createObject_v2_Response_mPayload::Ezsigntemplatesigner_createObject_v2_Response_mPayload(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsigntemplatesigner_createObject_v2_Response_mPayload::Ezsigntemplatesigner_createObject_v2_Response_mPayload() {
    this->initializeModel();
}

Ezsigntemplatesigner_createObject_v2_Response_mPayload::~Ezsigntemplatesigner_createObject_v2_Response_mPayload() {}

void Ezsigntemplatesigner_createObject_v2_Response_mPayload::initializeModel() {
...
void Ezsigntemplatesigner_createObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
...
void Ezsigntemplatesigner_createObject_v2_Response_mPayload::fromJsonObject(QJsonObject json) {
...
QString Ezsigntemplatesigner_createObject_v2_Response_mPayload::asJson() const {
...
QJsonObject Ezsigntemplatesigner_createObject_v2_Response_mPayload::asJsonObject() const {
    QJsonObject obj;
...
QList<qint32> Ezsigntemplatesigner_createObject_v2_Response_mPayload::getAPkiEzsigntemplatesignerId() const {
    return m_a_pki_ezsigntemplatesigner_id;
}
void Ezsigntemplatesigner_createObject_v2_Response_mPayload::setAPkiEzsigntemplatesignerId(const QList<qint32> &a_pki_ezsigntemplatesigner_id) {
    m_a_pki_ezsigntemplatesigner_id = a_pki_ezsigntemplatesigner_id;
    m_a_pki_ezsigntemplatesigner_id_isSet = true;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_a_pki_ezsigntemplatesigner_id_Set() const{
    return m_a_pki_ezsigntemplatesigner_id_isSet;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_a_pki_ezsigntemplatesigner_id_Valid() const{
    return m_a_pki_ezsigntemplatesigner_id_isValid;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::isBEzsigntemplatepackageNeedvalidation() const {
    return m_b_ezsigntemplatepackage_needvalidation;
}
void Ezsigntemplatesigner_createObject_v2_Response_mPayload::setBEzsigntemplatepackageNeedvalidation(const bool &b_ezsigntemplatepackage_needvalidation) {
...
bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_b_ezsigntemplatepackage_needvalidation_Set() const{
    return m_b_ezsigntemplatepackage_needvalidation_isSet;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_b_ezsigntemplatepackage_needvalidation_Valid() const{
    return m_b_ezsigntemplatepackage_needvalidation_isValid;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::isBEzsignbulksendNeedvalidation() const {
    return m_b_ezsignbulksend_needvalidation;
}
void Ezsigntemplatesigner_createObject_v2_Response_mPayload::setBEzsignbulksendNeedvalidation(const bool &b_ezsignbulksend_needvalidation) {
    m_b_ezsignbulksend_needvalidation = b_ezsignbulksend_needvalidation;
    m_b_ezsignbulksend_needvalidation_isSet = true;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_b_ezsignbulksend_needvalidation_Set() const{
    return m_b_ezsignbulksend_needvalidation_isSet;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::is_b_ezsignbulksend_needvalidation_Valid() const{
    return m_b_ezsignbulksend_needvalidation_isValid;
}

bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::isSet() const {
...
bool Ezsigntemplatesigner_createObject_v2_Response_mPayload::isValid() const {
