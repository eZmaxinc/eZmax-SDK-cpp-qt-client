...
/*
 * OAIEzsigntemplatedocument_getObject_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}
 */

#ifndef OAIEzsigntemplatedocument_getObject_v1_Response_mPayload_H
#define OAIEzsigntemplatedocument_getObject_v1_Response_mPayload_H
...
class OAIEzsigntemplatedocument_getObject_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsigntemplatedocument_getObject_v1_Response_mPayload();
    OAIEzsigntemplatedocument_getObject_v1_Response_mPayload(QString json);
    ~OAIEzsigntemplatedocument_getObject_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEzsigntemplatedocument_getObject_v1_Response_mPayload)

#endif // OAIEzsigntemplatedocument_getObject_v1_Response_mPayload_H
