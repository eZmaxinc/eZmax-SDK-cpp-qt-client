...
#ifndef Webhook_Request_H
#define Webhook_Request_H
...
class Webhook_Request : public Object {
public:
    Webhook_Request();
    Webhook_Request(const QString &json);
    ~Webhook_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Webhook_Request)

#endif // Webhook_Request_H
