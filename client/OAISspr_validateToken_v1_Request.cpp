...
OAISspr_validateToken_v1_Request::OAISspr_validateToken_v1_Request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISspr_validateToken_v1_Request::OAISspr_validateToken_v1_Request() {
    this->initializeModel();
}

OAISspr_validateToken_v1_Request::~OAISspr_validateToken_v1_Request() {}

void OAISspr_validateToken_v1_Request::initializeModel() {
...
void OAISspr_validateToken_v1_Request::fromJson(QString jsonString) {
...
void OAISspr_validateToken_v1_Request::fromJsonObject(QJsonObject json) {
...
QString OAISspr_validateToken_v1_Request::asJson() const {
...
QJsonObject OAISspr_validateToken_v1_Request::asJsonObject() const {
    QJsonObject obj;
...
QString OAISspr_validateToken_v1_Request::getPksCustomerCode() const {
    return pks_customer_code;
}
void OAISspr_validateToken_v1_Request::setPksCustomerCode(const QString &pks_customer_code) {
    this->pks_customer_code = pks_customer_code;
    this->m_pks_customer_code_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_pks_customer_code_Set() const{
    return m_pks_customer_code_isSet;
}

bool OAISspr_validateToken_v1_Request::is_pks_customer_code_Valid() const{
    return m_pks_customer_code_isValid;
}

qint32 OAISspr_validateToken_v1_Request::getFkiLanguageId() const {
    return fki_language_id;
}
void OAISspr_validateToken_v1_Request::setFkiLanguageId(const qint32 &fki_language_id) {
    this->fki_language_id = fki_language_id;
    this->m_fki_language_id_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_fki_language_id_Set() const{
    return m_fki_language_id_isSet;
}

bool OAISspr_validateToken_v1_Request::is_fki_language_id_Valid() const{
    return m_fki_language_id_isValid;
}

OAIField_eUserTypeSSPR OAISspr_validateToken_v1_Request::getEUserTypeSspr() const {
    return e_user_type_sspr;
}
void OAISspr_validateToken_v1_Request::setEUserTypeSspr(const OAIField_eUserTypeSSPR &e_user_type_sspr) {
    this->e_user_type_sspr = e_user_type_sspr;
    this->m_e_user_type_sspr_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_e_user_type_sspr_Set() const{
    return m_e_user_type_sspr_isSet;
}

bool OAISspr_validateToken_v1_Request::is_e_user_type_sspr_Valid() const{
    return m_e_user_type_sspr_isValid;
}

QString OAISspr_validateToken_v1_Request::getSEmailAddress() const {
    return s_email_address;
}
void OAISspr_validateToken_v1_Request::setSEmailAddress(const QString &s_email_address) {
    this->s_email_address = s_email_address;
    this->m_s_email_address_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool OAISspr_validateToken_v1_Request::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

QString OAISspr_validateToken_v1_Request::getSUserLoginname() const {
    return s_user_loginname;
}
void OAISspr_validateToken_v1_Request::setSUserLoginname(const QString &s_user_loginname) {
    this->s_user_loginname = s_user_loginname;
    this->m_s_user_loginname_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_s_user_loginname_Set() const{
    return m_s_user_loginname_isSet;
}

bool OAISspr_validateToken_v1_Request::is_s_user_loginname_Valid() const{
    return m_s_user_loginname_isValid;
}

QString OAISspr_validateToken_v1_Request::getBinUserSspRtoken() const {
    return bin_user_ssp_rtoken;
}
void OAISspr_validateToken_v1_Request::setBinUserSspRtoken(const QString &bin_user_ssp_rtoken) {
    this->bin_user_ssp_rtoken = bin_user_ssp_rtoken;
    this->m_bin_user_ssp_rtoken_isSet = true;
}

bool OAISspr_validateToken_v1_Request::is_bin_user_ssp_rtoken_Set() const{
    return m_bin_user_ssp_rtoken_isSet;
}

bool OAISspr_validateToken_v1_Request::is_bin_user_ssp_rtoken_Valid() const{
    return m_bin_user_ssp_rtoken_isValid;
}

bool OAISspr_validateToken_v1_Request::isSet() const {
...
bool OAISspr_validateToken_v1_Request::isValid() const {
