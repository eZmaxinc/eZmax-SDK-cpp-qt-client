...
void OAIField_eEzsignsignatureType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Acknowledgement", Qt::CaseInsensitive) == 0) {
        ...
        m_value = eOAIField_eEzsignsignatureType::ATTACHMENTSCONFIRMATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FieldText", Qt::CaseInsensitive) == 0) {
        m_value = eOAIField_eEzsignsignatureType::FIELDTEXT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FieldTextarea", Qt::CaseInsensitive) == 0) {
        m_value = eOAIField_eEzsignsignatureType::FIELDTEXTAREA;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIField_eEzsignsignatureType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIField_eEzsignsignatureType::ATTACHMENTS:
            val = "Attachments";
            break;
        case eOAIField_eEzsignsignatureType::ATTACHMENTSCONFIRMATION:
            val = "AttachmentsConfirmation";
            break;
        case eOAIField_eEzsignsignatureType::FIELDTEXT:
            val = "FieldText";
            break;
        case eOAIField_eEzsignsignatureType::FIELDTEXTAREA:
            val = "FieldTextarea";
            break;
        default:
            break;
