...
/*
 * OAIEzsigntemplatedocument_flatten_v1_Response.h
 *
 * Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocument}/flatten
 */

#ifndef OAIEzsigntemplatedocument_flatten_v1_Response_H
#define OAIEzsigntemplatedocument_flatten_v1_Response_H
...
class OAIEzsigntemplatedocument_flatten_v1_Response : public OAIObject {
public:
    OAIEzsigntemplatedocument_flatten_v1_Response();
    OAIEzsigntemplatedocument_flatten_v1_Response(QString json);
    ~OAIEzsigntemplatedocument_flatten_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatedocument_flatten_v1_Response)

#endif // OAIEzsigntemplatedocument_flatten_v1_Response_H
