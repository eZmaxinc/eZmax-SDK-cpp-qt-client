...
#ifndef Communicationrecipient_Response_H
#define Communicationrecipient_Response_H
...
class Communicationrecipient_Response : public Object {
public:
    Communicationrecipient_Response();
    Communicationrecipient_Response(QString json);
    ~Communicationrecipient_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Communicationrecipient_Response)

#endif // Communicationrecipient_Response_H
