...
/*
 * OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload.h
 *
 * Payload for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getEzsignsignaturesAutomatic
 */

#ifndef OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
#define OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
...
class OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload : public OAIObject {
public:
    OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload();
    OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload(QString json);
    ~OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload)

#endif // OAIEzsignbulksendtransmission_getEzsignsignaturesAutomatic_v1_Response_mPayload_H
