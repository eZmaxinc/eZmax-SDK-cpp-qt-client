...
/*
 * OAIBillingentityinternal_editObject_v1_Response.h
 *
 * Response for PUT /1/object/billingentityinternal/{pkiBillingentityinternalID}
 */

#ifndef OAIBillingentityinternal_editObject_v1_Response_H
#define OAIBillingentityinternal_editObject_v1_Response_H
...
class OAIBillingentityinternal_editObject_v1_Response : public OAIObject {
public:
    OAIBillingentityinternal_editObject_v1_Response();
    OAIBillingentityinternal_editObject_v1_Response(QString json);
    ~OAIBillingentityinternal_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIBillingentityinternal_editObject_v1_Response)

#endif // OAIBillingentityinternal_editObject_v1_Response_H
