...
private:
    ...
    QList<OAIEzsigntemplatepackagesigner_ResponseCompound> m_a_obj_ezsigntemplatepackagesigner;
    bool m_a_obj_ezsigntemplatepackagesigner_isSet;
    bool m_a_obj_ezsigntemplatepackagesigner_isValid;

    QList<OAIEzsigntemplatepackagemembership_ResponseCompound> m_a_obj_ezsigntemplatepackagemembership;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsigntemplatepackage_ResponseCompound)
