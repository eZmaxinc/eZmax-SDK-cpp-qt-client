...
Authenticationexternal_Response::Authenticationexternal_Response(const QString &json) {
...
void Authenticationexternal_Response::fromJson(const QString &jsonString) {
