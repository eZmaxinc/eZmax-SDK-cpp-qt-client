...
ObjectRejectedoffertopurchaseApi::ObjectRejectedoffertopurchaseApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectRejectedoffertopurchaseApi::~ObjectRejectedoffertopurchaseApi() {
}

void ObjectRejectedoffertopurchaseApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("rejectedoffertopurchaseGetListV1", defaultConf);
    _serverIndices.insert("rejectedoffertopurchaseGetListV1", 0);
    _serverConfigs.insert("rejectedoffertopurchaseImportIntoEDMV1", defaultConf);
    _serverIndices.insert("rejectedoffertopurchaseImportIntoEDMV1", 0);
}
...
*/
int ObjectRejectedoffertopurchaseApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void ObjectRejectedoffertopurchaseApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectRejectedoffertopurchaseApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectRejectedoffertopurchaseApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectRejectedoffertopurchaseApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectRejectedoffertopurchaseApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectRejectedoffertopurchaseApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectRejectedoffertopurchaseApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectRejectedoffertopurchaseApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int ObjectRejectedoffertopurchaseApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void ObjectRejectedoffertopurchaseApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectRejectedoffertopurchaseApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectRejectedoffertopurchaseApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectRejectedoffertopurchaseApi::enableResponseCompression() {
...
QString ObjectRejectedoffertopurchaseApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectRejectedoffertopurchaseApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseGetCommunicationListV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Rejectedoffertopurchase_getCommunicationList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseGetListV1(const ::Ezmaxapi::OptionalParam<QString> &e_order_by, const ::Ezmaxapi::OptionalParam<qint32> &i_row_max, const ::Ezmaxapi::OptionalParam<qint32> &i_row_offset, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language, const ::Ezmaxapi::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseGetListV1Callback);
    connect(this, &ObjectRejectedoffertopurchaseApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseGetListV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Rejectedoffertopurchase_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rejectedoffertopurchaseGetListV1Signal(output);
        Q_EMIT rejectedoffertopurchaseGetListV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rejectedoffertopurchaseGetListV1SignalE(output, error_type, error_str);
        Q_EMIT rejectedoffertopurchaseGetListV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rejectedoffertopurchaseGetListV1SignalError(output, error_type, error_str);
        Q_EMIT rejectedoffertopurchaseGetListV1SignalErrorFull(worker, error_type, error_str);
    }
}

void ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseImportIntoEDMV1(const qint32 &pki_rejectedoffertopurchase_id, const Rejectedoffertopurchase_importIntoEDM_v1_Request &rejectedoffertopurchase_import_into_edm_v1_request) {
    QString fullPath = QString(_serverConfigs["rejectedoffertopurchaseImportIntoEDMV1"][_serverIndices.value("rejectedoffertopurchaseImportIntoEDMV1")].URL()+"/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/importIntoEDM");
...

    {
        ...
        QByteArray output = rejectedoffertopurchase_import_into_edm_v1_request.asJson().toUtf8();
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseImportIntoEDMV1Callback);
    connect(this, &ObjectRejectedoffertopurchaseApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectRejectedoffertopurchaseApi::rejectedoffertopurchaseImportIntoEDMV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Rejectedoffertopurchase_importIntoEDM_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1Signal(output);
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1SignalE(output, error_type, error_str);
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1SignalError(output, error_type, error_str);
        Q_EMIT rejectedoffertopurchaseImportIntoEDMV1SignalErrorFull(worker, error_type, error_str);
    }
}

void ObjectRejectedoffertopurchaseApi::tokenAvailable(){
