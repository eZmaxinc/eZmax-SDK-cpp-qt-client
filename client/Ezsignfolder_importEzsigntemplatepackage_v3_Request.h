...
/*
 * Ezsignfolder_importEzsigntemplatepackage_v3_Request.h
 *
 * Request for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage
 */

#ifndef Ezsignfolder_importEzsigntemplatepackage_v3_Request_H
#define Ezsignfolder_importEzsigntemplatepackage_v3_Request_H
...
class Ezsignfolder_importEzsigntemplatepackage_v3_Request : public Object {
public:
    Ezsignfolder_importEzsigntemplatepackage_v3_Request();
    Ezsignfolder_importEzsigntemplatepackage_v3_Request(const QString &json);
    ~Ezsignfolder_importEzsigntemplatepackage_v3_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_importEzsigntemplatepackage_v3_Request)

#endif // Ezsignfolder_importEzsigntemplatepackage_v3_Request_H
