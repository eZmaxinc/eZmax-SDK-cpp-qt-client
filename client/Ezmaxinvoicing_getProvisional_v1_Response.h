...
/*
 * Ezmaxinvoicing_getProvisional_v1_Response.h
 *
 * Response for GET /1/object/ezmaxinvoicing/getProvisional
 */

#ifndef Ezmaxinvoicing_getProvisional_v1_Response_H
#define Ezmaxinvoicing_getProvisional_v1_Response_H
...
public:
    Ezmaxinvoicing_getProvisional_v1_Response();
    Ezmaxinvoicing_getProvisional_v1_Response(const QString &json);
    ~Ezmaxinvoicing_getProvisional_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxinvoicing_getProvisional_v1_Response)

#endif // Ezmaxinvoicing_getProvisional_v1_Response_H
