...
Usergroupexternal_RequestCompound::Usergroupexternal_RequestCompound(const QString &json) {
...
void Usergroupexternal_RequestCompound::fromJson(const QString &jsonString) {
