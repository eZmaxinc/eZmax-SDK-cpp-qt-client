...
/*
 * OAIUsergroupmembership_editObject_v1_Response.h
 *
 * Response for PUT /1/object/usergroupmembership/{pkiUsergroupmembershipID}
 */

#ifndef OAIUsergroupmembership_editObject_v1_Response_H
#define OAIUsergroupmembership_editObject_v1_Response_H
...
class OAIUsergroupmembership_editObject_v1_Response : public OAIObject {
public:
    OAIUsergroupmembership_editObject_v1_Response();
    OAIUsergroupmembership_editObject_v1_Response(QString json);
    ~OAIUsergroupmembership_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUsergroupmembership_editObject_v1_Response)

#endif // OAIUsergroupmembership_editObject_v1_Response_H
