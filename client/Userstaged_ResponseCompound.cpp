...
Userstaged_ResponseCompound::Userstaged_ResponseCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Userstaged_ResponseCompound::Userstaged_ResponseCompound() {
    this->initializeModel();
}

Userstaged_ResponseCompound::~Userstaged_ResponseCompound() {}

void Userstaged_ResponseCompound::initializeModel() {
...
void Userstaged_ResponseCompound::fromJson(const QString &jsonString) {
...
void Userstaged_ResponseCompound::fromJsonObject(QJsonObject json) {
...
QString Userstaged_ResponseCompound::asJson() const {
...
QJsonObject Userstaged_ResponseCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Userstaged_ResponseCompound::getPkiUserstagedId() const {
    return m_pki_userstaged_id;
}
void Userstaged_ResponseCompound::setPkiUserstagedId(const qint32 &pki_userstaged_id) {
    m_pki_userstaged_id = pki_userstaged_id;
    m_pki_userstaged_id_isSet = true;
}

bool Userstaged_ResponseCompound::is_pki_userstaged_id_Set() const{
    return m_pki_userstaged_id_isSet;
}

bool Userstaged_ResponseCompound::is_pki_userstaged_id_Valid() const{
    return m_pki_userstaged_id_isValid;
}

qint32 Userstaged_ResponseCompound::getFkiEmailId() const {
    return m_fki_email_id;
}
void Userstaged_ResponseCompound::setFkiEmailId(const qint32 &fki_email_id) {
    m_fki_email_id = fki_email_id;
    m_fki_email_id_isSet = true;
}

bool Userstaged_ResponseCompound::is_fki_email_id_Set() const{
    return m_fki_email_id_isSet;
}

bool Userstaged_ResponseCompound::is_fki_email_id_Valid() const{
    return m_fki_email_id_isValid;
}

QString Userstaged_ResponseCompound::getSEmailAddress() const {
    return m_s_email_address;
}
void Userstaged_ResponseCompound::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Userstaged_ResponseCompound::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Userstaged_ResponseCompound::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

QString Userstaged_ResponseCompound::getSUserstagedFirstname() const {
    return m_s_userstaged_firstname;
}
void Userstaged_ResponseCompound::setSUserstagedFirstname(const QString &s_userstaged_firstname) {
    m_s_userstaged_firstname = s_userstaged_firstname;
    m_s_userstaged_firstname_isSet = true;
}

bool Userstaged_ResponseCompound::is_s_userstaged_firstname_Set() const{
    return m_s_userstaged_firstname_isSet;
}

bool Userstaged_ResponseCompound::is_s_userstaged_firstname_Valid() const{
    return m_s_userstaged_firstname_isValid;
}

QString Userstaged_ResponseCompound::getSUserstagedLastname() const {
    return m_s_userstaged_lastname;
}
void Userstaged_ResponseCompound::setSUserstagedLastname(const QString &s_userstaged_lastname) {
    m_s_userstaged_lastname = s_userstaged_lastname;
    m_s_userstaged_lastname_isSet = true;
}

bool Userstaged_ResponseCompound::is_s_userstaged_lastname_Set() const{
    return m_s_userstaged_lastname_isSet;
}

bool Userstaged_ResponseCompound::is_s_userstaged_lastname_Valid() const{
    return m_s_userstaged_lastname_isValid;
}

QString Userstaged_ResponseCompound::getSUserstagedExternalid() const {
    return m_s_userstaged_externalid;
}
void Userstaged_ResponseCompound::setSUserstagedExternalid(const QString &s_userstaged_externalid) {
    m_s_userstaged_externalid = s_userstaged_externalid;
    m_s_userstaged_externalid_isSet = true;
}

bool Userstaged_ResponseCompound::is_s_userstaged_externalid_Set() const{
    return m_s_userstaged_externalid_isSet;
}

bool Userstaged_ResponseCompound::is_s_userstaged_externalid_Valid() const{
    return m_s_userstaged_externalid_isValid;
}

bool Userstaged_ResponseCompound::isSet() const {
...
bool Userstaged_ResponseCompound::isValid() const {
