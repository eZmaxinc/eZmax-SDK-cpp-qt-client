...
void ObjectEzsigndocumentApi::initializeServerConfigs() {
    ...
    _serverIndices.insert("ezsigndocumentCreateEzsignelementsPositionedByWordV2", 0);
    ...
    _serverConfigs.insert("ezsigndocumentCreateObjectV3", defaultConf);
    _serverIndices.insert("ezsigndocumentCreateObjectV3", 0);
    ...
    _serverConfigs.insert("ezsigndocumentEditEzsignannotationsV1", defaultConf);
    ...
    _serverIndices.insert("ezsigndocumentEditEzsignsignaturesV2", 0);
    ...
    _serverConfigs.insert("ezsigndocumentExtractTextV1", defaultConf);
    _serverIndices.insert("ezsigndocumentExtractTextV1", 0);
    _serverConfigs.insert("ezsigndocumentFlattenV1", defaultConf);
    _serverIndices.insert("ezsigndocumentFlattenV1", 0);
    _serverConfigs.insert("ezsigndocumentGetActionableElementsForSignerV1", defaultConf);
    _serverIndices.insert("ezsigndocumentGetActionableElementsForSignerV1", 0);
    ...
    _serverConfigs.insert("ezsigndocumentGetCompletedElementsV2", defaultConf);
    _serverIndices.insert("ezsigndocumentGetCompletedElementsV2", 0);
    ...
    _serverConfigs.insert("ezsigndocumentGetEzsignsignaturesV2", defaultConf);
    _serverIndices.insert("ezsigndocumentGetEzsignsignaturesV2", 0);
    ...
    _serverConfigs.insert("ezsigndocumentGetObjectV3", defaultConf);
    _serverIndices.insert("ezsigndocumentGetObjectV3", 0);
    ...
    _serverConfigs.insert("ezsigndocumentPrefillEzsignformV1", defaultConf);
    _serverIndices.insert("ezsigndocumentPrefillEzsignformV1", 0);
...
void ObjectEzsigndocumentApi::ezsigndocumentCreateEzsignelementsPositionedByWordV2(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_createEzsignelementsPositionedByWord_v2_Request &ezsigndocument_create_ezsignelements_positioned_by_word_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentCreateEzsignelementsPositionedByWordV2"][_serverIndices.value("ezsigndocumentCreateEzsignelementsPositionedByWordV2")].URL()+"/2/object/ezsigndocument/{pkiEzsigndocumentID}/createEzsignelementsPositionedByWord");
...

    {
        ...
        QByteArray output = ezsigndocument_create_ezsignelements_positioned_by_word_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentCreateEzsignelementsPositionedByWordV2Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentCreateEzsignelementsPositionedByWordV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_createEzsignelementsPositionedByWord_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentCreateObjectV3(const Ezsigndocument_createObject_v3_Request &ezsigndocument_create_object_v3_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentCreateObjectV3"][_serverIndices.value("ezsigndocumentCreateObjectV3")].URL()+"/3/object/ezsigndocument");
...

    {
        ...
        QByteArray output = ezsigndocument_create_object_v3_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentCreateObjectV3Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentCreateObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_createObject_v3_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditEzsignannotationsV1(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_editEzsignannotations_v1_Request &ezsigndocument_edit_ezsignannotations_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentEditEzsignannotationsV1"][_serverIndices.value("ezsigndocumentEditEzsignannotationsV1")].URL()+"/1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignannotations");
...

    {
        ...
        QByteArray output = ezsigndocument_edit_ezsignannotations_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentEditEzsignannotationsV1Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditEzsignannotationsV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_editEzsignannotations_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditEzsignsignaturesV2(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_editEzsignsignatures_v2_Request &ezsigndocument_edit_ezsignsignatures_v2_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentEditEzsignsignaturesV2"][_serverIndices.value("ezsigndocumentEditEzsignsignaturesV2")].URL()+"/2/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignsignatures");
...

    {
        ...
        QByteArray output = ezsigndocument_edit_ezsignsignatures_v2_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentEditEzsignsignaturesV2Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditEzsignsignaturesV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_editEzsignsignatures_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditObjectV1(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_editObject_v1_Request &ezsigndocument_edit_object_v1_request) {
...

    {
        ...
        QByteArray output = ezsigndocument_edit_object_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentEditObjectV1Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentEditObjectV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_editObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentExtractTextV1(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_extractText_v1_Request &ezsigndocument_extract_text_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentExtractTextV1"][_serverIndices.value("ezsigndocumentExtractTextV1")].URL()+"/1/object/ezsigndocument/{pkiEzsigndocumentID}/extractText");
...

    {
        ...
        QByteArray output = ezsigndocument_extract_text_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentExtractTextV1Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentExtractTextV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_extractText_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsForSignerV1(const qint32 &pki_ezsigndocument_id, const QString &e_signer_type, const ::Ezmaxapi::OptionalParam<qint32> &fki_ezsignsigner_id, const ::Ezmaxapi::OptionalParam<qint32> &fki_user_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetActionableElementsForSignerV1"][_serverIndices.value("ezsigndocumentGetActionableElementsForSignerV1")].URL()+"/1/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElementsForSigner");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsForSignerV1Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsForSignerV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_getActionableElementsForSigner_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ezsigndocumentGetActionableElementsForSignerV1Signal(output);
        Q_EMIT ezsigndocumentGetActionableElementsForSignerV1SignalFull(worker, output);
    } else {
        Q_EMIT ezsigndocumentGetActionableElementsForSignerV1SignalError(output, error_type, error_str);
        Q_EMIT ezsigndocumentGetActionableElementsForSignerV1SignalErrorFull(worker, error_type, error_str);
    }
}
...
void ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsV2(const qint32 &pki_ezsigndocument_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetActionableElementsV2"][_serverIndices.value("ezsigndocumentGetActionableElementsV2")].URL()+"/2/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsV2Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetActionableElementsV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_getActionableElements_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetCompletedElementsV2(const qint32 &pki_ezsigndocument_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetCompletedElementsV2"][_serverIndices.value("ezsigndocumentGetCompletedElementsV2")].URL()+"/2/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentGetCompletedElementsV2Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetCompletedElementsV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_getCompletedElements_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetEzsignsignaturesV2(const qint32 &pki_ezsigndocument_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetEzsignsignaturesV2"][_serverIndices.value("ezsigndocumentGetEzsignsignaturesV2")].URL()+"/2/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignatures");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentGetEzsignsignaturesV2Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetEzsignsignaturesV2Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_getEzsignsignatures_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetObjectV3(const qint32 &pki_ezsigndocument_id) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentGetObjectV3"][_serverIndices.value("ezsigndocumentGetObjectV3")].URL()+"/3/object/ezsigndocument/{pkiEzsigndocumentID}");
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentGetObjectV3Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentGetObjectV3Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_getObject_v3_Response output(QString(worker->response));
    worker->deleteLater();
...
void ObjectEzsigndocumentApi::ezsigndocumentPrefillEzsignformV1(const qint32 &pki_ezsigndocument_id, const Ezsigndocument_prefillEzsignform_v1_Request &ezsigndocument_prefill_ezsignform_v1_request) {
    QString fullPath = QString(_serverConfigs["ezsigndocumentPrefillEzsignformV1"][_serverIndices.value("ezsigndocumentPrefillEzsignformV1")].URL()+"/1/object/ezsigndocument/{pkiEzsigndocumentID}/prefillEzsignform");
...

    {
        ...
        QByteArray output = ezsigndocument_prefill_ezsignform_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectEzsigndocumentApi::ezsigndocumentPrefillEzsignformV1Callback);
    connect(this, &ObjectEzsigndocumentApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<HttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void ObjectEzsigndocumentApi::ezsigndocumentPrefillEzsignformV1Callback(HttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    Ezsigndocument_prefillEzsignform_v1_Response output(QString(worker->response));
    worker->deleteLater();
