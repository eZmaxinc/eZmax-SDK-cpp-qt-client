...
#ifndef Custom_User_Response_H
#define Custom_User_Response_H
...
class Custom_User_Response : public Object {
public:
    Custom_User_Response();
    Custom_User_Response(QString json);
    ~Custom_User_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Custom_User_Response)

#endif // Custom_User_Response_H
