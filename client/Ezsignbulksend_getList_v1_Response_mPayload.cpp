...
Ezsignbulksend_getList_v1_Response_mPayload::Ezsignbulksend_getList_v1_Response_mPayload(const QString &json) {
...
void Ezsignbulksend_getList_v1_Response_mPayload::fromJson(const QString &jsonString) {
