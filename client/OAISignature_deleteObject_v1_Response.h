...
/*
 * OAISignature_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/signature/{pkiSignatureID}
 */

#ifndef OAISignature_deleteObject_v1_Response_H
#define OAISignature_deleteObject_v1_Response_H
...
class OAISignature_deleteObject_v1_Response : public OAIObject {
public:
    OAISignature_deleteObject_v1_Response();
    OAISignature_deleteObject_v1_Response(QString json);
    ~OAISignature_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAISignature_deleteObject_v1_Response)

#endif // OAISignature_deleteObject_v1_Response_H
