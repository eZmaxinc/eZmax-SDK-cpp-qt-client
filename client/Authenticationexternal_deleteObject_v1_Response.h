...
/*
 * Authenticationexternal_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/authenticationexternal/{pkiAuthenticationexternalID}
 */

#ifndef Authenticationexternal_deleteObject_v1_Response_H
#define Authenticationexternal_deleteObject_v1_Response_H
...
class Authenticationexternal_deleteObject_v1_Response : public Object {
public:
    Authenticationexternal_deleteObject_v1_Response();
    Authenticationexternal_deleteObject_v1_Response(const QString &json);
    ~Authenticationexternal_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Authenticationexternal_deleteObject_v1_Response)

#endif // Authenticationexternal_deleteObject_v1_Response_H
