...
/*
 * Ezsignsignaturecustomdate_RequestCompound.h
 *
 * An Ezsignsignaturecustomdate Object and children to create a complete structure
 */

#ifndef Ezsignsignaturecustomdate_RequestCompound_H
#define Ezsignsignaturecustomdate_RequestCompound_H
...
class Ezsignsignaturecustomdate_RequestCompound : public Object {
public:
    Ezsignsignaturecustomdate_RequestCompound();
    Ezsignsignaturecustomdate_RequestCompound(const QString &json);
    ~Ezsignsignaturecustomdate_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignsignaturecustomdate_RequestCompound)

#endif // Ezsignsignaturecustomdate_RequestCompound_H
