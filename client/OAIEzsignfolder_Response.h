...
/*
 * OAIEzsignfolder_Response.h
 *
 * An Ezsignfolder Object
 */

#ifndef OAIEzsignfolder_Response_H
#define OAIEzsignfolder_Response_H
...
public:
    OAIEzsignfolder_Response();
    OAIEzsignfolder_Response(QString json);
    ~OAIEzsignfolder_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignfolder_Response)

#endif // OAIEzsignfolder_Response_H
