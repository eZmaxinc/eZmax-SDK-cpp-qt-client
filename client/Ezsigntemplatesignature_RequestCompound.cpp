...
Ezsigntemplatesignature_RequestCompound::Ezsigntemplatesignature_RequestCompound(const QString &json) {
...
void Ezsigntemplatesignature_RequestCompound::fromJson(const QString &jsonString) {
...
qint32 Ezsigntemplatesignature_RequestCompound::getFkiPaymentgatewayId() const {
    return m_fki_paymentgateway_id;
}
void Ezsigntemplatesignature_RequestCompound::setFkiPaymentgatewayId(const qint32 &fki_paymentgateway_id) {
    m_fki_paymentgateway_id = fki_paymentgateway_id;
    m_fki_paymentgateway_id_isSet = true;
}

bool Ezsigntemplatesignature_RequestCompound::is_fki_paymentgateway_id_Set() const{
    return m_fki_paymentgateway_id_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_fki_paymentgateway_id_Valid() const{
    return m_fki_paymentgateway_id_isValid;
}

bool Ezsigntemplatesignature_RequestCompound::isBEzsigntemplatesignatureHandwritten() const {
    return m_b_ezsigntemplatesignature_handwritten;
}
void Ezsigntemplatesignature_RequestCompound::setBEzsigntemplatesignatureHandwritten(const bool &b_ezsigntemplatesignature_handwritten) {
...
bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_handwritten_Set() const{
    return m_b_ezsigntemplatesignature_handwritten_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_handwritten_Valid() const{
    return m_b_ezsigntemplatesignature_handwritten_isValid;
}

bool Ezsigntemplatesignature_RequestCompound::isBEzsigntemplatesignatureReason() const {
    return m_b_ezsigntemplatesignature_reason;
}
void Ezsigntemplatesignature_RequestCompound::setBEzsigntemplatesignatureReason(const bool &b_ezsigntemplatesignature_reason) {
    m_b_ezsigntemplatesignature_reason = b_ezsigntemplatesignature_reason;
    m_b_ezsigntemplatesignature_reason_isSet = true;
}

bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_reason_Set() const{
    return m_b_ezsigntemplatesignature_reason_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_reason_Valid() const{
    return m_b_ezsigntemplatesignature_reason_isValid;
}

bool Ezsigntemplatesignature_RequestCompound::isBEzsigntemplatesignatureCreditcardcustomamount() const {
    return m_b_ezsigntemplatesignature_creditcardcustomamount;
}
void Ezsigntemplatesignature_RequestCompound::setBEzsigntemplatesignatureCreditcardcustomamount(const bool &b_ezsigntemplatesignature_creditcardcustomamount) {
...
bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_creditcardcustomamount_Set() const{
    return m_b_ezsigntemplatesignature_creditcardcustomamount_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_b_ezsigntemplatesignature_creditcardcustomamount_Valid() const{
    return m_b_ezsigntemplatesignature_creditcardcustomamount_isValid;
}

Field_eEzsigntemplatesignaturePositioning Ezsigntemplatesignature_RequestCompound::getEEzsigntemplatesignaturePositioning() const {
    return m_e_ezsigntemplatesignature_positioning;
}
void Ezsigntemplatesignature_RequestCompound::setEEzsigntemplatesignaturePositioning(const Field_eEzsigntemplatesignaturePositioning &e_ezsigntemplatesignature_positioning) {
...
bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_positioning_Set() const{
    return m_e_ezsigntemplatesignature_positioning_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_positioning_Valid() const{
...
void Ezsigntemplatesignature_RequestCompound::setEEzsigntemplatesignatureConsultationtrigger(const Field_eEzsigntemplatesignatureConsultationtrigger &e_ezsigntemplatesignature_consultationtrigger) {
...
bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_consultationtrigger_Set() const{
    return m_e_ezsigntemplatesignature_consultationtrigger_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_consultationtrigger_Valid() const{
...
QString Ezsigntemplatesignature_RequestCompound::getSEzsigntemplatesignatureDefaultvalue() const {
    return m_s_ezsigntemplatesignature_defaultvalue;
}
void Ezsigntemplatesignature_RequestCompound::setSEzsigntemplatesignatureDefaultvalue(const QString &s_ezsigntemplatesignature_defaultvalue) {
...
bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_defaultvalue_Set() const{
    return m_s_ezsigntemplatesignature_defaultvalue_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_defaultvalue_Valid() const{
...
QString Ezsigntemplatesignature_RequestCompound::getSEzsigntemplatesignatureTextvalidationcustommessage() const {
    return m_s_ezsigntemplatesignature_textvalidationcustommessage;
}
void Ezsigntemplatesignature_RequestCompound::setSEzsigntemplatesignatureTextvalidationcustommessage(const QString &s_ezsigntemplatesignature_textvalidationcustommessage) {
...
bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_textvalidationcustommessage_Set() const{
    return m_s_ezsigntemplatesignature_textvalidationcustommessage_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_textvalidationcustommessage_Valid() const{
    return m_s_ezsigntemplatesignature_textvalidationcustommessage_isValid;
}

Field_eEzsigntemplatesignatureDependencyrequirement Ezsigntemplatesignature_RequestCompound::getEEzsigntemplatesignatureDependencyrequirement() const {
    return m_e_ezsigntemplatesignature_dependencyrequirement;
}
void Ezsigntemplatesignature_RequestCompound::setEEzsigntemplatesignatureDependencyrequirement(const Field_eEzsigntemplatesignatureDependencyrequirement &e_ezsigntemplatesignature_dependencyrequirement) {
...
bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_dependencyrequirement_Set() const{
    return m_e_ezsigntemplatesignature_dependencyrequirement_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_dependencyrequirement_Valid() const{
    return m_e_ezsigntemplatesignature_dependencyrequirement_isValid;
}

QString Ezsigntemplatesignature_RequestCompound::getSEzsigntemplatesignaturePositioningpattern() const {
    return m_s_ezsigntemplatesignature_positioningpattern;
}
void Ezsigntemplatesignature_RequestCompound::setSEzsigntemplatesignaturePositioningpattern(const QString &s_ezsigntemplatesignature_positioningpattern) {
...
bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_positioningpattern_Set() const{
    return m_s_ezsigntemplatesignature_positioningpattern_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_positioningpattern_Valid() const{
    return m_s_ezsigntemplatesignature_positioningpattern_isValid;
}

qint32 Ezsigntemplatesignature_RequestCompound::getIEzsigntemplatesignaturePositioningoffsetx() const {
    return m_i_ezsigntemplatesignature_positioningoffsetx;
}
void Ezsigntemplatesignature_RequestCompound::setIEzsigntemplatesignaturePositioningoffsetx(const qint32 &i_ezsigntemplatesignature_positioningoffsetx) {
...
bool Ezsigntemplatesignature_RequestCompound::is_i_ezsigntemplatesignature_positioningoffsetx_Set() const{
    return m_i_ezsigntemplatesignature_positioningoffsetx_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_i_ezsigntemplatesignature_positioningoffsetx_Valid() const{
    return m_i_ezsigntemplatesignature_positioningoffsetx_isValid;
}

qint32 Ezsigntemplatesignature_RequestCompound::getIEzsigntemplatesignaturePositioningoffsety() const {
    return m_i_ezsigntemplatesignature_positioningoffsety;
}
void Ezsigntemplatesignature_RequestCompound::setIEzsigntemplatesignaturePositioningoffsety(const qint32 &i_ezsigntemplatesignature_positioningoffsety) {
...
bool Ezsigntemplatesignature_RequestCompound::is_i_ezsigntemplatesignature_positioningoffsety_Set() const{
    return m_i_ezsigntemplatesignature_positioningoffsety_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_i_ezsigntemplatesignature_positioningoffsety_Valid() const{
    return m_i_ezsigntemplatesignature_positioningoffsety_isValid;
}

Field_eEzsigntemplatesignaturePositioningoccurence Ezsigntemplatesignature_RequestCompound::getEEzsigntemplatesignaturePositioningoccurence() const {
    return m_e_ezsigntemplatesignature_positioningoccurence;
}
void Ezsigntemplatesignature_RequestCompound::setEEzsigntemplatesignaturePositioningoccurence(const Field_eEzsigntemplatesignaturePositioningoccurence &e_ezsigntemplatesignature_positioningoccurence) {
...
bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_positioningoccurence_Set() const{
    return m_e_ezsigntemplatesignature_positioningoccurence_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_e_ezsigntemplatesignature_positioningoccurence_Valid() const{
    return m_e_ezsigntemplatesignature_positioningoccurence_isValid;
}

QString Ezsigntemplatesignature_RequestCompound::getSEzsigntemplatesignatureCreditcardamountdescription() const {
    return m_s_ezsigntemplatesignature_creditcardamountdescription;
}
void Ezsigntemplatesignature_RequestCompound::setSEzsigntemplatesignatureCreditcardamountdescription(const QString &s_ezsigntemplatesignature_creditcardamountdescription) {
...
bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_creditcardamountdescription_Set() const{
    return m_s_ezsigntemplatesignature_creditcardamountdescription_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_s_ezsigntemplatesignature_creditcardamountdescription_Valid() const{
    return m_s_ezsigntemplatesignature_creditcardamountdescription_isValid;
}

QString Ezsigntemplatesignature_RequestCompound::getDEzsigntemplatesignatureCreditcardamount() const {
    return m_d_ezsigntemplatesignature_creditcardamount;
}
void Ezsigntemplatesignature_RequestCompound::setDEzsigntemplatesignatureCreditcardamount(const QString &d_ezsigntemplatesignature_creditcardamount) {
...
bool Ezsigntemplatesignature_RequestCompound::is_d_ezsigntemplatesignature_creditcardamount_Set() const{
    return m_d_ezsigntemplatesignature_creditcardamount_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_d_ezsigntemplatesignature_creditcardamount_Valid() const{
...
QList<Ezsigntemplateelementdependency_RequestCompound> Ezsigntemplatesignature_RequestCompound::getAObjEzsigntemplateelementdependency() const {
    return m_a_obj_ezsigntemplateelementdependency;
}
void Ezsigntemplatesignature_RequestCompound::setAObjEzsigntemplateelementdependency(const QList<Ezsigntemplateelementdependency_RequestCompound> &a_obj_ezsigntemplateelementdependency) {
...
bool Ezsigntemplatesignature_RequestCompound::is_a_obj_ezsigntemplateelementdependency_Set() const{
    return m_a_obj_ezsigntemplateelementdependency_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_a_obj_ezsigntemplateelementdependency_Valid() const{
    return m_a_obj_ezsigntemplateelementdependency_isValid;
}

QList<Ezsigntemplatesignaturepaymentdetail_RequestCompound> Ezsigntemplatesignature_RequestCompound::getAObjEzsigntemplatesignaturepaymentdetail() const {
    return m_a_obj_ezsigntemplatesignaturepaymentdetail;
}
void Ezsigntemplatesignature_RequestCompound::setAObjEzsigntemplatesignaturepaymentdetail(const QList<Ezsigntemplatesignaturepaymentdetail_RequestCompound> &a_obj_ezsigntemplatesignaturepaymentdetail) {
...
bool Ezsigntemplatesignature_RequestCompound::is_a_obj_ezsigntemplatesignaturepaymentdetail_Set() const{
    return m_a_obj_ezsigntemplatesignaturepaymentdetail_isSet;
}

bool Ezsigntemplatesignature_RequestCompound::is_a_obj_ezsigntemplatesignaturepaymentdetail_Valid() const{
