...
/*
 * Agent_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/agent/{pkiAgentID}/getAttachments
 */

#ifndef Agent_getAttachments_v1_Response_mPayload_H
#define Agent_getAttachments_v1_Response_mPayload_H
...
class Agent_getAttachments_v1_Response_mPayload : public Object {
public:
    Agent_getAttachments_v1_Response_mPayload();
    Agent_getAttachments_v1_Response_mPayload(const QString &json);
    ~Agent_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Agent_getAttachments_v1_Response_mPayload)

#endif // Agent_getAttachments_v1_Response_mPayload_H
