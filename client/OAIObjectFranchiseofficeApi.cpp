...
void OAIObjectFranchiseofficeApi::franchiseofficeGetAutocompleteV1(const QString &s_selector, const QVariant &s_query) {
    ...
    if(!s_query.isNull())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("sQuery")).append(querySuffix).append(QUrl::toPercentEncoding(::OpenAPI::toStringValue(s_query.value<QString>())));
    }
