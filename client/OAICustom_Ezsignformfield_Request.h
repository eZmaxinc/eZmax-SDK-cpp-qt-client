...
/*
 * OAICustom_Ezsignformfield_Request.h
 *
 * A Custom Ezsignformfield Object to fill an Ezsignform using submitForm
 */

#ifndef OAICustom_Ezsignformfield_Request_H
#define OAICustom_Ezsignformfield_Request_H
...
class OAICustom_Ezsignformfield_Request : public OAIObject {
public:
    OAICustom_Ezsignformfield_Request();
    OAICustom_Ezsignformfield_Request(QString json);
    ~OAICustom_Ezsignformfield_Request() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAICustom_Ezsignformfield_Request)

#endif // OAICustom_Ezsignformfield_Request_H
