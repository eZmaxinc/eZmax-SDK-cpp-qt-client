...
#ifndef Ezsigntemplatepackage_Response_H
#define Ezsigntemplatepackage_Response_H
...
class Ezsigntemplatepackage_Response : public Object {
public:
    Ezsigntemplatepackage_Response();
    Ezsigntemplatepackage_Response(const QString &json);
    ~Ezsigntemplatepackage_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplatepackage_Response)

#endif // Ezsigntemplatepackage_Response_H
