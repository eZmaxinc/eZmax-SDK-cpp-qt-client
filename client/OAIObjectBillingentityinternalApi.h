...
#ifndef OAI_OAIObjectBillingentityinternalApi_H
#define OAI_OAIObjectBillingentityinternalApi_H
...
public:
    OAIObjectBillingentityinternalApi(const int timeOut = 0);
    ~OAIObjectBillingentityinternalApi();
    ...
    */
    void billingentityinternalGetAutocompleteV1(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &e_filter_active = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &s_query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language = ::OpenAPI::OptionalParam<OAIHeader_Accept_Language>());
