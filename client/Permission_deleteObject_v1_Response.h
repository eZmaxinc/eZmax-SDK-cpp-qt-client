...
/*
 * Permission_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/permission/{pkiPermissionID}
 */

#ifndef Permission_deleteObject_v1_Response_H
#define Permission_deleteObject_v1_Response_H
...
class Permission_deleteObject_v1_Response : public Object {
public:
    Permission_deleteObject_v1_Response();
    Permission_deleteObject_v1_Response(const QString &json);
    ~Permission_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Permission_deleteObject_v1_Response)

#endif // Permission_deleteObject_v1_Response_H
