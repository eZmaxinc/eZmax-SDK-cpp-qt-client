...
/*
 * OAIEzsignsignature_createObject_v2_Response.h
 *
 * Response for POST /2/object/ezsignsignature
 */

#ifndef OAIEzsignsignature_createObject_v2_Response_H
#define OAIEzsignsignature_createObject_v2_Response_H
...
class OAIEzsignsignature_createObject_v2_Response : public OAIObject {
public:
    OAIEzsignsignature_createObject_v2_Response();
    OAIEzsignsignature_createObject_v2_Response(QString json);
    ~OAIEzsignsignature_createObject_v2_Response() override;
...
private:
    ...
    OAIEzsignsignature_createObject_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIEzsignsignature_createObject_v2_Response)

#endif // OAIEzsignsignature_createObject_v2_Response_H
