...
void Custom_Webhook_Response::initializeModel() {
    ...
    m_e_webhook_ezmaxpartnerevent_isSet = false;
    m_e_webhook_ezmaxpartnerevent_isValid = false;
    ...
    m_s_webhook_authentificationexternalerror_isSet = false;
    m_s_webhook_authentificationexternalerror_isValid = false;
...
void Custom_Webhook_Response::fromJsonObject(QJsonObject json) {
    ...
    m_e_webhook_ezmaxpartnerevent_isValid = ::Ezmaxapi::fromJsonValue(m_e_webhook_ezmaxpartnerevent, json[QString("eWebhookEzmaxpartnerevent")]);
    m_e_webhook_ezmaxpartnerevent_isSet = !json[QString("eWebhookEzmaxpartnerevent")].isNull() && m_e_webhook_ezmaxpartnerevent_isValid;
    ...
    m_s_webhook_authentificationexternalerror_isValid = ::Ezmaxapi::fromJsonValue(m_s_webhook_authentificationexternalerror, json[QString("sWebhookAuthentificationexternalerror")]);
    m_s_webhook_authentificationexternalerror_isSet = !json[QString("sWebhookAuthentificationexternalerror")].isNull() && m_s_webhook_authentificationexternalerror_isValid;
...
QJsonObject Custom_Webhook_Response::asJsonObject() const {
    ...
    if (m_e_webhook_ezmaxpartnerevent.isSet()) {
        obj.insert(QString("eWebhookEzmaxpartnerevent"), ::Ezmaxapi::toJsonValue(m_e_webhook_ezmaxpartnerevent));
    }
    ...
    if (m_s_webhook_authentificationexternalerror_isSet) {
        obj.insert(QString("sWebhookAuthentificationexternalerror"), ::Ezmaxapi::toJsonValue(m_s_webhook_authentificationexternalerror));
    }
...
Field_eWebhookEzmaxpartnerevent Custom_Webhook_Response::getEWebhookEzmaxpartnerevent() const {
    return m_e_webhook_ezmaxpartnerevent;
}
void Custom_Webhook_Response::setEWebhookEzmaxpartnerevent(const Field_eWebhookEzmaxpartnerevent &e_webhook_ezmaxpartnerevent) {
    m_e_webhook_ezmaxpartnerevent = e_webhook_ezmaxpartnerevent;
    m_e_webhook_ezmaxpartnerevent_isSet = true;
}

bool Custom_Webhook_Response::is_e_webhook_ezmaxpartnerevent_Set() const{
    return m_e_webhook_ezmaxpartnerevent_isSet;
}

bool Custom_Webhook_Response::is_e_webhook_ezmaxpartnerevent_Valid() const{
    return m_e_webhook_ezmaxpartnerevent_isValid;
}
...
Field_eWebhookRealestateevent Custom_Webhook_Response::getEWebhookRealestateevent() const {
    return m_e_webhook_realestateevent;
}
void Custom_Webhook_Response::setEWebhookRealestateevent(const Field_eWebhookRealestateevent &e_webhook_realestateevent) {
    m_e_webhook_realestateevent = e_webhook_realestateevent;
    m_e_webhook_realestateevent_isSet = true;
}

bool Custom_Webhook_Response::is_e_webhook_realestateevent_Set() const{
    return m_e_webhook_realestateevent_isSet;
}

bool Custom_Webhook_Response::is_e_webhook_realestateevent_Valid() const{
...
QString Custom_Webhook_Response::getSWebhookAuthentificationexternalerror() const {
    return m_s_webhook_authentificationexternalerror;
}
void Custom_Webhook_Response::setSWebhookAuthentificationexternalerror(const QString &s_webhook_authentificationexternalerror) {
    m_s_webhook_authentificationexternalerror = s_webhook_authentificationexternalerror;
    m_s_webhook_authentificationexternalerror_isSet = true;
}

bool Custom_Webhook_Response::is_s_webhook_authentificationexternalerror_Set() const{
    return m_s_webhook_authentificationexternalerror_isSet;
}

bool Custom_Webhook_Response::is_s_webhook_authentificationexternalerror_Valid() const{
    return m_s_webhook_authentificationexternalerror_isValid;
}
