...
Country_AutocompleteElement_Response::Country_AutocompleteElement_Response(const QString &json) {
...
void Country_AutocompleteElement_Response::fromJson(const QString &jsonString) {
