...
/*
 * OAIUserstaged_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/userstaged/{pkiUserstagedID}
 */

#ifndef OAIUserstaged_deleteObject_v1_Response_H
#define OAIUserstaged_deleteObject_v1_Response_H
...
class OAIUserstaged_deleteObject_v1_Response : public OAIObject {
public:
    OAIUserstaged_deleteObject_v1_Response();
    OAIUserstaged_deleteObject_v1_Response(QString json);
    ~OAIUserstaged_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIUserstaged_deleteObject_v1_Response)

#endif // OAIUserstaged_deleteObject_v1_Response_H
