...
#ifndef Ezmaxmaillinglist_subscribe_v1_Response_H
#define Ezmaxmaillinglist_subscribe_v1_Response_H
...
class Ezmaxmaillinglist_subscribe_v1_Response : public Object {
public:
    Ezmaxmaillinglist_subscribe_v1_Response();
    Ezmaxmaillinglist_subscribe_v1_Response(const QString &json);
    ~Ezmaxmaillinglist_subscribe_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezmaxmaillinglist_subscribe_v1_Response)

#endif // Ezmaxmaillinglist_subscribe_v1_Response_H
