...
void OAIEzmaxinvoicingsummaryglobal_ResponseCompound::fromJsonObject(QJsonObject json) {
    ...
    m_a_obj_ezmaxinvoicingcommission_isValid = ::OpenAPI::fromJsonValue(m_a_obj_ezmaxinvoicingcommission, json[QString("a_objEzmaxinvoicingcommission")]);
...
QJsonObject OAIEzmaxinvoicingsummaryglobal_ResponseCompound::asJsonObject() const {
    ...
    if (m_a_obj_ezmaxinvoicingcommission.size() > 0) {
        obj.insert(QString("a_objEzmaxinvoicingcommission"), ::OpenAPI::toJsonValue(m_a_obj_ezmaxinvoicingcommission));
    }
    return obj;
}
