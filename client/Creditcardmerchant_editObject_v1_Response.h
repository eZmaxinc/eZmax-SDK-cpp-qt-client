...
/*
 * Creditcardmerchant_editObject_v1_Response.h
 *
 * Response for PUT /1/object/creditcardmerchant/{pkiCreditcardmerchantID}
 */

#ifndef Creditcardmerchant_editObject_v1_Response_H
#define Creditcardmerchant_editObject_v1_Response_H
...
class Creditcardmerchant_editObject_v1_Response : public Object {
public:
    Creditcardmerchant_editObject_v1_Response();
    Creditcardmerchant_editObject_v1_Response(QString json);
    ~Creditcardmerchant_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Creditcardmerchant_editObject_v1_Response)

#endif // Creditcardmerchant_editObject_v1_Response_H
