...
#include "OAIObjectEzsignfoldertypeApi.h"
...
OAIObjectEzsignfoldertypeApi::~OAIObjectEzsignfoldertypeApi() {
}

void OAIObjectEzsignfoldertypeApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("ezsignfoldertypeGetObjectV1", defaultConf);
    _serverIndices.insert("ezsignfoldertypeGetObjectV1", 0);
...
*/
int OAIObjectEzsignfoldertypeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectEzsignfoldertypeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectEzsignfoldertypeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName,apiKey);
}

void OAIObjectEzsignfoldertypeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectEzsignfoldertypeApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectEzsignfoldertypeApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectEzsignfoldertypeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectEzsignfoldertypeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectEzsignfoldertypeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectEzsignfoldertypeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectEzsignfoldertypeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectEzsignfoldertypeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectEzsignfoldertypeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectEzsignfoldertypeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectEzsignfoldertypeApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectEzsignfoldertypeApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectEzsignfoldertypeApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectEzsignfoldertypeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectEzsignfoldertypeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeCreateObjectV1(const OAIEzsignfoldertype_createObject_v1_Request &oai_ezsignfoldertype_create_object_v1_request) {
...

    {
        ...
        QByteArray output = oai_ezsignfoldertype_create_object_v1_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeCreateObjectV1Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeCreateObjectV1Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIEzsignfoldertype_createObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeEditObjectV1(const qint32 &pki_ezsignfoldertype_id, const OAIEzsignfoldertype_editObject_v1_Request &oai_ezsignfoldertype_edit_object_v1_request) {
...

    {
        ...
        QByteArray output = oai_ezsignfoldertype_edit_object_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeEditObjectV1Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeEditObjectV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldertype_editObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV1(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &e_filter_active, const ::OpenAPI::OptionalParam<QString> &s_query, const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV1Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV2(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &e_filter_active, const ::OpenAPI::OptionalParam<QString> &s_query, const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV2Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetAutocompleteV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldertype_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetListV1(const ::OpenAPI::OptionalParam<QString> &e_order_by, const ::OpenAPI::OptionalParam<qint32> &i_row_max, const ::OpenAPI::OptionalParam<qint32> &i_row_offset, const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language, const ::OpenAPI::OptionalParam<QString> &s_filter) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetListV1Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetListV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldertype_getList_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV1(const qint32 &pki_ezsignfoldertype_id) {
    QString fullPath = QString(_serverConfigs["ezsignfoldertypeGetObjectV1"][_serverIndices.value("ezsignfoldertypeGetObjectV1")].URL()+"/1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV1Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldertype_getObject_v1_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        emit ezsignfoldertypeGetObjectV1Signal(output);
        emit ezsignfoldertypeGetObjectV1SignalFull(worker, output);
    } else {
        emit ezsignfoldertypeGetObjectV1SignalE(output, error_type, error_str);
        emit ezsignfoldertypeGetObjectV1SignalEFull(worker, error_type, error_str);
    }
}

void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV2(const qint32 &pki_ezsignfoldertype_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV2Callback);
    connect(this, &OAIObjectEzsignfoldertypeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsignfoldertypeApi::ezsignfoldertypeGetObjectV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsignfoldertype_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsignfoldertypeApi::tokenAvailable(){
