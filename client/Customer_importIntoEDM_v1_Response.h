...
/*
 * Customer_importIntoEDM_v1_Response.h
 *
 * Response for POST /1/object/customer/{pkiCustomerID}/importIntoEDM
 */

#ifndef Customer_importIntoEDM_v1_Response_H
#define Customer_importIntoEDM_v1_Response_H
...
class Customer_importIntoEDM_v1_Response_mPayload;
...
public:
    ...
    Customer_importIntoEDM_v1_Response_mPayload getMPayload() const;
    void setMPayload(const Customer_importIntoEDM_v1_Response_mPayload &m_payload);
...
private:
    ...
    Customer_importIntoEDM_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::Customer_importIntoEDM_v1_Response)

#endif // Customer_importIntoEDM_v1_Response_H
