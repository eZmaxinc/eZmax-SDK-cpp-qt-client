...
/*
 * Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload.h
 *
 * Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationrecipients
 */

#ifndef Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload_H
#define Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload_H
...
class Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload : public Object {
public:
    Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload();
    Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload(const QString &json);
    ~Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload)

#endif // Ezsignfolder_getCommunicationrecipients_v1_Response_mPayload_H
