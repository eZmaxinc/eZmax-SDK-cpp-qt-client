...
Ezsigntemplatepublic_ResponseCompound::Ezsigntemplatepublic_ResponseCompound(const QString &json) {
...
void Ezsigntemplatepublic_ResponseCompound::fromJson(const QString &jsonString) {
