...
Creditcardmerchant_Response::Creditcardmerchant_Response(const QString &json) {
...
void Creditcardmerchant_Response::initializeModel() {
    ...
    m_fki_currency_id_isSet = false;
    m_fki_currency_id_isValid = false;
...
void Creditcardmerchant_Response::fromJson(const QString &jsonString) {
...
void Creditcardmerchant_Response::fromJsonObject(QJsonObject json) {
    ...
    m_fki_currency_id_isValid = ::Ezmaxapi::fromJsonValue(m_fki_currency_id, json[QString("fkiCurrencyID")]);
    m_fki_currency_id_isSet = !json[QString("fkiCurrencyID")].isNull() && m_fki_currency_id_isValid;
...
QJsonObject Creditcardmerchant_Response::asJsonObject() const {
    ...
    if (m_fki_currency_id_isSet) {
        obj.insert(QString("fkiCurrencyID"), ::Ezmaxapi::toJsonValue(m_fki_currency_id));
    }
...
qint32 Creditcardmerchant_Response::getFkiCurrencyId() const {
    return m_fki_currency_id;
}
void Creditcardmerchant_Response::setFkiCurrencyId(const qint32 &fki_currency_id) {
    m_fki_currency_id = fki_currency_id;
    m_fki_currency_id_isSet = true;
}

bool Creditcardmerchant_Response::is_fki_currency_id_Set() const{
    return m_fki_currency_id_isSet;
}

bool Creditcardmerchant_Response::is_fki_currency_id_Valid() const{
    return m_fki_currency_id_isValid;
}

QString Creditcardmerchant_Response::getSCurrencyDescriptionX() const {
    return m_s_currency_description_x;
}
void Creditcardmerchant_Response::setSCurrencyDescriptionX(const QString &s_currency_description_x) {
    m_s_currency_description_x = s_currency_description_x;
    m_s_currency_description_x_isSet = true;
}

bool Creditcardmerchant_Response::is_s_currency_description_x_Set() const{
    return m_s_currency_description_x_isSet;
}

bool Creditcardmerchant_Response::is_s_currency_description_x_Valid() const{
...
bool Creditcardmerchant_Response::isValid() const {
    ...
    return m_pki_creditcardmerchant_id_isValid && m_fki_language_id_isValid && m_s_language_name_x_isValid && m_fki_currency_id_isValid && m_s_currency_description_x_isValid && m_b_creditcardmerchant_denyvisa_isValid && m_b_creditcardmerchant_denymastercard_isValid && m_b_creditcardmerchant_denyamex_isValid && m_b_creditcardmerchant_isactive_isValid && m_s_creditcardmerchant_description_isValid && m_s_creditcardmerchant_storeid_isValid && true;
}
