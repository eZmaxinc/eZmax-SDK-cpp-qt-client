...
/*
 * Discussionmembership_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/discussionmembership/{pkiDiscussionmembershipID}
 */

#ifndef Discussionmembership_deleteObject_v1_Response_H
#define Discussionmembership_deleteObject_v1_Response_H
...
class Discussionmembership_deleteObject_v1_Response : public Object {
public:
    Discussionmembership_deleteObject_v1_Response();
    Discussionmembership_deleteObject_v1_Response(const QString &json);
    ~Discussionmembership_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussionmembership_deleteObject_v1_Response)

#endif // Discussionmembership_deleteObject_v1_Response_H
