...
Emailtype_getAutocomplete_v2_Response_mPayload::Emailtype_getAutocomplete_v2_Response_mPayload(const QString &json) {
...
void Emailtype_getAutocomplete_v2_Response_mPayload::fromJson(const QString &jsonString) {
