...
Apikey_getCors_v1_Response_mPayload::Apikey_getCors_v1_Response_mPayload(const QString &json) {
...
void Apikey_getCors_v1_Response_mPayload::fromJson(const QString &jsonString) {
