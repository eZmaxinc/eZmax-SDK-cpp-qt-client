...
Ezsigntemplatesignature_ResponseCompound::Ezsigntemplatesignature_ResponseCompound(const QString &json) {
...
void Ezsigntemplatesignature_ResponseCompound::fromJson(const QString &jsonString) {
...
qint32 Ezsigntemplatesignature_ResponseCompound::getFkiPaymentgatewayId() const {
    return m_fki_paymentgateway_id;
}
void Ezsigntemplatesignature_ResponseCompound::setFkiPaymentgatewayId(const qint32 &fki_paymentgateway_id) {
    m_fki_paymentgateway_id = fki_paymentgateway_id;
    m_fki_paymentgateway_id_isSet = true;
}

bool Ezsigntemplatesignature_ResponseCompound::is_fki_paymentgateway_id_Set() const{
    return m_fki_paymentgateway_id_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_fki_paymentgateway_id_Valid() const{
    return m_fki_paymentgateway_id_isValid;
}

bool Ezsigntemplatesignature_ResponseCompound::isBEzsigntemplatesignatureHandwritten() const {
    return m_b_ezsigntemplatesignature_handwritten;
}
void Ezsigntemplatesignature_ResponseCompound::setBEzsigntemplatesignatureHandwritten(const bool &b_ezsigntemplatesignature_handwritten) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_handwritten_Set() const{
    return m_b_ezsigntemplatesignature_handwritten_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_handwritten_Valid() const{
    return m_b_ezsigntemplatesignature_handwritten_isValid;
}

bool Ezsigntemplatesignature_ResponseCompound::isBEzsigntemplatesignatureReason() const {
    return m_b_ezsigntemplatesignature_reason;
}
void Ezsigntemplatesignature_ResponseCompound::setBEzsigntemplatesignatureReason(const bool &b_ezsigntemplatesignature_reason) {
    m_b_ezsigntemplatesignature_reason = b_ezsigntemplatesignature_reason;
    m_b_ezsigntemplatesignature_reason_isSet = true;
}

bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_reason_Set() const{
    return m_b_ezsigntemplatesignature_reason_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_reason_Valid() const{
    return m_b_ezsigntemplatesignature_reason_isValid;
}

bool Ezsigntemplatesignature_ResponseCompound::isBEzsigntemplatesignatureCreditcardcustomamount() const {
    return m_b_ezsigntemplatesignature_creditcardcustomamount;
}
void Ezsigntemplatesignature_ResponseCompound::setBEzsigntemplatesignatureCreditcardcustomamount(const bool &b_ezsigntemplatesignature_creditcardcustomamount) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_creditcardcustomamount_Set() const{
    return m_b_ezsigntemplatesignature_creditcardcustomamount_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_b_ezsigntemplatesignature_creditcardcustomamount_Valid() const{
    return m_b_ezsigntemplatesignature_creditcardcustomamount_isValid;
}

Field_eEzsigntemplatesignaturePositioning Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignaturePositioning() const {
    return m_e_ezsigntemplatesignature_positioning;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignaturePositioning(const Field_eEzsigntemplatesignaturePositioning &e_ezsigntemplatesignature_positioning) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_positioning_Set() const{
    return m_e_ezsigntemplatesignature_positioning_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_positioning_Valid() const{
...
Field_eEzsigntemplatesignatureSignaturepad Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignatureSignaturepad() const {
    return m_e_ezsigntemplatesignature_signaturepad;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignatureSignaturepad(const Field_eEzsigntemplatesignatureSignaturepad &e_ezsigntemplatesignature_signaturepad) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_signaturepad_Set() const{
    return m_e_ezsigntemplatesignature_signaturepad_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_signaturepad_Valid() const{
    return m_e_ezsigntemplatesignature_signaturepad_isValid;
}

Field_eEzsigntemplatesignatureSignaturepadrequired Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignatureSignaturepadrequired() const {
    return m_e_ezsigntemplatesignature_signaturepadrequired;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignatureSignaturepadrequired(const Field_eEzsigntemplatesignatureSignaturepadrequired &e_ezsigntemplatesignature_signaturepadrequired) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_signaturepadrequired_Set() const{
    return m_e_ezsigntemplatesignature_signaturepadrequired_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_signaturepadrequired_Valid() const{
    return m_e_ezsigntemplatesignature_signaturepadrequired_isValid;
}

Field_eEzsigntemplatesignatureConsultationtrigger Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignatureConsultationtrigger() const {
    return m_e_ezsigntemplatesignature_consultationtrigger;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignatureConsultationtrigger(const Field_eEzsigntemplatesignatureConsultationtrigger &e_ezsigntemplatesignature_consultationtrigger) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_consultationtrigger_Set() const{
    return m_e_ezsigntemplatesignature_consultationtrigger_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_consultationtrigger_Valid() const{
...
QString Ezsigntemplatesignature_ResponseCompound::getSEzsigntemplatesignatureDefaultvalue() const {
    return m_s_ezsigntemplatesignature_defaultvalue;
}
void Ezsigntemplatesignature_ResponseCompound::setSEzsigntemplatesignatureDefaultvalue(const QString &s_ezsigntemplatesignature_defaultvalue) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_defaultvalue_Set() const{
    return m_s_ezsigntemplatesignature_defaultvalue_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_defaultvalue_Valid() const{
...
QString Ezsigntemplatesignature_ResponseCompound::getSEzsigntemplatesignatureTextvalidationcustommessage() const {
    return m_s_ezsigntemplatesignature_textvalidationcustommessage;
}
void Ezsigntemplatesignature_ResponseCompound::setSEzsigntemplatesignatureTextvalidationcustommessage(const QString &s_ezsigntemplatesignature_textvalidationcustommessage) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_textvalidationcustommessage_Set() const{
    return m_s_ezsigntemplatesignature_textvalidationcustommessage_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_textvalidationcustommessage_Valid() const{
    return m_s_ezsigntemplatesignature_textvalidationcustommessage_isValid;
}

Field_eEzsigntemplatesignatureDependencyrequirement Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignatureDependencyrequirement() const {
    return m_e_ezsigntemplatesignature_dependencyrequirement;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignatureDependencyrequirement(const Field_eEzsigntemplatesignatureDependencyrequirement &e_ezsigntemplatesignature_dependencyrequirement) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_dependencyrequirement_Set() const{
    return m_e_ezsigntemplatesignature_dependencyrequirement_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_dependencyrequirement_Valid() const{
    return m_e_ezsigntemplatesignature_dependencyrequirement_isValid;
}

QString Ezsigntemplatesignature_ResponseCompound::getSEzsigntemplatesignaturePositioningpattern() const {
    return m_s_ezsigntemplatesignature_positioningpattern;
}
void Ezsigntemplatesignature_ResponseCompound::setSEzsigntemplatesignaturePositioningpattern(const QString &s_ezsigntemplatesignature_positioningpattern) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_positioningpattern_Set() const{
    return m_s_ezsigntemplatesignature_positioningpattern_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_positioningpattern_Valid() const{
    return m_s_ezsigntemplatesignature_positioningpattern_isValid;
}

qint32 Ezsigntemplatesignature_ResponseCompound::getIEzsigntemplatesignaturePositioningoffsetx() const {
    return m_i_ezsigntemplatesignature_positioningoffsetx;
}
void Ezsigntemplatesignature_ResponseCompound::setIEzsigntemplatesignaturePositioningoffsetx(const qint32 &i_ezsigntemplatesignature_positioningoffsetx) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_positioningoffsetx_Set() const{
    return m_i_ezsigntemplatesignature_positioningoffsetx_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_positioningoffsetx_Valid() const{
    return m_i_ezsigntemplatesignature_positioningoffsetx_isValid;
}

qint32 Ezsigntemplatesignature_ResponseCompound::getIEzsigntemplatesignaturePositioningoffsety() const {
    return m_i_ezsigntemplatesignature_positioningoffsety;
}
void Ezsigntemplatesignature_ResponseCompound::setIEzsigntemplatesignaturePositioningoffsety(const qint32 &i_ezsigntemplatesignature_positioningoffsety) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_positioningoffsety_Set() const{
    return m_i_ezsigntemplatesignature_positioningoffsety_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_i_ezsigntemplatesignature_positioningoffsety_Valid() const{
    return m_i_ezsigntemplatesignature_positioningoffsety_isValid;
}

Field_eEzsigntemplatesignaturePositioningoccurence Ezsigntemplatesignature_ResponseCompound::getEEzsigntemplatesignaturePositioningoccurence() const {
    return m_e_ezsigntemplatesignature_positioningoccurence;
}
void Ezsigntemplatesignature_ResponseCompound::setEEzsigntemplatesignaturePositioningoccurence(const Field_eEzsigntemplatesignaturePositioningoccurence &e_ezsigntemplatesignature_positioningoccurence) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_positioningoccurence_Set() const{
    return m_e_ezsigntemplatesignature_positioningoccurence_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_e_ezsigntemplatesignature_positioningoccurence_Valid() const{
    return m_e_ezsigntemplatesignature_positioningoccurence_isValid;
}

QString Ezsigntemplatesignature_ResponseCompound::getSEzsigntemplatesignatureCreditcardamountdescription() const {
    return m_s_ezsigntemplatesignature_creditcardamountdescription;
}
void Ezsigntemplatesignature_ResponseCompound::setSEzsigntemplatesignatureCreditcardamountdescription(const QString &s_ezsigntemplatesignature_creditcardamountdescription) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_creditcardamountdescription_Set() const{
    return m_s_ezsigntemplatesignature_creditcardamountdescription_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_s_ezsigntemplatesignature_creditcardamountdescription_Valid() const{
    return m_s_ezsigntemplatesignature_creditcardamountdescription_isValid;
}

QString Ezsigntemplatesignature_ResponseCompound::getDEzsigntemplatesignatureCreditcardamount() const {
    return m_d_ezsigntemplatesignature_creditcardamount;
}
void Ezsigntemplatesignature_ResponseCompound::setDEzsigntemplatesignatureCreditcardamount(const QString &d_ezsigntemplatesignature_creditcardamount) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_d_ezsigntemplatesignature_creditcardamount_Set() const{
    return m_d_ezsigntemplatesignature_creditcardamount_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_d_ezsigntemplatesignature_creditcardamount_Valid() const{
...
QList<Ezsigntemplateelementdependency_ResponseCompound> Ezsigntemplatesignature_ResponseCompound::getAObjEzsigntemplateelementdependency() const {
    return m_a_obj_ezsigntemplateelementdependency;
}
void Ezsigntemplatesignature_ResponseCompound::setAObjEzsigntemplateelementdependency(const QList<Ezsigntemplateelementdependency_ResponseCompound> &a_obj_ezsigntemplateelementdependency) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_a_obj_ezsigntemplateelementdependency_Set() const{
    return m_a_obj_ezsigntemplateelementdependency_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_a_obj_ezsigntemplateelementdependency_Valid() const{
    return m_a_obj_ezsigntemplateelementdependency_isValid;
}

QList<Ezsigntemplatesignaturepaymentdetail_ResponseCompound> Ezsigntemplatesignature_ResponseCompound::getAObjEzsigntemplatesignaturepaymentdetail() const {
    return m_a_obj_ezsigntemplatesignaturepaymentdetail;
}
void Ezsigntemplatesignature_ResponseCompound::setAObjEzsigntemplatesignaturepaymentdetail(const QList<Ezsigntemplatesignaturepaymentdetail_ResponseCompound> &a_obj_ezsigntemplatesignaturepaymentdetail) {
...
bool Ezsigntemplatesignature_ResponseCompound::is_a_obj_ezsigntemplatesignaturepaymentdetail_Set() const{
    return m_a_obj_ezsigntemplatesignaturepaymentdetail_isSet;
}

bool Ezsigntemplatesignature_ResponseCompound::is_a_obj_ezsigntemplatesignaturepaymentdetail_Valid() const{
