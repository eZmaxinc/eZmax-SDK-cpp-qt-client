...
#ifndef OAI_OAIObjectDepartmentApi_H
#define OAI_OAIObjectDepartmentApi_H
...
class OAIObjectDepartmentApi : public QObject {
    Q_OBJECT

public:
    OAIObjectDepartmentApi(const int timeOut = 0);
    ~OAIObjectDepartmentApi();
    ...
    */
    void departmentGetAutocompleteV1(const QString &s_selector, const ::OpenAPI::OptionalParam<QString> &e_filter_active = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &s_query = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIHeader_Accept_Language> &accept_language = ::OpenAPI::OptionalParam<OAIHeader_Accept_Language>());
