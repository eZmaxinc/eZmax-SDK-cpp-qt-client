...
/*
 * Employee_getAttachments_v1_Response_mPayload.h
 *
 * Response for GET /1/object/employee/{pkiEmployeeID}/getAttachments
 */

#ifndef Employee_getAttachments_v1_Response_mPayload_H
#define Employee_getAttachments_v1_Response_mPayload_H
...
class Employee_getAttachments_v1_Response_mPayload : public Object {
public:
    Employee_getAttachments_v1_Response_mPayload();
    Employee_getAttachments_v1_Response_mPayload(const QString &json);
    ~Employee_getAttachments_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Employee_getAttachments_v1_Response_mPayload)

#endif // Employee_getAttachments_v1_Response_mPayload_H
