...
Field_eNotificationpreferenceStatus::Field_eNotificationpreferenceStatus(const QString &json) {
...
void Field_eNotificationpreferenceStatus::fromJson(const QString &jsonString) {
