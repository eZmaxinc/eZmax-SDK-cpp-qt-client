...
Company_AutocompleteElement_Response::Company_AutocompleteElement_Response(const QString &json) {
...
void Company_AutocompleteElement_Response::fromJson(const QString &jsonString) {
