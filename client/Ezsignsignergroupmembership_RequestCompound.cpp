...
Ezsignsignergroupmembership_RequestCompound::Ezsignsignergroupmembership_RequestCompound(const QString &json) {
    this->initializeModel();
    this->fromJson(json);
}

Ezsignsignergroupmembership_RequestCompound::Ezsignsignergroupmembership_RequestCompound() {
    this->initializeModel();
}

Ezsignsignergroupmembership_RequestCompound::~Ezsignsignergroupmembership_RequestCompound() {}

void Ezsignsignergroupmembership_RequestCompound::initializeModel() {
...
void Ezsignsignergroupmembership_RequestCompound::fromJson(const QString &jsonString) {
...
void Ezsignsignergroupmembership_RequestCompound::fromJsonObject(QJsonObject json) {
...
QString Ezsignsignergroupmembership_RequestCompound::asJson() const {
...
QJsonObject Ezsignsignergroupmembership_RequestCompound::asJsonObject() const {
    QJsonObject obj;
...
qint32 Ezsignsignergroupmembership_RequestCompound::getPkiEzsignsignergroupmembershipId() const {
    return m_pki_ezsignsignergroupmembership_id;
}
void Ezsignsignergroupmembership_RequestCompound::setPkiEzsignsignergroupmembershipId(const qint32 &pki_ezsignsignergroupmembership_id) {
    m_pki_ezsignsignergroupmembership_id = pki_ezsignsignergroupmembership_id;
    m_pki_ezsignsignergroupmembership_id_isSet = true;
}

bool Ezsignsignergroupmembership_RequestCompound::is_pki_ezsignsignergroupmembership_id_Set() const{
    return m_pki_ezsignsignergroupmembership_id_isSet;
}

bool Ezsignsignergroupmembership_RequestCompound::is_pki_ezsignsignergroupmembership_id_Valid() const{
    return m_pki_ezsignsignergroupmembership_id_isValid;
}

qint32 Ezsignsignergroupmembership_RequestCompound::getFkiEzsignsignergroupId() const {
    return m_fki_ezsignsignergroup_id;
}
void Ezsignsignergroupmembership_RequestCompound::setFkiEzsignsignergroupId(const qint32 &fki_ezsignsignergroup_id) {
    m_fki_ezsignsignergroup_id = fki_ezsignsignergroup_id;
    m_fki_ezsignsignergroup_id_isSet = true;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_ezsignsignergroup_id_Set() const{
    return m_fki_ezsignsignergroup_id_isSet;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_ezsignsignergroup_id_Valid() const{
    return m_fki_ezsignsignergroup_id_isValid;
}

qint32 Ezsignsignergroupmembership_RequestCompound::getFkiEzsignsignerId() const {
    return m_fki_ezsignsigner_id;
}
void Ezsignsignergroupmembership_RequestCompound::setFkiEzsignsignerId(const qint32 &fki_ezsignsigner_id) {
    m_fki_ezsignsigner_id = fki_ezsignsigner_id;
    m_fki_ezsignsigner_id_isSet = true;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_ezsignsigner_id_Set() const{
    return m_fki_ezsignsigner_id_isSet;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_ezsignsigner_id_Valid() const{
    return m_fki_ezsignsigner_id_isValid;
}

qint32 Ezsignsignergroupmembership_RequestCompound::getFkiUserId() const {
    return m_fki_user_id;
}
void Ezsignsignergroupmembership_RequestCompound::setFkiUserId(const qint32 &fki_user_id) {
    m_fki_user_id = fki_user_id;
    m_fki_user_id_isSet = true;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_user_id_Set() const{
    return m_fki_user_id_isSet;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_user_id_Valid() const{
    return m_fki_user_id_isValid;
}

qint32 Ezsignsignergroupmembership_RequestCompound::getFkiUsergroupId() const {
    return m_fki_usergroup_id;
}
void Ezsignsignergroupmembership_RequestCompound::setFkiUsergroupId(const qint32 &fki_usergroup_id) {
    m_fki_usergroup_id = fki_usergroup_id;
    m_fki_usergroup_id_isSet = true;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_usergroup_id_Set() const{
    return m_fki_usergroup_id_isSet;
}

bool Ezsignsignergroupmembership_RequestCompound::is_fki_usergroup_id_Valid() const{
    return m_fki_usergroup_id_isValid;
}

bool Ezsignsignergroupmembership_RequestCompound::isSet() const {
...
bool Ezsignsignergroupmembership_RequestCompound::isValid() const {
