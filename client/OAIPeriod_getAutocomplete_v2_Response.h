...
/*
 * OAIPeriod_getAutocomplete_v2_Response.h
 *
 * Response for GET /2/object/period/getAutocomplete
 */

#ifndef OAIPeriod_getAutocomplete_v2_Response_H
#define OAIPeriod_getAutocomplete_v2_Response_H
...
class OAIPeriod_getAutocomplete_v2_Response : public OAIObject {
public:
    OAIPeriod_getAutocomplete_v2_Response();
    OAIPeriod_getAutocomplete_v2_Response(QString json);
    ~OAIPeriod_getAutocomplete_v2_Response() override;
...
private:
    ...
    OAIPeriod_getAutocomplete_v2_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIPeriod_getAutocomplete_v2_Response)

#endif // OAIPeriod_getAutocomplete_v2_Response_H
