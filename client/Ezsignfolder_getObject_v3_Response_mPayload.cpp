...
Ezsignfolder_getObject_v3_Response_mPayload::Ezsignfolder_getObject_v3_Response_mPayload(const QString &json) {
...
void Ezsignfolder_getObject_v3_Response_mPayload::fromJson(const QString &jsonString) {
