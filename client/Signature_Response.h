...
#ifndef Signature_Response_H
#define Signature_Response_H
...
class Signature_Response : public Object {
public:
    Signature_Response();
    Signature_Response(const QString &json);
    ~Signature_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Signature_Response)

#endif // Signature_Response_H
