...
Userstaged_getList_v1_Response_mPayload::Userstaged_getList_v1_Response_mPayload(const QString &json) {
...
void Userstaged_getList_v1_Response_mPayload::fromJson(const QString &jsonString) {
