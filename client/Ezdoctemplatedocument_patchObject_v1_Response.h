...
/*
 * Ezdoctemplatedocument_patchObject_v1_Response.h
 *
 * Response for PATCH /1/object/ezdoctemplatedocument/{pkiEzdoctemplatedocumentID}
 */

#ifndef Ezdoctemplatedocument_patchObject_v1_Response_H
#define Ezdoctemplatedocument_patchObject_v1_Response_H
...
class Ezdoctemplatedocument_patchObject_v1_Response : public Object {
public:
    Ezdoctemplatedocument_patchObject_v1_Response();
    Ezdoctemplatedocument_patchObject_v1_Response(const QString &json);
    ~Ezdoctemplatedocument_patchObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezdoctemplatedocument_patchObject_v1_Response)

#endif // Ezdoctemplatedocument_patchObject_v1_Response_H
