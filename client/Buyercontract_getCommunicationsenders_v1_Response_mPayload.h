...
/*
 * Buyercontract_getCommunicationsenders_v1_Response_mPayload.h
 *
 * Response for GET /1/object/buyercontract/{pkiBuyercontractID}/getCommunicationsenders
 */

#ifndef Buyercontract_getCommunicationsenders_v1_Response_mPayload_H
#define Buyercontract_getCommunicationsenders_v1_Response_mPayload_H
...
class Buyercontract_getCommunicationsenders_v1_Response_mPayload : public Object {
public:
    Buyercontract_getCommunicationsenders_v1_Response_mPayload();
    Buyercontract_getCommunicationsenders_v1_Response_mPayload(const QString &json);
    ~Buyercontract_getCommunicationsenders_v1_Response_mPayload() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Buyercontract_getCommunicationsenders_v1_Response_mPayload)

#endif // Buyercontract_getCommunicationsenders_v1_Response_mPayload_H
