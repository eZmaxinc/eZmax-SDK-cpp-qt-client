...
Ezsigntemplatedocumentpage_Response::Ezsigntemplatedocumentpage_Response(const QString &json) {
...
void Ezsigntemplatedocumentpage_Response::fromJson(const QString &jsonString) {
