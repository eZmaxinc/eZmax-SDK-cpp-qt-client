...
Ezsigntemplatepackagesigner_Request::Ezsigntemplatepackagesigner_Request(const QString &json) {
...
void Ezsigntemplatepackagesigner_Request::fromJson(const QString &jsonString) {
