...
/*
 * OAIFranchisereferalincome_createObject_v1_Response.h
 *
 * Response for POST /1/object/franchisereferalincome
 */

#ifndef OAIFranchisereferalincome_createObject_v1_Response_H
#define OAIFranchisereferalincome_createObject_v1_Response_H
...
class OAIFranchisereferalincome_createObject_v1_Response : public OAIObject {
public:
    OAIFranchisereferalincome_createObject_v1_Response();
    OAIFranchisereferalincome_createObject_v1_Response(QString json);
    ~OAIFranchisereferalincome_createObject_v1_Response() override;
...
private:
    ...
    OAIFranchisereferalincome_createObject_v1_Response_mPayload m_m_payload;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIFranchisereferalincome_createObject_v1_Response)

#endif // OAIFranchisereferalincome_createObject_v1_Response_H
