...
#include "ObjectBankaccountApi.h"
...
ObjectBankaccountApi::ObjectBankaccountApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
ObjectBankaccountApi::~ObjectBankaccountApi() {
}

void ObjectBankaccountApi::initializeServerConfigs() {
    //Default server
...
*/
int ObjectBankaccountApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void ObjectBankaccountApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void ObjectBankaccountApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void ObjectBankaccountApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void ObjectBankaccountApi::setUsername(const QString &username) {
    _username = username;
}

void ObjectBankaccountApi::setPassword(const QString &password) {
    _password = password;
}


void ObjectBankaccountApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void ObjectBankaccountApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void ObjectBankaccountApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int ObjectBankaccountApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void ObjectBankaccountApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void ObjectBankaccountApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, ServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void ObjectBankaccountApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void ObjectBankaccountApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void ObjectBankaccountApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void ObjectBankaccountApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString ObjectBankaccountApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString ObjectBankaccountApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString ObjectBankaccountApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void ObjectBankaccountApi::bankaccountGetAutocompleteV2(const QString &s_selector, const ::Ezmaxapi::OptionalParam<QString> &e_filter_active, const ::Ezmaxapi::OptionalParam<QString> &s_query, const ::Ezmaxapi::OptionalParam<Header_Accept_Language> &accept_language) {
    ...
    connect(worker, &HttpRequestWorker::on_execution_finished, this, &ObjectBankaccountApi::bankaccountGetAutocompleteV2Callback);
...
void ObjectBankaccountApi::bankaccountGetAutocompleteV2Callback(HttpRequestWorker *worker) {
    ...
    Bankaccount_getAutocomplete_v2_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bankaccountGetAutocompleteV2Signal(output);
        Q_EMIT bankaccountGetAutocompleteV2SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bankaccountGetAutocompleteV2SignalE(output, error_type, error_str);
        Q_EMIT bankaccountGetAutocompleteV2SignalEFull(worker, error_type, error_str);
...
void ObjectBankaccountApi::tokenAvailable(){
