...
#ifndef Usergroupexternal_Response_H
#define Usergroupexternal_Response_H
...
class Usergroupexternal_Response : public Object {
public:
    Usergroupexternal_Response();
    Usergroupexternal_Response(const QString &json);
    ~Usergroupexternal_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Usergroupexternal_Response)

#endif // Usergroupexternal_Response_H
