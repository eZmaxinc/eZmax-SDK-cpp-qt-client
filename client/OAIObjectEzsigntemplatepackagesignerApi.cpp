...
#include "OAIObjectEzsigntemplatepackagesignerApi.h"
...
OAIObjectEzsigntemplatepackagesignerApi::OAIObjectEzsigntemplatepackagesignerApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIObjectEzsigntemplatepackagesignerApi::~OAIObjectEzsigntemplatepackagesignerApi() {
}

void OAIObjectEzsigntemplatepackagesignerApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIObjectEzsigntemplatepackagesignerApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIObjectEzsigntemplatepackagesignerApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIObjectEzsigntemplatepackagesignerApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIObjectEzsigntemplatepackagesignerApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIObjectEzsigntemplatepackagesignerApi::setUsername(const QString &username) {
    _username = username;
}

void OAIObjectEzsigntemplatepackagesignerApi::setPassword(const QString &password) {
    _password = password;
}


void OAIObjectEzsigntemplatepackagesignerApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIObjectEzsigntemplatepackagesignerApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIObjectEzsigntemplatepackagesignerApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIObjectEzsigntemplatepackagesignerApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectEzsigntemplatepackagesignerApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIObjectEzsigntemplatepackagesignerApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIObjectEzsigntemplatepackagesignerApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIObjectEzsigntemplatepackagesignerApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIObjectEzsigntemplatepackagesignerApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIObjectEzsigntemplatepackagesignerApi::abortRequests() {
    emit abortRequestsSignal();
}

QString OAIObjectEzsigntemplatepackagesignerApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIObjectEzsigntemplatepackagesignerApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIObjectEzsigntemplatepackagesignerApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV1(const OAIEzsigntemplatepackagesigner_createObject_v1_Request &oai_ezsigntemplatepackagesigner_create_object_v1_request) {
...

    {
        ...
        QByteArray output = oai_ezsigntemplatepackagesigner_create_object_v1_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV1Callback);
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerCreateObjectV1Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIEzsigntemplatepackagesigner_createObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerDeleteObjectV1(const qint32 &pki_ezsigntemplatepackagesigner_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerDeleteObjectV1Callback);
    connect(this, &OAIObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerDeleteObjectV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsigntemplatepackagesigner_deleteObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV1(const qint32 &pki_ezsigntemplatepackagesigner_id, const OAIEzsigntemplatepackagesigner_editObject_v1_Request &oai_ezsigntemplatepackagesigner_edit_object_v1_request) {
...

    {
        ...
        QByteArray output = oai_ezsigntemplatepackagesigner_edit_object_v1_request.asJson().toUtf8();
        input.request_body.append(output);
    }
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV1Callback);
    connect(this, &OAIObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerEditObjectV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsigntemplatepackagesigner_editObject_v1_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV2(const qint32 &pki_ezsigntemplatepackagesigner_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV2Callback);
    connect(this, &OAIObjectEzsigntemplatepackagesignerApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            emit allPendingRequestsCompleted();
...
void OAIObjectEzsigntemplatepackagesignerApi::ezsigntemplatepackagesignerGetObjectV2Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEzsigntemplatepackagesigner_getObject_v2_Response output(QString(worker->response));
    worker->deleteLater();
...
void OAIObjectEzsigntemplatepackagesignerApi::tokenAvailable(){
