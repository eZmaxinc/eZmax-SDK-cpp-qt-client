...
/*
 * Domain_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/domain/{pkiDomainID}
 */

#ifndef Domain_deleteObject_v1_Response_H
#define Domain_deleteObject_v1_Response_H
...
class Domain_deleteObject_v1_Response : public Object {
public:
    Domain_deleteObject_v1_Response();
    Domain_deleteObject_v1_Response(const QString &json);
    ~Domain_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Domain_deleteObject_v1_Response)

#endif // Domain_deleteObject_v1_Response_H
