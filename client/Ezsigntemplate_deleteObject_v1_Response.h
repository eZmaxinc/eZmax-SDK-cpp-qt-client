...
/*
 * Ezsigntemplate_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/ezsigntemplate/{pkiEzsigntemplateID}
 */

#ifndef Ezsigntemplate_deleteObject_v1_Response_H
#define Ezsigntemplate_deleteObject_v1_Response_H
...
class Ezsigntemplate_deleteObject_v1_Response : public Object {
public:
    Ezsigntemplate_deleteObject_v1_Response();
    Ezsigntemplate_deleteObject_v1_Response(const QString &json);
    ~Ezsigntemplate_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigntemplate_deleteObject_v1_Response)

#endif // Ezsigntemplate_deleteObject_v1_Response_H
