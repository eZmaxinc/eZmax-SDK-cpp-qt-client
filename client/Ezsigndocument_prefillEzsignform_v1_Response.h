...
/*
 * Ezsigndocument_prefillEzsignform_v1_Response.h
 *
 * Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/prefillEzsignform
 */

#ifndef Ezsigndocument_prefillEzsignform_v1_Response_H
#define Ezsigndocument_prefillEzsignform_v1_Response_H
...
class Ezsigndocument_prefillEzsignform_v1_Response : public Object {
public:
    Ezsigndocument_prefillEzsignform_v1_Response();
    Ezsigndocument_prefillEzsignform_v1_Response(const QString &json);
    ~Ezsigndocument_prefillEzsignform_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Ezsigndocument_prefillEzsignform_v1_Response)

#endif // Ezsigndocument_prefillEzsignform_v1_Response_H
