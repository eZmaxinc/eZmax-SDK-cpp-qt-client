...
Usergroupexternal_getObject_v2_Response_mPayload::Usergroupexternal_getObject_v2_Response_mPayload(const QString &json) {
...
void Usergroupexternal_getObject_v2_Response_mPayload::fromJson(const QString &jsonString) {
