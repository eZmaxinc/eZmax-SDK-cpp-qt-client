...
/*
 * OAIVariableexpense_RequestCompound.h
 *
 * A Variableexpense Object and children
 */

#ifndef OAIVariableexpense_RequestCompound_H
#define OAIVariableexpense_RequestCompound_H
...
class OAIVariableexpense_RequestCompound : public OAIObject {
public:
    OAIVariableexpense_RequestCompound();
    OAIVariableexpense_RequestCompound(QString json);
    ~OAIVariableexpense_RequestCompound() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::OAIVariableexpense_RequestCompound)

#endif // OAIVariableexpense_RequestCompound_H
