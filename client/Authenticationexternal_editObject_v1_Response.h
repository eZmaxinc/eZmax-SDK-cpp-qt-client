...
/*
 * Authenticationexternal_editObject_v1_Response.h
 *
 * Response for PUT /1/object/authenticationexternal/{pkiAuthenticationexternalID}
 */

#ifndef Authenticationexternal_editObject_v1_Response_H
#define Authenticationexternal_editObject_v1_Response_H
...
class Authenticationexternal_editObject_v1_Response : public Object {
public:
    Authenticationexternal_editObject_v1_Response();
    Authenticationexternal_editObject_v1_Response(const QString &json);
    ~Authenticationexternal_editObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Authenticationexternal_editObject_v1_Response)

#endif // Authenticationexternal_editObject_v1_Response_H
