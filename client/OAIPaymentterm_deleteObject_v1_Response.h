...
/*
 * OAIPaymentterm_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/paymentterm/{pkiPaymenttermID}
 */

#ifndef OAIPaymentterm_deleteObject_v1_Response_H
#define OAIPaymentterm_deleteObject_v1_Response_H
...
class OAIPaymentterm_deleteObject_v1_Response : public OAIObject {
public:
    OAIPaymentterm_deleteObject_v1_Response();
    OAIPaymentterm_deleteObject_v1_Response(QString json);
    ~OAIPaymentterm_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentterm_deleteObject_v1_Response)

#endif // OAIPaymentterm_deleteObject_v1_Response_H
