...
Email_Request::Email_Request(const QString &json) {
...
void Email_Request::initializeModel() {
...
void Email_Request::fromJson(const QString &jsonString) {
...
void Email_Request::fromJsonObject(QJsonObject json) {
...
QString Email_Request::asJson() const {
...
QJsonObject Email_Request::asJsonObject() const {
    QJsonObject obj;
...
qint32 Email_Request::getPkiEmailId() const {
    return m_pki_email_id;
}
void Email_Request::setPkiEmailId(const qint32 &pki_email_id) {
    m_pki_email_id = pki_email_id;
    m_pki_email_id_isSet = true;
}

bool Email_Request::is_pki_email_id_Set() const{
    return m_pki_email_id_isSet;
}

bool Email_Request::is_pki_email_id_Valid() const{
    return m_pki_email_id_isValid;
}

qint32 Email_Request::getFkiEmailtypeId() const {
    return m_fki_emailtype_id;
}
void Email_Request::setFkiEmailtypeId(const qint32 &fki_emailtype_id) {
    m_fki_emailtype_id = fki_emailtype_id;
    m_fki_emailtype_id_isSet = true;
}

bool Email_Request::is_fki_emailtype_id_Set() const{
    return m_fki_emailtype_id_isSet;
}

bool Email_Request::is_fki_emailtype_id_Valid() const{
    return m_fki_emailtype_id_isValid;
}

QString Email_Request::getSEmailAddress() const {
    return m_s_email_address;
}
void Email_Request::setSEmailAddress(const QString &s_email_address) {
    m_s_email_address = s_email_address;
    m_s_email_address_isSet = true;
}

bool Email_Request::is_s_email_address_Set() const{
    return m_s_email_address_isSet;
}

bool Email_Request::is_s_email_address_Valid() const{
    return m_s_email_address_isValid;
}

bool Email_Request::isSet() const {
...
bool Email_Request::isValid() const {
