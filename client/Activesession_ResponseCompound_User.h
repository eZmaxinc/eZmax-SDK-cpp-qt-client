...
public:
    ...
    bool isBUserAddmeinezsignfolder() const;
    void setBUserAddmeinezsignfolder(const bool &b_user_addmeinezsignfolder);
    bool is_b_user_addmeinezsignfolder_Set() const;
    bool is_b_user_addmeinezsignfolder_Valid() const;
    ...
    qint32 getIUserFrontendgoal() const;
    void setIUserFrontendgoal(const qint32 &i_user_frontendgoal);
    bool is_i_user_frontendgoal_Set() const;
    bool is_i_user_frontendgoal_Valid() const;
...
private:
    ...
    bool m_b_user_addmeinezsignfolder;
    bool m_b_user_addmeinezsignfolder_isSet;
    bool m_b_user_addmeinezsignfolder_isValid;
    ...
    qint32 m_i_user_frontendgoal;
    bool m_i_user_frontendgoal_isSet;
    bool m_i_user_frontendgoal_isValid;
};
