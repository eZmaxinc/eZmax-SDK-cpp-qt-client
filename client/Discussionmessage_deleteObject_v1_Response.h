...
/*
 * Discussionmessage_deleteObject_v1_Response.h
 *
 * Response for DELETE /1/object/discussionmessage/{pkiDiscussionmessageID}
 */

#ifndef Discussionmessage_deleteObject_v1_Response_H
#define Discussionmessage_deleteObject_v1_Response_H
...
class Discussionmessage_deleteObject_v1_Response : public Object {
public:
    Discussionmessage_deleteObject_v1_Response();
    Discussionmessage_deleteObject_v1_Response(const QString &json);
    ~Discussionmessage_deleteObject_v1_Response() override;
...
Q_DECLARE_METATYPE(Ezmaxapi::Discussionmessage_deleteObject_v1_Response)

#endif // Discussionmessage_deleteObject_v1_Response_H
